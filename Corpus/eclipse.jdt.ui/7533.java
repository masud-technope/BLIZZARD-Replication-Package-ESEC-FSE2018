...
class PackageExplorerActionGroup extends CompositeActionGroup {
    ...
    public  PackageExplorerActionGroup(PackageExplorerPart part) {
        ...
        fFrameList.addPropertyChangeListener(new // connect after the actions (order of property listener)
    ...
    private boolean isGoIntoTarget(Object element) {
        ...
        if (element instanceof IJavaElement) {
            ...
            return type == IJavaElement.JAVA_PROJECT || type == IJavaElement.PACKAGE_FRAGMENT_ROOT || type == IJavaElement.PACKAGE_FRAGMENT;
        }
