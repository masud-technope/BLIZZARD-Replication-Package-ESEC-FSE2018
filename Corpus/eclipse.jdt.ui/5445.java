    ...
    public static class Parameter {
        ...
        public void setCreateField(boolean createField) {
            if (fIndex == PARAMETER_OBJECT_IDX)
                ...
                "You can not set create field for the parameter object");
        ...
        public void setFieldName(String fieldName) {
            if (fIndex == PARAMETER_OBJECT_IDX)
                throw new //$NON-NLS-1$
                IllegalArgumentException(//$NON-NLS-1$
                "You can not set the field name of the parameter object");
    ...
    public RefactoringStatus validateDescriptor() {
        ...
        if (fParameters != null) {
            if (fParameters.length - 1 != fMethod.getNumberOfParameters()) {
                ...
                "The number of parameters does not match the number of parameters of the method");
            }
        ...
        if (//$NON-NLS-1$
        fPackageName != null && !"".equals(fPackageName)) {
