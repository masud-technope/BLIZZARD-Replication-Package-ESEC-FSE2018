...
public class ContentProviderTests2 extends TestCase {
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite(ContentProviderTests2.class.getName());
        //$JUnit-BEGIN$
    ...
    public void testGetParentArchive() throws Exception {
        ...
        //$NON-NLS-1$
        assertTrue("Wrong parent found for PackageFragmentRoot Archive", parent == fJProject3);
    }
    ...
    protected void setUp() throws Exception {
        ...
        //$NON-NLS-1$
        fInternalRoot1.getPackageFragment("a.d");
        //$NON-NLS-1$
