...
public class NLSSourceModifier {
    ...
    private void replaceAccessor(NLSSubstitution substitution, TextChange change) {
        ...
        if (accessorClassRef != null) {
            ...
            TextChangeCompatibility.addTextEdit(change, Messages.format(NLSMessages.NLSSourceModifier_replace_accessor, args), new ReplaceEdit(region.getOffset(), len, //
            substitution.getUpdatedAccessor()));
        }
    }
    ...
    private void replaceKey(NLSSubstitution substitution, TextChange change) {
        ...
        if (fIsEclipseNLS)
            ...
            replaceEdit = new ReplaceEdit(region.getOffset(), region.getLength(), //
    ...
    private void replaceValue(NLSSubstitution substitution, TextChange change) {
        ...
        TextChangeCompatibility.addTextEdit(change, Messages.format(NLSMessages.NLSSourceModifier_replace_value, args), new ReplaceEdit(region.getOffset(), region.getLength(), '\"' + unwindEscapeChars(//
    ...
    private void deleteTag(NLSSubstitution substitution, TextChange change) {
        ...
        TextChangeCompatibility.addTextEdit(change, NLSMessages.NLSSourceModifier_remove_tag, new DeleteEdit(textRegion.getOffset(), textRegion.getLength()));
    }
