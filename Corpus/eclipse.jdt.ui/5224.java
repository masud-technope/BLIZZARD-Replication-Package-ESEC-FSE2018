    ...
    private static class WorkingSetCompareEntry {
        ...
        public  WorkingSetCompareEntry(IAdaptable a) {
            if (a instanceof IJavaElement) {
                ...
                IResource fakeInternal = //$NON-NLS-1$
                proj.getProject().getFile(//$NON-NLS-1$
                wrapper.getProject().getElementName() + "-fake-jar.jar");
        ...
        private void init(IJarEntryResource jarEntryResource) {
            ...
            while (parent instanceof IJarEntryResource) parent = ((IJarEntryResource) parent).getParent();
        ...
        private boolean isAncestor(IJavaElement elem, IJavaElement parent) {
            ...
            while (// ITypes can be in ITypes
            anc instanceof IMember) {
