...
public class JavaStructureCreator extends StructureCreator {
    ...
    public String getContents(Object node, boolean ignoreWhiteSpace) {
        ...
        // however we request Whitespace and Comments
    ...
    public void rewriteTree(Differencer differencer, IDiffContainer root) {
        ...
        while (it.hasNext()) {
            ...
            if (// we found a RewriteInfo that could be successfully combined
            i.matches()) {
                ...
                if (// there better should be a difference
                d != null) {
    ...
    protected String[] getPath(Object element, Object input) {
        if (element instanceof IJavaElement) {
            ...
            for (int i = 0; i < n; i++) path[i] = args.get(n - 1 - i);
            return path;
        }
        return null;
    }
