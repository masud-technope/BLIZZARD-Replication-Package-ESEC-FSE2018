...
public class ContentAssistProcessor implements IContentAssistProcessor {
    ...
    private final class CompletionListener implements ICompletionListener, ICompletionListenerExtension {
        ...
        private Set<CompletionProposalCategory> getCategoriesToNotify() {
            ...
            if (fCategoryIteration != null) {
                ...
                while (it.hasNext()) currentCategories.addAll(it.next());
            }
    ...
    private boolean informUserAboutEmptyDefaultCategory() {
        if (OptionalMessageDialog.isDialogEnabled(PREF_WARN_ABOUT_EMPTY_ASSIST_CATEGORY)) {
            ...
            //$NON-NLS-1$
            final String restoreButtonLabel = JFaceResources.getString("defaults");
            ...
            final OptionalMessageDialog dialog = new OptionalMessageDialog(PREF_WARN_ABOUT_EMPTY_ASSIST_CATEGORY, shell, title, /* default image */
            null, message, MessageDialog.WARNING, new String[] { restoreButtonLabel, IDialogConstants.CLOSE_LABEL }, 1) {
            ...
            if (restoreId == returnValue || settingsId == returnValue) {
                ...
                if (settingsId == returnValue)
                    //$NON-NLS-1$
                    PreferencesUtil.createPreferenceDialogOn(shell, "org.eclipse.jdt.ui.preferences.CodeAssistPreferenceAdvanced", null, null).open();
