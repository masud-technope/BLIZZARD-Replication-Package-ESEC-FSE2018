...
public class TestPriorization extends TestCase {
    ...
    public void testReorderSimple() {
        ...
        String[] priority = { "testF(org.eclipse.jdt.junit.tests.TestPriorizationSuite2)" };
        Test prioritized = prioritize(suite, priority);
        List<String> order = new ArrayList();
        collectOrder(prioritized, order);
        String[] expected = { "testF", "testD", "testE" };
    ...
    public void testReorderWithPropagation() {
        ...
        List<String> order = new ArrayList();
        collectOrder(reordered, order);
        String[] expected = { "testF", "testD", "testE", "testA", "testB", "testC" };
        checkOrder(expected, order);
    }
    ...
    public void testReorderWithPropagation2() {
        ...
        List<String> order = new ArrayList();
        collectOrder(reordered, order);
        String[] expected = { "testF", "testD", "testE", "testA", "testB", "testC", "testX", "testY", "testZ" };
        checkOrder(expected, order);
    }
    ...
    public void testReorderWithPropagationBug() {
        ...
        suite4.addTest(createSuiteXYZ());
        suite4.addTest(suite);
        String[] priority = { "testE(org.eclipse.jdt.junit.tests.TestPriorizationSuite2)", "testF(org.eclipse.jdt.junit.tests.TestPriorizationSuite2)" };
        Test reordered = prioritize(suite4, priority);
        List<String> order = new ArrayList();
        collectOrder(reordered, order);
        String[] expected = { "testF", "testE", "testD", "testA", "testB", "testC", "testX", "testY", "testZ" };
        //printOrder(order);
        checkOrder(expected, order);
    }
    ...
    public void testReorderWithPropagation3() {
        ...
        suite4.addTest(createSuiteXYZ());
        suite4.addTest(suite);
        String[] priority = { "testF(org.eclipse.jdt.junit.tests.TestPriorizationSuite2)", "testZ(org.eclipse.jdt.junit.tests.TestPriorizationSuite)" };
        Test reordered = prioritize(suite4, priority);
        List<String> order = new ArrayList();
        collectOrder(reordered, order);
        String[] expected = { "testF", "testD", "testE", "testA", "testB", "testC", "testZ", "testX", "testY" };
        checkOrder(expected, order);
    }
