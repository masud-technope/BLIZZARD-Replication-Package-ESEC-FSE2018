...
public class JavaElementLabelProvider extends LabelProvider implements IStyledLabelProvider {
	 ...
	 */
    public static final int SHOW_RETURN_TYPE = 0x001;

    /**
	 * Flag (bit mask) indicating that method label include parameter types.
	 */
    public static final int SHOW_PARAMETERS = 0x002;
	 ...
	 */
    @Deprecated
    public static final int SHOW_CONTAINER = 0x004;
	 ...
	 */
    @Deprecated
    public static final int SHOW_POSTIFIX_QUALIFICATION = 0x080;

    /**
	 * Flag (bit mask) indicating that the label should show the icons with no space
	 * reserved for overlays.
	 */
    public static final int SHOW_SMALL_ICONS = 0x100;
	 ...
	 */
    public static final int SHOW_VARIABLE = 0x200;
	 ...
	 * @since 2.0
	 */
    public static final int SHOW_QUALIFIED = 0x400;
	 ...
	 * @since 2.0
	 */
    public static final int SHOW_POST_QUALIFIED = 0x800;

    /**
	 * Constant (value <code>0</code>) indicating that the label should show
	 * the basic images only.
	 */
    public static final int SHOW_BASICS = 0x000;
	 ...
	 */
    public static final int SHOW_DEFAULT = new Integer(SHOW_PARAMETERS | SHOW_OVERLAY_ICONS).intValue();
    ...
    private void updateTextProviderFlags() {
        ...
        if (getFlag(SHOW_POST_QUALIFIED)) {
            fTextFlags |= (JavaElementLabels.F_POST_QUALIFIED | JavaElementLabels.M_POST_QUALIFIED | JavaElementLabels.I_POST_QUALIFIED | JavaElementLabels.T_POST_QUALIFIED | JavaElementLabels.TP_POST_QUALIFIED | JavaElementLabels.D_POST_QUALIFIED | JavaElementLabels.CF_POST_QUALIFIED | JavaElementLabels.CU_POST_QUALIFIED);
        }
    }
