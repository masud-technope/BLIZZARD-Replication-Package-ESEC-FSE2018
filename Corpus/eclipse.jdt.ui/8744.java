...
public class TypeHierarchyPerfTest extends JdtPerformanceTestCase {
    ...
    public static Test suite() {
        OrderedTestSuite testSuite = new OrderedTestSuite(TypeHierarchyPerfTest.class, new String[] { "testOpenObjectHierarchy", "testOpenCollHierarchy", "testOpenObjectHierarchy2" });
