...
public class PackageExplorerPerfTest extends JdtPerformanceTestCase {
    ...
    public static Test suite() {
        TestSuite suite = new OrderedTestSuite(PackageExplorerPerfTest.class, new String[] { "testOpen", "testSelect", "testExpand", "testRefreshClassFolder" });
    ...
    public void testRefreshClassFolder() throws Throwable {
        ...
        // runs pending updates
        view.selectAndReveal(classFolder);
        joinBackgroudActivities();
