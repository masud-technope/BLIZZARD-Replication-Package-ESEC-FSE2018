...
public class RenameLocalVariableProcessor extends JavaRenameProcessor implements IReferenceUpdating {
    ...
    public Object getNewElement() {
        //cannot create an ILocalVariable
        return null;
    }
    ...
    public RefactoringStatus checkInitialConditions(IProgressMonitor pm) throws CoreException {
        ...
        if (!Checks.isDeclaredIn(fTempDeclarationNode, MethodDeclaration.class) && !Checks.isDeclaredIn(fTempDeclarationNode, Initializer.class) && !Checks.isDeclaredIn(fTempDeclarationNode, LambdaExpression.class)) {
    ...
    private TextEdit[] getAllRenameEdits(TextEdit declarationEdit) {
        ...
        for (int i = 0; i < referenceOffsets.length; i++) allRenameEdits[i] = createRenameEdit(referenceOffsets[i]);
