...
public class OverrideIndicatorImageProvider implements IAnnotationImageProvider {
	 ...
	 */
    //$NON-NLS-1$
    private static final String OVERRIDE_IMG_DESC_ID = "JavaPluginImages.DESC_OBJ_OVERRIDES";

    //$NON-NLS-1$
    private static final String OVERWRITE_IMG_DESC_ID = "JavaPluginImages.DESC_OBJ_IMPLEMENTS";
