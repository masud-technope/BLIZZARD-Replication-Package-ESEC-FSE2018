...
class ToggleCallModeAction extends Action {
    ...
    public  ToggleCallModeAction(CallHierarchyViewPart v, int mode) {
        ...
        if (mode == CallHierarchyViewPart.CALL_MODE_CALLERS) {
            ...
            //$NON-NLS-1$
            JavaPluginImages.setLocalImageDescriptors(this, "ch_callers.png");
            ...
            //$NON-NLS-1$
            JavaPluginImages.setLocalImageDescriptors(this, "ch_callees.png");
        } else {
            Assert.isTrue(false);
        }
        fView = v;
