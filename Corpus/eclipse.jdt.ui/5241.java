...
public class StringBuilderGenerator extends AbstractToStringGenerator {
    ...
    protected void initialize() {
        super.initialize();
        //$NON-NLS-1$ //$NON-NLS-2$
        fBuilderVariableName = createNameSuggestion(getContext().is50orHigher() ? "builder" : "buffer", NamingConventions.VK_LOCAL);
        ...
        //$NON-NLS-1$ //$NON-NLS-2$
        Name typeName = addImport(getContext().is50orHigher() ? "java.lang.StringBuilder" : "java.lang.StringBuffer");
    ...
    protected void complete() throws CoreException {
        ...
        //$NON-NLS-1$
        rStatement.setExpression(createMethodInvocation(fBuilderVariableName, "toString", null));
