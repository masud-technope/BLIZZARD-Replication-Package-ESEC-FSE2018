...
public class PullUpMethodPage extends UserInputWizardPage {
    ...
    private static class PullUpHierarchyContentProvider implements ITreeContentProvider {
        ...
        // IType -> IMember[]
        private Map<IType, IMember[]> fTypeToMemberArray;
    ...
    private void updateSelectionLabel() {
        ...
        String text = checkedMethodsCount == 1 ? Messages.format(RefactoringMessages.PullUpInputPage_hierarchyLabal_singular, JavaElementLabels.getElementLabel(methods[0], JavaElementLabels.M_PARAMETER_TYPES)) : Messages.format(RefactoringMessages.PullUpInputPage_hierarchyLabal_plural, String.valueOf(checkedMethodsCount));
