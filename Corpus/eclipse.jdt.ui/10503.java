...
public class DialogPackageExplorer implements IMenuListener, IPostSelectionProvider, ISetSelectionTarget {
    ...
    private final class PackageContentProvider extends PackageExplorerContentProvider {
        ...
        public Object[] getChildren(Object element) {
            ...
            if (((element instanceof IPackageFragmentRoot && !ClasspathModifier.isInExternalOrArchive((IPackageFragmentRoot) element)) || (element instanceof IJavaProject && fCurrJProject.isOnClasspath(fCurrJProject))) && fShowOutputFolders) {
                try {
                    ...
                    CPListElementAttribute outputFolder = new CPListElementAttribute(parent, CPListElement.OUTPUT, parent.getAttribute(CPListElement.OUTPUT), true);
        ...
        public boolean select(Viewer viewer, Object parentElement, Object element) {
            try {
                if (element instanceof IFile) {
                    ...
                    file.getName().equals(".classpath") || file.getName().equals(".project"))
                        return false;
    ...
    public void setContentProvider() {
        ...
        PackageLabelProvider labelProvider = new PackageLabelProvider(AppearanceAwareLabelProvider.DEFAULT_TEXTFLAGS | JavaElementLabels.P_COMPRESSED, AppearanceAwareLabelProvider.DEFAULT_IMAGEFLAGS | JavaElementImageProvider.SMALL_ICONS);
