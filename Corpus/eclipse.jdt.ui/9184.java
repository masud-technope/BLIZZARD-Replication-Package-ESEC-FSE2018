...
public abstract class TestElement implements ITestElement {
    ...
    public static final class Status {
        ...
        //$NON-NLS-1$
        public static final Status FAILURE = new Status("FAILURE", ITestRunListener2.STATUS_FAILURE);

        //$NON-NLS-1$
        public static final Status OK = new Status("OK", /*0*/
        ITestRunListener2.STATUS_OK);
    ...
    public String toString() {
        //$NON-NLS-1$
        return getProgressState() + " - " + getTestResult(true);
    }
}
