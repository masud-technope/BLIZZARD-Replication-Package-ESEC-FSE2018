...
public class CUPositionCompletionProcessor implements IContentAssistProcessor, ISubjectControlContentAssistProcessor {
    ...
    private ICompletionProposal[] internalComputeCompletionProposals(int documentOffset, String input) {
        ...
        try {
			 ...
			 */
            cu = fCompletionContextRequestor.getOriginalCu().getWorkingCopy(new WorkingCopyOwner() {
    ...
    protected abstract static class CUPositionCompletionRequestor extends CompletionRequestor {
        ...
        protected final void addAdjustedCompletion(String name, String completion, int start, int end, int relevance, ImageDescriptor descriptor) {
            JavaCompletionProposal javaCompletionProposal = new JavaCompletionProposal(completion, start - fOffsetReduction, end - start, getImage(descriptor), new StyledString(name), relevance);
        ...
        protected final void addAdjustedTypeCompletion(String name, String completion, int start, int end, int relevance, ImageDescriptor descriptor, String fullyQualifiedName) {
            ...
            JavaTypeCompletionProposal javaCompletionProposal = new JavaTypeCompletionProposal(replacementString, null, replacementOffset, replacementLength, getImage(descriptor), new StyledString(name), relevance, fullyQualifiedName);
            javaCompletionProposal.setTriggerCharacters(TRIGGER_CHARACTERS);
            fProposals.add(javaCompletionProposal);
        }
