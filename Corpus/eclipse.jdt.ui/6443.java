...
public class RenameVirtualMethodProcessor extends RenameMethodProcessor {
    ...
    private boolean isSpecialCase() throws CoreException {
        ...
        String[] specialNames = new String[] { //$NON-NLS-5$ //$NON-NLS-4$ //$NON-NLS-3$ //$NON-NLS-2$ //$NON-NLS-1$
        "toString", //$NON-NLS-5$ //$NON-NLS-4$ //$NON-NLS-3$ //$NON-NLS-2$ //$NON-NLS-1$
        "toString", //$NON-NLS-5$ //$NON-NLS-4$ //$NON-NLS-3$ //$NON-NLS-2$ //$NON-NLS-1$
        "toString", //$NON-NLS-5$ //$NON-NLS-4$ //$NON-NLS-3$ //$NON-NLS-2$ //$NON-NLS-1$
        "toString", //$NON-NLS-5$ //$NON-NLS-4$ //$NON-NLS-3$ //$NON-NLS-2$ //$NON-NLS-1$
        "equals", //$NON-NLS-5$ //$NON-NLS-4$ //$NON-NLS-3$ //$NON-NLS-2$ //$NON-NLS-1$
        "equals", //$NON-NLS-5$ //$NON-NLS-4$ //$NON-NLS-3$ //$NON-NLS-2$ //$NON-NLS-1$
        "getClass", //$NON-NLS-5$ //$NON-NLS-4$ //$NON-NLS-3$ //$NON-NLS-2$ //$NON-NLS-1$
        "getClass", //$NON-NLS-5$ //$NON-NLS-4$ //$NON-NLS-3$ //$NON-NLS-2$ //$NON-NLS-1$
        "hashCode", //$NON-NLS-5$ //$NON-NLS-4$ //$NON-NLS-3$ //$NON-NLS-2$ //$NON-NLS-1$
        "notify", "notifyAll", "wait", "wait", //$NON-NLS-4$ //$NON-NLS-3$ //$NON-NLS-2$ //$NON-NLS-1$
        "wait" };
        String[][] specialParamTypes = new String[][] { noParams, noParams, noParams, noParams, //$NON-NLS-2$ //$NON-NLS-1$
        { "QObject;" }, //$NON-NLS-2$ //$NON-NLS-1$
        { "Qjava.lang.Object;" }, //$NON-NLS-2$ //$NON-NLS-1$
        noParams, //$NON-NLS-2$ //$NON-NLS-1$
        noParams, noParams, noParams, noParams, { Signature.SIG_LONG, Signature.SIG_INT }, { Signature.SIG_LONG }, noParams };
        String[] specialReturnTypes = new String[] { //$NON-NLS-4$ //$NON-NLS-3$ //$NON-NLS-2$ //$NON-NLS-1$
        "QString;", //$NON-NLS-4$ //$NON-NLS-3$ //$NON-NLS-2$ //$NON-NLS-1$
        "QString;", //$NON-NLS-4$ //$NON-NLS-3$ //$NON-NLS-2$ //$NON-NLS-1$
        "Qjava.lang.String;", //$NON-NLS-4$ //$NON-NLS-3$ //$NON-NLS-2$ //$NON-NLS-1$
        "Qjava.lang.String;", //$NON-NLS-2$ //$NON-NLS-1$
        Signature.SIG_BOOLEAN, //$NON-NLS-2$ //$NON-NLS-1$
        Signature.SIG_BOOLEAN, //$NON-NLS-2$ //$NON-NLS-1$
        "QClass;", //$NON-NLS-2$ //$NON-NLS-1$
        "Qjava.lang.Class;", Signature.SIG_INT, Signature.SIG_VOID, Signature.SIG_VOID, Signature.SIG_VOID, Signature.SIG_VOID, Signature.SIG_VOID };
        Assert.isTrue((specialNames.length == specialParamTypes.length) && (specialParamTypes.length == specialReturnTypes.length));
        for (int i = 0; i < specialNames.length; i++) {
            if (specialNames[i].equals(getNewElementName()) && Checks.compareParamTypes(getMethod().getParameterTypes(), specialParamTypes[i]) && !specialReturnTypes[i].equals(getMethod().getReturnType())) {
                return true;
            }
        }
        return false;
    ...
    private boolean classesDeclareOverridingNativeMethod(IType[] classes) throws CoreException {
        for (int i = 0; i < classes.length; i++) {
            ...
            for (int j = 0; j < methods.length; j++) {
                if ((!methods[j].equals(getMethod())) && (JdtFlags.isNative(methods[j])) && (null != Checks.findSimilarMethod(getMethod(), new IMethod[] { methods[j] })))
                    return true;
            }
        }
        return false;
