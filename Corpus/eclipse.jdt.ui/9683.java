...
public class JspUIPlugin extends AbstractUIPlugin implements IResourceChangeListener {
	 ...
	 */
    //$NON-NLS-1$
    public static final String ID_PLUGIN = "org.eclipse.jdt.ui.examples.javafamily";
        ...
        if (fgJSPIndexingIsEnabled != enable) {
            ...
            if (enable) {
                ...
                try {
                    ...
                    log("visiting jsp files", e);
                }
                workspace.addResourceChangeListener(this, //					IResourceChangeEvent.POST_AUTO_BUILD |
    ...
    public void resourceChanged(IResourceChangeEvent event) {
        ...
        try {
            ...
            log("processing resource delta", e);
        }
    }
