...
public class PropertiesFileAutoEditStrategyTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        try {
            ...
            fAccessorPropertiesFileAutoEditStrategyISO_8859_1 = new Accessor("org.eclipse.jdt.internal.ui.propertiesfileeditor.PropertiesFileAutoEditStrategy", getClass().getClassLoader(), new Class[] { IFile.class, ISourceViewer.class }, new Object[] { fPropertiesFileISO_8859_1, null });
            fAccessorPropertiesFileUTF8 = new Accessor("org.eclipse.jdt.internal.ui.propertiesfileeditor.PropertiesFileAutoEditStrategy", getClass().getClassLoader(), new Class[] { IFile.class, ISourceViewer.class }, new Object[] { fPropertiesFileUTF8, null });
    ...
    private String getProposalText(Object proposal) {
        ...
        proposalInfo = proposalInfo.substring(5, proposalInfo.length() - 6);
        return proposalInfo;
    }
    ...
    public void testPasteUTF8_04() throws Exception {
        fDocumentCommand.text = "? \\u0905";
        Object proposal = performTestUTF8();
        assertEquals("? \\u0905", fDocumentCommand.text);
        assertNull(proposal);
    }
