...
public class TypeInfoTest extends TestCase {
    ...
    public void test1() throws Exception {
        ...
        engine.searchAllTypeNames(null, 0, new char[] { 'V' }, SearchPattern.R_PREFIX_MATCH, IJavaSearchConstants.TYPE, scope, requestor, IJavaSearchConstants.WAIT_UNTIL_READY_TO_SEARCH, null);
    ...
    public void test2() throws Exception {
        ...
        TypeNameMatchRequestor requestor = new TypeNameMatchCollector(result);
        SearchEngine engine = new SearchEngine();
        engine.searchAllTypeNames(null, 0, new char[] { 'T' }, SearchPattern.R_PREFIX_MATCH, IJavaSearchConstants.TYPE, scope, requestor, IJavaSearchConstants.WAIT_UNTIL_READY_TO_SEARCH, null);
    ...
    public void test_bug44772() throws Exception {
        ...
        // as internal
        JavaProjectHelper.addLibraryWithImport(fJProject1, Path.fromOSString(lib.getPath()), null, null);
        // and as external
        JavaProjectHelper.addLibrary(fJProject1, Path.fromOSString(lib.getPath()));
        ArrayList<TypeNameMatch> result = new ArrayList();
        IJavaElement[] elements = new IJavaElement[] { fJProject1 };
        IJavaSearchScope scope = SearchEngine.createJavaSearchScope(elements);
        TypeNameMatchRequestor requestor = new TypeNameMatchCollector(result);
        SearchEngine engine = new SearchEngine();
        engine.searchAllTypeNames(null, 0, "Foo".toCharArray(), SearchPattern.R_EXACT_MATCH | SearchPattern.R_CASE_SENSITIVE, IJavaSearchConstants.TYPE, scope, requestor, IJavaSearchConstants.WAIT_UNTIL_READY_TO_SEARCH, null);
