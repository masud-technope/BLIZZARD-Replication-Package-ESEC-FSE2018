...
public class RenameJavaProjectTests extends RefactoringTest {
    ...
    public void test0() throws Exception {
        ...
        try {
            ...
            ParticipantTesting.testRename(handles, new RenameArguments[] { new RenameArguments(newProjectName, true), new RenameArguments(newProjectName, true) });
    ...
    public void test1() throws Exception {
        ...
        try {
            ...
            JavaProjectHelper.addSourceContainer(referencing1, "src");
            JavaProjectHelper.addRTJar(referencing2);
            IAccessRule[] accessRules2 = new IAccessRule[] { JavaCore.newAccessRule(new Path("accessible"), IAccessRule.K_ACCESSIBLE) };
            IClasspathAttribute[] extraAttributes2 = new IClasspathAttribute[] { JavaCore.newClasspathAttribute("myTestAttribute", "val") };
