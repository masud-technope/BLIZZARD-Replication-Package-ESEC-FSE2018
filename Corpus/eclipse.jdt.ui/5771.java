...
class PackageSelectionStringButtonAdapter implements IStringButtonAdapter {
    ...
    public void changeControlPressed(DialogField field) {
        ...
        ElementListSelectionDialog dialog = new ElementListSelectionDialog(field.getLabelControl(null).getShell(), new JavaElementLabelProvider(JavaElementLabelProvider.SHOW_DEFAULT));
