...
public class AppearancePreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
    ...
    private IStatus getValidationStatus() {
        if (fAbbreviatePackageNames.isSelected() && JavaElementLabelComposer.parseAbbreviationPattern(fAbbreviatePackageNamePattern.getText()) == null) {
        ...
        if (//$NON-NLS-1$
        fCompressPackageNames.isSelected() && fPackageNamePattern.getText().equals(""))
