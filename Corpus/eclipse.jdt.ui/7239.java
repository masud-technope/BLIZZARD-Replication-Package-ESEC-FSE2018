...
public class JUnitLaunchConfigurationConstants {
    ...
    //$NON-NLS-1$
    public static final String ATTR_NO_DISPLAY = JUnitCorePlugin.PLUGIN_ID + ".NO_DISPLAY";

    //$NON-NLS-1$
    public static final String ATTR_PORT = JUnitCorePlugin.PLUGIN_ID + ".PORT";

    /**
	 * The test name, or "" iff running the whole test type.
	 */
    //$NON-NLS-1$
    public static final String ATTR_TEST_NAME = JUnitCorePlugin.PLUGIN_ID + ".TESTNAME";
    ...
    //$NON-NLS-1$
    public static final String ATTR_FAILURES_NAMES = JUnitCorePlugin.PLUGIN_ID + ".FAILURENAMES";
