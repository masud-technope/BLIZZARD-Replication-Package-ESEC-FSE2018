...
public class MethodOverrideTest extends CoreTests {
    ...
    public void testOverride0() throws Exception {
        ...
        // C and B
        doOverrideTests(cu, 2, 2, 1);
        // C and A
        doOverrideTests(cu, 2, 2, 0);
        // B and A
        doOverrideTests(cu, 2, 1, 0);
    }
    ...
    protected void doOverrideTests(CompilationUnit root, IType focusType, IType overridingType, ITypeBinding overridingTypeBinding, IType overriddenType, ITypeBinding overriddenTypeBinding) throws JavaModelException {
        ...
        for (int i = 0; i < overridingMethods.length; i++) {
            ...
            if (overrideAnnotation == null) {
                // only look at methods with the override annotation
                continue;
            }
            ...
            if (DEBUG_SHOWRESULTS) {
                ...
                if (testerOverrides != overrideAnnotationResult || testerOverrides != bindingOverrides || testerOverrides != bindingIsSubsignature || testerOverrides != uiBindingsIsSubsignature) {
                    System.out.println();
                    System.out.println("====================================");
