...
public class FastJavaPartitionScanner implements IPartitionTokenScanner, IJavaPartitions {
    ...
    // prefix for SINGLE_LINE or MULTI_LINE or JAVADOC
    private static final int SLASH = 2;

    // prefix for MULTI_LINE_COMMENT or JAVADOC
    private static final int SLASH_STAR = 3;

    // prefix for MULTI_LINE_COMMENT or JAVADOC
    private static final int SLASH_STAR_STAR = 4;

    // postfix for MULTI_LINE_COMMENT or JAVADOC
    ...
    private final IToken[] fTokens = new IToken[] { new Token(null), new Token(JAVA_SINGLE_LINE_COMMENT), new Token(JAVA_MULTI_LINE_COMMENT), new Token(JAVA_DOC), new Token(JAVA_CHARACTER), new Token(JAVA_STRING) };
