...
public class TypeFilterPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
    ...
    public  TypeFilterPreferencePage() {
        ...
        String[] buttonLabels = new String[] { PreferencesMessages.TypeFilterPreferencePage_add_button, PreferencesMessages.TypeFilterPreferencePage_addpackage_button, PreferencesMessages.TypeFilterPreferencePage_edit_button, PreferencesMessages.TypeFilterPreferencePage_remove_button, /* 4 */
        null, PreferencesMessages.TypeFilterPreferencePage_selectall_button, PreferencesMessages.TypeFilterPreferencePage_deselectall_button };
    ...
    private void doButtonPressed(int index) {
        ...
        } else if (// add packages
        index == IDX_ADD_PACKAGE) {
    ...
    private String[] choosePackage() {
        ...
        if (dialog.open() == IDialogConstants.OK_ID) {
            ...
            for (int i = 0; i < res.length; i++) {
                res[i] = //$NON-NLS-1$
                ((IPackageFragment) fragments[i]).getElementName() + //$NON-NLS-1$
                ".*";
            }
            return res;
        }
