...
public class TodoTaskConfigurationBlock extends OptionsConfigurationBlock {
    ...
    private class TodoTaskLabelProvider extends LabelProvider implements ITableLabelProvider, IFontProvider {
        ...
        public Image getImage(Object element) {
            // JavaPluginImages.get(JavaPluginImages.IMG_OBJS_REFACTORING_INFO);
            return null;
        }
    ...
    private static Key[] getKeys() {
        return new Key[] { PREF_COMPILER_TASK_TAGS, PREF_COMPILER_TASK_PRIORITIES, PREF_COMPILER_TASK_CASE_SENSITIVE };
    }
    ...
    protected void validateSettings(Key changedKey, String oldValue, String newValue) {
        ...
        //StatusUtil.getMostSevere(new IStatus[] { fTaskTagsStatus });
        IStatus status = fTaskTagsStatus;
