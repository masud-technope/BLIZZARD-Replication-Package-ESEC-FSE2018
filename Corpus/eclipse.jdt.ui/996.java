...
public class FilterDescriptor implements Comparable<FilterDescriptor>, IPluginContribution {
    ...
    private  FilterDescriptor(IConfigurationElement element) {
        ...
        //$NON-NLS-1$
        Assert.isTrue(isPatternFilter() ^ isCustomFilter(), "An extension for extension-point org.eclipse.jdt.ui.javaElementFilters does not specify a correct filter");
        //$NON-NLS-1$
        Assert.isNotNull(getId(), "An extension for extension-point org.eclipse.jdt.ui.javaElementFilters does not provide a valid ID");
        //$NON-NLS-1$
        Assert.isNotNull(getName(), "An extension for extension-point org.eclipse.jdt.ui.javaElementFilters does not provide a valid name");
    }
