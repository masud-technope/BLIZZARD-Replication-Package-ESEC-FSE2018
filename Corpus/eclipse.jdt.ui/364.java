...
public class NewVariableCorrectionProposal extends LinkedCorrectionProposal {
    ...
    protected ASTRewrite getRewrite() throws CoreException {
        ...
        switch(fVariableKind) {
            ...
            default:
                ...
                "Unsupported variable kind: " + fVariableKind);
        }
    }
    ...
    private ASTRewrite doAddParam(CompilationUnit cu) {
        ...
        if (decl instanceof MethodDeclaration) {
            ...
            if (javadoc != null) {
                ...
                rewrite.track(commentStart), //$NON-NLS-1$
                false, //$NON-NLS-1$
                "comment_start");
    ...
    private ASTRewrite doAddLocal(CompilationUnit cu) {
        ...
        while (// parent must be if, for or while
        list == null && statement.getParent() instanceof Statement) {
