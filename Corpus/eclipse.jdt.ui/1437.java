...
public class FilterTextControl {
	 ...
	 */
    private static ImageDescriptor fgClearIconDescriptor = AbstractUIPlugin.imageDescriptorFromPlugin(PlatformUI.PLUGIN_ID, //$NON-NLS-1$
    "$nl$/icons/full/etool16/clear_co.png");

    /**
	 * Image descriptor for disabled clear button.
	 */
    private static ImageDescriptor fgDisabledClearIconDescriptor = AbstractUIPlugin.imageDescriptorFromPlugin(PlatformUI.PLUGIN_ID, //$NON-NLS-1$
