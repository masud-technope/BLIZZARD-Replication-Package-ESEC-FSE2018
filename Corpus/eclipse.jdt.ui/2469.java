    ...
    private static class DeleteInputPage extends MessageWizardPage {
        ...
        protected String getMessageString() {
            ...
            try {
                ...
                if (e.isDoesNotExist())
                    return 1 == numberOfSelectedElements ? RefactoringMessages.DeleteWizard_12_singular : Messages.format(RefactoringMessages.DeleteWizard_12_plural, String.valueOf(numberOfSelectedElements));
        ...
        private String createConfirmationStringForOneElement() throws JavaModelException {
            ...
            if (elements.length == 1) {
                ...
                if (//checked before that this will work
                isLinked(getSelectedResources()[0]))
