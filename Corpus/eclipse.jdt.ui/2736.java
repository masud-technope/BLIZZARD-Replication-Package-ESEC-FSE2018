...
public class TemplateProposal implements IJavaCompletionProposal, ICompletionProposalExtension2, ICompletionProposalExtension3, ICompletionProposalExtension4, ICompletionProposalExtension6, ICompletionProposalExtension7 {
    ...
    public String getAdditionalProposalInfo() {
        try {
            ...
            handleException(JavaPlugin.getActiveWorkbenchShell(), new CoreException(new Status(IStatus.ERROR, JavaPlugin.getPluginId(), IStatus.OK, "", e)));
            return null;
        }
    }
    ...
    public boolean validate(IDocument document, int offset, DocumentEvent event) {
        try {
            ...
            if (offset >= replaceOffset) {
                ...
                if (//$NON-NLS-1$
                !valid && fContext instanceof JavaDocContext && templateName.startsWith("<")) {
