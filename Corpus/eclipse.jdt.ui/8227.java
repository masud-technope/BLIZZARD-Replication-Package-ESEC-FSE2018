...
public class RefactorActionGroup extends ActionGroup {
    ...
    public  RefactorActionGroup(JavaEditor editor, String groupName, boolean binary) {
        ...
        if (!fBinary) {
            ...
            //$NON-NLS-1$
            editor.setAction("ConvertAnonymousToNested", fConvertAnonymousToNestedAction);
            ...
            //$NON-NLS-1$
            editor.setAction("PushDown", fPushDownAction);
            ...
            //$NON-NLS-1$
            editor.setAction("ExtractClass", fExtractClassAction);
            ...
            //$NON-NLS-1$
            editor.setAction("ChangeType", fChangeTypeAction);
            ...
            //$NON-NLS-1$
            editor.setAction("IntroduceParameterObjectAction", fIntroduceParameterObjectAction);
        }
        ...
        //$NON-NLS-1$
        editor.setAction("IntroduceIndirection", fIntroduceIndirectionAction);
