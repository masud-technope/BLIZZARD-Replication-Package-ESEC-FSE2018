...
public class SimpleLineReader {
    ...
    public String readLine() {
        ...
        try {
            ...
            boolean continuesOnNext = content.endsWith("\\") && !isCommentOrWhiteSpace(content);
            while (continuesOnNext && fCurrLine < nLines) {
                ...
                continuesOnNext = content.endsWith("\\") && !isCommentOrWhiteSpace(content);
            }
            int end;
            if (fCurrLine < nLines) {
                end = fInput.getLineOffset(fCurrLine);
            } else {
