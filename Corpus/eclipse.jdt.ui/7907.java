...
public class NewTestCaseWizardPageTwo extends WizardPage {
    ...
    //$NON-NLS-1$
    private static final String STORE_USE_TASKMARKER = PAGE_NAME + ".USE_TASKMARKER";

    //$NON-NLS-1$
    private static final String STORE_CREATE_FINAL_METHOD_STUBS = PAGE_NAME + ".CREATE_FINAL_METHOD_STUBS";
        ...
        fMethodsTree.addFilter(new ViewerFilter() {
            ...
            public boolean select(Viewer viewer, Object parentElement, Object element) {
                if (element instanceof IMethod) {
                    ...
                    return !//$NON-NLS-1$
                    method.getElementName().equals(//$NON-NLS-1$
                    "<clinit>");
                }
                return true;
            }
            ...
            for (int i = types.length - 1; i > -1; i--) {
                ...
                if (object instanceof IType) {
                    ...
                    try {
                        ...
                        for_currMethods: for (int j = 0; j < currMethods.length; j++) {
