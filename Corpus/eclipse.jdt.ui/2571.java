...
public class TypeParametersCleanUp extends AbstractMultiFix {
    ...
    protected ICleanUpFix createFix(CompilationUnit compilationUnit) throws CoreException {
        if (compilationUnit == null)
            return null;
        return TypeParametersFix.createCleanUp(compilationUnit, isEnabled(CleanUpConstants.INSERT_INFERRED_TYPE_ARGUMENTS), isEnabled(CleanUpConstants.REMOVE_REDUNDANT_TYPE_ARGUMENTS));
    }
    ...
    protected ICleanUpFix createFix(CompilationUnit compilationUnit, IProblemLocation[] problems) throws CoreException {
        if (compilationUnit == null)
            return null;
        return TypeParametersFix.createCleanUp(compilationUnit, problems, isEnabled(CleanUpConstants.INSERT_INFERRED_TYPE_ARGUMENTS), isEnabled(CleanUpConstants.REMOVE_REDUNDANT_TYPE_ARGUMENTS));
    }
