...
public class CustomBuilderGenerator extends AbstractToStringGenerator {
    ...
    private final List<String> primitiveTypes = Arrays.asList(new String[] { "byte", "short", "char", "int", "long", "float", "double", "boolean" });

    private final String[] wrapperTypes = new String[] { //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$
    "java.lang.Byte", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$
    "java.lang.Short", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$
    "java.lang.Character", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$
    "java.lang.Integer", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$
    "java.lang.Long", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$
    "java.lang.Float", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$
            ...
            for (int i = 0; i < types.length; i++) {
                ...
                for (int j = 0; j < methods.length; j++) {
                    ...
                    if (parameterTypes.length == 1) {
                        ...
                        if (//$NON-NLS-1$
                        resolvedParameterTypeName1.equals(//$NON-NLS-1$
                        "java.lang.String")) {
                            specyficType = resolvedParameterTypeName2;
                            appendMethodInformation.methodType = 3;
                        } else if (//$NON-NLS-1$
                        resolvedParameterTypeName2.equals(//$NON-NLS-1$
                        "java.lang.String")) {
    ...
    private void tidyAppendsMethodsMap() {
        //$NON-NLS-1$
        int objectParametersType = appendMethodSpecificTypes.get("java.lang.Object").methodType;
    ...
    private MethodInvocation createAppendMethodForMember(Object member) {
        ...
        while (ami == null) {
            ...
            if (memberType != null)
                ...
                memberTypeName = "java.lang.Object";
            ami = appendMethodSpecificTypes.get(memberTypeName);
        }
