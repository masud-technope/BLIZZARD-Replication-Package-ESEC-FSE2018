...
public class BindingLabels18Test extends AbstractBindingLabelsTest {
    ...
    public void testMethodLabelPolymorphicSignatureDeclaration() throws Exception {
        ...
        IMethod invokeExact = methodHandle.getMethod("invokeExact", new String[] { Signature.createArraySignature(Signature.createTypeSignature("java.lang.Object", true), 1) });
    ...
    public void testTypeLabelLambda1() throws Exception {
        ...
        lab = getBindingLabel(lambdaMethod, JavaElementLabels.T_FULLY_QUALIFIED | JavaElementLabels.M_POST_QUALIFIED | JavaElementLabels.M_PARAMETER_TYPES | JavaElementLabels.M_PARAMETER_NAMES);
    ...
    public void testLambdaInAnonymousClass1() throws Exception {
        ...
        assertLinkMatch(lab, "{{org.test.C}}.{{org.test.C|t}}.{{org.test.C.t|new Thread() {...}}}.{{org.test.C.t.new Thread() {...}|run}}()." + "() -> {...} {{java.util.function|Consumer}}.{{java.util.function.Consumer<java.lang.String>|accept}}({{java.lang|String}}).s");
        ...
        assertLinkMatch(lab, "{{java.lang|String}} s - {{org.test.C}}.{{org.test.C|t}}.{{org.test.C.t|new Thread() {...}}}.{{org.test.C.t.new Thread() {...}|run}}()." + "() -> {...} {{java.util.function|Consumer}}.{{java.util.function.Consumer|accept}}({{java.util.function.Consumer|T}})");
    }
