...
public class MarkOccurrenceTest17 extends TestCase {
    ...
    public void testMarkMethodExits6() throws Exception {
        ...
        int offset = 1 + s.indexOf("void");
        int length = 0;
        OccurrenceLocation[] ranges = { find(s, "void", 1), find(s, "reader1", 1), find(s, "FileReader", 3), find(s, "reader2", 1), find(s, "FileReader", 5), find(s, "reader3", 1), find(s, "FileReader", 7), find(s, "read", 5), find(s, "}", 2), find(s, "}", 3) };
        checkSelection(s, offset, length, ranges);
    }
    ...
    public void testThrowingException1() throws Exception {
        ...
        s.append("}\n");
        //middle of word
        int offset = 1 + s.indexOf("NullPointerException e");
        int length = 0;
    ...
    public void testThrowingException2() throws Exception {
        ...
        s.append("}\n");
        //middle of word
        int offset = 1 + s.indexOf("NullPointerException | ");
        int length = 0;
        OccurrenceLocation[] ranges = { find(s, "throw", 2), find(s, "NullPointerException", 2) };
        checkSelection(s, offset, length, ranges);
    }
    ...
    public void testThrowingException3() throws Exception {
        ...
        s.append("}\n");
        //middle of word
        int offset = 1 + s.indexOf("FileNotFoundException e");
        int length = 0;
    ...
    public void testThrowingException4() throws Exception {
        ...
        s.append("}\n");
        //middle of word
        int offset = 1 + s.indexOf("IOException e");
        int length = 0;
    ...
    public void testThrowingException5() throws Exception {
        ...
        int offset = 1 + s.indexOf("IOException e");
        int length = 0;
        OccurrenceLocation[] ranges = { find(s, "IOException", 2), find(s, "FileReader", 3), find(s, "FileReader", 5), find(s, "FileReader", 7), find(s, "read", 5), find(s, "}", 2), find(s, "reader1", 1), find(s, "reader2", 1), find(s, "reader3", 1) };
        checkSelection(s, offset, length, ranges);
    }
    ...
    public void testThrowingException6() throws Exception {
        ...
        s.append("}\n");
        //middle of word
        int offset = 1 + s.indexOf("Throwable");
        int length = 0;
        OccurrenceLocation[] ranges = { find(s, "Throwable", 1), find(s, "reader1", 1), find(s, "FileReader", 3), find(s, "reader2", 1), find(s, "FileReader", 5), find(s, "reader3", 1), find(s, "FileReader", 7), find(s, "read", 5), find(s, "}", 2) };
        checkSelection(s, offset, length, ranges);
    }
    ...
    public void testThrowingException7() throws Exception {
        ...
        s.append("}\n");
        //middle of word
        int offset = 1 + s.indexOf("Exception {");
        int length = 0;
    ...
    public void testThrowingException8() throws Exception {
        ...
        s.append("}\n");
        //middle of word
        int offset = 1 + s.indexOf("Exception e1");
        int length = 0;
