...
public class TestTestSearchEngine extends TestCase {
    ...
    public void testOnePackage() throws Exception {
        ...
        assertEqualTypes("Test case not found", new IType[] { test1.getType("Test1"), test2.getType("Test2") }, result);
    }
    ...
    public void testTwoPackages() throws Exception {
        ...
        assertEqualTypes("Test case not found", new IType[] { test1.getType("Test1"), test2.getType("Test2"), test3.getType("Test3") }, result);
    }
    ...
    public void testTwoPackageFragmentRoots() throws Exception {
        ...
        assertEqualTypes("Test case not found", new IType[] { test1.getType("Test1"), test2.getType("Test2"), test3.getType("Test3"), test4.getType("Test4"), test5.getType("Test5") }, result);
    }
    ...
    public void testTwoPackageFragmentRootsSearchingInOne() throws Exception {
        ...
        assertEqualTypes("Test case not found", new IType[] { test4.getType("Test4"), test5.getType("Test5") }, result);
    }
    ...
    public void testTwoPackageFragmentRootsSearchingInOneNoSupertype() throws Exception {
        ...
        IPackageFragmentRoot root2 = JavaProjectHelper.addSourceContainer(fProject, "tests");
        IPackageFragment r = root2.createPackageFragment("r", true, null);
        ICompilationUnit testSub = r.createCompilationUnit("TestSub.java", "package r; import p.Test1; public class TestSub extends Test1 { }", true, null);
        IType[] result = findTests(root2);
    ...
    public void testSubPackage() throws Exception {
        ...
        IType[] result = findTests(p);
        assertEqualTypes("Test case not found", new IType[] { test1.getType("Test1") }, result);
    }
    ...
    private ICompilationUnit createCompilationUnit(IPackageFragment pack, int number) throws JavaModelException {
        return pack.createCompilationUnit("Test" + number + ".java", "package " + pack.getElementName() + "; import junit.framework.TestCase; public class Test" + number + " extends TestCase { }", true, null);
    }
