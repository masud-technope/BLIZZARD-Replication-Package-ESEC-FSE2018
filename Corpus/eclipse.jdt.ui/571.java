...
public class IntroduceIndirectionPerfAcceptanceTests extends RefactoringPerformanceTestCase {
    ...
    public static Test suite() {
        OrderedTestSuite suite = new OrderedTestSuite(IntroduceIndirectionPerfAcceptanceTests.class, new String[] { "testIntroduceIndirection" });
    ...
    protected void setUp() throws Exception {
        super.setUp();
        fProject = (IJavaProject) JavaCore.create(ResourcesPlugin.getWorkspace().getRoot().findMember(SWTTestProject.PROJECT));
