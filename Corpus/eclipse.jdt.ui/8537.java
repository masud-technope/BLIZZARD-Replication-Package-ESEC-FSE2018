...
public class GenerateConstructorUsingFieldsTest extends SourceTestCase {
    ...
    private IMethodBinding getObjectConstructor(CompilationUnit compilationUnit) {
        //$NON-NLS-1$
        final ITypeBinding binding = compilationUnit.getAST().resolveWellKnownType("java.lang.Object");
        //$NON-NLS-1$
    ...
    private void runIt(String topLevelTypeName, String[] fieldNames, IMethod superConstructor, String source, String destination) throws Exception {
        ...
        for (int i = 0; i < fieldNames.length; i++) fields[i] = type.getField(fieldNames[i]);
    ...
    public void test13() throws Exception {
        ...
        runIt("A", new String[] { "field" }, superConstructor, "package p;\r\n" + "\r\n" + "public class A extends SuperA {\r\n" + "	String field;\r\n" + "}\r\n" + "", "package p;\r\n" + "\r\n" + "import java.util.Map;\r\n" + "\r\n" + "public class A extends SuperA {\r\n" + "	String field;\r\n" + "\r\n" + "	/**\r\n" + "	 * @param someMap\r\n" + "	 * @param field\r\n" + "	 */\r\n" + "	public A(Map<String, A> someMap, String field) {\r\n" + "		super(someMap);\r\n" + "		this.field = field;\r\n" + "	}\r\n" + "}");
    }
    ...
    public void test15() throws Exception {
        ICompilationUnit unit = fPackageP.createCompilationUnit("A.java", "package p;\r\n" + "\r\n" + "public class A  {\r\n" + "}\r\n" + "\r\n" + "class B {\r\n" + "	A foo;\r\n" + "}", true, null);
        // get secondary type
        IType secondary = (IType) unit.getElementAt(40);
