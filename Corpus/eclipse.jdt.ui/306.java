...
public class ExtractConstantTests extends RefactoringTest {
    ...
    //XXX: [1.8][compiler] Bad syntax error 'insert ":: IdentifierOrNew"' for missing semicolon
    private static final boolean BUG_405780 = true;
    ...
    public //bug 104293
    void test31() throws //bug 104293
    Exception {
        helper1(9, 32, 9, 44, true, false, "AS_LIST", "AS_LIST");
    }

    public //bug 104293
    void test32() throws //bug 104293
    Exception {
        helper1(7, 20, 7, 35, true, false, "STRING", "STRING");
    }

    public //bug 108354
    void test33() throws //bug 108354
    Exception {
        helper1(7, 20, 7, 35, true, false, "STRING", "STRING");
    }

    public // syntax error
    void test34() throws // syntax error
    Exception {
        if (BUG_405780)
            return;
        helper1(7, 20, 7, 35, true, false, "STRING", "STRING");
