...
public class PackagesViewDeltaTests extends TestCase {
    ...
    public void testRemoveTopLevelFragmentNotLogicalPackage() throws Exception {
        ...
        fMyPart.pushDisplay();
        //$NON-NLS-1$
        assertTrue("Remove happened", fMyPart.hasRemoveHappened());
        //$NON-NLS-1$
        assertTrue("Correct package removed", fMyPart.getRemovedObject().contains(fPack12));
    }
    ...
    public void testRemoveBottomLevelFragmentNotLogicalPackage() throws Exception {
        ...
        fMyPart.pushDisplay();
        //$NON-NLS-1$
        assertTrue("No remove happened, in Logical Package", !fMyPart.hasRemoveHappened());
    }
    ...
    public void testRemoveFragmentInMultiFragmentLogicalPackage() throws Exception {
        ...
        //$NON-NLS-1$
        assertTrue("Refresh happened", !fMyPart.hasRemoveHappened() && !fMyPart.hasRefreshHappened());
        //test life cycle of Logical Package
        Object parent = fProvider.getParent(ChildCp1);
        if (!(parent instanceof LogicalPackage)) {
            //$NON-NLS-1$
            assertTrue("wrong parent found for logical package after remove", false);
        }
        LogicalPackage lp = (LogicalPackage) parent;
        //$NON-NLS-1$
        assertTrue("PackageFragment removed from logical package", lp.equals(expectedParent));
    }
    ...
    public void testRemoveBottomLevelFragmentInMultiFragmentLogicalPackage() throws Exception {
        ...
        //$NON-NLS-1$
        assertTrue("Refresh happened", !fMyPart.hasRefreshHappened() && !fMyPart.hasRemoveHappened());
        ...
        //$NON-NLS-1$
        assertTrue("PackageFragment removed from logical package", lp.equals(expectedChild));
    }
    ...
    public void testRemoveFragmentInTwoFragmentLogicalPackage() throws Exception {
        ...
        //$NON-NLS-1$
        assertTrue("Refresh happened", fMyPart.hasRemoveHappened() && fMyPart.hasAddHappened());
        Object addedObject = fMyPart.getAddedObject().get(0);
        Object removedObject = fMyPart.getRemovedObject().get(0);
        //$NON-NLS-1$
        assertTrue("Correct guy removed", cp10.equals(removedObject));
        //$NON-NLS-1$
        assertTrue("Correct guy added", fInternalPack10.equals(addedObject));
        //assert correct children gotten
        Object[] children = fProvider.getChildren(ParentCp4);
        //$NON-NLS-1$
        assertTrue("PackageFragment removed from logial package", compareArrays(children, new Object[] { fPack91, fInternalPack10 }));
    }
    ...
    public void testAddTopLevelFragmentNotLogicalPackage() throws Exception {
        ...
        fMyPart.clear();
        //$NON-NLS-1$
        IPackageFragment test = fRoot1.createPackageFragment("pack3.test", true, null);
        IElementChangedListener listener = (IElementChangedListener) fProvider;
        ...
        fMyPart.pushDisplay();
        //$NON-NLS-1$
        assertTrue("Add happened", fMyPart.hasAddHappened());
        //$NON-NLS-1$
        assertTrue("Correct package added", fMyPart.getAddedObject().contains(test));
    }
    ...
    public void testAddFragmentToLogicalPackage() throws Exception {
        ...
        //send delta
        //$NON-NLS-1$
        IPackageFragment pack101 = fRoot1.createPackageFragment("pack3.pack4.pack10", true, null);
        IElementChangedListener listener = (IElementChangedListener) fProvider;
        ...
        //$NON-NLS-1$
        assertTrue("Refresh did not happened", !fMyPart.hasRefreshHappened());
    }
    ...
    public void testAddCUFromFragmentNotLogicalPackageVisible() throws Exception {
        ...
        cp3.add(fInternalPack3);
        //$NON-NLS-1$//$NON-NLS-2$
        ICompilationUnit cu = fPack81.createCompilationUnit("Object.java", "", true, null);
        //initialise Map
        fMyPart.fViewer.setInput(fJProject);
        fProvider.getChildren(cp3);
        ...
        //$NON-NLS-1$
        assertTrue("Correct package refreshed", fMyPart.getRefreshedObject().contains(fPack81));
        //$NON-NLS-1$
        assertEquals("Correct number of refreshes", 1, fMyPart.getRefreshedObject().size());
    }
    ...
    public void testAddCUFromFragmentNotLogicalPackageNotVisible() throws Exception {
        ...
        assertTrue("Refresh happened", fMyPart.hasRefreshHappened());
        //$NON-NLS-1$
        assertTrue("Correct package refreshed", fMyPart.getRefreshedObject().contains(cp3));
        //$NON-NLS-1$
        assertEquals("Correct number of refreshes", 1, fMyPart.getRefreshedObject().size());
    }
    ...
    public void testAddBottomLevelFragmentNotLogicalPackage() throws Exception {
        ...
        fMyPart.clear();
        //$NON-NLS-1$
        IPackageFragment test = fRoot1.createPackageFragment("pack3.pack5.test", true, null);
        IElementChangedListener listener = (IElementChangedListener) fProvider;
        IJavaElementDelta delta = new TestDelta(IJavaElementDelta.ADDED, test);
        listener.elementChanged(new ElementChangedEvent(delta, ElementChangedEvent.POST_CHANGE));
        //force events from display
        ...
        assertTrue("Add happened", fMyPart.hasAddHappened());
        //$NON-NLS-1$
        assertTrue("Corrent package added", fMyPart.getAddedObject().contains(test));
    }
    ...
    protected void setUp() throws Exception {
        ...
        //------------set up project ------------------------------
        //$NON-NLS-1$//$NON-NLS-2$
        fJProject = JavaProjectHelper.createJavaProject("TestProject2", "bin");
        //$NON-NLS-1$
        ...
        //$NON-NLS-1$
        fInternalJarRoot.getPackageFragment("");
        //$NON-NLS-1$
        ...
        //$NON-NLS-1$
        fInternalPack6 = fInternalJarRoot.getPackageFragment("pack3.pack5.pack6");
        //$NON-NLS-1$
        fInternalPack10 = fInternalJarRoot.getPackageFragment("pack3.pack4.pack10");
        //$NON-NLS-1$
        fInternalJarRoot.getPackageFragment("meta-inf");
        //-----------------Set up source folder--------------------------
        //$NON-NLS-1$
        fRoot2 = JavaProjectHelper.addSourceContainer(fJProject, "src2");
        //$NON-NLS-1$
        fRoot2.createPackageFragment("", true, null);
        //$NON-NLS-1$
        fPack12 = fRoot2.createPackageFragment("pack1", true, null);
        //$NON-NLS-1$
        fRoot2.createPackageFragment("pack1.pack7", true, null);
        //$NON-NLS-1$
        ...
        //$NON-NLS-1$
        fPack102 = fRoot2.createPackageFragment("pack3.pack4.pack10", true, null);
        //$NON-NLS-1$//$NON-NLS-2$
        ...
        //$NON-NLS-1$//$NON-NLS-2$
        fPack52.createCompilationUnit("Object.java", "", true, null);
        //so that fPack42 won't get deleted when we delete fPack102 in certain tests
        //$NON-NLS-1$//$NON-NLS-2$
        fPack42.createCompilationUnit("Object.java", "", true, null);
        ...
        //----------------Set up source folder--------------------------
        //$NON-NLS-1$
        fRoot1 = JavaProjectHelper.addSourceContainer(fJProject, "src1");
        //$NON-NLS-1$
        fRoot1.createPackageFragment("", true, null);
        //$NON-NLS-1$
    ...
    public void setUpMockView() throws Exception {
        ...
        //$NON-NLS-1$
        IViewPart myPart = fPage.showView("org.eclipse.jdt.ui.tests.browsing.MockPluginView");
