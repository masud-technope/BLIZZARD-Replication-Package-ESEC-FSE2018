...
public class ToggleOrientationAction extends Action {
    ...
    public  ToggleOrientationAction(ITypeHierarchyViewPart v, int orientation) {
        ...
        if (orientation == ITypeHierarchyViewPart.VIEW_LAYOUT_HORIZONTAL) {
            ...
            //$NON-NLS-1$
            JavaPluginImages.setLocalImageDescriptors(this, "th_horizontal.png");
            ...
            //$NON-NLS-1$
            JavaPluginImages.setLocalImageDescriptors(this, "th_vertical.png");
            ...
            //$NON-NLS-1$
            JavaPluginImages.setLocalImageDescriptors(this, "th_automatic.png");
            ...
            //$NON-NLS-1$
            JavaPluginImages.setLocalImageDescriptors(this, "th_single.png");
        } else {
            Assert.isTrue(false);
        }
        fView = v;
