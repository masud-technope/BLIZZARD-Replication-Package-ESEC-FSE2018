 ...
 */
public final class ExtractMethodDescriptor extends JavaRefactoringDescriptor {
	 ...
	 * @since 1.2
	 */
    public  ExtractMethodDescriptor(String project, String description, String comment, Map<String, String> arguments, int flags) {
