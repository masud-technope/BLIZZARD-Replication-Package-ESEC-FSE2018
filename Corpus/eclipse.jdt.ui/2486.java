...
public class ContentProviderTests5 extends TestCase {
    ...
    public //bug 35851, 66694
    void testProjectSource1() throws //bug 35851, 66694
    Exception {
        ...
        assertEqualElements(new Object[] { defaultPackage, exclInclPackage, xPackage, zPackage, jdk, ab, excl, y, fDotClasspath, fDotProject }, fProvider.getChildren(fJProject));
    ...
    public //bug 35851, 66694
    void testNestedSource1() throws //bug 35851, 66694
    Exception {
    ...
    public //bug 35851, 66694
    void testInclExcl1() throws //bug 35851, 66694
    Exception {
