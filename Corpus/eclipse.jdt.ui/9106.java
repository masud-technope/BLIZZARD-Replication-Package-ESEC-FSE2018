...
public class BuildPathSupport {
    ...
    public static class JUnitPluginDescription {
            ...
            if (bundleInfo != null) {
                ...
                if (bestMatch != null) {
                    try {
                        ...
                        URL rootUrl = //$NON-NLS-1$
                        bestMatch.getEntry(//$NON-NLS-1$
                        "/");
        ...
        public IClasspathEntry getLibraryEntry() {
            ...
            if (bundleLocation != null) {
                ...
                String javadocLocation = //$NON-NLS-1$
                Platform.getPreferencesService().getString(//$NON-NLS-1$
                JUnitCorePlugin.CORE_PLUGIN_ID, //$NON-NLS-1$
                javadocPreferenceKey, //$NON-NLS-1$
                "", //$NON-NLS-1$
                null);
    ...
    public static final JUnitPluginDescription JUNIT3_PLUGIN = new JUnitPluginDescription("org.junit", new VersionRange("[3.8.2,3.9)"), "junit.jar", "junit.jar", "org.junit.source", "source-bundle/", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$
    JUnitPreferencesConstants.JUNIT3_JAVADOC);

    public static final JUnitPluginDescription JUNIT4_PLUGIN = new JUnitPluginDescription("org.junit", new VersionRange("[4.7.0,5.0.0)"), "junit.jar", "junit.jar", "org.junit.source", "source-bundle/", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$
    JUnitPreferencesConstants.JUNIT4_JAVADOC);

    private static final JUnitPluginDescription HAMCREST_CORE_PLUGIN = new JUnitPluginDescription("org.hamcrest.core", new VersionRange("[1.1.0,2.0.0)"), null, "org.hamcrest.core_1.*.jar", "org.hamcrest.core.source", "source-bundle/", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
    JUnitPreferencesConstants.HAMCREST_CORE_JAVADOC);

    public static final JUnitPluginDescription JUNIT4_AS_3_PLUGIN = new JUnitPluginDescription(JUNIT4_PLUGIN.bundleId, JUNIT4_PLUGIN.versionRange, JUNIT4_PLUGIN.bundleRoot, JUNIT4_PLUGIN.binaryImportedRoot, JUNIT4_PLUGIN.sourceBundleId, JUNIT4_PLUGIN.repositorySource, JUNIT3_PLUGIN.javadocPreferenceKey) {

        @Override
        public IAccessRule[] getAccessRules() {
            return new IAccessRule[] { JavaCore.newAccessRule(new Path("junit/"), //$NON-NLS-1$
            IAccessRule.K_ACCESSIBLE), JavaCore.newAccessRule(new Path("**/*"), //$NON-NLS-1$
