...
public class RefactoringUIPlugin extends AbstractUIPlugin {
    ...
    public static void log(Throwable t) {
        IStatus status = new Status(IStatus.ERROR, getPluginId(), IRefactoringUIStatusCodes.INTERNAL_ERROR, RefactoringUIMessages.RefactoringUIPlugin_internal_error, t);
    ...
    public static void logRemovedListener(Throwable t) {
        IStatus status = new Status(IStatus.ERROR, getPluginId(), IRefactoringUIStatusCodes.INTERNAL_ERROR, RefactoringUIMessages.RefactoringUIPlugin_listener_removed, t);
        ResourcesPlugin.getPlugin().getLog().log(status);
    }
