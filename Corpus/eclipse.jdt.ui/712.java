...
public final class JavaUI {
    ...
    ATTR_CMDLINE = "org.eclipse.jdt.ui.launcher.cmdLine";

    /**
	 * @deprecated Constant introduced to avoid deprecated warning
	 */
    @Deprecated
    private static final int DEPRECATED_CONSIDER_TYPES = IJavaElementSearchConstants.CONSIDER_TYPES;
    ...
    public static SelectionDialog createPackageDialog(Shell parent, IJavaProject project, int style, String filter) throws JavaModelException {
        Assert.isTrue((style | IJavaElementSearchConstants.CONSIDER_BINARIES | IJavaElementSearchConstants.CONSIDER_REQUIRED_PROJECTS) == (IJavaElementSearchConstants.CONSIDER_BINARIES | IJavaElementSearchConstants.CONSIDER_REQUIRED_PROJECTS));
    ...
    public static SelectionDialog createMainTypeDialog(Shell parent, IRunnableContext context, IJavaSearchScope scope, int style, boolean multipleSelection) {
        //$NON-NLS-1$
        return createMainTypeDialog(parent, context, scope, style, multipleSelection, "");
    }
