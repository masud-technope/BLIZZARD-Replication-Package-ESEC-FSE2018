...
public final class DefaultPhoneticHashProvider implements IPhoneticHashProvider {
    ...
    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta01 = { "ACH", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta02 = { "BACHER", "MACHER", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta03 = { "CAESAR", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta04 = { "CHIA", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta05 = { "CH", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta06 = { "CHAE", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta07 = { "HARAC", "HARIS", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
    private static final String[] meta08 = { "HOR", "HYM", "HIA", "HEM", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta09 = { "CHORE", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta10 = { "VAN ", "VON ", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta11 = { "SCH", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    private static final String[] meta12 = { "ORCHES", "ARCHIT", "ORCHID", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta13 = { "T", "S", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
    private static final String[] meta14 = { "A", "O", "U", "E", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ //$NON-NLS-9$ //$NON-NLS-10$ //$NON-NLS-11$
    private static final String[] meta15 = { "L", "R", "N", "M", "B", "H", "F", "V", "W", " ", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta16 = { "MC", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta17 = { "CZ", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta18 = { "WICZ", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta19 = { "CIA", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta20 = { "CC", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    private static final String[] meta21 = { "I", "E", "H", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta22 = { "HU", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta23 = { "UCCEE", "UCCES", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    private static final String[] meta24 = { "CK", "CG", "CQ", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    private static final String[] meta25 = { "CI", "CE", "CY", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$
    private static final String[] meta26 = { "GN", "KN", "PN", "WR", "PS", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    private static final String[] meta27 = { " C", " Q", " G", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    private static final String[] meta28 = { "C", "K", "Q", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta29 = { "CE", "CI", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta30 = { "DG", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    private static final String[] meta31 = { "I", "E", "Y", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta32 = { "DT", "DD", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    private static final String[] meta33 = { "B", "H", "D", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    private static final String[] meta34 = { "B", "H", "D", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta35 = { "B", "H", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$
    private static final String[] meta36 = { "C", "G", "L", "R", "T", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta37 = { "EY", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta38 = { "LI", "" };
    ...
    private static final String[] meta39 = { "ES", "EP", "EB", "EL", "EY", "IB", "IL", "IN", "IE", "EI", "ER", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta40 = { "ER", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    private static final String[] meta41 = { "DANGER", "RANGER", "MANGER", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta42 = { "E", "I", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta43 = { "RGY", "OGY", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    private static final String[] meta44 = { "E", "I", "Y", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta45 = { "AGGI", "OGGI", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta46 = { "VAN ", "VON ", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta47 = { "SCH", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta48 = { "ET", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta49 = { "C", "X", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta50 = { "JOSE", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta51 = { "SAN ", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta52 = { "SAN ", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta53 = { "JOSE", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$ //$NON-NLS-9$
    private static final String[] meta54 = { "L", "T", "K", "S", "N", "M", "B", "Z", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    private static final String[] meta55 = { "S", "K", "L", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    private static final String[] meta56 = { "ILLO", "ILLA", "ALLE", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta57 = { "AS", "OS", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta58 = { "A", "O", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta59 = { "ALLE", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta60 = { "UMB", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta61 = { "ER", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta62 = { "P", "B", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta63 = { "IE", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta64 = { "ME", "MA", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta65 = { "ISL", "YSL", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta66 = { "SUGAR", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta67 = { "SH", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
    private static final String[] meta68 = { "HEIM", "HOEK", "HOLM", "HOLZ", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta69 = { "SIO", "SIA", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta70 = { "SIAN", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
    private static final String[] meta71 = { "M", "N", "L", "W", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta72 = { "Z", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta73 = { "Z", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta74 = { "SC", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$
    private static final String[] meta75 = { "OO", "ER", "EN", "UY", "ED", "EM", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta76 = { "ER", "EN", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    private static final String[] meta77 = { "I", "E", "Y", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta78 = { "AI", "OI", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta79 = { "S", "Z", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta80 = { "TION", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta81 = { "TIA", "TCH", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta82 = { "TH", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta83 = { "TTH", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta84 = { "OM", "AM", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta85 = { "VAN ", "VON ", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta86 = { "SCH", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta87 = { "T", "D", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta88 = { "WR", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta89 = { "WH", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
    private static final String[] meta90 = { "EWSKI", "EWSKY", "OWSKI", "OWSKY", "" };

    //$NON-NLS-1$ //$NON-NLS-2$
    private static final String[] meta91 = { "SCH", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta92 = { "WICZ", "WITZ", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta93 = { "IAU", "EAU", "" };

    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    private static final String[] meta94 = { "AU", "OU", "" };
    ...
    public final String getHash(final String word) {
        //$NON-NLS-1$
        final String input = word.toUpperCase() + "     ";
