...
public class UndoManagerLeakTest extends LeakTestCase {
    ...
    public void testUndoManagerLeak() {
        ...
        fShell = null;
        fTextViewer = null;
        String[] types = { TextViewer.class.getName(), DefaultUndoManager.class.getName(), getDefaultUndoManagersInnerClass("HistoryListener").getName(), getDefaultUndoManagersInnerClass("TextCommand").getName(), getDefaultUndoManagersInnerClass("CompoundTextCommand").getName() };
