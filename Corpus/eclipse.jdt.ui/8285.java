...
public class AssertionVMArg {
    ...
    public static String setAssertInArgString(String currentArgs) {
        ...
        return (currentArgs.length() == 0) ? SHORT_VM_ARG_TEXT : //$NON-NLS-1$
        currentArgs + " " + SHORT_VM_ARG_TEXT;
    }

    public static boolean getEnableAssertionsPreference() {
        return Platform.getPreferencesService().getBoolean(JUnitCorePlugin.CORE_PLUGIN_ID, JUnitPreferencesConstants.ENABLE_ASSERTIONS, JUnitPreferencesConstants.ENABLE_ASSERTIONS_DEFAULT, null);
    }
