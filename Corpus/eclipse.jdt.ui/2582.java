...
class HistoryAction extends Action {
    ...
    private static long LABEL_FLAGS = JavaElementLabels.ALL_POST_QUALIFIED | JavaElementLabels.M_PARAMETER_TYPES | JavaElementLabels.M_APP_RETURNTYPE | JavaElementLabels.T_TYPE_PARAMETERS | JavaElementLabels.P_COMPRESSED | JavaElementLabels.COLORIZE;
    ...
    static String getElementLabel(IMember[] members) {
        switch(members.length) {
            case 0:
                ...
                return null;
            case 1:
                return Messages.format(CallHierarchyMessages.HistoryAction_inputElements_1, new String[] { getShortLabel(members[0]) });
            case 2:
                return Messages.format(CallHierarchyMessages.HistoryAction_inputElements_2, new String[] { getShortLabel(members[0]), getShortLabel(members[1]) });
            default:
                return Messages.format(CallHierarchyMessages.HistoryAction_inputElements_more, new String[] { getShortLabel(members[0]), getShortLabel(members[1]) });
        }
    }
