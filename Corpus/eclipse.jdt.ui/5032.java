...
public class TestModelProvider extends ModelProvider {
    ...
    private static class Sorter implements Comparator<IResourceDelta> {
        ...
        public int compare(IResourceDelta d1, IResourceDelta d2) {
            return d1.getResource().getFullPath().toPortableString().compareTo(d2.getResource().getFullPath().toPortableString());
        }
    }
    ...
    private static final int PRE_DELTA_FLAGS = IResourceDelta.CONTENT | IResourceDelta.MOVED_TO | IResourceDelta.MOVED_FROM | IResourceDelta.OPEN;
