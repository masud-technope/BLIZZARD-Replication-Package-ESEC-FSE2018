...
public class TypeHierarchyViewPart extends ViewPart implements ITypeHierarchyViewPart, IViewPartInputProvider {
    ...
    public  TypeHierarchyViewPart() {
        ...
        fAllViewers = null;
        fViewActions = new ToggleViewAction[] { new ToggleViewAction(this, HIERARCHY_MODE_CLASSIC), new ToggleViewAction(this, HIERARCHY_MODE_SUPERTYPES), new ToggleViewAction(this, HIERARCHY_MODE_SUBTYPES) };
        fDialogSettings = JavaPlugin.getDefault().getDialogSettings();
        fHistoryDropDownAction = new HistoryDropDownAction(this);
        fHistoryDropDownAction.setEnabled(false);
        fToggleOrientationActions = new ToggleOrientationAction[] { new ToggleOrientationAction(this, VIEW_LAYOUT_VERTICAL), new ToggleOrientationAction(this, VIEW_LAYOUT_HORIZONTAL), new ToggleOrientationAction(this, VIEW_LAYOUT_AUTOMATIC), new ToggleOrientationAction(this, VIEW_LAYOUT_SINGLE) };
    ...
    public void setHistoryEntries(IJavaElement[] elems) {
        List<IJavaElement[]> list = new ArrayList(1);
        list.add(elems);
    ...
    private void updateInput(IJavaElement[] inputElements) {
        ...
        if (inputElements == null) {
            ...
            fNoHierarchyShownLabel.setText(Messages.format(TypeHierarchyMessages.TypeHierarchyViewPart_createinput, HistoryAction.getElementLabel(fInputElements)));
            try {
    ...
    public void createPartControl(Composite container) {
        ...
        fActionGroups = new CompositeActionGroup(new ActionGroup[] { new NewWizardsActionGroup(this.getSite()), new OpenEditorActionGroup(this), new OpenViewActionGroup(this), new CCPActionGroup(this), new GenerateActionGroup(this), new RefactorActionGroup(this), new JavaSearchActionGroup(this) });
    ...
    public void setViewLayout(int layout) {
        if (fCurrentLayout != layout || layout == VIEW_LAYOUT_AUTOMATIC) {
            ...
            try {
                ...
                if (fMethodViewerViewForm != null && !fMethodViewerViewForm.isDisposed() && fTypeMethodsSplitter != null && !fTypeMethodsSplitter.isDisposed()) {
    ...
    private void updateHierarchyViewer(final boolean doExpand) {
        if (fInputElements == null) {
            ...
            } else if (//Show the empty hierarchy viewer till fresh computation is done.
            !isKeepShowingEmptyViewers()) {
        ...
        if (!fIsEnableMemberFilter && fCurrentLayout != VIEW_LAYOUT_SINGLE) {
            if (input == fMethodsViewer.getInput()) {
                ...
                Runnable runnable = new Runnable() {
                    ...
                    public void run() {
                        // refresh
                        fMethodsViewer.setInput(// refresh
                        input);
                    }
                };
                BusyIndicator.showWhile(getDisplay(), runnable);
    ...
    private void typeSelectionChanged(ISelection sel) {
        if (sel instanceof IStructuredSelection) {
            ...
            int nSelected = selected.size();
            if (nSelected != 0) {
                List<Object> types = new ArrayList(nSelected);
