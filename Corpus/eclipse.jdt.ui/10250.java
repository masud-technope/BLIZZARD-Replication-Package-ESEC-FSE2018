...
public class CallHierarchyContentProvider implements ITreeContentProvider {
                        ...
                        try {
                            if (type.isAnonymous()) {
                                ...
                                if (constructors.length == 0) {
                                    // type stands for the default constructor
    ...
    static boolean isInTheDefaultExpandWithConstructorList(IMethod method) {
        ...
        if (serializedMembers.length() == 0)
            return false;
        //$NON-NLS-1$
        String[] defaultMemberPatterns = serializedMembers.split(";");
    ...
    public boolean hasChildren(Object element) {
        ...
        // the "Update ..." placeholder has no children
        return false;
    }
