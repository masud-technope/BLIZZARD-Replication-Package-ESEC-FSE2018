...
public class TestReferenceFailure {
    ...
    public  TestReferenceFailure(ITestIdentifier reference, String status, String trace, FailedComparison comparison) {
        fTest = reference;
        fStatus = status;
        fTrace = trace;
    ...
    public String toString() {
        //$NON-NLS-1$
        return fStatus + " " + RemoteTestRunner.escapeTestName(fTest.getName());
    }
