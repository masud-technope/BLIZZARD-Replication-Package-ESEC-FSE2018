...
public final class TypingRun {
	 ...
	 */
    //$NON-NLS-1$
    public static final ChangeType DELETE = new ChangeType(true, "DELETE");
	 ...
	 */
    //$NON-NLS-1$
    public static final ChangeType INSERT = new ChangeType(true, "INSERT");

    /**
	 * A change of type <code>NO_CHANGE</code> does not change anything.
	 */
    //$NON-NLS-1$
    public static final ChangeType NO_CHANGE = new ChangeType(false, "NO_CHANGE");
	 ...
	 */
    //$NON-NLS-1$
    public static final ChangeType OVERTYPE = new ChangeType(true, "OVERTYPE");
	 ...
	 */
    //$NON-NLS-1$
    public static final ChangeType SELECTION = new ChangeType(false, "SELECTION");
	 ...
	 */
    //$NON-NLS-1$
    public static final ChangeType UNKNOWN = new ChangeType(true, "UNKNOWN");
