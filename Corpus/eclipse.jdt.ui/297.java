...
public class JavadocSpecificsWizardPage extends JavadocWizardPage {
    ...
    private void createExtraOptionsGroup(Composite composite) {
        ...
        String[] //$NON-NLS-1$
        versions = { "-", JavaCore.VERSION_1_3, JavaCore.VERSION_1_4, JavaCore.VERSION_1_5, JavaCore.VERSION_1_6, JavaCore.VERSION_1_7, JavaCore.VERSION_1_8 };
        ...
        fOverViewBrowseButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent event) {
                //$NON-NLS-1$
                handleFileBrowseButtonPressed(fOverViewText, new String[] { "*.html" }, JavadocExportMessages.JavadocSpecificsWizardPage_overviewbrowsedialog_title);
            }
        });
    }
