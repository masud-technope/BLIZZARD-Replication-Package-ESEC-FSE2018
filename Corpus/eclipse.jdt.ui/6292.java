...
public class JspPluginImages {
    ...
    static {
        ...
        try {
            //$NON-NLS-1$
            ICON_BASE_URL = new URL(JspUIPlugin.getDefault().getBundle().getEntry("/"), pathSuffix);
    ...
    //$NON-NLS-1$
    public static final String IMG_OBJ_TOMCAT = "IMG_TOMCAT";

    //$NON-NLS-1$
    public static final String IMG_OBJ_JSP = "IMG_OBJ_JSP";
    ...
    private static void declareImages() {
        //$NON-NLS-1$
        declareRegistryImage(IMG_OBJ_TOMCAT, OBJECT + "tomcat_obj.gif");
        //$NON-NLS-1$
        declareRegistryImage(IMG_OBJ_JSP, OBJECT + "jsp_obj.gif");
    }
