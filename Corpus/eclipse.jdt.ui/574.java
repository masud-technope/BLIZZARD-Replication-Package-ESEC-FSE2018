...
public class CleanUpRegistry {
    ...
    public static class CleanUpTabPageDescriptor {
        ...
        public  CleanUpTabPageDescriptor(IConfigurationElement element) {
            ...
            if (fKind == -1)
                JavaPlugin.logErrorMessage(Messages.format(FixMessages.CleanUpRegistry_WrongKindForConfigurationUI_error, new String[] { fName, element.getContributor().getName(), kind }));
        }
