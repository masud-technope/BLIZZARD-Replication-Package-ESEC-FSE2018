    ...
    private class Operation implements IWorkspaceRunnable {
        ...
        public void run(IProgressMonitor pm) throws CoreException {
            try {
                ...
                "", //$NON-NLS-1$
                fForked && !fForkChangeExecution ? 7 : 11);
                //$NON-NLS-1$
                ...
                //RefactoringUI.createUIAwareChangeOperation(fChange);
            ...
            try {
                ...
                if (op.fPerformChangeOperation != null) {
                    ...
                    if (validationStatus != null && validationStatus.hasFatalError()) {
                        MessageDialog.openError(fParent, fRefactoring.getName(), Messages.format(RefactoringMessages.RefactoringExecutionHelper_cannot_execute, validationStatus.getMessageMatchingSeverity(RefactoringStatus.FATAL)));
                        throw new InterruptedException();
                    }
                }
