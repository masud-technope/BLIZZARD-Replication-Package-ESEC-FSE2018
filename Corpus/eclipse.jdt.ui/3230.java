...
public class BasicCompilationUnitEditorActionContributor extends BasicJavaEditorActionContributor {
    ...
    public  BasicCompilationUnitEditorActionContributor() {
        ...
        //$NON-NLS-1$
        fContentAssist = new RetargetTextEditorAction(JavaEditorMessages.getBundleForConstructedKeys(), "ContentAssistProposal.");
        ...
        //$NON-NLS-1$
        fContextInformation = new RetargetTextEditorAction(JavaEditorMessages.getBundleForConstructedKeys(), "ContentAssistContextInformation.");
        fContextInformation.setActionDefinitionId(ITextEditorActionDefinitionIds.CONTENT_ASSIST_CONTEXT_INFORMATION);
        //$NON-NLS-1$
        fQuickAssistAction = new RetargetTextEditorAction(JavaEditorMessages.getBundleForConstructedKeys(), "CorrectionAssistProposal.");
        fQuickAssistAction.setActionDefinitionId(ITextEditorActionDefinitionIds.QUICK_ASSIST);
        //$NON-NLS-1$
        fChangeEncodingAction = new RetargetTextEditorAction(JavaEditorMessages.getBundleForConstructedKeys(), "Editor.ChangeEncodingAction.");
    }
    ...
    public void contributeToMenu(IMenuManager menu) {
        ...
        if (editMenu != null) {
            ...
            //$NON-NLS-1$
            IMenuManager caMenu = new MenuManager(JavaEditorMessages.BasicEditorActionContributor_specific_content_assist_menu, "specific_content_assist");
            ...
            //$NON-NLS-1$
            caMenu.add(new Separator("context_info"));
    ...
    public void setActiveEditor(IEditorPart part) {
        ...
        //$NON-NLS-1$
        actionBars.setGlobalActionHandler(JdtActionConstants.SHIFT_RIGHT, getAction(textEditor, "ShiftRight"));
        //$NON-NLS-1$
        actionBars.setGlobalActionHandler(JdtActionConstants.SHIFT_LEFT, getAction(textEditor, "ShiftLeft"));
