...
public class TypeEnvironment {
    ...
    //$NON-NLS-1$
    public final PrimitiveType INT = new PrimitiveType(this, PrimitiveType.INT, BindingKey.createTypeBindingKey("int"));
    ...
    private static final String[] BOXED_PRIMITIVE_NAMES = new String[] { //$NON-NLS-1$
    ...
    public void initializeJavaLangObject(IJavaProject project) {
        if (OBJECT_TYPE != null)
            return;
        //$NON-NLS-1$
        TType objectType = createStandardType("java.lang.Object", project);
