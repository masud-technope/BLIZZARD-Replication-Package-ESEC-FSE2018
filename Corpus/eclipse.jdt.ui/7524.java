    ...
    private static class UseSupertypeInputPage extends UserInputWizardPage {
        ...
        private class UseSupertypeContentProvider implements ITreeContentProvider {
            ...
            public Set<IType> getDirectSuperTypes(IType type) {
                ...
                try {
                    if (type.isInterface()) {
                        IType found = //$NON-NLS-1$
                        type.getJavaProject().findType(//$NON-NLS-1$
                        "java.lang.Object");
                        result.add(found);
                    }
        ...
        public void createControl(Composite parent) {
            ...
            label.setText(Messages.format(RefactoringMessages.UseSupertypeInputPage_Select_supertype_to_use, JavaElementLabels.getElementLabel(getUseSupertypeProcessor().getSubType(), JavaElementLabels.T_FULLY_QUALIFIED)));
