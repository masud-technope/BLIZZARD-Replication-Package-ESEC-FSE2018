...
public class ParameterInfo {
    ...
    public static ParameterInfo createInfoForAddedParameter(String type, String name) {
        //$NON-NLS-1$ //$NON-NLS-2$
        ParameterInfo info = new ParameterInfo("", "", INDEX_FOR_ADDED);
    ...
    public void markAsDeleted() {
        //added param infos should be simply removed from the list
    ...
    public String toString() {
        ...
        fOldTypeName + " " + fOldName + " @" + fOldIndex + " -> " + fNewTypeName + " " + fNewName + ": " + //$NON-NLS-1$//$NON-NLS-2$
        fDefaultValue + //$NON-NLS-1$//$NON-NLS-2$
        (fIsDeleted ? " (deleted)" : " (stays)");
    }
