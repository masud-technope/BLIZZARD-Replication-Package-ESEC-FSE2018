...
public class ExtensionPointTests extends TestCase {
    ...
    public void testJavaStatusContextViewer() throws Exception {
        ...
        ICompilationUnit unit = pack.createCompilationUnit("A.java", "package test; class A { }", true, null);
    ...
    private IPackageFragment getTestPackage() {
        IFolder folder = ResourcesPlugin.getWorkspace().getRoot().getFolder(new Path("/TestProject/src/test"));
