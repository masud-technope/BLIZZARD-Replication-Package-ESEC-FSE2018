...
public class ClasspathContainerDescriptor {
    ...
    public  ClasspathContainerDescriptor(IConfigurationElement configElement) throws CoreException {
        ...
        if (name == null) {
            //$NON-NLS-1$
            throw new CoreException(new Status(IStatus.ERROR, JavaUI.ID_PLUGIN, 0, "Invalid extension (missing name): " + id, null));
        }
        if (pageClassName == null) {
            //$NON-NLS-1$
            throw new CoreException(new Status(IStatus.ERROR, JavaUI.ID_PLUGIN, 0, "Invalid extension (missing page class name): " + id, null));
        }
    }
    ...
    public IClasspathContainerPage createPage() throws CoreException {
        if (fPage == null) {
            ...
            if (elem instanceof IClasspathContainerPage) {
                ...
                new Status(IStatus.ERROR, JavaUI.ID_PLUGIN, 0, "Invalid extension (page not of type IClasspathContainerPage): " + id, null));
            }
        }
        return fPage;
    }
