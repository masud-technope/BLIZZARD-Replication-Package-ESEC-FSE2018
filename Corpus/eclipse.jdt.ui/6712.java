...
public class OpenViewActionGroup extends ActionGroup {
    ...
    public  OpenViewActionGroup(IViewPart part, ISelectionProvider selectionProvider) {
        ...
        //$NON-NLS-1$
        fIsTypeHiararchyViewerOwner = "org.eclipse.jdt.internal.ui.typehierarchy.TypeHierarchyViewPart".equals(partName);
        //$NON-NLS-1$
        fIsCallHiararchyViewerOwner = "org.eclipse.jdt.internal.ui.callhierarchy.CallHierarchyViewPart".equals(partName);
    }
    ...
    public  OpenViewActionGroup(JavaEditor part) {
        ...
        //$NON-NLS-1$
        part.setAction("OpenImplementation", fOpenImplementation);
        ...
        //$NON-NLS-1$
        part.setAction("OpenAttachedJavadoc", fOpenAttachedJavadoc);
        ...
        //$NON-NLS-1$
        part.setAction("OpenCallHierarchy", fOpenCallHierarchy);
