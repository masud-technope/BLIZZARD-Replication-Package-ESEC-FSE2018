...
public class TextDiffContentTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        /////
        offset = 0;
        fEdit2 = new ReplaceEdit(offset, 0, "// add comment\n");
        ...
        fEdit3 = new ReplaceEdit(offset, endOffset - offset, "");
    ...
    private String getPreview(TextEditChangeGroup group, int context) throws CoreException {
        return fDocumentChange.getPreviewContent(new TextEditChangeGroup[] { group }, group.getRegion(), true, context, new NullProgressMonitor());
    }
