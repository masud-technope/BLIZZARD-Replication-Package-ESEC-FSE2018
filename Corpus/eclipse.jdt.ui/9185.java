...
public class RefactoringPluginImages {
    ...
    /** @since 3.2 */
    //$NON-NLS-1$
    public static final String IMG_OBJS_REFACTORING_DATE = NAME_PREFIX + "date_obj.gif";

    /** @since 3.2 */
    //$NON-NLS-1$
    public static final String IMG_OBJS_REFACTORING_TIME = NAME_PREFIX + "time_obj.gif";
    ...
    /** @since 3.2 */
    //$NON-NLS-1$
    public static final ImageDescriptor DESC_ELCL_SORT_PROJECT = createUnManaged(T_ELCL, "prj_mode.gif");

    /** @since 3.2 */
    //$NON-NLS-1$
    public static final ImageDescriptor DESC_DLCL_SORT_PROJECT = createUnManaged(T_DLCL, "prj_mode.gif");

    /** @since 3.2 */
    //$NON-NLS-1$
    public static final ImageDescriptor DESC_ELCL_SORT_DATE = createUnManaged(T_ELCL, "date_mode.gif");

    /** @since 3.2 */
    //$NON-NLS-1$
    public static final ImageDescriptor DESC_DLCL_SORT_DATE = createUnManaged(T_DLCL, "date_mode.gif");
    ...
    /** @since 3.2 */
    //$NON-NLS-1$
    public static final ImageDescriptor DESC_OBJS_REFACTORING_DATE = createUnManaged(T_OBJ, "date_obj.gif");

    /** @since 3.2 */
    //$NON-NLS-1$
    public static final ImageDescriptor DESC_OBJS_REFACTORING_TIME = createUnManaged(T_OBJ, "time_obj.gif");

    /** @since 3.2 */
    //$NON-NLS-1$
    public static final ImageDescriptor DESC_OBJS_REFACTORING = createUnManaged(T_OBJ, "refactoring_obj.gif");

    /** @since 3.2 */
    //$NON-NLS-1$
    public static final ImageDescriptor DESC_OBJS_REFACTORING_COLL = createUnManaged(T_OBJ, "refactorings_obj.gif");

    /** @since 3.2 */
    //$NON-NLS-1$
    public static final ImageDescriptor DESC_OVR_WORKSPACE = createUnManaged(T_OVR, "workspace_ovr.gif");

    //$NON-NLS-1$
    public static final ImageDescriptor DESC_OBJS_DEFAULT_CHANGE = createUnManaged(T_OBJ, "change.gif");

    //$NON-NLS-1$
    public static final ImageDescriptor DESC_OBJS_COMPOSITE_CHANGE = createUnManaged(T_OBJ, "composite_change.gif");

    //$NON-NLS-1$
    public static final ImageDescriptor DESC_OBJS_FILE_CHANGE = createUnManaged(T_OBJ, "file_change.gif");

    //$NON-NLS-1$
    public static final ImageDescriptor DESC_OBJS_TEXT_EDIT = createUnManaged(T_OBJ, "text_edit.gif");
