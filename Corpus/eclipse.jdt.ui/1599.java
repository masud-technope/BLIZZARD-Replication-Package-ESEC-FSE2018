...
public class ChangeExceptionsControl extends Composite {
    ...
    private IType chooseException() {
        ...
        FilteredTypesSelectionDialog dialog = new FilteredTypesSelectionDialog(getShell(), false, PlatformUI.getWorkbench().getProgressService(), scope, IJavaSearchConstants.CLASS);
        ...
        //$NON-NLS-1$
        dialog.setInitialPattern("*Exception*");
    ...
    private IStatus checkException(final IType type) throws JavaModelException {
        ...
        return JavaUIStatus.createError(IStatus.ERROR, RefactoringMessages.ChangeExceptionsControl_not_exception, null);
    }
