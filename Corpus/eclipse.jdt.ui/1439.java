...
public class RefactoringStatusEntry {
    ...
    public  RefactoringStatusEntry(int severity, String msg, RefactoringStatusContext context, String pluginId, int code, Object data) {
        Assert.isTrue(severity == RefactoringStatus.INFO || severity == RefactoringStatus.WARNING || severity == RefactoringStatus.ERROR || severity == RefactoringStatus.FATAL);
    ...
    public String toString() {
        ...
        return //$NON-NLS-1$
        "\n" + RefactoringStatus.getSeverityString(fSeverity) + ": " + //$NON-NLS-1$
        fMessage + "\nContext: " + //$NON-NLS-1$
        contextString + //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
