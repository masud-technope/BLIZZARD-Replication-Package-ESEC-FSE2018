...
public class JavaOutlineInformationControl extends AbstractInformationControl {
            ...
            if (fShowInheritedMembers && element instanceof IType) {
                ...
                if (type.getDeclaringType() == null || type.equals(fInitiallySelectedType)) {
                    ...
                    if (th != null) {
                        ...
                        for (int i = 0, scLength = superClasses.length; i < scLength; i++) children.addAll(Arrays.asList(super.getChildren(superClasses[i])));
    ...
    protected TreeViewer createTreeViewer(Composite parent, int style) {
        ...
        if (//$NON-NLS-1$
        decoratorMgr.getEnabled("org.eclipse.jdt.ui.override.decorator"))
