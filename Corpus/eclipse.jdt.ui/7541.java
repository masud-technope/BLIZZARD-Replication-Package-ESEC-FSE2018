...
public class AddDelegateMethodsAction extends SelectionDispatchAction {
    ...
    private static class AddDelegateMethodsActionStatusValidator implements ISelectionStatusValidator {
        ...
        public IStatus validate(Object[] selection) {
            ...
            if (duplicateCount > 0) {
                return new StatusInfo(IStatus.ERROR, duplicateCount == 1 ? ActionMessages.AddDelegateMethodsAction_duplicate_methods_singular : Messages.format(ActionMessages.AddDelegateMethodsAction_duplicate_methods_plural, String.valueOf(duplicateCount)));
            }
