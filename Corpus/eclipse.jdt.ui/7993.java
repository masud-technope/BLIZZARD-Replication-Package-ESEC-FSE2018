...
public class JavaBrowsingPerspectiveFactory implements IPerspectiveFactory {
    ...
    private void createVerticalLayout(IPageLayout layout) {
        ...
        //$NON-NLS-1$
        IPlaceholderFolderLayout placeHolderLeft = layout.createPlaceholderFolder("left", IPageLayout.LEFT, (float) 0.25, IPageLayout.ID_EDITOR_AREA);
        ...
        //$NON-NLS-1$
        IPlaceholderFolderLayout placeHolderBottom = layout.createPlaceholderFolder("bottom", IPageLayout.BOTTOM, (float) 0.75, IPageLayout.ID_EDITOR_AREA);
