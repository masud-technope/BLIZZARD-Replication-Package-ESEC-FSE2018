...
public class StringConcatenationGenerator extends AbstractToStringGenerator {
    ...
    protected void addMember(Object member, boolean addSeparator) {
        //$NON-NLS-1$ //$NON-NLS-2$
        boolean[] interfaces = implementsInterfaces(getMemberType(member).getErasure(), new String[] { "java.util.Collection", "java.util.Map" });
    ...
    protected void addMemberCheckNull(Object member, boolean addSeparator) {
        ...
        //$NON-NLS-1$ //$NON-NLS-2$
        literal.setLiteralValue(getContext().isSkipNulls() ? "" : "null");
