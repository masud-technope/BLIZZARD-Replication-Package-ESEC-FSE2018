...
public class SubTypesSet extends TypeSet {
    ...
    public TypeSet makeClone() {
        //new SubTypesSet(fUpperBounds.makeClone());
        return this;
    }
    ...
    public boolean containsAll(TypeSet s) {
        ...
        for (Iterator<TType> sIter = s.iterator(); sIter.hasNext(); ) {
            ...
            for (Iterator<TType> ubIter = fUpperBounds.iterator(); ubIter.hasNext(); ) {
                TType ub = ubIter.next();
                if (TTypes.canAssignTo(t, ub)) {
                    found = true;
                    break;
    ...
    public TypeSet upperBound() {
        // perhaps should be unmodifiable?
        return fUpperBounds;
    }
    ...
    public String toString() {
        ...
        return "<" + fID + ": subTypes(" + fUpperBounds + ")>";
    }
