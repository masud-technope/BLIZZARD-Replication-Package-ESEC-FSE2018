...
public class IteratorForLoopJavaContextTest extends AbstractForLoopJavaContextTest {
    ...
    public void testCollection() throws Exception {
        ...
        assertEquals("	for (java.util.Iterator iterator = numbers.iterator(); iterator.hasNext();) {\n" + "		Number number = (Number) iterator.next();\n" + "		\n" + "	}", template);
    }
    ...
    public void testSimpleTransitive() throws Exception {
        ...
        assertEquals("	for (java.util.Iterator iterator = lists.iterator(); iterator.hasNext();) {\n" + "		List<Number> list = (List<Number>) iterator.next();\n" + "		\n" + "	}", template);
    }

    public void testWildcard() throws Exception {
        String template = evaluateTemplateInMethod("void method(Collection<?> objects)");
        assertEquals("	for (java.util.Iterator iterator = objects.iterator(); iterator.hasNext();) {\n" + "		Object object = (Object) iterator.next();\n" + "		\n" + "	}", template);
    }
