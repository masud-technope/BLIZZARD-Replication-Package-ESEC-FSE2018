...
public class PropertiesFileEditorPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
    ...
    private final String[][] fSyntaxColorListModel = new String[][] { { PreferencesMessages.PropertiesFileEditorPreferencePage_key, PreferenceConstants.PROPERTIES_FILE_COLORING_KEY }, { PreferencesMessages.PropertiesFileEditorPreferencePage_value, PreferenceConstants.PROPERTIES_FILE_COLORING_VALUE }, { PreferencesMessages.PropertiesFileEditorPreferencePage_assignment, PreferenceConstants.PROPERTIES_FILE_COLORING_ASSIGNMENT }, { PreferencesMessages.PropertiesFileEditorPreferencePage_argument, PreferenceConstants.PROPERTIES_FILE_COLORING_ARGUMENT }, { PreferencesMessages.PropertiesFileEditorPreferencePage_comment, PreferenceConstants.PROPERTIES_FILE_COLORING_COMMENT } };
    ...
    private Control createPreviewer(Composite parent) {
        ...
        //$NON-NLS-1$
        String content = loadPreviewContentFromFile("PropertiesFileEditorColorSettingPreviewCode.txt");
    ...
    private void createHeader(Composite contents) {
        ...
        link.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                e.text))
                    PreferencesUtil.createPreferenceDialogOn(getShell(), e.text, null, "selectFont:org.eclipse.jdt.ui.PropertiesFileEditor.textfont");
            }
        });
    ...
    private void initialize() {
        initializeFields();
        for (int i = 0, n = fSyntaxColorListModel.length; i < n; i++) fHighlightingColorList.add(new HighlightingColorListItem(fSyntaxColorListModel[i][0], fSyntaxColorListModel[i][1], fSyntaxColorListModel[i][1] + BOLD, fSyntaxColorListModel[i][1] + ITALIC, fSyntaxColorListModel[i][1] + STRIKETHROUGH, fSyntaxColorListModel[i][1] + UNDERLINE, null));
