...
public class ContentProviderTests1 extends TestCase {
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite(ContentProviderTests1.class.getName());
        //$JUnit-BEGIN$
    ...
    public void testGetChildrenMidLevelFragmentInArchive() throws Exception {
        ...
        //$NON-NLS-1$
        assertTrue("wrong chidren found for mid level PackageFragment in Archive", compareArrays(children, expectedChildren));
    }
    ...
    public void testGetParentArchive() throws Exception {
        ...
        //$NON-NLS-1$
        assertTrue("Wrong parent found for PackageFragmentRoot Archive", parent == fJProject1);
    }
    ...
    public void testDeleteBottomLevelFragment() throws Exception {
        ...
        //$NON-NLS-1$
        assertTrue("Correct Remove", fMyPart.getRemovedObjects().contains(fPack2));
        //$NON-NLS-1$
        assertEquals("No refreshes", 0, fMyPart.getRefreshedObject().size());
    }

    public void testAddBottomLevelFragment() throws Exception {
        //$NON-NLS-1$
        IPackageFragment test = fRoot1.createPackageFragment("test", true, null);
        //send a delta indicating fragment deleted
        IElementChangedListener listener = (IElementChangedListener) fProvider;
        ...
        //$NON-NLS-1$
        assertTrue("Correct Add", test.equals(fMyPart.getAddedObject()));
        //$NON-NLS-1$
        assertEquals("No refreshes", 0, fMyPart.getRefreshedObject().size());
    }
    ...
    public void testChangedTopLevelPackageFragment() throws Exception {
        ...
        //$NON-NLS-1$
        assertEquals("No refresh happened", 0, fMyPart.getRefreshedObject().size());
    }
    ...
    public void testRemoveCUsFromPackageFragment() throws Exception {
        ...
        //$NON-NLS-1$
        assertEquals("One refresh", 1, fMyPart.getRefreshedObject().size());
    }
    ...
    public void testRemoveCUFromPackageFragment() throws Exception {
        ...
        assertTrue("Remove happened", fMyPart.hasRemoveHappened());
        //$NON-NLS-1$
        assertTrue("Correct refresh", fMyPart.getRemovedObjects().contains(fCU2));
        //$NON-NLS-1$
        assertEquals("No refreshes", 0, fMyPart.getRefreshedObject().size());
    }
    ...
    public void testBug65240() throws Exception {
        ...
        //$NON-NLS-1$
        assertTrue("Wrong children found for folder", compareArrays(children, expectedChildren));
        ...
        //$NON-NLS-1$
        assertTrue("Wrong children found for source folder", compareArrays(children, expectedChildren));
    }
    ...
    protected void setUp() throws Exception {
        ...
        //$NON-NLS-1$//$NON-NLS-2$
        fCU3 = fPack6.createCompilationUnit("Jen.java", "", true, null);
