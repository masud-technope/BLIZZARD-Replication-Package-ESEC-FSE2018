...
public class CompilationUnitEditorActionContributor extends BasicCompilationUnitEditorActionContributor {
    ...
    public  CompilationUnitEditorActionContributor() {
        ...
        //$NON-NLS-1$
        fToggleInsertModeAction = new RetargetTextEditorAction(b, "CompilationUnitEditorActionContributor.ToggleInsertMode.", IAction.AS_CHECK_BOX);
    ...
    public void setActiveEditor(IEditorPart part) {
        ...
        //$NON-NLS-1$
        bars.setGlobalActionHandler(JdtActionConstants.INDENT, getAction(textEditor, "Indent"));
