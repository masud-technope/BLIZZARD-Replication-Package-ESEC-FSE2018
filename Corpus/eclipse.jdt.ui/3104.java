...
public class JUnitContainerWizardPage extends NewElementWizardPage implements IClasspathContainerPage, IClasspathContainerPageExtension {
    ...
    public void createControl(Composite parent) {
        ...
        fVersionCombo.setItems(new String[] { JUnitMessages.JUnitContainerWizardPage_option_junit3, JUnitMessages.JUnitContainerWizardPage_option_junit4 });
    ...
    protected void doSelectionChanged() {
        ...
        if (fVersionCombo != null && fVersionCombo.getSelectionIndex() == 1) {
            ...
            if (libEntry == null)
                // JUnit 4 includes most of JUnit 3, so let's cheat
                libEntry = BuildPathSupport.getJUnit4as3LibraryEntry();
        }
        if (libEntry == null) {
