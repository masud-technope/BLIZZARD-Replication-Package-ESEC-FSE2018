...
public class InlineConstantTests extends RefactoringTest {
    ...
    private int firstIndexOf(String one, String[] others) {
        for (int i = 0; i < others.length; i++) if (one == null && others[i] == null || one.equals(others[i]))
            return i;
        return -1;
    }
    ...
    public // test for bug 93689
    void test26() throws // test for bug 93689
    Exception {
        helper1("p.A", 5, 42, 5, 42, true, true);
    }

    public // test for bug 109071
    void test27() throws // test for bug 109071
    Exception {
    ...
    public // test for bug 174327
    void test29() throws // test for bug 174327
    Exception {
        helper1("p.A", 7, 44, 7, 44, true, true);
    }

    public //test for bug 237547 (inline unused constant)
    void test30() throws //test for bug 237547 (inline unused constant)
    Exception {
        helper1(new String[] { "p.A", "p.B", "p.C", "p.D", "q.Consts" }, "q.Consts", 5, 32, 5, 40, true, true);
    }

    public // test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=265448
    void test31() throws // test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=265448
    Exception {
        helper1("p.A", 4, 23, 4, 28, true, true);
    }

    public // test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=265448
    void test32() throws // test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=265448
    Exception {
        helper1("p.A", 4, 23, 4, 28, true, true);
    }

    public // test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=279715
    void test33() throws // test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=279715
    Exception {
        helper1("p.A", 5, 29, 5, 30, true, true);
    }

    public // test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=297760
    void test34() throws // test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=297760
    Exception {
        helper1("p.A", 4, 24, 4, 25, true, true);
    }

    public // test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=335173
    void test35() throws // test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=335173
    Exception {
        helper1("p.A", 4, 22, 4, 23, true, true);
    }

    public // test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=335173
    void test36() throws // test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=335173
    Exception {
        helper1("p.A", 4, 22, 4, 23, true, true);
    }

    public // test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=335173
    void test37() throws // test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=335173
    Exception {
        helper1("p.A", 4, 23, 4, 28, true, true);
    }

    public // test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=218431
    void test38() throws // test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=218431
    Exception {
        helper1("p.A", 6, 22, 6, 23, true, true);
    }

    public // test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=218431
    void test39() throws // test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=218431
    Exception {
        helper1("p.A", 7, 26, 7, 27, true, true);
    }

    public // test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=431158
    void test40() throws // test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=431158
    Exception {
    ...
    public // test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=431158
    void test41() throws // test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=431158
    Exception {
        // Select qualified name to inline
        helper1("p.A", 8, 15, 8, 21, true, true);
    }

    public // test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=394721
    void test42() throws // test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=394721
    Exception {
