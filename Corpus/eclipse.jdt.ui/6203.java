...
public class ToStringTemplateParser {
    ...
    public Map<String, String> getVariableDescriptions() {
        if (descriptions == null) {
            ...
            for (int i = 0; i < ToStringTemplateParser.VARIABLES.length; i++) descriptions.put(ToStringTemplateParser.VARIABLES[i], ToStringTemplateParser.VARIABLE_DESCRIPTIONS[i]);
        }
        return descriptions;
    }
