...
public class LocalHistoryActionGroup extends ActionGroup {
    ...
    public  LocalHistoryActionGroup(CompilationUnitEditor editor, String groupName) {
        ...
        fCompareWith.init(editor, CompareMessages.LocalHistoryActionGroup_action_compare_with, CompareMessages.LocalHistoryActionGroup_action_compare_with_title, CompareMessages.LocalHistoryActionGroup_action_compare_with_message);
        ...
        fReplaceWithPrevious.init(editor, CompareMessages.LocalHistoryActionGroup_action_replace_with_previous, CompareMessages.LocalHistoryActionGroup_action_replace_with_previous_title, CompareMessages.LocalHistoryActionGroup_action_replace_with_previous_message);
        ...
        fReplaceWith.init(editor, CompareMessages.LocalHistoryActionGroup_action_replace_with, CompareMessages.LocalHistoryActionGroup_action_replace_with_title, CompareMessages.LocalHistoryActionGroup_action_replace_with_message);
        ...
        fAddFrom.init(editor, CompareMessages.LocalHistoryActionGroup_action_add, CompareMessages.LocalHistoryActionGroup_action_add_title, CompareMessages.LocalHistoryActionGroup_action_add_message);
