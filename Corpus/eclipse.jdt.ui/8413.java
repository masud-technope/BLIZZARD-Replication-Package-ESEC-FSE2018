...
public class JavaSearchResultPage extends AbstractTextSearchViewPage implements IAdaptable {
    ...
    private void initGroupingActions() {
        ...
        //$NON-NLS-1$
        JavaPluginImages.setLocalImageDescriptors(fGroupProjectAction, "prj_mode.png");
        ...
        //$NON-NLS-1$
        JavaPluginImages.setLocalImageDescriptors(fGroupPackageAction, "package_mode.png");
        ...
        //$NON-NLS-1$
        JavaPluginImages.setLocalImageDescriptors(fGroupFileAction, "file_mode.png");
        ...
        //$NON-NLS-1$
        JavaPluginImages.setLocalImageDescriptors(fGroupTypeAction, "type_mode.png");
    }
    ...
    public void init(IPageSite site) {
        ...
        menuManager.appendToGroup(IContextMenuConstants.GROUP_PROPERTIES, new Action(SearchMessages.JavaSearchResultPage_preferences_label) {
            ...
            public void run() {
                ...
                String[] displayedPages = { pageId, "org.eclipse.ui.editors.preferencePages.Annotations", "org.eclipse.ui.preferencePages.ColorsAndFonts" };
    ...
    protected void handleOpen(OpenEvent event) {
        ...
        if (firstElement instanceof ICompilationUnit || firstElement instanceof IClassFile || firstElement instanceof IMember) {
