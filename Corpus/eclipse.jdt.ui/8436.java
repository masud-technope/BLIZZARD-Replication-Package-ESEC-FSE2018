...
public class CleanUpPerfTest extends JdtPerformanceTestCase {
    ...
    public static Test suite() {
        return new MyTestSetup(new OrderedTestSuite(CleanUpPerfTest.class, new String[] { "testNullCleanUp", "testAllCleanUps", "testCodeStyleCleanUp", "testControlStatementsCleanUp", "testConvertLoopCleanUp", "testExpressionsCleanUp", "testJava50CleanUp", "testStringCleanUp", "testSortMembersCleanUp", "testUnnecessaryCodeCleanUp", "testUnusedCodeCleanUp", "testVariableDeclarationCleanUp", "testCodeFormatCleanUp", "testOrganizeImports" }));
    }
