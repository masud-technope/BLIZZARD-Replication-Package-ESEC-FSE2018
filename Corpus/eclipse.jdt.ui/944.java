...
public class CleanUpProfileManager extends ProfileManager {
    ...
    public static KeySet[] KEY_SETS = { new KeySet(JavaUI.ID_PLUGIN, new ArrayList(JavaPlugin.getDefault().getCleanUpRegistry().getDefaultOptions(CleanUpConstants.DEFAULT_CLEAN_UP_OPTIONS).getKeys())) };
