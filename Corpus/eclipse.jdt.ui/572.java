...
public class JavaElement extends ASTAttribute {
    ...
    public String getLabel() {
        if (fJavaElement == null) {
            ...
            "> " + classname.substring(classname.lastIndexOf('.') + 1) + ": " + JavaElementLabels.getElementLabel(fJavaElement, LABEL_OPTIONS) + //$NON-NLS-1$//$NON-NLS-2$
            (fJavaElement.exists() ? "" : " (does not exist)");
        }
    }
