...
public class MultiElementListSelectionDialog extends AbstractElementListSelectionDialog {
    ...
    public void setElements(Object[][] elements) {
        ...
        for (int i = 0; i != fNumberOfPages; i++) fPages[i] = new Page(elements[i]);
    ...
    protected void updateButtonsEnableState(IStatus status) {
        ...
        for (int i = 0; i != fNumberOfPages; i++) isAllOK = isAllOK && fPages[i].okState;
    ...
    private void initializeResult(int length) {
        ...
        for (int i = 0; i != length; i++) result.add(null);
        setResult(result);
    }
