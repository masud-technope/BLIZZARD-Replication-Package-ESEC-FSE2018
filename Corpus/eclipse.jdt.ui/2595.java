...
public class TypeSelectionComponent extends Composite implements ITypeSelectionComponent {
    ...
    private void createContent(final String message, int elementKind) {
        ...
        fViewer = new TypeInfoViewer(this, fMultipleSelection ? SWT.MULTI : SWT.NONE, label, fScope, elementKind, fInitialFilterText, fTypeSelectionExtension != null ? fTypeSelectionExtension.getFilterExtension() : null, fTypeSelectionExtension != null ? fTypeSelectionExtension.getImageProvider() : null);
