...
public class CleanUpConstants {
    ...
    FORMAT_COMMENT = "cleanup.format_comment";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    FORMAT_SINGLE_LINE_COMMENT = "cleanup.format_single_line_comment";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    FORMAT_MULTI_LINE_COMMENT = "cleanup.format_multi_line_comment";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    FORMAT_JAVADOC = "cleanup.format_javadoc";
	 ...
	 */
    //$NON-NLS-1$
    public static final String CONVERT_FUNCTIONAL_INTERFACES = "cleanup.convert_functional_interfaces";
	 ...
	 */
    //$NON-NLS-1$
    public static final String USE_LAMBDA = "cleanup.use_lambda";
	 ...
	 */
    //$NON-NLS-1$
    public static final String USE_ANONYMOUS_CLASS_CREATION = "cleanup.use_anonymous_class_creation";
	 ...
	 */
    //$NON-NLS-1$
    public static final String INSERT_INFERRED_TYPE_ARGUMENTS = "cleanup.insert_inferred_type_arguments";
	 ...
	 */
    //$NON-NLS-1$
    public static final String REMOVE_REDUNDANT_TYPE_ARGUMENTS = "cleanup.remove_redundant_type_arguments";
    ...
    public static void setDefaultOptions(int kind, CleanUpOptions options) {
        switch(kind) {
            ...
            default:
                ...
                false, //$NON-NLS-1$
                "Unknown Clean Up option kind: " + kind);
                break;
        }
    }
}
