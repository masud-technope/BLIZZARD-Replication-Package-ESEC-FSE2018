...
public class Java50Fix extends CompilationUnitRewriteOperationsFix {
        ...
        public void rewriteAST(CompilationUnitRewrite cuRewrite, LinkedProposalModel positionGroups) throws CoreException {
            ...
            for (int i = 0; i < nodes.length; i++) {
                ...
                for (Iterator<Type> iter = args.iterator(); iter.hasNext(); ) {
                    //$NON-NLS-1$ //$NON-NLS-2$
                    LinkedProposalPositionGroup group = new LinkedProposalPositionGroup("G" + i + "_" + j);
    ...
    public static boolean isMissingDeprecationProblem(int id) {
        return id == IProblem.FieldMissingDeprecatedAnnotation || id == IProblem.MethodMissingDeprecatedAnnotation || id == IProblem.TypeMissingDeprecatedAnnotation;
    }
