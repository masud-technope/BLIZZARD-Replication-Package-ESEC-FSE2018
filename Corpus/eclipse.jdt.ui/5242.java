...
public final class SearchMessages extends NLS {
    ...
    //$NON-NLS-1$
    private static final String BUNDLE_NAME = "org.eclipse.jdt.internal.ui.search.SearchMessages";
    ...
    public static String JavaSearchQuery_multi_selection_search_description;
    ...
    public static String MatchLocations_method_reference_description;

    public static String MatchLocations_method_reference_label;
