...
public class OpenJavaPerspectiveAction extends Action {
    ...
    public void run() {
        ...
        try {
            ...
            ExceptionHandler.handle(e, window.getShell(), ActionMessages.OpenJavaPerspectiveAction_dialog_title, ActionMessages.OpenJavaPerspectiveAction_error_open_failed);
        }
    }
}
