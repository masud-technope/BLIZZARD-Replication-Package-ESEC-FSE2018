...
public class CPListElement {
            ...
            case IClasspathEntry.CPE_CONTAINER:
                ...
                try {
                    ...
                    if (container != null) {
                        ...
                        // catch invalid container implementation
                        if (entries != null) {
                            for (int i = 0; i < entries.length; i++) {
                                ...
                                if (entry != null) {
                                    ...
                                    JavaPlugin.logErrorMessage(//$NON-NLS-1$//$NON-NLS-2$
                            ...
                            //$NON-NLS-1$//$NON-NLS-2$
                            JavaPlugin.logErrorMessage("container returns null as entries: '" + fPath + "'");
                        }
                    }
    ...
    private IStatus evaluateContainerChildStatus(CPListElementAttribute attrib) {
        if (fProject != null) {
            ...
            //$NON-NLS-1$
            return new Status(IStatus.ERROR, JavaUI.ID_PLUGIN, ClasspathContainerInitializer.ATTRIBUTE_READ_ONLY, "", null);
        }
        return null;
    }
        ...
        switch(curr.getEntryKind()) {
            ...
            case IClasspathEntry.CPE_LIBRARY:
                ...
                if (res == null) {
                    ...
                    // look for external JARs and folders
