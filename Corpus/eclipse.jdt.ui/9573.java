...
public abstract class UndoManagerAction implements IWorkbenchWindowActionDelegate {
    ...
    protected abstract static class Query implements IValidationCheckResultQuery {
    ...
    public void run(IAction action) {
        ...
        try {
            PlatformUI.getWorkbench().getProgressService().runInUI(new ProgressMonitorDialog(fWorkbenchWindow.getShell()), op, ResourcesPlugin.getWorkspace().getRoot());
