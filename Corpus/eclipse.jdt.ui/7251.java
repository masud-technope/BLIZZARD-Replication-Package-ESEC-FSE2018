...
public class JunitPreferenceInitializer extends AbstractPreferenceInitializer {
    ...
    public void initializeDefaultPreferences() {
        ...
        //$NON-NLS-1$
        prefs.put(JUnitPreferencesConstants.PREF_INACTIVE_FILTERS_LIST, "");
        prefs.putInt(JUnitPreferencesConstants.MAX_TEST_RUNS, 10);
        // see https://github.com/junit-team/junit/issues/570
        //$NON-NLS-1$
        prefs.put(JUnitPreferencesConstants.JUNIT3_JAVADOC, "http://junit.sourceforge.net/junit3.8.1/javadoc/");
        //$NON-NLS-1$
        prefs.put(JUnitPreferencesConstants.JUNIT4_JAVADOC, "http://junit-team.github.io/junit/javadoc/latest/");
        //$NON-NLS-1$
        prefs.put(JUnitPreferencesConstants.HAMCREST_CORE_JAVADOC, "http://hamcrest.org/JavaHamcrest/javadoc/1.3/");
