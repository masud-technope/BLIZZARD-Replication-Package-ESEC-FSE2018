...
public class ArraySuperTypeSet extends ArrayTypeSet {
    ...
    public  ArraySuperTypeSet(TypeSet s) {
        ...
        if (s instanceof SuperTypesOfSingleton || s instanceof SuperTypesSet)
            // optimization: array-super(super(s)) == array-super(s)
            fElemTypeSet = s.lowerBound();
        else
            fElemTypeSet = s;
    }
    ...
    protected TypeSet specialCasesIntersectedWith(TypeSet s2) {
        if (s2 instanceof ArraySuperTypeSet) {
            ...
            if (ats2.fElemTypeSet.isUniverse())
                // intersection doesn't include Object, which is in 'this'
    ...
    public boolean hasUniqueUpperBound() {
        // Object is the unique upper bound of any set of array types
        return true;
    }
    ...
    public String toString() {
        ...
        return "{" + fID + ": array-super(" + fElemTypeSet + ")}";
    }
}
