...
public class ContentProviderTests3 extends TestCase {
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite(ContentProviderTests3.class.getName());
        //$JUnit-BEGIN$
    ...
    public void testGetParentArchive() throws Exception {
        ...
        //$NON-NLS-1$
        assertTrue("Wrong parent found for PackageFragmentRoot Archive with folding", parent == fJProject1);
    }
    ...
    public void testDeleteBottomLevelFragmentFolding() throws Exception {
        ...
        while (fMyPart.getTreeViewer().getControl().getDisplay().readAndDispatch()) //$NON-NLS-1$
        assertTrue("Refresh happened", fMyPart.hasRefreshHappened());
        //$NON-NLS-1$
        assertTrue("Correct Refresh", fMyPart.wasObjectRefreshed(fRoot1));
        //$NON-NLS-1$
        assertTrue("Single refresh", fMyPart.getRefreshedObject().size() == 1);
    }
    ...
    public void testChangedTopLevelPackageFragmentFolding() throws Exception {
        ...
        //$NON-NLS-1$
        assertEquals("No refreshs", 0, fMyPart.getRefreshedObject().size());
    }
    ...
    protected void setUp() throws Exception {
        ...
        //$NON-NLS-1$
        fRoot1.createPackageFragment("pack3.pack5", true, null);
        //$NON-NLS-1$
