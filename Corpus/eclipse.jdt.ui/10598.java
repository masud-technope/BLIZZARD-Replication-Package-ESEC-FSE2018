...
public class AssignToVariableAssistProposal extends LinkedCorrectionProposal {
    ...
    // ExpressionStatement or SingleVariableDeclaration(s)
    ...
    private ASTRewrite doAddLocal() {
        ...
        Type type = evaluateType(ast, nodeToAssign, fTypeBinding, KEY_TYPE);
        ...
        setEndPosition(rewrite.track(nodeToAssign));
        return rewrite;
    }
    ...
    private VariableDeclarationFragment addFieldDeclaration(ASTRewrite rewrite, ASTNode newTypeDecl, int modifiers, Expression expression, ASTNode nodeToAssign, ITypeBinding typeBinding, int index) {
        ...
        Type type = evaluateType(ast, nodeToAssign, typeBinding, KEY_TYPE + index);
