...
public class GenerateActionGroup extends ActionGroup {
    ...
    public  GenerateActionGroup(IWorkbenchSite site, ISelectionProvider selectionProvider) {
        ...
        SelectionDispatchAction[] actions = new SelectionDispatchAction[] { fOverrideMethods, fAddGetterSetter, fAddDelegateMethods, fAddUnimplementedConstructors, fGenerateConstructorUsingFields, fHashCodeEquals, fToString, fAddJavaDocStub, fExternalizeStrings, fFindNLSProblems, fOrganizeImports, fFormatAll, fSortMembers, fAddTaskAction, fCleanUp };
    ...
    private int fillEditorSubMenu(IMenuManager source) {
        ...
        //$NON-NLS-1$
        added += addEditorAction(source, "QuickFormat");
