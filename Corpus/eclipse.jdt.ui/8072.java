...
public class ExtractMethodTestSetup extends RefactoringTestSetup {
    ...
    protected void setUp() throws Exception {
        ...
        ICompilationUnit cu = fExpressionPackage.createCompilationUnit("A.java", "package expression_in; import java.io.File; class A { public File getFile() { return null; } public void useFile(File file) { } }", true, null);
        cu = fExpressionPackage.createCompilationUnit("B.java", "package expression_in; import java.util.List; public class B { public List[] foo() { return null; } }", true, null);
        cu.save(null, true);
    }
