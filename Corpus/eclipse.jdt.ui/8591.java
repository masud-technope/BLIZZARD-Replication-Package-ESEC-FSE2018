...
public class NewJavaProjectWizardTest extends TestCase {
    ...
    public void testUserSet() throws Exception {
        ...
        IClasspathEntry[] entries = new IClasspathEntry[] { JavaCore.newSourceEntry(project.getFolder("dsrc1").getFullPath()), JavaCore.newSourceEntry(project.getFolder("dsrc2").getFullPath()) };
