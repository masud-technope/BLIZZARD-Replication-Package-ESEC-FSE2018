...
public class WhiteSpaceTabPage extends FormatterTabPage {
    ...
    private final class SyntaxComponent implements ISelectionChangedListener, ICheckStateListener, IDoubleClickListener {
        ...
        //$NON-NLS-1$
        private final String PREF_NODE_KEY = JavaUI.ID_PLUGIN + "formatter_page.white_space_tab_page.node";
        ...
        public void refreshState() {
            ...
            for (Iterator<Node> iter = fTree.iterator(); iter.hasNext(); ) iter.next().getCheckedLeafs(checked);
    ...
    private final class JavaElementComponent implements ISelectionChangedListener, ICheckStateListener {
        ...
        //$NON-NLS-1$
        private final String PREF_INNER_INDEX = JavaUI.ID_PLUGIN + "formatter_page.white_space.java_view.inner";

        //$NON-NLS-1$
        private final String PREF_OPTION_INDEX = JavaUI.ID_PLUGIN + "formatter_page.white_space.java_view.option";
        ...
        public void createContents(int numColumns, Composite parent) {
            ...
            fInnerViewer.setContentProvider(new ITreeContentProvider() {
                ...
                public boolean hasChildren(Object element) {
                    ...
                    for (final Iterator<Node> iter = children.iterator(); iter.hasNext(); ) if (iter.next() instanceof InnerNode)
                        return true;
                    return false;
                }
    ...
    private final class SwitchComponent extends SelectionAdapter {
        ...
        //$NON-NLS-1$
        private final String PREF_VIEW_KEY = JavaUI.ID_PLUGIN + "formatter_page.white_space_tab_page.view";

        private final String[] fItems = new String[] { FormatterMessages.WhiteSpaceTabPage_sort_by_java_element, FormatterMessages.WhiteSpaceTabPage_sort_by_syntax_element };
