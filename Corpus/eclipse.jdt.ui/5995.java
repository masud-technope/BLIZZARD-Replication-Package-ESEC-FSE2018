...
public class FoldingActionGroup extends ActionGroup {
    ...
    public  FoldingActionGroup(final ITextEditor editor, ITextViewer viewer) {
        ...
        fToggle = new //$NON-NLS-1$
        PreferenceAction(//$NON-NLS-1$
        FoldingMessages.getResourceBundle(), //$NON-NLS-1$
        "Projection.Toggle.", //$NON-NLS-1$
        ...
        fRestoreDefaults = new //$NON-NLS-1$
        FoldingAction(//$NON-NLS-1$
        FoldingMessages.getResourceBundle(), //$NON-NLS-1$
        "Projection.Restore.") {
        ...
        fCollapseMembers = new //$NON-NLS-1$
        FoldingAction(//$NON-NLS-1$
        FoldingMessages.getResourceBundle(), //$NON-NLS-1$
        "Projection.CollapseMembers.") {
        ...
        fCollapseComments = new //$NON-NLS-1$
        FoldingAction(//$NON-NLS-1$
        FoldingMessages.getResourceBundle(), //$NON-NLS-1$
        "Projection.CollapseComments.") {
