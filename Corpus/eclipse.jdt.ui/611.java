...
class RenameTypeWizardSimilarElementsPage extends UserInputWizardPage {
    ...
    private static class SimilarElementTreeContentProvider implements ITreeContentProvider {
        ...
        public void inputChanged(Viewer viewer, Object oldInput, Object newInput) {
            ...
            if (newInput == null)
                return;
            @SuppressWarnings("unchecked") final Map<IJavaElement, String> similarElementsMap = (Map<IJavaElement, String>) newInput;
    ...
    private static class SimilarElementComparator extends JavaElementComparator {
        ...
        public int category(Object element) {
            ...
            if (sourceRange != null)
                // +100: safe distance from all other categories.
    ...
    public IWizardPage getNextPage() {
        ...
        if (// if user pressed cancel, then the next page is the current page
        nextPage != this)
