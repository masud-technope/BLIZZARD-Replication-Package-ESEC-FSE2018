...
public class PreferenceConstants {
    ...
    APPEARANCE_OVERRIDE_INDICATOR = "org.eclipse.jdt.ui.overrideindicator";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    CODEGEN_USE_GETTERSETTER_PREFIX = "org.eclipse.jdt.ui.gettersetter.prefix.enable";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    CODEGEN_GETTERSETTER_PREFIX = "org.eclipse.jdt.ui.gettersetter.prefix.list";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    CODEGEN_USE_GETTERSETTER_SUFFIX = "org.eclipse.jdt.ui.gettersetter.suffix.enable";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    CODEGEN_GETTERSETTER_SUFFIX = "org.eclipse.jdt.ui.gettersetter.suffix.list";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    CODEGEN__NON_JAVADOC_COMMENTS = "org.eclipse.jdt.ui.seecomments";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    CODEGEN__FILE_COMMENTS = "org.eclipse.jdt.ui.filecomments";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    LINK_PACKAGES_TO_EDITOR = "org.eclipse.jdt.ui.packages.linktoeditor";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    LINK_TYPEHIERARCHY_TO_EDITOR = "org.eclipse.jdt.ui.packages.linktypehierarchytoeditor";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    UPDATE_JAVA_VIEWS = "JavaUI.update";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    UPDATE_ON_SAVE = "JavaUI.update.onSave";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    UPDATE_WHILE_EDITING = "JavaUI.update.whileEditing";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_CURRENT_LINE = "currentLine";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_CURRENT_LINE_COLOR = "currentLineColor";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_PRINT_MARGIN = "printMargin";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_PRINT_MARGIN_COLOR = "printMarginColor";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_PRINT_MARGIN_COLUMN = "printMarginColumn";
	 ...
	 */
    @Deprecated
    public static final String EDITOR_FIND_SCOPE_COLOR = AbstractTextEditor.PREFERENCE_COLOR_FIND_SCOPE;
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_SPACES_FOR_TABS = "spacesForTabs";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_TAB_WIDTH = "org.eclipse.jdt.ui.editor.tab.width";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_PROBLEM_INDICATION = "problemIndication";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_PROBLEM_INDICATION_COLOR = "problemIndicationColor";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_WARNING_INDICATION = "warningIndication";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_WARNING_INDICATION_COLOR = "warningIndicationColor";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_TASK_INDICATION = "taskIndication";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_TASK_INDICATION_COLOR = "taskIndicationColor";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_BOOKMARK_INDICATION = "bookmarkIndication";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_BOOKMARK_INDICATION_COLOR = "bookmarkIndicationColor";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_SEARCH_RESULT_INDICATION = "searchResultIndication";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_SEARCH_RESULT_INDICATION_COLOR = "searchResultIndicationColor";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_UNKNOWN_INDICATION = "othersIndication";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_UNKNOWN_INDICATION_COLOR = "othersIndicationColor";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_ERROR_INDICATION_IN_OVERVIEW_RULER = "errorIndicationInOverviewRuler";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_WARNING_INDICATION_IN_OVERVIEW_RULER = "warningIndicationInOverviewRuler";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_TASK_INDICATION_IN_OVERVIEW_RULER = "taskIndicationInOverviewRuler";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_BOOKMARK_INDICATION_IN_OVERVIEW_RULER = "bookmarkIndicationInOverviewRuler";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_SEARCH_RESULT_INDICATION_IN_OVERVIEW_RULER = "searchResultIndicationInOverviewRuler";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_UNKNOWN_INDICATION_IN_OVERVIEW_RULER = "othersIndicationInOverviewRuler";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_OVERVIEW_RULER = "overviewRuler";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_LINE_NUMBER_RULER = "lineNumberRuler";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_LINE_NUMBER_RULER_COLOR = "lineNumberColor";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_LINKED_POSITION_COLOR = "linkedPositionColor";
	 ...
	 */
    @Deprecated
    public static final String EDITOR_FOREGROUND_DEFAULT_COLOR = AbstractTextEditor.PREFERENCE_COLOR_FOREGROUND_SYSTEM_DEFAULT;
	 ...
	 */
    @Deprecated
    public static final String EDITOR_BACKGROUND_DEFAULT_COLOR = AbstractTextEditor.PREFERENCE_COLOR_BACKGROUND_SYSTEM_DEFAULT;
	 ...
	 * @see org.eclipse.jface.preference.PreferenceConverter
	 */
    public static final String EDITOR_MULTI_LINE_COMMENT_COLOR = IJavaColorConstants.JAVA_MULTI_LINE_COMMENT;
	 ...
	 * </p>
	 */
    public static final String EDITOR_MULTI_LINE_COMMENT_BOLD = IJavaColorConstants.JAVA_MULTI_LINE_COMMENT + EDITOR_BOLD_SUFFIX;
	 ...
	 * @since 3.0
	 */
    public static final String EDITOR_MULTI_LINE_COMMENT_ITALIC = IJavaColorConstants.JAVA_MULTI_LINE_COMMENT + EDITOR_ITALIC_SUFFIX;
	 ...
	 * @since 3.1
	 */
    public static final String EDITOR_MULTI_LINE_COMMENT_STRIKETHROUGH = IJavaColorConstants.JAVA_MULTI_LINE_COMMENT + EDITOR_STRIKETHROUGH_SUFFIX;
	 ...
	 * @since 3.1
	 */
    public static final String EDITOR_MULTI_LINE_COMMENT_UNDERLINE = IJavaColorConstants.JAVA_MULTI_LINE_COMMENT + EDITOR_UNDERLINE_SUFFIX;
	 ...
	 * @see org.eclipse.jface.preference.PreferenceConverter
	 */
    public static final String EDITOR_SINGLE_LINE_COMMENT_COLOR = IJavaColorConstants.JAVA_SINGLE_LINE_COMMENT;
	 ...
	 * </p>
	 */
    public static final String EDITOR_SINGLE_LINE_COMMENT_BOLD = IJavaColorConstants.JAVA_SINGLE_LINE_COMMENT + EDITOR_BOLD_SUFFIX;
	 ...
	 * @since 3.0
	 */
    public static final String EDITOR_SINGLE_LINE_COMMENT_ITALIC = IJavaColorConstants.JAVA_SINGLE_LINE_COMMENT + EDITOR_ITALIC_SUFFIX;
	 ...
	 * @since 3.1
	 */
    public static final String EDITOR_SINGLE_LINE_COMMENT_STRIKETHROUGH = IJavaColorConstants.JAVA_SINGLE_LINE_COMMENT + EDITOR_STRIKETHROUGH_SUFFIX;
	 ...
	 * @since 3.1
	 */
    public static final String EDITOR_SINGLE_LINE_COMMENT_UNDERLINE = IJavaColorConstants.JAVA_SINGLE_LINE_COMMENT + EDITOR_UNDERLINE_SUFFIX;
	 ...
	 * @see org.eclipse.jface.preference.PreferenceConverter
	 */
    public static final String EDITOR_JAVA_KEYWORD_COLOR = IJavaColorConstants.JAVA_KEYWORD;
	 ...
	 * </p>
	 */
    public static final String EDITOR_JAVA_KEYWORD_BOLD = IJavaColorConstants.JAVA_KEYWORD + EDITOR_BOLD_SUFFIX;
	 ...
	 * @since 3.0
	 */
    public static final String EDITOR_JAVA_KEYWORD_ITALIC = IJavaColorConstants.JAVA_KEYWORD + EDITOR_ITALIC_SUFFIX;
	 ...
	 * @since 3.1
	 */
    public static final String EDITOR_JAVA_KEYWORD_STRIKETHROUGH = IJavaColorConstants.JAVA_KEYWORD + EDITOR_STRIKETHROUGH_SUFFIX;
	 ...
	 * @since 3.1
	 */
    public static final String EDITOR_JAVA_KEYWORD_UNDERLINE = IJavaColorConstants.JAVA_KEYWORD + EDITOR_UNDERLINE_SUFFIX;
	 ...
	 * @see org.eclipse.jface.preference.PreferenceConverter
	 */
    public static final String EDITOR_STRING_COLOR = IJavaColorConstants.JAVA_STRING;
	 ...
	 * </p>
	 */
    public static final String EDITOR_STRING_BOLD = IJavaColorConstants.JAVA_STRING + EDITOR_BOLD_SUFFIX;
	 ...
	 * @since 3.0
	 */
    public static final String EDITOR_STRING_ITALIC = IJavaColorConstants.JAVA_STRING + EDITOR_ITALIC_SUFFIX;
	 ...
	 * @since 3.1
	 */
    public static final String EDITOR_STRING_STRIKETHROUGH = IJavaColorConstants.JAVA_STRING + EDITOR_STRIKETHROUGH_SUFFIX;
	 ...
	 * @since 3.1
	 */
    public static final String EDITOR_STRING_UNDERLINE = IJavaColorConstants.JAVA_STRING + EDITOR_UNDERLINE_SUFFIX;
	 ...
	 */
    @Deprecated
    public static final String EDITOR_JAVA_METHOD_NAME_COLOR = IJavaColorConstants.JAVA_METHOD_NAME;
	 ...
	 */
    @Deprecated
    public static final String EDITOR_JAVA_METHOD_NAME_BOLD = IJavaColorConstants.JAVA_METHOD_NAME + EDITOR_BOLD_SUFFIX;
	 ...
	 */
    @Deprecated
    public static final String EDITOR_JAVA_METHOD_NAME_ITALIC = IJavaColorConstants.JAVA_METHOD_NAME + EDITOR_ITALIC_SUFFIX;
	 ...
	 * @since 3.0
	 */
    public static final String EDITOR_JAVA_KEYWORD_RETURN_COLOR = IJavaColorConstants.JAVA_KEYWORD_RETURN;
	 ...
	 * @since 3.0
	 */
    public static final String EDITOR_JAVA_KEYWORD_RETURN_BOLD = IJavaColorConstants.JAVA_KEYWORD_RETURN + EDITOR_BOLD_SUFFIX;
	 ...
	 * @since 3.0
	 */
    public static final String EDITOR_JAVA_KEYWORD_RETURN_ITALIC = IJavaColorConstants.JAVA_KEYWORD_RETURN + EDITOR_ITALIC_SUFFIX;
	 ...
	 * @since 3.1
	 */
    public static final String EDITOR_JAVA_KEYWORD_RETURN_STRIKETHROUGH = IJavaColorConstants.JAVA_KEYWORD_RETURN + EDITOR_STRIKETHROUGH_SUFFIX;
	 ...
	 * @since 3.1
	 */
    public static final String EDITOR_JAVA_KEYWORD_RETURN_UNDERLINE = IJavaColorConstants.JAVA_KEYWORD_RETURN + EDITOR_UNDERLINE_SUFFIX;
	 ...
	 * @since 3.0
	 */
    public static final String EDITOR_JAVA_OPERATOR_COLOR = IJavaColorConstants.JAVA_OPERATOR;
	 ...
	 * @since 3.0
	 */
    public static final String EDITOR_JAVA_OPERATOR_BOLD = IJavaColorConstants.JAVA_OPERATOR + EDITOR_BOLD_SUFFIX;
	 ...
	 * @since 3.0
	 */
    public static final String EDITOR_JAVA_OPERATOR_ITALIC = IJavaColorConstants.JAVA_OPERATOR + EDITOR_ITALIC_SUFFIX;
	 ...
	 * @since 3.1
	 */
    public static final String EDITOR_JAVA_OPERATOR_STRIKETHROUGH = IJavaColorConstants.JAVA_OPERATOR + EDITOR_STRIKETHROUGH_SUFFIX;
	 ...
	 * @since 3.1
	 */
    public static final String EDITOR_JAVA_OPERATOR_UNDERLINE = IJavaColorConstants.JAVA_OPERATOR + EDITOR_UNDERLINE_SUFFIX;
	 ...
	 * @since 3.3
	 */
    public static final String EDITOR_JAVA_BRACKET_COLOR = IJavaColorConstants.JAVA_BRACKET;
	 ...
	 * @since 3.3
	 */
    public static final String EDITOR_JAVA_BRACKET_BOLD = IJavaColorConstants.JAVA_BRACKET + EDITOR_BOLD_SUFFIX;
	 ...
	 * @since 3.3
	 */
    public static final String EDITOR_JAVA_BRACKET_ITALIC = IJavaColorConstants.JAVA_BRACKET + EDITOR_ITALIC_SUFFIX;
	 ...
	 * @since 3.3
	 */
    public static final String EDITOR_JAVA_BRACKET_STRIKETHROUGH = IJavaColorConstants.JAVA_BRACKET + EDITOR_STRIKETHROUGH_SUFFIX;
	 ...
	 * @since 3.3
	 */
    public static final String EDITOR_JAVA_BRACKET_UNDERLINE = IJavaColorConstants.JAVA_BRACKET + EDITOR_UNDERLINE_SUFFIX;
	 ...
	 */
    @Deprecated
    public static final String EDITOR_JAVA_ANNOTATION_COLOR = IJavaColorConstants.JAVA_ANNOTATION;
	 ...
	 */
    @Deprecated
    public static final String EDITOR_JAVA_ANNOTATION_BOLD = IJavaColorConstants.JAVA_ANNOTATION + EDITOR_BOLD_SUFFIX;
	 ...
	 */
    @Deprecated
    public static final String EDITOR_JAVA_ANNOTATION_ITALIC = IJavaColorConstants.JAVA_ANNOTATION + EDITOR_ITALIC_SUFFIX;
	 ...
	 */
    @Deprecated
    public static final String EDITOR_JAVA_ANNOTATION_STRIKETHROUGH = IJavaColorConstants.JAVA_ANNOTATION + EDITOR_STRIKETHROUGH_SUFFIX;
	 ...
	 */
    @Deprecated
    public static final String EDITOR_JAVA_ANNOTATION_UNDERLINE = IJavaColorConstants.JAVA_ANNOTATION + EDITOR_UNDERLINE_SUFFIX;
	 ...
	 * @see org.eclipse.jface.preference.PreferenceConverter
	 */
    public static final String EDITOR_JAVA_DEFAULT_COLOR = IJavaColorConstants.JAVA_DEFAULT;
	 ...
	 * </p>
	 */
    public static final String EDITOR_JAVA_DEFAULT_BOLD = IJavaColorConstants.JAVA_DEFAULT + EDITOR_BOLD_SUFFIX;
	 ...
	 * @since 3.0
	 */
    public static final String EDITOR_JAVA_DEFAULT_ITALIC = IJavaColorConstants.JAVA_DEFAULT + EDITOR_ITALIC_SUFFIX;
	 ...
	 * @since 3.1
	 */
    public static final String EDITOR_JAVA_DEFAULT_STRIKETHROUGH = IJavaColorConstants.JAVA_DEFAULT + EDITOR_STRIKETHROUGH_SUFFIX;
	 ...
	 * @since 3.1
	 */
    public static final String EDITOR_JAVA_DEFAULT_UNDERLINE = IJavaColorConstants.JAVA_DEFAULT + EDITOR_UNDERLINE_SUFFIX;
	 ...
	 * @since 2.1
	 */
    public static final String EDITOR_TASK_TAG_COLOR = IJavaColorConstants.TASK_TAG;
	 ...
	 * @since 2.1
	 */
    public static final String EDITOR_TASK_TAG_BOLD = IJavaColorConstants.TASK_TAG + EDITOR_BOLD_SUFFIX;
	 ...
	 * @since 3.0
	 */
    public static final String EDITOR_TASK_TAG_ITALIC = IJavaColorConstants.TASK_TAG + EDITOR_ITALIC_SUFFIX;
	 ...
	 * @since 3.1
	 */
    public static final String EDITOR_TASK_TAG_STRIKETHROUGH = IJavaColorConstants.TASK_TAG + EDITOR_STRIKETHROUGH_SUFFIX;
	 ...
	 * @since 3.1
	 */
    public static final String EDITOR_TASK_TAG_UNDERLINE = IJavaColorConstants.TASK_TAG + EDITOR_UNDERLINE_SUFFIX;
	 ...
	 * @see org.eclipse.jface.preference.PreferenceConverter
	 */
    public static final String EDITOR_JAVADOC_KEYWORD_COLOR = IJavaColorConstants.JAVADOC_KEYWORD;
	 ...
	 * </p>
	 */
    public static final String EDITOR_JAVADOC_KEYWORD_BOLD = IJavaColorConstants.JAVADOC_KEYWORD + EDITOR_BOLD_SUFFIX;
	 ...
	 * @since 3.0
	 */
    public static final String EDITOR_JAVADOC_KEYWORD_ITALIC = IJavaColorConstants.JAVADOC_KEYWORD + EDITOR_ITALIC_SUFFIX;
	 ...
	 *
	 */
    public static final String EDITOR_JAVADOC_KEYWORD_STRIKETHROUGH = IJavaColorConstants.JAVADOC_KEYWORD + EDITOR_STRIKETHROUGH_SUFFIX;
	 ...
	 * @since 3.1
	 */
    public static final String EDITOR_JAVADOC_KEYWORD_UNDERLINE = IJavaColorConstants.JAVADOC_KEYWORD + EDITOR_UNDERLINE_SUFFIX;
	 ...
	 * @see org.eclipse.jface.preference.PreferenceConverter
	 */
    public static final String EDITOR_JAVADOC_TAG_COLOR = IJavaColorConstants.JAVADOC_TAG;
	 ...
	 * </p>
	 */
    public static final String EDITOR_JAVADOC_TAG_BOLD = IJavaColorConstants.JAVADOC_TAG + EDITOR_BOLD_SUFFIX;
	 ...
	 * @since 3.0
	 */
    public static final String EDITOR_JAVADOC_TAG_ITALIC = IJavaColorConstants.JAVADOC_TAG + EDITOR_ITALIC_SUFFIX;
	 ...
	 * @since 3.1
	 */
    public static final String EDITOR_JAVADOC_TAG_STRIKETHROUGH = IJavaColorConstants.JAVADOC_TAG + EDITOR_STRIKETHROUGH_SUFFIX;
	 ...
	 * @since 3.1
	 */
    public static final String EDITOR_JAVADOC_TAG_UNDERLINE = IJavaColorConstants.JAVADOC_TAG + EDITOR_UNDERLINE_SUFFIX;
	 ...
	 * @see org.eclipse.jface.preference.PreferenceConverter
	 */
    public static final String EDITOR_JAVADOC_LINKS_COLOR = IJavaColorConstants.JAVADOC_LINK;
	 ...
	 * </p>
	 */
    public static final String EDITOR_JAVADOC_LINKS_BOLD = IJavaColorConstants.JAVADOC_LINK + EDITOR_BOLD_SUFFIX;
	 ...
	 * @since 3.0
	 */
    public static final String EDITOR_JAVADOC_LINKS_ITALIC = IJavaColorConstants.JAVADOC_LINK + EDITOR_ITALIC_SUFFIX;
	 ...
	 * @since 3.1
	 */
    public static final String EDITOR_JAVADOC_LINKS_STRIKETHROUGH = IJavaColorConstants.JAVADOC_LINK + EDITOR_STRIKETHROUGH_SUFFIX;
	 ...
	 * @since 3.1
	 */
    public static final String EDITOR_JAVADOC_LINKS_UNDERLINE = IJavaColorConstants.JAVADOC_LINK + EDITOR_UNDERLINE_SUFFIX;
	 ...
	 * @see org.eclipse.jface.preference.PreferenceConverter
	 */
    public static final String EDITOR_JAVADOC_DEFAULT_COLOR = IJavaColorConstants.JAVADOC_DEFAULT;
	 ...
	 * </p>
	 */
    public static final String EDITOR_JAVADOC_DEFAULT_BOLD = IJavaColorConstants.JAVADOC_DEFAULT + EDITOR_BOLD_SUFFIX;
	 ...
	 * @since 3.0
	 */
    public static final String EDITOR_JAVADOC_DEFAULT_ITALIC = IJavaColorConstants.JAVADOC_DEFAULT + EDITOR_ITALIC_SUFFIX;
	 ...
	 * @since 3.1
	 */
    public static final String EDITOR_JAVADOC_DEFAULT_STRIKETHROUGH = IJavaColorConstants.JAVADOC_DEFAULT + EDITOR_STRIKETHROUGH_SUFFIX;
	 ...
	 * @since 3.1
	 */
    public static final String EDITOR_JAVADOC_DEFAULT_UNDERLINE = IJavaColorConstants.JAVADOC_DEFAULT + EDITOR_UNDERLINE_SUFFIX;
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_CTRL_ALT_HOVER = "ctrlAltHover";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_CTRL_ALT_SHIFT_HOVER = "ctrlAltShiftHover";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_CTRL_SHIFT_HOVER = "ctrlShiftHover";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_ALT_SHIFT_HOVER = "altShiftHover";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_NO_HOVER_CONFIGURED_ID = "noHoverConfiguredId";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_DEFAULT_HOVER_CONFIGURED_ID = "defaultHoverConfiguredId";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_DEFAULT_HOVER = "defaultHover";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_BROWSER_LIKE_LINKS = "browserLikeLinks";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_BROWSER_LIKE_LINKS_KEY_MODIFIER = "browserLikeLinksKeyModifier";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_BROWSER_LIKE_LINKS_KEY_MODIFIER_MASK = "browserLikeLinksKeyModifierMask";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    EDITOR_SEMANTIC_HIGHLIGHTING_ENABLED = EDITOR_SEMANTIC_HIGHLIGHTING_PREFIX + "enabled";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    SPELLING_CHECK_SPELLING = "spelling_check_spelling";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    FORMATTER_COMMENT_FORMATSOURCE = "comment_format_source_code";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    FORMATTER_COMMENT_INDENTPARAMETERDESCRIPTION = "comment_indent_parameter_description";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    FORMATTER_COMMENT_FORMATHEADER = "comment_format_header";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    FORMATTER_COMMENT_INDENTROOTTAGS = "comment_indent_root_tags";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    FORMATTER_COMMENT_FORMAT = "comment_format_comments";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    FORMATTER_COMMENT_NEWLINEFORPARAMETER = "comment_new_line_for_parameter";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    FORMATTER_COMMENT_SEPARATEROOTTAGS = "comment_separate_root_tags";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    FORMATTER_COMMENT_LINELENGTH = "comment_line_length";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    FORMATTER_COMMENT_FORMATHTML = "comment_format_html";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    CODEASSIST_ORDER_PROPOSALS = "content_assist_order_proposals";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    CODEASSIST_PROPOSALS_BACKGROUND = "content_assist_proposals_background";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    CODEASSIST_PROPOSALS_FOREGROUND = "content_assist_proposals_foreground";
    ...
    @Deprecated
    public static final String //$NON-NLS-1$
    REFACTOR_ERROR_PAGE_SEVERITY_THRESHOLD = "Refactoring.ErrorPage.severityThreshold";
    ...
    public static void initializeDefaultValues(IPreferenceStore store) {
        ...
        // clear preference, update on save not supported anymore
        store.setToDefault(PreferenceConstants.UPDATE_JAVA_VIEWS);
        ...
        //$NON-NLS-1$
        store.setDefault(PreferenceConstants.APPEARANCE_PKG_NAME_PATTERN_FOR_PKG_VIEW, "");
        ...
        //$NON-NLS-1$
        store.setDefault(PreferenceConstants.APPEARANCE_PKG_NAME_ABBREVIATION_PATTERN_FOR_PKG_VIEW, "");
        // ImportOrganizePreferencePage
        //$NON-NLS-1$
        store.setDefault(PreferenceConstants.ORGIMPORTS_IMPORTORDER, "java;javax;org;com");
        ...
        //$NON-NLS-1$
        store.setDefault(PreferenceConstants.TYPEFILTER_ENABLED, "");
        //$NON-NLS-1$
        store.setDefault(PreferenceConstants.TYPEFILTER_DISABLED, "");
        ...
        //$NON-NLS-1$
        store.setDefault(PreferenceConstants.CODEGEN_EXCEPTION_VAR_NAME, "e");
        ...
        //$NON-NLS-1$
        store.setDefault(PreferenceConstants.APPEARANCE_MEMBER_SORT_ORDER, "T,SF,SI,SM,F,I,C,M");
        //$NON-NLS-1$
        store.setDefault(PreferenceConstants.APPEARANCE_VISIBILITY_SORT_ORDER, "B,V,R,D");
        ...
        //$NON-NLS-1$
        store.setDefault(PreferenceConstants.CODEASSIST_AUTOACTIVATION_TRIGGERS_JAVADOC, "@#");
        ...
        //$NON-NLS-1$
        store.setDefault(PreferenceConstants.CODEASSIST_EXCLUDED_CATEGORIES, "org.eclipse.jdt.ui.textProposalCategory\0org.eclipse.jdt.ui.javaTypeProposalCategory\0org.eclipse.jdt.ui.javaNoTypeProposalCategory\0");
        //$NON-NLS-1$
        store.setDefault(PreferenceConstants.CODEASSIST_CATEGORY_ORDER, "org.eclipse.jdt.ui.spellingProposalCategory:65545\0org.eclipse.jdt.ui.javaTypeProposalCategory:65540\0org.eclipse.jdt.ui.javaNoTypeProposalCategory:65539\0org.eclipse.jdt.ui.textProposalCategory:65541\0org.eclipse.jdt.ui.javaAllProposalCategory:65542\0org.eclipse.jdt.ui.templateProposalCategory:2\0org.eclipse.jdt.ui.swtProposalCategory:3\0");
        //$NON-NLS-1$
        store.setDefault(PreferenceConstants.CODEASSIST_LRU_HISTORY, "");
        //$NON-NLS-1$
        store.setDefault(PreferenceConstants.CODEASSIST_SORTER, "org.eclipse.jdt.ui.RelevanceSorter");
        //$NON-NLS-1$
        store.setDefault(PreferenceConstants.CODEASSIST_FAVORITE_STATIC_MEMBERS, "");
        ...
        // Shift
        String sourceHoverModifierName = Action.findModifierString(sourceHoverModifier);
        int nlsHoverModifier = SWT.MOD1 + SWT.MOD3;
        // Ctrl + Alt //$NON-NLS-1$
        String nlsHoverModifierName = Action.findModifierString(SWT.MOD1) + "+" + Action.findModifierString(SWT.MOD3);
        int javadocHoverModifier = SWT.MOD1 + SWT.MOD2;
        // Ctrl + Shift //$NON-NLS-1$
        String javadocHoverModifierName = Action.findModifierString(SWT.MOD1) + "+" + Action.findModifierString(SWT.MOD2);
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        store.setDefault(PreferenceConstants.EDITOR_TEXT_HOVER_MODIFIERS, "org.eclipse.jdt.ui.BestMatchHover;0;org.eclipse.jdt.ui.JavaSourceHover;" + sourceHoverModifierName + ";org.eclipse.jdt.ui.NLSStringHover;" + nlsHoverModifierName + ";org.eclipse.jdt.ui.JavadocHover;" + javadocHoverModifierName);
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        store.setDefault(PreferenceConstants.EDITOR_TEXT_HOVER_MODIFIER_MASKS, "org.eclipse.jdt.ui.BestMatchHover;0;org.eclipse.jdt.ui.JavaSourceHover;" + sourceHoverModifier + ";org.eclipse.jdt.ui.NLSStringHover;" + nlsHoverModifier + ";org.eclipse.jdt.ui.JavadocHover;" + javadocHoverModifier);
        ...
        //$NON-NLS-1$
        String isInitializedKey = "spelling_locale_initialized";
        ...
        //$NON-NLS-1$
        store.setDefault(PreferenceConstants.SPELLING_USER_DICTIONARY, "");
        // Note: For backwards compatibility we must use the property and not the workspace default
        //$NON-NLS-1$
        store.setDefault(PreferenceConstants.SPELLING_USER_DICTIONARY_ENCODING, System.getProperty("file.encoding"));
        ...
        //$NON-NLS-1$
        store.setDefault(PreferenceConstants.EDITOR_FOLDING_PROVIDER, "org.eclipse.jdt.ui.text.defaultFoldingProvider");
        ...
        // global
        store.setToDefault(EDITOR_SMART_HOME_END);
        // global
        store.setToDefault(EDITOR_LINE_NUMBER_RULER);
        // global
        store.setToDefault(EDITOR_LINE_NUMBER_RULER_COLOR);
        // removed -> true
        store.setToDefault(EDITOR_OVERVIEW_RULER);
        // accessibility
        store.setToDefault(AbstractDecoratedTextEditorPreferenceConstants.EDITOR_USE_CUSTOM_CARETS);
        // global
        store.setToDefault(PreferenceConstants.EDITOR_CURRENT_LINE);
        // global
        store.setToDefault(PreferenceConstants.EDITOR_CURRENT_LINE_COLOR);
        // global
        store.setToDefault(PreferenceConstants.EDITOR_PRINT_MARGIN);
        // global
        store.setToDefault(PreferenceConstants.EDITOR_PRINT_MARGIN_COLUMN);
        // global
        store.setToDefault(PreferenceConstants.EDITOR_PRINT_MARGIN_COLOR);
        // global
        store.setToDefault(PreferenceConstants.EDITOR_FOREGROUND_COLOR);
        // global
        store.setToDefault(PreferenceConstants.EDITOR_FOREGROUND_DEFAULT_COLOR);
        // global
        store.setToDefault(PreferenceConstants.EDITOR_BACKGROUND_COLOR);
        // global
        store.setToDefault(PreferenceConstants.EDITOR_BACKGROUND_DEFAULT_COLOR);
        // global
        store.setToDefault(PreferenceConstants.EDITOR_FIND_SCOPE_COLOR);
        // global
        ...
        // global
        store.setToDefault(PreferenceConstants.EDITOR_DISABLE_OVERWRITE_MODE);
        // removed
        store.setToDefault(PreferenceConstants.EDITOR_SEMANTIC_HIGHLIGHTING_ENABLED);
        // global
        store.setToDefault(PreferenceConstants.EDITOR_SHOW_TEXT_HOVER_AFFORDANCE);
        //Code Clean Up
        ...
        //$NON-NLS-1$
        store.setDefault(PREF_DEFAULT_EXPAND_WITH_CONSTRUCTORS_MEMBERS, "java.lang.Runnable.run;java.util.concurrent.Callable.call;org.eclipse.swt.widgets.Listener.handleEvent");
        // compatibility code
        String str = store.getString(CallHierarchyContentProvider.OLD_PREF_DEFAULT_EXPAND_WITH_CONSTRUCTORS);
        if (str.length() > 0) {
            //$NON-NLS-1$
            String[] oldPrefStr = str.split(";");
            for (int i = 0; i < oldPrefStr.length; i++) {
                oldPrefStr[i] = //$NON-NLS-1$
                oldPrefStr[i] + //$NON-NLS-1$
                (".*");
            }
