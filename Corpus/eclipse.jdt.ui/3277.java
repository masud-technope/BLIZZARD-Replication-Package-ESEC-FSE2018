...
public final class SuperTypeConstraintsCreator extends HierarchicalASTVisitor {
    ...
    private static void getOriginalMethods(final IMethodBinding binding, final ITypeBinding type, final Collection<IMethodBinding> originals, final boolean implementations) {
        ...
        if (!implementations) {
            ...
            for (int index = 0; index < types.length; index++) getOriginalMethods(binding, types[index], originals, implementations);
            if (ancestor != null)
    ...
    public final void endVisit(final CatchClause node) {
        ...
        if (declaration != null) {
            ...
            if (descendant != null) {
                final ITypeBinding binding = //$NON-NLS-1$
                node.getAST().resolveWellKnownType(//$NON-NLS-1$
                "java.lang.Throwable");
                if (binding != null) {
    ...
    public final void endVisit(final MethodDeclaration node) {
        ...
        if (binding != null) {
            ...
            if (!exceptions.isEmpty()) {
                final ITypeBinding throwable = //$NON-NLS-1$
                node.getAST().resolveWellKnownType(//$NON-NLS-1$
                "java.lang.Throwable");
                if (throwable != null) {
