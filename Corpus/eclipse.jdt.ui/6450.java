    ...
    private static class DeleteResourcesRefactoringConfigurationPage extends UserInputWizardPage {
        ...
        public void createControl(Composite parent) {
            ...
            if (onlyProjects) {
                ...
                projectLocationsLabel.setText(resources.length == 1 ? RefactoringUIMessages.DeleteResourcesWizard_project_location : RefactoringUIMessages.DeleteResourcesWizard_project_locations);
        ...
        private boolean containsLinkedResource(IResource[] resources) {
            for (int i = 0; i < resources.length; i++) {
                ...
                if (// paranoia code, can not be null
