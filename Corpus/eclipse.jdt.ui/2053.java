...
public class TypeConstraintTests extends RefactoringTest {
    ...
    private static List<String> allToStrings(Object[] elements) {
        ...
        //want to be able to remove stuff from it
    ...
    public void testConstraints11() throws Exception {
        String[] strings = { "[null] <= [A:f(A, Object)]_returnType", "[Parameter(1,B:f(A, Object))] =^= [a4]", "[B:f(A, Object)]_returnType =^= A", "Decl(B:f(A, Object)) < Decl(A:f(A, Object))", "[Parameter(1,A:f(A, Object))] == [Parameter(1,B:f(A, Object))]", "[Parameter(0,A:f(A, Object))] == [Parameter(0,B:f(A, Object))]", "[A:f(A, Object)]_returnType == [B:f(A, Object)]_returnType", "[Parameter(0,B:f(A, Object))] =^= [a3]", "[Parameter(0,A:f(A, Object))] =^= [a0]", "Decl(A:f(A, Object)) =^= p.A", "[null] <= [B:f(A, Object)]_returnType", "[Parameter(1,A:f(A, Object))] =^= [a1]", "[A:f(A, Object)]_returnType =^= A", "Decl(B:f(A, Object)) =^= p.B", "[a3] =^= A", "[a0] =^= A", "[a1] =^= Object", "[a4] =^= Object" };
        testConstraints(strings);
    }
