...
public class AddSourceFolderWizard extends BuildPathWizard {
    ...
    public void addPages() {
        super.addPages();
        fAddFolderPage = new AddSourceFolderWizardPage(getEntryToEdit(), getExistingEntries(), getOutputLocation(), fLinkedMode, fCanCommitConflict, fAllowConflict, fAllowRemoveProjectFolder, fAllowAddExclusionPatterns, fParent);
