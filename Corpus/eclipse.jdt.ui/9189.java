...
public class CallHierarchyTestHelper {
    ...
    public void createAnonymousInnerClassInsideMethod() throws Exception {
        ...
        fType1 = cu1.createType("public class AnonymousInnerInsideMethod {\n" + "  void m() {\n" + "    System.out.println(\"before\");\n" + "    Runnable runnable = new Runnable() {\n" + "      public void run() {\n" + "        System.out.println(\"run\");\n" + "      }\n" + "    };\n" + "    runnable.run();\n" + "  }\n" + "}\n", null, true, null);
    }
    ...
    public void createStaticInitializerClass() throws Exception {
        ...
        fType1 = cu1.createType("public class Initializer { static { someMethod(); }\n public static void someMethod() { }\n }\n", null, true, null);
    }
