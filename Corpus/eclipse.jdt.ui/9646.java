...
class JarOptionsPage extends WizardPage implements IJarPackageWizardPage {
    ...
    //$NON-NLS-1$
    private static final String STORE_EXPORT_WARNINGS = PAGE_NAME + ".EXPORT_WARNINGS";

    //$NON-NLS-1$
    private static final String STORE_EXPORT_ERRORS = PAGE_NAME + ".EXPORT_ERRORS";

    //$NON-NLS-1$
    private static final String STORE_SAVE_DESCRIPTION = PAGE_NAME + ".SAVE_DESCRIPTION";

    //$NON-NLS-1$
    private static final String STORE_DESCRIPTION_LOCATION = PAGE_NAME + ".DESCRIPTION_LOCATION";

    //$NON-NLS-1$
    private static final String STORE_USE_SRC_FOLDERS = PAGE_NAME + ".STORE_USE_SRC_FOLDERS";

    //$NON-NLS-1$
    private static final String STORE_BUILD_IF_NEEDED = PAGE_NAME + ".BUILD_IF_NEEDED";
    ...
    protected void initializeJarPackage() {
        ...
        if (settings != null) {
            ...
            // bug 15877
            fJarPackage.setSaveDescription(false);
