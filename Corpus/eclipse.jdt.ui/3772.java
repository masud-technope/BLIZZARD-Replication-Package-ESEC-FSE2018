...
public class JavadocProblemsConfigurationBlock extends OptionsConfigurationBlock {
    ...
    protected void validateSettings(Key changedKey, String oldValue, String newValue) {
        ...
        if (changedKey != null) {
            if (PREF_PB_INVALID_JAVADOC.equals(changedKey) || PREF_PB_MISSING_JAVADOC_TAGS.equals(changedKey) || PREF_PB_MISSING_JAVADOC_COMMENTS.equals(changedKey) || PREF_JAVADOC_SUPPORT.equals(changedKey) || PREF_PB_INVALID_JAVADOC_TAGS.equals(changedKey)) {
                updateEnableStates();
            } else {
                return;
            }
