...
public class PromoteTempToFieldTests extends RefactoringTest {
    ...
    protected void passHelper(int startLine, int startColumn, int endLine, int endColumn, String newName, boolean declareStatic, boolean declareFinal, int initializeIn, int accessModifier) throws Exception {
    ...
    protected void failHelper(int startLine, int startColumn, int endLine, int endColumn, String newName, boolean declareStatic, boolean declareFinal, int initializeIn, int accessModifier, int expectedSeverity) throws Exception {
    ...
    private void enablementHelper(int startLine, int startColumn, int endLine, int endColumn, String newName, boolean declareStatic, boolean declareFinal, int initializeIn, int accessModifier, boolean expectedCanEnableSettingFinal, boolean expectedCanEnableSettingStatic, boolean expectedCanEnableInitInField, boolean expectedCanEnableInitInMethod, boolean expectedCanEnableInitInConstructors) throws Exception {
    ...
    private void enablementHelper1(int startLine, int startColumn, int endLine, int endColumn, boolean expectedCanEnableSettingFinal, boolean expectedCanEnableSettingStatic, boolean expectedCanEnableInitInField, boolean expectedCanEnableInitInMethod, boolean expectedCanEnableInitInConstructors) throws Exception {
        enablementHelper(startLine, startColumn, endLine, endColumn, "i", false, false, PromoteTempToFieldRefactoring.INITIALIZE_IN_METHOD, Modifier.PRIVATE, expectedCanEnableSettingFinal, expectedCanEnableSettingStatic, expectedCanEnableInitInField, expectedCanEnableInitInMethod, expectedCanEnableInitInConstructors);
    }
    ...
    public void testEnablement0() throws Exception {
        ...
        enablementHelper(5, 13, 5, 14, newName, declareStatic, declareFinal, initializeIn, accessModifier, expectedCanEnableSettingFinal, expectedCanEnableSettingStatic, expectedCanEnableInitInField, expectedCanEnableInitInMethod, expectedCanEnableInitInConstructors);
    }
    ...
    public void testEnablement5() throws Exception {
        ...
        int initializeIn = PromoteTempToFieldRefactoring.INITIALIZE_IN_FIELD;
        int accessModifier = Modifier.PRIVATE;
        enablementHelper(7, 21, 7, 22, newName, declareStatic, declareFinal, initializeIn, accessModifier, expectedCanEnableSettingFinal, expectedCanEnableSettingStatic, expectedCanEnableInitInField, expectedCanEnableInitInMethod, expectedCanEnableInitInConstructors);
    }
    ...
    public void testEnablement8() throws Exception {
        ...
        int accessModifier = Modifier.PRIVATE;
        enablementHelper(4, 13, 4, 14, newName, declareStatic, declareFinal, initializeIn, accessModifier, expectedCanEnableSettingFinal, expectedCanEnableSettingStatic, expectedCanEnableInitInField, expectedCanEnableInitInMethod, expectedCanEnableInitInConstructors);
    }
    ...
    public void testEnablement10() throws Exception {
        ...
        int initializeIn = PromoteTempToFieldRefactoring.INITIALIZE_IN_METHOD;
        int accessModifier = Modifier.PRIVATE;
        enablementHelper(6, 12, 6, 12, newName, declareStatic, declareFinal, initializeIn, accessModifier, expectedCanEnableSettingFinal, expectedCanEnableSettingStatic, expectedCanEnableInitInField, expectedCanEnableInitInMethod, expectedCanEnableInitInConstructors);
    }
    ...
    public void testEnablement11() throws Exception {
        ...
        int initializeIn = PromoteTempToFieldRefactoring.INITIALIZE_IN_METHOD;
        int accessModifier = Modifier.PRIVATE;
        enablementHelper(6, 21, 6, 27, newName, declareStatic, declareFinal, initializeIn, accessModifier, expectedCanEnableSettingFinal, expectedCanEnableSettingStatic, expectedCanEnableInitInField, expectedCanEnableInitInMethod, expectedCanEnableInitInConstructors);
    }
    ...
    public void testEnablement12() throws Exception {
        ...
        int initializeIn = PromoteTempToFieldRefactoring.INITIALIZE_IN_METHOD;
        int accessModifier = Modifier.PRIVATE;
        enablementHelper(5, 16, 5, 17, newName, declareStatic, declareFinal, initializeIn, accessModifier, expectedCanEnableSettingFinal, expectedCanEnableSettingStatic, expectedCanEnableInitInField, expectedCanEnableInitInMethod, expectedCanEnableInitInConstructors);
    }
    ...
    public void testEnablement13() throws Exception {
        ...
        int initializeIn = PromoteTempToFieldRefactoring.INITIALIZE_IN_METHOD;
        int accessModifier = Modifier.PRIVATE;
        enablementHelper(4, 18, 4, 19, newName, declareStatic, declareFinal, initializeIn, accessModifier, expectedCanEnableSettingFinal, expectedCanEnableSettingStatic, expectedCanEnableInitInField, expectedCanEnableInitInMethod, expectedCanEnableInitInConstructors);
    }
    ...
    public //test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=49840
    void test19() throws //test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=49840
    Exception {
        int accessModifier = Modifier.PRIVATE;
        int initializeIn = PromoteTempToFieldRefactoring.INITIALIZE_IN_METHOD;
        boolean declareFinal = false;
    ...
    public //test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=49840
    void test20() throws //test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=49840
    Exception {
        int accessModifier = Modifier.PRIVATE;
        int initializeIn = PromoteTempToFieldRefactoring.INITIALIZE_IN_METHOD;
        boolean declareFinal = false;
    ...
    public //test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=47798
    void test21() throws //test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=47798
    Exception {
        int accessModifier = Modifier.PRIVATE;
        int initializeIn = PromoteTempToFieldRefactoring.INITIALIZE_IN_FIELD;
        boolean declareFinal = true;
    ...
    public //test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=54444
    void test22() throws //test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=54444
    Exception {
        ICompilationUnit cu = createCUfromTestFile(getPackageP(), true, true);
    ...
    public //syntax error
    void test23() throws //syntax error
    Exception {
        int accessModifier = Modifier.PRIVATE;
        int initializeIn = PromoteTempToFieldRefactoring.INITIALIZE_IN_FIELD;
        boolean declareFinal = false;
    ...
    public //syntax error
    void test24() throws //syntax error
    Exception {
        int accessModifier = Modifier.PRIVATE;
        int initializeIn = PromoteTempToFieldRefactoring.INITIALIZE_IN_METHOD;
        boolean declareFinal = false;
    ...
    public //test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=136911
    void test25() throws //test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=136911
    Exception {
        int accessModifier = Modifier.PRIVATE;
        int initializeIn = PromoteTempToFieldRefactoring.INITIALIZE_IN_METHOD;
        boolean declareFinal = false;
