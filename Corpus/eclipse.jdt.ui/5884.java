...
public class BinaryReferencesTests extends TestCase {
    ...
    public void testRenameVirtualMethod01() throws Exception {
        ...
        assertContainsMatches(matches, new String[] { "=BinaryReference/binary<ref(SubClass.class[SubClass~baseMethod" });
    }

    public void testRenameVirtualMethod02() throws Exception {
        List<SearchMatch> matches = doRenameMethod("source.BaseClass", "compareTo");
        assertContainsMatches(matches, new String[] { "=BinaryReference/binary<ref(SubClass.class[SubClass~compareTo~Lsource.BaseClass;" });
    }
    ...
    public void testRenameVirtualMethod03() throws Exception {
        ...
        assertContainsMatches(matches, new String[] { "=BinaryReference/binary<ref(ReferenceClass.class[ReferenceClass~main~\\[Ljava.lang.String;", "=BinaryReference/binary<ref(ReferenceClass.class[ReferenceClass~main~\\[Ljava.lang.String;", "=BinaryReference/binary<ref(SubClass.class[SubClass~baseMethod" });
    }
    ...
    public void testRenameField01() throws Exception {
        ...
        assertContainsMatches(matches, new String[] { "=BinaryReference/binary<ref(SubClass.class[SubClass~SubClass~I" });
    }
    ...
    public void testRenameField04() throws Exception {
        if (// https://bugs.eclipse.org/bugs/show_bug.cgi?id=226660
        BUG_226660)
            return;
    ...
    public void testChangeSignature01() throws Exception {
        ...
        assertContainsMatches(matches, new String[] { "=BinaryReference/binary<ref(SubClass.class[SubClass~baseMethod", "=BinaryReference/binary<ref(SubClass.class[SubClass~baseMethod" });
    }
    ...
    public void testChangeConstructorSignature01() throws Exception {
        ...
        assertContainsMatches(matches, new String[] { "=BinaryReference/binary<ref(SubClass.class[SubClass~SubClass~I", "=BinaryReference/binary<ref(ReferenceClass.class[ReferenceClass~main~\\[Ljava.lang.String;" });
    }
    ...
    public void testMoveStaticMember01() throws Exception {
        ...
        assertContainsMatches(matches, new String[] { "=BinaryReference/binary<ref(ReferenceClass.class[ReferenceClass~main~\\[Ljava.lang.String;", "=BinaryReference/binary<ref(ReferenceClass.class[ReferenceClass~main~\\[Ljava.lang.String;" });
    }
