...
public class PropertiesFileSourceViewerConfiguration extends TextSourceViewerConfiguration {
    ...
    public String[] getConfiguredContentTypes(ISourceViewer sourceViewer) {
        ...
        for (int i = 0; i < length; i++) contentTypes[i + 1] = IPropertiesFilePartitions.PARTITIONS[i];
        return contentTypes;
    }
    ...
    public boolean affectsTextPresentation(PropertyChangeEvent event) {
        return fPropertyKeyScanner.affectsBehavior(event) || fCommentScanner.affectsBehavior(event) || fPropertyValueScanner.affectsBehavior(event);
    }
    ...
    protected Map<String, IAdaptable> getHyperlinkDetectorTargets(ISourceViewer sourceViewer) {
        ...
        //$NON-NLS-1$
        targets.put("org.eclipse.jdt.ui.PropertiesFileEditor", fTextEditor);
        return targets;
    }
    ...
    public IQuickAssistAssistant getQuickAssistAssistant(ISourceViewer sourceViewer) {
        if (getEditor() != null) {
            ...
            //$NON-NLS-1$
            assistant.setRestoreCompletionProposalSize(JavaPlugin.getDefault().getDialogSettingsSection("quick_assist_proposal_size"));
            return assistant;
        }
        return null;
    }
