...
public interface IHtmlTagConstants {
    ...
    public static final String[] HTML_ENTITY_CODES = new String[] { "&lt;", "&gt;", "&nbsp;", "&amp;", "&circ;", "&tilde;", "&quot;" };
    ...
    public static final String[] HTML_GENERAL_TAGS = new String[] { "a", "b", "blockquote", "br", "code", "dd", "dl", "dt", "em", "hr", "h1", "h2", "h3", "h4", "h5", "h6", "i", "li", "nl", "ol", "p", "pre", "q", "strong", "tbody", "td", "th", "tr", "tt", "ul" };
