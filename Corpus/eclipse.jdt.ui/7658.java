...
public final class ConvertIterableLoopOperation extends ConvertLoopOperation {
        ...
        if (body != null) {
            ...
            body.accept(new ASTVisitor() {
                ...
                public final boolean visit(final MethodInvocation node) {
                    ...
                    binding != null && (binding.getName().equals("next") || binding.getName().equals("nextElement"))) {
                        ...
                        fragment.accept(new ASTVisitor() {
                            ...
                            public final boolean visit(final MethodInvocation node) {
                                ...
                                if (binding != null) {
                                    ...
                                    if (type != null) {
                                        ...
                                        if (qualified.startsWith("java.util.Enumeration<") || //$NON-NLS-1$ //$NON-NLS-2$
                                        qualified.startsWith(//$NON-NLS-1$ //$NON-NLS-2$
                                        "java.util.Iterator<")) {
                                            final Expression qualifier = node.getExpression();
                                            if (qualifier != null) {
                                                final ITypeBinding resolved = qualifier.resolveTypeBinding();
                                                if (resolved != null) {
                                                    final ITypeBinding //$NON-NLS-1$
                                                    iterable = //$NON-NLS-1$
                                                    getSuperType(resolved, "java.lang.Iterable");
                                                    if (iterable != null) {
                                                ...
                                                if (declaring != null) {
                                                    final ITypeBinding //$NON-NLS-1$
                                                    superBinding = //$NON-NLS-1$
                                                    getSuperType(declaring, "java.lang.Iterable");
                            ...
                            public final boolean visit(final VariableDeclarationFragment node) {
                                ...
                                if (binding != null) {
                                    ...
                                    if (type != null) {
                                        ITypeBinding iterator = getSuperType(//$NON-NLS-1$
                                        type, //$NON-NLS-1$
                                        "java.util.Iterator");
                                        if (iterator != null)
                                            fIteratorVariable = binding;
                                        else {
                                            iterator = getSuperType(//$NON-NLS-1$
                                            type, //$NON-NLS-1$
                    ...
                    public boolean visit(SimpleName node) {
                        ...
                        if (nodeBinding == fIteratorVariable) {
                            if (node.getLocationInParent() == MethodInvocation.EXPRESSION_PROPERTY) {
                                ...
                                if (//$NON-NLS-1$ //$NON-NLS-2$
                                name.equals("next") || //$NON-NLS-1$ //$NON-NLS-2$
                                name.equals("nextElement")) {
    ...
    private IStatus checkExpressionCondition() {
        ...
        if (//$NON-NLS-1$
        qualifiedName.startsWith("java.util.Enumeration")) {
            if (//$NON-NLS-1$
            !methodName.equals("hasMoreElements"))
                return SEMANTIC_CHANGE_WARNING_STATUS;
        } else if (//$NON-NLS-1$
        qualifiedName.startsWith("java.util.Iterator")) {
            if (//$NON-NLS-1$
