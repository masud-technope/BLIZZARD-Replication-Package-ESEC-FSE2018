...
public class JavaCompareAction implements IActionDelegate {
    ...
    public void run(IAction action) {
        ...
        fJavaElementLabelProvider = new JavaElementLabelProvider(JavaElementLabelProvider.SHOW_PARAMETERS | JavaElementLabelProvider.SHOW_OVERLAY_ICONS | JavaElementLabelProvider.SHOW_POST_QUALIFIED | JavaElementLabelProvider.SHOW_ROOT);
