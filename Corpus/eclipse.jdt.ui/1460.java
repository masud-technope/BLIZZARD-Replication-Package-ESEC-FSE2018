...
public class MemberFilterActionGroup extends ActionGroup {
    ...
    public  MemberFilterActionGroup(StructuredViewer viewer, String viewerId, boolean inViewMenu, int availableFilters) {
        ...
        if (isSet(filterProperty, availableFilters)) {
            ...
            //$NON-NLS-1$
            JavaPluginImages.setLocalImageDescriptors(hideFields, "fields_co.png");
        ...
        if (isSet(filterProperty, availableFilters)) {
            ...
            //$NON-NLS-1$
            JavaPluginImages.setLocalImageDescriptors(hideStatic, "static_co.png");
        ...
        if (isSet(filterProperty, availableFilters)) {
            ...
            //$NON-NLS-1$
            JavaPluginImages.setLocalImageDescriptors(hideNonPublic, "public_co.png");
        ...
        if (isSet(filterProperty, availableFilters)) {
            ...
            //$NON-NLS-1$
            JavaPluginImages.setLocalImageDescriptors(hideLocalTypes, "localtypes_co.png");
