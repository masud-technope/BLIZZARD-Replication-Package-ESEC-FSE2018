...
public class JavaSourceViewerConfiguration extends TextSourceViewerConfiguration {
	 ...
	 */
    @Deprecated
    public static final String PREFERENCE_TAB_WIDTH = PreferenceConstants.EDITOR_TAB_WIDTH;
	 ...
	 */
    @Deprecated
    public static final String SPACES_FOR_TABS = PreferenceConstants.EDITOR_SPACES_FOR_TABS;
    ...
    public IQuickAssistAssistant getQuickAssistAssistant(ISourceViewer sourceViewer) {
        if (getEditor() != null) {
            ...
            //$NON-NLS-1$
            assistant.setRestoreCompletionProposalSize(getSettings("quick_assist_proposal_size"));
            return assistant;
        }
        return null;
    }
    ...
    public String[] getIndentPrefixes(ISourceViewer sourceViewer, String contentType) {
        ...
        if (!allowTabs) {
            ...
            Arrays.fill(spaces, ' ');
            //$NON-NLS-1$
            return new String[] { new String(spaces), "" };
        } else if (!useSpaces)
    ...
    public String[] getConfiguredContentTypes(ISourceViewer sourceViewer) {
        return new String[] { IDocument.DEFAULT_CONTENT_TYPE, IJavaPartitions.JAVA_DOC, IJavaPartitions.JAVA_MULTI_LINE_COMMENT, IJavaPartitions.JAVA_SINGLE_LINE_COMMENT, IJavaPartitions.JAVA_STRING, IJavaPartitions.JAVA_CHARACTER };
    }
    ...
    public IInformationPresenter getInformationPresenter(ISourceViewer sourceViewer) {
        ...
        for (int i = 0; i < contentTypes.length; i++) presenter.setInformationProvider(provider, contentTypes[i]);
    ...
    protected Map<String, IAdaptable> getHyperlinkDetectorTargets(ISourceViewer sourceViewer) {
        ...
        //$NON-NLS-1$
        targets.put("org.eclipse.jdt.ui.javaCode", fTextEditor);
        return targets;
    }
}
