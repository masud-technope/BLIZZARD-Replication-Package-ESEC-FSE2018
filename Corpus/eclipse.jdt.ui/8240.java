...
public class ProblemSeveritiesConfigurationBlock extends OptionsConfigurationBlock {
    ...
    private class NullAnnotationsConfigurationDialog extends StatusDialog {
        ...
        private class AnnotationWrapper {
            ...
            // mimic a mutable string
            public String annotationName;

            // null means: no status computed, yet.
        ...
        private class AnnotationListDialogField extends ListDialogField<AnnotationWrapper> implements IAnnotationDialogField {
            ...
            public void addElementsFromCommaSeparatedList(String value) {
                ...
                if (value.isEmpty())
                    return;
                String[] strings = //$NON-NLS-1$
                value.split(//$NON-NLS-1$
                ",");
                for (int i = 0; i < strings.length; i++) addElement(new AnnotationWrapper(strings[i].trim()));
            }
        ...
        protected Control createDialogArea(Composite parent) {
            ...
            layout.numColumns = 1;
            // heuristic to match the default size of the dialog
            int fieldWidthHint = convertWidthInCharsToPixels(90);
            ...
            String[] texts = { PreferencesMessages.NullAnnotationsConfigurationDialog_nullable_annotations_label, PreferencesMessages.NullAnnotationsConfigurationDialog_nullable_annotations_description };
            ...
            texts = new String[] { PreferencesMessages.NullAnnotationsConfigurationDialog_nonnull_annotations_label, PreferencesMessages.NullAnnotationsConfigurationDialog_nonnull_annotations_description };
            ...
            texts = new String[] { PreferencesMessages.NullAnnotationsConfigurationDialog_nonnullbydefault_annotations_label, PreferencesMessages.NullAnnotationsConfigurationDialog_nonnullbydefault_annotations_description };
        ...
        private void createNullAnnotationGroup(AnnotationDialogField primaryField, final AnnotationListDialogField secondaryList, Composite parent, String[] texts, int fieldWidthHint) {
            ...
            // force text wrapping
            LayoutUtil.setWidthHint(intro, 1);
            primaryField.doFillIntoGrid(group, 2);
            // button column is empty for the primary field
            addSpacer(group);
        ...
        @Override
        public void create() {
            // cannot show error status before this super call
            super.create();
        ...
        public String[] getResult() {
            return new String[] { fNullableAnnotationDialogField.getText(), fNonNullAnnotationDialogField.getText(), fNonNullByDefaultAnnotationDialogField.getText(), fOtherNullableAnnotationsDialogField.getCommaSeparatedElements(), fOtherNonNullAnnotationsDialogField.getCommaSeparatedElements(), fOtherNonNullByDefaultAnnotationsDialogField.getCommaSeparatedElements() };
        }
	 ...
	 */
    //$NON-NLS-1$
    private static final Key INTR_DEFAULT_NULL_ANNOTATIONS = getLocalKey("internal.default.null.annotations");
    ...
    private static final String[] NULL_ANNOTATIONS_DEFAULTS = { PREF_NULLABLE_ANNOTATION_NAME.getStoredValue(DefaultScope.INSTANCE, null), PREF_NONNULL_ANNOTATION_NAME.getStoredValue(DefaultScope.INSTANCE, null), PREF_NONNULL_BY_DEFAULT_ANNOTATION_NAME.getStoredValue(DefaultScope.INSTANCE, null) };
    ...
    public static Key[] getKeys() {
        return new Key[] { PREF_PB_OVERRIDING_PACKAGE_DEFAULT_METHOD, PREF_PB_METHOD_WITH_CONSTRUCTOR_NAME, PREF_PB_DEPRECATION, PREF_PB_HIDDEN_CATCH_BLOCK, PREF_PB_UNUSED_LOCAL, PREF_PB_UNUSED_PARAMETER, PREF_PB_UNUSED_EXCEPTION_PARAMETER, PREF_PB_UNUSED_PARAMETER_INCLUDE_DOC_COMMENT_REFERENCE, PREF_PB_SYNTHETIC_ACCESS_EMULATION, PREF_PB_NON_EXTERNALIZED_STRINGS, PREF_PB_UNUSED_IMPORT, PREF_PB_UNUSED_LABEL, PREF_PB_STATIC_ACCESS_RECEIVER, PREF_PB_DEPRECATION_IN_DEPRECATED_CODE, PREF_PB_NO_EFFECT_ASSIGNMENT, PREF_PB_INCOMPATIBLE_INTERFACE_METHOD, PREF_PB_UNUSED_PRIVATE, PREF_PB_UNUSED_TYPE_PARAMETER, PREF_PB_CHAR_ARRAY_IN_CONCAT, PREF_PB_UNNECESSARY_ELSE, PREF_PB_POSSIBLE_ACCIDENTAL_BOOLEAN_ASSIGNMENT, PREF_PB_LOCAL_VARIABLE_HIDING, PREF_PB_FIELD_HIDING, PREF_PB_SPECIAL_PARAMETER_HIDING_FIELD, PREF_PB_INDIRECT_STATIC_ACCESS, PREF_PB_EMPTY_STATEMENT, PREF_PB_SIGNAL_PARAMETER_IN_OVERRIDING, PREF_PB_SIGNAL_PARAMETER_IN_ABSTRACT, PREF_PB_UNNECESSARY_TYPE_CHECK, PREF_PB_UNUSED_DECLARED_THROWN_EXCEPTION, PREF_PB_UNQUALIFIED_FIELD_ACCESS, PREF_PB_UNDOCUMENTED_EMPTY_BLOCK, PREF_PB_FINALLY_BLOCK_NOT_COMPLETING, PREF_PB_DEPRECATION_WHEN_OVERRIDING, PREF_PB_UNUSED_DECLARED_THROWN_EXCEPTION_WHEN_OVERRIDING, PREF_PB_UNUSED_DECLARED_THROWN_EXCEPTION_INCLUDE_DOC_COMMENT_REFERENCE, PREF_PB_UNUSED_DECLARED_THROWN_EXCEPTION_EXEMPT_EXCEPTION_AND_THROWABLE, PREF_PB_MISSING_SERIAL_VERSION, PREF_PB_PARAMETER_ASSIGNMENT, PREF_PB_NULL_REFERENCE, PREF_PB_POTENTIAL_NULL_REFERENCE, PREF_ANNOTATION_NULL_ANALYSIS, INTR_DEFAULT_NULL_ANNOTATIONS, PREF_NULLABLE_ANNOTATION_NAME, PREF_NULLABLE_ANNOTATION_SECONDARY_NAMES, PREF_NONNULL_ANNOTATION_NAME, PREF_NONNULL_ANNOTATION_SECONDARY_NAMES, PREF_NONNULL_BY_DEFAULT_ANNOTATION_NAME, PREF_NONNULL_BY_DEFAULT_ANNOTATION_SECONDARY_NAMES, PREF_MISSING_NONNULL_BY_DEFAULT_ANNOTATION, PREF_PB_NULL_SPECIFICATION_VIOLATION, PREF_PB_POTENTIAL_NULL_ANNOTATION_INFERENCE_CONFLICT, PREF_PB_NULL_UNCHECKED_CONVERSION, PREF_PB_PESSIMISTIC_NULL_ANALYSIS_FOR_FREE_TYPE_VARIABLES, PREF_PB_NONNULL_TYPEVAR_FROM_LEGACY_INVOCATION, PREF_PB_REDUNDANT_NULL_ANNOTATION, PREF_PB_NONNULL_PARAMETER_ANNOTATION_DROPPED, PREF_PB_REDUNDANT_NULL_CHECK, PREF_PB_INCLUDE_ASSERTS_IN_NULL_ANALYSIS, PREF_PB_SYNTACTIC_NULL_ANLYSIS_FOR_FIELDS, PREF_INHERIT_NULL_ANNOTATIONS, PREF_PB_UNCLOSED_CLOSEABLE, PREF_PB_POTENTIALLY_UNCLOSED_CLOSEABLE, PREF_PB_EXPLICITLY_CLOSED_AUTOCLOSEABLE, PREF_PB_FALLTHROUGH_CASE, PREF_PB_REDUNDANT_SUPERINTERFACE, PREF_PB_UNUSED_WARNING_TOKEN, PREF_15_PB_UNCHECKED_TYPE_OPERATION, PREF_15_PB_FINAL_PARAM_BOUND, PREF_15_PB_VARARGS_ARGUMENT_NEED_CAST, PREF_15_PB_AUTOBOXING_PROBLEM, PREF_15_PB_MISSING_OVERRIDE_ANNOTATION, PREF_16_PB_MISSING_OVERRIDE_ANNOTATION_FOR_INTERFACE_METHOD_IMPLEMENTATION, PREF_15_PB_ANNOTATION_SUPER_INTERFACE, PREF_15_PB_TYPE_PARAMETER_HIDING, PREF_15_PB_INCOMPLETE_ENUM_SWITCH, PREF_15_PB_MISSING_ENUM_CASE_DESPITE_DEFAULT, PREF_15_PB_SWITCH_MISSING_DEFAULT_CASE, PREF_PB_MISSING_DEPRECATED_ANNOTATION, PREF_15_PB_RAW_TYPE_REFERENCE, PREF_15_PB_UNAVOIDABLE_GENERIC_TYPE_PROBLEMS, PREF_17_PB_REDUNDANT_TYPE_ARGUMENTS, PREF_PB_FATAL_OPTIONAL_ERROR, PREF_PB_FORBIDDEN_REFERENCE, PREF_PB_DISCOURRAGED_REFERENCE, PREF_PB_SUPPRESS_WARNINGS, PREF_PB_SUPPRESS_OPTIONAL_ERRORS, PREF_PB_UNHANDLED_WARNING_TOKEN, PREF_PB_COMPARING_IDENTICAL, PREF_PB_MISSING_SYNCHRONIZED_ON_INHERITED_METHOD, PREF_PB_MISSING_HASHCODE_METHOD, PREF_PB_DEAD_CODE, PREF_PB_UNUSED_OBJECT_ALLOCATION, PREF_PB_MISSING_STATIC_ON_METHOD, PREF_PB_POTENTIALLY_MISSING_STATIC_ON_METHOD };
    }
    ...
    private Composite createStyleTabContent(Composite folder) {
        ...
        String[] errorWarningInfoIgnoreLabels = new String[] { PreferencesMessages.ProblemSeveritiesConfigurationBlock_error, PreferencesMessages.ProblemSeveritiesConfigurationBlock_warning, PreferencesMessages.ProblemSeveritiesConfigurationBlock_info, PreferencesMessages.ProblemSeveritiesConfigurationBlock_ignore };
        String[] errorWarning = new String[] { ERROR, WARNING };
        String[] errorWarningLabels = new String[] { PreferencesMessages.ProblemSeveritiesConfigurationBlock_error, PreferencesMessages.ProblemSeveritiesConfigurationBlock_warning };
        ...
        //$NON-NLS-1$
        twistieKey = OptionsConfigurationBlock.getLocalKey("ProblemSeveritiesConfigurationBlock_section_code_style");
        ...
        //$NON-NLS-1$
        twistieKey = OptionsConfigurationBlock.getLocalKey("ProblemSeveritiesConfigurationBlock_section_potential_programming_problems");
        section = fFilteredPrefTree.addExpandableComposite(composite, label, nColumns, twistieKey, null, false);
        excomposite = getExpandableComposite(twistieKey);
        inner = createInnerComposite(excomposite, nColumns, composite.getFont());
        ...
        //$NON-NLS-1$
        twistieKey = OptionsConfigurationBlock.getLocalKey("ProblemSeveritiesConfigurationBlock_section_name_shadowing");
        section = fFilteredPrefTree.addExpandableComposite(composite, label, nColumns, twistieKey, null, false);
        excomposite = getExpandableComposite(twistieKey);
        inner = createInnerComposite(excomposite, nColumns, composite.getFont());
        ...
        //$NON-NLS-1$
        twistieKey = OptionsConfigurationBlock.getLocalKey("ProblemSeveritiesConfigurationBlock_section_deprecations");
        section = fFilteredPrefTree.addExpandableComposite(composite, label, nColumns, twistieKey, null, false);
        excomposite = getExpandableComposite(twistieKey);
        inner = createInnerComposite(excomposite, nColumns, composite.getFont());
        ...
        //$NON-NLS-1$
        twistieKey = OptionsConfigurationBlock.getLocalKey("ProblemSeveritiesConfigurationBlock_section_unnecessary_code");
        section = fFilteredPrefTree.addExpandableComposite(composite, label, nColumns, twistieKey, null, false);
        excomposite = getExpandableComposite(twistieKey);
        inner = createInnerComposite(excomposite, nColumns, composite.getFont());
        ...
        //$NON-NLS-1$
        twistieKey = OptionsConfigurationBlock.getLocalKey("ProblemSeveritiesConfigurationBlock_section_generics");
        section = fFilteredPrefTree.addExpandableComposite(composite, label, nColumns, twistieKey, null, false);
        excomposite = getExpandableComposite(twistieKey);
        inner = createInnerComposite(excomposite, nColumns, composite.getFont());
        ...
        //$NON-NLS-1$
        twistieKey = OptionsConfigurationBlock.getLocalKey("ProblemSeveritiesConfigurationBlock_section_annotations");
        section = fFilteredPrefTree.addExpandableComposite(composite, label, nColumns, twistieKey, null, false);
        excomposite = getExpandableComposite(twistieKey);
        inner = createInnerComposite(excomposite, nColumns, composite.getFont());
        ...
        //$NON-NLS-1$
        twistieKey = OptionsConfigurationBlock.getLocalKey("ProblemSeveritiesConfigurationBlock_section_null_analysis");
        section = fFilteredPrefTree.addExpandableComposite(composite, label, nColumns, twistieKey, null, false);
        excomposite = getExpandableComposite(twistieKey);
        inner = createInnerComposite(excomposite, nColumns, composite.getFont());
        ...
        fFilteredPrefTree.addCheckBoxWithLink(inner, label, INTR_DEFAULT_NULL_ANNOTATIONS, enabledDisabled, extraIndent, node, true, SWT.DEFAULT, new SelectionAdapter() {
    ...
    protected void validateSettings(Key changedKey, String oldValue, String newValue) {
        ...
        if (changedKey != null) {
            if (PREF_PB_UNUSED_PARAMETER.equals(changedKey) || PREF_PB_DEPRECATION.equals(changedKey) || PREF_PB_LOCAL_VARIABLE_HIDING.equals(changedKey) || PREF_15_PB_INCOMPLETE_ENUM_SWITCH.equals(changedKey) || PREF_PB_UNUSED_DECLARED_THROWN_EXCEPTION.equals(changedKey) || PREF_PB_SUPPRESS_WARNINGS.equals(changedKey) || PREF_ANNOTATION_NULL_ANALYSIS.equals(changedKey)) {
                updateEnableStates();
            }
            if (checkValue(PREF_ANNOTATION_NULL_ANALYSIS, ENABLED) && (PREF_ANNOTATION_NULL_ANALYSIS.equals(changedKey) || PREF_PB_NULL_REFERENCE.equals(changedKey) || PREF_PB_POTENTIAL_NULL_REFERENCE.equals(changedKey) || PREF_PB_NULL_SPECIFICATION_VIOLATION.equals(changedKey) || PREF_PB_POTENTIAL_NULL_ANNOTATION_INFERENCE_CONFLICT.equals(changedKey))) {
    ...
    private void updateNullAnnotationsSetting() {
        String[] annotationNames = { getValue(PREF_NULLABLE_ANNOTATION_NAME), getValue(PREF_NONNULL_ANNOTATION_NAME), getValue(PREF_NONNULL_BY_DEFAULT_ANNOTATION_NAME) };
    ...
    private IStatus validateNullnessAnnotation(String value, String errorMessage, boolean isTypeMandatory) {
        ...
        if (value.isEmpty() && !isTypeMandatory)
            return status;
        if (JavaConventions.validateJavaTypeName(value, JavaCore.VERSION_1_5, JavaCore.VERSION_1_5).matches(IStatus.ERROR) || value.indexOf('.') == -1) {
