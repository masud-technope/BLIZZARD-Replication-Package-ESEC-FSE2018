...
public class TextEditChangeNode extends InternalTextEditChangeNode {
    ...
    public String getText() {
        ...
        if (change instanceof TextFileChange) {
            ...
            return Messages.format(RefactoringUIMessages.PreviewWizardPage_changeElementLabelProvider_textFormat, new String[] { BasicElementLabels.getResourceName(file), BasicElementLabels.getPathLabel(file.getParent().getFullPath(), false) });
        }
