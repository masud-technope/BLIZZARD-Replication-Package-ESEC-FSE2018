...
public class CleanUpConfigurationBlock extends ProfileConfigurationBlock {
    ...
    //$NON-NLS-1$
    private static final String DIALOGSTORE_LASTSAVELOADPATH = JavaUI.ID_PLUGIN + ".cleanup";
    ...
    private void doShowCleanUpWizard(boolean showWizard) {
        ...
        if (preferences.get(CleanUpConstants.SHOW_CLEAN_UP_WIZARD, null) != null && preferences.getBoolean(CleanUpConstants.SHOW_CLEAN_UP_WIZARD, true) == showWizard)
            return;
