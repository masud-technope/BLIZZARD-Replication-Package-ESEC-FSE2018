...
public class UtilitiesTest extends QuickFixTest {
    ...
    public void testGuessBindingForTypeReference() throws Exception {
        ...
        String[] expected = { "java.lang.String", "java.lang.String", "null", "java.lang.String", "java.util.ArrayList<java.lang.String>", "java.lang.Number", "java.lang.String", "java.lang.Number", "java.lang.Number", "test1.E<java.lang.String>.F<java.lang.Number>", "test1.E<java.lang.String>" };
    ...
    public void testGetPossibleTypeKinds() throws Exception {
        ...
        buf.append("}\n");
        ICompilationUnit cu = pack1.createCompilationUnit("E.java", buf.toString(), false, null);
        int[] expected = { SimilarElementsRequestor.ALL_TYPES, SimilarElementsRequestor.ALL_TYPES, SimilarElementsRequestor.CLASSES | // X<String>
        SimilarElementsRequestor.INTERFACES, SimilarElementsRequestor.REF_TYPES_AND_VAR, SimilarElementsRequestor.REF_TYPES_AND_VAR, // E<String>.X
        SimilarElementsRequestor.REF_TYPES, SimilarElementsRequestor.CLASSES | //X<String>.A
        SimilarElementsRequestor.INTERFACES, //new X();
        SimilarElementsRequestor.CLASSES, //new X() { };
        SimilarElementsRequestor.CLASSES | SimilarElementsRequestor.INTERFACES, SimilarElementsRequestor.ALL_TYPES, SimilarElementsRequestor.REF_TYPES, SimilarElementsRequestor.REF_TYPES };
        CompilationUnit astRoot = getASTRoot(cu);
        FieldDeclaration[] fields = ((TypeDeclaration) astRoot.types().get(0)).getFields();
        for (int i = 0; i < fields.length; i++) {
            ASTNode node = NodeFinder.perform(astRoot, buf.indexOf("X", fields[i].getStartPosition()), 1);
