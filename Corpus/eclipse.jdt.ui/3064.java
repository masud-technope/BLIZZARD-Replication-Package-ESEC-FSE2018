...
public class PackagesView extends JavaBrowsingPart {
    ...
    private MultiActionGroup createSwitchActionGroup() {
        ...
        //$NON-NLS-1$
        JavaPluginImages.setLocalImageDescriptors(switchToFlatViewAction, "flatLayout.png");
        //$NON-NLS-1$
        JavaPluginImages.setLocalImageDescriptors(switchToHierarchicalViewAction, "hierarchicalLayout.png");
    ...
    private static class LayoutActionGroup extends MultiActionGroup {
        ...
        public void fillActionBars(IActionBars actionBars) {
            ...
            //$NON-NLS-1$
            final IContributionItem groupMarker = new GroupMarker("layout");
            ...
            //$NON-NLS-1$
            manager.appendToGroup("layout", newManager);
