...
public class ControlStatementsFix extends CompilationUnitRewriteOperationsFix {
    ...
    private static final class ControlStatementFinder extends GenericVisitor {
        ...
        public  ControlStatementFinder(boolean findControlStatementsWithoutBlock, boolean removeUnnecessaryBlocks, boolean removeUnnecessaryBlocksOnlyWhenReturnOrThrow, List<CompilationUnitRewriteOperation> resultingCollection) {
        ...
        private static boolean satisfiesPrecondition(Statement controlStatement, ChildPropertyDescriptor childDescriptor, boolean onlyReturnAndThrows, boolean cleanUpCheck) {
            ...
            if (controlStatement instanceof IfStatement) {
                if (((IfStatement) controlStatement).getThenStatement() != child)
                    //can always remove blocks in else part
                    return true;
                IfStatement ifStatement = (IfStatement) controlStatement;
                if (ifStatement.getElseStatement() == null)
                    //can always remove if no else part
                    return true;
                ...
                while (true) {
                    ...
                    if (parent instanceof IfStatement) {
                        ...
                        if (//->currentChild is an unblocked then part
                        body == currentChild && ((IfStatement) parent).getElseStatement() != null)
                            return false;
