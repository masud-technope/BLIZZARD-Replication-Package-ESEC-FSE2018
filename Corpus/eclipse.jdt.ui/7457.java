...
public class JUnitPlugin extends AbstractUIPlugin {
    ...
    //$NON-NLS-1$ //$NON-NLS-2$
    public static final String ID_EXTENSION_POINT_JUNIT_LAUNCHCONFIGS = PLUGIN_ID + "." + "junitLaunchConfigs";
    ...
    private static void setImageDescriptors(IAction action, String type, String relPath) {
        //$NON-NLS-1$
        ImageDescriptor id = createImageDescriptor("d" + type, relPath, false);
        if (id != null)
            action.setDisabledImageDescriptor(id);
        //$NON-NLS-1$
        ImageDescriptor descriptor = createImageDescriptor("e" + type, relPath, true);
