...
public final class MemberVisibilityAdjustor {
	 ...
	 * @since 3.2
	 */
    public static final GroupCategorySet SET_VISIBILITY_ADJUSTMENTS = new GroupCategorySet(new //$NON-NLS-1$
    GroupCategory(//$NON-NLS-1$
    "org.eclipse.jdt.internal.corext.visibilityAdjustments", RefactoringCoreMessages.MemberVisibilityAdjustor_adjustments_name, RefactoringCoreMessages.MemberVisibilityAdjustor_adjustments_description));
    ...
    // LinkedHashMap to preserve order of generated warnings
    ...
    private boolean isInsideMovedMember(final IJavaElement element) {
        ...
        while ((current = current.getParent()) != null) if (current.equals(fReferenced))
            return true;
        return false;
    }
