...
public class RefactoringSaveHelper {
    ...
    public  RefactoringSaveHelper(int saveMode) {
        Assert.isTrue(saveMode == SAVE_ALL_ALWAYS_ASK || saveMode == SAVE_ALL || saveMode == SAVE_NON_JAVA_UPDATES || saveMode == SAVE_JAVA_ONLY_UPDATES || saveMode == SAVE_NOTHING);
        fSaveMode = saveMode;
    }
    ...
    public boolean saveEditors(Shell shell) {
        ...
        switch(fSaveMode) {
            ...
            case SAVE_NON_JAVA_UPDATES:
                // see https://bugs.eclipse.org/bugs/show_bug.cgi?id=175495
        ...
        try {
            ...
            try {
                if (fSaveMode == SAVE_ALL_ALWAYS_ASK || fSaveMode == SAVE_ALL || RefactoringSavePreferences.getSaveAllEditors()) {
