...
public class RefactoringSignatureDescriptorFactory {
    ...
    public static IntroduceParameterObjectDescriptor createIntroduceParameterObjectDescriptor(String project, String description, String comment, Map<String, String> arguments, int flags) throws IllegalArgumentException {
