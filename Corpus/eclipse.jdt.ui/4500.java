...
abstract class JavaHistoryActionImpl {
    ...
    /* extends Action implements IActionDelegate*/
    ...
    void applyChanges(ASTRewrite rewriter, final IDocument document, final ITextFileBuffer textFileBuffer, Shell shell, boolean inEditor, Map<String, String> options) throws CoreException, InvocationTargetException, InterruptedException {
