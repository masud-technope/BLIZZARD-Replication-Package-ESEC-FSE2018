...
class ShowPreviousFailureAction extends Action {
    ...
    public  ShowPreviousFailureAction(TestRunnerViewPart part) {
        ...
        //$NON-NLS-1$
        setDisabledImageDescriptor(JUnitPlugin.getImageDescriptor("dlcl16/select_prev.gif"));
        //$NON-NLS-1$
        setHoverImageDescriptor(JUnitPlugin.getImageDescriptor("elcl16/select_prev.gif"));
        //$NON-NLS-1$
        setImageDescriptor(JUnitPlugin.getImageDescriptor("elcl16/select_prev.gif"));
