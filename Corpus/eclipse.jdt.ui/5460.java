...
public class PatternStrings {
    ...
    public static String getMethodSignature(IMethod method) {
        ...
        buffer.append(JavaElementLabels.getElementLabel(method.getDeclaringType(), JavaElementLabels.T_FULLY_QUALIFIED | JavaElementLabels.USE_RESOLVED));
    ...
    public static String getTypeSignature(IType field) {
        return JavaElementLabels.getElementLabel(field, JavaElementLabels.T_FULLY_QUALIFIED | JavaElementLabels.T_TYPE_PARAMETERS | JavaElementLabels.USE_RESOLVED);
    }
