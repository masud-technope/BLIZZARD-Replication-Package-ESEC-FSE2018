...
public class NewAnnotationWizardPage extends NewTypeWizardPage {
    ...
    private static final int TYPE = NewTypeWizardPage.ANNOTATION_TYPE;
    ...
    private void doStatusUpdate() {
        ...
        IStatus[] status = new IStatus[] { fContainerStatus, isEnclosingTypeSelected() ? fEnclosingTypeStatus : fPackageStatus, fTypeNameStatus, fModifierStatus };
