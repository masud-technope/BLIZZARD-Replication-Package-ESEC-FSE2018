            ...
            for (int j = 0; j < i; j++) {
                ...
                while (parent != null) {
                    if (wrappers[i] == parent) {
                        // disable if element is a parent of other selected elements
                        return false;
                    }
                ...
                while (parentElement != null) {
                    if (parentElement == wrappers[j]) {
                        // disable if element is a child of other selected elements
                        return false;
                    }
