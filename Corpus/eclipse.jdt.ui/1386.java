...
public abstract class PreviewNode {
    ...
    static final int[][] ACTIVATION_TABLE = new int[][] { /* INACTIVE */
    { INACTIVE, PARTLY_ACTIVE, PARTLY_ACTIVE }, /* PARTLY_ACTIVE*/
    { PARTLY_ACTIVE, PARTLY_ACTIVE, PARTLY_ACTIVE }, /* ACTIVE */
    { PARTLY_ACTIVE, PARTLY_ACTIVE, ACTIVE } };
	 ...
	 */
    /* package */
    void initialize(PreviewNode parent) {
