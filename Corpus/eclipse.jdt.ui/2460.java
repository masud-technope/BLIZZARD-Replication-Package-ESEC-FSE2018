...
public final class ProposalSorterHandle {
    ...
    //$NON-NLS-1$
    private static final String PERFORMANCE_EVENT = JavaPlugin.getPluginId() + "/perf/content_assist_sorters/extensions";
    ...
    Status createExceptionStatus(InvalidRegistryObjectException x) {
        ...
        //$NON-NLS-1$
        return new Status(IStatus.INFO, JavaPlugin.getPluginId(), IStatus.OK, disable + " " + reason, x);
    }
    ...
    Status createExceptionStatus(CoreException x) {
        ...
        //$NON-NLS-1$
        return new Status(IStatus.ERROR, JavaPlugin.getPluginId(), IStatus.OK, disable + " " + reason, x);
    }
    ...
    Status createExceptionStatus(RuntimeException x) {
        ...
        //$NON-NLS-1$
        return new Status(IStatus.WARNING, JavaPlugin.getPluginId(), IStatus.OK, disable + " " + reason, x);
    }
    ...
    private Status createAPIViolationStatus(String operation) {
        ...
        //$NON-NLS-1$
        return new Status(IStatus.WARNING, JavaPlugin.getPluginId(), IStatus.OK, disable + " " + reason, null);
    }
