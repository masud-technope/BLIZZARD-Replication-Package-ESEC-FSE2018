...
public class WorkingSetDropAdapterTest extends TestCase {
    ...
    public void testInvalidSource1() throws Exception {
        ...
        IWorkingSet target = PlatformUI.getWorkbench().getWorkingSetManager().createWorkingSet("Target", new IAdaptable[] { fProject });
    ...
    public void testAddProject() throws Exception {
        ITreeSelection selection = createSelection(fProject, null);
        IWorkingSet target = PlatformUI.getWorkbench().getWorkingSetManager().createWorkingSet("Target", new IAdaptable[0]);
    ...
    public void testMoveProject() throws Exception {
        IWorkingSet source = PlatformUI.getWorkbench().getWorkingSetManager().createWorkingSet("Source", new IAdaptable[] { fProject });
    ...
    private ITreeSelection createSelection(Object selectedElement, List<TreePath> treePathes) {
        ...
        return new TreeSelection(treePathes.toArray(new TreePath[treePathes.size()]), fPackageExplorer.getTreeViewer().getComparer());
    }
