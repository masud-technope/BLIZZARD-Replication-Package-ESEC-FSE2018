...
public class NewWizardsActionGroup extends ActionGroup {
    ...
    private boolean isNewTarget(Object element) {
        ...
        if (element instanceof IJavaElement) {
            ...
            return type == IJavaElement.JAVA_PROJECT || type == IJavaElement.PACKAGE_FRAGMENT_ROOT || type == IJavaElement.PACKAGE_FRAGMENT || type == IJavaElement.COMPILATION_UNIT || type == IJavaElement.TYPE;
        }
        if (element instanceof IWorkingSet) {
            String workingSetId = ((IWorkingSet) element).getId();
            return IWorkingSetIDs.JAVA.equals(workingSetId) || IWorkingSetIDs.RESOURCE.equals(workingSetId) || IWorkingSetIDs.OTHERS.equals(workingSetId);
        }
        return false;
    }
