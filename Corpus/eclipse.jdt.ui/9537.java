...
public class JavaMoveLinesAction extends TextEditorAction {
    ...
    public static JavaMoveLinesAction[] createMoveCopyActionSet(ResourceBundle bundle, CompilationUnitEditor editor) {
        ...
        //$NON-NLS-1$
        actions[0] = new JavaMoveLinesAction(bundle, "Editor.MoveLinesUp.", true, false, state);
        //$NON-NLS-1$
        actions[1] = new JavaMoveLinesAction(bundle, "Editor.MoveLinesDown.", false, false, state);
        //$NON-NLS-1$
        actions[2] = new JavaMoveLinesAction(bundle, "Editor.CopyLineUp.", true, true, state);
        //$NON-NLS-1$
        actions[3] = new JavaMoveLinesAction(bundle, "Editor.CopyLineDown.", false, true, state);
        return actions;
    }
