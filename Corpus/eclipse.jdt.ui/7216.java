...
public class RefactoringScannerTests extends RefactoringTest {
    ...
    private void helper2(String fileName, Position[] expectedMatches) throws Exception {
        ...
        for (int i = 0; i < expectedMatches.length; i++) expectedMatchesList.add(new Integer(TextRangeUtil.getOffset(text, expectedMatches[i].fLine, expectedMatches[i].fColumn)));
