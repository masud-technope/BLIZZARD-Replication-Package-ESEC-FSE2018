...
public class ParameterEditDialog extends StatusDialog {
    ...
    private IStatus validateName() {
        ...
        IStatus status = fContext != null ? JavaConventionsUtil.validateFieldName(text, fContext.getCuHandle().getJavaProject()) : JavaConventions.validateFieldName(text, JavaCore.VERSION_1_3, JavaCore.VERSION_1_3);
