...
public class ChangeSignatureTests extends RefactoringTest {
    ...
    private void helperDoAll(String typeName, String methodName, String[] signature, ParameterInfo[] newParamInfos, int[] newIndices, String[] oldParamNames, String[] newParamNames, String[] newParameterTypeNames, int[] permutation, int newVisibility, int[] deleted, String returnTypeName, boolean createDelegate) throws Exception {
        ICompilationUnit cu = createCUfromTestFile(getPackageP(), true, true);
    ...
    private void helperDoAll(String typeName, String methodName, String[] signature, ParameterInfo[] newParamInfos, int[] newIndices, String[] oldParamNames, String[] newParamNames, String[] newParameterTypeNames, int[] permutation, int newVisibility, int[] deleted, String returnTypeName) throws Exception {
        helperDoAll(typeName, methodName, signature, newParamInfos, newIndices, oldParamNames, newParamNames, newParameterTypeNames, permutation, newVisibility, deleted, returnTypeName, false);
    }
    ...
    private void helperDoAllFail(String methodName, String[] signature, ParameterInfo[] newParamInfos, int[] newIndices, String[] oldParamNames, String[] newParamNames, String[] newParameterTypeNames, int[] permutation, int newVisibility, int[] deleted, int expectedSeverity) throws Exception {
    ...
    private void helperDoAllWithExceptions(String typeName, String methodName, String[] signature, ParameterInfo[] newParamInfos, int[] newIndices, String[] oldParamNames, String[] newParamNames, String[] newParameterTypeNames, int[] permutation, int newVisibility, int[] deleted, String returnTypeName, String[] removeExceptions, String[] addExceptions) throws Exception {
        ICompilationUnit cu = createCUfromTestFile(getPackageP(), true, true);
        IType classA = getType(cu, typeName);
        IMethod method = classA.getMethod(methodName, signature);
        assertTrue("method " + methodName + " does not exist", method.exists());
    ...
    public void test21() throws Exception {
        ...
        int[] permutation = { 1, 0 };
        //retain
        int newVisibility = JdtFlags.VISIBILITY_CODE_INVALID;
        int[] deleted = null;
    ...
    public void testAll60() throws Exception {
        ...
        helperDoAllWithExceptions("I", "getList", signature, newParamInfo, newIndices, oldParamNames, newParamNames, newParameterTypeNames, permutation, newVisibility, deletedIndices, newReturnTypeName, removeExceptions, addExceptions);
    }

    public //bug 51634
    void testAll61() throws //bug 51634
    Exception {
        String[] signature = {};
        ParameterInfo[] newParamInfo = null;
        int[] newIndices = null;
    ...
    public // https://bugs.eclipse.org/bugs/show_bug.cgi?id=158008 and https://bugs.eclipse.org/bugs/show_bug.cgi?id=201929
    void testAll64() throws // https://bugs.eclipse.org/bugs/show_bug.cgi?id=158008 and https://bugs.eclipse.org/bugs/show_bug.cgi?id=201929
    Exception {
    ...
    public // https://bugs.eclipse.org/393829
    void testAnonymous01() throws // https://bugs.eclipse.org/393829
    Exception {
        ParameterInfo[] newParamInfo = null;
        int[] newIndices = null;
    ...
    public // https://bugs.eclipse.org/bugs/show_bug.cgi?id=191349
    void testAddSyntaxError01() throws // https://bugs.eclipse.org/bugs/show_bug.cgi?id=191349
    Exception {
    ...
    public //bug 42100
    void testAddRecursive1() throws //bug 42100
    Exception {
        String[] signature = { "I" };
    ...
    public //bug 52091
    void testException03() throws //bug 52091
    Exception {
    ...
    public //bug 52058
    void testException04() throws //bug 52058
    Exception {
    ...
    public //bug 56132
    void testException05() throws //bug 56132
    Exception {
    ...
    public //bug 47062
    void testInStatic01() throws //bug 47062
    Exception {
    ...
    public //bug 47062
    void testInStatic02() throws //bug 47062
    Exception {
        String[] signature = { "QString;", "QString;" };
        ParameterInfo[] newParamInfo = null;
        int[] newIndices = null;
