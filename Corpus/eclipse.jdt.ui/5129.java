...
public final class CaptureType extends AbstractTypeVariable {
    ...
    public boolean doEquals(TType type) {
        return getBindingKey().equals(((CaptureType) type).getBindingKey()) && fJavaProject.equals(((CaptureType) type).fJavaProject);
    }
    ...
    protected String getPlainPrettySignature() {
        //$NON-NLS-1$
        return "capture-of " + fWildcard.getPrettySignature();
    }
}
