...
public class SelfEncapsulateFieldInputPage extends UserInputWizardPage {
    ...
    private void doOpenPreference() {
        ...
        if (// relevant options changes
        open == Window.OK && !Arrays.equals(relevantOptions, getRelevantOptions(project))) {
    ...
    private String[] getRelevantOptions(IJavaProject project) {
        return new String[] { project.getOption(JavaCore.CODEASSIST_FIELD_PREFIXES, true), project.getOption(JavaCore.CODEASSIST_FIELD_SUFFIXES, true), PreferenceConstants.getPreference(PreferenceConstants.CODEGEN_IS_FOR_GETTERS, project) };
    }
