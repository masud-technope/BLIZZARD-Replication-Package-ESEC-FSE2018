...
public class DeleteAction extends SelectionDispatchAction {
    ...
    private void deleteWorkingSets(IStructuredSelection selection) {
        ...
        if (selection.size() == 1) {
            ...
            dialog = new MessageDialog(getShell(), ReorgMessages.DeleteWorkingSet_single, null, dialogMessage, MessageDialog.QUESTION, new String[] { ReorgMessages.DeleteWorkingSet_Hide, ReorgMessages.DeleteWorkingSet_Remove, IDialogConstants.CANCEL_LABEL }, 0) {
        ...
        if (dialogResponse == REMOVE_BUTTON) {
            ...
            @SuppressWarnings("unchecked") List<IWorkingSet> workingSets = (List<IWorkingSet>) SelectionUtil.toList(selection);
