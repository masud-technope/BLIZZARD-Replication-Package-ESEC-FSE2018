...
public class GoToNextPreviousMemberActionTests extends RefactoringTest {
    ...
    private void helper(int startLine, int startColumn, int endLine, int endColumn, int expectedStartLine, int expectedStartColumn, boolean isSelectNext) throws Exception {
