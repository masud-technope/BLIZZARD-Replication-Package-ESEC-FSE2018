...
public class CustomFiltersDialog extends SelectionDialog {
    ...
    private void addSelectionButtons(Composite composite) {
        ...
        SelectionListener listener = new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                for (int i = 0; i < fBuiltInFilters.length; i++) fFilterDescriptorChangeHistory.push(fBuiltInFilters[i]);
            }
        };
    ...
    private void checkInitialSelections() {
        ...
        while (itemsToCheck.hasNext()) fCheckBoxList.setChecked(itemsToCheck.next(), true);
    }
    ...
    public String[] getEnabledFilterIds() {
        ...
        for (int i = 0; i < result.length; i++) enabledIds.add(((FilterDescriptor) result[i]).getId());
