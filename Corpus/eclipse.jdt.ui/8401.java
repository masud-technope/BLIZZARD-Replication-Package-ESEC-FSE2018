...
public class ExtractMethodTests extends AbstractSelectionTestCase {
    ...
    //XXX: [1.8][dom ast] method body recovery broken (empty body)
    ...
    protected void destinationTest(int destination) throws Exception {
        performTest(fgTestSetup.getDestinationPackage(), "A", COMPARE_WITH_OUTPUT, "destination_out", null, null, destination);
    }
    ...
    public void test970() throws Exception {
        // for https://bugs.eclipse.org/bugs/show_bug.cgi?id=186061
        duplicatesTest();
    }

    public void test971() throws Exception {
        // for https://bugs.eclipse.org/bugs/show_bug.cgi?id=160853
        performTest(fgTestSetup.getDuplicatesPackage(), "A", COMPARE_WITH_OUTPUT, "duplicates_out", null, null, 1);
    }
    ...
    public void test980() throws Exception {
        // for https://bugs.eclipse.org/bugs/show_bug.cgi?id=264606
        duplicatesTest();
    }
    ...
    public void test1120() throws Exception {
        //https://bugs.eclipse.org/bugs/show_bug.cgi?id=369295
        genericTest();
    }
