...
public class UserLibraryMarkerResolutionGenerator implements IMarkerResolutionGenerator2 {
    ...
    public boolean hasResolutions(IMarker marker) {
        ...
        if (id == IJavaModelStatusConstants.CP_CONTAINER_PATH_UNBOUND || id == IJavaModelStatusConstants.CP_VARIABLE_PATH_UNBOUND || id == IJavaModelStatusConstants.INVALID_CP_CONTAINER_ENTRY || id == IJavaModelStatusConstants.DEPRECATED_VARIABLE || id == IJavaModelStatusConstants.INVALID_CLASSPATH) {
            return true;
        }
        return false;
    }
	 ...
	 */
    private abstract static class UserLibraryMarkerResolution implements IMarkerResolution2 {
