...
public class MoveMembersTests extends RefactoringTest {
    ...
    private void fieldMethodTypePackageHelper_failing(String[] fieldNames, String[] methodNames, String[][] signatures, String[] typeNames, int errorLevel, String destinationTypeName, IPackageFragment packForA, IPackageFragment packForB) throws Exception {
        ICompilationUnit cuA = createCUfromTestFile(packForA, "A");
    ...
    private void fieldMethodTypeHelper_failing(String[] fieldNames, String[] methodNames, String[][] signatures, String[] typeNames, int errorLevel, String destinationTypeName) throws Exception {
        IPackageFragment packForA = getPackageP();
        IPackageFragment packForB = getPackageP();
        fieldMethodTypePackageHelper_failing(fieldNames, methodNames, signatures, typeNames, errorLevel, destinationTypeName, packForA, packForB);
    }
    ...
    public //test for bug 41691
    void test29() throws //test for bug 41691
    Exception {
        methodHelper_passing(new String[] { "m" }, new String[][] { new String[0] });
    }

    public //test for bug 41691
    void test30() throws //test for bug 41691
    Exception {
        fieldHelper_passing(new String[] { "id" });
    }

    public //test for bug 41691
    void test31() throws //test for bug 41691
    Exception {
        fieldHelper_passing(new String[] { "odd" });
    }

    public //test for bug 41734, 41691
    void test32() throws //test for bug 41734, 41691
    Exception {
        printTestDisabledMessage("test for 41734");
    //methodHelper_passing(new String[]{"m"}, new String[][]{new String[0]});
    }

    public //test for bug 28022
    void test33() throws //test for bug 28022
    Exception {
        fieldHelper_passing(new String[] { "i" });
    }

    public //test for bug 28022
    void test34() throws //test for bug 28022
    Exception {
        fieldHelper_passing(new String[] { "i" });
    }

    public //test for bug 28022
    void test35() throws //test for bug 28022
    Exception {
        fieldHelper_passing(new String[] { "i" });
    }
    ...
    public void testFail0() throws Exception {
        fieldMethodTypeHelper_failing(new String[0], new String[] { "m" }, new String[][] { new String[0] }, new String[0], RefactoringStatus.FATAL, "p.B");
    }

    public void testFail1() throws Exception {
        fieldMethodTypeHelper_failing(new String[0], new String[] { "m" }, new String[][] { new String[0] }, new String[0], RefactoringStatus.ERROR, "p.B.X");
    }

    public void testFail2() throws Exception {
        fieldMethodTypeHelper_failing(new String[0], new String[] { "m" }, new String[][] { new String[0] }, new String[0], RefactoringStatus.ERROR, "p.B");
    }

    public void testFail3() throws Exception {
        fieldMethodTypeHelper_failing(new String[0], new String[] { "m" }, new String[][] { new String[] { "I", "I" } }, new String[0], RefactoringStatus.ERROR, "p.B");
    }

    public void testFail4() throws Exception {
        fieldMethodTypeHelper_failing(new String[0], new String[] { "m" }, new String[][] { new String[] { "I", "I" } }, new String[0], RefactoringStatus.WARNING, "p.B");
    }
    ...
    public void testFail6() throws Exception {
        fieldMethodTypeHelper_failing(new String[] { "i" }, new String[0], new String[0][0], new String[0], RefactoringStatus.ERROR, "p.B");
    }
    ...
    public void testFail15() throws Exception {
        fieldMethodTypeHelper_failing(new String[0], new String[] { "m" }, new String[][] { new String[0] }, new String[0], RefactoringStatus.WARNING, "p.B");
    }

    public void testFail16() throws Exception {
        IPackageFragment packageForB = getRoot().createPackageFragment("r", false, null);
        fieldMethodTypePackageHelper_failing(new String[] { "f" }, new String[0], new String[0][0], new String[0], RefactoringStatus.ERROR, "r.B", getPackageP(), packageForB);
    }

    public void testFail17() throws Exception {
        fieldMethodTypeHelper_failing(new String[0], new String[] { "m" }, new String[][] { new String[0] }, new String[0], RefactoringStatus.FATAL, "java.lang.Object");
    }

    public void testFail18() throws Exception {
        fieldMethodTypeHelper_failing(new String[0], new String[] { "m" }, new String[][] { new String[0] }, new String[0], RefactoringStatus.FATAL, "p.DontExist");
    }
