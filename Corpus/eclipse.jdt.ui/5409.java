...
public class PackagesViewContentProviderTests2 extends TestCase {
    ...
    public void testGetElementsProject() throws Exception {
        ...
        //$NON-NLS-1$
        assertTrue("Wrong children founf for PackageFragment", compareArrays(children, expectedChildren));
    }
    ...
    public void testRemovePackageInTwoPackageLogicalPackage() throws Exception {
        ...
        //$NON-NLS-1$
        assertTrue("Correct guy removed", canFindEqualCompoundElement(cp10, new Object[] { removedObject }));
        //$NON-NLS-1$
    ...
    public void testAddPackageToCreateLogicalPackage() throws Exception {
        ...
        //create new package
        //$NON-NLS-1$
        IPackageFragment pack11 = fRoot1.createPackageFragment("pack1", true, null);
        ...
        //$NON-NLS-1$
        assertTrue("Remove and add happened", fMyPart.hasRemoveHappened() && fMyPart.hasAddHappened());
        Object addedObject = fMyPart.getAddedObject().get(0);
        Object removedObject = fMyPart.getRemovedObject().get(0);
        //$NON-NLS-1$
        assertTrue("Correct guy removed", fPack12.equals(removedObject));
        //$NON-NLS-1$
        assertTrue("Correct guy added", lp1.equals(addedObject));
    }
