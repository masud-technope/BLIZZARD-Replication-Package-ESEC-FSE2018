...
public class LegacyTestRunListenerTest extends AbstractTestRunListenerTest {
    ...
    public void testOK() throws Exception {
        ...
        String[] expectedSequence = new String[] { LegacyTestRunListener.testRunStartedMessage(1), LegacyTestRunListener.testStartedMessage("2", "testSucceed(pack.ATestCase)"), LegacyTestRunListener.testEndedMessage("2", "testSucceed(pack.ATestCase)"), LegacyTestRunListener.testRunEndedMessage() };
    ...
    public void testFail() throws Exception {
        ...
        String[] expectedSequence = new String[] { LegacyTestRunListener.testRunStartedMessage(1), LegacyTestRunListener.testStartedMessage("2", "testFail(pack.ATestCase)"), LegacyTestRunListener.testFailedMessage(ITestRunListener.STATUS_FAILURE, "2", "testFail(pack.ATestCase)"), LegacyTestRunListener.testEndedMessage("2", "testFail(pack.ATestCase)"), LegacyTestRunListener.testRunEndedMessage() };
        String[] actual = runTest(source);
        assertEqualLog(expectedSequence, actual);
    }
