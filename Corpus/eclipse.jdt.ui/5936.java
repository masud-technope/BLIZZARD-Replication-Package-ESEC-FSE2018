...
public class JavaOutlinePage extends Page implements IContentOutlinePage, IAdaptable, IPostSelectionProvider {
    ...
    class ClassOnlyAction extends Action {
        ...
        public  ClassOnlyAction() {
            ...
            //$NON-NLS-1$
            JavaPluginImages.setLocalImageDescriptors(//$NON-NLS-1$
            this, //$NON-NLS-1$
            "gointo_toplevel_type.png");
            IPreferenceStore preferenceStore = JavaPlugin.getDefault().getPreferenceStore();
            boolean showclass = //$NON-NLS-1$
            preferenceStore.getBoolean(//$NON-NLS-1$
            "GoIntoTopLevelTypeAction.isChecked");
        ...
        private void setTopLevelTypeOnly(boolean show) {
            ...
            IPreferenceStore preferenceStore = JavaPlugin.getDefault().getPreferenceStore();
            //$NON-NLS-1$
            preferenceStore.setValue(//$NON-NLS-1$
            "GoIntoTopLevelTypeAction.isChecked", //$NON-NLS-1$
            show);
        }
    }
    ...
    public void createControl(Composite parent) {
        ...
        AppearanceAwareLabelProvider lprovider = new AppearanceAwareLabelProvider(AppearanceAwareLabelProvider.DEFAULT_TEXTFLAGS | JavaElementLabels.F_APP_TYPE_SIGNATURE | JavaElementLabels.ALL_CATEGORY, AppearanceAwareLabelProvider.DEFAULT_IMAGEFLAGS);
        ...
        fActionGroups = new CompositeActionGroup(new ActionGroup[] { new OpenViewActionGroup(this), new CCPActionGroup(this), new GenerateActionGroup(this), new RefactorActionGroup(this), new JavaSearchActionGroup(this) });
