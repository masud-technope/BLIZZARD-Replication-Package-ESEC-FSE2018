...
public class StringFormatGenerator extends AbstractToStringGenerator {
    ...
    protected void complete() throws CoreException {
        ...
        if (getContext().is50orHigher())
            ...
            //$NON-NLS-1$
            formatClass = "java.text.MessageFormat";
        //$NON-NLS-1$ 
        MethodInvocation formatInvocation = createMethodInvocation(addImport(formatClass), "format", null);
        ...
        if (getContext().is50orHigher()) {
            ...
            //$NON-NLS-1$
            arrayCreation.setType(fAst.newArrayType(fAst.newSimpleType(addImport("java.lang.Object"))));
    ...
    protected void addElement(Object element) {
        ...
        if (element instanceof Expression) {
            ...
            if (getContext().is50orHigher()) {
                ...
                //$NON-NLS-1$ //$NON-NLS-2$
                buffer.append("{" + (arguments.size() - 1) + "}");
            }
        }
    }
