...
public class JavadocStandardWizardPage extends JavadocWizardPage {
    ...
    private void createBasicOptionsGroup(Composite composite) {
        ...
        fSeperatedIndexCheck = new FlaggedButton(fBasicOptionsGroup, JavadocExportMessages.JavadocStandardWizardPage_seperateindexbutton_label, createGridData(GridData.GRAB_HORIZONTAL, 1, LayoutUtil.getIndent()), fStore.SPLITINDEX, true);
    ...
    private void createTagOptionsGroup(Composite composite) {
        ...
        fDeprecatedList = new FlaggedButton(fTagsGroup, JavadocExportMessages.JavadocStandardWizardPage_deprecatedlistbutton_label, createGridData(GridData.FILL_HORIZONTAL, 1, LayoutUtil.getIndent()), fStore.NODEPRECATEDLIST, false);
    ...
    private void createStyleSheetGroup(Composite composite) {
        ...
        fStyleSheetBrowseButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent event) {
                //$NON-NLS-1$
                handleFileBrowseButtonPressed(fStyleSheetText, new String[] { "*.css" }, JavadocExportMessages.JavadocSpecificsWizardPage_stylesheetbrowsedialog_title);
            }
        });
    }
            ...
            case STYLESHEETSTATUS:
                ...
                if (fStyleSheetButton.getSelection()) {
                    ...
                    if (filename.length() == 0) {
                        ...
                        ext.equalsIgnoreCase(//$NON-NLS-1$
                        "css")) {
