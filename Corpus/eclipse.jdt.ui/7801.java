...
public class NewEnumWizardPage extends NewTypeWizardPage {
    ...
    //$NON-NLS-1$
    private static final String PAGE_NAME = "NewEnumWizardPage";

    private static final int TYPE = NewTypeWizardPage.ENUM_TYPE;
    ...
    private void doStatusUpdate() {
        ...
        IStatus[] status = new IStatus[] { fContainerStatus, isEnclosingTypeSelected() ? fEnclosingTypeStatus : fPackageStatus, fTypeNameStatus, fModifierStatus, fSuperInterfacesStatus };
