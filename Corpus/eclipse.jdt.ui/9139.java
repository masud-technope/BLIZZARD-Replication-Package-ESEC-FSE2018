...
class JavaStructureDiffViewer extends StructureDiffViewer implements IElementChangedListener {
    ...
    protected void compareInputChanged(ICompareInput input) {
        fThreeWay = input != null ? input.getAncestor() != null : false;
    ...
    protected void createToolItems(ToolBarManager toolBarManager) {
        ...
        //$NON-NLS-1$
        IAction a = new ChangePropertyAction(getBundle(), getCompareConfiguration(), "action.Smart.", SMART);
        fSmartActionItem = new ActionContributionItem(a);
        fSmartActionItem.setVisible(fThreeWay);
        //$NON-NLS-1$
        toolBarManager.appendToGroup("modes", fSmartActionItem);
    }
