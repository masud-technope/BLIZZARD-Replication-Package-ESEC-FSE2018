...
public class InvocationCountExampleTest extends TestCase {
    ...
    public void test() throws Exception {
        InvocationCountPerformanceMeter performanceMeter = new InvocationCountPerformanceMeter(Performance.getDefault().getDefaultScenarioId(this), new Method[] { Double.class.getDeclaredMethod("hashCode", new Class[] {}), Double.class.getDeclaredMethod("equals", new Class[] { Object.class }) });
        try {
