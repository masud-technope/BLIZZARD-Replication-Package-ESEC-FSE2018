...
public class JavaElementLabelsTest18 extends CoreTests {
    ...
    public void testTypeLabelLambda1() throws Exception {
        ...
        lab = JavaElementLabels.getTextLabel(lambdaMethod, JavaElementLabels.T_FULLY_QUALIFIED | JavaElementLabels.M_POST_QUALIFIED | JavaElementLabels.M_PARAMETER_TYPES | JavaElementLabels.M_PARAMETER_NAMES);
