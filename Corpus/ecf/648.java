...
public class MultipleRecipientManager {
     ...
     */
    public static void send(Connection connection, Packet packet, List<String> to, List<String> cc, List<String> bcc) throws XMPPException {
     ...
     *                       some JEP-33 specific features were requested.
     */
    public static void send(Connection connection, Packet packet, List<String> to, List<String> cc, List<String> bcc, String replyTo, String replyRoom, boolean noReply) throws XMPPException {
    ...
    private static void sendToIndividualRecipients(Connection connection, Packet packet, List<String> to, List<String> cc, List<String> bcc) {
        if (to != null) {
    ...
    private static void sendThroughService(Connection connection, Packet packet, List<String> to, List<String> cc, List<String> bcc, String replyTo, String replyRoom, boolean noReply, String serviceAddress) {
