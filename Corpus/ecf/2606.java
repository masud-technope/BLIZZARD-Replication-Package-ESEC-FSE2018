    ...
    public  MethodInvocationDialog(IShellProvider parentShell, Class cls) {
        ...
        for (int i = 0; i < methods.length; i++) {
            ...
            for (int j = 0; j < types.length; j++) {
                ...
                !name.equals("char") && !name.equals("boolean") && !name.equals("int") && //$NON-NLS-1$ //$NON-NLS-2$
                !name.equals("double") && !name.equals("float") && //$NON-NLS-1$ //$NON-NLS-2$
                !name.equals("long") && !name.equals("short") && //$NON-NLS-1$ //$NON-NLS-2$
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        methodsViewer.addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent e) {
                ...
                if (element != null) {
                    getButton(IDialogConstants.OK_ID).setEnabled(!//$NON-NLS-1$
