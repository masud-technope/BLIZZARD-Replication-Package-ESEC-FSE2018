...
public class EclipseCollabSharedObject extends GenericSharedObject {
    ...
    protected void createOutputView() {
        //$NON-NLS-1$
        final String projectName = (localResource == null || localResource.getName().trim().equals("")) ? Messages.EclipseCollabSharedObject_WORKSPACE_RESOURCE_NAME : localResource.getName();
    ...
    public void sendShowView(IUser touser, String id) {
        ...
        try {
            ...
            log("Exception on sendShowView to " + touser, e);
        }
    }
