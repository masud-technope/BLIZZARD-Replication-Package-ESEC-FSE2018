    ...
    public static class Service extends DNSRecord {
        ...
        boolean handleQuery(JmDNSImpl dns, long expirationTime) {
            ...
            if (info != null && (port != info.port || !server.equalsIgnoreCase(dns.getLocalHost().getName()))) {
                ...
                DNSRecord.Service localService = new DNSRecord.Service(info.getQualifiedName(), DNSConstants.TYPE_SRV, DNSConstants.CLASS_IN | DNSConstants.CLASS_UNIQUE, DNSConstants.DNS_TTL, info.priority, info.weight, info.port, dns.getLocalHost().getName());
                // itself.
                try {
