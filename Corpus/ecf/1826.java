...
public abstract class AbstractSharedObjectContainerAdapterFactory extends AbstractContainerAdapterFactory {
    ...
    protected synchronized ISharedObject getSharedObjectAdapter(ISharedObjectContainer container, Class adapterType) {
        ...
        try {
            ...
            Trace.catching(Activator.PLUGIN_ID, SharedObjectDebugOptions.EXCEPTIONS_CATCHING, AbstractSharedObjectContainerAdapterFactory.class, "getSharedObjectAdapter", e);
    ...
    protected ID createAdapterID(ISharedObjectContainer container, Class adapterType) {
        ...
        try {
            ...
            Trace.catching(Activator.PLUGIN_ID, SharedObjectDebugOptions.EXCEPTIONS_CATCHING, AbstractSharedObjectContainerAdapterFactory.class, "getAdapterID", e);
