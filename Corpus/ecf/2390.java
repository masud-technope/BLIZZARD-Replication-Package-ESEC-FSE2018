/*
 * $Header: /home/data/cvs/rt/org.eclipse.ecf/tests/bundles/org.eclipse.ecf.tests.apache.httpclient.server/src/org/apache/commons/httpclient/TestHttps.java,v 1.1 2009/02/13 18:07:48 slewis Exp $
 * $Revision: 1.1 $
 ...
 * @author Ortwin Glück
 * @version $Id: TestHttps.java,v 1.1 2009/02/13 18:07:48 slewis Exp $
 */
    ...
    public void testHttpsGet() {
        ...
        if (PROXY_HOST != null) {
            if (PROXY_USER != null) {
                ...
                state.setProxyCredentials(AuthScope.ANY, new UsernamePasswordCredentials(PROXY_USER, PROXY_PASS));
            }
