...
public class XMPPContainer extends ClientSOContainer implements IPresenceService {
    ...
    public static final String CONTAINER_HELPER_ID = XMPPContainer.class.getName() + //$NON-NLS-1$
    ".xmpphandler";

    //$NON-NLS-1$
    protected static final String GOOGLE_SERVICENAME = "gmail.com";

    private static final String[] googleHosts = { GOOGLE_SERVICENAME, "talk.google.com", //$NON-NLS-1$ //$NON-NLS-2$
    "googlemail.com" };
