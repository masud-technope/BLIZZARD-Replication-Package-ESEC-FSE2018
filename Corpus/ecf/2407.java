...
public class TestMethodCharEncoding extends HttpClientTestBase {
    ...
    static final int RUSSIAN_STUFF_UTF8[] = { 0xD0, 0x92, 0xD1, 0x81, 0xD0, 0xB5, 0xD0, 0xBC, 0x5F, 0xD0, 0xBF, 0xD1, 0x80, 0xD0, 0xB8, 0xD0, 0xB2, 0xD0, 0xB5, 0xD1, 0x82 };
    ...
    private void verifyEncoding(RequestEntity entity, int[] sample) throws IOException {
    ...
    public void testQueryParams() throws Exception {
        ...
        get.setQueryString(new NameValuePair[] { new NameValuePair("ru", ru_msg), new NameValuePair("ch", ch_msg) });
        Map params = new HashMap();
        StringTokenizer tokenizer = new StringTokenizer(get.getQueryString(), "&");
    ...
    public void testUrlEncodedRequestBody() throws Exception {
        ...
        String ru_msg = constructString(RUSSIAN_STUFF_UNICODE);
        String ch_msg = constructString(SWISS_GERMAN_STUFF_UNICODE);
        httppost.setRequestBody(new NameValuePair[] { new NameValuePair("ru", ru_msg), new NameValuePair("ch", ch_msg) });
        httppost.setRequestHeader("Content-Type", PostMethod.FORM_URL_ENCODED_CONTENT_TYPE + "; charset=" + CHARSET_UTF8);
        ByteArrayOutputStream bos = new ByteArrayOutputStream();
