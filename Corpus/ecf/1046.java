...
public class Roster {
     ...
     */
    public enum SubscriptionMode implements  {
    ...
    private class PresencePacketListener implements PacketListener {
        ...
        public void processPacket(Packet packet) {
            ...
            if (presence.getType() == Presence.Type.unavailable) {
                ...
                } else // Otherwise, this is a normal offline presence.
                if (presenceMap.get(key) != null) {
                    Map<String, Presence> userPresences = presenceMap.get(key);
            ...
            // Otherwise, in manual mode so ignore.
            } else // presence info for the user.
            ...
            for (RosterPacket.Item item : rosterPacket.getRosterItems()) {
                ...
                if (RosterPacket.ItemType.remove.equals(item.getItemType())) {
                    ...
                    if (!item.getGroupNames().isEmpty()) {
                        unfiledEntries.remove(entry);
                    } else // Otherwise add it to the list of unfiled entries.
                    {
                        if (!unfiledEntries.contains(entry)) {
