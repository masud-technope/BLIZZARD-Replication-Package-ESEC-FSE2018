...
public class XMPPRoomID extends BaseID implements IChatID {
    ...
    public String toString() {
        //$NON-NLS-1$
        final StringBuffer sb = new StringBuffer("XMPPRoomID[");
        sb.append(//$NON-NLS-1$
        getNamespace().getScheme() + "://" + getUsername() + AT_SIGN + this.domain + DOT + this.host + SLASH + //$NON-NLS-1$
        this.roomname).append(//$NON-NLS-1$
        "]");
        return sb.toString();
    }
