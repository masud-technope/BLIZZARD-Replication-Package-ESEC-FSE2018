...
public abstract class Node {
    ...
    protected Packet sendPubsubPacket(Type type, NodeExtension ext) throws XMPPException {
        return PubSubManager.sendPubsubPacket(con, to, type, ext);
    }

    protected Packet sendPubsubPacket(Type type, NodeExtension ext, PubSubNamespace ns) throws XMPPException {
