 ...
 * $RCSfile$
 * $Revision: 11825 $
 * $Date: 2010-08-15 08:45:57 -0700 (Sun, 15 Aug 2010) $
 *
...
public class Message extends Packet {
    ...
    public void setSubject(String subject) {
        if (subject == null) {
            // use empty string because #removeSubject(null) is ambiguous 
            removeSubject("");
            return;
        }
    ...
    public void setBody(String body) {
        if (body == null) {
            // use empty string because #removeBody(null) is ambiguous
            removeBody("");
            return;
        }
        addBody(null, body);
