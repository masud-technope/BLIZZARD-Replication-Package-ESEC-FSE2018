...
public class SimpleHttpServer implements Runnable {
    ...
    public  SimpleHttpServer(String serverThreadName, SimpleSocketFactory socketfactory, int port) throws IOException {
        ...
        try {
            while (!this.stopped && !Thread.interrupted()) {
                ...
                try {
                    ...
                    Thread t = new SimpleConnectionThread(tg, this.testname + " thread " + this.count, conn, this.connections, this.requestHandler);
                    t.setDaemon(true);
                    t.start();
                } catch (IOException e) {
