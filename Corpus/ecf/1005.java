...
public class VCardProvider implements IQProvider {
    ...
    public IQ parseIQ(XmlPullParser parser) throws Exception {
        ...
        try {
            ...
            while (true) {
                ...
                if (event == XmlPullParser.END_TAG && "vCard".equals(parser.getName()))
                    break;
                event = parser.next();
            }
    ...
    private static class VCardReader {
        ...
        private void setupPhoto() {
            ...
            for (int i = 0; i < childNodeCount; i++) nodes.add(childNodes.item(i));
            String name = null;
            String value = null;
            for (Node n : nodes) {
                name = n.getNodeName();
