...
public class RpcClientContainerInstantiator extends BaseContainerInstantiator implements IRemoteServiceContainerInstantiator {
    ...
    public IContainer createInstance(ContainerTypeDescription description, Object[] parameters) throws ContainerCreateException {
        try {
            ...
            throw new ContainerCreateException("Could not create RPCClientContainer", e);
        }
    }
