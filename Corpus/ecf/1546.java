...
public class RpcNamespace extends Namespace {
	 ...
	 */
    //$NON-NLS-1$
    public static final String NAME = "ecf.xmlrpc.namespace";

    /**
	 * The scheme of this namespace.
	 */
    //$NON-NLS-1$
    public static final String SCHEME = "xmlrpc";

    public  RpcNamespace() {
        //$NON-NLS-1$
        super(NAME, "Rpc Namespace");
    }
    ...
    public ID createInstance(Object[] parameters) throws IDCreateException {
        ...
        try {
            ...
            //$NON-NLS-1$
            throw new IllegalArgumentException("Invalid parameters to RPCID creation");
        } catch (Exception e) {
            throw new IDCreateException("Could not create RPC ID", e);
        }
    }

    public Class[][] getSupportedParameterTypes() {
        return new Class[][] { { String.class }, { Integer.class }, { Boolean.class }, { Double.class }, { Date.class }, { byte[].class }, { Object[].class }, { List.class }, { Map.class } };
    }
