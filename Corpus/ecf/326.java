...
public abstract class AdHocCommand {
    ...
    public static SpecificErrorCondition getSpecificErrorCondition(XMPPError error) {
        ...
        for (SpecificErrorCondition condition : SpecificErrorCondition.values()) {
            if (error.getExtension(condition.toString(), AdHocCommandData.SpecificError.namespace) != null) {
                return condition;
            }
        }
        return null;
    ...
    public enum SpecificErrorCondition implements  {
