...
public class TestHttpConnectionManager extends HttpClientTestBase {
    ...
    public void testConnectMethodFailureRelease() throws Exception {
        ...
        // will not be used
        client.getHostConfiguration().setHost("notARealHost", 1234, new Protocol("https", (ProtocolSocketFactory) new FakeSecureProtocolSocketFactory(), 443));
    ...
    public void testReclaimUnusedConnection() {
        this.server.setHttpService(new EchoService());
        MultiThreadedHttpConnectionManager connectionManager = new MultiThreadedHttpConnectionManager();
        connectionManager.getParams().setIntParameter(HttpConnectionManagerParams.MAX_TOTAL_CONNECTIONS, 1);
        client.setHttpConnectionManager(connectionManager);
        // we shouldn't have to wait if a connection is available
    ...
    static class GetConnectionThread extends Thread {
        ...
        public  GetConnectionThread(HostConfiguration hostConfiguration, MultiThreadedHttpConnectionManager connectionManager, long timeout) {
