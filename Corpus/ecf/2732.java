...
public class FileTransferManager {
    ...
    public OutgoingFileTransfer createOutgoingFileTransfer(String userID) {
        ...
        } else // in order to reach an client entity.
        if (!StringUtils.isFullJID(userID)) {
            throw new IllegalArgumentException("The provided user id was not a full JID (i.e. with resource part)");
        }
        return new OutgoingFileTransfer(connection.getUser(), userID, fileTransferNegotiator.getNextStreamID(), fileTransferNegotiator);
    }
