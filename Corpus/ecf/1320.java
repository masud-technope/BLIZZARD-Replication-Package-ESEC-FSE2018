/*
 * $Header: /home/data/cvs/rt/org.eclipse.ecf/tests/bundles/org.eclipse.ecf.tests.apache.httpclient.server/src/org/apache/commons/httpclient/TestHttpConnection.java,v 1.1 2009/02/13 18:07:48 slewis Exp $
 * $Revision: 1.1 $
 ...
 *
 * @version $Id: TestHttpConnection.java,v 1.1 2009/02/13 18:07:48 slewis Exp $
 *
 */
public class TestHttpConnection extends HttpClientTestBase {
    ...
    public void testConnTimeoutRelease() {
        ...
        Protocol testProtocol = new Protocol("timeout", new DelayedProtocolSocketFactory(500, Protocol.getProtocol("http").getSocketFactory()), this.server.getLocalPort());
