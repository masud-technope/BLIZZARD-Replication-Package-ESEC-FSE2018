/*
 * $Header: /home/data/cvs/rt/org.eclipse.ecf/tests/bundles/org.eclipse.ecf.tests.apache.httpclient.server/src/org/apache/commons/httpclient/TestPostMethod.java,v 1.1 2009/02/13 18:07:49 slewis Exp $
 * $Revision: 1.1 $
 ...
 * @version $Id: TestPostMethod.java,v 1.1 2009/02/13 18:07:49 slewis Exp $
 */
public class TestPostMethod extends HttpClientTestBase {
    ...
    public void testParametersBodyToParamServlet() throws Exception {
        ...
        NameValuePair[] parametersBody = new NameValuePair[] { new NameValuePair("pname1", "pvalue1"), new NameValuePair("pname2", "pvalue2") };
    ...
    public void testStringBodyToParamServlet() throws Exception {
        ...
        method.setRequestEntity(new StringRequestEntity(stringBody, PostMethod.FORM_URL_ENCODED_CONTENT_TYPE, null));
        this.server.setHttpService(new EchoService());
        try {
            this.client.executeMethod(method);
            assertEquals(200, method.getStatusCode());
