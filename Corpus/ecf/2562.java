...
public class Workgroup {
    ...
    public  Workgroup(String workgroupJID, Connection connection) {
         ...
         */
        MultiUserChat.addInvitationListener(connection, new org.jivesoftware.smackx.muc.InvitationListener() {
    ...
    public boolean isAvailable() {
        ...
        PacketCollector collector = connection.createPacketCollector(new AndFilter(fromFilter, typeFilter));
