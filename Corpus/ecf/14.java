/*
 * $Header: /home/data/cvs/rt/org.eclipse.ecf/tests/bundles/org.eclipse.ecf.tests.apache.httpclient.server/src/org/apache/commons/httpclient/TestRedirects.java,v 1.1 2009/02/13 18:07:50 slewis Exp $
 * $Revision: 1.1 $
 ...
 * 
 * @version $Id: TestRedirects.java,v 1.1 2009/02/13 18:07:50 slewis Exp $
 */
public class TestRedirects extends HttpClientTestBase {
    ...
    public void testRelativeRedirect() throws IOException {
        ...
        this.client.getParams().setBooleanParameter(HttpClientParams.REJECT_RELATIVE_REDIRECT, false);
        GetMethod httpget = new GetMethod("/oldlocation/");
        httpget.setFollowRedirects(true);
        try {
            this.client.executeMethod(httpget);
    ...
    public void testRejectRelativeRedirect() throws IOException {
        ...
        int port = this.server.getLocalPort();
        this.server.setHttpService(new RelativeRedirectService());
        this.client.getParams().setBooleanParameter(HttpClientParams.REJECT_RELATIVE_REDIRECT, true);
        GetMethod httpget = new GetMethod("/oldlocation/");
        httpget.setFollowRedirects(true);
        try {
            this.client.executeMethod(httpget);
