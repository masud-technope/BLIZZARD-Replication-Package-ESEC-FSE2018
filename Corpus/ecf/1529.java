...
public class InputDialogWithComboHistory extends Dialog {
     ...
     */
    public  InputDialogWithComboHistory(Shell parentShell, String dialogTitle, String dialogMessage, String initialValue, String[] additionalValues, IInputValidator validator) {
        super(parentShell);
