    ...
    private class PresencePacketListener implements PacketListener {
        ...
        public void processPacket(Packet packet) {
            ...
            if (presence.getType() == Presence.Type.available) {
                ...
                AgentStatus agentStatus = (AgentStatus) presence.getExtension(AgentStatus.ELEMENT_NAME, AgentStatus.NAMESPACE);
                if (agentStatus == null) {
                    return;
                } else // of this Agent
                if (!workgroupJID.equals(agentStatus.getWorkgroupJID())) {
                    return;
                }
            ...
            } else // If an "unavailable" packet, remove any entries in the presence map.
            ...
            if (packet instanceof AgentStatusRequest) {
                ...
                for (Iterator<AgentStatusRequest.Item> i = statusRequest.getAgents().iterator(); i.hasNext(); ) {
                    ...
                    if ("remove".equals(item.getType())) {
                        ...
                        // about them.
                        String key = StringUtils.parseName(StringUtils.parseName(agentJID) + "@" + StringUtils.parseServer(agentJID));
                        presenceMap.remove(key);
