/*
 * $Header: /home/data/cvs/rt/org.eclipse.ecf/tests/bundles/org.eclipse.ecf.tests.apache.httpclient.server/src/org/apache/commons/httpclient/params/TestHttpParams.java,v 1.1 2009/02/13 18:07:51 slewis Exp $
 * $Revision: 1.1 $
...
public class TestHttpParams extends HttpClientTestBase {
    ...
    public void testDefaults() throws IOException {
        ...
        assertEquals(HttpStatus.SC_OK, httpget.getStatusCode());
        assertEquals("test", httpget.getRequestHeader("User-Agent").getValue());
        assertEquals("test", httpget.getParams().getParameter(HttpMethodParams.USER_AGENT));
        assertEquals("test", hostconfig.getParams().getParameter(HttpMethodParams.USER_AGENT));
        assertEquals("test", client.getParams().getParameter(HttpMethodParams.USER_AGENT));
    }
}
