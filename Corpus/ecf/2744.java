...
public class SimpleHttpServerConnection {
    ...
    public SimpleRequest readRequest() throws IOException {
        try {
            ...
            SimpleRequest request = new SimpleRequest(RequestLine.parseLine(line), HttpParser.parseHeaders(this.in, HTTP_ELEMENT_CHARSET), this.in);
            return request;
        } catch (IOException e) {
            close();
            throw e;
    ...
    public SimpleResponse readResponse() throws IOException {
        try {
            ...
            SimpleResponse response = new SimpleResponse(new StatusLine(line), HttpParser.parseHeaders(this.in, HTTP_ELEMENT_CHARSET), this.in);
            return response;
        } catch (IOException e) {
            close();
            throw e;
