/*
 * $Header: /home/data/cvs/rt/org.eclipse.ecf/tests/bundles/org.eclipse.ecf.tests.apache.httpclient.server/src/org/apache/commons/httpclient/TestHttpState.java,v 1.1 2009/02/13 18:07:50 slewis Exp $
 * $Revision: 1.1 $
 ...
 * 
 * @version $Id: TestHttpState.java,v 1.1 2009/02/13 18:07:50 slewis Exp $
 * 
 */
public class TestHttpState extends TestCase {
    ...
    public static final AuthScope SCOPE1 = new AuthScope(AuthScope.ANY_HOST, AuthScope.ANY_PORT, "realm1");

    public static final AuthScope SCOPE2 = new AuthScope(AuthScope.ANY_HOST, AuthScope.ANY_PORT, "realm2");

    public static final AuthScope BOGUS = new AuthScope(AuthScope.ANY_HOST, AuthScope.ANY_PORT, "bogus");

    public static final AuthScope DEFSCOPE = new AuthScope("host", AuthScope.ANY_PORT, "realm");
