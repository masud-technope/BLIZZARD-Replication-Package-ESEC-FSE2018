...
public abstract class AbstractDistributionTest extends ContainerAbstractTestCase {
    ...
    protected void assertReferenceHasCorrectType(ServiceReference sr, String classname) {
    ...
    protected void assertReferencesValidAndFirstHasCorrectType(ServiceReference[] references, String classname) {
    ...
    protected ServiceTracker createProxyServiceTracker(String clazz) throws InvalidSyntaxException {
        ServiceTracker st = new ServiceTracker(getContext(), getContext().createFilter("(&(" + org.osgi.framework.Constants.OBJECTCLASS + "=" + clazz + ")(" + org.osgi.service.remoteserviceadmin.RemoteConstants.SERVICE_IMPORTED + "=*))"), new ServiceTrackerCustomizer() {
