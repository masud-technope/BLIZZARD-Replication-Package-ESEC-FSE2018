...
public class R_OSGiWSSRemoteServiceAccessTest extends AbstractRemoteServiceAccessTest {
    ...
    protected IContainer createClient(int index) throws Exception {
        return ContainerFactory.getDefault().createContainer(CONTAINER_TYPE_NAME, new Object[] { IDFactory.getDefault().createStringID("r-osgi.wss://localhost:" + (9279 + index)) });
    }
