...
public final class EndpointPermission extends Permission {
    ...
    private static final int ACTION_READ = 0x00000001;

    private static final int ACTION_IMPORT = 0x00000002;

    private static final int ACTION_EXPORT = 0x00000004;

    private static final int ACTION_ALL = ACTION_EXPORT | ACTION_IMPORT | ACTION_READ;
...
final class EndpointPermissionCollection extends PermissionCollection {
    ...
    private synchronized void readObject(java.io.ObjectInputStream in) throws IOException, ClassNotFoundException {
        ...
        @SuppressWarnings("unchecked") HashMap<String, EndpointPermission> p = (HashMap<String, EndpointPermission>) gfields.get("permissions", new HashMap<String, EndpointPermission>());
        permissions = p;
