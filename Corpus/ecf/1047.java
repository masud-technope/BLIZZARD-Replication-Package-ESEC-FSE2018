/*
 * $Header: /home/data/cvs/rt/org.eclipse.ecf/tests/bundles/org.eclipse.ecf.tests.apache.httpclient.server/src/org/apache/commons/httpclient/TestHttpMethodFundamentals.java,v 1.1 2009/02/13 18:07:48 slewis Exp $
 * $Revision: 1.1 $
 ...
 * 
 * @version $Id: TestHttpMethodFundamentals.java,v 1.1 2009/02/13 18:07:48 slewis Exp $
 */
public class TestHttpMethodFundamentals extends HttpClientTestBase {
    ...
    public void testHttpMethodBaseTEandCL() throws Exception {
        ...
        try {
            ...
            HttpConnection conn = this.client.getHttpConnectionManager().getConnection(this.client.getHostConfiguration());
            assertNotNull(conn);
            conn.assertNotOpen();
        } finally {
    ...
    public void testUrlGetMethodWithPathQuery() {
        ...
        try {
            assertEquals("Get URL", "http://www.fubar.com/path1/path2?query=string", method.getURI().toString());
    ...
    public void testUrlGetMethodWithPath() {
        ...
        try {
            assertEquals("Get URL", "http://www.fubar.com/path1/path2", method.getURI().toString());
        } catch (URIException e) {
            fail("trouble getting URI: " + e);
        }
        assertEquals("Get Path", "/path1/path2", method.getPath());
    ...
    public void testUrlGetMethod() {
        ...
        try {
            assertEquals("Get URL", "http://www.fubar.com/", method.getURI().toString());
        } catch (URIException e) {
            fail("trouble getting URI: " + e);
        }
