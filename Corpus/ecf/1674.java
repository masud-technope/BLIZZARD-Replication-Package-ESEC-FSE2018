/*
 * $Header: /home/data/cvs/rt/org.eclipse.ecf/tests/bundles/org.eclipse.ecf.tests.apache.httpclient.server/src/org/apache/commons/httpclient/TestVirtualHost.java,v 1.1 2009/02/13 18:07:49 slewis Exp $
 * $Revision: 1.1 $
...
public class TestVirtualHost extends HttpClientTestBase {
    ...
    private class VirtualSocketFactory implements ProtocolSocketFactory {
        ...
        public Socket createSocket(final String host, int port, final InetAddress localAddress, int localPort, final HttpConnectionParams params) throws IOException, UnknownHostException, ConnectTimeoutException {
