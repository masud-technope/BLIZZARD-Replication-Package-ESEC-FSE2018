...
public final class ImportRewriteConfiguration {
    ...
    public enum OriginalImportHandling implements  {
	 ...
	 */
    public enum ImportContainerSorting implements  {
	 ...
	 */
    public enum ImplicitImportIdentification implements  {
        ...
        JAVA_LANG_AND_CU_PACKAGE() {
            ...
            Set<String> determineImplicitImportContainers(ICompilationUnit compilationUnit) {
                ...
                //$NON-NLS-1$
                implicitImportContainerNames.add(//$NON-NLS-1$
                "java.lang");
