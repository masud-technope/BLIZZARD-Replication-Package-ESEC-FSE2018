 ...
 */
    public void testSimpleSubTypeHierarchy() throws CoreException {
        ...
        IFile file = null;
        try {
            file = this.createFile("P/src/x/y/B.java", "package x.y;\n" + "public class B {\n" + "}");
            ...
            assertHierarchyEquals("Focus: B [in B.java [in x.y [in src [in P]]]]\n" + "Super types:\n" + "  Object [in Object.class [in java.lang [in " + getExternalJCLPathString() + "]]]\n" + "Sub types:\n" + "  A [in [Working copy] A.java [in x.y [in src [in P]]]]\n", h);
        } finally {
            if (file != null) {
 ...
 */
    public void testSimpleSuperTypeHierarchy() throws CoreException {
        ...
        IFile file = null;
        try {
            file = this.createFile("P/src/x/y/C.java", "package x.y;\n" + "public class C extends B {\n" + "}");
            ...
            assertHierarchyEquals("Focus: C [in C.java [in x.y [in src [in P]]]]\n" + "Super types:\n" + "  B [in [Working copy] A.java [in x.y [in src [in P]]]]\n" + "    Object [in Object.class [in java.lang [in " + getExternalJCLPathString() + "]]]\n" + "Sub types:\n", h);
        } finally {
            if (file != null) {
                this.deleteResource(file);
            }
    ...
    public void test228845() throws CoreException {
        ...
        try {
            file = this.createFile("P/src/x/y/B.java", "package x.y;\n" + "public class B {\n" + "}");
            IType type = this.getCompilationUnit("P/src/x/y/B.java").getType("B");
            // no working copies explicitly passed, should still honor primary working copies.
    ...
    public void test442534() throws CoreException, IOException {
        ...
        try {
            project = this.createJavaProject("Bug442534", new String[] { "src" }, new String[] { this.getExternalJCLPathString(), "lib" }, "bin");
            ...
            this.createFile("Bug442534/src/X.java", "import q.*;\n" + "public final class X {\n" + "	public static void main(String[] args) {\n" + "		foo(e -> { if (new Object() instanceof Y);});\n" + "	};\n" + "	static void foo(I i) {\n" + "		return;\n" + "	}\n" + "}\n" + "interface I {\n" + "	void foo(int x);\n" + "}\n");
            this.createFile("Bug442534/src/q/Y.java", "package q;\n" + "public class Y {\n" + "}\n");
            this.createFile("Bug442534/src/q/package-info.java", "package q;\n");
