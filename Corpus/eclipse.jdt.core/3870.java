...
public interface ClassFileConstants {
	 ...
	 */
    // indicate presence of an attribute  "DefaultValue" (annotation method)
    ...
    int ATTR_STACK_MAP_TABLE = 0x8;

    // Stack map attribute: cldc
    int ATTR_STACK_MAP = 0x10;

    // type annotation attribute (jsr 308)
    int ATTR_TYPE_ANNOTATION = 0x20;

    // method parameters attribute (jep 118)
    int ATTR_METHOD_PARAMETERS = 0x40;
