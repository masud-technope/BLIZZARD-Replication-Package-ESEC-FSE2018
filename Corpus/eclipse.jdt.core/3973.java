...
public final class SourceType {
    ...
    protected void addField(SourceField sourceField) {
        ...
        if (this.numberOfFields == this.fields.length) {
            System.arraycopy(this.fields, 0, this.fields = new SourceField[this.numberOfFields * 2], 0, this.numberOfFields);
        }
    ...
    protected void addMethod(SourceMethod sourceMethod) {
        ...
        if (this.numberOfMethods == this.methods.length) {
            System.arraycopy(this.methods, 0, this.methods = new SourceMethod[this.numberOfMethods * 2], 0, this.numberOfMethods);
        }
    ...
    public SourceType[] getMemberTypes() {
        if (this.memberTypes != null && this.memberTypes.length != this.numberOfMemberTypes) {
            System.arraycopy(this.memberTypes, 0, this.memberTypes = new SourceType[this.numberOfMemberTypes], 0, this.numberOfMemberTypes);
        }
