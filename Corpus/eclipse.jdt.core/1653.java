...
public class CompatibilityRulesTests extends AbstractASTTests {
    ...
    public void test005() throws JavaModelException {
        ITypeBinding[] bindings = createTypeBindings(new String[] {}, new String[] { "I", "J" });
    ...
    public void test012() throws CoreException {
        try {
            ...
            ITypeBinding[] bindings = createTypeBindings(new String[] {}, new String[] { "I", "Ljava/lang/Object;" }, project);
    ...
    public void test019() throws JavaModelException {
        IMethodBinding[] bindings = createMethodBindings(new String[] { "/P/p1/X.java", "package p1;\n" + "public class X {\n" + "  void foo() {\n" + "  }\n" + "}", "/P/p1/Y.java", "package p1;\n" + "public class Y extends X {\n" + "  void foo() {\n" + "  }\n" + "}" }, new String[] { "Lp1/Y;.foo()V", "Lp1/X;.foo()V" });
    ...
    public void test022() throws JavaModelException {
        ...
        try {
            workingCopy = getWorkingCopy("/P/p1/X.java", /*compute problems to get bindings*/
            true);
    ...
    public void test023() throws JavaModelException {
        ITypeBinding[] bindings = createTypeBindings(new String[] { "/P/java/lang/Integer.java", "package java.lang;\n" + "public class Integer {\n" + "}" }, new String[] { "I", "Ljava/lang/Integer;" });
    ...
    public void test042() throws JavaModelException {
        ...
        // parameterized type
        ITypeBinding superType = bindings[0].getDeclaringClass().getSuperclass();
    ...
    public void test045() throws JavaModelException {
        ITypeBinding[] bindings = createTypeBindings(new String[] {}, new String[] { "B", "I" });
