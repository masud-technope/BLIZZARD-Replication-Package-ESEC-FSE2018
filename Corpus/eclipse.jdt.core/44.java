 ...
 */
	...
	*/
        if (fieldDeclaration.declarationSourceEnd > 0 && nestedBlockDeclaration.sourceStart > fieldDeclaration.declarationSourceEnd) {
            // ignore
            if (this.parent == null)
                return this;
 ...
 */
    public RecoveredElement add(FieldDeclaration newFieldDeclaration, int bracketBalanceValue) {
        ...
        (// initializer
        newFieldDeclaration.type == null) || (// non void
        (fieldTypeName = newFieldDeclaration.type.getTypeName()).length == 1 && CharOperation.equals(fieldTypeName[0], VoidBinding.sourceName()))) {
            // ignore
            if (this.parent == null)
                return this;
 ...
 */
    public RecoveredElement add(LocalDeclaration localDeclaration, int bracketBalanceValue) {
        ...
        if (fieldDeclaration.declarationSourceEnd != 0 && localDeclaration.declarationSourceStart > fieldDeclaration.declarationSourceEnd) {
            // ignore
            if (parent == null)
                return this;
 ...
 */
    public RecoveredElement add(Statement statement, int bracketBalanceValue) {
		...
		it must be belonging to an enclosing type */
        if (fieldDeclaration.declarationSourceEnd != 0 && statement.sourceStart > fieldDeclaration.declarationSourceEnd) {
            // ignore
            if (parent == null)
                return this;
    ...
    public RecoveredElement add(TypeDeclaration typeDeclaration, int bracketBalanceValue) {
        /* do not consider a type starting passed the type end (if set)
		it must be belonging to an enclosing type */
        if (fieldDeclaration.declarationSourceEnd != 0 && typeDeclaration.declarationSourceStart > fieldDeclaration.declarationSourceEnd) {
            // ignore
            if (parent == null)
                return this;
