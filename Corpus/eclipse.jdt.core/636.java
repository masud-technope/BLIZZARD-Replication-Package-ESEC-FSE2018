            ...
            if (CharOperation.equals(attributeName, ConstantValueName)) {
                ...
                switch(u1At(relativeOffset)) {
                    ...
                    case StringTag:
                        ...
                        constant = new StringConstant(String.valueOf(utf8At(utf8Offset + 3, u2At(utf8Offset + 1))));
                        break;
                }
            }
            readOffset += (6 + u4At(readOffset + 2));
 ...
 */
    ...
    public String toString() {
        ...
        return buffer.append(//$NON-NLS-1$
        ...
        ((modifiers & 0x0080) == 0x0080 ? "transient " : "")).append(getTypeName()).append(//$NON-NLS-1$
        " ").append(getName()).append(//$NON-NLS-1$
        " ").append(getConstant()).append(//$NON-NLS-1$
        "}").toString();
    }
}
