...
public class SuperTypeTest extends AbstractRegressionTest {
    ...
    public void test012() {
        ...
        runNegativeTest(/* flush output directory */
        true, new String[] /* test files */
        { "X.java", "public class X implements J {}\n" + "class Y extends X implements I {}\n" + "interface I {}\n" + "interface J extends I {}\n" }, /* no class libraries */
        null, customOptions, // compiler results
        "----------\n" + /* expected compiler log */
    ...
    public void test014() {
        ...
        runNegativeTest(/* flush output directory */
        true, new String[] /* test files */
        { "X.java", "public class X implements I, J {}", "I.java", "public interface I {}", "J.java", "public interface J extends I {}" }, /* no class libraries */
        null, customOptions, // compiler results
