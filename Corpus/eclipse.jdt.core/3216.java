...
public interface TypeConstants {
    ...
    //$NON-NLS-1$
    char[][] JAVA_UTIL_COLLECTION = { JAVA, UTIL, "Collection".toCharArray() };

    //$NON-NLS-1$
    char[][] JAVA_UTIL_ITERATOR = { JAVA, UTIL, "Iterator".toCharArray() };

    //$NON-NLS-1$
    char[][] JAVA_UTIL_OBJECTS = { JAVA, UTIL, "Objects".toCharArray() };
    ...
    //$NON-NLS-1$
    char[][] JAVA_LANG_ANNOTATION_REPEATABLE = { JAVA, LANG, ANNOTATION, "Repeatable".toCharArray() };

    //$NON-NLS-1$
    char[][] JAVA_LANG_OVERRIDE = { JAVA, LANG, "Override".toCharArray() };

    //$NON-NLS-1$
    char[][] JAVA_LANG_FUNCTIONAL_INTERFACE = { JAVA, LANG, "FunctionalInterface".toCharArray() };
    ...
    //$NON-NLS-1$
    char[][] JAVA_IO_EXTERNALIZABLE = { JAVA, IO, "Externalizable".toCharArray() };
    ...
    char[][] JAVAX_RMI_CORBA_STUB = new char[][] { JAVAX, //$NON-NLS-1$
    "rmi".toCharArray(), //$NON-NLS-1$
    "CORBA".toCharArray(), //$NON-NLS-1$
    "Stub".toCharArray() };

    //$NON-NLS-1$
    char[][] JAVA_LANG_SAFEVARARGS = { JAVA, LANG, "SafeVarargs".toCharArray() };

    //$NON-NLS-1$
    char[] INVOKE = "invoke".toCharArray();

    char[][] // Signature while parsing binary file
    JAVA_LANG_INVOKE_METHODHANDLE_POLYMORPHICSIGNATURE = { JAVA, LANG, INVOKE, //$NON-NLS-1$
    "MethodHandle".toCharArray(), //$NON-NLS-1$
    "PolymorphicSignature".toCharArray() };

    char[][] // Signature while parsing source file
    JAVA_LANG_INVOKE_METHODHANDLE_$_POLYMORPHICSIGNATURE = { JAVA, LANG, INVOKE, //$NON-NLS-1$
    "MethodHandle$PolymorphicSignature".toCharArray() };

    //$NON-NLS-1$
    char[][] JAVA_LANG_INVOKE_LAMBDAMETAFACTORY = { JAVA, LANG, INVOKE, "LambdaMetafactory".toCharArray() };

    //$NON-NLS-1$
    char[][] JAVA_LANG_INVOKE_SERIALIZEDLAMBDA = { JAVA, LANG, INVOKE, "SerializedLambda".toCharArray() };

    //$NON-NLS-1$
    char[][] JAVA_LANG_INVOKE_METHODHANDLES = { JAVA, LANG, INVOKE, "MethodHandles".toCharArray() };

    //$NON-NLS-1$
    char[][] JAVA_LANG_AUTOCLOSEABLE = { JAVA, LANG, "AutoCloseable".toCharArray() };
    ...
    //$NON-NLS-1$ //$NON-NLS-2$
    char[][] GUAVA_CLOSEABLES = { COM, GOOGLE, "common".toCharArray(), IO, "Closeables".toCharArray() };

    //$NON-NLS-1$
    char[][] APACHE_IOUTILS = { ORG, APACHE, COMMONS, IO, "IOUtils".toCharArray() };

    //$NON-NLS-1$ //$NON-NLS-2$
    char[][] APACHE_DBUTILS = { ORG, APACHE, COMMONS, "dbutils".toCharArray(), "DbUtils".toCharArray() };

    //$NON-NLS-1$
    char[] CLOSE_QUIETLY = "closeQuietly".toCharArray();

    CloseMethodRecord[] closeMethods = new CloseMethodRecord[] { new CloseMethodRecord(GUAVA_CLOSEABLES, CLOSE_QUIETLY, 1), new CloseMethodRecord(GUAVA_CLOSEABLES, CLOSE, 1), new CloseMethodRecord(APACHE_IOUTILS, CLOSE_QUIETLY, 1), new CloseMethodRecord(APACHE_DBUTILS, CLOSE, 1), // closeQuietly(Connection,Statement,ResultSet) 
    new CloseMethodRecord(APACHE_DBUTILS, CLOSE_QUIETLY, 3), //$NON-NLS-1$
    ...
    new CloseMethodRecord(APACHE_DBUTILS, "rollbackAndCloseQuietly".toCharArray(), 1) };

    // white lists of closeables:
    char[][] JAVA_IO_WRAPPER_CLOSEABLES = new char[][] { //$NON-NLS-1$
    ...
    "OutputStreamWriter".toCharArray() };

    char[][] JAVA_UTIL_ZIP_WRAPPER_CLOSEABLES = new char[][] { //$NON-NLS-1$
    ...
    char[][][] OTHER_WRAPPER_CLOSEABLES = new char[][][] { //$NON-NLS-1$ //$NON-NLS-2$
    ...
    { JAVA, "beans".toCharArray(), "XMLDecoder".toCharArray() }, //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    { JAVAX, "sound".toCharArray(), "sampled".toCharArray(), "AudioInputStream".toCharArray() } };

    char[][] JAVA_IO_RESOURCE_FREE_CLOSEABLES = new char[][] { //$NON-NLS-1$
    ...
    "StringBufferInputStream".toCharArray() };

    char[][] RESOURCE_FREE_CLOSEABLE_STREAM = new char[][] { //$NON-NLS-1$ //$NON-NLS-2$
    JAVA, //$NON-NLS-1$ //$NON-NLS-2$
    UTIL, //$NON-NLS-1$ //$NON-NLS-2$
    "stream".toCharArray(), //$NON-NLS-1$ //$NON-NLS-2$
    "Stream".toCharArray() };
    ...
    char[][] COM_GOOGLE_COMMON_BASE_PRECONDITIONS = new char[][] { COM, GOOGLE, "common".toCharArray(), "base".toCharArray(), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    "Preconditions".toCharArray() };
    ...
    public static enum BoundCheckStatus implements  {
