...
public class WorkingCopyNotInClasspathTests extends ModifyingResourceTests {
    ...
    public void setUp() throws Exception {
        ...
        try {
            ...
            IFile file = this.createFile("P/txt/X.java", "public class X {\n" + "}");
    ...
    public void testCommitWorkingCopy1() throws CoreException {
        ...
        assertSourceEquals("Unexpected contents", newContents, new String(Util.getResourceContentsAsCharArray(originalFile)));
    }
 ...
 */
    ...
    public void testGetSource() throws CoreException {
        ...
        try {
            ...
            assertEquals("Unexpected source", source, copy.getSource());
        } finally {
            if (copy != null)
                copy.discardWorkingCopy();
 ...
 */
    public void testReconcileSimpleProject() throws CoreException {
        ...
        try {
            ...
            wc.reconcile(ICompilationUnit.NO_AST, /*force problem detection*/
            true, owner, null);
        } finally {
            if (wc != null) {
                wc.discardWorkingCopy();
 ...
 */
    public void testReconcileSimpleProject2() throws CoreException {
        ...
        try {
            ...
            wc.becomeWorkingCopy(null);
            wc.reconcile(ICompilationUnit.NO_AST, /*force problem detection*/
            true, newWorkingCopyOwner(pbRequestor), null);
        } finally {
            if (wc != null) {
                wc.discardWorkingCopy();
            }
 ...
 */
    public void testSimpleProject() throws CoreException {
        ...
        try {
            ...
            IFile file = createFile("/SimpleProject/X.java", "public class X {\n" + "}");
            ICompilationUnit cu = JavaCore.createCompilationUnitFrom(file);
            copy = cu.getWorkingCopy(null);
            try {
                copy.getChildren();
 ...
 */
    public void testPrimaryExistence() {
        ICompilationUnit primary = this.workingCopy.getPrimary();
        assertTrue("Primary compilation unit should not exist", !primary.exists());
    }
 ...
 */
    public void testPrimaryIsOpen() {
        ...
        assertTrue("Primary compilation should not be opened", !original.isOpen());
    }
