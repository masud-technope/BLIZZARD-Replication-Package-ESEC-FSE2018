...
public class ExclusionPatternsTests extends ModifyingResourceTests {
    ...
    protected void setClasspath(String[] sourceFoldersAndExclusionPatterns) throws JavaModelException {
        this.project.setRawClasspath(createClasspath(sourceFoldersAndExclusionPatterns, false, /*no inclusion*/
        true), null);
    }
 ...
 */
    public void testAddExclusionOnFolderUnderProject() throws CoreException {
        try {
            ...
            createFolder("/P1/doc");
            clearDeltas();
            javaProject.setRawClasspath(createClasspath(new String[] { "/P1", "doc/" }, /*no inclusion*/
            false, /*exclusion*/
            true), null);
            ...
            assertSortedElementsEqual("Unexpected children", "<default> [in <project root> [in P1]]", root.getChildren());
            assertResourceNamesEqual("Unexpected non-java resources of project", ".classpath\n" + ".project\n" + "doc", javaProject.getNonJavaResources());
        } finally {
            deleteProject("P1");
        }
    }
 ...
 */
    public void testCreateExcludedPackage2() throws CoreException {
        ...
        assertResourceNamesEqual("Unexpected non-java resources", "org", root.getNonJavaResources());
    }
 ...
 */
    public void testCreateExcludedAndIncludedPackages() throws CoreException {
        ...
        assertResourceNamesEqual("Unexpected non-java resources", "p2", root.getPackageFragment("p1").getNonJavaResources());
    }
 ...
 */
    public void testRenameExcludedCompilationUnit() throws CoreException {
        ...
        assertDeltas("Unexpected deltas", "P[*]: {CHILDREN}\n" + "	src[*]: {CHILDREN}\n" + "		p[*]: {CHILDREN | CONTENT}\n" + "			B.java[+]: {}\n" + "			ResourceDelta(/P/src/p/A.java)[-]");
        IPackageFragment pkg = getPackage("/P/src/p");
        assertSortedElementsEqual("Unexpected children", "B.java [in p [in src [in P]]]", pkg.getChildren());
        ...
        try {
            JavaCore.run(new IWorkspaceRunnable() {
                ...
                public void run(IProgressMonitor monitor) throws CoreException {
                    ...
                    javaProject.setRawClasspath(createClasspath(new String[] { "/P2", "src/", "/P2/src", "" }, /*no inclusion*/
                    false, /*exclusion*/
                    true), null);
