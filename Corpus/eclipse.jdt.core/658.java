...
public class NonFatalErrorTest extends AbstractRegressionTest {
    ...
    public void test007() {
        ...
        runConformTest(/* test files */
        new String[] { "X.java", "public class X {\n" + "        @SuppressWarnings(\"unused\")\n" + "        static void foo() {\n" + "            String s = null;\n" + "            System.out.println(\"SUCCESS\");\n" + "        }\n" + "        public static void main(String argv[]) {\n" + "            foo();\n" + "        }\n" + "}" }, /* expected output string */
        "SUCCESS", /* no class libraries */
        null, true, null, /* custom options */
        customOptions, /* do not check error string */
        null);
    }
    ...
    public void testImportUnresolved() {
        ...
        runNegativeTest(// flush dir
        true, new String[] { "X.java", "import com.bogus.Missing;\n" + "public class X {\n" + "	public static void main(String[] args) {\n" + "		new X().test();\n" + "	}\n" + "	void test() {\n" + "		System.out.println(\"OK\");\n" + "	}\n" + "}\n" }, // libs
        null, options, "----------\n" + "1. ERROR in X.java (at line 1)\n" + "	import com.bogus.Missing;\n" + "	       ^^^^^^^^^\n" + "The import com.bogus cannot be resolved\n" + "----------\n", "OK", "", JavacTestOptions.SKIP);
    }
