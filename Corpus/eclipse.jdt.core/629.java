                                ...
                                if ("NestedAnnotation".equals(nestedType.getSimpleName())) {
                                    ...
                                    for (MethodDeclaration annotationMethod : annotationMethods) {
                                        if ("value".equals(annotationMethod.getSimpleName())) {
                                            final AnnotationTypeElementDeclaration value = (AnnotationTypeElementDeclaration) annotationMethod;
                                            final String defaultString = value.getDefaultValue() == null ? "" : value.getDefaultValue().toString();
