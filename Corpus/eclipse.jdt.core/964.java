...
public interface ProblemReasons {
    ...
    // super access within default method
    ...
    // 18.5.1 ignores arguments not pertinent to applicability. When these are taken into consideration method could fail applicability
    final int InferredApplicableMethodInapplicable = 27;
