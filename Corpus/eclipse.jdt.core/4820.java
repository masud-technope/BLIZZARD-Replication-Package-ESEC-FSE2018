...
public class FieldAccess extends Expression {
    ...
    new ChildPropertyDescriptor(FieldAccess.class, "expression", Expression.class, MANDATORY, CYCLE_RISK);
    ...
    new ChildPropertyDescriptor(FieldAccess.class, "name", SimpleName.class, MANDATORY, NO_CYCLE_RISK);
	 ...
	 */
    int treeSize() {
        return memSize() + (this.expression == null ? 0 : getExpression().treeSize()) + (this.fieldName == null ? 0 : getName().treeSize());
    }
}
