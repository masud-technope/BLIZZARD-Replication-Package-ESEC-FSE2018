...
class TypeBinding implements ITypeBinding {
    ...
    private static final int VALID_MODIFIERS = Modifier.PUBLIC | Modifier.PROTECTED | Modifier.PRIVATE | Modifier.ABSTRACT | Modifier.STATIC | Modifier.FINAL | Modifier.STRICTFP;
    ...
    public synchronized IVariableBinding[] getDeclaredFields() {
        ...
        try {
            if (isClass() || isInterface() || isEnum()) {
                ...
                FieldBinding[] fieldBindings = // resilience
            ...
            org.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve declared fields");
        }
        return this.fields = NO_VARIABLE_BINDINGS;
    }
    ...
    public synchronized IMethodBinding[] getDeclaredMethods() {
        ...
        try {
            if (isClass() || isInterface() || isEnum()) {
                ReferenceBinding referenceBinding = (ReferenceBinding) this.binding;
                // be resilient
                org.eclipse.jdt.internal.compiler.lookup.MethodBinding[] internalMethods = referenceBinding.availableMethods();
            ...
            org.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve declared methods");
        }
        return this.methods = NO_METHOD_BINDINGS;
    }
	 ...
	 */
    public synchronized // should not deflect to prototype.
        ...
        if (this.binding instanceof org.eclipse.jdt.internal.compiler.lookup.LocalTypeBinding) {
            ...
            if (methodBinding != null) {
                try {
                    ...
                    org.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve declaring method");
                }
            }
        } else if (this.binding.isTypeVariable()) {
            TypeVariableBinding typeVariableBinding = (TypeVariableBinding) this.binding;
        ...
        if (isClass() || isInterface() || isEnum()) {
            ...
            if (referenceBinding.isNestedType()) {
                try {
                    ...
                    org.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve declaring class");
                }
            }
        } else if (this.binding.isTypeVariable()) {
            TypeVariableBinding typeVariableBinding = (TypeVariableBinding) this.binding;
    ...
    public synchronized ITypeBinding[] getInterfaces() {
        ...
        try {
            ...
            org.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve interfaces");
        }
    ...
    private JavaElement getUnresolvedJavaElement(org.eclipse.jdt.internal.compiler.lookup.TypeBinding typeBinding) {
        ...
        if (this.resolver instanceof DefaultBindingResolver) {
            ...
            if (!defaultBindingResolver.fromJavaProject)
                return null;
            return org.eclipse.jdt.internal.core.util.Util.getUnresolvedJavaElement(typeBinding, defaultBindingResolver.workingCopyOwner, defaultBindingResolver.getBindingsToNodesMap());
        }
        return null;
    }
    ...
    public synchronized ITypeBinding getSuperclass() {
        ...
        try {
            ...
            org.eclipse.jdt.internal.core.util.Util.log(e, "Could not retrieve superclass");
        ...
        if (typeVariableBinding != null) {
            ...
            if (firstClassOrArrayBound == null) {
                ...
                if (org.eclipse.jdt.internal.compiler.lookup.TypeBinding.equalsEquals(firstClassOrArrayBound, varSuperclass)) {
                    boundsLength++;
                } else if (// capture of ? extends/super arrayType
                firstClassOrArrayBound.isArrayType()) {
                    boundsLength++;
                } else {
