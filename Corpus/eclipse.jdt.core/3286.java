...
public interface AnnotationTest {
    ...
    public int method5(int p0, @Deprecated int p1, @RTVisibleAnno(anno = @SimpleAnnotation("param2"), clazzes = {}) @RTInvisibleAnno("2") int p2);

    public int method6(int p0, int p1, int p2);

    @RTVisibleAnno(name = "I'm \"special\": \t\\\n", charValue = '\'', clazzes = {}, anno = @SimpleAnnotation(""))
    public int method7();
}
