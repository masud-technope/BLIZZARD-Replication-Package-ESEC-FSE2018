 ...
 */
    ...
    public void test037() {
        this.runConformTest(// test directory preparation
    ...
    public void test047() {
        this.runNegativeTest(// test directory preparation
        new String[] /* test files */
        { "X.java", "public class X<T extends I & J> {\n" + "  void foo(T t) {\n" + "  }\n" + "}\n" + "interface I {\n" + "  public int method();\n" + "}\n" + "interface J {\n" + "  public boolean method();\n" + "}\n" }, // compiler results
        "----------\n" + /* expected compiler log */
        "1. ERROR in X.java (at line 1)\n" + "	public class X<T extends I & J> {\n" + "	               ^\n" + "The return types are incompatible for the inherited methods I.method(), J.method()\n" + "----------\n", // javac options
        JavacTestOptions.JavacHasABug.JavacBug5061359);
    }
    ...
    public void test074() {
        this.runNegativeTest(/* skipJavac */
        false, this.complianceLevel < ClassFileConstants.JDK1_8 ? null : JavacTestOptions.EclipseHasABug.EclipseBug427719, new String[] { "Y.java", "interface I<T> {}\n" + "class A {\n" + "	void a(I x) {}\n" + "	void b(I<?> x) {}\n" + "	void b(I<?>[] x) {}\n" + "	<U> void c(I<?> x) {}\n" + "}\n" + "class B extends A {}\n" + "class C extends B implements I {\n" + "	void a(C c) {}\n" + "	void b(C c) {}\n" + "	void b(C[] c) {}\n" + "	void c(C c) {}\n" + "}\n" + "class D extends C {\n" + "    void test() {\n" + "        a(new C());\n" + "        a(new D());\n" + // ambiguous b(I<?>) in A and b(C) in C match
        "        b(new C());\n" + // ambiguous b(I<?>) in A and b(C) in C match
        "        b(new D());\n" + // ambiguous b(I<?>[]) in A and b(C[]) in C match
        "        b(new C[0]);\n" + // ambiguous b(I<?>[]) in A and b(C[]) in C match
