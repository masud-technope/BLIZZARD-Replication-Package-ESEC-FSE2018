...
public class APITests extends APTTestBase {
    ...
    public void testAptUtil() throws Exception {
        ...
        AnnotationProcessorFactory factory = AptUtil.getFactoryForAnnotation(HelloWorldAnnotation.class.getName(), jproj);
        ...
        try {
            factory = //$NON-NLS-1$
            AptUtil.getFactoryForAnnotation(//$NON-NLS-1$
            "org.eclipse.Foo", //$NON-NLS-1$
            jproj);
            assertEquals(factory.getClass(), HelloWorldWildcardAnnotationProcessorFactory.class);
        } finally {
        ...
        factory = //$NON-NLS-1$
        AptUtil.getFactoryForAnnotation("org.eclipse.Foo", jproj);
        assertNull(factory);
    }
    ...
    public void testMessagerAPI() throws Exception {
        ...
        ExpectedProblem prob1 = new //$NON-NLS-1$ 
        ExpectedProblem(//$NON-NLS-1$ 
        "", //$NON-NLS-1$ 
        MessagerAnnotationProcessor.PROBLEM_TEXT_WARNING, //$NON-NLS-1$ 
        code, MessagerCodeExample.WARNING_START, MessagerCodeExample.WARNING_END);
        ExpectedProblem prob2 = new //$NON-NLS-1$
        ExpectedProblem(//$NON-NLS-1$
        "", //$NON-NLS-1$
        MessagerAnnotationProcessor.PROBLEM_TEXT_ERROR, //$NON-NLS-1$
        code, MessagerCodeExample.ERROR_START, MessagerCodeExample.ERROR_END);
