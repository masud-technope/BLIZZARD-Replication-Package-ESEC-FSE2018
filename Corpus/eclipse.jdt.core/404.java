...
public class SwitchStatement extends Statement {
    ...
    new ChildPropertyDescriptor(SwitchStatement.class, "expression", Expression.class, MANDATORY, CYCLE_RISK);

    /**
	 * The "statements" structural property of this node type (element type: {@link Statement}).
	 * @since 3.0
	 */
    public static final ChildListPropertyDescriptor STATEMENTS_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(SwitchStatement.class, "statements", Statement.class, CYCLE_RISK);
