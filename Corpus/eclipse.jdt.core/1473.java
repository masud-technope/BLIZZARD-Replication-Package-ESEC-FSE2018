...
public class TypeAnnotationTest extends AbstractRegressionTest {
    ...
    public void test060f_codeblocks_new_arraysWithQualifiedNestedTypes() throws Exception {
        ...
        String expectedOutput = "    RuntimeVisibleTypeAnnotations: \n" + "      #37 @org.foo.bar.B(\n" + "        #38 value=(int) 1 (constant type)\n" + "        target type = 0x44 NEW\n" + "        offset = 10\n" + "        location = [ARRAY, ARRAY]\n" + "      )\n" + "      #37 @org.foo.bar.B(\n" + "        #38 value=(int) 2 (constant type)\n" + "        target type = 0x44 NEW\n" + "        offset = 10\n" + "        location = [ARRAY, ARRAY, INNER_TYPE]\n" + "      )\n" + "      #37 @org.foo.bar.B(\n" + "        #38 value=(int) 3 (constant type)\n" + "        target type = 0x44 NEW\n" + "        offset = 10\n" + "      )\n" + "      #37 @org.foo.bar.B(\n" + "        #38 value=(int) 4 (constant type)\n" + "        target type = 0x44 NEW\n" + "        offset = 10\n" + "        location = [ARRAY]\n" + "      )\n";
        checkDisassembledClassFile(OUTPUT_DIR + File.separator + "org" + File.separator + "foo" + File.separator + "bar" + File.separator + "X.class", "org.foo.bar.X", expectedOutput, ClassFileBytesDisassembler.SYSTEM);
    }
    ...
    public // PQTR (ParameterizedQualifiedTypeReference)
    void test100_pqtr() throws // PQTR (ParameterizedQualifiedTypeReference)
    Exception {
    ...
    public // QTR (QualifiedTypeReference)
    void test101a_qtr() throws // QTR (QualifiedTypeReference)
    Exception {
    ...
    public // QTR (QualifiedTypeReference)
    void test101b_qtr() throws // QTR (QualifiedTypeReference)
    Exception {
    ...
    public // QTR (QualifiedTypeReference)
    void test101c_qtr() throws // QTR (QualifiedTypeReference)
    Exception {
    ...
    public // STR (SingleTypeReference)
    void test102a_str() throws // STR (SingleTypeReference)
    Exception {
        this.runConformTest(new String[] { "X.java", "class X {\n" + "    @B(1) X field;\n" + "}\n", "B.java", "import java.lang.annotation.*;\n" + "@Target(ElementType.TYPE_USE)\n" + "@Retention(RetentionPolicy.RUNTIME)\n" + "@interface B { int value() default -1; }\n" }, "");
    ...
    public // STR (SingleTypeReference)
    void test102b_str() throws // STR (SingleTypeReference)
    Exception {
        this.runConformTest(new String[] { "X.java", "class X {\n" + "    @B(1) int field;\n" + "}\n", "B.java", "import java.lang.annotation.*;\n" + "@Target(ElementType.TYPE_USE)\n" + "@Retention(RetentionPolicy.RUNTIME)\n" + "@interface B { int value() default -1; }\n" }, "");
        String expectedOutput = "    RuntimeVisibleTypeAnnotations: \n" + "      #8 @B(\n" + "        #9 value=(int) 1 (constant type)\n" + "        target type = 0x13 FIELD\n" + "      )\n";
        checkDisassembledClassFile(OUTPUT_DIR + File.separator + "X.class", "X", expectedOutput, ClassFileBytesDisassembler.SYSTEM);
    ...
    public // ATR (ArrayTypeReference)
    void test103a_atr() throws // ATR (ArrayTypeReference)
    Exception {
        this.runConformTest(new String[] { "X.java", "class X {\n" + "    @B(1) X[] field;\n" + "}\n", "B.java", "import java.lang.annotation.*;\n" + "@Target(ElementType.TYPE_USE)\n" + "@Retention(RetentionPolicy.RUNTIME)\n" + "@interface B { int value() default -1; }\n" }, "");
        String expectedOutput = "    RuntimeVisibleTypeAnnotations: \n" + "      #8 @B(\n" + "        #9 value=(int) 1 (constant type)\n" + "        target type = 0x13 FIELD\n" + "        location = [ARRAY]\n" + "      )\n";
        checkDisassembledClassFile(OUTPUT_DIR + File.separator + "X.class", "X", expectedOutput, ClassFileBytesDisassembler.SYSTEM);
    ...
    public // ATR (ArrayTypeReference)
    void test103b_atr() throws // ATR (ArrayTypeReference)
    Exception {
        this.runConformTest(new String[] { "X.java", "class X {\n" + "    X @B(2)[] field;\n" + "}\n", "B.java", "import java.lang.annotation.*;\n" + "@Target(ElementType.TYPE_USE)\n" + "@Retention(RetentionPolicy.RUNTIME)\n" + "@interface B { int value() default -1; }\n" }, "");
        String expectedOutput = "    RuntimeVisibleTypeAnnotations: \n" + "      #8 @B(\n" + "        #9 value=(int) 2 (constant type)\n" + "        target type = 0x13 FIELD\n" + "      )\n";
        checkDisassembledClassFile(OUTPUT_DIR + File.separator + "X.class", "X", expectedOutput, ClassFileBytesDisassembler.SYSTEM);
    ...
    public // ATR (ArrayTypeReference)
    void test103c_atr() throws // ATR (ArrayTypeReference)
    Exception {
        this.runConformTest(new String[] { "X.java", "class X {\n" + "    X []@B(3)[] field;\n" + "}\n", "B.java", "import java.lang.annotation.*;\n" + "@Target(ElementType.TYPE_USE)\n" + "@Retention(RetentionPolicy.RUNTIME)\n" + "@interface B { int value() default -1; }\n" }, "");
        String expectedOutput = "    RuntimeVisibleTypeAnnotations: \n" + "      #8 @B(\n" + "        #9 value=(int) 3 (constant type)\n" + "        target type = 0x13 FIELD\n" + "        location = [ARRAY]\n" + "      )\n";
        checkDisassembledClassFile(OUTPUT_DIR + File.separator + "X.class", "X", expectedOutput, ClassFileBytesDisassembler.SYSTEM);
    ...
    public // ATR (ArrayTypeReference)
    void test103d_atr() throws // ATR (ArrayTypeReference)
    Exception {
        this.runConformTest(new String[] { "X.java", "class X {\n" + "    X []@B(3)[][] field;\n" + "}\n", "B.java", "import java.lang.annotation.*;\n" + "@Target(ElementType.TYPE_USE)\n" + "@Retention(RetentionPolicy.RUNTIME)\n" + "@interface B { int value() default -1; }\n" }, "");
        String expectedOutput = "    RuntimeVisibleTypeAnnotations: \n" + "      #8 @B(\n" + "        #9 value=(int) 3 (constant type)\n" + "        target type = 0x13 FIELD\n" + "        location = [ARRAY]\n" + "      )\n";
        checkDisassembledClassFile(OUTPUT_DIR + File.separator + "X.class", "X", expectedOutput, ClassFileBytesDisassembler.SYSTEM);
    ...
    public // ATR (ArrayTypeReference)
    void test103e_atr() throws // ATR (ArrayTypeReference)
    Exception {
        this.runConformTest(new String[] { "X.java", "class X {\n" + "    @B(1) int []@B(3)[][] field;\n" + "}\n", "B.java", "import java.lang.annotation.*;\n" + "@Target(ElementType.TYPE_USE)\n" + "@Retention(RetentionPolicy.RUNTIME)\n" + "@interface B { int value() default -1; }\n" }, "");
        String expectedOutput = "    RuntimeVisibleTypeAnnotations: \n" + "      #8 @B(\n" + "        #9 value=(int) 1 (constant type)\n" + "        target type = 0x13 FIELD\n" + "        location = [ARRAY, ARRAY, ARRAY]\n" + "      )\n" + "      #8 @B(\n" + "        #9 value=(int) 3 (constant type)\n" + "        target type = 0x13 FIELD\n" + "        location = [ARRAY]\n" + "      )\n";
        checkDisassembledClassFile(OUTPUT_DIR + File.separator + "X.class", "X", expectedOutput, ClassFileBytesDisassembler.SYSTEM);
    ...
    public // PSTR (ParameterizedSingleTypeReference)
    void test104a_pstr() throws // PSTR (ParameterizedSingleTypeReference)
    Exception {
    ...
    public // PSTR (ParameterizedSingleTypeReference)
    void test104b_pstr() throws // PSTR (ParameterizedSingleTypeReference)
    Exception {
    ...
    public // AQTR (ArrayQualifiedTypeReference)
    void test105a_aqtr() throws // AQTR (ArrayQualifiedTypeReference)
    Exception {
    ...
    public // AQTR (ArrayQualifiedTypeReference)
    void test105b_aqtr() throws // AQTR (ArrayQualifiedTypeReference)
    Exception {
    ...
    public // WTR (WildcardTypeReference)
    void test106a_wtr() throws // WTR (WildcardTypeReference)
    Exception {
    ...
    public // WTR (WildcardTypeReference)
    void test106b_wtr() throws // WTR (WildcardTypeReference)
    Exception {
        this.runConformTest(new String[] { "X.java", "import java.util.List;\n" + "class X<T1> {\n" + "	 List<? extends @B(1) Number[]> field;\n" + "}\n", "List.java", "class List {}\n", "B.java", "import java.lang.annotation.*;\n" + "@Target(ElementType.TYPE_USE)\n" + "@Retention(RetentionPolicy.RUNTIME)\n" + "@interface B { int value() default -1; }\n" }, "");
    ...
    public void testTypeVariable() {
        runNegativeTest(new String[] { "X.java", "public class X<@Missing T> {\n" + "}\n" }, "----------\n" + "1. ERROR in X.java (at line 1)\n" + "	public class X<@Missing T> {\n" + "	                ^^^^^^^\n" + "Missing cannot be resolved to a type\n" + "----------\n");
    }
    ...
    public void testForwardReference() {
        this.runNegativeTest(/* skipJavac */
        false, JavacTestOptions.Excuse.JavacHasWarningsEclipseNotConfigured, new String[] { "T.java", "import java.lang.annotation.Annotation;\n" + "import java.lang.annotation.ElementType;\n" + "import java.lang.annotation.Target;\n" + "\n" + "@R(TC.class)\n" + "@Target(ElementType.TYPE_PARAMETER)\n" + "@interface T {\n" + "}\n" + "\n" + "interface I<@T K> {\n" + "}\n" + "\n" + "@Deprecated\n" + "@interface TC {\n" + "\n" + "}\n" + "\n" + "@Target(ElementType.ANNOTATION_TYPE)\n" + "@interface R {\n" + "    Class<? extends Annotation> value();\n" + "}\n" }, "");
    }
    ...
    public void testBug492322readFromClass() {
        ...
        assertEquals("Base.@A2 Static.@A3 Middle1.@A4 Middle2<Object>.@A5 Middle3.@A6 GenericInner<String>", new String(methods1[0].parameters[0].annotatedDebugName()));
        MethodBinding[] methods2 = type.getMethods("method2".toCharArray());
        assertEquals("Base.@A2 Static.@A3 Middle1.@A4 Middle2<@B1 Object>.@A5 Middle3.@A6 GenericInner<@B2 String> @A7 [] @A8 []", new String(methods2[0].parameters[0].annotatedDebugName()));
        MethodBinding[] methods3 = type.getMethods("method3".toCharArray());
        assertEquals("Base.@A2 Static.@A3 Middle1.@A4 Middle2<@B1 Class<@C1 Object @C2 []> @B2 []>.@A5 Middle3.@A6 GenericInner<@B3 String> @A7 [] @A8 []", new String(methods3[0].parameters[0].annotatedDebugName()));
    }
    ...
    public void testBug492322WithOldBinary() {
        ...
        Compiler compiler = new Compiler(getNameEnvironment(new String[0], paths), getErrorHandlingPolicy(), new CompilerOptions(customOptions), requestor, getProblemFactory());
        char[][] compoundName = new char[][] { "test1".toCharArray(), "Base".toCharArray() };
        ReferenceBinding type = compiler.lookupEnvironment.askForType(compoundName);
        assertNotNull(type);
        MethodBinding[] methods1 = type.getMethods("method1".toCharArray());
        assertEquals("Base.Static.@A2 Static2<Exception>.@A3 Middle1.@A4 Middle2<Object>.@A5 Middle3.@A6 GenericInner<String>", new String(methods1[0].parameters[0].annotatedDebugName()));
        MethodBinding[] methods2 = type.getMethods("method2".toCharArray());
        assertEquals("Base.Static.@A2 Static2<@B1 Exception>.@A3 Middle1.@A4 Middle2<@B2 Object>.@A5 Middle3.@A6 GenericInner<@B3 String> @A7 [] @A8 []", new String(methods2[0].parameters[0].annotatedDebugName()));
        MethodBinding[] methods3 = type.getMethods("method3".toCharArray());
        assertEquals("Base.Static.@A2 Static2<@B1 Exception>.@A3 Middle1.@A4 Middle2<@B2 Class<@C1 Object @C2 []> @B3 []>.@A5 Middle3.@A6 GenericInner<@B4 String> @A7 [] @A8 []", new String(methods3[0].parameters[0].annotatedDebugName()));
    }
}
