...
public class MultiProjectTests extends BuilderTests {
    ...
    public void testCompileOrder() throws JavaModelException {
        ...
        expectingOnlySpecificProblemsFor(workspaceRootPath, new Problem[] { //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public void testCycle1() throws JavaModelException {
        ...
        try {
            ...
            //$NON-NLS-1$ //$NON-NLS-2$
            expectingOnlySpecificProblemFor(p1, new Problem("p1", "A cycle was detected in the build path of project 'P1'. The cycle consists of projects {P1, P2, P3}", p1, -1, -1, CategorizedProblem.CAT_BUILDPATH, IMarker.SEVERITY_WARNING));
            //$NON-NLS-1$ //$NON-NLS-2$
            expectingOnlySpecificProblemFor(p2, new Problem("p2", "A cycle was detected in the build path of project 'P2'. The cycle consists of projects {P1, P2, P3}", p2, -1, -1, CategorizedProblem.CAT_BUILDPATH, IMarker.SEVERITY_WARNING));
            //$NON-NLS-1$ //$NON-NLS-2$
            expectingOnlySpecificProblemFor(p3, new Problem("p3", "A cycle was detected in the build path of project 'P3'. The cycle consists of projects {P1, P2, P3}", p3, -1, -1, CategorizedProblem.CAT_BUILDPATH, IMarker.SEVERITY_WARNING));
            JavaCore.setOptions(options);
        } finally {
    ...
    public void testCycle2() throws JavaModelException {
        ...
        try {
            ...
            //$NON-NLS-1$ //$NON-NLS-2$
            expectingOnlySpecificProblemFor(p1, new Problem("p1", "A cycle was detected in the build path of project 'P1'. The cycle consists of projects {P1, P2, P3}", p1, -1, -1, CategorizedProblem.CAT_BUILDPATH, IMarker.SEVERITY_WARNING));
            expectingOnlySpecificProblemsFor(p2, new Problem[] { //$NON-NLS-1$ //$NON-NLS-2$
            ...
            new Problem("p2", "A cycle was detected in the build path of project 'P2'. The cycle consists of projects {P1, P2, P3}", p2, -1, -1, CategorizedProblem.CAT_BUILDPATH, IMarker.SEVERITY_WARNING) });
            //$NON-NLS-1$ //$NON-NLS-2$
            expectingOnlySpecificProblemFor(p3, new Problem("p3", "A cycle was detected in the build path of project 'P3'. The cycle consists of projects {P1, P2, P3}", p3, -1, -1, CategorizedProblem.CAT_BUILDPATH, IMarker.SEVERITY_WARNING));
            JavaCore.setOptions(options);
        } finally {
    ...
    public void testCycle4() throws JavaModelException {
        ...
        try {
            ...
            new Problem("p2", "A cycle was detected in the build path of project 'P2'. The cycle consists of projects {P1, P2, P3}", p2, -1, -1, CategorizedProblem.CAT_BUILDPATH, IMarker.SEVERITY_WARNING) });
            expectingOnlySpecificProblemsFor(p3, new Problem[] { //$NON-NLS-1$ //$NON-NLS-2$
            ...
            new Problem("p3", "A cycle was detected in the build path of project 'P3'. The cycle consists of projects {P1, P2, P3}", p3, -1, -1, CategorizedProblem.CAT_BUILDPATH, IMarker.SEVERITY_WARNING) });
            //$NON-NLS-1$ //$NON-NLS-2$
            env.addClass(//$NON-NLS-1$ //$NON-NLS-2$
            root1, //$NON-NLS-1$ //$NON-NLS-2$
            "p1", //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public void testCycle5() throws JavaModelException {
        ...
        try {
            ...
            expectingOnlySpecificProblemsFor(p1, new Problem[] { //$NON-NLS-1$ //$NON-NLS-2$
            ...
            new Problem("p1", "A cycle was detected in the build path of project 'P1'. The cycle consists of projects {P1, P2}", p1, -1, -1, CategorizedProblem.CAT_BUILDPATH, IMarker.SEVERITY_WARNING) });
            expectingOnlySpecificProblemsFor(p2, new Problem[] { //$NON-NLS-1$ //$NON-NLS-2$
            ...
            new Problem("p2", "A cycle was detected in the build path of project 'P2'. The cycle consists of projects {P1, P2}", p2, -1, -1, CategorizedProblem.CAT_BUILDPATH, IMarker.SEVERITY_WARNING) });
            //$NON-NLS-1$ //$NON-NLS-2$
            env.addClass(//$NON-NLS-1$ //$NON-NLS-2$
            root1, //$NON-NLS-1$ //$NON-NLS-2$
            "p11", //$NON-NLS-1$ //$NON-NLS-2$
            "XX", "package p11;\n" + "public class XX {\n" + //$NON-NLS-1$
            "}\n");
            //$NON-NLS-1$ //$NON-NLS-2$
            env.addClass(//$NON-NLS-1$ //$NON-NLS-2$
            root2, //$NON-NLS-1$ //$NON-NLS-2$
            "p22", //$NON-NLS-1$ //$NON-NLS-2$
            "YY", "package p22;\n" + "public class YY {\n" + //$NON-NLS-1$
            "}\n");
            incrementalBuild();
            env.waitForAutoBuild();
    ...
    public void testCycle6() throws JavaModelException {
        ...
        try {
            ...
            env.waitForAutoBuild();
            expectingOnlySpecificProblemsFor(p1, new Problem[] { //$NON-NLS-1$ //$NON-NLS-2$
            new Problem("p1", "A cycle was detected in the build path of project 'P1'. The cycle consists of projects {P1, P2, P3}", p1, -1, -1, CategorizedProblem.CAT_BUILDPATH, IMarker.SEVERITY_WARNING) });
            expectingOnlySpecificProblemsFor(p2, new Problem[] { //$NON-NLS-1$ //$NON-NLS-2$
            new Problem("p2", "A cycle was detected in the build path of project 'P2'. The cycle consists of projects {P1, P2, P3}", p2, -1, -1, CategorizedProblem.CAT_BUILDPATH, IMarker.SEVERITY_WARNING) });
            expectingOnlySpecificProblemsFor(p3, new Problem[] { //$NON-NLS-1$ //$NON-NLS-2$
            new Problem("p3", "A cycle was detected in the build path of project 'P3'. The cycle consists of projects {P1, P2, P3}", p3, -1, -1, CategorizedProblem.CAT_BUILDPATH, IMarker.SEVERITY_WARNING) });
    ...
    public void testExcludePartOfAnotherProject1() throws JavaModelException {
        ...
        env.addClass(//$NON-NLS-1$ //$NON-NLS-2$
        root1, //$NON-NLS-1$ //$NON-NLS-2$
        "p.internal", //$NON-NLS-1$ //$NON-NLS-2$
        "B", //$NON-NLS-1$
        "package p.internal;\n" + //$NON-NLS-1$
        "public class B {\n" + //$NON-NLS-1$
        "}\n");
        ...
        env.waitForAutoBuild();
        //$NON-NLS-1$ //$NON-NLS-2$
        expectingSpecificProblemFor(project2Path, new Problem("", "Access restriction: The type 'B' is not API (restriction on required project 'Project1')", d, 23, 35, CategorizedProblem.CAT_RESTRICTION, IMarker.SEVERITY_ERROR));
        env.removeProject(project1Path);
        env.removeProject(project2Path);
    }
    ...
    public void testIgnoreIfBetterNonAccessibleRule2() throws JavaModelException {
        ...
        env.waitForAutoBuild();
        //$NON-NLS-1$ //$NON-NLS-2$
        expectingSpecificProblemFor(project3Path, new Problem("", "Discouraged access: The type 'A' is not API (restriction on required project 'Project2')", b, 35, 38, CategorizedProblem.CAT_RESTRICTION, IMarker.SEVERITY_WARNING));
        env.removeProject(project1Path);
        env.removeProject(project2Path);
        env.removeProject(project3Path);
    }
    ...
    public void test101_class_folder_non_exported() throws JavaModelException {
        ...
        fullBuild();
        env.waitForAutoBuild();
        expectingSpecificProblemsFor(P2, new Problem[] { new Problem("", "The import p cannot be resolved", c, 7, 8, CategorizedProblem.CAT_IMPORT, IMarker.SEVERITY_ERROR), new Problem("", "A cannot be resolved to a type", c, 31, 32, CategorizedProblem.CAT_TYPE, IMarker.SEVERITY_ERROR) });
        env.removeProject(P1);
        env.removeProject(P2);
    }
    ...
    public void test102_missing_required_binaries() throws JavaModelException {
        ...
        try {
            ...
            fullBuild();
            env.waitForAutoBuild();
            expectingOnlySpecificProblemsFor(p3, new Problem[] { new Problem("p3", "The project was not built since its build path is incomplete. Cannot find the class file for I. Fix the build path then try building this project", p3, -1, -1, CategorizedProblem.CAT_BUILDPATH, IMarker.SEVERITY_ERROR), new Problem("p3", "The type I cannot be resolved. It is indirectly referenced from required .class files", y, 23, 24, CategorizedProblem.CAT_BUILDPATH, IMarker.SEVERITY_ERROR) });
        } finally {
            env.setBuildOrder(null);
            env.removeProject(p1);
            env.removeProject(p2);
    ...
    public void test103_missing_required_binaries() throws JavaModelException {
        ...
        try {
            ...
            fullBuild();
            env.waitForAutoBuild();
            expectingOnlySpecificProblemsFor(p3, new Problem[] { new Problem("p3", "The project was not built since its build path is incomplete. Cannot find the class file for I. Fix the build path then try building this project", p3, -1, -1, CategorizedProblem.CAT_BUILDPATH, IMarker.SEVERITY_ERROR), new Problem("p3", "The type I cannot be resolved. It is indirectly referenced from required .class files", y, 0, 1, CategorizedProblem.CAT_BUILDPATH, IMarker.SEVERITY_ERROR) });
        } finally {
            env.setBuildOrder(null);
            env.setBuildOrder(null);
            env.removeProject(p1);
    ...
    public void test461074() throws JavaModelException {
        ...
        env.addClass(//$NON-NLS-1$ //$NON-NLS-2$
        root1, //$NON-NLS-1$ //$NON-NLS-2$
        "pack.missing", //$NON-NLS-1$ //$NON-NLS-2$
        "MissingType", "package pack.missing;\n" + "public class MissingType {\n" + "}\n");
        //----------------------------
        //         Project2
        //----------------------------
        //$NON-NLS-1$
    ...
    public void test461074_error() throws JavaModelException {
        ...
        //$NON-NLS-1$
        env.setOutputFolder(p3, "bin");
        IPath test = //$NON-NLS-1$ //$NON-NLS-2$
        env.addClass(//$NON-NLS-1$ //$NON-NLS-2$
        root3, //$NON-NLS-1$ //$NON-NLS-2$
        "pack.test", //$NON-NLS-1$ //$NON-NLS-2$
        "Test", "package pack.test;\n" + "import pack.lib.SuperClass;\n" + "public class Test extends SuperClass {/*empty*/}\n");
        ...
        fullBuild();
        env.waitForAutoBuild();
        expectingOnlySpecificProblemsFor(p3, new Problem[] { new Problem("p3", "The project was not built since its build path is incomplete. Cannot find the class file for pack.missing.MissingType. Fix the build path then try building this project", p3, -1, -1, CategorizedProblem.CAT_BUILDPATH, IMarker.SEVERITY_ERROR), new Problem("p3", "The type pack.missing.MissingType cannot be resolved. It is indirectly referenced from required .class files", test, 0, 1, CategorizedProblem.CAT_BUILDPATH, IMarker.SEVERITY_ERROR) });
        env.setBuildOrder(null);
        env.removeProject(p1);
        env.removeProject(p2);
        env.removeProject(p3);
