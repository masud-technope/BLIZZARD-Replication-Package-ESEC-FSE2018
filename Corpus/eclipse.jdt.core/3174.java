 ...
 */
    public void testAnonymousType12() throws CoreException {
        ...
        ITypeHierarchy hierarchy = type.newTypeHierarchy(null);
        assertHierarchyEquals("Focus: A210070 [in A210070.java [in q8 [in src [in TypeHierarchy]]]]\n" + "Super types:\n" + "  Object [in Object.class [in java.lang [in " + getExternalJCLPathString() + "]]]\n" + "Sub types:\n" + "  <anonymous #1> [in foo() [in A210070 [in A210070.java [in q8 [in src [in TypeHierarchy]]]]]]\n", hierarchy);
    }
 ...
 */
    public void testBinaryTypeHiddenByOtherJar() throws CoreException, IOException {
        ...
        try {
            ...
            assertHierarchyEquals("Focus: Y [in Y.class [in p [in " + externalJar2 + "]]]\n" + "Super types:\n" + "  X [in X.class [in p [in " + externalJar1 + "]]]\n" + "    Object [in Object.class [in java.lang [in " + getExternalJCLPathString() + "]]]\n" + "Sub types:\n", focus.newTypeHierarchy(null));
        } finally {
 ...
 */
    public void testBinaryTypeInDotClassJar() throws CoreException, IOException {
        ...
        try {
            ...
            assertHierarchyEquals("Focus: X [in X.class [in p [in " + externalJar + "]]]\n" + "Super types:\n" + "  Object [in Object.class [in java.lang [in " + getExternalJCLPathString() + "]]]\n" + "Sub types:\n" + "  <anonymous> [in Y$1.class [in p [in " + externalJar + "]]]\n", focus.newTypeHierarchy(null));
        } finally {
            if (externalJar != null)
 ...
 */
    public void testExternalFolder() throws CoreException, IOException {
        try {
            ...
            assertHierarchyEquals("Focus: X [in X.class [in p [in " + getExternalPath() + "externalLib]]]\n" + "Super types:\n" + "Sub types:\n" + "  Y [in Y.class [in p [in " + getExternalPath() + "externalLib]]]\n", hierarchy);
        } finally {
            deleteProject("P");
 ...
 */
    public void testZIPArchive() throws CoreException, IOException {
        try {
            ...
            ITypeHierarchy hierarchy = classFile.getType().newTypeHierarchy(null);
            assertHierarchyEquals("Focus: X [in X.class [in p [in " + getExternalPath() + "externalLib.abc]]]\n" + "Super types:\n" + "Sub types:\n" + "  Y [in Y.class [in p [in " + getExternalPath() + "externalLib.abc]]]\n", hierarchy);
        } finally {
 ...
 */
    public void testFindObject() throws CoreException {
        ...
        // create hierarchy
        // should not throw a StackOverFlow
 ...
 */
    public void testGetAllSuperclassesFromBinary() throws JavaModelException {
        ...
        // it works when we use newTypeHierarchy(null)
        ITypeHierarchy hierarchy = type.newSupertypeHierarchy(null);
 ...
 */
    public void testGetAllSupertypes4() throws JavaModelException {
        ...
        ITypeHierarchy hierarchy = type.newTypeHierarchy(null);
        IType[] types = hierarchy.getAllSuperInterfaces(type);
        assertTypesEqual("Unexpected all super interfaces of B", "", types);
    }
 ...
 */
    public void testGetExtendingInterfaces() throws JavaModelException {
        ...
        this.assertTypesEqual("Unexpected extending interfaces of I", "p2.I1\n" + "p2.I2\n", types);
        type = getCompilationUnit("TypeHierarchy", "src", "p2", "X.java").getType("X");
        hierarchy = type.newTypeHierarchy(null);
        types = hierarchy.getExtendingInterfaces(type);
        this.assertTypesEqual("Unexpected extending interfaces of X", // interfaces cannot extend a class
        "", types);
    }
 ...
 */
    public void testGetImplementingClasses() throws JavaModelException {
        ...
        this.assertTypesEqual("Unexpected implementing classes of I", "p2.X\n", types);
        type = getCompilationUnit("TypeHierarchy", "src", "p2", "X.java").getType("X");
        hierarchy = type.newTypeHierarchy(null);
        types = hierarchy.getImplementingClasses(type);
        this.assertTypesEqual("Unexpected implementing classes of X", // classes cannot implement a class
        "", types);
    }
 ...
 */
    public void testGetSubclasses() throws JavaModelException {
        ...
        this.assertTypesEqual("Unexpected subclasses of binary.I", // interfaces cannot have a subclass
        "", types);
    }
 ...
 */
    public void testMemberTypeSubtypeDifferentProject() throws CoreException {
        try {
            ...
            ITypeHierarchy hierarchy = focus.newTypeHierarchy(/*no progress*/
            null);
 ...
 */
    public void testPotentialSubtypeInDependentProject() throws Exception {
        try {
            ...
            assertSortedElementsEqual("Unexpected types in hierarchy", "Object [in Object.class [in java.lang [in " + getExternalJCLPathString() + "]]]\n" + "Y169678 [in X169678 [in X169678.java [in p1 [in <project root> [in P1]]]]]\n" + "Z169678 [in Z169678.java [in p1 [in <project root> [in P1]]]]", allTypes);
        } finally {
            deleteProjects(new String[] { "P1", "P2" });
        }
    }
 ...
 */
    public void testResolvedTypeAsFocus() throws CoreException {
        try {
            ...
            assertElementsEqual("Unexpected focus type in hierarchy", "Y [in X.java [in <default> [in <project root> [in P]]]]", new IJavaElement[] { hierarchy.getType() }, /*show resolved info*/
            true);
        } finally {
            deleteProject("P");
        }
 ...
 */
    public void testSupertypeHierarchyGetSubclasses() throws JavaModelException {
        ...
        assertTypesEqual("Unexpected subclasses of Object", "", types);
        ICompilationUnit cu = getCompilationUnit("TypeHierarchy", "src", "p1", "Y.java");
        type = cu.getType("Y");
        hierarchy = type.newSupertypeHierarchy(null);
        types = hierarchy.getSubclasses(type);
        assertTypesEqual("Unexpected subclasses of Y", "", types);
    }
 ...
 */
    public void testSupertypeHierarchyGetSubtypes() throws JavaModelException {
        ...
        assertTypesEqual("Unexpected subtypes of Object", "", types);
        ICompilationUnit cu = getCompilationUnit("TypeHierarchy", "src", "p1", "Y.java");
        type = cu.getType("Y");
        hierarchy = type.newSupertypeHierarchy(null);
        types = hierarchy.getSubtypes(type);
        assertTypesEqual("Unexpected subtypes of Y", "", types);
    }
 ...
 */
    public void testVisibility2() throws JavaModelException {
        ...
        ITypeHierarchy hierarchy = type.newTypeHierarchy(null);
        assertHierarchyEquals("Focus: Z [in Z.java [in q6 [in src [in TypeHierarchy]]]]\n" + "Super types:\n" + "  NonVisibleInterface [in X.java [in q5 [in src [in TypeHierarchy]]]]\n" + "  Object [in Object.class [in java.lang [in " + getExternalJCLPathString() + "]]]\n" + "Sub types:\n", hierarchy);
    }
 ...
 */
    public void testBug186781() throws JavaModelException {
        ...
        // when bug occurred a stack overflow happened here...
        ITypeHierarchy hierarchy = type.newTypeHierarchy(null);
        assertHierarchyEquals("Focus: X [in X.java [in q186871 [in src [in TypeHierarchy]]]]\n" + "Super types:\n" + "  Super [in X.java [in q186871 [in src [in TypeHierarchy]]]]\n" + "    Object [in Object.class [in java.lang [in " + getExternalJCLPathString() + "]]]\n" + "Sub types:\n", hierarchy);
    }
 ...
 */
    public void testBug254738() throws CoreException {
        try {
            ...
            focus = focus.getMethod("parentmethod", new String[] {}).getType("", 1).getMethod("nestedonemethod", new String[] {}).getType("", 1);
            ITypeHierarchy hierarchy = focus.newTypeHierarchy(null);
 ...
 */
    public void testBug288698() throws JavaModelException {
        ...
        assertTrue("Type should exist!", type.exists());
        // when bug occurred a StringIndexOutOfBoundsException was thrown here
        ITypeHierarchy hierarchy = type.newTypeHierarchy(null);
        assertHierarchyEquals("Focus: AbstractBugTest [in AbstractBugTest.java [in p288698 [in src288698.classbug [in TypeHierarchy]]]]\n" + "Super types:\n" + "  Object [in Object.class [in java.lang [in " + getExternalJCLPathString() + "]]]\n" + "Sub types:\n" + "  <anonymous #1> [in testIt() [in BugTest2Buggy [in BugTest2Buggy.java [in p288698 [in src288698.classbug [in TypeHierarchy]]]]]]\n", hierarchy);
    }
 ...
 */
    ...
    public void testBug393192() throws CoreException {
        ...
        try {
            ...
            createFile("/Bug393192/src/pullup/A.java", "package pullup;\n" + "\n" + "class A {\n" + "    @Deprecated\n" + "    void m0() {\n" + "    }\n" + "\n" + "    @Deprecated\n" + "    void m1() {\n" + "    }\n" + "\n" + "    @Deprecated\n" + "    void m2() {\n" + "    }\n" + "\n" + "    @Deprecated\n" + "    void m3() {\n" + "    }\n" + "\n" + "    @Deprecated\n" + "    void m4() {\n" + "    }\n" + "\n" + "    @Deprecated\n" + "    void m5() {\n" + "    }\n" + "\n" + "    @Deprecated\n" + "    void m6() {\n" + "    }\n" + "\n" + "    @Deprecated\n" + "    void m7() {\n" + "    }\n" + "\n" + "    @Deprecated\n" + "    void m8() {\n" + "    }\n" + "\n" + "    @Deprecated\n" + "    void m9() {\n" + "    }\n" + "\n" + "    /**\n" + "     * @param\n" + "     */\n" + "    @Deprecated\n" + "    void m10() {\n" + "    }\n" + "}\n" + "\n");
            createFile("/Bug393192/src/pullup/package-info.java", "package pullup;\n" + "\n");
            createFile("/Bug393192/src/pullup/PullUpBug.java", "package pullup;\n" + "\n" + "class PullUpBug extends A {\n" + "\n" + "    void mb() {\n" + "        pullUp();\n" + "    }\n" + "\n" + "    // INVOKE Pull Up REFACTORING ON \"pullUp\", or type Hierarchy on A\n" + "    private void pullUp() {\n" + "    }\n" + "}\n");
            ...
            assertHierarchyEquals("Focus: A [in A.java [in pullup [in src [in Bug393192]]]]\n" + "Super types:\n" + "  Object [in Object.class [in java.lang [in " + getExternalJCLPathString() + "]]]\n" + "Sub types:\n" + "  PullUpBug [in PullUpBug.java [in pullup [in src [in Bug393192]]]]\n", hierarchy);
        } finally {
            if (prj != null)
                deleteProject(prj);
        }
    ...
    public void testBug436155() throws CoreException, IOException {
        try {
            ...
            createFolder("/P/abc/p");
            addLibrary(project, "lib.jar", "libsrc.zip", new String[] { "p/I.java", "package p;\n" + "public abstract class I {}", "p/I2.java", "package p;\n" + "public abstract class I2 extends I {}", "p/Text.java", "package p;\n" + "public class Text extends I2 {}" }, "1.4");
    ...
    public void testBug462158() throws CoreException, IOException {
        ...
        try {
            ...
            assertTypesEqual("Incorrect hierarchy", "java.util.ArrayList\n" + "java.util.AbstractList\n" + "java.util.AbstractCollection\n" + "java.lang.Object\n", allSupertypes, false);
        } finally {
            if (prj != null)
                deleteProject(prj);
        }
