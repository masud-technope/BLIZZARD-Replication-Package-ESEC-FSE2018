...
public interface IIndexConstants {
    ...
    //$NON-NLS-1$
    char[] ANNOTATION_REF = "annotationRef".toCharArray();
    ...
    //$NON-NLS-1$
    char[] METHOD_DECL_PLUS = "methodDeclPlus".toCharArray();
    ...
    char[][] COUNTS = new char[][] { new char[] { '/', '0' }, new char[] { '/', '1' }, new char[] { '/', '2' }, new char[] { '/', '3' }, new char[] { '/', '4' }, new char[] { '/', '5' }, new char[] { '/', '6' }, new char[] { '/', '7' }, new char[] { '/', '8' }, new char[] { '/', '9' } };
