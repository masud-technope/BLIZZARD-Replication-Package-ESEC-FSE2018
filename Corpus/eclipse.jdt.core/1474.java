...
public class ProgrammingProblemsTest extends AbstractRegressionTest {
    ...
    void runTest(String[] testFiles, String[] errorOptions, String[] warningOptions, String[] ignoreOptions, boolean expectingCompilerErrors, String expectedCompilerLog, String expectedOutputString, boolean forceExecution, String[] classLib, boolean shouldFlushOutputDirectory, String[] vmArguments, Map customOptions, ICompilerRequestor clientRequestor, boolean skipJavac) {
        ...
        runTest(testFiles, expectingCompilerErrors, expectedCompilerLog, expectedOutputString, /* expectedErrorString */
        "", forceExecution, classLib, shouldFlushOutputDirectory, vmArguments, compilerOptions, clientRequestor, skipJavac);
    }
    ...
    public void test0002_unread_parameters() {
        runTest(new String[] { "X.java", "public class X {\n" + "  public void foo(boolean b) {\n" + "  }\n" + "}\n" }, /* errorOptions */
        null, new String[] { CompilerOptions.OPTION_ReportUnusedParameter }, /* ignoreOptions */
        null, /* expectingCompilerErrors */
    ...
    public void test0003_unread_parameters() {
        ...
        null, /* shouldFlushOutputDirectory */
        true, /* vmArguments */
        null, customOptions, /* clientRequestor */
        null, /* skipJavac */
        true);
    }
    ...
    public void test0006_unread_parameters() {
        runTest(new String[] { "X.java", "public class X {\n" + "  public void foo(boolean b) {\n" + "  }\n" + "}\n" }, new String[] { CompilerOptions.OPTION_ReportUnusedParameter }, /* warningOptions */
        null, /* ignoreOptions */
        null, /* expectingCompilerErrors */
    ...
    public void test0008_declared_thrown_checked_exceptions() {
        runTest(new String[] { "X.java", "import java.io.IOException;\n" + "public class X {\n" + "  public void foo() throws IOException {\n" + "  }\n" + "}\n" }, /* errorOptions */
        null, new String[] { CompilerOptions.OPTION_ReportUnusedDeclaredThrownException }, /* ignoreOptions */
        null, /* expectingCompilerErrors */
    ...
    public void test0010_declared_thrown_checked_exceptions() {
        Map customOptions = new HashMap();
        customOptions.put(CompilerOptions.OPTION_DocCommentSupport, CompilerOptions.ENABLED);
        customOptions.put(CompilerOptions.OPTION_ReportUnusedDeclaredThrownExceptionIncludeDocCommentReference, CompilerOptions.DISABLED);
        runTest(new String[] { "X.java", "import java.io.IOException;\n" + "public class X {\n" + "/** @throws IOException mute warning **/\n" + "  public void foo() throws IOException {\n" + "  }\n" + "}\n" }, /* errorOptions */
        null, new String[] { CompilerOptions.OPTION_ReportUnusedDeclaredThrownException }, /* ignoreOptions */
        null, /* expectingCompilerErrors */
    ...
    public void test0012_declared_thrown_checked_exceptions() {
        runTest(new String[] { "X.java", "import java.io.IOException;\n" + "public class X {\n" + "  public void foo() throws IOException {\n" + "  }\n" + "}\n" }, new String[] { CompilerOptions.OPTION_ReportUnusedDeclaredThrownException }, /* warningOptions */
        null, /* ignoreOptions */
        null, /* expectingCompilerErrors */
    ...
    public void test0014_declared_thrown_checked_exceptions_unread_parameters() {
        runTest(new String[] { "X.java", "import java.io.IOException;\n" + "public class X {\n" + "  void foo(int unused) throws IOException {}\n" + "}\n" }, new String[] { CompilerOptions.OPTION_ReportUnusedDeclaredThrownException }, /* errorOptions */
        new String[] { CompilerOptions.OPTION_ReportUnusedParameter }, /* ignoreOptions */
        null, /* expectingCompilerErrors */
    ...
    public void test0015_declared_thrown_checked_exceptions_unread_parameters() {
        runTest(new String[] { "X.java", "import java.io.IOException;\n" + "public class X {\n" + "  void foo(int unused) throws IOException {}\n" + "}\n" }, /* errorOptions */
        null, new String[] { CompilerOptions.OPTION_ReportUnusedDeclaredThrownException, CompilerOptions.OPTION_ReportUnusedParameter }, /* ignoreOptions */
        null, /* expectingCompilerErrors */
    ...
    public void test0017_shadowing_package_visible_methods() {
        ...
        null, new String[] { CompilerOptions.OPTION_ReportOverridingPackageDefaultMethod }, /* ignoreOptions */
        null, /* expectingCompilerErrors */
    ...
    public void test0023_declared_thrown_unchecked_exceptions() {
        Map customOptions = new HashMap();
        customOptions.put(JavaCore.COMPILER_PB_UNUSED_DECLARED_THROWN_EXCEPTION_EXEMPT_EXCEPTION_AND_THROWABLE, CompilerOptions.DISABLED);
        runTest(new String[] { "X.java", "public class X {\n" + "  public void foo() throws Exception {\n" + "  }\n" + "}\n" }, /* errorOptions */
        null, new String[] { CompilerOptions.OPTION_ReportUnusedDeclaredThrownException }, /* ignoreOptions */
        null, /* expectingCompilerErrors */
 ...
 */
    ...
    public void test0042() {
        ...
        null, new String[] { CompilerOptions.OPTION_ReportUnusedLocal }, /* ignoreOptions */
        null, /* expectingCompilerErrors */
        false, /* expectedCompilerLog */
        "", /* expectedOutputString */
        "", /* forceExecution */
