 ...
 */
    public  DOMFactory() {
        ...
        this.lineSeparator = org.eclipse.jdt.internal.core.util.Util.getLineSeparator(null, null);
    }
 ...
 */
    public IDOMMethod createMethod() {
        //$NON-NLS-2$ //$NON-NLS-1$
        return createMethod("public void newMethod() {" + this.lineSeparator + "}" + this.lineSeparator);
    }
 ...
 */
    public IDOMType createType() {
        //$NON-NLS-2$ //$NON-NLS-1$
        return createType("public class AClass {" + this.lineSeparator + "}" + this.lineSeparator);
    }
 ...
 */
    public IDOMType createInterface() {
        //$NON-NLS-2$ //$NON-NLS-1$
        return createType("public interface AnInterface {" + this.lineSeparator + "}" + this.lineSeparator);
    }
