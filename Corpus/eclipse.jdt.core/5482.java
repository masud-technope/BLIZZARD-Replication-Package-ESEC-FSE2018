...
public class PrimitiveType extends AnnotatableType {
	 ...
	 * @since 3.10
	 */
    public static final ChildListPropertyDescriptor ANNOTATIONS_PROPERTY = internalAnnotationsPropertyFactory(PrimitiveType.class);

    /**
	 * The "primitiveTypeCode" structural property of this node type (type: {@link PrimitiveType.Code}).
	 * @since 3.0
	 */
    public static final SimplePropertyDescriptor PRIMITIVE_TYPE_CODE_PROPERTY = //$NON-NLS-1$
    new SimplePropertyDescriptor(PrimitiveType.class, "primitiveTypeCode", PrimitiveType.Code.class, MANDATORY);
