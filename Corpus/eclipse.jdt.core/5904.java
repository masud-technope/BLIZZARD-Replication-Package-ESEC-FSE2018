 ...
 */
    public void test1FTZCIG() {
        ...
        "class Bar {								\n" + "	void foo() {							\n" + "		new X() {							\n" + "			protected void bar() {			\n" + "			}								\n" + "		}									\n" + "	}										\n" + "}											\n", // completeBehind:
        "p", // expectedCompletionNodeToString:
        "<CompleteOnType:p>", // expectedUnitDisplayString:
        "class Bar {\n" + "  Bar() {\n" + "  }\n" + "  void foo() {\n" + "    new X() {\n" + "      <CompleteOnType:p>;\n" + "      void bar() {\n" + "      }\n" + "    };\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "p", // expectedReplacedSource:
        "protected", // test name
        "<1FTZCIG>");
    }
 ...
 */
    public void testCatchClause1() {
        ...
        "class Bar {								\n" + "	void foo() {							\n" + "		try {								\n" + "			fred();							\n" + "		} catch (Xxx e) {					\n" + "		}									\n" + "	}										\n" + "}											\n", // completeBehind:
        "X", // expectedCompletionNodeToString:
        "<CompleteOnException:X>", // expectedUnitDisplayString:
 ...
 */
    public void testCatchClause3() {
        this.runTestCheckMethodParse(// compilationUnit:
        "class Bar {								\n" + "	void foo() {							\n" + "		try {								\n" + "			fred();							\n" + "		} catch (x.y.Xxx e) {				\n" + "		}									\n" + "	}										\n" + "}											\n", // completeBehind:
        "x.y.X", // expectedCompletionNodeToString:
        "<CompleteOnException:x.y.X>", // expectedUnitDisplayString:
 ...
 */
    public void testClassBody() {
        ...
        "class Bar {								\n" + "	Xxx foo() {								\n" + "	}										\n" + "}											\n", // completeBehind:
        "X", // expectedCompletionNodeToString:
        "<CompleteOnType:X>", // expectedUnitDisplayString:
        "class Bar {\n" + "  Bar() {\n" + "  }\n" + "  <CompleteOnType:X>\n" + "}\n", // expectedCompletionIdentifier:
        "X", // expectedReplacedSource:
        "Xxx", // test name
 ...
 */
    public void testClassInstanceCreationExpressionName1() {
        this.runTestCheckMethodParse(// compilationUnit:
        "public class Bar {								\n" + "	static Bar baz;								\n" + "	public class X {							\n" + "		void foo() {							\n" + "			Bar.baz.new Xxx();					\n" + "		}										\n" + "	}											\n" + "}												\n", // completeBehind:
        "new X", // expectedCompletionNodeToString:
        "<CompleteOnType:X>", // expectedUnitDisplayString:
 ...
 */
    public void testExtendsClass() {
        ...
        "X", // expectedCompletionNodeToString:
        "<CompleteOnClass:X>", // expectedUnitDisplayString:
 ...
 */
    public void testExtendsInterface() {
        ...
        "X", // expectedCompletionNodeToString:
        "<CompleteOnInterface:X>", // expectedUnitDisplayString:
 ...
 */
    public void testQualifiedTypeReferenceShrinkAll() {
        this.runTestCheckMethodParse(// compilationUnit:
        "class Bar {								\n" + "	void foo() {							\n" + "		int i = 0;							\n" + "		new a.b.c.Xxx();			\n" + "	}										\n" + "}											\n", // completeBehind:
        "		new a", // expectedCompletionNodeToString:
        "<CompleteOnType:a>", // expectedUnitDisplayString:
 ...
 */
    public void testQualifiedTypeReferenceShrinkNone() {
        ...
        "class Bar {								\n" + "	void foo() {							\n" + "		int i = 0;							\n" + "		new a.b.c.Xxx();			\n" + "	}										\n" + "}											\n", // completeBehind:
        "X", // expectedCompletionNodeToString:
        "<CompleteOnType:a.b.c.X>", // expectedUnitDisplayString:
 ...
 */
    public void testQualifiedTypeReferenceShrinkOne() {
        ...
        "<CompleteOnType:a.b.c.>", // expectedUnitDisplayString:
