 ...
 */
    ...
    public boolean matchesDecodedKey(SearchPattern decodedPattern) {
        ...
        if (this.superRefKind == ONLY_SUPER_CLASSES && pattern.enclosingTypeName != ONE_ZERO)
            // consider enumerations as classes, reject interfaces and annotations
            if (pattern.superClassOrInterface == INTERFACE_SUFFIX || pattern.superClassOrInterface == ANNOTATION_TYPE_SUFFIX)
                return false;
