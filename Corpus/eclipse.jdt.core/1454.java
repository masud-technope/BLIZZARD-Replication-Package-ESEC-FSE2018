...
public class WorkingCopySearchTests extends JavaSearchTests {
    ...
    public void testAddNewType() throws CoreException {
        ...
        SearchPattern pattern = SearchPattern.createPattern("NewType", TYPE, DECLARATIONS, SearchPattern.R_EXACT_MATCH | SearchPattern.R_CASE_SENSITIVE);
        new SearchEngine(new ICompilationUnit[] { this.workingCopy }).search(pattern, new SearchParticipant[] { SearchEngine.getDefaultSearchParticipant() }, scope, this.resultCollector, null);
    ...
    public void testAllTypeNames1() throws CoreException {
        ...
        new SearchEngine(new ICompilationUnit[] { this.workingCopy }).searchAllTypeNames(null, SearchPattern.R_EXACT_MATCH, null, // case insensitive
        SearchPattern.R_PATTERN_MATCH, TYPE, scope, requestor, IJavaSearchConstants.WAIT_UNTIL_READY_TO_SEARCH, null);
    ...
    public void testAllTypeNames3() throws CoreException {
        ...
        try {
            ...
            SearchTests.SearchTypeNameRequestor requestor = new SearchTests.SearchTypeNameRequestor();
            new SearchEngine().searchAllTypeNames("wc3".toCharArray(), SearchPattern.R_EXACT_MATCH, "X".toCharArray(), // case insensitive
            SearchPattern.R_PREFIX_MATCH, TYPE, scope, requestor, IJavaSearchConstants.WAIT_UNTIL_READY_TO_SEARCH, null);
            assertSearchResults("Unexpected all type names", "wc3.X44884", requestor);
        } finally {
    ...
    public void testAllTypeNamesBug99915() throws CoreException {
        ...
        IJavaSearchScope scope = SearchEngine.createJavaSearchScope(new IJavaElement[] { this.workingCopy.getParent() });
        SearchTests.SearchTypeNameRequestor requestor = new SearchTests.SearchTypeNameRequestor();
        new SearchEngine(new ICompilationUnit[] { this.workingCopy }).searchAllTypeNames(null, SearchPattern.R_EXACT_MATCH, "A*".toCharArray(), // case insensitive
        SearchPattern.R_PATTERN_MATCH, TYPE, scope, requestor, IJavaSearchConstants.WAIT_UNTIL_READY_TO_SEARCH, null);
        assertSearchResults("Unexpected all type names", "wc.AAABBB", requestor);
    }
    ...
    public void testAllTypeNamesBug98684() throws CoreException {
        try {
            ...
            new SearchEngine(this.workingCopies).searchAllTypeNames(null, SearchPattern.R_EXACT_MATCH, "A".toCharArray(), SearchPattern.R_PREFIX_MATCH, TYPE, scope, requestor, IJavaSearchConstants.WAIT_UNTIL_READY_TO_SEARCH, null);
            assertSearchResults("Unexpected all type names", "p2.A2\n" + "p2.A2$A2Inner1\n" + "p2.A2$A2Inner2", requestor);
        } finally {
            deleteProject("P1");
            deleteProject("P2");
        }
    ...
    public void testDeclarationOfReferencedTypes() throws CoreException {
        IMethod method = this.workingCopy.getType("X").createMethod("public void foo() {\n" + "  X x = new X();\n" + "}", null, true, null);
        //	JavaSearchResultCollector resultCollector = new JavaSearchResultCollector();
    ...
    public void testMoveType() throws CoreException {
        ...
        try {
            ...
            //		JavaSearchResultCollector resultCollector = new JavaSearchResultCollector();
            SearchPattern pattern = SearchPattern.createPattern("X", TYPE, DECLARATIONS, SearchPattern.R_EXACT_MATCH | SearchPattern.R_CASE_SENSITIVE);
            searchEngine.search(pattern, new SearchParticipant[] { SearchEngine.getDefaultSearchParticipant() }, scope1, this.resultCollector, null);
            ...
            searchEngine.search(pattern, new SearchParticipant[] { SearchEngine.getDefaultSearchParticipant() }, scope2, this.resultCollector, null);
    ...
    public void testRemoveType() throws CoreException {
        ...
        this.resultCollector = new JavaSearchResultCollector();
        new SearchEngine().search(pattern, new SearchParticipant[] { SearchEngine.getDefaultSearchParticipant() }, scope, this.resultCollector, null);
        assertSearchResults("src/wc/X.java wc.X [X]", this.resultCollector);
    }
    ...
    public void testBug478042_dirtyWC_001() throws CoreException {
        ...
        "AllMethod".toCharArray(), // declaring SimpleType
        SearchPattern.R_PREFIX_MATCH, "foo".toCharArray(), SearchPattern.R_PREFIX_MATCH, scope, requestor, IJavaSearchConstants.WAIT_UNTIL_READY_TO_SEARCH, null);
        assertSearchResults("/JavaSearch/src/wc/X.java char p478042.AllMethodDeclarations01.foo03(Object o,String s)\n" + "/JavaSearch/src/wc/X.java int p478042.AllMethodDeclarations01.foo02(Object o)\n" + "/JavaSearch/src/wc/X.java void p478042.AllMethodDeclarations01.foo01()", requestor);
    }
    ...
    public void testBug478042_dirtyWC_002() throws CoreException {
        ...
        new SearchEngine(new ICompilationUnit[] { this.workingCopy }).searchAllMethodNames("p478042".toCharArray(), //package
        SearchPattern.R_EXACT_MATCH, // declaring Qualification
        "AllMethod".toCharArray(), // declaring Qualification
        SearchPattern.R_PREFIX_MATCH, // declaring SimpleType
        "Nested".toCharArray(), // declaring SimpleType
        SearchPattern.R_EXACT_MATCH, "foo".toCharArray(), SearchPattern.R_PREFIX_MATCH, scope, requestor, IJavaSearchConstants.WAIT_UNTIL_READY_TO_SEARCH, null);
        assertSearchResults("/JavaSearch/src/wc/X.java char p478042.AllMethodDeclarations01.Nested.foo03(Object o,String s)\n" + "/JavaSearch/src/wc/X.java int p478042.AllMethodDeclarations01.Nested.foo02(Object o)\n" + "/JavaSearch/src/wc/X.java void p478042.AllMethodDeclarations01.Nested.foo01()", requestor);
    }
    ...
    public void testBug478042_dirtyWC_003() throws CoreException {
        ...
        "AllMethod".toCharArray(), // declaring Qualification
        SearchPattern.R_PREFIX_MATCH, // declaring SimpleType
        "Inner".toCharArray(), // declaring SimpleType
        SearchPattern.R_EXACT_MATCH, "foo".toCharArray(), SearchPattern.R_PREFIX_MATCH, scope, requestor, IJavaSearchConstants.WAIT_UNTIL_READY_TO_SEARCH, null);
        assertSearchResults("/JavaSearch/src/wc/X.java char p478042.AllMethodDeclarations01.Nested.Inner.foo03(Object o,String s)\n" + "/JavaSearch/src/wc/X.java int p478042.AllMethodDeclarations01.Nested.Inner.foo02(Object o)\n" + "/JavaSearch/src/wc/X.java void p478042.AllMethodDeclarations01.Nested.Inner.foo01()", requestor);
    }
    ...
    public void testBug478042_dirtyWC_004() throws CoreException {
        ...
        IJavaSearchScope scope = SearchEngine.createJavaSearchScope(new IJavaElement[] { this.workingCopy.getParent() });
        SearchTests.SearchMethodNameRequestor requestor = new SearchTests.SearchMethodNameRequestor();
        new SearchEngine(new ICompilationUnit[] { this.workingCopy }).searchAllMethodNames("p478042.AllMethod*".toCharArray(), SearchPattern.R_PATTERN_MATCH, "foo".toCharArray(), SearchPattern.R_PREFIX_MATCH, scope, requestor, IJavaSearchConstants.WAIT_UNTIL_READY_TO_SEARCH, null);
        assertSearchResults("/JavaSearch/src/wc/X.java char p478042.AllMethodDeclarations01.foo03(Object o,String s)\n" + "/JavaSearch/src/wc/X.java int p478042.AllMethodDeclarations01.foo02(Object o)\n" + "/JavaSearch/src/wc/X.java void p478042.AllMethodDeclarations01.foo01()", requestor);
    }
    ...
    public void testBug483650_dirtyWC_002() throws CoreException {
        ...
        IJavaSearchScope scope = SearchEngine.createJavaSearchScope(new IJavaElement[] { this.workingCopy.getParent() });
        SearchTests.SearchMethodNameRequestor requestor = new SearchTests.SearchMethodNameRequestor();
        new SearchEngine(new ICompilationUnit[] { this.workingCopy }).searchAllMethodNames("p478042.AllMethod*.Nested".toCharArray(), SearchPattern.R_PATTERN_MATCH, "foo".toCharArray(), SearchPattern.R_PREFIX_MATCH, scope, requestor, IJavaSearchConstants.WAIT_UNTIL_READY_TO_SEARCH, null);
        assertSearchResults("/JavaSearch/src/wc/X.java char p478042.AllMethodDeclarations01.Nested.foo03(Object o,String s)\n" + "/JavaSearch/src/wc/X.java int p478042.AllMethodDeclarations01.Nested.foo02(Object o)\n" + "/JavaSearch/src/wc/X.java void p478042.AllMethodDeclarations01.Nested.foo01()", requestor);
    }
    ...
    public void testBug483650_dirtyWC_003() throws CoreException {
        ...
        IJavaSearchScope scope = SearchEngine.createJavaSearchScope(new IJavaElement[] { this.workingCopy.getParent() });
        SearchTests.SearchMethodNameRequestor requestor = new SearchTests.SearchMethodNameRequestor();
        new SearchEngine(new ICompilationUnit[] { this.workingCopy }).searchAllMethodNames("p478042.AllMethod*.Inner".toCharArray(), SearchPattern.R_PATTERN_MATCH, "foo".toCharArray(), SearchPattern.R_PREFIX_MATCH, scope, requestor, IJavaSearchConstants.WAIT_UNTIL_READY_TO_SEARCH, null);
        assertSearchResults("/JavaSearch/src/wc/X.java char p478042.AllMethodDeclarations01.Nested.Inner.foo03(Object o,String s)\n" + "/JavaSearch/src/wc/X.java int p478042.AllMethodDeclarations01.Nested.Inner.foo02(Object o)\n" + "/JavaSearch/src/wc/X.java void p478042.AllMethodDeclarations01.Nested.Inner.foo01()", requestor);
    }
