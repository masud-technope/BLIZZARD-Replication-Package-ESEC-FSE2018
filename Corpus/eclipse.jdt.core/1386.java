...
public class CompilerOptions implements ProblemReasons, ProblemSeverities, ClassFileConstants {
    ...
    //$NON-NLS-1$
    public static final String OPTION_ReportUnsafeTypeOperation = "org.eclipse.jdt.core.compiler.problem.unsafeTypeOperation";
    ...
    public long complianceLevel = JDK1_4;

    //1.3 source behavior by default
    public long sourceLevel = JDK1_3;

    // default generates for JVM1.2
    public long targetJDK = JDK1_2;
    ...
    public void set(Map optionsMap) {
        ...
        if ((optionValue = optionsMap.get(OPTION_ReportUnsafeTypeOperation)) != null)
            updateSeverity(UnsafeTypeOperation, optionValue);
    ...
    public String toString() {
        ...
        buf.append("\n\t- local variables debug attributes: ").append((this.produceDebugAttributes & Vars) != 0 ? "ON" : " OFF");
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        buf.append("\n\t- line number debug attributes: ").append((this.produceDebugAttributes & Lines) != 0 ? "ON" : " OFF");
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        buf.append("\n\t- source debug attributes: ").append((this.produceDebugAttributes & Source) != 0 ? "ON" : " OFF");
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        ...
        //$NON-NLS-1$
        buf.append("\n\t- unused declared thrown exception: ").append(getSeverityString(UnusedDeclaredThrownException));
        //$NON-NLS-1$
        ...
        //$NON-NLS-1$
        buf.append("\n\t- unsafe type operation: ").append(getSeverityString(UnsafeTypeOperation));
        //$NON-NLS-1$
        ...
        //$NON-NLS-1$
        buf.append("\n\t- forbidden reference to non-API type: ").append(getSeverityString(ForbiddenReference));
        return buf.toString();
    }
