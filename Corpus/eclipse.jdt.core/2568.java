...
public abstract class JavaElement extends PlatformObject implements IJavaElement {
    ...
    protected Object openWhenClosed(Object info, boolean forceAdd, IProgressMonitor monitor) throws JavaModelException {
        ...
        try {
            ...
            if (// a source ref element could not be opened
            info == null) {
    ...
    public String toDebugString() {
        StringBuffer buffer = new StringBuffer();
        this.toStringInfo(0, buffer, NO_INFO, /*show resolved info*/
        true);
        return buffer.toString();
    }
    ...
    public String toStringWithAncestors() {
        return toStringWithAncestors(/*show resolved info*/
        true);
    }
    ...
    protected void toStringAncestors(StringBuffer buffer) {
        ...
        if (parentElement != null && parentElement.getParent() != null) {
            //$NON-NLS-1$
            buffer.append(" [in ");
            parentElement.toStringInfo(0, buffer, NO_INFO, /*don't show resolved info*/
            false);
    ...
    public Object toStringInfo(int tab, StringBuffer buffer) {
        ...
        this.toStringInfo(tab, buffer, info, /*show resolved info*/
        true);
        return info;
    }
    ...
    protected String getURLContents(URL baseLoc, String docUrlValue) throws JavaModelException {
        ...
        try {
            redirect: for (// avoid endless redirects...
            int i = 0; // avoid endless redirects...
            i < 5; // avoid endless redirects...
            i++) {
                ...
                if (connection instanceof HttpURLConnection) {
                    ...
                    if (httpCon.getResponseCode() == 301) {
                        docUrlValue = //$NON-NLS-1$
                        httpCon.getHeaderField(//$NON-NLS-1$
                        "location");
                        if (docUrlValue != null) {
                            continue redirect;
                        }
