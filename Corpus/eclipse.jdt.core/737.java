 ...
 */
    public void acceptImport(int declarationStart, int declarationEnd, int nameStart, int nameEnd, char[][] tokens, boolean onDemand, int modifiers) {
        addImport(new SourceImport(declarationStart, declarationEnd, CharOperation.concatWith(tokens, '.'), onDemand, modifiers, this.source));
    }
 ...
 */
    ...
    protected void addImport(SourceImport sourceImport) {
        ...
        if (this.numberOfImports == this.currentImports.length) {
            System.arraycopy(this.currentImports, 0, this.currentImports = new SourceImport[this.numberOfImports * 2], 0, this.numberOfImports);
        }
    ...
    public void dietParse(String s, String testName, boolean recordLocalDeclaration) {
        ...
        reset();
        SourceElementParser parser = new SourceElementParser(this, new DefaultProblemFactory(Locale.getDefault()), new CompilerOptions(getCompilerOptions()), recordLocalDeclaration, /*optimize string literals*/
        true);
    ...
    public void enterType(TypeInfo typeInfo) {
        if (this.currentType == null) {
            ...
            this.currentType.addMemberType(memberType = new SourceType(this.currentType.getName(), typeInfo.declarationStart, typeInfo.modifiers, typeInfo.name, typeInfo.nameSourceStart, typeInfo.nameSourceEnd, typeInfo.superclass, typeInfo.superinterfaces, this.source));
    ...
    public void enterField(FieldInfo fieldInfo) {
        this.currentType.addField(this.currentField = new SourceField(fieldInfo.declarationStart, fieldInfo.modifiers, fieldInfo.type, fieldInfo.name, fieldInfo.nameSourceStart, fieldInfo.nameSourceEnd, this.source));
    }

    public void enterInitializer(int declarationSourceStart, int modifiers) {
        this.currentType.addField(this.currentInitializer = new SourceInitializer(declarationSourceStart, modifiers));
    }
    ...
    protected void enterAbtractMethod(MethodInfo methodInfo) {
        this.currentType.addMethod(this.currentMethod = new SourceMethod(methodInfo.declarationStart, methodInfo.modifiers, methodInfo.returnType, // null for constructors
        methodInfo.name, methodInfo.nameSourceStart, methodInfo.nameSourceEnd, methodInfo.parameterTypes, methodInfo.parameterNames, methodInfo.exceptionTypes, this.source));
    ...
    public void fullParse(String s, String testName, boolean recordLocalDeclaration, Map options) {
        this.source = s.toCharArray();
        reset();
        SourceElementParser parser = new SourceElementParser(this, new DefaultProblemFactory(Locale.getDefault()), new CompilerOptions(options), recordLocalDeclaration, /*optimize string literals*/
        true);
        ICompilationUnit sourceUnit = new CompilationUnit(this.source, testName, null);
    ...
    public void setImports() {
        if (this.currentImports == null)
            return;
        if (this.numberOfImports != this.currentImports.length) {
            System.arraycopy(this.currentImports, 0, this.currentImports = new SourceImport[this.numberOfImports], 0, this.numberOfImports);
        }
    ...
    public void test01() {
        ...
        assertEquals("Invalid source " + testName, expectedUnitToString, this.currentType.toString());
    }
    ...
    public void test15() {
        ...
        assertEquals("Invalid class declarationSourceStart ", 26, member.getDeclarationSourceStart());
        assertEquals("Invalid class declarationSourceEnd ", 227, member.getDeclarationSourceEnd());
        assertEquals("Invalid source " + testName, expectedUnitToString, this.currentType.toString());
    }
    ...
    public void test17() {
        ...
        SourceType member = members[0];
        assertEquals("Invalid class declarationSourceStart ", 26, member.getDeclarationSourceStart());
        assertEquals("Invalid class declarationSourceEnd ", 117, member.getDeclarationSourceEnd());
        assertEquals("Invalid source " + testName, expectedUnitToString, this.currentType.toString());
    }
    ...
    public void test26() {
        ...
        assertEquals("Invalid class declarationSourceStart ", 34, members[0].getDeclarationSourceStart());
        assertEquals("Invalid class declarationSourceEnd ", 90, members[0].getDeclarationSourceEnd());
        methods = members[0].getMethods();
        assertTrue(" invalid methods ", methods != null);
    ...
    public void test27() {
        ...
        assertTrue(" invalid members ", members != null);
        assertEquals(" contains one member ", 1, members.length);
        assertEquals("Invalid class declarationSourceStart ", 45, members[0].getDeclarationSourceStart());
        assertEquals("Invalid class declarationSourceEnd ", 101, members[0].getDeclarationSourceEnd());
        methods = members[0].getMethods();
        assertTrue(" invalid methods ", methods != null);
        assertEquals(" contains one method ", 1, methods.length);
    ...
    public void test28() {
        ...
        assertEquals(" contains one member ", 1, members.length);
        assertEquals("Invalid class declarationSourceStart ", 45, members[0].getDeclarationSourceStart());
        assertEquals("Invalid class declarationSourceEnd ", 65, members[0].getDeclarationSourceEnd());
        methods = members[0].getMethods();
        assertTrue(" invalid methods ", methods == null);
        members = members[0].getMemberTypes();
        assertTrue(" invalid members ", members == null);
    ...
    public void test37() {
        ...
        assertTrue(" invalid members ", members != null);
        assertEquals("contains one member ", 1, members.length);
        assertEquals("Invalid class declarationSourceStart ", 73, members[0].getDeclarationSourceStart());
        assertEquals("Invalid class declarationSourceEnd ", 104, members[0].getDeclarationSourceEnd());
        fields = members[0].getFields();
        assertTrue(" invalid fields ", fields != null);
        assertEquals("contains one field ", 1, fields.length);
    ...
    public void test39() {
        ...
        assertEquals("contains one member ", 1, members.length);
        assertEquals("Invalid class declarationSourceStart ", 73, members[0].getDeclarationSourceStart());
        assertEquals("Invalid class declarationSourceEnd ", 87, members[0].getDeclarationSourceEnd());
        fields = members[0].getFields();
        assertTrue(" invalid fields ", fields == null);
        methods = members[0].getMethods();
        assertTrue(" invalid methods ", methods == null);
