...
interface X03 {
	 ...
	 *        want to know if the formatter is able to handle more than two
	 *        lines in a tag description. But this time this description is
	 *        split on several lines which may make the work a little bit more
	 *        difficult to do...
	 * 
	 * 
	 * 
