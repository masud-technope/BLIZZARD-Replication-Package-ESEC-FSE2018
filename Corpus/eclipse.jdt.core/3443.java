...
public class MethodRefParameter extends ASTNode {
    ...
    new ChildPropertyDescriptor(MethodRefParameter.class, "type", Type.class, MANDATORY, NO_CYCLE_RISK);
    ...
    new SimplePropertyDescriptor(MethodRefParameter.class, "varargs", boolean.class, MANDATORY);
    ...
    new ChildPropertyDescriptor(MethodRefParameter.class, "name", SimpleName.class, OPTIONAL, NO_CYCLE_RISK);
