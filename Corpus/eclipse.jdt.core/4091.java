    ...
    public void execute() throws BuildException {
        ...
        try {
            ...
            if (hasDebugAttributes) {
                //$NON-NLS-1$
                getProject().setUserProperty(//$NON-NLS-1$
                this.property, //$NON-NLS-1$
                "has debug");
            }
        } catch (IOException e) {
            throw new BuildException(AntAdapterMessages.getString("checkDebugAttributes.ioexception.occured") + this.file);
        }
    }
