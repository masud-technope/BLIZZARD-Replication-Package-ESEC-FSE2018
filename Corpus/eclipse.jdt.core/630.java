...
public class StandAloneASTParserTest extends AbstractRegressionTest {
    ...
    public void test7() throws IOException {
        ...
        try {
            ...
            parser.createASTs(new String[] { file.getCanonicalPath(), fileY.getCanonicalPath() }, null, new String[] {}, new FileASTRequestor() {
            }, null);
        } finally {
            file.delete();
            fileY.delete();
    ...
    public void testBug461250() {
        ...
        parser.setEnvironment(emptyStringArray, emptyStringArray, emptyStringArray, /* includeRunningVMBootclasspath */
        true);
    ...
    public void testBug465048() {
        ...
        SimpleName innerClassLiteral = (SimpleName) NodeFinder.perform(cu, cu.getPosition(4, 16), /* length */
        1);
