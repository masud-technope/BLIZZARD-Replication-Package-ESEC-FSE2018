...
public class BatchASTCreationTests extends AbstractASTTests {
    ...
    private void assertBindingsCreated(String[] pathAndSources, final String[] expectedKeys) throws JavaModelException {
        ...
        try {
            ...
            try {
                dummyWorkingCopies = createWorkingCopies(new String[] { "/P/Test.java", "public class Test {\n" + "}" });
    ...
    public void test001() throws CoreException {
        this.workingCopies = createWorkingCopies(new String[] { "/P/p1/X.java", "package p1;\n" + "public class X extends Y {\n" + "}", "/P/p1/Y.java", "package p1;\n" + "public class Y {\n" + "}" });
    ...
    public void test002() throws CoreException {
        MarkerInfo[] markerInfos = createMarkerInfos(new String[] { "/P/p1/X.java", "package p1;\n" + "public class X extends /*start*/Y/*end*/ {\n" + "}", "/P/p1/Y.java", "package p1;\n" + "/*start*/public class Y {\n" + "}/*end*/" });
    ...
    public void test003() throws CoreException {
        ...
        try {
            this.workingCopies = createWorkingCopies(new String[] { "/P/p1/X.java", "package p1;\n" + "public class X extends Y {\n" + "}" });
            otherWorkingCopies = createWorkingCopies(new String[] { "/P/p1/Y.java", "package p1;\n" + "public class Y {\n" + "}" });
            TestASTRequestor requestor = new TestASTRequestor();
            resolveASTs(this.workingCopies, requestor);
            assertASTNodesEqual("package p1;\n" + "public class X extends Y {\n" + "}\n" + "\n", requestor.asts);
        } finally {
    ...
    public void test004() throws CoreException {
        assertRequestedBindingFound(new String[] { "/P/p1/X.java", "/*start*/package p1;/*end*/\n" + "public class X {\n" + "}" }, "p1");
    }
    ...
    public void test005() throws CoreException {
        assertRequestedBindingFound(new String[] { "/P/p1/X.java", "package p1;\n" + "/*start*/public class X extends Y {\n" + "}/*end*/", "/P/p1/Y.java", "package p1;\n" + "public class Y {\n" + "}" }, "Lp1/X;");
    }
    ...
    public void test011() throws CoreException {
        assertBindingCreated(new String[] { "/P/p1/X.java", "package p1;\n" + "public class X {\n" + "}" }, "p1");
    }
    ...
    public void test042() throws CoreException {
        ...
        try {
            workingCopy = getWorkingCopy("/P/X.java", "public class X {\n" + "  int field;\n" + "}");
            BindingRequestor requestor = new BindingRequestor();
            String[] bindingKeys = new String[] { "LX;", "LX;.field)I" };
            resolveASTs(new ICompilationUnit[] { workingCopy }, bindingKeys, requestor, getJavaProject("P"), workingCopy.getOwner());
            assertBindingsEqual("LX;\n" + "LX;.field)I", requestor.getBindings(bindingKeys));
        } finally {
            if (workingCopy != null)
    ...
    public void test045() throws CoreException {
        ITypeBinding[] bindings = createTypeBindings(new String[] { "/P/p1/X.java", "package p1;\n" + "public class X {\n" + "}", "/P/p1/Y.java", "package p1;\n" + "public class Y<E> {\n" + "}" }, new String[] { "Lp1/X;", "Lp1/Y<Lp1/Y;{0}+Lp1/X;>;" });
        assertBindingsEqual("Lp1/X;\n" + "Lp1/Y<Lp1/Y;{0}+Lp1/X;>;", bindings);
    }
    ...
    public void test046() throws CoreException {
        assertBindingCreated(new String[] {}, "[Ljava/lang/Class<Ljava/lang/Object;>;");
    }
    ...
    public void test047() throws CoreException {
        ITypeBinding[] bindings = createTypeBindings(new String[] {}, new String[] { "N" });
        assertBindingsEqual("N", bindings);
    }
    ...
    public void test048() throws CoreException {
        ITypeBinding[] bindings = createTypeBindings(new String[] {}, new String[] { "[Ljava/lang/Object;" });
        assertBindingsEqual("[Ljava/lang/Object;", bindings);
    }
    ...
    public void test049() throws CoreException {
        ITypeBinding[] bindings = createTypeBindings(new String[] {}, new String[] { "Ljava/lang/Class<TT;>;:TT;" });
        assertBindingsEqual("Ljava/lang/Class;:TT;", bindings);
    }
    ...
    public void test050() throws CoreException {
        ITypeBinding[] bindings = createTypeBindings(new String[] {}, new String[] { "Ljava/lang/Class<Ljava/lang/Class<TT;>;{0}+[Ljava/lang/Object;>;" });
        assertBindingsEqual("Ljava/lang/Class<Ljava/lang/Class;{0}+[Ljava/lang/Object;>;", bindings);
    }
    ...
    public void test051() throws CoreException {
        ITypeBinding[] bindings = createTypeBindings(new String[] {}, new String[] { "Lp1/DoesNotExist;" });
        assertBindingsEqual("<null>", bindings);
    }
    ...
    public void test056() throws CoreException, IOException {
        try {
            ...
            addLibrary(project, "lib.jar", "src.zip", new String[] { "/BinaryProject/p/X.java", "package p;\n" + "public class X<K, V> {\n" + "  public class Y<K1, V1> {\n" + "  }\n" + "}" }, "1.5");
            ITypeBinding[] bindings = createTypeBindings(new String[0], new String[] { "Lp/X<>.Y<Lp/X;:TK;Lp/X;:TV;>;" }, project);
            assertBindingsEqual("Lp/X<>.Y<Lp/X;:TK;Lp/X;:TV;>;", bindings);
        } finally {
    ...
    public void test057() throws CoreException {
        ITypeBinding[] bindings = createTypeBindings(new String[] {}, new String[] { "Lp/Missing$Member;" });
        assertBindingsEqual("<null>", bindings);
    }
    ...
    public void test060() throws CoreException {
        assertRequestedBindingFound(new String[] { "/P/xy/Cap.java", "package xy;\n" + "import java.util.Vector;\n" + "public class Cap {\n" + "	{\n" + "		Vector<?> v= null;\n" + "		/*start*/v.get(0)/*end*/;\n" + "	}\n" + "}", "/P/java/util/Vector.java", "package java.util;\n" + "public class Vector<T> {\n" + "  public T get(int i) {\n" + "    return null;\n" + "  }\n" + "}" }, "Lxy/Cap;&!Ljava/util/Vector;{0}*82;");
    }
    ...
    public void test064() throws CoreException {
        assertRequestedBindingsFound(new String[] { "/P/p1/X.java", "package p1;\n" + "/*start1*/public class X {\n" + "	Object o= null;\n" + "	Y<?> field;\n" + "	void foo() {\n" + "		/*start2*/o = field/*end2*/;\n" + "	}\n" + "}/*end1*/\n", "/P/p1/Y.java", "package p1;\n" + "public class Y<T> {\n" + "}" }, new String[] { "Lp1/X;", "Lp1/X;&Lp1/Y<!Lp1/Y;{0}*83;>;" });
    }
    ...
    public void test066() throws CoreException {
        ...
        try {
            ...
            primaryWorkingCopy.becomeWorkingCopy(/*no progress*/
            null);
            ...
            ownedWorkingcopy = getWorkingCopy("/P/p1/X.java", "package p1;\n" + "public class X {\n" + "  void foo() {}\n" + "}", this.owner);
            // create bindings
            assertRequestedBindingFound(new String[] { "/P/p1/Y.java", "package p1;\n" + "public class Y {\n" + "  void bar() {\n" + "    /*start*/new X().foo()/*end*/;\n" + "}" }, "Lp1/X;.foo()V");
        } finally {
    ...
    public void test067() throws CoreException {
        ...
        assertBindingEquals("Lp1/X<>;", bindings.length == 0 ? null : bindings[0].getDeclaringClass());
    }
    ...
    public void test071() throws CoreException {
        final MarkerInfo[] markerInfos = createMarkerInfos(new String[] { "/P/p1/X.java", "package p1;\n" + "public class X extends /*start*/Y/*end*/ {\n" + "}", "/P/p1/Y.java", "package p1;\n" + "public class Y {\n" + "  static final int CONST = 2 + 3;\n" + "}" });
        this.workingCopies = createWorkingCopies(markerInfos, this.owner);
        class Requestor extends TestASTRequestor {
    ...
    public void test072() throws CoreException {
        IVariableBinding[] bindings = createVariableBindings(new String[] { "/P/X.java", "public class X {\n" + "    void m() {\n" + "        Object o;\n" + "    }\n" + "}" }, new String[] { "LX;.m()V#o" });
        assertBindingEquals("LX;.m()V", bindings[0].getDeclaringMethod());
    }
    ...
    public void test073() throws CoreException, IOException {
        try {
            ...
            compilationUnits[0] = getWorkingCopy("P072/X.java", "public class X {\n" + "  @Override" + "  public boolean equals(Object o) {\n" + "    return true;\n" + "  }\n" + "}");
            compilationUnits[1] = getWorkingCopy("P072/Y.java", "public class Y extends X {\n" + "}");
            compilationUnits[2] = getWorkingCopy("P072/Z.java", "public class Z {\n" + "  Y m;\n" + "  boolean foo(Object p) {\n" + "    return this.m.equals(p);\n" + "  }\n" + "}");
            ASTParser parser = ASTParser.newParser(JLS3_INTERNAL);
 ...
 */
    public void test077_Bug163647() throws CoreException {
        ...
        this.workingCopies = createWorkingCopies(new String[] { "/P/Test.java", content }, true);
        ASTNode node = buildAST(content, this.workingCopies[0]);
        assertEquals("Invalid node type!", ASTNode.METHOD_INVOCATION, node.getNodeType());
        IBinding binding = resolveBinding(node);
        BindingKey bindingKey = new BindingKey(binding.getKey());
    ...
    public void test080() throws CoreException, IOException {
        ...
        try {
            ...
            createFile("/" + projectName + "/src/test/Test.java", "package test;\n" + "import java.util.*;\n" + "public class Test {\n" + "        public interface ExtraIterator<T> extends Iterator {\n" + "                public void extra();\n" + "        }\n" + "        public class Test2<T> implements ExtraIterator<T> {\n" + "            public boolean hasNext() {\n" + "                return false;\n" + "            }\n" + "            public T next() {\n" + "                return null;\n" + "            }\n" + "            public void remove() {\n" + "            }\n" + "            public void extra() {\n" + "            }\n" + "        }\n" + "}");
            ICompilationUnit compilationUnits[] = new ICompilationUnit[1];
