...
public class GetSourceTests extends ModifyingResourceTests {
    ...
    public void testJavadocRange02() throws CoreException {
        try {
            ...
            createFile("/P/p/A.java", cuSource);
            IType type = getCompilationUnit("/P/p/A.java").getType("A");
            assertSourceEquals("Unexpected Javadoc'", "/** X */", getSource(cuSource, type.getJavadocRange()));
        } finally {
            deleteFile("/P/p/A.java");
        }
    }
    ...
    public void testLocalVariable3() throws JavaModelException {
        ...
        String actualSource = ((ISourceReference) var).getSource();
        // semi-colon is not part of the local declaration in a for statement
	 ...
	 */
    public // was testAnnotationNameRange1
    void testNameRange01() throws // was testAnnotationNameRange1
    CoreException {
        try {
            String cuSource = "package p;\n" + "@ MyAnnot (1)\n" + "public class Y {\n" + "}";
            createFile("/P/p/Y.java", cuSource);
            IAnnotation annotation = getCompilationUnit("/P/p/Y.java").getType("Y").getAnnotation("MyAnnot");
            assertSourceEquals("Unexpected source'", "MyAnnot", getNameSource(cuSource, annotation));
        } finally {
	 ...
	 * Ensures that the name range for an annotation is correct.
	 */
    public // was testAnnotationNameRange2
    void testNameRange02() throws // was testAnnotationNameRange2
    CoreException {
        try {
            String cuSource = "package p;\n" + "@x.  y  .  z.MyAnnot (1)\n" + "public class Y {\n" + "}";
            createFile("/P/p/Y.java", cuSource);
            IAnnotation annotation = getCompilationUnit("/P/p/Y.java").getType("Y").getAnnotation("x.y.z.MyAnnot");
            assertSourceEquals("Unexpected source'", "x.  y  .  z.MyAnnot", getNameSource(cuSource, annotation));
        } finally {
            deleteFile("/P/p/Y.java");
        }
    }
	 ...
	 */
    public // was testAnnotationNameRange3
    void testNameRange03() throws // was testAnnotationNameRange3
    CoreException {
        try {
            String cuSource = "package p;\n" + "public class Y {\n" + "  void foo() {\n" + "    @MyAnnot int local;\n" + "  }\n" + "}";
            createFile("/P/p/Y.java", cuSource);
	 ...
	 */
    public // was testNameRangeAnonymous
    void testNameRange04() throws // was testNameRangeAnonymous
    CoreException {
        try {
            String cuSource = "package p;\n" + "public class Y {\n" + "  void foo() {\n" + "    Y y = new Y() {};\n" + "    class C {\n" + "    }\n" + "  }\n" + "}";
            createFile("/P/p/Y.java", cuSource);
	 ...
	 */
    public // was testNameRangeTypeParameter1
    void testNameRange05() throws // was testNameRangeTypeParameter1
    CoreException {
        try {
            String cuSource = "package p;\n" + "public class Y<T extends String> {\n" + "}";
            createFile("/P/p/Y.java", cuSource);
            ITypeParameter typeParameter = getCompilationUnit("/P/p/Y.java").getType("Y").getTypeParameter("T");
            assertSourceEquals("Unexpected source'", "T", getNameSource(cuSource, typeParameter));
        } finally {
            deleteFile("/P/p/Y.java");
        }
    }
	 ...
	 * Ensures the name range for a type parameter is correct.
	 */
    public // was testNameRangeTypeParameter2
    void testNameRange06() throws // was testNameRangeTypeParameter2
    CoreException {
        try {
            ...
            assertSourceEquals("Unexpected source'", "U", getNameSource(cuSource, typeParameter));
        } finally {
            deleteFile("/P/p/Y.java");
        }
    }
	 ...
	 */
    public // was testNameRangeMethodWithSyntaxError
    void testNameRange07() throws // was testNameRangeMethodWithSyntaxError
    CoreException {
        try {
            String cuSource = "package p;\n" + "public class Y {\n" + "  void foo() {\n" + "  }\n" + "  void static bar() {}\n" + "}";
            createFile("/P/p/Y.java", cuSource);
	 ...
	 */
    public // was testNameRangeAnonymous
    void testNameRange09() throws // was testNameRangeAnonymous
    CoreException {
        try {
            String cuSource = "package p . q . r. s ;\n" + "public class Y {\n" + "  void foo() {\n" + "    Y y = new Y() {};\n" + "    class C {\n" + "    }\n" + "  }\n" + "}";
	 ...
	 */
    public // was testNameRangeAnonymous
    void testNameRange10() throws // was testNameRangeAnonymous
    CoreException {
        try {
            String cuSource = "import java . lang . * ;\n" + "public class Y {\n" + "}";
	 ...
	 */
    public // was testNameRangeAnonymous
    void testNameRange11() throws // was testNameRangeAnonymous
    CoreException {
        try {
            String cuSource = "import java . lang  .  Object  ;\n" + "public class Y {\n" + "}";
            createFile("/P/Y.java", cuSource);
            final IImportDeclaration[] imports = getCompilationUnit("/P/Y.java").getImports();
            assertEquals("Wrong size", 1, imports.length);
            String actualSource = getNameSource(cuSource, imports[0]);
	 ...
	 * (regression test for https://bugs.eclipse.org/bugs/show_bug.cgi?id=209823)
	 */
    public // was testAnnotationSourceRange
    void testSourceRange01() throws // was testAnnotationSourceRange
    CoreException {
        try {
            String cuSource = "package p;\n" + "public class Y {\n" + "  void foo() {\n" + "    @MyAnnot int local;\n" + "  }\n" + "}";
            createFile("/P/p/Y.java", cuSource);
            IAnnotation annotation = getLocalVariable(getCompilationUnit("/P/p/Y.java"), "local", "local").getAnnotation("MyAnnot");
            assertSourceEquals("Unexpected source'", "@MyAnnot", getSource(cuSource, annotation.getSourceRange()));
        } finally {
            deleteFile("/P/p/Y.java");
        }
    }
	 ...
	 */
    public // was testAnonymousSourceRange
    void testSourceRange02() throws // was testAnonymousSourceRange
    CoreException {
        try {
            String cuSource = "package p;\n" + "public class Y {\n" + "  void foo() {\n" + "    new Object() {};\n" + "  }\n" + "}";
            createFile("/P/p/Y.java", cuSource);
            IType type = getCompilationUnit("/P/p/Y.java").getType("Y").getMethod("foo", new String[0]).getType("", 1);
            assertSourceEquals("Unexpected source'", "new Object() {}", getSource(cuSource, type.getSourceRange()));
        } finally {
            deleteFile("/P/p/Y.java");
        }
    }
    ...
    public void testSourceRange03() throws CoreException {
        try {
            ...
            createFile("/P15/X.java", cuSource);
            IType type = getCompilationUnit("/P15/X.java").getType("X").getField("GREEN").getType("", 1);
            assertSourceEquals("Unexpected source'", "GREEN() {}", getSource(cuSource, type.getSourceRange()));
        } finally {
            deleteProject("P15");
        }
    }
    ...
    public void testTypeParameter1() throws CoreException {
        try {
            ...
            createFile("/P/p/Y.java", cuSource);
            ITypeParameter typeParameter = getCompilationUnit("/P/p/Y.java").getType("Y").getTypeParameter("T");
            assertSourceEquals("Unexpected source'", "T extends String", typeParameter.getSource());
        } finally {
            deleteFile("/P/p/Y.java");
        }
    }
    ...
    public void testTypeParameter2() throws CoreException {
        try {
            ...
            createFile("/P/p/Y.java", cuSource);
            ITypeParameter typeParameter = getCompilationUnit("/P/p/Y.java").getType("Y").getMethod("foo", new String[0]).getTypeParameter("U");
            assertSourceEquals("Unexpected source'", "U extends StringBuffer & Runnable", typeParameter.getSource());
        } finally {
            deleteFile("/P/p/Y.java");
        }
    }
