 ...
 */
    ...
    protected void assertCompletionNodeResult(String source, String expected) {
        ...
        assertEquals("Completion node is not correct!", expected, actual);
    }
    ...
    protected void verifyAllTagsCompletion() {
        char[][] allTags = { // Block tags
        TAG_AUTHOR, TAG_DEPRECATED, TAG_EXCEPTION, TAG_PARAM, TAG_RETURN, TAG_SEE, TAG_VERSION, TAG_CATEGORY, TAG_SINCE, TAG_SERIAL, TAG_SERIAL_DATA, TAG_SERIAL_FIELD, TAG_THROWS, // Inline tags
        TAG_LINK, TAG_DOC_ROOT };
        char[][] additionalTags = null;
        if (this.complianceLevel == ClassFileConstants.JDK1_4) {
            additionalTags = new char[][] { TAG_INHERITDOC, TAG_LINKPLAIN, TAG_VALUE };
        } else if (this.complianceLevel > ClassFileConstants.JDK1_4) {
            additionalTags = new char[][] { TAG_INHERITDOC, TAG_LINKPLAIN, TAG_VALUE, TAG_CODE, TAG_LITERAL };
        }
 ...
 */
    ...
    public void test003() {
        ...
        char[][] allTags = this.complianceLevel == ClassFileConstants.JDK1_3 ? new char[][] { TAG_VERSION } : new char[][] { TAG_VERSION, TAG_VALUE };
    ...
    public void test005() {
        ...
        char[][] allTags = this.complianceLevel == ClassFileConstants.JDK1_3 ? new char[][] { TAG_LINK } : new char[][] { TAG_LINK, TAG_LINKPLAIN };
    ...
    public void test006() {
        ...
        verifyCompletionInJavadoc(source, "@");
        char[][] allTags = { TAG_LINK, TAG_DOC_ROOT };
        char[][] additionalTags = null;
        if (this.complianceLevel == ClassFileConstants.JDK1_4) {
            additionalTags = new char[][] { TAG_INHERITDOC, TAG_LINKPLAIN, TAG_VALUE };
        } else if (this.complianceLevel > ClassFileConstants.JDK1_4) {
 ...
 */
    public void test010() {
        ...
        assertCompletionNodeResult(source, "<CompletionOnJavadocSingleTypeReference:\n" + "	infos:formal reference\n" + ">");
    }
    ...
    public void test012() {
        ...
        assertCompletionNodeResult(source, "<CompletionOnJavadocSingleTypeReference:Str\n" + "	infos:formal reference\n" + ">");
    }
    ...
    public void test014() {
        ...
        assertCompletionNodeResult(source, "<CompletionOnJavadocSingleTypeReference:Obj\n" + "	infos:text\n" + ">");
    }
 ...
 */
    ...
    public void test026() {
        ...
        char[][] allTags = this.complianceLevel == ClassFileConstants.JDK1_3 ? new char[][] { TAG_LINK } : (this.complianceLevel == ClassFileConstants.JDK1_4 ? new char[][] { TAG_LINK, TAG_LINKPLAIN } : new char[][] { TAG_LINK, TAG_LINKPLAIN, TAG_LITERAL });
