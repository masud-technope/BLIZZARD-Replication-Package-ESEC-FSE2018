...
Serializable {
    ...
    public enum ExampleEnum implements //
    Runnable, //
    Serializable {
    ...
    public void function1(Object param1, //
    Object param2, Object param3, Object param4) throws Exc1, Ex2, Ex3 {
        List<String> strings = //
        Arrays.asList(//
        "aaa", //
        "bbb", //
        ...
        this.getWriter().println("aaaaa" + "bbbbbb" + "ccc");
    }
}
