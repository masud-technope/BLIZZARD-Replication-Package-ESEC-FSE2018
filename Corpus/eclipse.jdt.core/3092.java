...
public class ImportDeclaration extends ASTNode {
    ...
    new ChildPropertyDescriptor(ImportDeclaration.class, "name", Name.class, MANDATORY, NO_CYCLE_RISK);

    /**
	 * The "onDemand" structural property of this node type (type: {@link Boolean}).
	 * @since 3.0
	 */
    public static final SimplePropertyDescriptor ON_DEMAND_PROPERTY = //$NON-NLS-1$
    new SimplePropertyDescriptor(ImportDeclaration.class, "onDemand", boolean.class, MANDATORY);

    /**
	 * The "static" structural property of this node type (type: {@link Boolean}) (added in JLS3 API).
	 * @since 3.1
	 */
    public static final SimplePropertyDescriptor STATIC_PROPERTY = //$NON-NLS-1$
    new SimplePropertyDescriptor(ImportDeclaration.class, "static", boolean.class, MANDATORY);
