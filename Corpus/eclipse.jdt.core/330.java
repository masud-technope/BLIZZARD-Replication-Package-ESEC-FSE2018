...
public class ClassDeclarationImpl extends TypeDeclarationImpl implements ClassDeclaration, ClassType {
    ...
    private void getASTConstructor(final AbstractTypeDeclaration typeDecl, final List<ConstructorDeclaration> results) {
            ...
            if (bodyDecl.getNodeType() == ASTNode.METHOD_DECLARATION) {
                ...
                if (methodDecl.isConstructor()) {
                    ...
                    if (methodBinding == null) {
                        if (file == null)
                            file = getResource();
                        ConstructorDeclaration mirrorDecl = (ConstructorDeclaration) Factory.createDeclaration(methodDecl, file, _env);
                        if (mirrorDecl != null)
    ...
    public ClassType getSuperclass() {
        ...
        if (superClass == null)
            ...
            // catch error case where user extends some interface instead of a class.
