...
public class ASTBasedFieldDeclarationImpl extends ASTBasedMemberDeclarationImpl implements FieldDeclaration {
    ...
    public  ASTBasedFieldDeclarationImpl(final VariableDeclarationFragment astNode, final IFile file, final BaseProcessorEnv env) {
        super(astNode, file, env);
        assert astNode.getParent() != null && astNode.getParent().getNodeType() == ASTNode.FIELD_DECLARATION : //$NON-NLS-1$
        "parent isn't a field declaration";
    }
