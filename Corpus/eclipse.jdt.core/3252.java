...
public abstract class Constant implements TypeIds, OperatorIds {
    ...
    public boolean booleanValue() {
        //$NON-NLS-1$ //$NON-NLS-2$
        throw new ShouldNotImplement(Util.bind("constant.cannotCastedInto", typeName(), "boolean"));
    }

    public byte byteValue() {
        //$NON-NLS-1$ //$NON-NLS-2$
        throw new ShouldNotImplement(Util.bind("constant.cannotCastedInto", typeName(), "byte"));
    }
    ...
    public char charValue() {
        //$NON-NLS-1$ //$NON-NLS-2$
        throw new ShouldNotImplement(Util.bind("constant.cannotCastedInto", typeName(), "char"));
    }
    ...
    public static final Constant computeConstantOperation(Constant cst, int id, int operator) {
        switch(operator) {
            ...
            case PLUS:
                return cst;
            case //the two special -9223372036854775808L and -2147483648 are inlined at parseTime
            MINUS:
                switch(id) {
                    case T_float:
                        float f;
    ...
    public static final Constant computeConstantOperation(Constant left, int leftId, int operator, Constant right, int rightId) {
        switch(operator) {
            ...
            case GREATER_EQUAL:
                return computeConstantOperationGREATER_EQUAL(left, leftId, operator, right, rightId);
            case LEFT_SHIFT:
                return computeConstantOperationLEFT_SHIFT(left, leftId, operator, right, rightId);
            case LESS:
                return computeConstantOperationLESS(left, leftId, operator, right, rightId);
            case LESS_EQUAL:
                return computeConstantOperationLESS_EQUAL(left, leftId, operator, right, rightId);
            case MINUS:
            ...
            case REMAINDER:
                return computeConstantOperationREMAINDER(left, leftId, operator, right, rightId);
            case RIGHT_SHIFT:
                return computeConstantOperationRIGHT_SHIFT(left, leftId, operator, right, rightId);
            case UNSIGNED_RIGHT_SHIFT:
                return computeConstantOperationUNSIGNED_RIGHT_SHIFT(left, leftId, operator, right, rightId);
            case XOR:
    ...
    public double doubleValue() {
        //$NON-NLS-2$ //$NON-NLS-1$
        throw new ShouldNotImplement(Util.bind("constant.cannotCastedInto", typeName(), "double"));
    }

    public float floatValue() {
        //$NON-NLS-2$ //$NON-NLS-1$
        throw new ShouldNotImplement(Util.bind("constant.cannotCastedInto", typeName(), "float"));
    }
    ...
    public int intValue() {
        //$NON-NLS-2$ //$NON-NLS-1$
        throw new ShouldNotImplement(Util.bind("constant.cannotCastedInto", typeName(), "int"));
    }

    public long longValue() {
        //$NON-NLS-2$ //$NON-NLS-1$
        throw new ShouldNotImplement(Util.bind("constant.cannotCastedInto", typeName(), "long"));
    }

    public short shortValue() {
        //$NON-NLS-2$ //$NON-NLS-1$
        throw new ShouldNotImplement(Util.bind("constant.cannotConvertedTo", typeName(), "short"));
    }

    public String stringValue() {
        //$NON-NLS-1$ //$NON-NLS-2$
        throw new ShouldNotImplement(Util.bind("constant.cannotConvertedTo", typeName(), "String"));
    }
