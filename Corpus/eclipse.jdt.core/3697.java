...
public class AbstractMethodTests extends BuilderTests {
    ...
    public void test001() throws JavaModelException {
        ...
        "}\n");
        IPath classX = //$NON-NLS-1$ //$NON-NLS-2$
        env.addClass(//$NON-NLS-1$ //$NON-NLS-2$
        root1, //$NON-NLS-1$ //$NON-NLS-2$
        ...
        IPath classY = //$NON-NLS-1$ //$NON-NLS-2$
        env.addClass(//$NON-NLS-1$ //$NON-NLS-2$
    ...
    public void test002() throws JavaModelException {
        ...
        IPath project1Path = env.addProject("Project1");
        env.addExternalJars(project1Path, Util.getJavaClassLibs());
        // need default abstract method
        env.getJavaProject(project1Path).setOption(JavaCore.COMPILER_CODEGEN_TARGET_PLATFORM, JavaCore.VERSION_1_1);
        // remove old package fragment root so that names don't collide
        //$NON-NLS-1$
        env.removePackageFragmentRoot(project1Path, "");
        //$NON-NLS-1$
