...
public class ParameterizedFieldBinding extends FieldBinding {
    ...
    public  ParameterizedFieldBinding(ParameterizedTypeBinding parameterizedDeclaringClass, FieldBinding originalField) {
        super(originalField.name, (originalField.modifiers & ClassFileConstants.AccEnum) != 0 ? // enum constant get paramType as its type
        parameterizedDeclaringClass : (originalField.modifiers & ClassFileConstants.AccStatic) != 0 ? // no subst for static field
        originalField.type : Scope.substitute(parameterizedDeclaringClass, originalField.type), originalField.modifiers, parameterizedDeclaringClass, null);
