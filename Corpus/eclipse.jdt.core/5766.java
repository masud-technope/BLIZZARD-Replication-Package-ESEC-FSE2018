...
public class ASTRewriteFlattener extends ASTVisitor {
    ...
    public boolean visit(IntersectionType node) {
        //$NON-NLS-1$
        visitList(node, IntersectionType.TYPES_PROPERTY, " & ", Util.EMPTY_STRING, Util.EMPTY_STRING);
        return false;
    }
    ...
    public boolean visit(MethodDeclaration node) {
        ...
        ChildListPropertyDescriptor exceptionsProperty = node.getAST().apiLevel() < AST.JLS8 ? INTERNAL_METHOD_THROWN_EXCEPTIONS_PROPERTY : MethodDeclaration.THROWN_EXCEPTION_TYPES_PROPERTY;
        //$NON-NLS-1$			
        visitList(node, exceptionsProperty, String.valueOf(','), " throws ", Util.EMPTY_STRING);
    ...
    public boolean visit(UnionType node) {
        //$NON-NLS-1$
        visitList(node, UnionType.TYPES_PROPERTY, " | ", Util.EMPTY_STRING, Util.EMPTY_STRING);
        return false;
    }
    ...
    public boolean visit(MethodRef node) {
        ...
        this.result.append('(');
        //$NON-NLS-1$
        visitList(node, MethodRef.PARAMETERS_PROPERTY, ",");
        this.result.append(')');
        return false;
    }
    ...
    public boolean visit(EnumDeclaration node) {
        ...
        this.result.append(' ');
        //$NON-NLS-1$
        visitList(node, EnumDeclaration.SUPER_INTERFACE_TYPES_PROPERTY, String.valueOf(','), "implements ", Util.EMPTY_STRING);
        this.result.append('{');
    ...
    public boolean visit(NormalAnnotation node) {
        ...
        this.result.append('(');
        //$NON-NLS-1$
        visitList(node, NormalAnnotation.VALUES_PROPERTY, ", ");
        this.result.append(')');
        return false;
    }
    ...
    public boolean visit(ParameterizedType node) {
        ...
        this.result.append('<');
        //$NON-NLS-1$
        visitList(node, ParameterizedType.TYPE_ARGUMENTS_PROPERTY, ", ");
        this.result.append('>');
        return false;
    }
    ...
    public boolean visit(TypeParameter node) {
        ...
        //$NON-NLS-1$ //$NON-NLS-2$
        visitList(node, TypeParameter.TYPE_BOUNDS_PROPERTY, " & ", " extends ", Util.EMPTY_STRING);
        return false;
    }
