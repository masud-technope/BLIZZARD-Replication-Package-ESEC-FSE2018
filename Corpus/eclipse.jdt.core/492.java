 ...
 */
    private void setUpBracesPreferences(String braces) {
        if (braces != null) {
            assertTrue("Invalid value for braces preferences: " + braces, braces.equals(DefaultCodeFormatterConstants.END_OF_LINE) || braces.equals(DefaultCodeFormatterConstants.NEXT_LINE) || braces.equals(DefaultCodeFormatterConstants.NEXT_LINE_ON_WRAP) || braces.equals(DefaultCodeFormatterConstants.NEXT_LINE_SHIFTED));
 ...
 */
    ...
    public void testBug027079c2() throws JavaModelException {
        ...
        this.formatterPrefs.disabling_tag = "disable-formatter".toCharArray();
        this.formatterPrefs.enabling_tag = "enable-formatter".toCharArray();
        String source = "public class X03b {\n" + "void foo() {\n" + "	bar(\n" + "// disable-formatter\n" + "				/**       unformatted		comment  	  */\n" + "				\"this\"  ,\n" + "					\"is\",\n" + "			\"a specific\",\n" + "		\"line wrapping \"\n" + "// enable-formatter\n" + "	);\n" + "	bar(\n" + "				/**       formatted		comment  	  */\n" + "				\"this\"  ,\n" + "					\"is\",\n" + "			\"a specific\",\n" + "		\"line wrapping \"\n" + "	);\n" + "}\n" + "void bar(String... str) {}\n" + "}\n";
    ...
    public void testBug027079d() throws JavaModelException {
        ...
        this.formatterPrefs.disabling_tag = "disable-formatter".toCharArray();
        this.formatterPrefs.enabling_tag = "enable-formatter".toCharArray();
        String source = "public class X04 {\n" + "\n" + "/* disable-formatter */\n" + "void     foo(    )      {	\n" + "				//      unformatted       comment  	  \n" + "}\n" + "/* enable-formatter */\n" + "void     bar(    )      {	\n" + "				//      formatted       comment  	  \n" + "}\n" + "}\n";
        formatSource(source, "public class X04 {\n" + "\n" + "/* disable-formatter */\n" + "void     foo(    )      {	\n" + "				//      unformatted       comment  	  \n" + "}\n" + "/* enable-formatter */\n" + "	void bar() {\n" + "		// formatted comment\n" + "	}\n" + "}\n", CodeFormatter.K_COMPILATION_UNIT | CodeFormatter.F_INCLUDE_COMMENTS, /* indentation level */
        0, /* offset */
        0, /* length (all) */
        -1, "\n", /*repeat*/
        true);
    ...
    public void testBug027079d2() throws JavaModelException {
        ...
        this.formatterPrefs.disabling_tag = "disable-formatter".toCharArray();
        this.formatterPrefs.enabling_tag = "enable-formatter".toCharArray();
        String source = "public class X04b {\n" + "\n" + "/* disable-formatter */\n" + "void     foo(    )      {	\n" + "				//      unformatted       comment  	  \n" + "}\n" + "/* enable-formatter */\n" + "void     bar(    )      {	\n" + "				//      formatted       comment  	  \n" + "}\n" + "}\n";
    ...
    public void testBug027079d3() throws JavaModelException {
        ...
        this.formatterPrefs.disabling_tag = "disable-formatter".toCharArray();
        this.formatterPrefs.enabling_tag = "enable-formatter".toCharArray();
        String source = "public class X04c {\n" + "\n" + "/* disable-formatter */\n" + "void     foo(    )      {	\n" + "				//      unformatted       comment  	  \n" + "}\n" + "/* enable-formatter */\n" + "void     bar(    )      {	\n" + "				//      formatted       comment  	  \n" + "}\n" + "}\n";
    ...
    public void testBug027079d4() throws JavaModelException {
        ...
        this.formatterPrefs.disabling_tag = "disable-formatter".toCharArray();
        this.formatterPrefs.enabling_tag = "enable-formatter".toCharArray();
        String source = "public class X04d {\n" + "\n" + "/* disable-formatter */\n" + "void     foo(    )      {	\n" + "				//      unformatted       comment  	  \n" + "}\n" + "/* enable-formatter */\n" + "void     bar(    )      {	\n" + "				//      formatted       comment  	  \n" + "}\n" + "}\n";
        formatSource(source, "public class X04d {\n" + "\n" + "/* disable-formatter */\n" + "void     foo(    )      {	\n" + "				//      unformatted       comment  	  \n" + "}\n" + "/* enable-formatter */\n" + "	void bar() {\n" + "		// formatted comment\n" + "	}\n" + "}\n", CodeFormatter.K_COMPILATION_UNIT | CodeFormatter.F_INCLUDE_COMMENTS, /* indentation level */
        0, /* offset */
        0, /* length (all) */
        -1, "\n", /*repeat*/
        true);
    ...
    public void testBug027079e() throws JavaModelException {
        ...
        String source = "public class X05 {\n" + "\n" + "/* format: off */\n" + "void     foo(    )      {	\n" + "				//      unformatted       comment\n" + "}\n" + "/* format: on */\n" + "void     bar(    )      {	\n" + "				//      formatted       comment\n" + "}\n" + "}\n";
    ...
    public void testBug027079f() throws JavaModelException {
        ...
        this.formatterPrefs.disabling_tag = "format: off".toCharArray();
        this.formatterPrefs.enabling_tag = "format: on".toCharArray();
        String source = "public class X06 {\n" + "\n" + "// format: off\n" + "void     foo(    )      {	\n" + "				//      unformatted       comment\n" + "}\n" + "// format: on\n" + "void     bar(    )      {	\n" + "				//      formatted       comment\n" + "}\n" + "}\n";
    ...
    public void testBug027079f2() throws JavaModelException {
        ...
        this.formatterPrefs.disabling_tag = "format: off".toCharArray();
        this.formatterPrefs.enabling_tag = "format: on".toCharArray();
        String source = "public class X06b {\n" + "\n" + "/** format: off */\n" + "void     foo(    )      {	\n" + "				//      unformatted       comment\n" + "}\n" + "/** format: on */\n" + "void     bar(    )      {	\n" + "				//      formatted       comment\n" + "}\n" + "}\n";
        formatSource(source, "public class X06b {\n" + "\n" + "/** format: off */\n" + "void     foo(    )      {	\n" + "				//      unformatted       comment\n" + "}\n" + "/** format: on */\n" + "	void bar() {\n" + "		// formatted comment\n" + "	}\n" + "}\n");
    }
    ...
    public void testBug027079f3() throws JavaModelException {
        ...
        this.formatterPrefs.disabling_tag = "    format:  	  off    ".toCharArray();
        this.formatterPrefs.enabling_tag = "	format:	  	on	".toCharArray();
        String source = "public class X06c {\n" + "\n" + "/*    format:  	  off    */\n" + "void     foo(    )      {	\n" + "				//      unformatted       comment\n" + "}\n" + "// 	format:	  	on	\n" + "void     bar(    )      {	\n" + "				//      formatted       comment\n" + "}\n" + "}\n";
        formatSource(source, "public class X06c {\n" + "\n" + "/*    format:  	  off    */\n" + "void     foo(    )      {	\n" + "				//      unformatted       comment\n" + "}\n" + "// 	format:	  	on	\n" + "	void bar() {\n" + "		// formatted comment\n" + "	}\n" + "}\n");
    }
    ...
    public void testBug027079f4() throws JavaModelException {
        ...
        this.formatterPrefs.disabling_tag = "    format:  	  off    ".toCharArray();
        this.formatterPrefs.enabling_tag = "	format:	  	on	".toCharArray();
        String source = "public class X06d {\n" + "\n" + "/* format: off */\n" + "void     foo(    )      {	\n" + "				//      formatted       comment\n" + "}\n" + "/* format: on */\n" + "void     bar(    )      {	\n" + "				//      formatted       comment\n" + "}\n" + "}\n";
        formatSource(source, "public class X06d {\n" + "\n" + "	/* format: off */\n" + "	void foo() {\n" + "		// formatted comment\n" + "	}\n" + "\n" + "	/* format: on */\n" + "	void bar() {\n" + "		// formatted comment\n" + "	}\n" + "}\n");
    }
 ...
 */
    ...
    public void testBug059891_01b() throws JavaModelException {
        ...
        this.formatterOptions.put(DefaultCodeFormatterConstants.FORMATTER_ALIGNMENT_FOR_ARGUMENTS_IN_METHOD_INVOCATION, DefaultCodeFormatterConstants.createAlignmentValue(false, DefaultCodeFormatterConstants.WRAP_COMPACT, DefaultCodeFormatterConstants.INDENT_ON_COLUMN));
        String source = "public class X01 {\n" + "	void test() {\n" + "		foo(bar(1, 2, 3, 4), bar(5, 6, 7, 8));\n" + "	}\n" + "}\n";
        formatSource(source, "public class X01 {\n" + "	void test() {\n" + "		foo(bar(1, 2, 3, 4),\n" + "			bar(5, 6, 7, 8));\n" + "	}\n" + "}\n");
    }
    ...
    public void testBug059891_164093_01() throws JavaModelException {
        ...
        this.formatterOptions.put(DefaultCodeFormatterConstants.FORMATTER_ALIGNMENT_FOR_PARAMETERS_IN_METHOD_DECLARATION, DefaultCodeFormatterConstants.createAlignmentValue(false, DefaultCodeFormatterConstants.WRAP_COMPACT, DefaultCodeFormatterConstants.INDENT_ON_COLUMN));
    ...
    public void testBug059891_164093_02() throws JavaModelException {
        ...
        this.formatterOptions.put(DefaultCodeFormatterConstants.FORMATTER_ALIGNMENT_FOR_SELECTOR_IN_METHOD_INVOCATION, DefaultCodeFormatterConstants.createAlignmentValue(false, DefaultCodeFormatterConstants.WRAP_COMPACT, DefaultCodeFormatterConstants.INDENT_ON_COLUMN));
 ...
 */
    ...
    public void testBug199265d1() throws JavaModelException {
        String source = "import java.util.Set; // trailing comment\n" + "// line comment\n" + "import java.util.Map; // trailing comment\n" + "// line comment\n" + "public class X04 {\n" + "\n" + "}\n";
 ...
 */
    public void testBug281655() throws JavaModelException {
        ...
        String source = "@MessageDriven(mappedName = \"filiality/SchedulerMQService\", \n" + "        activationConfig = { \n" + "            @ActivationConfigProperty(propertyName = \"cronTrigger\",\n" + "propertyValue = \"0/10 * * * * ?\") \n" + "        })\n" + "@RunAs(\"admin\")\n" + "@ResourceAdapter(\"quartz-ra.rar\")\n" + "@TransactionAttribute(TransactionAttributeType.NOT_SUPPORTED)\n" + "public class X {\n" + "}\n";
 ...
 */
    ...
    public void testBug282030a() throws JavaModelException {
        String source = "@MyAnnot(value1 = \"this is an example\", value2 = \"of an annotation\", value3 = \"with several arguments\", value4 = \"which may need to be wrapped\")\n" + "public class Test {\n" + "}\n";
    ...
    public void testBug282030g1() throws JavaModelException {
        this.formatterPrefs.alignment_for_arguments_in_annotation = Alignment.M_ONE_PER_LINE_SPLIT;
        String source = "@MyAnnot1(member1 = \"sample1\", member2 = \"sample2\")\n" + "public class X {\n" + "}\n";
    ...
    public void testBug282030h1() throws JavaModelException {
        this.formatterPrefs.alignment_for_arguments_in_annotation = Alignment.M_ONE_PER_LINE_SPLIT;
        setPageWidth80();
        String source = "@MyAnnot1(name = \"sample1\", \n" + "                value = { \n" + "                        @MyAnnot2(name = \"sample2\",\n" + "value = \"demo\") \n" + "                })\n" + "public class X {\n" + "}\n";
 ...
 */
    ...
    public void testBug264112_w24_S1() {
        ...
        String source = "class Sample1 {void foo() {Other.bar( 100,\n" + "200,\n" + "300,\n" + "400,\n" + "500,\n" + "600,\n" + "700,\n" + "800,\n" + "900 );}}\n";
        formatSource(source, "class Sample1 {\n" + "	void foo() {\n" + "		Other.bar(100,\n" + "				200,\n" + "				300,\n" + "				400,\n" + "				500,\n" + "				600,\n" + "				700,\n" + "				800,\n" + "				900);\n" + "	}\n" + "}\n");
    }

    public void testBug264112_w24_S2() {
        this.formatterPrefs.page_width = 24;
        String source = "class Sample2 {int foo(Some a) {return a.getFirst();}}\n";
 ...
 */
    public void testBug320754_00() throws JavaModelException {
        String source = "public class X00\n" + "{\n" + "    public static void main(String[] args)\n" + "    {\n" + "        int a=0;int b;\n" + "\n" + "        System.out.println(a);\n" + "\n" + "    }\n" + "}\n";
        formatSource(source, "public class X00 {\n" + "	public static void main(String[] args) {\n" + "		int a = 0;\n" + "		int b;\n" + "\n" + "		System.out.println(a);\n" + "\n" + "	}\n" + "}\n");
    }

    public void testBug320754_01a() throws JavaModelException {
        this.formatterPrefs.use_tags = true;
        String source = "//@formatter:off\n" + "//@formatter:on\n" + "public class X01a\n" + "{\n" + "    public static void main(String[] args)\n" + "    {\n" + "        int a=0;int b;\n" + "\n" + "        System.out.println(a);\n" + "\n" + "    }\n" + "}\n";
        formatSource(source, "//@formatter:off\n" + "//@formatter:on\n" + "public class X01a {\n" + "	public static void main(String[] args) {\n" + "		int a = 0;\n" + "		int b;\n" + "\n" + "		System.out.println(a);\n" + "\n" + "	}\n" + "}\n");
    }
 ...
 */
    public void testBug332877() throws Exception {
        String source = "public enum Environment {\n" + "    PROD,       // Production level environments\n" + "    STAGING    // Staging\n" + "}\n";
 ...
 */
    public void testBug437639() throws Exception {
        ...
        formatSource(source, "package com.test;\n" + "\n" + "import java.math.BigDecimal;\n" + "import java.math.BigInteger;\n" + "import java.util.ArrayList;\n" + "//import java.util.Arrays;\n" + "import java.util.Date;\n" + "import java.util.List;\n" + "\n" + "public class Test {\n" + "\n" + "	public static void main(String[] args) {\n" + "		BigDecimal big = new BigDecimal(1);\n" + "		BigInteger bigI = new BigInteger(\"1\");\n" + "		Date d = new Date();\n" + "		List list = new ArrayList<>();\n" + "	}\n" + "}\n");
    }
 ...
 */
    public void testBug462945() throws Exception {
        ...
        formatSource(source, "package p1;\n" + "\n" + "enum ReviewResult {\n" + "	Good{, Bad\n" + "}\n");
    }
 ...
 */
    public void testBug469438() {
        this.formatterPrefs.use_tags = true;
        String source = "public class C1 {\r\n" + "	int     b;\r\n" + "\r\n" + "	/** @formatter:off */\r\n" + "	private void  a() {\r\n" + "		// @formatter:on\r\n" + "		if ()\r\n" + "	}\r\n" + "}";
        formatSource(source, "public class C1 {\r\n" + "	int b;\r\n" + "\r\n" + "	/** @formatter:off */\r\n" + "	private void  a() {\r\n" + "		// @formatter:on\r\n" + "		if ()\r\n" + "	}\r\n" + "}");
    }
 ...
 */
    public void testBug470977() throws Exception {
        String source = "public class TestFormat {\r\n" + "	public static void main(String[] args) {\r\n" + "		assert \"\".length() == 0;\r\n" + "		assert (!false);\r\n" + "\r\n" + "		assert !false;\r\n" + "		assert +0 == 0;\r\n" + "		assert -0 == 0;\r\n" + "\r\n" + "		int i = 0;\r\n" + "		assert ++i == 1;\r\n" + "		assert --i == 0;\r\n" + "	}\r\n" + "}";
        formatSource(source);
    }
 ...
 */
    public void testBug472962() {
        String source = "public @interface A {\r\n" + "	String[] strings();\r\n" + "\r\n" + "	Class<String> stringClasses();\r\n" + "}";
        formatSource(source);
    }
 ...
 */
    public void testBug471780() {
        String source = "public enum MyEnum {\r\n" + "	/** A. */\r\n" + "	A,\r\n" + "	/** B. */\r\n" + "	B\r\n" + "}";
        formatSource(source);
    }
 ...
 */
    public void testBug467618() {
        ...
        String source = "public enum E2 {\r\n" + "\r\n" + "	FOOBAR,\r\n" + "\r\n" + "	FOOBARBAZ,\r\n" + "\r\n" + "	FOO;\r\n" + "}";
        formatSource(source, "public enum E2 {\r\n" + "\r\n" + "				FOOBAR,\r\n" + "\r\n" + "				FOOBARBAZ,\r\n" + "\r\n" + "				FOO;\r\n" + "}");
    }
 ...
 */
    public void testBug472815() {
        ...
        String source = "public class Snippet {\r\n" + "\r\n" + "	int[] a1 = { };\r\n" + "	int[] a2 = {\r\n" + "	};\r\n" + "	int[] a3 = {\r\n" + "\r\n" + "	};\r\n" + "	int[] a4 = {\r\n" + "\r\n" + "\r\n" + "	};\r\n" + "	int[] a5 = {\r\n" + "\r\n" + "\r\n" + "\r\n" + "	};\r\n" + "\r\n" + "	void f1() { }\r\n" + "	void f2() {\r\n" + "	}\r\n" + "	void f3() {\r\n" + "\r\n" + "	}\r\n" + "	void f4() {\r\n" + "\r\n" + "\r\n" + "	}\r\n" + "	void f5() {\r\n" + "\r\n" + "\r\n" + "\r\n" + "	}\r\n" + "}";
        formatSource(source, "public class Snippet {\r\n" + "\r\n" + "	int[] a1 = {};\r\n" + "	int[] a2 = {};\r\n" + "	int[] a3 = {\r\n" + "\r\n" + "	};\r\n" + "	int[] a4 = {\r\n" + "\r\n" + "\r\n" + "	};\r\n" + "	int[] a5 = {\r\n" + "\r\n" + "\r\n" + "	};\r\n" + "\r\n" + "	void f1() {\r\n" + "	}\r\n" + "\r\n" + "	void f2() {\r\n" + "	}\r\n" + "\r\n" + "	void f3() {\r\n" + "\r\n" + "	}\r\n" + "\r\n" + "	void f4() {\r\n" + "\r\n" + "\r\n" + "	}\r\n" + "\r\n" + "	void f5() {\r\n" + "\r\n" + "\r\n" + "	}\r\n" + "}");
    }
 ...
 */
    public void testBug475793() {
        ...
        formatSource(source, "public class C {\r\n" + "	public void f() {\r\n" + "		Foo.bar(() -> {}, IllegalArgumentException.class);\r\n" + "	}\r\n" + "}");
    }
 ...
 */
    public void testBug471202() {
        ...
        formatSource(source, "public @interface MyAnnotation {\r\n" + "	Attributes attributes() default @Attributes();\r\n" + "\r\n" + "	@MyAnnotation(attributes = @Attributes())\r\n" + "	String test();\r\n" + "}");
    }
 ...
 */
    public void testBug475791() {
        ...
        formatSource(source, "public class Example {\r\n" + "	static String staticField;\r\n" + "	static {\r\n" + "	}\r\n" + "	String field;\r\n" + "	{\r\n" + "	}\r\n" + "	static String staticField2;\r\n" + "	{\r\n" + "	}\r\n" + "	String field2;\r\n" + "	static {\r\n" + "	}\r\n" + "\r\n" + "	static void staticMethod() {\r\n" + "	};\r\n" + "	static {\r\n" + "	}\r\n" + "\r\n" + "	void method() {\r\n" + "	}\r\n" + "	static {\r\n" + "	}\r\n" + "	{\r\n" + "	}\r\n" + "\r\n" + "	static class staticClass {\r\n" + "	};\r\n" + "	{\r\n" + "	}\r\n" + "	static {\r\n" + "	}\r\n" + "}");
    }
 ...
 */
    public void testBug477430() {
        this.formatterPrefs.alignment_for_arguments_in_method_invocation = DefaultCodeFormatterOptions.Alignment.M_ONE_PER_LINE_SPLIT + DefaultCodeFormatterOptions.Alignment.M_FORCE;
 ...
 */
    public void testBug480735() {
        String source = "public enum Example implements Serializable, Cloneable {\r\n" + "}";
        formatSource(source);
    }
 ...
 */
    public void testBug479898() {
        ...
        String source = "public class FormattingTest {\r\n" + "	public void formatterTest() {\r\n" + "		try {\r\n" + "		} catch (final	InstantiationException | IllegalAccessException | IllegalArgumentException\r\n" + "						| NoSuchMethodException e) {\r\n" + "		}\r\n" + "	}\r\n" + "}";
        formatSource(source);
    }
 ...
 */
    public void testBug485276() {
        ...
        String source = "public class PostSaveListenerCleanUpExceptionTest {\r\n" + "	public Object[][] dataProvider() {\r\n" + "		return new Object[][] { { new String() // comment 1\r\n" + "				}, { new String() } };\r\n" + "	}\r\n" + "\r\n" + "	Object o = new Object() {\r\n" + "		public Object[][] dataProvider() {\r\n" + "			return new Object[][] { { new String() // comment 1\r\n" + "					}, { new String() } };\r\n" + "		}\r\n" + "	};\r\n" + "}";
        formatSource(source);
    }
