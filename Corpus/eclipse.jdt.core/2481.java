 ...
 */
    ...
    public void test003() throws JavaModelException {
        ...
        assertResults("version[JAVADOC_BLOCK_TAG]{@version, null, null, version, null, " + this.positions + JAVADOC_RELEVANCE + "}\n" + "value[JAVADOC_INLINE_TAG]{{@value}, null, null, value, null, " + this.positions + JAVADOC_RELEVANCE + "}");
    }
    ...
    public void test005() throws JavaModelException {
        ...
        assertResults("link[JAVADOC_INLINE_TAG]{{@link}, null, null, link, null, " + this.positions + JAVADOC_RELEVANCE + "}\n" + "linkplain[JAVADOC_INLINE_TAG]{{@linkplain}, null, null, linkplain, null, " + this.positions + JAVADOC_RELEVANCE + "}");
    }
 ...
 */
    ...
    public void test013() throws JavaModelException {
        ...
        completeInJavadoc("/Completion/src/javadoc/types/tags/BasicTestTypes.java", source, true, "BasicTest");
        assertResults("BasicTestTypes<TPARAM>[TYPE_REF]{BasicTestTypes, javadoc.types.tags, Ljavadoc.types.tags.BasicTestTypes<TTPARAM;>;, null, null, " + this.positions + R_DRICUNR + "}\n" + "BasicTestReferences[TYPE_REF]{org.eclipse.jdt.core.tests.BasicTestReferences, org.eclipse.jdt.core.tests, Lorg.eclipse.jdt.core.tests.BasicTestReferences;, null, null, " + this.positions + R_DRICNR + "}");
    }
    ...
    public void test014() throws JavaModelException {
        ...
        assertResults("BasicTestTypes[TYPE_REF]{BasicTestTypes, javadoc.types.tags, Ljavadoc.types.tags.BasicTestTypes;, null, null, " + this.positions + R_DRICNR + "}");
    }
    ...
    public void test015() throws JavaModelException {
        ...
        String source = "package javadoc.types.tags;\n" + "/**\n" + " * Completion after:\n" + " * 	@see javadoc.types.tags.BasicTest\n" + " * 		Note: JDT-UI failed on this one\n" + " */\n" + "public class BasicTestTypes<TPARAM> {\n" + "}\n";
        completeInJavadoc("/Completion/src/javadoc/types/tags/BasicTestTypes.java", source, true, "javadoc.types.tags.BasicTest");
        assertResults("BasicTestTypes<TPARAM>[TYPE_REF]{BasicTestTypes, javadoc.types.tags, Ljavadoc.types.tags.BasicTestTypes<TTPARAM;>;, null, null, " + this.positions + R_DRICNR + "}");
    }
    ...
    public void test016() throws JavaModelException {
        ...
        assertResults("java.lang[PACKAGE_REF]{java.lang, java.lang, null, null, null, " + this.positions + R_DRICQNR + "}");
    }
    ...
    public void test020() throws JavaModelException {
        ...
        assertSortedResults("Bin2[TYPE_REF]{pack.Bin2, pack, Lpack.Bin2;, null, null, " + this.positions + R_DRICENQNR + "}");
    }
    ...
    public void test021() throws JavaModelException {
        ...
        assertSortedResults("IllegalMonitorStateException[TYPE_REF]{IllegalMonitorStateException, java.lang, Ljava.lang.IllegalMonitorStateException;, null, null, " + this.positions + R_DRICUNR + "}\n" + "InterruptedException[TYPE_REF]{InterruptedException, java.lang, Ljava.lang.InterruptedException;, null, null, " + this.positions + R_DRICUNR + "}");
    }
    ...
    public void test026() throws JavaModelException {
        ...
        assertResults("Object[TYPE_REF]{Object, java.lang, Ljava.lang.Object;, null, null, " + this.positions + R_DRICNR + "}");
    }
 ...
 */
    public void test030() throws JavaModelException {
        ...
        assertResults("BasicTestTypes.BasicTestTypesMember[TYPE_REF]{BasicTestTypesMember, javadoc.types.tags, Ljavadoc.types.tags.BasicTestTypes$BasicTestTypesMember;, null, null, " + this.positions + R_DRICUNR + "}");
    }
    ...
    public void test032() throws JavaModelException {
        ...
        completeInJavadoc("/Completion/src/javadoc/types/tags/BasicTestTypes.java", source, true, "BasicTestTypesM");
        assertResults("BasicTestTypes.BasicTestTypesMember[TYPE_REF]{BasicTestTypesMember, javadoc.types.tags, Ljavadoc.types.tags.BasicTestTypes$BasicTestTypesMember;, null, null, " + this.positions + R_DRICNR + "}");
    }
    ...
    public void test034() throws JavaModelException {
        ...
        assertResults("BasicTestTypesSecondary[TYPE_REF]{BasicTestTypesSecondary, javadoc.types.tags, Ljavadoc.types.tags.BasicTestTypesSecondary;, null, null, " + this.positions + R_DRICUNR + "}");
    }
    ...
    public void test035() throws JavaModelException {
        ...
        assertResults("BasicTestTypesSecondary[TYPE_REF]{BasicTestTypesSecondary, javadoc.types.tags, Ljavadoc.types.tags.BasicTestTypesSecondary;, null, null, " + this.positions + R_DRICNR + "}");
    }
 ...
 */
    ...
    public void test041() throws JavaModelException {
        ...
        completeInJavadoc("/Completion/src/javadoc/types/tags/BasicTestTypes.java", source, true, "FIE");
        assertResults("FIELD[FIELD_REF]{FIELD, Lorg.eclipse.jdt.core.tests.BasicTestReferences;, I, FIELD, null, " + this.positions + R_DRICNR + "}");
    }
    ...
    public void test043() throws JavaModelException {
        ...
        assertResults("foo[FIELD_REF]{foo, Ljavadoc.types.tags.BasicTestTypes;, I, foo, null, " + this.positions + R_DRICNRNS + "}");
    }
    ...
    public void test045() throws JavaModelException {
        String[] sources = { "/Completion/src/javadoc/types/tags/BasicTestTypes.java", "package javadoc.types.tags;\n" + "/**\n" + " * Completion after:\n" + " * 	@see OtherTypes#fo\n" + " */\n" + "public class BasicTestTypes {\n" + "}", "/Completion/src/javadoc/types/tags/OtherTypes.java", "package javadoc.types.tags;\n" + "public class OtherTypes {\n" + "	int foo;\n" + "}" };
        completeInJavadoc(sources, true, "fo");
        assertResults("foo[FIELD_REF]{foo, Ljavadoc.types.tags.OtherTypes;, I, foo, null, " + this.positions + R_DRICNRNS + "}");
    }
 ...
 */
    ...
    public void test052() throws JavaModelException {
        ...
        assertResults("method[METHOD_REF]{method(), Ljavadoc.types.tags.OtherTypes;, ()V, method, null, " + this.positions + R_DRICNRNS + "}");
    }
 ...
 */
    public void test060() throws JavaModelException {
        ...
        String source = "package javadoc.types.tags;\n" + "/**\n" + " * Completion after:\n" + " * 	@param \n" + " */\n" + "public class BasicTestTypes<TPARAM> {}\n";
        // empty token
        completeInJavadoc("/Completion/src/javadoc/types/tags/BasicTestTypes.java", source, true, "@param ", 0);
        assertResults("TPARAM[JAVADOC_PARAM_REF]{<TPARAM>, null, null, TPARAM, null, " + this.positions + JAVADOC_RELEVANCE + "}");
    }
    ...
    public void test068() throws JavaModelException {
        ...
        String source = "package javadoc.types.tags;\n" + "/**\n" + " * Completion after:\n" + " * 	@param <T1>\n" + " * 	@param <T1>\n" + " */\n" + "public class BasicTestTypes<T1, T2, T3> {}\n";
        //2nd position
        completeInJavadoc("/Completion/src/javadoc/types/tags/BasicTestTypes.java", source, true, "<T1>", 2);
        assertResults("");
    }
    ...
    public void test069() throws JavaModelException {
        ...
        // empty token
        completeInJavadoc("/Completion/src/javadoc/types/tags/BasicTestTypes.java", source, true, "** 	@param ", 0);
        assertResults("T2[JAVADOC_PARAM_REF]{<T2>, null, null, T2, null, " + this.positions + JAVADOC_RELEVANCE + "}");
    }
    ...
    public void test070() throws JavaModelException {
        ...
        String source = "package javadoc.types.tags;\n" + "/**\n" + " * Completion after:\n" + " * 	@param <T1>\n" + " * 	@param <T2>\n" + " * 	@param <T3>\n" + " */\n" + "public class BasicTestTypes<T1, T2, T3> {}\n";
        // 3rd position
        completeInJavadoc("/Completion/src/javadoc/types/tags/BasicTestTypes.java", source, true, "<T", 3);
        assertResults("T3[JAVADOC_PARAM_REF]{<T3>, null, null, T3, null, " + this.positions + JAVADOC_RELEVANCE + "}");
    }
 ...
 */
    public void test100() throws JavaModelException {
        ...
        completeInJavadoc("/Completion/src/javadoc/types/ZBasicTestTypes.java", source, true, "ZBasi", 1, new int[] {});
        assertResults("ZBasicTestTypes[TYPE_REF]{ZBasicTestTypes, javadoc.types, Ljavadoc.types.ZBasicTestTypes;, null, null, " + this.positions + R_DRICUNR + "}\n" + "ZBasicTestTypes[JAVADOC_TYPE_REF]{{@link ZBasicTestTypes}, javadoc.types, Ljavadoc.types.ZBasicTestTypes;, null, null, " + this.positions + R_DRICUNRIT + "}");
    }

    public void test101() throws JavaModelException {
        String source = "package javadoc.types;\n" + "/**\n" + " * Completion after:\n" + " * 	bla ZBasi bla\n" + " */\n" + "public class ZBasicTestTypes {}\n";
        completeInJavadoc("/Completion/src/javadoc/types/ZBasicTestTypes.java", source, true, "ZBasi", 1, new int[] { CompletionProposal.JAVADOC_TYPE_REF });
        assertResults("ZBasicTestTypes[TYPE_REF]{ZBasicTestTypes, javadoc.types, Ljavadoc.types.ZBasicTestTypes;, null, null, " + this.positions + R_DRICUNR + "}");
    }

    public void test102() throws JavaModelException {
        String source = "package javadoc.types;\n" + "/**\n" + " * Completion after:\n" + " * 	bla ZBasi bla\n" + " */\n" + "public class ZBasicTestTypes {}\n";
        completeInJavadoc("/Completion/src/javadoc/types/ZBasicTestTypes.java", source, true, "ZBasi", 1, new int[] { CompletionProposal.TYPE_REF });
        assertResults("ZBasicTestTypes[JAVADOC_TYPE_REF]{{@link ZBasicTestTypes}, javadoc.types, Ljavadoc.types.ZBasicTestTypes;, null, null, " + this.positions + R_DRICUNRIT + "}");
    }

    public void test103() throws JavaModelException {
        String source = "package javadoc.types;\n" + "/**\n" + " * Completion after:\n" + " * 	bla ZBasicTestTypes#fo bla\n" + " */\n" + "public class ZBasicTestTypes {\n" + "  public void foo() {}\n" + "}\n";
        completeInJavadoc("/Completion/src/javadoc/types/ZBasicTestTypes.java", source, true, "ZBasicTestTypes#fo", 1, new int[] {});
        assertResults("foo[JAVADOC_METHOD_REF]{{@link ZBasicTestTypes#foo()}, Ljavadoc.types.ZBasicTestTypes;, ()V, foo, null, " + this.positions + R_DRICNRNSIT + "}");
    }

    public void test104() throws JavaModelException {
        String source = "package javadoc.types;\n" + "/**\n" + " * Completion after:\n" + " * 	bla ZBasicTestTypes#fo bla\n" + " */\n" + "public class ZBasicTestTypes {\n" + "  public void foo() {}\n" + "}\n";
        completeInJavadoc("/Completion/src/javadoc/types/ZBasicTestTypes.java", source, true, "ZBasicTestTypes#fo", 1, new int[] { CompletionProposal.JAVADOC_METHOD_REF });
        assertResults("");
    }

    public void test105() throws JavaModelException {
        String source = "package javadoc.types;\n" + "/**\n" + " * Completion after:\n" + " * 	bla ZBasicTestTypes#fo bla\n" + " */\n" + "public class ZBasicTestTypes {\n" + "  public void foo() {}\n" + "}\n";
        completeInJavadoc("/Completion/src/javadoc/types/ZBasicTestTypes.java", source, true, "ZBasicTestTypes#fo", 1, new int[] { CompletionProposal.METHOD_REF });
        assertResults("foo[JAVADOC_METHOD_REF]{{@link ZBasicTestTypes#foo()}, Ljavadoc.types.ZBasicTestTypes;, ()V, foo, null, " + this.positions + R_DRICNRNSIT + "}");
    }
    ...
    public void test106() throws JavaModelException {
        String source = "package javadoc.types;\n" + "/**\n" + " * Completion after:\n" + " * 	bla ZBasicTestTypes#fo bla\n" + " */\n" + "public class ZBasicTestTypes {\n" + "  public int foo;\n" + "}\n";
        completeInJavadoc("/Completion/src/javadoc/types/ZBasicTestTypes.java", source, true, "ZBasicTestTypes#fo", 1, new int[] {});
        assertResults("foo[JAVADOC_FIELD_REF]{{@link ZBasicTestTypes#foo}, Ljavadoc.types.ZBasicTestTypes;, I, foo, null, " + this.positions + R_DRICNRNSIT + "}");
    }

    public void test107() throws JavaModelException {
        String source = "package javadoc.types;\n" + "/**\n" + " * Completion after:\n" + " * 	bla ZBasicTestTypes#fo bla\n" + " */\n" + "public class ZBasicTestTypes {\n" + "  public int foo;\n" + "}\n";
        completeInJavadoc("/Completion/src/javadoc/types/ZBasicTestTypes.java", source, true, "ZBasicTestTypes#fo", 1, new int[] { CompletionProposal.JAVADOC_FIELD_REF });
        assertResults("");
    }

    public void test108() throws JavaModelException {
        String source = "package javadoc.types;\n" + "/**\n" + " * Completion after:\n" + " * 	bla ZBasicTestTypes#fo bla\n" + " */\n" + "public class ZBasicTestTypes {\n" + "  public int foo;\n" + "}\n";
        completeInJavadoc("/Completion/src/javadoc/types/ZBasicTestTypes.java", source, true, "ZBasicTestTypes#fo", 1, new int[] { CompletionProposal.FIELD_REF });
        assertResults("foo[JAVADOC_FIELD_REF]{{@link ZBasicTestTypes#foo}, Ljavadoc.types.ZBasicTestTypes;, I, foo, null, " + this.positions + R_DRICNRNSIT + "}");
    }

    public void test109() throws JavaModelException {
        String source = "package javadoc.types;\n" + "/**\n" + " * Completion after:\n" + " * 	bla javadoc.types.ZBasi bla\n" + " */\n" + "public class ZBasicTestTypes {}\n";
        completeInJavadoc("/Completion/src/javadoc/types/ZBasicTestTypes.java", source, true, "javadoc.types.ZBasi", 1, new int[] {});
        assertResults("ZBasicTestTypes[TYPE_REF]{ZBasicTestTypes, javadoc.types, Ljavadoc.types.ZBasicTestTypes;, null, null, " + this.positions + R_DRICNR + "}\n" + "ZBasicTestTypes[JAVADOC_TYPE_REF]{{@link ZBasicTestTypes}, javadoc.types, Ljavadoc.types.ZBasicTestTypes;, null, null, " + this.positions + R_DRICNRIT + "}");
    }

    public void test110() throws JavaModelException {
        String source = "package javadoc.types;\n" + "/**\n" + " * Completion after:\n" + " * 	bla javadoc.types.ZBasi bla\n" + " */\n" + "public class ZBasicTestTypes {}\n";
        completeInJavadoc("/Completion/src/javadoc/types/ZBasicTestTypes.java", source, true, "javadoc.types.ZBasi", 1, new int[] { CompletionProposal.JAVADOC_TYPE_REF });
        assertResults("ZBasicTestTypes[TYPE_REF]{ZBasicTestTypes, javadoc.types, Ljavadoc.types.ZBasicTestTypes;, null, null, " + this.positions + R_DRICNR + "}");
    }

    public void test111() throws JavaModelException {
        String source = "package javadoc.types;\n" + "/**\n" + " * Completion after:\n" + " * 	bla javadoc.types.ZBasi bla\n" + " */\n" + "public class ZBasicTestTypes {}\n";
        completeInJavadoc("/Completion/src/javadoc/types/ZBasicTestTypes.java", source, true, "javadoc.types.ZBasi", 1, new int[] { CompletionProposal.TYPE_REF });
        assertResults("ZBasicTestTypes[JAVADOC_TYPE_REF]{{@link ZBasicTestTypes}, javadoc.types, Ljavadoc.types.ZBasicTestTypes;, null, null, " + this.positions + R_DRICNRIT + "}");
    }

    public void test112() throws JavaModelException {
        String source = "package javadoc.types;\n" + "/**\n" + " * Completion after:\n" + " * 	bla javadoc.types.ZBasicTestTypes.Inn bla\n" + " */\n" + "public class ZBasicTestTypes {\n" + "  public class Inner {}\n" + "}\n";
        completeInJavadoc("/Completion/src/javadoc/types/ZBasicTestTypes.java", source, true, "javadoc.types.ZBasicTestTypes.Inn", 1, new int[] {});
        assertResults("ZBasicTestTypes.Inner[TYPE_REF]{Inner, javadoc.types, Ljavadoc.types.ZBasicTestTypes$Inner;, null, null, " + this.positions + R_DRICNR + "}\n" + "ZBasicTestTypes.Inner[JAVADOC_TYPE_REF]{{@link Inner}, javadoc.types, Ljavadoc.types.ZBasicTestTypes$Inner;, null, null, " + this.positions + R_DRICNRIT + "}");
    }

    public void test113() throws JavaModelException {
        String source = "package javadoc.types;\n" + "/**\n" + " * Completion after:\n" + " * 	bla javadoc.types.ZBasicTestTypes.Inn bla\n" + " */\n" + "public class ZBasicTestTypes {\n" + "  public class Inner {}\n" + "}\n";
        completeInJavadoc("/Completion/src/javadoc/types/ZBasicTestTypes.java", source, true, "javadoc.types.ZBasicTestTypes.Inn", 1, new int[] { CompletionProposal.JAVADOC_TYPE_REF });
        assertResults("ZBasicTestTypes.Inner[TYPE_REF]{Inner, javadoc.types, Ljavadoc.types.ZBasicTestTypes$Inner;, null, null, " + this.positions + R_DRICNR + "}");
    }

    public void test114() throws JavaModelException {
        String source = "package javadoc.types;\n" + "/**\n" + " * Completion after:\n" + " * 	bla javadoc.types.ZBasicTestTypes.Inn bla\n" + " */\n" + "public class ZBasicTestTypes {\n" + "  public class Inner {}\n" + "}\n";
        completeInJavadoc("/Completion/src/javadoc/types/ZBasicTestTypes.java", source, true, "javadoc.types.ZBasicTestTypes.Inn", 1, new int[] { CompletionProposal.TYPE_REF });
        assertResults("ZBasicTestTypes.Inner[JAVADOC_TYPE_REF]{{@link Inner}, javadoc.types, Ljavadoc.types.ZBasicTestTypes$Inner;, null, null, " + this.positions + R_DRICNRIT + "}");
    }
}
