    ...
    public TypeBinding resolveType(BlockScope scope) {
        ...
        if (this.typeArguments != null) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if ((this.genericTypeArguments[i] = typeReference.resolveType(scope, /* check bounds*/
                true)) == null) {
        ...
        if (!this.binding.isValidBinding()) {
            if (this.binding instanceof ProblemMethodBinding && ((ProblemMethodBinding) this.binding).problemId() == NotVisible) {
