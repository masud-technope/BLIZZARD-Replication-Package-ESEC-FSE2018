...
public class Java8ElementProcessor extends BaseProcessor {
    ...
    public void testRepeatedAnnotations17() {
        // discovery is always in terms of container
        Set<? extends Element> actualElments = roundEnv.getElementsAnnotatedWith(Foo.class);
        assertNotNull("RoundEnvironment#getElementsAnnotatedWith returned null", actualElments);
        ...
        for (Element e : actualElments) {
            verifyAnnotations(e, new String[] { "@FooContainer(value=@org.eclipse.jdt.compiler.apt.tests.annotations.Foo,@org.eclipse.jdt.compiler.apt.tests.annotations.Foo)" }, new String[] { "@FooContainer(value=[@org.eclipse.jdt.compiler.apt.tests.annotations.Foo, @org.eclipse.jdt.compiler.apt.tests.annotations.Foo])" });
    ...
    public // Goo is wrapped by GooNonContainer, but Goo is not repeatable.
    void testRepeatedAnnotations19() {
        // discovery is always in terms of container
        Set<? extends Element> actualElments = roundEnv.getElementsAnnotatedWith(Goo.class);
        assertNotNull("RoundEnvironment#getElementsAnnotatedWith returned null", actualElments);
        assertTrue("Found unexpected elements", actualElments.size() == 0);
        ...
        assertTrue("Found unexpected elements", actualElments.size() == 1);
        for (Element e : actualElments) {
            verifyAnnotations(e, new String[] { "@GooNonContainer(value=@org.eclipse.jdt.compiler.apt.tests.annotations.Goo,@org.eclipse.jdt.compiler.apt.tests.annotations.Goo)" }, new String[] { "@GooNonContainer(value=[@org.eclipse.jdt.compiler.apt.tests.annotations.Goo, @org.eclipse.jdt.compiler.apt.tests.annotations.Goo])" });
            ...
            assertTrue("Should not be empty", annots.length == 1);
            // Goo should not be unwrapped from the container as Goo is not a repeatable annotation.
            annots = e.getAnnotationsByType(Goo.class);
            assertTrue("Should be 0", annots.length == 0);
        }
    }

    public // Both Foo and FooContainer occur.
    void testRepeatedAnnotations20() {
        // discovery is always in terms of container
        Set<? extends Element> actualElments = roundEnv.getElementsAnnotatedWith(Foo.class);
        assertNotNull("RoundEnvironment#getElementsAnnotatedWith returned null", actualElments);
        assertTrue("Found unexpected elements", actualElments.size() == 1);
        ...
        assertTrue("Found unexpected elements", actualElments.size() == 1);
        for (Element e : actualElments) {
            verifyAnnotations(e, new String[] { "@FooContainer(value=@org.eclipse.jdt.compiler.apt.tests.annotations.Foo)", "@Foo()" }, new String[] { "@FooContainer(value=[@org.eclipse.jdt.compiler.apt.tests.annotations.Foo])", "@org.eclipse.jdt.compiler.apt.tests.annotations.Foo" });
            Annotation annot = e.getAnnotation(Foo.class);
    ...
    public // Foo is wrapped by a non-declared container
    void testRepeatedAnnotations21() {
        // discovery is always in terms of container
        Set<? extends Element> actualElments = roundEnv.getElementsAnnotatedWith(Foo.class);
        assertNotNull("RoundEnvironment#getElementsAnnotatedWith returned null", actualElments);
        assertTrue("Found unexpected elements", actualElments.size() == 0);
        ...
        assertTrue("Found unexpected elements", actualElments.size() == 1);
        for (Element e : actualElments) {
            verifyAnnotations(e, new String[] { "@FooNonContainer(value=@org.eclipse.jdt.compiler.apt.tests.annotations.Foo,@org.eclipse.jdt.compiler.apt.tests.annotations.Foo)" }, new String[] { "@FooNonContainer(value=[@org.eclipse.jdt.compiler.apt.tests.annotations.Foo, @org.eclipse.jdt.compiler.apt.tests.annotations.Foo])" });
            Annotation annot = e.getAnnotation(Foo.class);
    ...
    public // Repeating type annotations
    void testRepeatedAnnotations22() {
        // discovery is always in terms of container
        Set<? extends Element> actualElments = roundEnv.getElementsAnnotatedWith(Foo.class);
        assertNotNull("RoundEnvironment#getElementsAnnotatedWith returned null", actualElments);
        ...
        for (Element e : actualElments) {
            if (e instanceof VariableElement) {
                ...
                verifyAnnotations(mirror, new String[] { "@TFooContainer(value=@org.eclipse.jdt.compiler.apt.tests.annotations.TFoo,@org.eclipse.jdt.compiler.apt.tests.annotations.TFoo)" }, new String[] { "@TFooContainer(value=[@org.eclipse.jdt.compiler.apt.tests.annotations.TFoo, @org.eclipse.jdt.compiler.apt.tests.annotations.TFoo])" });
    ...
    public void testRepeatedAnnotations24() {
        // discovery is always in terms of container
        Set<? extends Element> actualElments = roundEnv.getElementsAnnotatedWith(IFoo.class);
        assertNotNull("RoundEnvironment#getElementsAnnotatedWith returned null", actualElments);
    ...
    public void testRepeatedAnnotations25() {
        // discovery is always in terms of container
        Set<? extends Element> actualElments = roundEnv.getElementsAnnotatedWith(IFooContainer.class);
        assertNotNull("RoundEnvironment#getElementsAnnotatedWith returned null", actualElments);
        assertTrue("Found unexpected elements", actualElments.size() == 2);
    ...
    private String getAnnotationString(AnnotationMirror annot) {
        ...
        buf.append('(');
        for (// @Marker3()
        ExecutableElement executableElement : // @Marker3()
        keys) {
    ...
    public void assertModifiers(Set<Modifier> modifiers, String[] expected) {
        ...
        for (int i = 0, length = expected.length; i < length; i++) {
            ...
            if (!result)
                reportError("Modifier not present :" + expected[i]);
        }
        if (!actual.isEmpty()) {
