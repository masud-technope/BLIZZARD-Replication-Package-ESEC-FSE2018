...
public class StaticImportTest extends AbstractComparableTest {
    ...
    public // test static vs. instance
    void test004() {
    ...
    public // test non static member types
    void test006() {
    ...
    public // test non static member types vs. static field
    void test007() {
    ...
    public // test static top level types
    void test008() {
    ...
    public void test013() {
        this.runNegativeTest(new String[] { "X.java", // found if ZZ is static
    ...
    public // test field/method collisions
    void test022() {
    ...
    public void test023() {
        ...
        // extra inheritance hiccup for method lookup
    ...
    public // ensure inherited problem fields do not stop package resolution
    void test026() {
    ...
    public void test037() {
        this.runConformTest(new String[] { "X.java", "import static p.A.CONSTANT_I;\n" + "import static p.A.CONSTANT_B;\n" + "public class X {\n" + "  static int i = p.A.CONSTANT_I;\n" + "  static int j = p.A.CONSTANT_B;\n" + "  static int m = CONSTANT_I;\n" + "  static int n = CONSTANT_B;\n" + "}", "p/A.java", "package p;\n" + "public class A extends B implements I {}\n" + "interface I { int CONSTANT_I = 1; }\n" + "class B { public static int CONSTANT_B = 1; }" }, JavacTestOptions.JavacHasABug.JavacBugFixed_6_10);
    }
    ...
    public void test071() {
        ...
        "node/Test/node.java", "package node.Test;\n" + "public class node {\n" + "}\n", //------------------------------
        "node/Test.java", "package node;\n" + "public class Test {\n" + "        public static void node() {}\n" + "}\n", //------------------------------
