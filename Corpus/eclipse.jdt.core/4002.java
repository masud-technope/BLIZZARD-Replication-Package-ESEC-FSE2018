...
public class Disassembler extends ClassFileBytesDisassembler {
        ...
        for (int i = 0, max = checkBits.length; i < max; i++) {
            switch(checkBits[i]) {
                case IModifierConstants.ACC_PUBLIC:
                    firstModifier = appendModifier(//$NON-NLS-1$
                    buffer, //$NON-NLS-1$
                    accessFlags, //$NON-NLS-1$
                    IModifierConstants.ACC_PUBLIC, //$NON-NLS-1$
                    "public", //$NON-NLS-1$
                    firstModifier);
                    break;
                case IModifierConstants.ACC_PROTECTED:
                    ...
                    buffer, //$NON-NLS-1$
                    accessFlags, //$NON-NLS-1$
                    IModifierConstants.ACC_PROTECTED, //$NON-NLS-1$
                    "protected", //$NON-NLS-1$
                    firstModifier);
                    break;
                case IModifierConstants.ACC_PRIVATE:
                    ...
                    buffer, //$NON-NLS-1$
                    accessFlags, //$NON-NLS-1$
                    IModifierConstants.ACC_PRIVATE, //$NON-NLS-1$
                    "private", //$NON-NLS-1$
                    firstModifier);
                    break;
                case IModifierConstants.ACC_ABSTRACT:
                    ...
                    buffer, //$NON-NLS-1$
                    accessFlags, //$NON-NLS-1$
                    IModifierConstants.ACC_ABSTRACT, //$NON-NLS-1$
                    "abstract", //$NON-NLS-1$
                    firstModifier);
                    break;
                case IModifierConstants.ACC_STATIC:
                    ...
                    buffer, //$NON-NLS-1$
                    accessFlags, //$NON-NLS-1$
                    IModifierConstants.ACC_STATIC, //$NON-NLS-1$
                    "static", //$NON-NLS-1$
                    firstModifier);
                    break;
                case IModifierConstants.ACC_FINAL:
                    ...
                    buffer, //$NON-NLS-1$
                    accessFlags, //$NON-NLS-1$
                    IModifierConstants.ACC_FINAL, //$NON-NLS-1$
                    "final", //$NON-NLS-1$
                    firstModifier);
                    break;
                case IModifierConstants.ACC_SYNCHRONIZED:
                    ...
                    buffer, //$NON-NLS-1$
                    accessFlags, //$NON-NLS-1$
                    IModifierConstants.ACC_SYNCHRONIZED, //$NON-NLS-1$
                ...
                case IModifierConstants.ACC_NATIVE:
                    ...
                    buffer, //$NON-NLS-1$
                    accessFlags, //$NON-NLS-1$
                    IModifierConstants.ACC_NATIVE, //$NON-NLS-1$
                    "native", //$NON-NLS-1$
                    firstModifier);
                    break;
                case IModifierConstants.ACC_STRICT:
                    ...
                    buffer, //$NON-NLS-1$
                    accessFlags, //$NON-NLS-1$
                    IModifierConstants.ACC_STRICT, //$NON-NLS-1$
                    "strictfp", //$NON-NLS-1$
                    firstModifier);
                    break;
                case IModifierConstants.ACC_TRANSIENT:
                    ...
                    buffer, //$NON-NLS-1$
                    accessFlags, //$NON-NLS-1$
                    IModifierConstants.ACC_TRANSIENT, //$NON-NLS-1$
                    "transient", //$NON-NLS-1$
                    firstModifier);
                    break;
                case IModifierConstants.ACC_VOLATILE:
                    ...
                    if (asBridge) {
                        ...
                        buffer, //$NON-NLS-1$
                        accessFlags, //$NON-NLS-1$
                        IModifierConstants.ACC_BRIDGE, //$NON-NLS-1$
                        "bridge", //$NON-NLS-1$
                        firstModifier);
                    } else {
                        firstModifier = appendModifier(//$NON-NLS-1$
                        buffer, //$NON-NLS-1$
                        accessFlags, //$NON-NLS-1$
                        IModifierConstants.ACC_VOLATILE, //$NON-NLS-1$
                        "volatile", //$NON-NLS-1$
                        firstModifier);
                    }
                    break;
                case IModifierConstants.ACC_ENUM:
                    ...
                    buffer, //$NON-NLS-1$
                    accessFlags, //$NON-NLS-1$
                    IModifierConstants.ACC_ENUM, //$NON-NLS-1$
                    "enum", //$NON-NLS-1$
                    firstModifier);
                    break;
                case IModifierConstants.ACC_SYNTHETIC:
                    ...
                    buffer, //$NON-NLS-1$
                    accessFlags, //$NON-NLS-1$
                    IModifierConstants.ACC_SYNTHETIC, //$NON-NLS-1$
                    "synthetic", //$NON-NLS-1$
                    firstModifier);
                    break;
                case IModifierConstants.ACC_MANDATED:
                    ...
                    buffer, //$NON-NLS-1$
                    accessFlags, //$NON-NLS-1$
                    IModifierConstants.ACC_MANDATED, //$NON-NLS-1$
                    "mandated", //$NON-NLS-1$
                    firstModifier);
                    break;
            }
    ...
    private void decodeModifiersForFieldForWorkingCopy(StringBuffer buffer, int accessFlags) {
        decodeModifiers(buffer, accessFlags, new int[] { IModifierConstants.ACC_PUBLIC, IModifierConstants.ACC_PROTECTED, IModifierConstants.ACC_PRIVATE, IModifierConstants.ACC_STATIC, IModifierConstants.ACC_FINAL, IModifierConstants.ACC_TRANSIENT, IModifierConstants.ACC_VOLATILE });
    }
    ...
    private final void decodeModifiersForMethodParameters(StringBuffer buffer, int accessFlags) {
        decodeModifiers(buffer, accessFlags, false, true, new int[] { IModifierConstants.ACC_FINAL, IModifierConstants.ACC_MANDATED, IModifierConstants.ACC_SYNTHETIC });
    }
    ...
    private void disassemble(IAnnotation annotation, StringBuffer buffer, String lineSeparator, int tabNumber, int mode) {
        ...
        buffer.append(Messages.bind(Messages.disassembler_annotationentrystart, new String[] { Integer.toString(typeIndex), new String(returnClassName(Signature.toCharArray(typeName), '.', mode)) }));
    ...
    private void disassemble(IExtendedAnnotation extendedAnnotation, StringBuffer buffer, String lineSeparator, int tabNumber, int mode) {
        ...
        buffer.append(Messages.bind(Messages.disassembler_extendedannotationentrystart, new String[] { Integer.toString(typeIndex), new String(returnClassName(Signature.toCharArray(typeName), '.', mode)) }));
        ...
        buffer.append(Messages.bind(Messages.disassembler_extendedannotation_targetType, new String[] { Integer.toHexString(targetType), getTargetType(targetType) }));
        switch(targetType) {
    ...
    private void disassembleTypePathContents(int targetType, IExtendedAnnotation extendedAnnotation, StringBuffer buffer, String lineSeparator, int tabNumber, int mode) {
        ...
        if (typepath.length != 0) {
            writeNewLine(buffer, lineSeparator, tabNumber + 2);
            buffer.append(Messages.bind(Messages.disassembler_extendedannotation_typepath, new String[] { toTypePathString(typepath) }));
        }
    }
    ...
    private void disassembleTargetTypeContents(boolean insideWildcard, int targetType, IExtendedAnnotation extendedAnnotation, StringBuffer buffer, String lineSeparator, int tabNumber, int mode) {
        switch(targetType) {
            ...
            case IExtendedAnnotationConstants.METHOD_TYPE_PARAMETER:
                buffer.append(Messages.bind(Messages.disassembler_extendedannotation_type_parameter, new String[] { Integer.toString(extendedAnnotation.getTypeParameterIndex()) }));
                break;
            case IExtendedAnnotationConstants.CLASS_EXTENDS:
                buffer.append(Messages.bind(Messages.disassembler_extendedannotation_classextendsimplements, new String[] { Integer.toString(extendedAnnotation.getAnnotationTypeIndex()) }));
                break;
            ...
            case IExtendedAnnotationConstants.METHOD_TYPE_PARAMETER_BOUND:
                buffer.append(Messages.bind(Messages.disassembler_extendedannotation_type_parameter_with_bound, new String[] { Integer.toString(extendedAnnotation.getTypeParameterIndex()), Integer.toString(extendedAnnotation.getTypeParameterBoundIndex()) }));
                break;
            case IExtendedAnnotationConstants.FIELD:
            case IExtendedAnnotationConstants.METHOD_RETURN:
            case IExtendedAnnotationConstants.METHOD_RECEIVER:
            ...
            case IExtendedAnnotationConstants.METHOD_FORMAL_PARAMETER:
                buffer.append(Messages.bind(Messages.disassembler_extendedannotation_method_parameter, new String[] { Integer.toString(extendedAnnotation.getParameterIndex()) }));
                break;
            case IExtendedAnnotationConstants.THROWS:
                buffer.append(Messages.bind(Messages.disassembler_extendedannotation_throws, new String[] { Integer.toString(extendedAnnotation.getAnnotationTypeIndex()) }));
                break;
            ...
            case IExtendedAnnotationConstants.RESOURCE_VARIABLE:
                ...
                for (int i = 0; i < localVariableTableSize; i++) {
                    ...
                    buffer.append(Messages.bind(Messages.classfileformat_localvariablereferenceinfoentry, new String[] { Integer.toString(startPC), Integer.toString(startPC + length), Integer.toString(index) }));
                }
                break;
            case IExtendedAnnotationConstants.EXCEPTION_PARAMETER:
                buffer.append(Messages.bind(Messages.disassembler_extendedannotation_exception_table_index, new String[] { Integer.toString(extendedAnnotation.getExceptionTableIndex()) }));
                break;
            ...
            case IExtendedAnnotationConstants.METHOD_REFERENCE:
                buffer.append(Messages.bind(Messages.disassembler_extendedannotation_offset, new String[] { Integer.toString(extendedAnnotation.getOffset()) }));
                break;
            ...
            case IExtendedAnnotationConstants.METHOD_REFERENCE_TYPE_ARGUMENT:
                buffer.append(Messages.bind(Messages.disassembler_extendedannotation_offset, new String[] { Integer.toString(extendedAnnotation.getOffset()) }));
                writeNewLine(buffer, lineSeparator, tabNumber + 2);
                buffer.append(Messages.bind(Messages.disassembler_extendedannotation_type_argument, new String[] { Integer.toString(extendedAnnotation.getAnnotationTypeIndex()) }));
                break;
        }
    }
    ...
    private void disassemble(IAnnotationComponentValue annotationComponentValue, StringBuffer buffer, String lineSeparator, int tabNumber, int mode) {
        switch(annotationComponentValue.getTag()) {
            ...
            case IAnnotationComponentValue.STRING_TAG:
                ...
                switch(constantPoolEntry.getKind()) {
                    case IConstantPoolConstant.CONSTANT_Long:
                        value = //$NON-NLS-1$
                        constantPoolEntry.getLongValue() + "L";
                        break;
                    case IConstantPoolConstant.CONSTANT_Float:
                        value = //$NON-NLS-1$
                        constantPoolEntry.getFloatValue() + "f";
                        break;
                    ...
                    case IConstantPoolConstant.CONSTANT_Integer:
                        ...
                        switch(annotationComponentValue.getTag()) {
                            case IAnnotationComponentValue.CHAR_TAG:
                                ...
                                break;
                            case IAnnotationComponentValue.BOOLEAN_TAG:
                                temp.append(//$NON-NLS-1$//$NON-NLS-2$
                                constantPoolEntry.getIntegerValue() == 1 ? //$NON-NLS-1$//$NON-NLS-2$
                                "true" : //$NON-NLS-1$//$NON-NLS-2$
                                "false");
                                break;
                            case IAnnotationComponentValue.BYTE_TAG:
                                temp.append("(byte) ").append(//$NON-NLS-1$
                                constantPoolEntry.getIntegerValue());
                                break;
                            case IAnnotationComponentValue.SHORT_TAG:
                                temp.append("(short) ").append(//$NON-NLS-1$
                                constantPoolEntry.getIntegerValue());
                                break;
                            case IAnnotationComponentValue.INTEGER_TAG:
                                temp.append("(int) ").append(//$NON-NLS-1$
                                constantPoolEntry.getIntegerValue());
                        }
            ...
            case IAnnotationComponentValue.ENUM_TAG:
                ...
                buffer.append(Messages.bind(Messages.disassembler_annotationenumvalue, new String[] { Integer.toString(enumConstantTypeNameIndex), Integer.toString(enumConstantNameIndex), new String(returnClassName(Signature.toCharArray(typeName), '.', mode)), new String(constantName) }));
                break;
            case IAnnotationComponentValue.CLASS_TAG:
                ...
                buffer.append(Messages.bind(Messages.disassembler_annotationclassvalue, new String[] { Integer.toString(classIndex), new String(returnClassName(Signature.toCharArray(className), '.', mode)) }));
                break;
    ...
    public String disassemble(IClassFileReader classFileReader, String lineSeparator, int mode) {
        ...
        if (checkMode(mode, SYSTEM | DETAILED)) {
            ...
            if (innerClassesAttribute != null || enclosingMethodAttribute != null || bootstrapMethods != null || remainingAttributesLength != 0) {
    ...
    private void disassemble(ICodeAttribute codeAttribute, char[][] parameterNames, char[] methodDescriptor, boolean isStatic, StringBuffer buffer, String lineSeparator, int tabNumber, int mode) {
        ...
        if (localVariableAttributeLength != 0) {
            ...
            for (int i = 0; i < localVariableAttributeLength; i++) {
                ...
                buffer.append(Messages.bind(Messages.classfileformat_localvariabletableentry, new String[] { Integer.toString(startPC), Integer.toString(startPC + length), new String(localVariableTableEntry.getName()), Integer.toString(index), new String(returnClassName(typeName, '.', mode)) }));
            }
        }
        ...
        if (localVariableTypeTableLength != 0) {
            ...
            for (int i = 0; i < localVariableTypeTableLength; i++) {
                ...
                CharOperation.replace(typeName, '/', '.');
                buffer.append(Messages.bind(Messages.classfileformat_localvariabletableentry, new String[] { Integer.toString(startPC), Integer.toString(startPC + length), new String(localVariableTypeTableEntry.getName()), Integer.toString(index), new String(returnClassName(typeName, '.', mode)) }));
            }
        }
    ...
    private void disassemble(IStackMapTableAttribute attribute, StringBuffer buffer, String lineSeparator, int tabNumber, int mode) {
        ...
        for (int j = 0; j < numberOfEntries; j++) {
            ...
            switch(type) {
                ...
                case 247:
                    buffer.append(Messages.bind(Messages.disassembler_frame_same_locals_1_stack_item_extended, Integer.toString(absolutePC), disassemble(frame.getStackItems(), mode)));
                    break;
                case 248:
                case 249:
                case 250:
                ...
                case 254:
                    // APPEND
                    buffer.append(Messages.bind(Messages.disassembler_frame_append, Integer.toString(absolutePC), disassemble(frame.getLocals(), mode)));
                    break;
                case 255:
                    // FULL_FRAME
                ...
                default:
                    if (type <= 63) {
                        ...
                        offsetDelta = type - 64;
                        buffer.append(Messages.bind(Messages.disassembler_frame_same_locals_1_stack_item, Integer.toString(absolutePC), disassemble(frame.getStackItems(), mode)));
                    }
            }
        }
    }
    ...
    private String bootstrapMethodDescription(IBootstrapMethodsEntry entry, IConstantPool constantPool) {
        ...
        //$NON-NLS-1$
        builder.append(Messages.bind("invokestatic {0}.{1}:{2}", methodDescription(constantPoolEntry)));
                ...
                case IConstantPoolConstant.CONSTANT_MethodHandle:
                    ...
                    switch(constantPoolEntry2.getReferenceKind()) {
                        ...
                        case IConstantPoolConstant.METHOD_TYPE_REF_NewInvokeSpecial:
                            ...
                            builder.append(Messages.bind("{0}.{1}:{2}", methodDescription(//$NON-NLS-1$
                            constantPoolEntry)));
    ...
    private String[] methodDescription(IConstantPoolEntry constantPoolEntry) {
        return new String[] { new String(constantPoolEntry.getClassName()), new String(constantPoolEntry.getMethodName()), new String(constantPoolEntry.getMethodDescriptor()) };
    }
        ...
        for (int i = 1; i < length; i++) {
            ...
            switch(constantPool.getEntryKind(i)) {
                ...
                case IConstantPoolConstant.CONSTANT_InterfaceMethodref:
                    ...
                    buffer.append(Messages.bind(Messages.disassembler_constantpool_interfacemethodref, new String[] { Integer.toString(i), Integer.toString(constantPoolEntry.getClassIndex()), Integer.toString(constantPoolEntry.getNameAndTypeIndex()), methodDescription[0], methodDescription[1], methodDescription[2] }));
                    break;
                case IConstantPoolConstant.CONSTANT_Long:
                ...
                case IConstantPoolConstant.CONSTANT_Methodref:
                    methodDescription = methodDescription(constantPoolEntry);
                    buffer.append(Messages.bind(Messages.disassembler_constantpool_methodref, new String[] { Integer.toString(i), Integer.toString(constantPoolEntry.getClassIndex()), Integer.toString(constantPoolEntry.getNameAndTypeIndex()), methodDescription[0], methodDescription[1], methodDescription[2] }));
                    break;
                ...
                case IConstantPoolConstant.CONSTANT_String:
                    buffer.append(Messages.bind(Messages.disassembler_constantpool_string, new String[] { Integer.toString(i), Integer.toString(constantPoolEntry.getStringIndex()), decodeStringValue(constantPoolEntry.getStringValue()) }));
                    break;
                case IConstantPoolConstant.CONSTANT_Utf8:
                    buffer.append(Messages.bind(Messages.disassembler_constantpool_utf8, new String[] { Integer.toString(i), decodeStringValue(new String(constantPoolEntry.getUtf8Value())) }));
                    break;
                case IConstantPoolConstant.CONSTANT_MethodHandle:
                    IConstantPoolEntry2 entry2 = (IConstantPoolEntry2) constantPoolEntry;
                    buffer.append(Messages.bind(Messages.disassembler_constantpool_methodhandle, new String[] { Integer.toString(i), getReferenceKind(entry2.getReferenceKind()), Integer.toString(entry2.getReferenceIndex()) }));
                    break;
                case IConstantPoolConstant.CONSTANT_MethodType:
                    entry2 = (IConstantPoolEntry2) constantPoolEntry;
                    buffer.append(Messages.bind(Messages.disassembler_constantpool_methodtype, new String[] { Integer.toString(i), Integer.toString(entry2.getDescriptorIndex()), String.valueOf(entry2.getMethodDescriptor()) }));
                    break;
                case IConstantPoolConstant.CONSTANT_InvokeDynamic:
                    entry2 = (IConstantPoolEntry2) constantPoolEntry;
                    buffer.append(Messages.bind(Messages.disassembler_constantpool_invokedynamic, new String[] { Integer.toString(i), Integer.toString(entry2.getBootstrapMethodAttributeIndex()), Integer.toString(entry2.getNameAndTypeIndex()), new String(constantPoolEntry.getMethodName()), new String(constantPoolEntry.getMethodDescriptor()) }));
            }
        }
    }
    ...
    private void disassemble(IEnclosingMethodAttribute enclosingMethodAttribute, StringBuffer buffer, String lineSeparator, int tabNumber) {
        ...
        buffer.append(Messages.disassembler_constantpoolindex).append(enclosingMethodAttribute.getEnclosingClassIndex()).append(//$NON-NLS-1$
        " ").append(Messages.disassembler_constantpoolindex).append(enclosingMethodAttribute.getMethodNameAndTypeIndex()).append(//$NON-NLS-1$
    ...
    private void disassemble(IFieldInfo fieldInfo, StringBuffer buffer, String lineSeparator, int tabNumber, int mode) {
        ...
        if (constantValueAttribute != null) {
            ...
            switch(constantPoolEntry.getKind()) {
                case IConstantPoolConstant.CONSTANT_Long:
                    buffer.append(//$NON-NLS-1$
                    constantPoolEntry.getLongValue() + //$NON-NLS-1$
                    "L");
                    break;
                case IConstantPoolConstant.CONSTANT_Float:
                    buffer.append(//$NON-NLS-1$
                    constantPoolEntry.getFloatValue() + //$NON-NLS-1$
                    "f");
                    break;
                case IConstantPoolConstant.CONSTANT_Double:
                ...
                case IConstantPoolConstant.CONSTANT_Integer:
                    switch(fieldDescriptor[0]) {
                        ...
                        case 'Z':
                            ...
                            constantPoolEntry.getIntegerValue() == 1 ? "true" : "false");
                            break;
                        case 'B':
    ...
    private void disassemble(IBootstrapMethodsAttribute bootstrapMethodsAttribute, StringBuffer buffer, String lineSeparator, int tabNumber, IConstantPool constantPool) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            buffer.append(Messages.bind(Messages.disassembler_bootstrapmethodentry, new String[] { Integer.toString(i), Integer.toString(entry.getBootstrapMethodReference()), bootstrapMethodDescription(entry, constantPool), getArguments(entry.getBootstrapArguments(), argumentsName) }));
        }
    }
    ...
    private String getArguments(int[] arguments, String[] argumentsName) {
        ...
        for (int i = 0, max = arguments.length; i < max; i++) {
            buffer.append(Messages.bind(Messages.disassembler_bootstrapmethodentry_argument, new String[] { Integer.toString(arguments[i]), argumentsName[i] }));
        ...
        for (int i = 0, max = infos.length; i < max; i++) {
            ...
            switch(infos[i].getTag()) {
                ...
                case IVerificationTypeInfo.ITEM_OBJECT:
                    ...
                    if (// length check for resilience
                    classTypeName.length > 0 && classTypeName[0] == '[') {
            ...
            methodLoop: for (int i = 0, max = methods.length; i < max; i++) {
                ...
                if (CharOperation.equals(methodInfo.getName(), TypeConstants.VALUES)) {
                    ...
                    if (Signature.getParameterCount(descriptor) == 0) {
                        if (CharOperation.equals(returnClassName(Signature.getReturnType(descriptor), '.', mode), CharOperation.concat(new char[] { '[', 'L' }, className, new char[] { ';' }))) {
                            continue methodLoop;
                        }
                    }
                    ...
                    if (parameterTypes.length == 1 && CharOperation.equals(parameterTypes[0], //$NON-NLS-1$
                    "Ljava.lang.String;".toCharArray())) {
                        if (CharOperation.equals(returnClassName(Signature.getReturnType(descriptor), '.', mode), CharOperation.concat('L', className, ';'))) {
                            continue methodLoop;
                        }
                    }
        ...
        for (int i = 0, max = typepath.length; i < max; i++) {
            ...
            switch(typepathElement[0]) {
                ...
                case IExtendedAnnotationConstants.TYPE_PATH_TYPE_ARGUMENT_INDEX:
                    buffer.append(Messages.bind(Messages.disassembler_extendedannotation_typepath_typeargument, new String[] { Integer.toString(typepathElement[1]) }));
                    break;
                default:
                    throw new IllegalStateException("Unrecognized type_path_kind: " + typepathElement//$NON-NLS-1$
                    [0]);
            }
        }
        buffer.append(']');
