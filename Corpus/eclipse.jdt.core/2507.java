...
public class CompilerToolTests extends TestCase {
    ...
    static final String[] FAKE_ZERO_ARG_OPTIONS = new String[] { // pass-through options
    "-Jignore", "-Xignore", "-Akey=value" };
    ...
    public void testCompilerOneClassWithEclipseCompiler3() {
        ...
        // System compiler
        StandardJavaFileManager manager = compiler.getStandardFileManager(null, Locale.getDefault(), Charset.defaultCharset());
        @SuppressWarnings("resource") ForwardingJavaFileManager<StandardJavaFileManager> forwardingJavaFileManager = new ForwardingJavaFileManager<StandardJavaFileManager>(manager) {
