...
public class BinaryParameterDeclarationImpl extends DeclarationImpl implements ParameterDeclaration {
    ...
    public MirrorKind kind() {
        return MirrorKind.FORMAL_PARAMETER;
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof BinaryParameterDeclarationImpl) {
            ...
            return otherParam._paramIndex == _paramIndex && otherParam._executable.getDeclarationBinding().isEqualTo(_executable.getDeclarationBinding());
        }
        return false;
    }
