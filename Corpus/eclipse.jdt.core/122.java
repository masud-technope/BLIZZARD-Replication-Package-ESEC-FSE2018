 ...
 */
    public void testBug3270() throws JavaModelException {
        ...
        // empty token
        completeInJavadoc("/Completion/src/javadoc/bugs/BasicTestBugs.java", source, true, "@throws ", 0);
        if (CompletionEngine.NO_TYPE_COMPLETION_ON_EMPTY_TOKEN) {
            assertSortedResults("InterruptedException[TYPE_REF]{InterruptedException, java.lang, Ljava.lang.InterruptedException;, null, null, " + this.positions + R_DRICUNREETE + "}");
        } else {
    ...
    public void testBug3270b() throws JavaModelException {
        ...
        assertSortedResults("CloneNotSupportedException[TYPE_REF]{CloneNotSupportedException, java.lang, Ljava.lang.CloneNotSupportedException;, null, null, " + this.positions + R_DRICUNRE + "}\n" + "Class[TYPE_REF]{Class, java.lang, Ljava.lang.Class;, null, null, " + this.positions + R_DRICUNR + "}");
    }
 ...
 */
    public void testBug22043() throws JavaModelException {
        ...
        // 2nd occurence
        completeInJavadoc("/Completion/src/javadoc/bugs/BasicTestBugs.java", source, true, "S", 2);
    ...
    public void testBug22043a() throws JavaModelException {
        ...
        // 2nd occurence
        completeInJavadoc("/Completion/src/javadoc/bugs/BasicTestBugs.java", source, true, "thisIsAMethod", 2);
        assertResults("thisIsAMethod[METHOD_REF]{thisIsAMethod(String), Ljavadoc.bugs.BasicTestBugs;, (Ljava.lang.String;)V, thisIsAMethod, (param), " + this.positions + R_DRICENNRNS + "}");
    }
    ...
    public void testBug22043b() throws JavaModelException {
        ...
        // 2nd occurence
        completeInJavadoc("/Completion/src/javadoc/bugs/BasicTestBugs.java", source, true, "thisIsAMethod(", 2);
        assertResults("thisIsAMethod[METHOD_REF]{thisIsAMethod(String), Ljavadoc.bugs.BasicTestBugs;, (Ljava.lang.String;)V, thisIsAMethod, (param), " + this.positions + R_DRICENUNR + "}");
    }
    ...
    public void testBug22043c() throws JavaModelException {
        ...
        // 2nd occurence
        completeInJavadoc("/Completion/src/javadoc/bugs/BasicTestBugs.java", source, true, "thisIsAMethod(", 2);
        assertResults("thisIsAMethod[METHOD_REF]{thisIsAMethod(Object), Ljavadoc.bugs.BasicTestBugs;, (Ljava.lang.Object;)V, thisIsAMethod, (str), " + this.positions + R_DRICENUNR + "}\n" + "thisIsAMethod[METHOD_REF]{thisIsAMethod(String), Ljavadoc.bugs.BasicTestBugs;, (Ljava.lang.String;)V, thisIsAMethod, (param), " + this.positions + R_DRICENUNR + "}");
    }
 ...
 */
    public void testBug67732() throws JavaModelException {
        ...
        assertSortedResults("toString[METHOD_REF]{toString(), Ljava.lang.Object;, ()Ljava.lang.String;, toString, null, " + this.positions + R_DRICNRNS + "}");
    }
 ...
 */
    public void testBug68757() throws JavaModelException {
        String[] sources = { "/Completion/src/javadoc/bugs/BasicTestBugs.java", "package javadoc.bugs;\n" + "import javadoc.tests.OtherType;\n" + "public class BasicTestBugs {\n" + "	/**\n" + "	 * @see Other\n" + "	 */\n" + "	public void foo(OtherType type) {}\n" + "}\n", "/Completion/src/javadoc/tests/OtherType.java", "package javadoc.tests;\n" + "public class OtherType {\n" + "}\n" };
        // 2nd occurrence
        completeInJavadoc(sources, true, "Other", 2);
        assertSortedResults("OtherType[TYPE_REF]{OtherType, javadoc.tests, Ljavadoc.tests.OtherType;, null, null, " + this.positions + R_DRICUNR + "}");
    }
    ...
    public void testBug68757a() throws JavaModelException {
        ...
        assertSortedResults("OtherType[TYPE_REF]{javadoc.tests.OtherType, javadoc.tests, Ljavadoc.tests.OtherType;, null, null, " + this.positions + R_DRICNR + "}");
    }
 ...
 */
    public void _testBug75551() throws JavaModelException {
        ...
        assertSortedResults("SuperClass.InnerClass[TYPE_REF]{SuperClass.InnerClass, javadoc.bugs, Ljavadoc.bugs.SuperClass$InnerClass;, null, null, " + this.positions + R_DRICUNR + "}");
    }
 ...
 */
    public void testBug86112() throws JavaModelException {
        ...
        // empty token
        completeInJavadoc(sources, true, "#", 0);
 ...
 */
    public void testBug87868() throws JavaModelException {
        ...
        assertSortedResults("method[METHOD_REF]{method(Object), Ljavadoc.bugs.BasicTestBugs;, (Ljava.lang.Object;)V, method, (s), " + this.positions + R_DRICNRNS + "}");
    }
 ...
 */
    public void testBug113376a() throws JavaModelException {
        setUpProjectOptions(CompilerOptions.VERSION_1_5);
        String[] sources = { "/Completion/src/javadoc/bugs/BasicTestFields.java", "package javadoc.bugs;\n" + "/**\n" + " * @see javadoc.util.Collection\n" + " * @see javadoc.util.List#add(Object)\n" + " */public class BasicTestBugs<A> {\n" + "}", "/Completion/src/javadoc/util/Collection.java", "package javadoc.util;\n" + "public interface Collection<E> {}\n" + "public interface List<E> {}\n" + "	public void add(E e);\n" + "}" };
        completeInJavadoc(sources, true, "javadoc.util.Collection");
        assertSortedResults("Collection[TYPE_REF]{javadoc.util.Collection, javadoc.util, Ljavadoc.util.Collection;, null, null, " + this.positions + R_DRICENQNR + "}");
    }
    ...
    public void testBug113376b() throws JavaModelException {
        ...
        String[] sources = { "/Completion/src/javadoc/bugs/BasicTestFields.java", "package javadoc.bugs;\n" + "/**\n" + " * {@link String.}\n" + " * \n" + " * @see javadoc.util.Collection\n" + " * @see javadoc.util.List#add(Object)\n" + " */public class BasicTestBugs<A> {\n" + "}", "/Completion/src/javadoc/util/Collection.java", "package javadoc.util;\n" + "public interface Collection<E> {}\n" + "public interface List<E> {}\n" + "	public void add(E e);\n" + "}" };
        // empty token
        completeInJavadoc(sources, true, "String.", 0);
        assertSortedResults("");
    }
 ...
 */
    public void testBug114341a() throws JavaModelException {
        ...
        assertSortedResults("Secondary.Member[JAVADOC_TYPE_REF]{{@link Member}, javadoc.text, Ljavadoc.text.Secondary$Member;, null, null, " + this.positions + R_DRICNRIT + "}\n" + "Secondary.Member[TYPE_REF]{Member, javadoc.text, Ljavadoc.text.Secondary$Member;, null, null, " + this.positions + R_DRICNR + "}");
    }
    ...
    public void testBug114341b() throws JavaModelException {
        ...
        assertSortedResults("Secondary.Member[TYPE_REF]{Member, javadoc.text, Ljavadoc.text.Secondary$Member;, null, null, " + this.positions + R_DRICNR + "}");
    }
 ...
 */
    ...
    public void testBug115662c() throws JavaModelException {
        ...
        assertSortedResults("toString[METHOD_REF]{toString(), Ljava.lang.Object;, ()Ljava.lang.String;, toString, null, " + this.positions + R_DRICENNRNS + "}");
    }
 ...
 */
    public void testBug118397a() throws JavaModelException {
        ...
        // 2nd occurence
        completeInJavadoc("/Completion/src/bugs/b118397/BasicTestBugs.java", source, true, "bugs.b118", 2);
        assertSortedResults("bugs.b118397[PACKAGE_REF]{bugs.b118397, bugs.b118397, null, null, null, " + this.positions + R_DRICQNR + "}");
    }
    ...
    public void testBug118397c() throws JavaModelException {
        ...
        assertSortedResults("BasicTestBugs.Inner[TYPE_REF]{Inner, bugs.b118397, Lbugs.b118397.BasicTestBugs$Inner;, null, null, " + this.positions + R_DRICNR + "}");
    }
    ...
    public void testBug118397d() throws JavaModelException {
        ...
        assertSortedResults("BasicTestBugs.Inner.Level2[TYPE_REF]{Level2, bugs.b118397, Lbugs.b118397.BasicTestBugs$Inner$Level2;, null, null, " + this.positions + R_DRICNR + "}");
    }
 ...
 */
    public void testBug139621a() throws JavaModelException {
        ...
        assertSortedResults("Object[TYPE_REF]{Object, java.lang, Ljava.lang.Object;, null, null, " + this.positions + R_DRICUNR + "}");
    }
 ...
 */
    public void testBug144866() throws JavaModelException {
        ...
        // 2nd occurence
        completeInJavadoc("/Completion/src/bugs/b144866/BasicTestBugs.java", source, true, "EX", 2);
        assertSortedResults("EXAMPLE[FIELD_REF]{EXAMPLE, Lbugs.b144866.BasicTestBugs;, I, EXAMPLE, null, " + this.positions + R_DRICNR + "}");
    }
 ...
 */
    public void testBug171016() throws JavaModelException {
        ...
        assertSortedResults("inheritDoc[JAVADOC_INLINE_TAG]{{@inheritDoc}, null, null, inheritDoc, null, " + this.positions + JAVADOC_RELEVANCE + "}");
    }
 ...
 */
    ...
    public void _testBug171031() throws JavaModelException {
        ...
        // should not have any proposal as
        assertSortedResults("");
    }
 ...
 */
    public void testBug185576a() throws JavaModelException {
        ...
        assertSortedResults("BasicTestBugs[TYPE_REF]{BasicTestBugs, bugs.b185576, Lbugs.b185576.BasicTestBugs;, null, null, " + emptyPositions + R_DRICUNR + "}");
    }
    ...
    public void testBug249785a() throws JavaModelException {
        ...
        assertSortedResults("field[FIELD_REF]{field, Lbugs.b171016.BasicTestBugs;, I, field, null, " + this.positions + R_DRICNRNS + "}");
    }
