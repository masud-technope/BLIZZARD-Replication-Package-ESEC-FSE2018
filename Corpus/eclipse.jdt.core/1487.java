 ...
 */
    public void testAddFileToNonJavaProject() throws CoreException {
        ...
        assertTrue("Project P should not be present already", indexOf("P", projects) == -1);
        try {
            createProject("P");
            this.createFile("/P/toto.txt", "");
            projects = model.getJavaProjects();
            assertTrue("Project P should not be present", indexOf("P", projects) == -1);
        } finally {
 ...
 */
    public void testCreateNonJavaProject() throws CoreException {
        try {
            ...
            waitForAutoBuild();
            IMarker[] markers = project.findMarkers(/*all type of markers*/
 ...
 */
    public void testCreatePkgHandleInDifferentProject() throws CoreException {
        try {
            ...
            assertElementEquals("Unexpected element", "x.y [in /P1/lib [in P2]]", element);
        } finally {
 ...
 */
    public void testGetJavaProjects1() throws CoreException {
        ...
        try {
            this.createJavaProject("P", new String[] {}, "");
            projects = model.getJavaProjects();
            assertTrue("Project P should be present", indexOf("P", projects) != -1);
            this.deleteProject("P");
            projects = model.getJavaProjects();
            assertTrue("Project P should not be present any longer", indexOf("P", projects) == -1);
        } finally {
            this.deleteProject("P");
        }
    }
 ...
 */
    public void testGetNonJavaResources() throws CoreException {
        try {
            ...
            assertResourceNamesEqual("Unexpected non-Java resources", "", model.getNonJavaResources());
            createProject("SP1");
            assertResourceNamesEqual("Unexpected non-Java resources after creation of SP1", "SP1", model.getNonJavaResources());
            createProject("SP2");
            assertResourceNamesEqual("Unexpected non-Java resources after creation of SP2", "SP1\n" + "SP2", model.getNonJavaResources());
            this.deleteProject("SP1");
            assertResourceNamesEqual("Unexpected non-Java resources after deletion of SP1", "SP2", model.getNonJavaResources());
        } finally {
            this.deleteProject("SP1");
 ...
 */
    public void testGetSchedulingRule1() {
        ...
        assertEquals("Unexpected scheduling rule", project.getResource(), project.getSchedulingRule());
    }
 ...
 */
    public void testGetSchedulingRule2() {
        ...
        assertEquals("Unexpected scheduling rule", root.getResource(), root.getSchedulingRule());
    }
 ...
 */
    public void testGetSchedulingRule4() {
        ...
        assertEquals("Unexpected scheduling rule", pkg.getResource(), pkg.getSchedulingRule());
    }
 ...
 */
    public void testInitializeAfterLoad2() throws CoreException {
        try {
            ...
            assertExceptionEquals("Unexpected exception", "org.eclipse.core.runtime.OperationCanceledException", actual);
        } finally {
            deleteProject("P1");
            deleteProject("P2");
        }
