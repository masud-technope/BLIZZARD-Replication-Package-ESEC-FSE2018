...
public class Java50Tests extends BuilderTests {
    ...
    public void testAnnotation() throws JavaModelException {
        ...
        expectingProblemsFor(usePath, "Problem : The annotation @Ann is disallowed for this location [ resource : </Project/p/Use.java> range : <11,17> category : <40> severity : <2>]");
    }
    ...
    public void testMissingRequiredBinaries() throws JavaModelException {
        ...
        new Problem("p1", "The type p2.Z cannot be resolved. It is indirectly referenced from required .class files", xx, 51, 67, CategorizedProblem.CAT_BUILDPATH, IMarker.SEVERITY_ERROR) });
    }
    ...
    public void testParameterizedType1() throws JavaModelException {
        ...
        incrementalBuild(projectPath);
        expectingProblemsFor(usePath, "Problem : The method foo(List<Object>) in the type Other is not applicable for the arguments (ArrayList<String>) [ resource : </Project/p/Use.java> range : <104,107> category : <50> severity : <2>]");
    }
    ...
    public void testParameterizedType2() throws JavaModelException {
        ...
        incrementalBuild(projectPath);
        expectingProblemsFor(usePath, "Problem : Unhandled exception type Exception [ resource : </Project/p/Use.java> range : <92,132> category : <40> severity : <2>]");
    }
