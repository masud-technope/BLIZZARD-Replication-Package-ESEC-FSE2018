...
public class InstanceOfExpression extends OperatorExpression {
    ...
    public  InstanceOfExpression(Expression expression, TypeReference type) {
        ...
        this.type = type;
        // https://bugs.eclipse.org/bugs/show_bug.cgi?id=282141
    ...
    public FlowInfo analyseCode(BlockScope currentScope, FlowContext flowContext, FlowInfo flowInfo) {
        ...
        if (local != null && (local.type.tagBits & TagBits.IsBaseType) == 0) {
            ...
            flowContext.recordUsingNullReference(currentScope, local, this.expression, FlowContext.CAN_ONLY_NULL | FlowContext.IN_INSTANCEOF, flowInfo);
...
*/
    ...
    public TypeBinding resolveType(BlockScope scope) {
        ...
        if (!checkedType.isReifiable()) {
            ...
            if (// disallow autoboxing
            (expressionType != TypeBinding.NULL && expressionType.isBaseType()) || !checkCastTypesCompatibility(scope, checkedType, expressionType, null)) {
