...
public interface _IAttributeDefinitionDescriptor {
    ...
    //$NON-NLS-1$
    public static final String BUILT_ATTRIBUTE = "abc";

    //$NON-NLS-1$
    public static final String WORK_ATTRIBUTE = "abc";

    //$NON-NLS-1$
    public static final String RANKING_ATTRIBUTE = "abc";

    //$NON-NLS-1$
    public static final String RANKING_ATTRIBUTE_V2 = "abc";

    //$NON-NLS-1$
    public static final String REFERENCE_ATTRIBUTE = "abc";
