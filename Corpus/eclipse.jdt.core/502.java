 ...
 */
    public void testAbstractMethod() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "foo() [in SuperInterface [in SuperInterface.java [in <default> [in src [in Resolve]]]]]", elements);
    }
    ...
    public void testAmbiguousMethod1() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "foo(Test1) [in Test [in [Working copy] Test.java [in test [in src [in Resolve]]]]]", elements);
    }
 ...
 */
    public void testArgumentName1() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "var1 [in foo(Object, int) [in ResolveArgumentName [in ResolveArgumentName.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
 ...
 */
    public void testArgumentName2() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "var2 [in foo(Object, int) [in ResolveArgumentName [in ResolveArgumentName.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
 ...
 */
    public void testArrayLength() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "", elements);
    }
 ...
 */
    public void testCatchArgumentName1() throws JavaModelException {
        ...
        IJavaElement[] elements = codeSelect(cu, "var1", "var1");
        assertElementsEqual("Unexpected elements", "var1 [in foo() [in ResolveCatchArgumentName [in ResolveCatchArgumentName.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
 ...
 */
    public void testCatchArgumentName2() throws JavaModelException {
        ICompilationUnit cu = getCompilationUnit("Resolve", "src", "", "ResolveCatchArgumentName.java");
        IJavaElement[] elements = codeSelect(cu, "var2", "var2");
        assertElementsEqual("Unexpected elements", "var2 [in foo() [in ResolveCatchArgumentName [in ResolveCatchArgumentName.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
 ...
 */
    public void testCatchArgumentType1() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "Y1 [in X1 [in X1.java [in <default> [in src [in Resolve]]]]]", elements);
    }
 ...
 */
    public void testCatchArgumentType3() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "exception [in foo() [in ResolveCatchArgumentType1 [in ResolveCatchArgumentType1.java [in <default> [in src [in Resolve]]]]]]", elements);
 ...
 */
    public void testClass1() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "X [in X.java [in p1 [in src [in Resolve]]]]", elements);
    }
 ...
 */
    public void testConstructor() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "ResolveConstructor(String) [in ResolveConstructor [in ResolveConstructor.java [in <default> [in src [in Resolve]]]]]", elements);
    }
 ...
 */
    public void testConstructor2() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "ResolveConstructorCall() [in ResolveConstructorCall [in ResolveConstructorCall.class [in <default> [in class-folder [in Resolve]]]]]", elements);
    }
 ...
 */
    public void testConstructor3() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "AClass [in [Working copy] Type.java [in test.p [in src [in Resolve]]]]", elements);
    }
 ...
 */
    public void testConstructor4() throws JavaModelException {
        ...
        IJavaElement[] elements = codeSelect(this.workingCopies[0], "AClass(unknown)", "AClass");
        assertElementsEqual("Unexpected elements", "AClass(Object) [in AClass [in [Working copy] Type.java [in test.p [in src [in Resolve]]]]]", elements);
    }
 ...
 */
    public void testConstructor5() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "ResolveConstructorCall2() [in ResolveConstructorCall2 [in ResolveConstructorCall2.class [in <default> [in class-folder [in Resolve]]]]]", elements);
    }
 ...
 */
    public void testConstructor6() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "ResolveConstructorCall3 [in ResolveConstructorCall3.class [in <default> [in class-folder [in Resolve]]]]", elements);
    }
 ...
 */
    public void testConstructorCallOfMemberType() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "Inner [in ResolveConstructorCallOfMemberType$Inner.class [in <default> [in class-folder [in Resolve]]]]", elements);
    }
    ...
    public void _testConstructorCallOfMemberType2() throws JavaModelException {
        ...
        IJavaElement[] elements = codeSelect(cf, "Inner();", "Inner");
        assertElementsEqual("Unexpected elements", "Inner(ResolveConstructorCallOfMemberType2) [in Inner [in ResolveConstructorCallOfMemberType2$Inner.class [in <default> [in class-folder [in Resolve]]]]]", elements);
    }
 ...
 */
    public void testConstructorDeclaration() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "ResolveConstructorDeclaration(int) [in ResolveConstructorDeclaration [in ResolveConstructorDeclaration.java [in <default> [in src [in Resolve]]]]]", elements);
    }
 ...
 */
    public void testEmptyCU1() throws JavaModelException {
        this.workingCopies = new ICompilationUnit[1];
        this.workingCopies[0] = getWorkingCopy("/Resolve/src/Test.java", "//this CU must contain only an unknown type name" + "Unknown\n" + "\n");
 ...
 */
    public void testEmptySelection() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "Object [in Object.class [in java.lang [in " + getExternalJCLPathString() + "]]]", elements);
    }
 ...
 */
    public void testEmptySelectionOnMethod() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "foo() [in ResolveEmptySelectionOnMethod [in ResolveEmptySelectionOnMethod.java [in <default> [in src [in Resolve]]]]]", elements);
    }
 ...
 */
    public void testExplicitSuperConstructorCall() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "SuperClass(int) [in SuperClass [in SuperClass.java [in <default> [in src [in Resolve]]]]]", elements);
    }
 ...
 */
    public void testExplicitThisConstructorCall() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "ResolveExplicitThisConstructorCall() [in ResolveExplicitThisConstructorCall [in ResolveExplicitThisConstructorCall.java [in <default> [in src [in Resolve]]]]]", elements);
    }
 ...
 */
    public void testField() throws JavaModelException {
        ...
        IJavaElement[] elements = codeSelect(cu, "foo =", "foo");
        assertElementsEqual("Unexpected elements", "foo [in ResolveField [in ResolveField.java [in <default> [in src [in Resolve]]]]]", elements);
    }
 ...
 */
    public void testFieldDeclaration() throws JavaModelException {
        ...
        IJavaElement[] elements = codeSelect(cu, "foo", "foo");
        assertElementsEqual("Unexpected elements", "foo [in ResolveFieldDeclaration [in ResolveFieldDeclaration.java [in <default> [in src [in Resolve]]]]]", elements);
    }
 ...
 */
    public void testImport() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "ImportedClass [in ImportedClass.java [in a.b [in src [in Resolve]]]]", elements);
    }
 ...
 */
    public void testInnerClassAsParamater() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "foo(Inner) [in ResolveInnerClassAsParamater [in ResolveInnerClassAsParamater.java [in <default> [in src [in Resolve]]]]]", elements);
    }
 ...
 */
    public void testInterface() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "Y [in Y.java [in p1 [in src [in Resolve]]]]", elements);
    }
 ...
 */
    public void testLocalClass1() throws JavaModelException {
        ...
        IJavaElement[] elements = codeSelect(cu, "Y[]", "Y");
        assertElementsEqual("Unexpected elements", "Y [in foo() [in ResolveLocalClass1 [in ResolveLocalClass1.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
 ...
 */
    public void testLocalClass2() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "Y [in foo() [in ResolveLocalClass2 [in ResolveLocalClass2.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
 ...
 */
    public void testLocalClass3() throws JavaModelException {
        ...
        IJavaElement[] elements = codeSelect(cu, "Y[]{", "Y");
        assertElementsEqual("Unexpected elements", "Y [in foo() [in ResolveLocalClass3 [in ResolveLocalClass3.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
 ...
 */
    public void testLocalClass4() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "Y [in foo() [in ResolveLocalClass4 [in ResolveLocalClass4.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
 ...
 */
    public void testLocalClass5() throws JavaModelException {
        ...
        IJavaElement[] elements = codeSelect(cu, "Y y", "Y");
        assertElementsEqual("Unexpected elements", "Y [in foo() [in ResolveLocalClass5 [in ResolveLocalClass5.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
 ...
 */
    public void testLocalClass6() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "Y [in foo() [in ResolveLocalClass6 [in ResolveLocalClass6.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
 ...
 */
    public void testLocalClass7() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "X [in <anonymous #2> [in foo2() [in ResolveLocalClass7 [in ResolveLocalClass7.java [in <default> [in src [in Resolve]]]]]]]", elements);
    }
 ...
 */
    public void testLocalClass8() throws JavaModelException {
        ...
        IJavaElement[] elements = select("/Resolve/src/test/Test.java", "package test;\n" + "public class Test\n" + "  void foo() {\n" + "    class LocalClass {}\n" + "    Object o = new LocalClass();\n" + "  }\n" + "}\n", "LocalClass");
        assertElementsEqual("Unexpected elements", "LocalClass [in foo() [in Test [in [Working copy] Test.java [in test [in src [in Resolve]]]]]]", elements);
    }
 ...
 */
    public void testLocalClass9() throws CoreException, IOException {
        try {
            ...
            addLibrary(project, "lib.jar", "libsrc.zip", new String[] { "X.java", "public class X {\n" + "  void foo() {\n" + "    class Y {\n" + "    }\n" + "  }\n" + "}" }, "1.4");
 ...
 */
    public void testLocalConstructor() throws JavaModelException {
        ...
        IJavaElement[] elements = codeSelect(cu, "Y(\"", "Y");
        assertElementsEqual("Unexpected elements", "Y(String) [in Y [in foo() [in ResolveLocalConstructor [in ResolveLocalConstructor.java [in <default> [in src [in Resolve]]]]]]]", elements);
    }
 ...
 */
    public void testLocalConstructorDeclaration() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "Y(int) [in Y [in foo() [in ResolveLocalConstructorDeclaration [in ResolveLocalConstructorDeclaration.java [in <default> [in src [in Resolve]]]]]]]", elements);
    }
 ...
 */
    public void testLocalField() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "fred [in Y [in foo() [in ResolveLocalField [in ResolveLocalField.java [in <default> [in src [in Resolve]]]]]]]", elements);
    }
 ...
 */
    public void testLocalField2() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "var [in <anonymous #2> [in foo2() [in ResolveLocalField2 [in ResolveLocalField2.java [in <default> [in src [in Resolve]]]]]]]", elements);
    }
 ...
 */
    public void testLocalFieldDeclaration() throws JavaModelException {
        ...
        IJavaElement[] elements = codeSelect(cu, "fred", "fred");
        assertElementsEqual("Unexpected elements", "fred [in Y [in foo() [in ResolveLocalFieldDeclaration [in ResolveLocalFieldDeclaration.java [in <default> [in src [in Resolve]]]]]]]", elements);
    }
 ...
 */
    public void testLocalMemberTypeDeclaration() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "Member [in Y [in foo() [in ResolveLocalMemberTypeDeclaration1 [in ResolveLocalMemberTypeDeclaration1.java [in <default> [in src [in Resolve]]]]]]]", elements);
    }
 ...
 */
    public void testLocalMemberTypeDeclaration2() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "MemberOfMember [in Member [in Y [in foo() [in ResolveLocalMemberTypeDeclaration2 [in ResolveLocalMemberTypeDeclaration2.java [in <default> [in src [in Resolve]]]]]]]]", elements);
    }
 ...
 */
    public void testLocalMethod() throws JavaModelException {
        ...
        IJavaElement[] elements = codeSelect(cu, "foo(\"", "foo");
        assertElementsEqual("Unexpected elements", "foo(String) [in Y [in bar() [in ResolveLocalMethod [in ResolveLocalMethod.java [in <default> [in src [in Resolve]]]]]]]", elements);
    }
 ...
 */
    public void testLocalMethod2() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "bar() [in <anonymous #2> [in foo2() [in ResolveLocalMethod2 [in ResolveLocalMethod2.java [in <default> [in src [in Resolve]]]]]]]", elements);
    }
 ...
 */
    public void testLocalMethodDeclaration() throws JavaModelException {
        ...
        IJavaElement[] elements = codeSelect(cu, "foo(i", "foo");
        assertElementsEqual("Unexpected elements", "foo(int) [in Y [in bar() [in ResolveLocalMethodDeclaration [in ResolveLocalMethodDeclaration.java [in <default> [in src [in Resolve]]]]]]]", elements);
    }
 ...
 */
    public void testLocalName1() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "var1 [in foo() [in ResolveLocalName [in ResolveLocalName.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
 ...
 */
    public void testLocalName2() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "var2 [in foo() [in ResolveLocalName [in ResolveLocalName.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
 ...
 */
    public void testLocalName5() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "var3 [in foo() [in ResolveLocalName [in ResolveLocalName.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
 ...
 */
    public void testLocalName7() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "var4 [in foo() [in ResolveLocalName [in ResolveLocalName.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
 ...
 */
    public void testLocalVarTypeSignature1() throws JavaModelException {
        ILocalVariable localVar = getLocalVariable("/Resolve/src/ResolveLocalName.java", "var1 = new Object();", "var1");
        assertEquals("Unexpected type signature", "QObject;", localVar.getTypeSignature());
    }
 ...
 */
    public void testLocalVarTypeSignature2() throws JavaModelException {
        ...
        assertEquals("Unexpected type signature", "I", localVar.getTypeSignature());
    }
 ...
 */
    public void testMemberTypeDeclaration() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "MemberInterface [in ResolveMemberTypeDeclaration1 [in ResolveMemberTypeDeclaration1.java [in <default> [in src [in Resolve]]]]]", elements);
    }
 ...
 */
    public void testMemberTypeDeclaration2() throws JavaModelException {
        ...
        IJavaElement[] elements = codeSelect(cu, "MemberOfMember", "MemberOfMember");
        assertElementsEqual("Unexpected elements", "MemberOfMember [in Member [in ResolveMemberTypeDeclaration2 [in ResolveMemberTypeDeclaration2.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
 ...
 */
    public void testMethod() throws JavaModelException {
        ...
        IJavaElement[] elements = codeSelect(cu, "foo(\"", "foo");
        assertElementsEqual("Unexpected elements", "foo(String) [in ResolveMethod [in ResolveMethod.java [in <default> [in src [in Resolve]]]]]", elements);
    }
 ...
 */
    public void testMethodDeclaration() throws JavaModelException {
        ...
        IJavaElement[] elements = codeSelect(cu, "foo(i", "foo");
        assertElementsEqual("Unexpected elements", "foo(int) [in ResolveMethodDeclaration [in ResolveMethodDeclaration.java [in <default> [in src [in Resolve]]]]]", elements);
    }
 ...
 */
    public void testMethodDeclarationInAnonymous() throws JavaModelException {
        ...
        IJavaElement[] elements = codeSelect(cu, "bar()", "bar");
        assertElementsEqual("Unexpected elements", "bar() [in <anonymous #1> [in foo() [in ResolveMethodDeclarationInAnonymous [in ResolveMethodDeclarationInAnonymous.java [in <default> [in src [in Resolve]]]]]]]", elements);
    }
 ...
 */
    public void testMethodDeclarationInAnonymous2() throws JavaModelException {
        ...
        IJavaElement[] elements = codeSelect(cu, "foo()", "foo");
        assertElementsEqual("Unexpected elements", "foo() [in <anonymous #1> [in field [in ResolveMethodDeclarationInAnonymous2 [in ResolveMethodDeclarationInAnonymous2.java [in <default> [in src [in Resolve]]]]]]]", elements);
    }
 ...
 */
    public void testMethodDeclarationInAnonymous3() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "selectMe() [in <anonymous #1> [in bar() [in <anonymous #1> [in foo() [in ResolveMethodDeclarationInAnonymous3 [in ResolveMethodDeclarationInAnonymous3.java [in <default> [in src [in Resolve]]]]]]]]]", elements);
    }
 ...
 */
    public void testMethodDeclarationInAnonymous4() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "bar() [in <anonymous> [in X$1.class [in p [in test47214.jar [in Resolve]]]]]", elements);
    }
 ...
 */
    public void testMethodWithIncorrectParameter() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "foo(int) [in ResolveMethodWithIncorrectParameter [in ResolveMethodWithIncorrectParameter.java [in <default> [in src [in Resolve]]]]]", elements);
    }
    ...
    public void testMethodWithIncorrectParameter2() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "called(String) [in Test [in [Working copy] Test.java [in test [in src [in Resolve]]]]]", elements);
    }
 ...
 */
    public void testMethodWithInnerTypeInClassFile() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "test() [in MyClass [in MyClass.class [in <default> [in zzz.jar [in Resolve]]]]]", elements);
    }
 ...
 */
    public void testMethodWithInnerTypeInClassFile2() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "method(MyClass2.Inner[]) [in MyClass2 [in MyClass2.class [in <default> [in zzz.jar [in Resolve]]]]]", elements);
 ...
 */
    public void testNegativeResolveUnicode() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "String [in String.class [in java.lang [in " + getExternalJCLPathString() + "]]]", elements);
    }
 ...
 */
    public void testPackage() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "java.lang [in " + getExternalJCLPathString() + "]", elements);
    }
 ...
 */
    public void testStaticClassConstructor() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "StaticInnerClass() [in StaticInnerClass [in ResolveStaticClassConstructor$StaticInnerClass.class [in <default> [in test25888.jar [in Resolve]]]]]", elements);
    }
 ...
 */
    public void testTypeDeclaration() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "OtherType [in ResolveTypeDeclaration.java [in <default> [in src [in Resolve]]]]", elements);
    }
 ...
 */
    public void testTypeInComment() throws JavaModelException {
        ...
        IJavaElement[] elements = codeSelect(cu, "X */", "X");
        assertElementsEqual("Unexpected elements", "X [in X.java [in p2 [in src [in Resolve]]]]", elements);
    }
 ...
 */
    ...
    public void testUnicode2() throws JavaModelException {
        ...
        int length = "".length();
        IJavaElement[] elements = this.workingCopies[0].codeSelect(start, length, this.wcOwner);
        assertElementsEqual("Unexpected elements", "B [in [Working copy] B.java [in test [in src [in Resolve]]]]", elements);
    }
 ...
 */
    public void testLocalNameForClassFile() throws JavaModelException {
        ...
        //Resolve a local declaration name
        IJavaElement[] elements = codeSelect(cu, "var1 = new Object();", "var1");
        assertElementsEqual("Unexpected elements", "var1 [in foo() [in ResolveLocalName [in ResolveLocalName.class [in <default> [in test47177.jar [in Resolve]]]]]]", elements);
        // Resolve a local declaration name with base type
        elements = codeSelect(cu, "var2 = 1;", "var2");
        assertElementsEqual("Unexpected elements", "var2 [in foo() [in ResolveLocalName [in ResolveLocalName.class [in <default> [in test47177.jar [in Resolve]]]]]]", elements);
        // Resolve a local variable reference
        ...
        assertElementsEqual("Unexpected elements", "var3 [in foo() [in ResolveLocalName [in ResolveLocalName.class [in <default> [in test47177.jar [in Resolve]]]]]]", elements);
        // Resolve a local variable reference
        elements = codeSelect(cu, "var3.toString();", "var3");
        assertElementsEqual("Unexpected elements", "var3 [in foo() [in ResolveLocalName [in ResolveLocalName.class [in <default> [in test47177.jar [in Resolve]]]]]]", elements);
        // Resolve a local variable reference
        elements = codeSelect(cu, "var4;", "var4");
        assertElementsEqual("Unexpected elements", "var4 [in foo() [in ResolveLocalName [in ResolveLocalName.class [in <default> [in test47177.jar [in Resolve]]]]]]", elements);
    }
 ...
 */
    public void testMethodDeclarationInInterface() throws JavaModelException {
        ...
        IJavaElement[] elements = codeSelect(cu, "foo", "foo");
        assertElementsEqual("Unexpected elements", "foo() [in QI [in QI.class [in <default> [in jj.jar [in Resolve]]]]]", elements);
    }
    ...
    public void testMethodInAnonymous1() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.workingCopies[0].codeSelect(start, length, this.wcOwner);
        assertElementsEqual("Unexpected elements", "foo(boolean) [in Test2 [in [Working copy] Test2.java [in <default> [in src [in Resolve]]]]]", elements);
    }
 ...
 */
    ...
    public void testDuplicateLocals1() throws JavaModelException {
        ...
        int length = "x".length();
        IJavaElement[] elements = this.workingCopies[0].codeSelect(start, length, this.wcOwner);
        assertElementsEqual("Unexpected elements", "x [in foo() [in Test [in [Working copy] Test.java [in test [in src [in Resolve]]]]]]", elements);
        assertEquals("Unexpected type", "QTestString;", ((ILocalVariable) elements[0]).getTypeSignature());
    ...
    public void testDuplicateLocals2() throws JavaModelException {
        ...
        int length = "x".length();
        IJavaElement[] elements = this.workingCopies[0].codeSelect(start, length, this.wcOwner);
        assertElementsEqual("Unexpected elements", "x [in main(String[]) [in Test [in [Working copy] Test.java [in test [in src [in Resolve]]]]]]", elements);
        assertEquals("Unexpected type", "QTestException;", ((ILocalVariable) elements[0]).getTypeSignature());
    }
    ...
    public void testDuplicateLocalsType1() throws JavaModelException {
        ...
        IJavaElement[] elements = this.workingCopies[0].codeSelect(start, length, this.wcOwner);
        assertElementsEqual("Unexpected elements", "bar() [in Local#2 [in foo() [in Test [in [Working copy] Test.java [in test [in src [in Resolve]]]]]]]", elements);
    }
    ...
    public void testDuplicateLocalsType2() throws JavaModelException {
        ...
        int length = "foo".length();
        IJavaElement[] elements = this.workingCopies[0].codeSelect(start, length, this.wcOwner);
        assertElementsEqual("Unexpected elements", "foo() [in Local [in foo() [in Test [in [Working copy] Test.java [in test [in src [in Resolve]]]]]]]", elements);
    }
 ...
 */
    public void testDuplicateMethodDeclaration() throws JavaModelException {
        ...
        int length = "foo".length();
        IJavaElement[] elements = cu.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "foo() [in ResolveDuplicateMethodDeclaration [in ResolveDuplicateMethodDeclaration.java [in <default> [in src [in Resolve]]]]]", elements);
    }
 ...
 */
    public void testDuplicateMethodDeclaration2() throws JavaModelException {
        ...
        int length = "foo".length();
        IJavaElement[] elements = cu.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "foo()#2 [in ResolveDuplicateMethodDeclaration [in ResolveDuplicateMethodDeclaration.java [in <default> [in src [in Resolve]]]]]", elements);
    }
    ...
    public void testDuplicateMethodDeclaration3() throws JavaModelException {
        ...
        int length = "foo".length();
        IJavaElement[] elements = cu.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "foo(Object) [in ResolveDuplicateMethodDeclaration3 [in ResolveDuplicateMethodDeclaration3.java [in <default> [in src [in Resolve]]]]]", elements);
    }
    ...
    public void testDuplicateMethodDeclaration4() throws JavaModelException {
        ...
        int length = "foo".length();
        IJavaElement[] elements = cu.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "foo(Object)#2 [in ResolveDuplicateMethodDeclaration3 [in ResolveDuplicateMethodDeclaration3.java [in <default> [in src [in Resolve]]]]]", elements);
    }
    ...
    public void testDuplicateMethodDeclaration5() throws JavaModelException {
        ...
        int length = "foo".length();
        IJavaElement[] elements = cu.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "foo(Zork) [in ResolveDuplicateMethodDeclaration5 [in ResolveDuplicateMethodDeclaration5.java [in <default> [in src [in Resolve]]]]]", elements);
    }
    ...
    public void testDuplicateMethodDeclaration6() throws JavaModelException {
        ...
        int length = "foo".length();
        IJavaElement[] elements = cu.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "foo(Zork)#2 [in ResolveDuplicateMethodDeclaration5 [in ResolveDuplicateMethodDeclaration5.java [in <default> [in src [in Resolve]]]]]", elements);
    }
    ...
    public void testDuplicateMethodDeclaration7() throws JavaModelException {
        ...
        int length = "foo".length();
        IJavaElement[] elements = cu.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "foo(Zork) [in Inner [in ResolveDuplicateMethodDeclaration7 [in ResolveDuplicateMethodDeclaration7.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
    ...
    public void testDuplicateMethodDeclaration8() throws JavaModelException {
        ...
        int length = "foo".length();
        IJavaElement[] elements = cu.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "foo(Zork)#2 [in Inner [in ResolveDuplicateMethodDeclaration7 [in ResolveDuplicateMethodDeclaration7.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
    ...
    public void testDuplicateMethodDeclaration9() throws JavaModelException {
        ...
        int length = "foo".length();
        IJavaElement[] elements = cu.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "foo(Zork) [in Inner [in ResolveDuplicateMethodDeclaration9 [in ResolveDuplicateMethodDeclaration9.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
    ...
    public void testDuplicateMethodDeclaration10() throws JavaModelException {
        ...
        int length = "foo".length();
        IJavaElement[] elements = cu.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "foo(Zork)#2 [in Inner [in ResolveDuplicateMethodDeclaration9 [in ResolveDuplicateMethodDeclaration9.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
    ...
    public void testDuplicateMethodDeclaration11() throws JavaModelException {
        ...
        int length = "foo".length();
        IJavaElement[] elements = cu.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "foo(Zork) [in Inner#2 [in ResolveDuplicateMethodDeclaration11 [in ResolveDuplicateMethodDeclaration11.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
    ...
    public void testDuplicateMethodDeclaration12() throws JavaModelException {
        ...
        int length = "foo".length();
        IJavaElement[] elements = cu.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "foo(Zork)#2 [in Inner#2 [in ResolveDuplicateMethodDeclaration11 [in ResolveDuplicateMethodDeclaration11.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
    ...
    public void testDuplicateFieldDeclaration() throws JavaModelException {
        ...
        IJavaElement[] elements = cu.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "var [in Inner [in ResolveDuplicateFieldDeclaration [in ResolveDuplicateFieldDeclaration.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
    ...
    public void testDuplicateFieldDeclaration2() throws JavaModelException {
        ...
        int length = "var".length();
        IJavaElement[] elements = cu.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "var#2 [in Inner [in ResolveDuplicateFieldDeclaration [in ResolveDuplicateFieldDeclaration.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
    ...
    public void testDuplicateFieldDeclaration3() throws JavaModelException {
        ...
        int length = "var".length();
        IJavaElement[] elements = cu.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "var [in Inner#2 [in ResolveDuplicateFieldDeclaration3 [in ResolveDuplicateFieldDeclaration3.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
    ...
    public void testDuplicateFieldDeclaration4() throws JavaModelException {
        ...
        int length = "var".length();
        IJavaElement[] elements = cu.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "var#2 [in Inner#2 [in ResolveDuplicateFieldDeclaration3 [in ResolveDuplicateFieldDeclaration3.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
    ...
    public void testDuplicateTypeDeclaration() throws JavaModelException {
        ...
        IJavaElement[] elements = cu.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "Inner [in ResolveDuplicateTypeDeclaration [in ResolveDuplicateTypeDeclaration.java [in <default> [in src [in Resolve]]]]]", elements);
    }
    ...
    public void testDuplicateTypeDeclaration2() throws JavaModelException {
        ...
        int length = "Inner".length();
        IJavaElement[] elements = cu.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "Inner#2 [in ResolveDuplicateTypeDeclaration [in ResolveDuplicateTypeDeclaration.java [in <default> [in src [in Resolve]]]]]", elements);
    }
    ...
    public void testDuplicateTypeDeclaration3() throws JavaModelException {
        ...
        IJavaElement[] elements = cu.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "Inner2 [in Inner [in ResolveDuplicateTypeDeclaration3 [in ResolveDuplicateTypeDeclaration3.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
    ...
    public void testDuplicateTypeDeclaration4() throws JavaModelException {
        ...
        int length = "Inner2".length();
        IJavaElement[] elements = cu.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "Inner2#2 [in Inner [in ResolveDuplicateTypeDeclaration3 [in ResolveDuplicateTypeDeclaration3.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
    ...
    public void testDuplicateTypeDeclaration5() throws JavaModelException {
        ...
        int length = "Inner2".length();
        IJavaElement[] elements = cu.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "Inner2 [in Inner#2 [in ResolveDuplicateTypeDeclaration5 [in ResolveDuplicateTypeDeclaration5.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
    ...
    public void testDuplicateTypeDeclaration6() throws JavaModelException {
        ...
        int length = "Inner2".length();
        IJavaElement[] elements = cu.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "Inner2#2 [in Inner#2 [in ResolveDuplicateTypeDeclaration5 [in ResolveDuplicateTypeDeclaration5.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
    ...
    public void testDuplicateTypeDeclaration7() throws CoreException, IOException {
        ...
        try {
            String[] pathAndContents = new String[] { "test/p/Type.java", "package test.p;" + "public class Type {\n" + "}\n" };
            ...
            IJavaElement[] elements = this.workingCopies[0].codeSelect(start, length, this.wcOwner);
            assertElementsEqual("Unexpected elements", "Type [in [Working copy] Type.java [in test.p [in src [in Resolve]]]]", elements);
        } finally {
    ...
    public void testDuplicateTypeDeclaration8() throws JavaModelException {
        ...
        int length = "Type".length();
        IJavaElement[] elements = this.workingCopies[0].codeSelect(start, length, this.wcOwner);
        assertElementsEqual("Unexpected elements", "Type [in [Working copy] Type.java [in test.p1 [in src [in Resolve]]]]", elements);
    }
    ...
    public void testArrayParameterInsideParent1() throws JavaModelException {
        ...
        int length = "var".length();
        IJavaElement[] elements = cu.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "var [in test(int[]) [in ResolveArrayParameterInsideParent1 [in ResolveArrayParameterInsideParent1.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
    ...
    public void testDeepLocalVariable() throws JavaModelException {
        ...
        int length = "foo".length();
        IJavaElement[] elements = cu.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "foo [in D9() [in D9 [in D8 [in D7 [in D6 [in D5 [in D4 [in D3 [in D2 [in D1 [in ResolveDeepLocalVariable [in ResolveDeepLocalVariable.java [in <default> [in src [in Resolve]]]]]]]]]]]]]]]", elements);
    }
 ...
 */
    public void testLocalVariable() throws JavaModelException {
        ...
        IJavaElement[] elements = codeSelect(cu, "var =", "var");
        assertElementsEqual("Unexpected elements", "var [in toto() [in <anonymous #2> [in foo2() [in ResolveLocalVariable [in ResolveLocalVariable.java [in <default> [in src [in Resolve]]]]]]]]", elements);
    }
 ...
 */
    public void testQualifiedName1() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "ZZ [in YY [in XX [in XX.java [in pp.qq [in src [in Resolve]]]]]]", elements);
    }
 ...
 */
    public void testQualifiedName5() throws JavaModelException {
        ...
        IJavaElement[] elements = codeSelect(cu, "YY.ZZ", "YY.ZZ");
        assertElementsEqual("Unexpected elements", "ZZ [in YY [in XX [in ResolveQualifiedName5 [in ResolveQualifiedName5.java [in <default> [in src [in Resolve]]]]]]]", elements);
    }
    ...
    public void testTypeInsideConstructor() throws JavaModelException {
        ...
        try {
            imported = getWorkingCopy("/Resolve/src/test/AType.java", "public class AType {\n" + "	public class Sub {\n" + "	}\n" + "}\n");
            IJavaElement[] elements = select("/Resolve/src/test/Test.java", "public class Test<\n" + "	void foo() {\n" + "	  new Test.Sub();\n" + "	}\n" + "}\n", "Test");
            assertElementsEqual("Unexpected elements", "Test [in [Working copy] Test.java [in test [in src [in Resolve]]]]", elements);
        } finally {
            if (imported != null) {
    ...
    public void testMemberTypeInImport() throws JavaModelException {
        ...
        try {
            imported = getWorkingCopy("/Resolve/src/test/AType.java", "public class AType {\n" + "	public class Sub {\n" + "	}\n" + "}\n");
            IJavaElement[] elements = select("/Resolve/src/test/Test.java", "import test.AType.Sub;\n" + "public class Test\n" + "}\n", "Sub");
            assertElementsEqual("Unexpected elements", "Sub [in AType [in [Working copy] AType.java [in test [in src [in Resolve]]]]]", elements);
        } finally {
            if (imported != null) {
                imported.discardWorkingCopy();
            }
    ...
    public void testSingleNameInImport() throws JavaModelException {
        ...
        try {
            aType = getWorkingCopy("/Resolve/src/zzz/AType.java", "package zzz;\n" + "public class AType {\n" + "}\n");
            IJavaElement[] elements = select("/Resolve/src/test/Test.java", "package test;\n" + "import zzz.*;\n" + "public class Test\n" + "}\n", "zzz");
            assertElementsEqual("Unexpected elements", "zzz [in src [in Resolve]]", elements);
        } finally {
            if (aType != null) {
 ...
 */
    public void testSecondaryTypes() throws JavaModelException {
        ...
        IJavaElement[] elements = cu.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "Secondary [in Test.java [in b120350 [in src [in Resolve]]]]", elements);
    }

    //https://bugs.eclipse.org/bugs/show_bug.cgi?id=192497
    public void testSelectOnCursor1() throws JavaModelException {
        ICompilationUnit cu = getWorkingCopy("/Resolve/src/AType.java", "public class AType {\n" + "  public void doLoad(){}\n" + "  public void foo() {\n" + "    doLoad();\n" + "  }\n" + "}\n");
        String str = cu.getSource();
        // perform code select between 'd' and 'o'
        int start = str.indexOf("oLoad();");
        int length = 0;
        IJavaElement[] elements = cu.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "doLoad() [in AType [in [Working copy] AType.java [in <default> [in src [in Resolve]]]]]", elements);
    }

    //https://bugs.eclipse.org/bugs/show_bug.cgi?id=207572
    public void testSelectOnCursor2() throws JavaModelException {
        ICompilationUnit cu = getWorkingCopy("/Resolve/src/AType.java", "public class X {\n" + "        Object o;\n" + "\n" + "        String foo() {\n" + "                return \"aaa\n" + "        }\n" + "}n");
        String str = cu.getSource();
        int start = str.indexOf("foo") + "fo".length();
        int length = 0;
        IJavaElement[] elements = cu.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "foo() [in X [in [Working copy] AType.java [in <default> [in src [in Resolve]]]]]", elements);
    }
 ...
 */
    public void testWorkingCopyOrder1() throws JavaModelException {
        ...
        assertElementEquals("Unexpected type", "Type [in [Working copy] Type.java [in test.p [in src [in Resolve]]]]", foundType);
    }
 ...
 */
    public void testWorkingCopyOrder2() throws Exception {
        ...
        try {
            String[] pathAndContents = new String[] { "test/p/Type.java", "package test.p;\n" + "public class Type {\n" + "}\n" };
            addLibrary(jarName, srcName, pathAndContents, JavaCore.VERSION_1_4);
            this.workingCopies = new ICompilationUnit[1];
            this.workingCopies[0] = getWorkingCopy("/Resolve/src/test/p/Type.java", "package test.p;\n" + "public class Type {\n" + "}\n");
            IJavaProject javaProject = getJavaProject("Resolve");
    ...
    public void testInvalidField1() throws JavaModelException {
        ICompilationUnit cu = getWorkingCopy("/Resolve/src/test/Test.java", "package test;" + "public class Event {\n" + "        public int x;\n" + "\n" + "        public void handle(Event e) {\n" + "                e.x.eee.foo();\n" + "        }\n" + "}");
        String str = cu.getSource();
    ...
    public void testInterfaceX() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "Proto [in Bug [in [Working copy] Bug.java [in test [in src [in Resolve]]]]]", elements);
    }
    ...
    public void test306078() throws JavaModelException {
        ...
        int length = "X".length();
        IJavaElement[] elements = this.workingCopies[1].codeSelect(start, length, this.wcOwner);
        assertElementsEqual("Unexpected elements", "X [in A [in [Working copy] A.java [in <default> [in src [in Resolve]]]]]", elements);
    }
    ...
    public void testCodeSelectInHybrid1415Projects() throws CoreException, IOException {
        ...
        try {
            String[] pathAndContents = new String[] { "TestSuite.java", "public class TestSuite {\n" + "    public TestSuite(final Class<? extends TestCase> p) {}\n" + "}\n" + "class TestCase {}\n" };
            ...
            IJavaElement[] elements = this.workingCopies[0].codeSelect(start, length, this.wcOwner);
            assertElementsEqual("Unexpected elements", "TestSuite(java.lang.Class) [in TestSuite [in TestSuite.class [in <default> [in bug299384.jar [in Resolve]]]]]", elements);
        } finally {
            removeLibrary(this.currentProject, jarName, srcName);
        }
    }
    ...
    public void testMethodParameter() throws JavaModelException {
        ...
        int length = "x".length();
        IJavaElement[] elements = this.workingCopies[0].codeSelect(start, length, this.wcOwner);
        assertElementsEqual("Unexpected elements", "x [in foo(int) [in Test [in [Working copy] Test.java [in test [in src [in Resolve]]]]]]", elements);
    ...
    public void testConstantInLocal() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.workingCopies[0].codeSelect(start, length, this.wcOwner);
        assertElementsEqual("Unexpected elements", "FINAL [in <anonymous #1> [in main(String[]) [in X [in [Working copy] Test2.java [in <default> [in src [in Resolve]]]]]]]", elements);
        selectAt = "CONSTANT";
        selection = "CONSTANT";
        start = str.indexOf(selectAt);
        length = selection.length();
        elements = this.workingCopies[0].codeSelect(start, length, this.wcOwner);
        assertElementsEqual("Unexpected elements", "CONSTANT [in Local [in main(String[]) [in X [in [Working copy] Test2.java [in <default> [in src [in Resolve]]]]]]]", elements);
    }
}
