 ...
 */
    public void test03() {
        String str = "public class X extends java.io.IOException {	\n" + "}												\n";
        String selectionStartBehind = "java.io.";
        String selectionEndBehind = "IOException";
        String expectedCompletionNodeToString = "<SelectOnType:java.io.IOException>";
        String completionIdentifier = "IOException";
        String expectedUnitDisplayString = "public class X extends <SelectOnType:java.io.IOException> {\n" + "  public X() {\n" + "  }\n" + "}\n";
 ...
 */
    public void test04() {
        ...
        String expectedUnitDisplayString = "public class X extends <SelectOnType:java.io> {\n" + "  public X() {\n" + "  }\n" + "}\n";
        String expectedReplacedSource = "java.io.IOException";
 ...
 */
    public void test05() {
        ...
        String expectedUnitDisplayString = "public class X extends java.io.IOException {\n" + "  public X() {\n" + "  }\n" + "  int foo() {\n" + "    <SelectOnMessageSend:System.out.println(\"hello\")>;\n" + "  }\n" + "}\n";
 ...
 */
    public void test06() {
        String str = "public class X extends 						\n" + "	int foo(){									\n" + "		System.out.println(\"hello\");			\n";
        String selectionStartBehind = "System.out.";
        String selectionEndBehind = "println";
        String expectedCompletionNodeToString = "<SelectOnMessageSend:System.out.println(\"hello\")>";
        String completionIdentifier = "println";
 ...
 */
    public void test18() {
        ...
        String expectedCompletionNodeToString = "<SelectOnAllocationExpression:new Object() {\n" + "}>";
 ...
 */
    public void test21() {
        ...
        String expectedUnitDisplayString = "import <SelectOnImport:x.y.Other>;\n" + "public class X {\n" + "  public X() {\n" + "  }\n" + "  int foo() {\n" + "  }\n" + "}\n";
        String expectedReplacedSource = "x.y.Other";
 ...
 */
    public void test33() {
        ...
        String expectedUnitDisplayString = "import java.util.AbstractMap;\n" + "public class c4 extends AbstractMap {\n" + "  public c4() {\n" + "  }\n" + "  public <SelectOnType:Set> entrySet() {\n" + "  }\n" + "}\n";
