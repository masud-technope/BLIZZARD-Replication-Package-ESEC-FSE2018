...
public class JavaDocTestCase extends MultiLineTestCase {
    ...
    public void testSingleLineComment2() {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        assertEquals(PREFIX + DELIMITER + INFIX + "test" + DELIMITER + POSTFIX, testFormat(PREFIX + "test" + DELIMITER + "\t" + POSTFIX));
    }
    ...
    public void testSingleLineCommentSpace1() {
        //$NON-NLS-1$ //$NON-NLS-2$
        assertEquals(PREFIX + " test" + POSTFIX, testFormat(PREFIX + "test*/"));
    }

    public void testSingleLineCommentSpace2() {
        //$NON-NLS-1$ //$NON-NLS-2$
        assertEquals(PREFIX + " test" + POSTFIX, testFormat(PREFIX + "test" + POSTFIX));
    }
    ...
    public void testSingleLineCommentSpace4() {
        //$NON-NLS-1$ //$NON-NLS-2$
        assertEquals(PREFIX + " test test" + POSTFIX, testFormat(PREFIX + " test   test*/"));
    }

    public void testSingleLineCommentTabs1() {
        //$NON-NLS-1$ //$NON-NLS-2$
        assertEquals(PREFIX + " test test" + POSTFIX, testFormat(PREFIX + "\ttest\ttest" + POSTFIX));
    }
    ...
    public void testMultiLineCommentBreak1() {
        //$NON-NLS-1$
        String input = PREFIX + " test<br>test" + POSTFIX;
        //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public void testMultiLineCommentCodeSnippet1() {
        ...
        //$NON-NLS-1$
        String postfix = DELIMITER + INFIX + "</pre>" + DELIMITER + POSTFIX;
        //$NON-NLS-1$
        String input = prefix + "while (i != 0) i--;" + postfix;
        //$NON-NLS-1$//$NON-NLS-2$
        String expected = prefix + "while (i != 0)" + DELIMITER + INFIX + "\ti--;" + postfix;
    ...
    public void testMultiLineCommentCodeSnippet2() {
        ...
        String input = prefix + "while (i != 0) { i--; }" + postfix;
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        String expected = prefix + "while (i != 0) {" + DELIMITER + INFIX + "\ti--;" + DELIMITER + INFIX + "}" + postfix;
        String result = testFormat(input);
        assertEquals(expected, result);
        result = testFormat(result);
        result = testFormat(result);
    ...
    public void testMultiLineCommentCodeSnippet4() {
        ...
        //$NON-NLS-1$
        setUserOption(DefaultCodeFormatterConstants.FORMATTER_LINE_SPLIT, "80");
        String result = testFormat(input);
        assertEquals(expected, result);
    }
    ...
    public void testMultiLineCommentCodeSnippetHtmlEntities1() {
        ...
        String postfix = DELIMITER + INFIX + "</pre>" + DELIMITER + POSTFIX;
        //$NON-NLS-1$
        String input = prefix + "System.out.  println(\"test\");" + postfix;
        //$NON-NLS-1$
        String expected = prefix + "System.out.println(\"test\");" + postfix;
        String result = testFormat(input);
        assertEquals(expected, result);
        result = testFormat(result);
        result = testFormat(result);
    ...
    public void testMultiLineCommentIndentSpaces1() {
        ...
        //$NON-NLS-1$
        setUserOption(DefaultCodeFormatterConstants.FORMATTER_INDENTATION_SIZE, "3");
        assertEquals(prefix + expected + postfix, testFormat(prefix + content + postfix, prefix.length(), content.length()));
    }
    ...
    public void testMultiLineCommentLineBreakBeforeImmutableRegions1() {
        //$NON-NLS-1$
        setUserOption(DefaultCodeFormatterConstants.FORMATTER_COMMENT_LINE_LENGTH, "22");
        //$NON-NLS-1$
    ...
    public void testMultiLineCommentLineBreakBeforeImmutableRegions2() {
        //$NON-NLS-1$
        setUserOption(DefaultCodeFormatterConstants.FORMATTER_COMMENT_LINE_LENGTH, "21");
        //$NON-NLS-1$
        String input = PREFIX + DELIMITER + INFIX + "a <code>test</code>" + DELIMITER + POSTFIX;
        //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public void testMultiLineCommentLineBreakBeforeImmutableRegions3() {
        //$NON-NLS-1$
        setUserOption(DefaultCodeFormatterConstants.FORMATTER_COMMENT_LINE_LENGTH, "20");
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        String input = PREFIX + DELIMITER + INFIX + "a <code>" + DELIMITER + INFIX + "testestestestestestestestestest" + DELIMITER + INFIX + "</code>" + DELIMITER + POSTFIX;
        String expected = input;
        String result = testFormat(input);
        assertEquals(expected, result);
    }
    ...
    public void testMultiLineCommentBlankLineBeforeJavadoctags1() {
        //$NON-NLS-1$
        setUserOption(DefaultCodeFormatterConstants.FORMATTER_COMMENT_INSERT_EMPTY_LINE_BEFORE_ROOT_TAGS, JavaCore.DO_NOT_INSERT);
        //$NON-NLS-1$
        ...
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        String input = PREFIX + DELIMITER + INFIX + "Description" + DELIMITER + INFIX + "@param test" + DELIMITER + POSTFIX;
        String expected = input;
        String result = testFormat(input);
        assertEquals(expected, result);
    }
    ...
    public void testMultiLineCommentBlankLineBeforeJavadoctags2() {
        //$NON-NLS-1$
        setUserOption(DefaultCodeFormatterConstants.FORMATTER_COMMENT_INSERT_EMPTY_LINE_BEFORE_ROOT_TAGS, JavaCore.INSERT);
        //$NON-NLS-1$
        setUserOption(DefaultCodeFormatterConstants.FORMATTER_COMMENT_CLEAR_BLANK_LINES_IN_JAVADOC_COMMENT, DefaultCodeFormatterConstants.TRUE);
        //$NON-NLS-1$
        String prefix = PREFIX + DELIMITER + INFIX + "Description";
        //$NON-NLS-1$
        String postfix = DELIMITER + INFIX + "@param test" + DELIMITER + POSTFIX;
    ...
    public void testMultiLineCommentBlankLineBeforeJavadoctags3() {
        ...
        setUserOption(DefaultCodeFormatterConstants.FORMATTER_COMMENT_CLEAR_BLANK_LINES_IN_JAVADOC_COMMENT, DefaultCodeFormatterConstants.TRUE);
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        String input = PREFIX + DELIMITER + INFIX + "Description" + DELIMITER + INFIX + DELIMITER + INFIX + "@param test" + DELIMITER + POSTFIX;
        String expected = input;
        String result = testFormat(input);
        assertEquals(expected, result);
    }
    ...
    public void testMultiLineCommentBlankLineBeforeJavadoctags6() {
        ...
        setUserOption(DefaultCodeFormatterConstants.FORMATTER_COMMENT_INSERT_EMPTY_LINE_BEFORE_ROOT_TAGS, JavaCore.INSERT);
        //$NON-NLS-1$
        setUserOption(DefaultCodeFormatterConstants.FORMATTER_COMMENT_CLEAR_BLANK_LINES, DefaultCodeFormatterConstants.TRUE);
        //$NON-NLS-1$
        String prefix = PREFIX + DELIMITER + INFIX + "Description";
        //$NON-NLS-1$
        String postfix = DELIMITER + INFIX + "@param test" + DELIMITER + POSTFIX;
    ...
    public void testInlineTag1() {
        //$NON-NLS-1$
        String input = PREFIX + DELIMITER + INFIX + "{@link Object} has many methods." + DELIMITER + POSTFIX;
        String expected = input;
        String result = testFormat(input);
        assertEquals(expected, result);
    }
    ...
    public void testInlineTag2() {
        //$NON-NLS-1$
        String input = PREFIX + DELIMITER + INFIX + "{@link Object}s are cool." + DELIMITER + POSTFIX;
        String expected = input;
        String result = testFormat(input);
        assertEquals(expected, result);
    }
    ...
    public void testTagWordbreaks1() {
        //$NON-NLS-1$
        String input = PREFIX + DELIMITER + INFIX + "<code>Object</code> rocks." + DELIMITER + POSTFIX;
        String expected = input;
        String result = testFormat(input);
        assertEquals(expected, result);
    }
    ...
    public void testTagWordbreaks2() {
        //$NON-NLS-1$
        String input = PREFIX + DELIMITER + INFIX + "<code>Object</code>s are cool." + DELIMITER + POSTFIX;
        String expected = input;
        String result = testFormat(input);
        assertEquals(expected, result);
    }
    ...
    public void test109605() {
        String input = "/**" + DELIMITER + "			 * <pre>" + DELIMITER + "			 * " + DELIMITER + "			 * </pre>" + DELIMITER + "			 * " + DELIMITER + "			 * " + DELIMITER + "			 * @author Darren Pearce" + DELIMITER + "			 * @version 22-Sep-2005" + DELIMITER + "			 * " + DELIMITER + "			 */";
        String expected = "/**" + DELIMITER + " * <pre>" + DELIMITER + " * " + DELIMITER + " * </pre>" + DELIMITER + " * " + DELIMITER + " * " + DELIMITER + " * @author Darren Pearce" + DELIMITER + " * @version 22-Sep-2005" + DELIMITER + " * " + DELIMITER + " */";
        String result = testFormat(input);
        assertEquals(expected, result);
    }
    ...
    public void test60453() {
        ...
        String expected = "/**" + DELIMITER + " * Creates a new instance of DynamicEventChannel sdf sdfs dsdf dsfsd fd fsd fsdf" + DELIMITER + " * sdf dsfsd (on the same line)" + DELIMITER + " * " + DELIMITER + " * @pre obj != null" + DELIMITER + " */";
    ...
    public void test198153() {
        Map options = DefaultCodeFormatterConstants.getEclipseDefaultSettings();
        String input = "/**" + DELIMITER + " * <pre>" + DELIMITER + " * System.out.println(&#34;hello world&#34;);" + DELIMITER + " * </pre>" + DELIMITER + " */";
        String expected = "/**" + DELIMITER + " * <pre>" + DELIMITER + // No space after "world".
        " * System.out.println(&#34;hello world&#34;);" + DELIMITER + " * </pre>" + DELIMITER + " */";
        String result = testFormat(input, options);
        assertEquals(expected, result);
    }
    ...
    public void test197169() {
        ...
        String input = "/**" + DELIMITER + " * <pre>" + DELIMITER + " * &#064;Anno1 class Foo {" + DELIMITER + " * &#064;Anno1 class Bar {}" + DELIMITER + " * }" + DELIMITER + " * &#064;Anno2(&#064;Anno1) class Baz {}" + DELIMITER + " * </pre>" + DELIMITER + " */";
        String expected = "/**" + DELIMITER + " * <pre>" + DELIMITER + // Initial &#064 left alone.
        " * &#064;Anno1" + DELIMITER + " * class Foo {" + DELIMITER + // Left alone even after whitespace.
        " * 	&#064;Anno1" + DELIMITER + " * 	class Bar {" + DELIMITER + " * 	}" + DELIMITER + " * }" + DELIMITER + " * " + DELIMITER + // Non-initial &#064; expanded.
        " * &#064;Anno2(&#064;Anno1)" + DELIMITER + " * class Baz {" + DELIMITER + " * }" + DELIMITER + " * </pre>" + DELIMITER + " */";
        String result = testFormat(input, options);
        assertEquals(expected, result);
    }
    ...
    public void test109636() {
        Map options = DefaultCodeFormatterConstants.getEclipseDefaultSettings();
        String input = "/**" + DELIMITER + " * <code>" + DELIMITER + " * <pre>" + DELIMITER + " * setLeadingComment(\"/&#42; traditional comment &#42;/\");  // correct" + DELIMITER + " * setLeadingComment(\"missing comment delimiters\");  // wrong" + DELIMITER + " * setLeadingComment(\"/&#42; unterminated traditional comment \");  // wrong" + DELIMITER + " * setLeadingComment(\"/&#42; broken\\n traditional comment &#42;/\");  // correct" + DELIMITER + " * setLeadingComment(\"// end-of-line comment\\n\");  // correct" + DELIMITER + " * setLeadingComment(\"// end-of-line comment without line terminator\");  // correct" + DELIMITER + " * setLeadingComment(\"// broken\\n end-of-line comment\\n\");  // wrong" + DELIMITER + " * </pre>" + DELIMITER + " * </code>" + DELIMITER + " */";
        String result = testFormat(input, options);
    ...
    public void test109636_2() {
        Map options = DefaultCodeFormatterConstants.getEclipseDefaultSettings();
        String input = "/**" + DELIMITER + " * <pre>" + DELIMITER + " * /* Comment ending in multiple stars *&#42;/" + DELIMITER + " * /* Entity-needing character after a star *&lt; &#42;/" + DELIMITER + " * </pre>" + DELIMITER + " */";
        String expected = "/**" + DELIMITER + " * <pre>" + DELIMITER + " * /* Comment ending in multiple stars *&#42;/" + DELIMITER + " * /* Entity-needing character after a star *&lt; &#42;/" + DELIMITER + " * </pre>" + DELIMITER + " */";
        String result = testFormat(input, options);
        assertEquals(expected, result);
    }
    ...
    public void test109636_4() {
        Map options = DefaultCodeFormatterConstants.getEclipseDefaultSettings();
        String input = "/**" + DELIMITER + " * <pre>" + DELIMITER + " * setLeadingComment(\"/&#42; traditional comment &#42;/\");  // correct" + DELIMITER + " * setLeadingComment(\"missing comment delimiters\");  // wrong" + DELIMITER + " * setLeadingComment(\"/&#42; unterminated traditional comment \");  // wrong" + DELIMITER + " * setLeadingComment(\"/&#42; broken\\n traditional comment &#42;/\");  // correct" + DELIMITER + " * setLeadingComment(\"// end-of-line comment\\n\");  // correct" + DELIMITER + " * setLeadingComment(\"// end-of-line comment without line terminator\");  // correct" + DELIMITER + " * setLeadingComment(\"// broken\\n end-of-line comment\\n\");  // wrong" + DELIMITER + " * </pre>" + DELIMITER + " */";
        String expected = "/**" + DELIMITER + " * <pre>" + DELIMITER + " * setLeadingComment(\"/&#42; traditional comment &#42;/\"); // correct" + DELIMITER + " * setLeadingComment(\"missing comment delimiters\"); // wrong" + DELIMITER + " * setLeadingComment(\"/&#42; unterminated traditional comment \"); // wrong" + DELIMITER + " * setLeadingComment(\"/&#42; broken\\n traditional comment &#42;/\"); // correct" + DELIMITER + " * setLeadingComment(\"// end-of-line comment\\n\"); // correct" + DELIMITER + " * setLeadingComment(\"// end-of-line comment without line terminator\"); // correct" + DELIMITER + " * setLeadingComment(\"// broken\\n end-of-line comment\\n\"); // wrong" + DELIMITER + " * </pre>" + DELIMITER + " */";
        String result = testFormat(input, options);
        assertEquals(expected, result);
    }
