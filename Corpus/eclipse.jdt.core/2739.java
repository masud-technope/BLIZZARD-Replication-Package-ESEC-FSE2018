 ...
 */
    public void test001() {
        this.runConformTest(new String[] { /* p1.A */
 ...
 */
    public void test002() {
        this.runNegativeTest(new String[] { /* A.java */
 ...
 */
    public void test004() {
        ...
        this.runConformTest(new String[] { /* A3.java */
        "A3.java", "class A3 { \n" + "	class B {} \n" + "} \n" });
        // no specific success output string
        /* then compile with previous input */
        this.runConformTest(new String[] { /* A4.java */
        "A4.java", "class A4 { \n" + "	void foo(){ \n" + "		new A3().new B(){}; \n" + "	} \n" + "} \n" }, // no specific success output string
        null, // use default class-path
        null, false, // do not flush previous output dir content
        null);
    }
 ...
 */
    public void test008() {
        this.runConformTest(new String[] { /* Y2.java */
 ...
 */
    public void test009() {
        this.runConformTest(new String[] { /* Y3.java */
 ...
 */
    public void test010() {
        this.runConformTest(new String[] { /* Y4.java */
        "Y4.java", "public class Y4 { \n" + "	public static void main(String[] argv){ \n" + "		if (new Y4().bar() == 3) \n" + "			System.out.println(\"SUCCESS\"); \n" + "		else \n" + "			System.out.println(\"FAILED\"); \n" + "	} \n" + "	int bar() { \n" + "		final int i = \"xxx\".length(); \n" + "		final String s = this.toString(); \n" + "		class X { \n" + "			class AX { \n" + "				int bar() { \n" + "					class BX { \n" + "						int foo() { \n" + "							return new AX().foo(); \n" + "						} \n" + "					} \n" + "					return new BX().foo(); \n" + "				} \n" + "				int foo() { \n" + "					return i; \n" + "				} \n" + "			} \n" + "		} \n" + "		return new X().new AX().bar(); \n" + "	} \n" + "} \n" }, "SUCCESS");
    }
 ...
 */
    public void test011() {
        this.runConformTest(new String[] { /* Y5.java */
        "Y5.java", "public class Y5 { \n" + "	public static void main(String[] argv){ \n" + "		if (new Y5().bar(5) == 5) \n" + "			System.out.println(\"SUCCESS\"); \n" + "		else \n" + "			System.out.println(\"FAILED\"); \n" + "	} \n" + "	int bar(final int i) { \n" + "		class X { \n" + "			int bar() { \n" + "				return new Object(){  \n" + "						int foo(){ \n" + "							return i; \n" + "						} \n" + "					}.foo(); \n" + "			} \n" + "		} \n" + "		return new X().bar(); \n" + "	} \n" + "} \n" }, "SUCCESS");
    }
 ...
 */
    public void test012() {
        this.runConformTest(new String[] { /* A.java */
 ...
 */
    public void test014() {
        this.runConformTest(new String[] { /* Z1.java */
        "Z1.java", "public class Z1 { \n" + "	public static void main(String[] argv){ \n" + "		new Z1().new W(); \n" + "		System.out.println(\"SUCCESS\"); \n" + "	} \n" + "	class W extends Y { \n" + "		W() { \n" + "			super(new Object(), foo()); \n" + "		} \n" + "	} \n" + "	String foo() { \n" + "		return \"\"; \n" + "	} \n" + "} \n" + "class Y { \n" + "	Y(Object o, String s) { \n" + "	} \n" + "}	\n" }, "SUCCESS");
    }
 ...
 */
    public void test015() {
        this.runConformTest(new String[] { /* AAA.java */
        "AAA.java", "public class AAA {  \n" + "	public static void main(String argv[]){  \n" + "		if (new AAA().foo(5) == 15);  \n" + "		System.out.println(\"SUCCESS\"); \n" + "	}  \n" + "	int foo(final int loc){  \n" + "		class I {  \n" + "			int i = loc;  \n" + "			{  \n" + "				System.out.println(\"loc=\"+ loc );	  \n" + "			}  \n" + "			int foo(){   \n" + "				System.out.println(\"I:i=\"+ i );	  \n" + "				return i;}   \n" + "		}    \n" + "		class J extends I {  \n" + "			I obj = new I(){  \n" + "				int foo() {  \n" + "					System.out.println(\"J\");  \n" + "					return super.foo() + 10; }};  \n" + "		}  \n" + "		return new J().obj.foo();  \n" + "	}  \n" + " }  \n" }, "loc=5\n" + "loc=5\n" + "J\n" + "I:i=5\n" + "SUCCESS");
    }
 ...
 */
    ...
    public void test025() {
        this.runConformTest(new String[] { /* PortReport.java */
        "PortReport.java", "import java.util.*; \n" + "public class PortReport { \n" + "	public static void main(String[] args) { \n" + "		Portfolio port = new Portfolio(\"foobar\"); \n" + "		System.out.println(\"SUCCESS\"); \n" + "	} \n" + "} \n", /* Portfolio.java */
 ...
 */
    public void test034() {
        this.runConformTest(new String[] { /* A2.java */
 ...
 */
    public void test039() {
        this.runConformTest(new String[] { /* p1/X.java */
 ...
 */
    ...
    public void test052() {
        this.runConformTest(new String[] { /* p2/Y.java */
 ...
 */
    public void test057() {
        this.runConformTest(new String[] { /* VE_Test.java */
        "VE_Test.java", "public class VE_Test {	\n" + "    class VE_Inner {	\n" + "        private VE_Inner() {}	\n" + "    }	\n" + "    private static void test(){	\n" + "        VE_Test ve_test = new VE_Test();	\n" + "        VE_Inner pi = ve_test.new VE_Inner();	\n" + "    }	\n" + "    public static void main(String[] args){	\n" + "        new VE_Test();	\n" + "        System.out.println(\"SUCCESS\");	\n" + "    }	\n" + "}	\n" }, "SUCCESS");
    }
 ...
 */
    ...
    public void test087() {
        ...
        "[X$1N]", "", JavacTestOptions.EclipseHasABug.EclipseBug235809);
    }
