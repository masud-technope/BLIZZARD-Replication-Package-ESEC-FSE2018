...
public class WildcardType extends AnnotatableType {
	 ...
	 */
    public static final ChildPropertyDescriptor BOUND_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(WildcardType.class, "bound", Type.class, OPTIONAL, CYCLE_RISK);

    /**
	 * The "upperBound" structural property of this node type (type: {@link Boolean}).
	 */
    public static final SimplePropertyDescriptor UPPER_BOUND_PROPERTY = //$NON-NLS-1$
    new SimplePropertyDescriptor(WildcardType.class, "upperBound", boolean.class, MANDATORY);
