...
public class TryStatement extends Statement {
	 ...
	 * @since 3.7.1
	 */
    public static final ChildListPropertyDescriptor RESOURCES_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(TryStatement.class, "resources", VariableDeclarationExpression.class, CYCLE_RISK);
    ...
    new ChildPropertyDescriptor(TryStatement.class, "body", Block.class, MANDATORY, CYCLE_RISK);

    /**
	 * The "catchClauses" structural property of this node type (element type: {@link CatchClause}).
	 * @since 3.0
	 */
    public static final ChildListPropertyDescriptor CATCH_CLAUSES_PROPERTY = //$NON-NLS-1$
	 ...
	 * @since 3.0
	 */
    public static final ChildPropertyDescriptor FINALLY_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(TryStatement.class, "finally", Block.class, OPTIONAL, CYCLE_RISK);
	 ...
	 */
    int treeSize() {
        return memSize() + (this.resources == null ? 0 : this.resources.listSize()) + (this.body == null ? 0 : getBody().treeSize()) + this.catchClauses.listSize() + (this.optionalFinallyBody == null ? 0 : getFinally().treeSize());
    }
}
