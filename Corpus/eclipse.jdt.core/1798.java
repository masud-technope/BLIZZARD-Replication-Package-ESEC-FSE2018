 ...
 */
    public UndoEdit applyTextEdit(TextEdit edit, IProgressMonitor monitor) throws JavaModelException {
        ...
        // can not happen, there are no compilation units without buffer
        return null;
    }
 ...
 */
    ...
    protected boolean buildStructure(OpenableElementInfo info, final IProgressMonitor pm, Map newElements, IResource underlyingResource) throws JavaModelException {
        ...
        SourceElementParser parser = new SourceElementParser(requestor, problemFactory, compilerOptions, /*report local declarations*/
        true, !createAST);
        parser.reportOnlyOneSyntaxError = !computeProblems;
        parser.setMethodsFullRecovery(true);
        parser.setStatementsRecovery((reconcileFlags & ICompilationUnit.ENABLE_STATEMENTS_RECOVERY) != 0);
        if (// disable javadoc parsing if not computing problems, not resolving and not creating ast
        !computeProblems && !resolveBindings && !createAST)
        ...
        try {
            if (computeProblems) {
                ...
                compilationUnitDeclaration = parser.parseCompilationUnit(source, /*full parse to find local elements*/
                true, pm);
            }
            if (createAST) {
 ...
 */
    public void codeComplete(int offset, CompletionRequestor requestor, WorkingCopyOwner workingCopyOwner, IProgressMonitor monitor) throws JavaModelException {
        codeComplete(this, isWorkingCopy() ? (org.eclipse.jdt.internal.compiler.env.ICompilationUnit) getOriginalElement() : this, offset, requestor, workingCopyOwner, this, monitor);
    }
    ...
    public IType createType(String content, IJavaElement sibling, boolean force, IProgressMonitor monitor) throws JavaModelException {
        if (!exists()) {
            ...
            if (!pkg.isDefaultPackage()) {
                ...
                String lineSeparator = Util.getLineSeparator(/*no existing source*/
                null, getJavaProject());
                //$NON-NLS-1$ //$NON-NLS-2$
 ...
 */
    public char[] getContents() {
        ...
        if (buffer == null) {
            ...
            try {
                ...
                if (JavaModelManager.getJavaModelManager().abortOnMissingSource.get() == Boolean.TRUE) {
                    IOException ioException = e.getJavaModelStatus().getCode() == IJavaModelStatusConstants.IO_EXCEPTION ? (IOException) e.getException() : new IOException(e.getMessage());
        ...
        if (// see https://bugs.eclipse.org/bugs/show_bug.cgi?id=129814
        contents == null) {
            if (JavaModelManager.getJavaModelManager().abortOnMissingSource.get() == Boolean.TRUE) {
 ...
 */
    public JavaModelManager.PerWorkingCopyInfo getPerWorkingCopyInfo() {
        return JavaModelManager.getJavaModelManager().getPerWorkingCopyInfo(this, false, /*don't create*/
        false, /*don't record usage*/
        null);
    }
 ...
 */
    public ICompilationUnit getWorkingCopy(WorkingCopyOwner workingCopyOwner, IProblemRequestor problemRequestor, IProgressMonitor monitor) throws JavaModelException {
        ...
        JavaModelManager.PerWorkingCopyInfo perWorkingCopyInfo = manager.getPerWorkingCopyInfo(workingCopy, /*don't create*/
        false, /*record usage*/
        true, /*not used since don't create*/
        null);
        if (perWorkingCopyInfo != null) {
 ...
 */
    public void makeConsistent(IProgressMonitor monitor) throws JavaModelException {
        makeConsistent(NO_AST, false, /* don't perform statements recovery */
        0, null, /*don't collect problems but report them*/
        monitor);
    }
 ...
 */
    public void reconcile(boolean forceProblemDetection, IProgressMonitor monitor) throws JavaModelException {
        reconcile(NO_AST, forceProblemDetection ? ICompilationUnit.FORCE_PROBLEM_DETECTION : 0, null, /*use primary owner*/
        monitor);
    }
 ...
 * @since 3.0
 */
    public org.eclipse.jdt.core.dom.CompilationUnit reconcile(int astLevel, boolean forceProblemDetection, WorkingCopyOwner workingCopyOwner, IProgressMonitor monitor) throws JavaModelException {
 ...
 * @since 3.0
 */
    public org.eclipse.jdt.core.dom.CompilationUnit reconcile(int astLevel, boolean forceProblemDetection, boolean enableStatementsRecovery, WorkingCopyOwner workingCopyOwner, IProgressMonitor monitor) throws JavaModelException {
        int flags = 0;
 ...
 */
    public void save(IProgressMonitor pm, boolean force) throws JavaModelException {
        if (isWorkingCopy()) {
            ...
            // not simply makeConsistent, also computes fine-grain deltas
            reconcile();
 ...
 */
    ...
    protected IStatus validateExistence(IResource underlyingResource) {
        ...
        if (// no check is done on root kind or exclusion pattern for working copies
        !isWorkingCopy()) {
