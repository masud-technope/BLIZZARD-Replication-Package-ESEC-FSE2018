...
public class MirrorUtilTestAnnotationProcessor extends BaseProcessor {
    ...
    public static final String[] ENV_KEYS = { // no-translation
    ENVPREFIX + "normal", ENVPREFIX + "normalPath", ENVPREFIX + "boguscpvar", ENVPREFIX + "badProj", // expected-translation
    ENVPREFIX + "cpvar", ENVPREFIX + "cpvarPath", ENVPREFIX + "cpvarFile", ENVPREFIX + "proj", ENVPREFIX + "projFile", ENVPREFIX + "projdirFile" };

    public static final String[] ENV_VALUES = { // no-translation
    "normal", "normal/foo.bar", "%NOSUCH/VARNAME%", "%ROOT%/someOtherProject/foo/nonexistent.txt", // expected-translation
    "%ECLIPSE_HOME%", "%ECLIPSE_HOME%/plugins", "%ECLIPSE_HOME%/configuration/config.ini", "%ROOT%/org.eclipse.jdt.apt.tests.MirrorUtilTestsProject", "%ROOT%/org.eclipse.jdt.apt.tests.MirrorUtilTestsProject/.classpath", "%PROJECT.DIR%/.classpath" };
