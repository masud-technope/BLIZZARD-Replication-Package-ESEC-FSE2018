 ...
 */
    public void test002() {
        this.runNegativeTest(new String[] { /* p1.A */
 ...
 */
    public void test011() {
        this.runNegativeTest(new String[] { /* p2.Aa */
        "p2/Aa.java", "package p2;										\n" + "class Aa extends p1.A{								\n" + "	class B implements p1.A.C {						\n" + "	}												\n" + "	public static void main (String args[]) {		\n" + "	}												\n" + "}", /* p1.A */
 ...
 */
    public void test015() {
        this.runConformTest(new String[] { /* pack1.First */
 ...
 */
    public void test016() {
        this.runConformTest(new String[] { /* pack1.Outer */
        "pack1/Outer.java", "package pack1;										\n" + "import pack2.*;									\n" + "public class Outer {								\n" + "	int time, distance;								\n" + "	public Outer() {								\n" + "	}												\n" + "	public Outer(int d) {							\n" + "		distance = d;								\n" + "	}												\n" + "	public void aMethod() {							\n" + "		this.distance *= 2;							\n" + "		return;										\n" + "	}												\n" + "}", /* pack2.OuterTwo */
 ...
 */
    public void test030() {
        ...
        "SUCCESS", // custom classpath
        null, // flush previous output dir content
        true, // special vm args
        null, // custom options
        target1_2, /*no custom requestor*/
        null);
        this.runConformTest(new String[] { "p1/C.java", "package p1; \n" + "public class C {	\n" + "	void bar(A a){ \n" + "		a.foo();	\n" + "	}	\n" + "  public static void main(String[] args) {	\n" + "    System.out.println(\"SUCCESS\");	\n" + "  }	\n" + "} \n" }, // expected output
        "SUCCESS", // custom classpath
        null, // flush previous output dir content
        false, // special vm args
        null, // custom options
 ...
 */
    ...
    public void test047() {
        this.runConformTest(new String[] { //================================
        "X.java", "public class X extends SuperTest\n" + "{\n" + "    public X()\n" + "    {\n" + "        super();\n" + "    }\n" + "  \n" + "    static void print(Object obj)\n" + "    {\n" + "        System.out.println(\"Object:\" + obj.toString());\n" + "    }\n" + "    \n" + "    public static void main(String[] args)\n" + "    {\n" + "        print(\"Hello world\");\n" + "    }\n" + "}\n" + "class SuperTest\n" + "{\n" + "    SuperTest(){};\n" + "    static void print(String s)\n" + "    {\n" + "        System.out.println(\"String: \" + s);\n" + "    }\n" + "}\n" }, "String: Hello world");
    }

    // 73740 - missing serialVersionUID diagnosis shouldn't trigger load of Serializable
    public void test048() {
        this.runConformTest(new String[] { //---------------------------
        "X.java", "public class X {\n" + "   public static void main(String[] args) {\n" + "		System.out.println(\"SUCCESS\");\n" + "   }\n" + "}\n" }, "SUCCESS", Util.concatWithClassLibs(OUTPUT_DIR, /*output in front*/
        true), // do not flush output
        false, // vm args
        null, // options
    ...
    public void test068() {
        ...
        if (compOptions.complianceLevel < ClassFileConstants.JDK1_5)
            return;
    ...
    public void test068a() {
        ...
        options.put(CompilerOptions.OPTION_Source, CompilerOptions.VERSION_1_4);
        this.runConformTest(new String[] { //===================
        "Test14.java", "public class Test14 {\n" + "    public static void main(String[] args) {\n" + "        X1 x = new X2().foo();\n" + "        X2 xx = new X2().foo();\n" + "        X1 z = new Z().foo();\n" + "        X2 zz = new Z().foo();\n" + "    }\n" + // =================,
    ...
    public void test071() {
        ...
        null, /* do not flush output directory */
    ...
    public void test103() {
        Map options = getCompilerOptions();
        CompilerOptions compOptions = new CompilerOptions(options);
        if (compOptions.complianceLevel < ClassFileConstants.JDK1_4)
            return;
        this.runNegativeTest(new String[] { //------------------------------
