 ...
 */
    public void generateCode(BlockScope currentScope, CodeStream codeStream) {
        ...
        if (this.initialization != null && !((isStatic = this.binding.isStatic()) && this.binding.constant() != Constant.NotAConstant)) {
            ...
            // store into field
            if (isStatic) {
                codeStream.fieldAccess(Opcodes.OPC_putstatic, this.binding, /* default declaringClass */
                null);
            } else {
                codeStream.fieldAccess(Opcodes.OPC_putfield, this.binding, /* default declaringClass */
                null);
            }
        }
 ...
 */
    ...
    public void resolve(MethodScope initializationScope) {
        ...
        if (classScope != null) {
            checkHiding: {
                ...
                checkHidingSuperField: {
                    ...
                    FieldBinding existingVariable = classScope.findField(declaringType.superclass, this.name, /*do not resolve hidden field*/
                    this, false, /* no visibility checks please */
                    true);
                ...
                if (outerScope.kind == Scope.COMPILATION_UNIT_SCOPE)
                    break checkHiding;
                Binding existingVariable = outerScope.getBinding(this.name, Binding.VARIABLE, this, /*do not resolve hidden field*/
                false);
                if (existingVariable == null)
                    break checkHiding;
                if (!existingVariable.isValidBinding())
        ...
        if (// enum constants have no declared type
        this.type != null) {
        ...
        try {
            ...
            if ((this.binding.getAnnotationTagBits() & TagBits.AnnotationDeprecated) == 0 && (this.binding.modifiers & ClassFileConstants.AccDeprecated) != 0 && initializationScope.compilerOptions().sourceLevel >= ClassFileConstants.JDK1_5) {
            ...
            if (this.initialization == null) {
                ...
                if (this.initialization instanceof ArrayInitializer) {
                    ...
                    TypeBinding.notEquals(fieldType, initializationType))
