...
public final class HashtableOfType {
    ...
    private void rehash() {
        ...
        HashtableOfType newHashtable = new HashtableOfType(elementSize < 100 ? 100 : elementSize * 2);
        char[] currentKey;
    ...
    public String toString() {
        ...
        for (int i = 0, length = valueTable.length; i < length; i++) if ((type = valueTable[i]) != null)
            //$NON-NLS-1$
            s += type.toString() + "\n";
        return s;
    }
