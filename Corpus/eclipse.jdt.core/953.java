...
public class AnonymousClassDeclaration extends ASTNode {
	 ...
	 * @since 3.0
	 */
    public static final ChildListPropertyDescriptor BODY_DECLARATIONS_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(AnonymousClassDeclaration.class, "bodyDeclarations", BodyDeclaration.class, CYCLE_RISK);
	 ...
	 * Defaults to none.
	 */
    private ASTNode.NodeList bodyDeclarations = new ASTNode.NodeList(BODY_DECLARATIONS_PROPERTY);
