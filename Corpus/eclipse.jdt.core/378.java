 ...
 */
    public void test1FTZ849() {
        this.runTestCheckMethodParse(// compilationUnit:
        "class Bar {								\n" + "	void foo() {							\n" + "		X o = new X;						\n" + "		fred.xyz;							\n" + "	}										\n" + "}											\n", // completeBehind:
        "fred.x", // expectedCompletionNodeToString:
        "<CompleteOnName:fred.x>", // expectedUnitDisplayString:
        "class Bar {\n" + "  Bar() {\n" + "  }\n" + "  void foo() {\n" + "    X o;\n" + "    <CompleteOnName:fred.x>;\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "x", // expectedReplacedSource:
        "fred.xyz", // test name
        "<1FTZ849>");
    }
 ...
 */
    public void test1FUUP73() {
        runTestCheckDietParse(// compilationUnit:
        "public class A {					\n" + "	String s = \"hello\";			\n" + "	Object o = s.concat(\"boo\");	\n", // completeBehind:
        "Object o = s", // expectedCompletionNodeToString:
        "<CompleteOnName:s>", // expectedUnitDisplayString:
        "public class A {\n" + "  String s;\n" + "  Object o = <CompleteOnName:s>;\n" + "  public A() {\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "s", // expectedReplacedSource:
        "s", // test name
        "<1FUUP73>");
        runTestCheckDietParse(// compilationUnit:
        "public class A {					\n" + "	String s = \"hello\";			\n" + "	Object o = s.concat(\"boo\");	\n", // completeBehind:
        "Object o = s.c", // expectedCompletionNodeToString:
        "<CompleteOnName:s.c>", // expectedUnitDisplayString:
        "public class A {\n" + "  String s;\n" + "  Object o = <CompleteOnName:s.c>;\n" + "  public A() {\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "c", // expectedReplacedSource:
        "s.concat", // test name
        "<1FUUP73>");
    }
 ...
 */
    public void test1FVRQQA_1() {
        this.runTestCheckMethodParse(// compilationUnit:
        "class X {									\n" + "	void foo() {							\n" + "		Enumeration e = null; 				\n" + "		e.to								\n" + "	}										\n" + "}											\n", // completeBehind:
        "e.to", // expectedCompletionNodeToString:
        "<CompleteOnName:e.to>", // expectedUnitDisplayString:
        "class X {\n" + "  X() {\n" + "  }\n" + "  void foo() {\n" + "    Enumeration e;\n" + "    <CompleteOnName:e.to>;\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "to", // expectedReplacedSource:
        "e.to", // test name
        "<1FVRQQA_1>");
    }
 ...
 */
    public void test1FVRQQA_2() {
        ...
        "e.has", // expectedCompletionNodeToString:
        "<CompleteOnName:e.has>", // expectedUnitDisplayString:
        "class X {\n" + "  X() {\n" + "  }\n" + "  void foo() {\n" + "    Enumeration e;\n" + "    for (; <CompleteOnName:e.has>; ) \n" + "      ;\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "has", // expectedReplacedSource:
        "e.has", // test name
        "<1FVRQQA_2>");
    }
 ...
 */
    public void test1FVT66Q_1() {
        ...
        "	codeAss", // expectedCompletionNodeToString:
        "<CompleteOnName:codeAss>", // expectedUnitDisplayString:
        "package test;\n" + "public class Test {\n" + "  public Test() {\n" + "  }\n" + "  public void foo() {\n" + "    final int codeAssistTarget;\n" + "    Thread t;\n" + "    new Thread() {\n" + "      public void run() {\n" + "        <CompleteOnName:codeAss>;\n" + "      }\n" + "    };\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "codeAss", // expectedReplacedSource:
        "codeAss", // test name
        "<1FVT66Q_1>");
    }
 ...
 */
    public void test1FVT66Q_2() {
        this.runTestCheckMethodParse(// compilationUnit:
        "package test;							\n" + "										\n" + "public class Test {					\n" + "	public void foo() {					\n" + "		final int codeAssistTarget= 3;	\n" + "										\n" + "		Thread t= new Thread() {		\n" + "			public void run() {			\n" + "				codeAss					\n" + "			}							\n" + "		};								\n" + "		codeA							\n" + "	}									\n" + "}										\n", // completeBehind:
        "\n		codeA", // expectedCompletionNodeToString:
        "<CompleteOnName:codeA>", // expectedUnitDisplayString:
        "package test;\n" + "public class Test {\n" + "  public Test() {\n" + "  }\n" + "  public void foo() {\n" + "    final int codeAssistTarget;\n" + "    Thread t;\n" + "    <CompleteOnName:codeA>;\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "codeA", // expectedReplacedSource:
        "codeA", // test name
        "<1FVT66Q_2>");
    }
 ...
 */
    public void test1G8DE30() {
        ...
        "<CompleteOnName:>", // expectedUnitDisplayString:
        "class Bar {\n" + "  Bar() {\n" + "  }\n" + "  void foo() {\n" + "    new Runnable() {\n" + "      public void run() {\n" + "        <CompleteOnName:>;\n" + "      }\n" + "    };\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
 ...
 */
    public void testEmptyNameReferenceAfterCast() {
        this.runTestCheckMethodParse(// compilationUnit:
        "class X {									\n" + "	void foo() {							\n" + "		X x = (X)							\n" + "											\n" + "	}										\n" + "}											\n", // completeBehind:
        "(X)", // expectedCompletionNodeToString:
        "<CompleteOnName:>", // expectedUnitDisplayString:
 ...
 */
    public void testEmptyNameReferenceAfterPlus() {
        this.runTestCheckMethodParse(// compilationUnit:
        "class X {									\n" + "	void foo() {							\n" + "		1 + 								\n" + "											\n" + "	}										\n" + "}											\n", // completeBehind:
        "1 +", // expectedCompletionNodeToString:
        "<CompleteOnName:>", // expectedUnitDisplayString:
        "class X {\n" + "  X() {\n" + "  }\n" + "  void foo() {\n" + "    <CompleteOnName:>;\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "", // expectedReplacedSource:
        "", // test name
 ...
 */
    public void testEmptyNameReferenceInArrayDim() {
        this.runTestCheckMethodParse(// compilationUnit:
        "class X {									\n" + "	void foo() {							\n" + "		int[]								\n" + "											\n" + "	}										\n" + "}											\n", // completeBehind:
        "int[", // expectedCompletionNodeToString:
        "<CompleteOnName:>", // expectedUnitDisplayString:
        "class X {\n" + "  X() {\n" + "  }\n" + "  void foo() {\n" + "    <CompleteOnName:>;\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "", // expectedReplacedSource:
        "", // test name
 ...
 */
    public void testInnerClassFieldInitializer() {
        runTestCheckDietParse(// compilationUnit:
        "class Bar {								\n" + "	Object o = new Object() {				\n" + "		void foo() {						\n" + "			xyz								\n" + "		}									\n" + "	};										\n" + "}											\n", // completeBehind:
        "xyz", // expectedCompletionNodeToString:
        "<CompleteOnName:xyz>", // expectedUnitDisplayString:
        "class Bar {\n" + "  Object o = new Object() {\n" + "    void foo() {\n" + "      <CompleteOnName:xyz>;\n" + "    }\n" + "  };\n" + "  Bar() {\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "xyz", // expectedReplacedSource:
        "xyz", // test name
 ...
 */
    public void testMethodInvocationAnonymousInnerClass() {
        ...
        "class Bar {									\n" + "	void foo() {								\n" + "		primary().bizz(							\n" + "			new X() {							\n" + "				void fuzz() {					\n" + "					x.y.z						\n" + "				}								\n" + "			}									\n" + "		);										\n" + "	}											\n" + "}												\n", // completeBehind:
        "x.", // expectedCompletionNodeToString:
        "<CompleteOnName:x.>", // expectedUnitDisplayString:
        "class Bar {\n" + "  Bar() {\n" + "  }\n" + "  void foo() {\n" + "    new X() {\n" + "      void fuzz() {\n" + "        <CompleteOnName:x.>;\n" + "      }\n" + "    };\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "", // expectedReplacedSource:
        "x.", // test name
 ...
 */
    public void testQualifiedNameReferenceShrinkAll() {
        this.runTestCheckMethodParse(// compilationUnit:
        "class Bar {								\n" + "	void foo() {							\n" + "		int i = 0;							\n" + "		a.b.c.Xxx o = new Y(i);		\n" + "	}										\n" + "}											\n", // completeBehind:
        "		a", // expectedCompletionNodeToString:
        "<CompleteOnName:a>", // expectedUnitDisplayString:
        "class Bar {\n" + "  Bar() {\n" + "  }\n" + "  void foo() {\n" + "    int i;\n" + "    <CompleteOnName:a>;\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "a", // expectedReplacedSource:
        "a", // test name
 ...
 */
    public void testQualifiedNameReferenceShrinkAllButOne() {
        ...
        "Bar.", // expectedCompletionNodeToString:
        "<CompleteOnName:Bar.>", // expectedUnitDisplayString:
        "class Bar {\n" + "  public class InnerBar {\n" + "    public InnerBar() {\n" + "    }\n" + "  }\n" + "  public class SubInnerBar extends InnerBar {\n" + "    SubInnerBar() {\n" + "      super();\n" + "      <CompleteOnName:Bar.>;\n" + "    }\n" + "  }\n" + "  static Bar x;\n" + "  <clinit>() {\n" + "  }\n" + "  Bar() {\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "", // expectedReplacedSource:
        "Bar.", // test name
 ...
 */
    public void testQualifiedNameReferenceShrinkNone() {
        this.runTestCheckMethodParse(// compilationUnit:
        "class Bar {									\n" + "	static Bar x;								\n" + "	public class InnerBar {						\n" + "	}											\n" + "	public class SubInnerBar extends InnerBar {	\n" + "		SubInnerBar() {							\n" + "			Bar.x.x.super();					\n" + "		}										\n" + "	}											\n" + "}												\n", // completeBehind:
        "Bar.x.x", // expectedCompletionNodeToString:
        "<CompleteOnName:Bar.x.x>", // expectedUnitDisplayString:
 ...
 */
    public void testQualifiedNameReferenceShrinkNone2() {
        ...
        "class Bar {								\n" + "	void foo() {							\n" + "		int i = 0;							\n" + "		a.b.c.Xxx o = new Y(i);		\n" + "	}										\n" + "}											\n", // completeBehind:
        "X", // expectedCompletionNodeToString:
        "<CompleteOnName:a.b.c.X>", // expectedUnitDisplayString:
 ...
 */
    public void testQualifiedNameReferenceShrinkOne() {
        this.runTestCheckMethodParse(// compilationUnit:
        "class Bar {									\n" + "	static Bar x;								\n" + "	public class InnerBar {						\n" + "	}											\n" + "	public class SubInnerBar extends InnerBar {	\n" + "		SubInnerBar() {							\n" + "			Bar.x.x.super();					\n" + "		}										\n" + "	}											\n" + "}												\n", // completeBehind:
        "Bar.x.", // expectedCompletionNodeToString:
        "<CompleteOnName:Bar.x.>", // expectedUnitDisplayString:
 ...
 */
    public void testQualifiedNameReferenceShrinkOne2() {
        this.runTestCheckMethodParse(// compilationUnit:
        "class Bar {								\n" + "	void foo() {							\n" + "		int i = 0;							\n" + "		a.b.c.X o = new Y(i);		\n" + "	}										\n" + "}											\n", // completeBehind:
        "a.b.c.", // expectedCompletionNodeToString:
        "<CompleteOnName:a.b.c.>", // expectedUnitDisplayString:
 ...
 */
    public void testUnicode() {
        ...
        "class X {					\n" + "	void foo() {			\n" + "		bar.\\u005ax 		\n" + "	}						\n" + "}							\n", // completeBehind:
        "x", // expectedCompletionNodeToString:
        "<CompleteOnName:bar.Zx>", // expectedUnitDisplayString:
        "class X {\n" + "  X() {\n" + "  }\n" + "  void foo() {\n" + "    <CompleteOnName:bar.Zx>;\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "Zx", // expectedReplacedSource:
        "bar.\\u005ax", // test name
        "<complete on unicode>");
    }
}
