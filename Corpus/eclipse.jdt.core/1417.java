...
public class MethodVerifyTest extends AbstractComparableTest {
    ...
    String mustOverrideMessage(String method, String type) {
        return "The method " + method + " of type " + type + (new CompilerOptions(getCompilerOptions()).sourceLevel < ClassFileConstants.JDK1_6 ? " must override a superclass method\n" : " must override or implement a supertype method\n");
    }
    ...
    public // pick up superTypes as binaries
    void test003() {
    ...
    public // simple covariance cases
    void test007() {
    ...
    public // executable bridge method case
    void test010() {
    ...
    public // test inheritance scenarios
    void test037() {
    ...
    public // inherited cases for bridge methods, varargs clashes, return type conversion checks
    void test041() {
        runConformTest(true, new String[] { "X.java", "public class X { public void foo(String... n) {} }\n" + "interface I { void foo(String[] n); }\n" + "class Y extends X implements I { }\n" }, "----------\n" + "1. WARNING in X.java (at line 3)\n" + "	class Y extends X implements I { }\n" + "	      ^\n" + "Varargs methods should only override or be overridden by other varargs methods unlike X.foo(String...) and I.foo(String[])\n" + "----------\n", null, null, JavacTestOptions.EclipseJustification.EclipseBug83902);
    }
    ...
    public // ambiguous message sends because of substitution from 2 different type variables
    void test043() {
 ...
 */
    ...
    public void test075a() {
        this.runConformTest(// there is no name clash in this case AND no override error - there would be if the annotation was present
        new String[] { "A.java", "class A<U> { <S extends J> void foo(U u, S s) { } }\n" + "class B<V> extends A<V> { <S1 extends K> void foo(V v, S1 s) { } }\n" + "interface J {}\n" + "interface K extends J {}" }, "");
    }
    ...
    public void test094() {
        ...
        false, JavacTestOptions.Excuse.JavacCompilesIncorrectSource, new String[] { //===================
    ...
    public void test160() {
        this.runConformTest(new String[] { //--------------------------------------------
        "bar/X.java", "package bar;" + "public class X {\n" + "	static void foo() {}\n" + "}", //--------------------------------------------
    ...
    public void test177() {
        if (// see test187()
        new CompilerOptions(getCompilerOptions()).complianceLevel >= ClassFileConstants.JDK1_6) {
 ...
 */
    ...
    public void test345949a() throws Exception {
        if (new CompilerOptions(getCompilerOptions()).sourceLevel < ClassFileConstants.JDK1_7)
            return;
