 ...
 */
    public void testFinallyOneBlock() {
        evaluateWithExpectedWarningAndDisplayString(buildCharArray(new String[] { "try {", "	return 1;", "} finally {", "	return 2;", "}" }), new CategorizedProblem[] { newProblem(IProblem.FinallyMustCompleteNormally, ProblemSeverities.Warning, 30, 40, 4) }, "2".toCharArray());
    }
 ...
 */
    public void testBug345334() {
        ...
        evaluateWithExpectedDisplayString(options, buildCharArray(new String[] { "return \"SUCCESS\";\n" }), "SUCCESS".toCharArray());
    }
 ...
 */
    public void testDiamond() {
        ...
        evaluateWithExpectedDisplayString(buildCharArray(new String[] { "class X<T> {", "	T field;", "	public X(T param) {", "		field = param;", "	}", "	public T foo() {", "		return field;", "	}", "};", "new X<>(\"SUCCESS\").foo();\n" }), "SUCCESS".toCharArray());
    }
}
