...
public class CompletionContextTests extends AbstractJavaModelCompletionTests {
    ...
    public void test0009() throws JavaModelException {
        ...
        int cursorLocation = str.lastIndexOf("ZZZZ") + "ZZZZ".length();
        CompletionResult result = contextComplete(this.workingCopies[0], cursorLocation);
        assertResults("completion offset=" + (cursorLocation) + "\n" + "completion range=[" + (tokenStart) + ", " + (tokenEnd) + "]\n" + "completion token=\"ZZZZ\"\n" + "completion token kind=TOKEN_KIND_NAME\n" + "expectedTypesSignatures=null\n" + "expectedTypesKeys=null\n" + "completion token location={STATEMENT_START}", result.context);
    }
    ...
    public void test0013() throws JavaModelException {
        ...
        int cursorLocation = str.lastIndexOf("ZZZZ") + "ZZZZ".length();
        CompletionResult result = contextComplete(this.workingCopies[0], cursorLocation);
        assertResults("completion offset=" + (cursorLocation) + "\n" + "completion range=[" + (tokenStart) + ", " + (tokenEnd) + "]\n" + "completion token=\"ZZZZ\"\n" + "completion token kind=TOKEN_KIND_NAME\n" + "expectedTypesSignatures=null\n" + "expectedTypesKeys=null\n" + "completion token location=UNKNOWN", result.context);
    }
    ...
    public void test0109() throws JavaModelException {
        ...
        int cursorLocation = str.lastIndexOf("ZZZZ") + "ZZZZ".length();
        CompletionResult result = contextComplete(this.workingCopies[0], cursorLocation);
        assertResults("completion offset=" + (cursorLocation) + "\n" + "completion range=[" + (tokenStart) + ", " + (tokenEnd) + "]\n" + "completion token=\"ZZZZ\"\n" + "completion token kind=TOKEN_KIND_NAME\n" + "expectedTypesSignatures={Ljava.lang.Object;}\n" + "expectedTypesKeys={Ljava/lang/Object;}\n" + "completion token location={CONSTRUCTOR_START}", result.context);
    }
    ...
    public void test0143() throws JavaModelException {
        ...
        assertResults("completion offset=" + (cursorLocation) + "\n" + "completion range=[" + (tokenStart) + ", " + (tokenEnd) + "]\n" + "completion token=\"zzzz\"\n" + "completion token kind=TOKEN_KIND_NAME\n" + "expectedTypesSignatures=null\n" + "expectedTypesKeys=null\n" + "completion token location=UNKNOWN\n" + "visibleElements={}", result.context);
    }
    ...
    public void test0151() throws CoreException, IOException {
        ...
        this.addLibrary(getJavaProject("Completion"), "test.jar", "testsrc.zip", new String[] { "/Completion/test/A.java", "package test;\n" + "public class A extends C {\n" + "  public void methodA() {}\n" + "  public void method0(int i) {}\n" + "}", "/Completion/test/C.java", "package test;\n" + "public class C {\n" + "  public void methodC() {}\n" + "  public void method0(int i) {}\n" + "}" }, "1.4");
        String str = this.workingCopies[0].getSource();
        int tokenStart = str.lastIndexOf("zzzz");
        int tokenEnd = tokenStart + "zzzz".length() - 1;
        int cursorLocation = str.lastIndexOf("zzzz") + "zzzz".length();
    ...
    public void test0152() throws JavaModelException {
        ...
        try {
            contextComplete0(this.workingCopies[0], cursorLocation, /*do not use extended context*/
            false, /*ask enclosing element*/
            true, /*ask visible elements*/
            true, null);
    ...
    public void test0158() throws JavaModelException {
        ...
        assertResults("completion offset=" + (cursorLocation) + "\n" + "completion range=[" + (tokenStart) + ", " + (tokenEnd) + "]\n" + "completion token=\"zzzz\"\n" + "completion token kind=TOKEN_KIND_NAME\n" + "expectedTypesSignatures=null\n" + "expectedTypesKeys=null\n" + "completion token location={STATEMENT_START}\n" + "enclosingElement=foo() {key=Ltest/X;.foo()V} [in X [in [Working copy] X.java [in test [in src3 [in Completion]]]]]", result.context);
    }
    ...
    public void test0159() throws JavaModelException {
        ...
        int cursorLocation = str.lastIndexOf("zzzz") + "zzzz".length();
        CompletionResult result = contextComplete(this.workingCopies[0], cursorLocation, true, false);
        assertResults("completion offset=" + (cursorLocation) + "\n" + "completion range=[" + (tokenStart) + ", " + (tokenEnd) + "]\n" + "completion token=\"zzzz\"\n" + "completion token kind=TOKEN_KIND_NAME\n" + "expectedTypesSignatures=null\n" + "expectedTypesKeys=null\n" + "completion token location={MEMBER_START}\n" + "enclosingElement=X {key=Ltest/X;} [in [Working copy] X.java [in test [in src3 [in Completion]]]]", result.context);
    }
    ...
    public void test0160() throws JavaModelException {
        ...
        int cursorLocation = str.lastIndexOf("zzzz") + "zzzz".length();
        CompletionResult result = contextComplete(this.workingCopies[0], cursorLocation, true, false);
        assertResults("completion offset=" + (cursorLocation) + "\n" + "completion range=[" + (tokenStart) + ", " + (tokenEnd) + "]\n" + "completion token=\"zzzz\"\n" + "completion token kind=TOKEN_KIND_NAME\n" + "expectedTypesSignatures=null\n" + "expectedTypesKeys=null\n" + "completion token location=UNKNOWN\n" + "enclosingElement=[Working copy] X.java [in test [in src3 [in Completion]]]", result.context);
    }
    ...
    public void test0161() throws JavaModelException {
        ...
        int cursorLocation = str.lastIndexOf("zzzz") + "zzzz".length();
        CompletionResult result = contextComplete(this.workingCopies[0], cursorLocation, true, false);
        assertResults("completion offset=" + (cursorLocation) + "\n" + "completion range=[" + (tokenStart) + ", " + (tokenEnd) + "]\n" + "completion token=\"zzzz\"\n" + "completion token kind=TOKEN_KIND_NAME\n" + "expectedTypesSignatures=null\n" + "expectedTypesKeys=null\n" + "completion token location={MEMBER_START}\n" + "enclosingElement=Y {key=Ltest/X$Y;} [in X [in [Working copy] X.java [in test [in src3 [in Completion]]]]]", result.context);
    }
