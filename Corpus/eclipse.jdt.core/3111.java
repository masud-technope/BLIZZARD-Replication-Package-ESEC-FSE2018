...
public class Example extends Object implements Runnable, Serializable {

    public enum ExampleEnum implements Runnable, Serializable {
    ...
    public int[] array = { 11111, 22222, 33333, 44444, 55555 };

    public String[] array2 = new String[] { "aaaaa", "bbbbb" };

    public Object[] array3 = { null, null };
