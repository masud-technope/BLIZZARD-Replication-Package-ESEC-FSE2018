...
public class Javadoc extends Comment {
	 ...
	 */
    public static final SimplePropertyDescriptor COMMENT_PROPERTY = //$NON-NLS-1$
    new SimplePropertyDescriptor(Javadoc.class, "comment", String.class, MANDATORY);

    /**
	 * The "tags" structural property of this node type (element type: {@link TagElement}).
	 * @since 3.1
	 */
    public static final ChildListPropertyDescriptor TAGS_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(Javadoc.class, "tags", TagElement.class, CYCLE_RISK);
