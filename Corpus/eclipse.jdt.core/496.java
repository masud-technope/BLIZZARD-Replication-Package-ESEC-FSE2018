...
public class CreationReference extends MethodReference {
    ...
    new ChildPropertyDescriptor(CreationReference.class, "type", Type.class, MANDATORY, NO_CYCLE_RISK);

    /**
	 * The "typeArguments" structural property of this node type (element type: {@link Type}).
	 */
    public static final ChildListPropertyDescriptor TYPE_ARGUMENTS_PROPERTY = internalTypeArgumentsFactory(CreationReference.class);
	 ...
	 */
    int treeSize() {
        return memSize() + (this.type == null ? 0 : getType().treeSize()) + (this.typeArguments == null ? 0 : this.typeArguments.listSize());
    }
}
