...
public class TypeBindingTests308 extends ConverterTestSetup {
    ...
    public void test013() throws Exception {
        String contents = "public class X extends Y<@Marker(10) Integer, String> {}\n" + "class Y<T, V> {}\n" + "@java.lang.annotation.Target (java.lang.annotation.ElementType.TYPE_USE)\n" + "@interface Marker {int value();}\n";
        this.workingCopy = getWorkingCopy("/Converter18/src/X.java", /*resolve*/
        true);
        ASTNode node = buildAST(contents, this.workingCopy);
        assertEquals("Not a compilation unit", ASTNode.COMPILATION_UNIT, node.getNodeType());
    ...
    public void test014() throws Exception {
        String contents = "public class X<T extends Object & Comparable<? super @Marker String>> {}\n" + "class Y<T> {}\n" + "@java.lang.annotation.Target (java.lang.annotation.ElementType.TYPE_USE)\n" + "@interface Marker {}\n";
        this.workingCopy = getWorkingCopy("/Converter18/src/X.java", /*resolve*/
        true);
        ASTNode node = buildAST(contents, this.workingCopy);
        assertEquals("Not a compilation unit", ASTNode.COMPILATION_UNIT, node.getNodeType());
    ...
    public void test017() throws Exception {
        String contents = "public class X<P, C> {\n" + "  public X() {\n" + "    if (!(this instanceof @Marker X)) {}\n" + "  }\n" + "}\n" + "@java.lang.annotation.Target (java.lang.annotation.ElementType.TYPE_USE)\n" + "@interface Marker {}\n";
        this.workingCopy = getWorkingCopy("/Converter18/src/X.java", true);
        ASTNode node = buildAST(contents, this.workingCopy);
        assertEquals("Not a compilation unit", ASTNode.COMPILATION_UNIT, node.getNodeType());
        CompilationUnit compilationUnit = (CompilationUnit) node;
    ...
    public void testAnnotatedBinaryType3() throws CoreException, IOException {
        ...
        try {
            String[] pathAndContents = new String[] { "Outer.java", "public class Outer<K>  {\n" + "	class Inner<P> {\n" + "	}\n" + "	public @T(1) Outer<@T(2) String>.@T(3) Inner<@T(4) Integer> @T(5) [] omi @T(6) [];\n" + "}\n" + "@java.lang.annotation.Target (java.lang.annotation.ElementType.TYPE_USE)\n" + "@interface T {\n" + "	int value();\n" + "}\n" };
            HashMap libraryOptions = new HashMap(javaProject.getOptions(true));
            libraryOptions.put(CompilerOptions.OPTION_Store_Annotations, CompilerOptions.ENABLED);
            addLibrary(javaProject, jarName, srcName, pathAndContents, JavaCore.VERSION_1_8, libraryOptions);
    ...
    public void testBinarySuperInterfaces() throws CoreException, IOException {
        ...
        final IJavaProject javaProject = getJavaProject("Converter18");
        try {
            String[] pathAndContents = new String[] { "Y.java", "import java.lang.annotation.ElementType;\n" + "import java.lang.annotation.Target;\n" + "@Target(ElementType.TYPE_USE)\n" + "@interface T1 {\n" + "}\n" + "public abstract class Y implements Comparable<@T1 Y>{  \n" + "}\n" };
            HashMap libraryOptions = new HashMap(javaProject.getOptions(true));
            libraryOptions.put(CompilerOptions.OPTION_Store_Annotations, CompilerOptions.ENABLED);
            addLibrary(javaProject, jarName, srcName, pathAndContents, JavaCore.VERSION_1_8, libraryOptions);
            String contents = "public class X {\n" + "    void foo(Y y) {\n" + "    }\n" + "}\n";
    ...
    public void testAnnotatedTypeIdentity3() throws CoreException, IOException {
        ...
        final IJavaProject javaProject = getJavaProject("Converter18");
        try {
            String[] pathAndContents = new String[] { "Outer.java", "import java.util.List;\n" + "public class Outer  {\n" + "	@T List<@T String> ls;\n" + "}\n" + "@java.lang.annotation.Target (java.lang.annotation.ElementType.TYPE_USE)\n" + "@interface T {\n" + "	int value() default 10;\n" + "}\n" };
            HashMap libraryOptions = new HashMap(javaProject.getOptions(true));
            libraryOptions.put(CompilerOptions.OPTION_Store_Annotations, CompilerOptions.ENABLED);
            addLibrary(javaProject, jarName, srcName, pathAndContents, JavaCore.VERSION_1_8, libraryOptions);
    ...
    public void testGenericMethod() throws CoreException, IOException {
        String contents = "import java.lang.annotation.Annotation;\n" + "import java.lang.annotation.ElementType;\n" + "import java.lang.annotation.Target;\n" + "@Target(ElementType.TYPE_USE)\n" + "@interface T {\n" + "}\n" + "public class X { \n" + "	<N extends Annotation> @T String f(N a) {\n" + "		return null;\n" + "	}\n" + "}\n";
        this.workingCopy = getWorkingCopy("/Converter18/src/X.java", true);
        ASTNode node = buildAST(contents, this.workingCopy);
        assertEquals("Not a compilation unit", ASTNode.COMPILATION_UNIT, node.getNodeType());
        CompilationUnit compilationUnit = (CompilationUnit) node;
    ...
    public void testBinaryAnnotationType() throws CoreException, IOException {
        ...
        final IJavaProject javaProject = getJavaProject("Converter18");
        try {
            String[] pathAndContents = new String[] { "T.java", "import java.lang.annotation.ElementType;\n" + "import java.lang.annotation.Target;\n" + "@Deprecated\n" + "@Target(ElementType.TYPE_USE)\n" + "@interface T {\n" + "	int value() default 0;\n" + "}\n" };
            HashMap libraryOptions = new HashMap(javaProject.getOptions(true));
            libraryOptions.put(CompilerOptions.OPTION_Store_Annotations, CompilerOptions.ENABLED);
            addLibrary(javaProject, jarName, srcName, pathAndContents, JavaCore.VERSION_1_8, libraryOptions);
            String contents = "@T\n" + "public class X {\n" + "}\n";
    ...
    public void testAnnotationRecovery() throws CoreException, IOException {
        ...
        String expected = "import java.lang.annotation.ElementType;\n" + "import java.lang.annotation.Target;\n" + "import java.util.List;\n" + "@Target(ElementType.TYPE_USE) @interface NonNull {}\n" + "public class X {\n" + "  List<@NonNull String> list2;\n" + "}\n" + "class Y {\n" + "  void bar(){\n" + "  }\n" + "  void foo(){\n" + "  }\n" + "}\n";
        this.workingCopy = getWorkingCopy("/Converter18/src/X.java", true);
    ...
    public void testBug427337() throws CoreException, IOException {
        String contents = "public class X implements I {\n" + "}\n";
    ...
    public void test425216() throws CoreException, IOException {
        String contents = "import static java.lang.annotation.ElementType.TYPE_USE;\n" + "import java.lang.annotation.Target;\n" + "@Target(TYPE_USE)\n" + "@interface NonNull {}\n" + "public class X {\n" + "   X foo(@NonNull X this) {\n" + "	   return this;\n" + "   }\n" + "}\n";
        this.workingCopy = getWorkingCopy("/Converter18/src/X.java", true);
        ASTNode node = buildAST(contents, this.workingCopy);
        assertEquals("Not a compilation unit", ASTNode.COMPILATION_UNIT, node.getNodeType());
        CompilationUnit compilationUnit = (CompilationUnit) node;
    ...
    public void testBug487716a() throws Exception {
        try {
            ...
            this.workingCopy = getWorkingCopy("/Converter18/src/p/X.java", /*resolve*/
            true);
            ASTNode node = buildAST(contents, this.workingCopy, false);
            assertEquals("Not a compilation unit", ASTNode.COMPILATION_UNIT, node.getNodeType());
            CompilationUnit compilationUnit = (CompilationUnit) node;
    ...
    public void testBug460491_comment30() throws CoreException {
        ...
        testPackage.createCompilationUnit("Generic.java", "package test;\n" + "\n" + "public class Generic<T> {\n" + "	public static class NestedStatic {\n" + "		public static final String X = \"x\";\n" + "	}\n" + "}\n", true, null);
