...
public class ASTRewritingModifyingRemoveTest extends ASTRewritingModifyingTest {
    ...
    public void testBug446446_001() throws Exception {
        ...
        String contents = "package testBug446446_001;\n" + "public class X {\n " + "    public static void main(String[] args) {\n" + "        X bug = new X(\n" + "                1.0e-3  // some comment\n" + "                , null);\n" + "    }\n" + "\n" + "    X(double d) {\n" + "    }\n" + "}\n";
        ...
        String preview = evaluateRewrite(cu, astRoot);
        String expected = "package testBug446446_001;\n" + "public class X {\n " + "    public static void main(String[] args) {\n" + "        X bug = new X(\n" + "                1.0e-3  // some comment\n" + ");\n" + "    }\n" + "\n" + "    X(double d) {\n" + "    }\n" + "}\n";
    ...
    public void testBug446446_002() throws Exception {
        ...
        String contents = "package testBug446446_002;\n" + "public class X {\n" + "    public void foo() {\n" + "        if (i == 0) {\n" + "            foo();\n" + "            i++; // comment\n" + "            i++;}" + "    }\n" + "}\n";
        StringBuffer buf = new StringBuffer(contents);
        ICompilationUnit cu = pack1.createCompilationUnit("X.java", buf.toString(), false, null);
        CompilationUnit astRoot = createCU(cu, false);
        astRoot.recordModifications();
        ...
        String preview = evaluateRewrite(cu, astRoot);
        String expected = "package testBug446446_002;\n" + "public class X {\n" + "    public void foo() {\n" + "        if (i == 0) {\n" + "            foo();\n" + "            i++; // comment\n" + "}    }\n" + "}\n";
        assertEqualString(preview, expected);
    }
    ...
    public void testBug446446_003() throws Exception {
        ...
        String contents = "package testBug446446_003;\n" + "public class X {\n" + "    public void foo() {\n" + "        if (i == 0) {\n" + "            foo();\n" + "            i++; // comment\n" + "            i++;\n" + "        }\n" + "    }\n" + "}\n";
        StringBuffer buf = new StringBuffer(contents);
        ICompilationUnit cu = pack1.createCompilationUnit("X.java", buf.toString(), false, null);
        CompilationUnit astRoot = createCU(cu, false);
        astRoot.recordModifications();
        ...
        thenBlock.statements().remove(2);
        String preview = evaluateRewrite(cu, astRoot);
        String expected = "package testBug446446_003;\n" + "public class X {\n" + "    public void foo() {\n" + "        if (i == 0) {\n" + "            foo();\n" + "            i++; // comment\n" + "        }\n" + "    }\n" + "}\n";
        assertEqualString(preview, expected);
    }
    ...
    public void testBug446446_004() throws Exception {
        ...
        String contents = "package testBug446446_004;\n" + "public class X {\n" + "    public void foo() {\n" + "        if (i == 0) {\n" + "            foo();\n" + "            i++; // comment\n" + "            i++;\n" + "            i++;}\n" + "    }\n" + "}\n";
        StringBuffer buf = new StringBuffer(contents);
        ICompilationUnit cu = pack1.createCompilationUnit("X.java", buf.toString(), false, null);
        CompilationUnit astRoot = createCU(cu, false);
        astRoot.recordModifications();
        ...
        thenBlock.statements().remove(2);
        String preview = evaluateRewrite(cu, astRoot);
        String expected = "package testBug446446_004;\n" + "public class X {\n" + "    public void foo() {\n" + "        if (i == 0) {\n" + "            foo();\n" + "            i++; // comment\n" + "}\n" + "    }\n" + "}\n";
        assertEqualString(preview, expected);
    }
    ...
    public void testBug446446_005() throws Exception {
        ...
        String contents = "package testBug446446_005;\n" + "public class X {\n" + "    public void foo() {\n" + "        if (i == 0) {\n" + "            foo();\n" + "            i++; // comment\n" + "            i++;}" + "    }\n" + "}\n";
        StringBuffer buf = new StringBuffer(contents);
        ICompilationUnit cu = pack1.createCompilationUnit("X.java", buf.toString(), false, null);
        CompilationUnit astRoot = createCU(cu, false);
        astRoot.recordModifications();
        ...
        String preview = evaluateRewrite(cu, astRoot);
        String expected = "package testBug446446_005;\n" + "public class X {\n" + "    public void foo() {\n" + "        if (i == 0) {\n" + "            foo();\n" + "            i++; // comment\n" + "            --i;}    }\n" + "}\n";
        assertEqualString(preview, expected);
    }
}
