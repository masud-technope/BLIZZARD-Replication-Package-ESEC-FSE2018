 ...
 */
    public void testFieldOccurencesInWorkingCopies() throws CoreException {
        ...
        try {
            ...
            new SearchEngine(new ICompilationUnit[] { wc1, wc2 }).search(pattern, new SearchParticipant[] { SearchEngine.getDefaultSearchParticipant() }, scope, resultCollector, null);
            assertEquals("Unexpected occurences of field p1.X.BAR", "p1/X.java [in P1] p1.X.BAR [BAR]\n" + "p2/Y.java [in P2] int p2.Y.bar() [BAR]", resultCollector.toString());
        } finally {
            if (wc1 != null) {
 ...
 */
    public void testHierarchyScope1() throws CoreException {
        try {
            ...
            assertSearchResults("p/X.java [in P1] void p.X.bar() [foo()]", resultCollector);
        } finally {
            deleteProject("P1");
            deleteProject("P2");
        }
 ...
 */
    public void testHierarchyScope3() throws CoreException {
        try {
            ...
            resultCollector.showProject();
            search(method, REFERENCES, scope, resultCollector);
            assertSearchResults("q/Y.java [in P2] void q.Y.bar() [foo()]", resultCollector);
        } finally {
            deleteProject("P1");
            deleteProject("P2");
        }
 ...
 */
    public void testHierarchyScope4() throws CoreException {
        try {
            ...
            resultCollector.showProject();
            search(method, REFERENCES, scope, resultCollector);
            assertSearchResults("p2/Y.java [in P2] void p2.Y.bar() [foo()] EXACT_MATCH", resultCollector);
        } finally {
 ...
 */
    public void testPackageDeclaration() throws CoreException {
        try {
            ...
            search(pkg, DECLARATIONS, scope, resultCollector);
            assertSearchResults("Unexpected package declarations", "p [in P1] p", resultCollector);
        } finally {
            deleteProject("P1");
            deleteProject("P2");
        }
 ...
 */
    public void testReferenceInWorkingCopies() throws CoreException {
        ...
        try {
            ...
            workingCopy1 = getCompilationUnit("/P1/p1/X.java").getWorkingCopy(owner, /*no progress monitor*/
            null);
            workingCopy1.getBuffer().setContents("package p1;\n" + "public class X {\n" + "  void bar(Test test) {\n" + "  }\n" + "}");
            workingCopy1.makeConsistent(null);
            workingCopy2 = getCompilationUnit("/P2/p2/Y.java").getWorkingCopy(owner, /*no progress monitor*/
            null);
            ...
            new SearchEngine(owner).search(SearchPattern.createPattern(method, REFERENCES), new SearchParticipant[] { SearchEngine.getDefaultSearchParticipant() }, scope, resultCollector, null);
            assertSearchResults("Unexpected package references", "p2/Y.java void p2.Y.fred() [bar(null)]", resultCollector);
        } finally {
 ...
 */
    public void testTypeDeclarationInJar() throws CoreException {
        try {
            ...
            JavaSearchResultCollector resultCollector = new JavaSearchResultCollector();
            resultCollector.showProject();
            search("Object", TYPE, DECLARATIONS, scope, resultCollector);
            assertSearchResults("Unexpected result in scope of P1", getExternalJCLPathString() + " [in P1] java.lang.Object", resultCollector);
            scope = SearchEngine.createJavaSearchScope(new IJavaElement[] { p2 });
            resultCollector = new JavaSearchResultCollector();
            resultCollector.showProject();
            search("Object", TYPE, DECLARATIONS, scope, resultCollector);
            assertSearchResults("Unexpected result in scope of P2", getExternalJCLPathString() + " [in P2] java.lang.Object", resultCollector);
        } finally {
            deleteProject("P1");
            deleteProject("P2");
        }
 ...
 */
    public void testBug151189_Workspace() throws CoreException {
        try {
            ...
            //JavaSearchScope(new IJavaElement[] {p1, p2});
            IJavaSearchScope scope = SearchEngine.createWorkspaceScope();
            JavaSearchResultCollector resultCollector = new JavaSearchResultCollector();
            resultCollector.showProject();
            search(method, DECLARATIONS, scope, resultCollector);
            assertSearchResults("Unexpected declarations of method test.Declaration_bis.doOperation(int)", "test/Declaration_bis.java [in P2] void test.Declaration_bis.doOperation(int) [doOperation]", resultCollector);
            // search method declaration in workspace scope with JDT-UI flags
            resultCollector = new JavaSearchResultCollector();
            resultCollector.showProject();
            search(method, UI_DECLARATIONS, scope, resultCollector);
            assertSearchResults("Unexpected declarations of method test.Declaration_bis.doOperation(int)", "pack/Declaration.java [in P1] void pack.Declaration.doOperation(int) [doOperation]\n" + "pack/Interface.java [in P1] void pack.Interface.doOperation(int) [doOperation]\n" + "test/Declaration_bis.java [in P2] void test.Declaration_bis.doOperation(int) [doOperation]", resultCollector);
        } finally {
            deleteProject("P1");
            deleteProject("P2");
        }
 ...
 */
    public void testBug163072() throws CoreException {
        try {
            // setup project P1
            /*IJavaProject p1 = */
            // standard project using 1.4 compliance
            createJavaProject("P1");
            ...
            resultCollector.showAccuracy(true);
            search(method, REFERENCES, scope, resultCollector);
            assertSearchResults("Unexpected references of method Test.getType()", "test/Test.java [in P1] void test.Test.foo() [getType()] EXACT_MATCH", resultCollector);
        } finally {
            deleteProject("P1");
            deleteProject("P2");
        }
 ...
 */
    public void testBug176831() throws CoreException {
        try {
            ...
            resultCollector.showProject();
            resultCollector.showAccuracy(true);
            new SearchEngine().search(SearchPattern.createPattern("toString", IJavaSearchConstants.METHOD, IJavaSearchConstants.DECLARATIONS, SearchPattern.R_EXACT_MATCH), new SearchParticipant[] { SearchEngine.getDefaultSearchParticipant() }, scope, resultCollector, null);
            assertSearchResults("Unexpected references to /P1/p/A.java", "" + getExternalJCLPathString() + " [in P2] java.lang.String java.lang.Object.toString() EXACT_MATCH", resultCollector);
        } finally {
            deleteProject("P1");
            deleteProject("P2");
        }
    ...
    public void testBug176831b() throws CoreException {
        try {
            ...
            resultCollector.showAccuracy(true);
            new SearchEngine().search(SearchPattern.createPattern("toString", IJavaSearchConstants.METHOD, IJavaSearchConstants.DECLARATIONS, SearchPattern.R_EXACT_MATCH), new SearchParticipant[] { SearchEngine.getDefaultSearchParticipant() }, scope, resultCollector, null);
            assertSearchResults("Unexpected references to /P1/p/A.java", "" + getExternalJCLPathString() + " [in P3] java.lang.String java.lang.Object.toString() EXACT_MATCH", resultCollector);
        } finally {
            deleteProject("P1");
            deleteProject("P2");
            deleteProject("P3");
 ...
 */
    public void testBug195228() throws CoreException {
        try {
            ...
            new SearchEngine().searchAllTypeNames(null, SearchPattern.R_EXACT_MATCH, null, SearchPattern.R_PREFIX_MATCH, IJavaSearchConstants.TYPE, scope, requestor, IJavaSearchConstants.WAIT_UNTIL_READY_TO_SEARCH, null);
 ...
 */
    public void testBug199392_Jar() throws CoreException {
        try {
            ...
            new SearchEngine().searchAllTypeNames(null, SearchPattern.R_EXACT_MATCH, new char[] { 'M', 'y' }, SearchPattern.R_CAMELCASE_MATCH, IJavaSearchConstants.TYPE, scope, collector, IJavaSearchConstants.WAIT_UNTIL_READY_TO_SEARCH, null);
            assertEquals("Found types sounds not to be correct", "test.MyClass", collector.toString());
        } finally {
    ...
    public void testBug199392_Jar_SamePartCount() throws CoreException {
        try {
            ...
            IJavaSearchScope scope = SearchEngine.createJavaSearchScope(new IJavaElement[] { project });
            new SearchEngine().searchAllTypeNames(null, SearchPattern.R_EXACT_MATCH, new char[] { 'M', 'y' }, SearchPattern.R_CAMELCASE_SAME_PART_COUNT_MATCH, IJavaSearchConstants.TYPE, scope, collector, IJavaSearchConstants.WAIT_UNTIL_READY_TO_SEARCH, null);
            assertEquals("Found types sounds not to be correct", "", collector.toString());
        } finally {
            deleteProject("Test.jar");
        }
    }
 ...
 */
    public void testBug210689() throws CoreException {
        try {
            ...
            resultCollector.showProject();
            resultCollector.showAccuracy(true);
            new SearchEngine().search(pattern, new SearchParticipant[] { SearchEngine.getDefaultSearchParticipant() }, SearchEngine.createWorkspaceScope(), resultCollector, null);
            assertSearchResults("Unexpected references to /P1/p/A.java", "p/Ref.java [in P2] p.Ref.a [A] EXACT_MATCH", resultCollector);
        } finally {
            deleteProject("P0");
            deleteProject("P1");
            deleteProject("P2");
 ...
 */
    public void testBug229128() throws CoreException {
        ...
        try {
            ...
            copies[0] = getWorkingCopy("/P1/p/X.java", "package p;\n" + "@MyAnnot\n" + "public class X {\n" + "}\n", /*default working copy owner*/
            null);
            // setup project P2
            IJavaProject p2 = createJavaProject("P2", new String[] { "" }, new String[] { "JCL15_LIB" }, new String[] { "/P1" }, "", "1.5");
            createFolder("/P2/q");
            copies[1] = getWorkingCopy("/P2/q/Y.java", "package q;\n" + "@p.MyAnnot\n" + "public class Y {\n" + "}\n", /*default working copy owner*/
            null);
            // Get annotation type
            IType type = getCompilationUnit("/P1/p/MyAnnot.java").getType("MyAnnot");
            // search annotation type reference in P2 scope
            IJavaSearchScope scope = SearchEngine.createJavaSearchScope(new IJavaElement[] { p2 }, /*don't include referenced projects*/
            false);
            JavaSearchResultCollector resultCollector = new JavaSearchResultCollector();
            resultCollector.showProject();
            resultCollector.showAccuracy(true);
            search(type, ANNOTATION_TYPE_REFERENCE, scope, resultCollector);
            assertSearchResults("Unexpected references of annotation type MyAnnot", "q/Y.java [in P2] q.Y [p.MyAnnot] EXACT_MATCH", resultCollector);
        } finally {
 ...
 */
    public void testBug229951a() throws Exception {
        try {
            ...
            assertSearchResults("Unexpected references of annotation type MyAnnot", "X229951.java X229951 [X229951]", resultCollector);
        } finally {
 ...
 */
    public void testBug250454() throws CoreException {
        try {
            ...
            new SearchEngine().search(pattern, new SearchParticipant[] { SearchEngine.getDefaultSearchParticipant() }, SearchEngine.createWorkspaceScope(), resultCollector, null);
            assertSearchResults("Unexpected references to " + method, "p/ShapeUser.java [in P2] void p.ShapeUser.useShape(Shape) [f()] EXACT_MATCH SUPER INVOCATION", resultCollector);
        } finally {
            deleteProject("P0");
            deleteProject("P1");
            deleteProject("P2");
    ...
    public void testBug250454_jars() throws CoreException, IOException {
        ...
        try {
            // setup jar
            String[] pathsAndContents = new String[] { "p/Shape.java", "package p;\n" + "public interface Shape {\n" + "	public void f();\n" + "}\n" };
