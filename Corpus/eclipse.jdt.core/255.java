...
public class AutoBoxingTest extends AbstractComparableTest {
    ...
    public // constant cases of base type -> Number
    void test001() {
        // int -> Integer
    ...
    public // non constant cases of base type -> Number
    void test002() {
        // int -> Integer
    ...
    public // autoboxing method is chosen over private exact match & visible varargs method
    void test004() {
    ...
    public // this is NOT an ambiguous case as 'long' is matched before autoboxing kicks in
    void test005() {
        this.runConformTest(new String[] { "X.java", "public class X {\n" + "	public static void main(String[] s) {\n" + "		new Y().test(1);\n" + "	}\n" + "}\n" + "class Y {\n" + "	void test(Integer i) { System.out.print('n'); }\n" + "	void test(long i) { System.out.print('y'); }\n" + "}\n" }, "y");
    }

    public void test006() {
        // Integers are not compatible with Longs, even though ints are compatible with longs
        ...
        // likewise with Byte and Integer
    ...
    public void test007() {
        // this is NOT an ambiguous case as Long is not a match for int
        this.runConformTest(new String[] { "X.java", "public class X {\n" + "	public static void main(String[] s) {\n" + "		new Y().test(1, 1);\n" + "	}\n" + "}\n" + "class Y {\n" + "	void test(Long i, int j) { System.out.print('n'); }\n" + "	void test(long i, Integer j) { System.out.print('y'); }\n" + "}\n" }, "y");
    }

    public // test autoboxing AND varargs method match
    void test008() {
        this.runConformTest(new String[] { "X.java", "public class X {\n" + "	public static void main(String[] s) {\n" + "		Y.test(1, new Integer(2), -3);\n" + "	}\n" + "}\n" + "class Y {\n" + "	public static void test(int ... i) { System.out.print('y'); }\n" + "}\n" }, "y");
    }

    public void test009() {
        // 2 of these sends are ambiguous
    ...
    public // local declaration assignment tests
    void test010() {
        this.runConformTest(new String[] { "X.java", "public class X {\n" + "	public static void main(String[] s) {\n" + "		int i = Y.test();\n" + "		System.out.print(i);\n" + "	}\n" + "}\n" + "class Y {\n" + "	public static Byte test() { return new Byte((byte) 1); }\n" + "}\n" }, "1");
        this.runConformTest(new String[] { "X.java", "public class X {\n" + "	public static void main(String[] s) {\n" + "		Object o = Y.test();\n" + "		System.out.print(o);\n" + "	}\n" + "}\n" + "class Y {\n" + "	public static int test() { return 1; }\n" + "}\n" }, "1");
    }

    public // field declaration assignment tests
    void test011() {
        this.runConformTest(new String[] { "X.java", "public class X {\n" + "	static int i = Y.test();\n" + "	public static void main(String[] s) {\n" + "		System.out.print(i);\n" + "	}\n" + "}\n" + "class Y {\n" + "	public static Byte test() { return new Byte((byte) 1); }\n" + "}\n" }, "1");
        this.runConformTest(new String[] { "X.java", "public class X {\n" + "	static Object o = Y.test();\n" + "	public static void main(String[] s) {\n" + "		System.out.print(o);\n" + "	}\n" + "}\n" + "class Y {\n" + "	public static int test() { return 1; }\n" + "}\n" }, "1");
    }

    public // varargs and autoboxing
    void test012() {
        this.runConformTest(new String[] { "X.java", "public class X {\n" + "	public static void main(String[] args) {\n" + "		Integer x = new Integer(15); \n" + "		int y = 32;\n" + "		System.out.printf(\"%x + %x\", x, y);\n" + "	}\n" + "}" }, "f + 20");
    }

    public // foreach and autoboxing
    void test013() {
    ...
    public // boolean expression
    void test032() throws // boolean expression
    Exception {
    ...
    public // boxing in field decl
    void test054() {
        this.runConformTest(new String[] { "X.java", "public class X {\n" + "	static Byte b = 1;\n" + "	public static void main(String[] s) {\n" + "		++b;\n" + "		if (b instanceof Byte) {\n" + "			System.out.println(\"SUCCESS\");\n" + "		}\n" + "	}\n" + "}\n" }, "SUCCESS");
    }

    public // boxing in foreach
    void test055() {
    ...
    public // autoboxing and generics
    void test058() {
        this.runConformTest(new String[] { "X.java", "import java.util.ArrayList;\n" + "import java.util.List;\n" + "import java.util.Iterator;\n" + "\n" + "public class X {\n" + "\n" + "	public static void main(String[] args) {\n" + "		List<Integer> list = new ArrayList<Integer>();\n" + "		for (int i = 0; i < 5; i++) {\n" + "			list.add(i);\n" + "	    }\n" + "	    int sum = 0;\n" + "	    for (Integer i : list) {\n" + "	    	sum += i;\n" + "	    }	    \n" + "        System.out.print(sum);\n" + "    }\n" + "}\n" }, "10");
    }
    ...
    public // autoboxing and boolean expr
    void test060() {
    ...
    public // generic type case + foreach statement
    void test065() {
        this.runConformTest(new String[] { "X.java", "import java.util.ArrayList;\n" + "import java.util.List;\n" + "\n" + "public class X {\n" + "	public static void main(String[] args) {\n" + "		List<Integer> list = new ArrayList<Integer>();\n" + "		for (int i = 0; i < 5; i++) {\n" + "			list.add(i);\n" + "	    }\n" + "	    int sum = 0;\n" + "	    for (int i : list) {\n" + "	    	sum += i;\n" + "	    }\n" + "        System.out.print(sum);\n" + "    }\n" + "}" }, "10");
    }

    public // array case + foreach statement
    void test066() {
    ...
    public void test104() {
        this.runConformTest(/* skipJavac */
        false, JavacTestOptions.Excuse.JavacGeneratesIncorrectCode, new String[] { "X.java", "import java.util.HashMap;\n" + "\n" + "public class X {\n" + "	public static void main(String[] args) {\n" + "		try {\n" + "			String x = \"\";\n" + "			HashMap<String, Integer> y = new HashMap<String, Integer>();\n" + "			Integer w = (x.equals(\"X\") ? 0 : y.get(\"yKey\"));\n" + "		} catch(NullPointerException e) {\n" + "			System.out.println(\"SUCCESS\");\n" + "		}\n" + "	}\n" + "}\n" }, "SUCCESS");
    }
    ...
    public void test106() {
        runConformTest(/* flush output directory */
        true, new String[] /* test files */
        { "X.java", "class XSuper<T> {\n" + "	T value;\n" + "}\n" + "public class X extends XSuper<Integer>{\n" + "	public void a() {\n" + "		value--;\n" + "		--value;\n" + "		value -= 1;\n" + "		value = value - 1;\n" + "		System.out.println(value);\n" + "	}\n" + "\n" + "	public static void main(final String[] args) {\n" + "		X x = new X();\n" + "		x.value = 5;\n" + "		x.a();\n" + "	}\n" + "}\n" }, /* do not check compiler log */
        null, /* expected output string */
        "1", /* expected error string */
        "", // javac options
        JavacTestOptions.JavacHasABug.JavacBugFixed_6_10);
    }
    ...
    public void test118() {
        ...
        "1", /* expected error string */
        "", // javac options
        JavacTestOptions.JavacHasABug.JavacBug6575821);
    }
