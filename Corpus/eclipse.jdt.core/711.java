...
public interface TagBits {
    ...
    final int HasTypeVariable = ASTNode.Bit30;

    // set either for wildcards (direct) or parameterized types indirectly referencing wildcards
    final int HasWildcard = ASTNode.Bit31;
}
