 ...
 */
    ...
    public void test005() {
        ...
        "SUCCESS", null, // flush previous output dir content
    ...
    public void test006() {
        ...
        false, new /* test files */
        String[] { "A.java", "public class A {\n" + "   public static void main(String[] args) {	\n" + "        System.out.print(X.i);	\n" + "	}	\n" + "}" }, /* expected compiler log */
        "", /* expected output string */
        "0", /* expected error string */
        "", // javac options
    ...
    public void test012() {
        ...
        customOptions.put(CompilerOptions.OPTION_ReportDeprecationInDeprecatedCode, CompilerOptions.IGNORE);
