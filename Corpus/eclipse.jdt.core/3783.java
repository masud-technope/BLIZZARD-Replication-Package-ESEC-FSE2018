...
public class ReconcileEnv extends AbstractCompilationEnv implements EclipseAnnotationProcessorEnvironment {
    ...
    private  ReconcileEnv(ReconcileContext context, ICompilationUnit workingCopy, IFile file, IJavaProject javaProj) {
        // acceptAST() callback.
        ...
        if (AptPlugin.DEBUG_COMPILATION_ENV)
            ...
            "constructed " + this + " for " + _workingCopy.getElementName());
    }
