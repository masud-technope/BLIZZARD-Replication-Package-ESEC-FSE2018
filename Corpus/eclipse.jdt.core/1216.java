...
public class ArrayAccess extends Expression {
	 ...
	 * @since 3.0
	 */
    public static final ChildPropertyDescriptor ARRAY_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(ArrayAccess.class, "array", Expression.class, MANDATORY, CYCLE_RISK);

    /**
	 * The "index" structural property of this node type (child type: {@link Expression}).
	 * @since 3.0
	 */
    public static final ChildPropertyDescriptor INDEX_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(ArrayAccess.class, "index", Expression.class, MANDATORY, CYCLE_RISK);
