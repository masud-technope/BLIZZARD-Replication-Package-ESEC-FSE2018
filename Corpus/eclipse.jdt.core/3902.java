...
public class VariableDeclarationStatement extends Statement {
    ...
    new SimplePropertyDescriptor(VariableDeclarationStatement.class, "modifiers", int.class, MANDATORY);
    ...
    new ChildListPropertyDescriptor(VariableDeclarationStatement.class, "modifiers", IExtendedModifier.class, CYCLE_RISK);
    ...
    new ChildPropertyDescriptor(VariableDeclarationStatement.class, "type", Type.class, MANDATORY, NO_CYCLE_RISK);
    ...
    new ChildListPropertyDescriptor(VariableDeclarationStatement.class, "fragments", VariableDeclarationFragment.class, CYCLE_RISK);
