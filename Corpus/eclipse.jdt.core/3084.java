...
public class SynchronizedStatement extends SubRoutineStatement {
    ...
    public FlowInfo analyseCode(BlockScope currentScope, FlowContext flowContext, FlowInfo flowInfo) {
        ...
        flowInfo = block.analyseCode(scope, new InsideSubRoutineFlowContext(flowContext, this), expression.analyseCode(scope, flowContext, flowInfo));
        // optimizing code gen
    ...
    public void resolve(BlockScope upperScope) {
        ...
        // not inlinable
        synchroVariable.setConstant(NotAConstant);
