...
public class QualifiedAllocationExpression extends AllocationExpression {
    ...
    public FlowInfo analyseCode(BlockScope currentScope, FlowContext flowContext, FlowInfo flowInfo) {
        ...
        if (this.enclosingInstance != null) {
            ...
            if (this.binding != null && this.binding.declaringClass != null) {
                ...
                if (superclass != null && superclass.isMemberType() && !superclass.isStatic()) {
                    ...
                    currentScope.tagAsAccessingEnclosingInstanceStateOf(superclass.enclosingType(), /* type variable access */
                    false);
        ...
        checkCapturedLocalInitializationIfNecessary((ReferenceBinding) (this.anonymousType == null ? this.binding.declaringClass.erasure() : this.binding.declaringClass.superclass().erasure()), currentScope, flowInfo);
        // process arguments
    ...
    private TypeBinding resolveTypeForQualifiedAllocationExpression(BlockScope scope) {
        ...
        if (this.constant != Constant.NotAConstant) {
            ...
            if (this.enclosingInstance != null) {
                ...
                if ((enclosingInstanceType = this.enclosingInstance.resolveType(scope)) == null) {
                    ...
                    enclosingInstanceType = new ProblemReferenceBinding(enclosingInstanceReference.compoundName, enclosingInstanceReference, ProblemReasons.NotVisible);
                ...
                if (this.type == null) {
                    ...
                    receiverType = this.type.resolveType(/* check bounds*/
                    scope, true);
                    checkIllegalNullAnnotation(scope, receiverType);
                    ...
                    if (receiverType.isValidBinding()) {
                        ...
                        if (this.binding != null && !this.binding.isValidBinding()) {
                            ...
                            if (closestMatch != null) {
                                if (// generic method
                                closestMatch.original().typeVariables != // generic method
            ...
            if (this.anonymousType == null) {
                ...
                if (superType.isTypeVariable()) {
                    ...
                    return null;
                } else if (// tolerate enum constant body
                this.type != null && superType.isEnum()) {
                ...
                this.resolvedType = // 1.2 change
                this.anonymousType.binding;
                if ((this.resolvedType.tagBits & TagBits.HierarchyHasProblems) != 0) {
                    // stop secondary errors
                    return null;
                }
        ...
        if (// must call before computeConversion() and typeMismatchError()
        TypeBinding.notEquals(expectedType, enclosingInstanceType))
    ...
    public void traverse(ASTVisitor visitor, BlockScope scope) {
        if (visitor.visit(this, scope)) {
            ...
            if (// case of enum constant
            this.type != null)
                this.type.traverse(visitor, scope);
            if (this.arguments != null) {
                int argumentsLength = this.arguments.length;
                for (int i = 0; i < argumentsLength; i++) this.arguments[i].traverse(visitor, scope);
            }
            if (this.anonymousType != null)
