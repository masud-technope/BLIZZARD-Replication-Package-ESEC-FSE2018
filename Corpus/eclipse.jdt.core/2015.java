...
public class LocalVariableLocator extends VariableLocator {
    ...
    protected int matchLocalVariable(LocalVariableBinding variable, boolean matchName) {
        ...
        if (matchName && !matchesName(this.pattern.name, variable.readableName()))
            return IMPOSSIBLE_MATCH;
        return variable.declaration.declarationSourceStart == getLocalVariable().declarationSourceStart ? ACCURATE_MATCH : IMPOSSIBLE_MATCH;
    }
