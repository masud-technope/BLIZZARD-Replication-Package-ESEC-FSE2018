 ...
 */
    public void close() {
        ...
        notifyChanged(event);
        synchronized (// ensure that no other thread is adding/removing a listener at the same time (https://bugs.eclipse.org/bugs/show_bug.cgi?id=126673)
        this) {
 ...
 */
    public void save(IProgressMonitor progress, boolean force) throws JavaModelException {
        ...
        try {
            ...
            if (this.file.exists()) {
                this.file.setContents(stream, force ? IResource.FORCE | IResource.KEEP_HISTORY : IResource.KEEP_HISTORY, null);
            } else {
 ...
 */
    ...
    public String toString() {
        ...
        //$NON-NLS-1$
        buffer.append("Owner: " + ((JavaElement) this.owner).toStringWithAncestors());
        //$NON-NLS-1$
