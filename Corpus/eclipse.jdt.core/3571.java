...
public class Clinit extends AbstractMethodDeclaration {
    ...
    private void generateCode(ClassScope classScope, ClassFile classFile, int clinitOffset) {
        ...
        if (this.assertionSyntheticFieldBinding != null) {
            ...
            codeStream.iconst_0();
            jumpLabel.place();
            codeStream.fieldAccess(Opcodes.OPC_putstatic, this.assertionSyntheticFieldBinding, /* default declaringClass */
            null);
        }
        ...
        if (TypeDeclaration.kind(declaringType.modifiers) == TypeDeclaration.ENUM_DECL) {
                ...
                if (fieldDeclarations != null) {
                    for (int i = 0, max = fieldDeclarations.length; i < max; i++) {
                        ...
                        if (fieldDecl.getKind() == AbstractVariableDeclaration.ENUM_CONSTANT) {
                            ...
                            codeStream.fieldAccess(Opcodes.OPC_getstatic, /* default declaringClass */
            ...
            codeStream.fieldAccess(Opcodes.OPC_putstatic, declaringType.enumValuesSyntheticfield, /* default declaringClass */
            null);
