 ...
 */
    public void testPrimarySuper() {
        ...
        "super(1, 2,", // expectedCompletionNodeToString:
        "<CompleteOnExplicitConstructorCall:primary().super(1, 2)>;", // expectedUnitDisplayString:
 ...
 */
    public void testPrimaryThis() {
        this.runTestCheckMethodParse(// compilationUnit:
        "class Bar {									\n" + "	static Bar x;								\n" + "	public class InnerBar {						\n" + "		InnerBar(Bar x) {						\n" + "		}										\n" + "	}											\n" + "	public class SubInnerBar extends InnerBar {	\n" + "		SubInnerBar(Bar x) {					\n" + "			primary().this(1, 2, i);			\n" + "		}										\n" + "	}											\n" + "}												\n", // completeBehind:
        "this(1, 2,", // expectedCompletionNodeToString:
        "<CompleteOnExplicitConstructorCall:primary().this(1, 2)>;", // expectedUnitDisplayString:
 ...
 */
    public void testSuper() {
        ...
        "class Bar {								\n" + "	Bar() {									\n" + "		super(1, 2, i);						\n" + "	}										\n" + "}											\n", // completeBehind:
        "super(1, 2,", // expectedCompletionNodeToString:
        "<CompleteOnExplicitConstructorCall:super(1, 2)>;", // expectedUnitDisplayString:
 ...
 */
    public void testThis() {
        ...
        "class Bar {								\n" + "	Bar() {									\n" + "		this(1, 2, i);						\n" + "	}										\n" + "}											\n", // completeBehind:
        "this(1, 2,", // expectedCompletionNodeToString:
        "<CompleteOnExplicitConstructorCall:this(1, 2)>;", // expectedUnitDisplayString:
 ...
 */
    public void testWrapperNameSuper() {
        ...
        "<CompleteOnMemberAccess:fred().x>", // expectedUnitDisplayString:
