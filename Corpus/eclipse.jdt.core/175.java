...
public abstract class ASTVisitor {
    ...
    public void endVisit(AnnotationTypeDeclaration annotationTypeDeclaration, BlockScope scope) {
    // do nothing by default
    }

    public void endVisit(AnnotationTypeDeclaration annotationTypeDeclaration, ClassScope scope) {
    // do nothing by default
    }

    public void endVisit(AnnotationTypeDeclaration annotationTypeDeclaration, CompilationUnitScope scope) {
    // do nothing by default
    }

    public void endVisit(AnnotationTypeMemberDeclaration annotationTypeDeclaration, ClassScope classScope) {
    // do nothing by default
    }
    ...
    public boolean visit(AnnotationTypeDeclaration annotationTypeDeclaration, BlockScope scope) {
        // do nothing by default, keep traversing
        return true;
    }

    public boolean visit(AnnotationTypeDeclaration annotationTypeDeclaration, ClassScope scope) {
        // do nothing by default, keep traversing
        return true;
    }

    public boolean visit(AnnotationTypeDeclaration annotationTypeDeclaration, CompilationUnitScope scope) {
        // do nothing by default, keep traversing
        return true;
    }

    public boolean visit(AnnotationTypeMemberDeclaration annotationTypeDeclaration, ClassScope classScope) {
        // do nothing by default, keep traversing
        return true;
    }
