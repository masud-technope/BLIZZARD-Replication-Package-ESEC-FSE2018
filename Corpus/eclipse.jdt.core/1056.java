 ...
 */
    ...
    public void generateAssignment(BlockScope currentScope, CodeStream codeStream, Assignment assignment, boolean valueRequired) {
        ...
        if (assignment.expression.isCompactableOperation()) {
            ...
            ((operator == PLUS) || (operator == MULTIPLY)) && ((variableReference = (SingleNameReference) operation.right).binding == this.binding) && // exclude non constant expressions, since could have side-effect
        ...
        switch(this.bits & RestrictiveFlagMASK) {
            ...
            Binding.FIELD:
                ...
                if (codegenField.canBeSeenBy(getReceiverType(currentScope), this, currentScope)) {
                    ...
                    fieldStore(currentScope, codeStream, codegenField, null, this.actualReceiverType, this.delegateThis == null, /*implicit this*/
                    valueRequired);
                    if (valueRequired) {
                        codeStream.generateImplicitConversion(assignment.implicitConversion);
                    }
            ...
            Binding.LOCAL:
                ...
                (this.bits & FirstAssignmentToLocal) != 0) {
                ...
                Binding.FIELD:
                    ...
                    fieldConstant == Constant.NotAConstant) {
                        if (codegenField.canBeSeenBy(getReceiverType(currentScope), this, currentScope)) {
                            ...
                            TypeBinding constantPoolDeclaringClass = CodeStream.getConstantPoolDeclaringClass(currentScope, codegenField, /* implicit this */
                            someReceiverType, true);
 ...
 */
    public void generateCompoundAssignment(BlockScope currentScope, CodeStream codeStream, MethodBinding writeAccessor, Expression expression, int operator, int assignmentImplicitConversion, boolean valueRequired) {
        switch(this.bits & RestrictiveFlagMASK) {
            ...
            Binding.FIELD:
                ...
                if (codegenField.isStatic()) {
                    if (codegenField.canBeSeenBy(getReceiverType(currentScope), this, currentScope)) {
                        TypeBinding someReceiverType = this.delegateThis != null ? this.delegateThis.type : this.actualReceiverType;
                        TypeBinding constantPoolDeclaringClass = CodeStream.getConstantPoolDeclaringClass(currentScope, codegenField, someReceiverType, /* implicit this */
                        true);
                        codeStream.fieldAccess(Opcodes.OPC_getstatic, codegenField, constantPoolDeclaringClass);
                    } else {
        ...
        switch(this.bits & RestrictiveFlagMASK) {
            ...
            Binding.FIELD:
                FieldBinding codegenField = ((FieldBinding) this.binding).original();
                if (codegenField.canBeSeenBy(getReceiverType(currentScope), this, currentScope)) {
                    fieldStore(currentScope, codeStream, codegenField, writeAccessor, this.actualReceiverType, this.delegateThis == null, /* implicit this */
                    valueRequired);
                } else {
    ...
    public void generateReceiver(CodeStream codeStream) {
        ...
        if (this.delegateThis != null) {
            ...
            codeStream.fieldAccess(Opcodes.OPC_getfield, this.delegateThis, /* default declaringClass */
            null);
        }
    }
    ...
    public TypeBinding reportError(BlockScope scope) {
        ...
        if (this.binding instanceof ProblemFieldBinding && ((ProblemFieldBinding) this.binding).problemId() == NotFound) {
            if (this.evaluationContext.declaringTypeName != null) {
                ...
                if (// if not found then internal error, field should have been found
                this.delegateThis != null) {
