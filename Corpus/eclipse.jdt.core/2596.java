...
public class SuperMethodInvocation extends Expression {
	 ...
	 * @since 3.0
	 */
    public static final ChildPropertyDescriptor QUALIFIER_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(SuperMethodInvocation.class, "qualifier", Name.class, OPTIONAL, NO_CYCLE_RISK);
    ...
    new ChildListPropertyDescriptor(SuperMethodInvocation.class, "typeArguments", Type.class, NO_CYCLE_RISK);
    ...
    new ChildPropertyDescriptor(SuperMethodInvocation.class, "name", SimpleName.class, MANDATORY, NO_CYCLE_RISK);
    ...
    new ChildListPropertyDescriptor(SuperMethodInvocation.class, "arguments", Expression.class, CYCLE_RISK);
	 ...
	 */
    int treeSize() {
        return memSize() + (this.optionalQualifier == null ? 0 : getQualifier().treeSize()) + (this.typeArguments == null ? 0 : this.typeArguments.listSize()) + (this.methodName == null ? 0 : getName().treeSize()) + (this.arguments == null ? 0 : this.arguments.listSize());
    }
}
