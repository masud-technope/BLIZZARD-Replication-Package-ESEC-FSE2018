...
public abstract class Binding {
    ...
    public static final ReferenceBinding[] ANY_EXCEPTION = new ReferenceBinding[] { null };
    ...
    public static final int NullnessDefaultMASK = // included to terminate search up the parent chain
    NULL_UNSPECIFIED_BY_DEFAULT | DefaultLocationParameter | DefaultLocationReturnType | DefaultLocationField | DefaultLocationTypeArgument | DefaultLocationTypeParameter | DefaultLocationTypeBound | DefaultLocationArrayContents;
