 ...
 */
    ...
    protected void assertNoProblem(char[] source, ICompilationUnit unit) throws InterruptedException, JavaModelException {
        ...
        if (this.problemRequestor.problemCount > 0) {
            ...
            // need to set contents again to be sure that following reconcile will be really done
            unit.getBuffer().setContents(source);
            unit.reconcile(JLS_LATEST, // force problem detection to see errors if any
            true, // do not use working copy owner to not use working copies in name lookup
            null, null);
            if (this.problemRequestor.problemCount > 0) {
 ...
 */
    public void testAccessRestriction2() throws CoreException, IOException {
        try {
            ...
            addLibrary(project, "lib.jar", "libsrc.zip", new String[] { "p/X.java", "package p;\n" + "public class X {\n" + "}" }, /*no non-Java resources*/
 ...
 */
    public void testAccessRestriction3() throws CoreException {
        try {
            ...
            createJavaProject("P3", new String[] { "src" }, new String[] { "JCL_LIB" }, null, null, new String[] { "/P2" }, null, new String[][] { new String[] { "**/X" } }, /*don't combine access restrictions*/
            false, new boolean[] { true }, "bin", null, null, null, "1.4", /*don't import*/
            false);
 ...
 */
    public void testAccessRestriction4() throws CoreException {
        try {
            ...
            createFile("/P1/p/X.java", "package p; public class X {}");
            createJavaProject("P2", new String[] {}, new String[] {}, null, null, new String[] { "/P1" }, null, null, new boolean[] { true }, "", null, null, null, "1.4");
            createJavaProject("P3", new String[] { "src" }, new String[] { "JCL_LIB" }, null, null, new String[] { "/P2" }, null, new String[][] { new String[] { "**/X" } }, /*combine access restrictions*/
            true, new boolean[] { true }, "bin", null, null, null, "1.4", /*don't import*/
            false);
            setUpWorkingCopy("/P3/src/Y.java", "public class Y extends p.X {}");
 ...
 */
    public void testAccessRestriction5() throws CoreException {
        try {
            ...
            p2.setRawClasspath(classpath, null);
            this.problemRequestor.initialize(this.workingCopy.getSource().toCharArray());
            this.workingCopy.reconcile(ICompilationUnit.NO_AST, /*force problem detection*/
            true, null, null);
 ...
 */
    public void testAnnotations5() throws JavaModelException {
        ...
        try {
            setUp15WorkingCopy();
            annotation = getWorkingCopy("Reconciler15/src/p1/MyAnnot2.java", "/* test */\n" + "package p1;\n" + "public @interface MyAnnot2 {\n" + "  String bar();\n" + "}", this.wcOwner);
            setWorkingCopyContents("package p1;\n" + "public class X {\n" + "  @MyAnnot2(bar=\"a\")\n" + "  public void foo() {\n" + "  }\n" + "}");
 ...
 */
    public void testBroadcastAST1() throws JavaModelException {
        setWorkingCopyContents("package p1;\n" + "import p2.*;\n" + "public class X {\n" + "}");
        this.workingCopy.reconcile(JLS_LATEST, false, /*don't force problem detection*/
        null, /*primary owner*/
        null);
 ...
 */
    public void testBroadcastAST2() throws JavaModelException {
        this.workingCopy.reconcile(JLS_LATEST, true, /*force problem detection*/
        null, /*primary owner*/
        null);
        assertASTNodeEquals("Unexpected ast", "package p1;\n" + "import p2.*;\n" + "public class X {\n" + "  public void foo(){\n" + "  }\n" + "}\n", this.deltaListener.getCompilationUnitAST(this.workingCopy));
    }
    ...
    public void testBroadcastAST4() throws CoreException {
        JavaCore.run(new IWorkspaceRunnable() {
            ...
            public void run(IProgressMonitor monitor) throws CoreException {
                ReconcilerTests.this.workingCopy.reconcile(JLS_LATEST, /*force problem detection*/
                true, /*primary owner*/
                null, monitor);
                setWorkingCopyContents("package p1;\n" + "import p2.*;\n" + "public class X {\n" + "}");
                ReconcilerTests.this.workingCopy.reconcile(JLS_LATEST, /*don't force problem detection*/
                false, /*primary owner*/
                null, monitor);
            }
        }, /*no progress*/
 ...
 */
    public void testChangeInternalJar() throws CoreException, IOException {
        ...
        try {
            String[] pathAndContents = new String[] { "test/before/Foo.java", "package test.before;\n" + "public class Foo {\n" + "}\n" };
 ...
 */
    public void testConvertPrimitiveTypeArrayTypeArgument() throws CoreException {
        ...
        try {
            otherCopy = getWorkingCopy("Reconciler15/src/Y.java", "public class Y {\n" + "  void foo(Z<int[]> z) {}\n" + "}\n" + "class Z<E> {\n" + "}", this.wcOwner);
 ...
 */
    public void testExternal1() throws CoreException {
        // don't use the one created in setUp()
        this.workingCopy.discardWorkingCopy();
        this.workingCopy = null;
        this.problemRequestor = new ProblemRequestor();
        IClasspathEntry[] classpath = new IClasspathEntry[] { JavaCore.newLibraryEntry(getExternalJCLPath(), null, null) };
        this.workingCopy = newExternalWorkingCopy("External.java", classpath, this.problemRequestor, "public class External {\n" + "	String foo(){\n" + "		return \"\";\n" + "	}\n" + "}\n");
        this.workingCopy.reconcile(ICompilationUnit.NO_AST, false, null, /*no owner*/
        null);
        assertProblems("Unexpected problems", "----------\n" + "----------\n");
    }
 ...
 */
    public void testExternal2() throws CoreException {
        ...
        try {
            ...
            IClasspathEntry[] classpath = new IClasspathEntry[] { JavaCore.newContainerEntry(new Path("org.eclipse.jdt.core.tests.model.TEST_CONTAINER")) };
            this.workingCopy = newExternalWorkingCopy("External.java", classpath, this.problemRequestor, "public class External {\n" + "	String foo(){\n" + "		return \"\";\n" + "	}\n" + "}\n");
            this.workingCopy.reconcile(ICompilationUnit.NO_AST, false, /*no owner*/
            null, null);
 ...
 */
    public void testExternal3() throws Exception {
        try {
            ...
            IClasspathEntry[] classpath = new IClasspathEntry[] { JavaCore.newLibraryEntry(getExternalJCLPath(), null, null), JavaCore.newLibraryEntry(new Path(getExternalResourcePath("lib.jar")), null, null) };
            this.workingCopy = newExternalWorkingCopy("External.java", classpath, this.problemRequestor, "public class External {\n" + "	p.Lib field;\n" + "}\n");
            this.workingCopy.reconcile(ICompilationUnit.NO_AST, false, /*no owner*/
            null, null);
 ...
 */
    public void testMethodWithError01() throws CoreException {
        ...
        setWorkingCopyContents(contents);
        this.workingCopy.reconcile(ICompilationUnit.NO_AST, false, null, null);
        assertWorkingCopyDeltas("Unexpected delta after fixing syntax error", "[Working copy] X.java[*]: {CONTENT | FINE GRAINED}");
 ...
 */
    public void testMethodWithError05() throws CoreException {
        try {
            ...
            createFile("/Reconciler/src/tests/AbstractSearchableSource.java", contents);
            ...
            assertEquals("unexpected errors", expected, actual);
        } finally {
 ...
 */
    public void testMethodWithError07() throws CoreException {
        ...
        try {
            ...
            this.workingCopy = getCompilationUnit("Reconciler/src/p1/Y.java").getWorkingCopy(this.wcOwner, null);
            // Close working copy
            // use a back door as working copies cannot be closed
 ...
 */
    public void testMethodWithError08() throws CoreException {
        ...
        try {
            ...
            createFile("/Reconciler/src/p2/X01.java", contents);
            this.problemRequestor = new ProblemRequestor();
            this.problemRequestor.initialize(contents.toCharArray());
 ...
 */
    public void testRawUsage() throws CoreException {
        ICompilationUnit otherCopy = null;
        try {
            otherCopy = getWorkingCopy("Reconciler15/src/Generic105756.java", "public class Generic105756<T> {\n" + "  void foo() {}\n" + "}", this.wcOwner);
            setUp15WorkingCopy("/Reconciler15/src/X.java", this.wcOwner);
 ...
 */
    public void testReconcileParticipant02() throws CoreException {
        ...
        setWorkingCopyContents("package p1;\n" + "import p2.*;\n" + "public class X {\n" + "  public void bar() {\n" + "    System.out.println()\n" + "  }\n" + "}");
        this.workingCopy.reconcile(ICompilationUnit.NO_AST, false, null, null);
        assertDeltas("Unexpected participant delta", "<null>", participant.delta);
    }
 ...
 */
    public void testReconcileParticipant04() throws CoreException {
        ...
        assertSame("Unexpected participant ast", participant.ast, ast);
    }
 ...
 */
    public void testReconcileParticipant09() throws CoreException {
        ...
        this.workingCopy.reconcile(ICompilationUnit.NO_AST, false, /*don't force problem detection*/
        null, null);
    }
 ...
 */
    public void testReconcileParticipant10() throws CoreException {
        ...
        this.workingCopy.reconcile(ICompilationUnit.NO_AST, true, /*force problem detection*/
        null, null);
        assertTrue("Participant should have been notified", participantReconciled[0]);
    }
 ...
 */
    public void testRenameClasspathFile() throws CoreException {
        ...
        try {
            ...
            copy = getWorkingCopy("/P2/src/p2/Y.java", "package p2;\n" + "import p1.X;\n" + "public class Y extends X {\n" + "}", /*compute problems*/
            true);
            moveFile("/P1/.classpath2", "/P1/.classpath");
            this.problemRequestor.reset();
            copy.reconcile(ICompilationUnit.NO_AST, /*for pb detection*/
            true, /*default owner*/
            null, /*no progress*/
            null);
            assertProblems("Unexpected problems", "----------\n" + "----------\n");
 ...
 */
    ...
    public void testSuppressWarnings1() throws JavaModelException {
        ICompilationUnit otherCopy = null;
        try {
            otherCopy = getWorkingCopy("/Reconciler15/src/X.java", "@Deprecated\n" + "public class X {\n" + "   void foo(){}\n" + "}\n", this.wcOwner);
 ...
 */
    public void testSuppressWarnings2() throws JavaModelException {
        ICompilationUnit otherCopy = null;
        try {
            otherCopy = getWorkingCopy("/Reconciler15/src/java/util/List.java", "package java.util;\n" + "public interface List<E> {\n" + "}\n", this.wcOwner);
            setUp15WorkingCopy("/Reconciler15/src/X.java", this.wcOwner);
 ...
 */
    public void testSuppressWarnings3() throws JavaModelException {
        ICompilationUnit otherCopy = null;
        try {
            otherCopy = getWorkingCopy("/Reconciler15/src/java/util/HashMap.java", "package java.util;\n" + "public class HashMap implements Map {\n" + "}\n", this.wcOwner);
            setUp15WorkingCopy("/Reconciler15/src/X.java", this.wcOwner);
 ...
 */
    public void testTwoProjectsWithDifferentCompliances() throws CoreException {
        ...
        try {
            ...
            setWorkingCopyContents("package p;\n" + "public class Y {\n" + "  void bar(Class c) {\n" + "    new X().foo(c);\n" + "  }\n" + "}");
            this.workingCopy.reconcile(ICompilationUnit.NO_AST, /*force pb detection*/
            true, this.wcOwner, null);
            assertProblems("Unexpected problems", "----------\n" + "----------\n");
        } finally {
            deleteProjects(new String[] { "P1", "P2" });
        }
 ...
 */
    public void testTypeParameterWithBound() throws CoreException {
        ...
        ICompilationUnit workingCopy1 = null;
        try {
            workingCopy1 = getWorkingCopy("/Reconciler15/src/test/I.java", "package test;\n" + "public interface I {\n" + "	<T extends I> void foo(T t);\n" + "}\n", this.wcOwner);
            this.problemRequestor = new ProblemRequestor();
 ...
 */
    public void testTypeParameterStartingWithDollar() throws CoreException {
        ...
        ICompilationUnit workingCopy1 = null;
        try {
            workingCopy1 = getWorkingCopy("/Reconciler15/src/test/Y.java", "package test;\n" + "public class Y<$T> {\n" + "	void foo($T t);\n" + "}\n", this.wcOwner);
            this.problemRequestor = new ProblemRequestor();
            this.workingCopy = getWorkingCopy("Reconciler15/src/test/X.java", "", this.wcOwner);
            setWorkingCopyContents("package test;\n" + "public class X {\n" + "	public void bar() {\n" + "    new Y<String>().foo(\"\");\n" + "	}\n" + "}\n");
            this.workingCopy.reconcile(ICompilationUnit.NO_AST, false, this.wcOwner, null);
 ...
 */
    public void testTypeWithDollarName() throws CoreException {
        ...
        try {
            String contents = "package p1;\n" + "public class Y$Z {\n" + "}";
            createFile("/Reconciler/src/p1/Y$Z.java", contents);
            this.problemRequestor = new ProblemRequestor();
 ...
 */
    public void testTypeWithDollarName2() throws CoreException {
        ...
        try {
            ...
            workingCopy2 = getWorkingCopy("/Reconciler/src/p1/Y$Z.java", "package p1;\n" + "public class Y$Z {\n" + "}", owner);
            setWorkingCopyContents("package p1;\n" + "public class X {\n" + "  Y$Z field;\n" + "}");
 ...
 */
    public void testTypeWithDollarName3() throws CoreException {
        ...
        try {
            WorkingCopyOwner owner = this.workingCopy.getOwner();
            workingCopy2 = getWorkingCopy("/Reconciler/src/p1/Cl$ss.java", "package p1;\n" + "public interface Cl$ss {\n" + "        public void test(Cl$ss c);\n" + "        public void foo();\n" + "}", owner);
            setWorkingCopyContents("package p1;\n" + "public class X {\n" + "        void m(Cl$ss c2) {\n" + "                c2.test(c2);\n" + "                c2.foo();\n" + "        }\n" + "}");
            this.workingCopy.reconcile(ICompilationUnit.NO_AST, false, owner, null);
            assertProblems("Unexpected problems", "----------\n" + "----------\n");
        } finally {
 ...
 */
    public void testVarargs() throws CoreException {
        ...
        ICompilationUnit workingCopy1 = null;
        try {
            workingCopy1 = getWorkingCopy("/Reconciler15/src/test/X.java", "package test;\n" + "public class X {\n" + "	void bar(String ... args) {}\n" + "}\n", this.wcOwner);
            this.problemRequestor = new ProblemRequestor();
 ...
 */
    public void testBug36032a() throws CoreException, InterruptedException {
        try {
            ...
            this.createFile("/P/Test.java", source);
            ...
            this.createFile("/P/Bar.java", "class SBar{ void bar() {} }\n");
    ...
    public void testBug36032c() throws CoreException, InterruptedException {
        try {
            ...
            createFile("/P2/test/Test2.java", source);
 ...
 */
    public void testBug118823() throws CoreException, InterruptedException, IOException {
        try {
            ...
            createFile("/P1/Test.java", source);
            createJavaProject("P2", new String[] { "" }, new String[] { "JCL_LIB" }, new String[] { "/P1" }, "bin");
            String source2 = "class A {\n" + "	Secondary s;\n" + "}\n";
            createFile("/P2/A.java", source2);
            waitUntilIndexesReady();
            ...
            getWorkspace().run(new IWorkspaceRunnable() {
                ...
                public void run(IProgressMonitor monitor) throws CoreException {
                    ...
                    createFile("/P1/Test.java", source1);
                }
            }, null);
            ...
            this.workingCopies[0].reconcile(JLS_LATEST, // force problem detection to see errors if any
            true, // do not use working copy owner to not use working copies in name lookup
            null, null);
            assertNoProblem(sourceChars, this.workingCopies[0]);
            ...
            this.workingCopies[1].reconcile(JLS_LATEST, // force problem detection to see errors if any
            true, // do not use working copy owner to not use working copies in name lookup
            null, null);
    ...
    public void test1002() throws CoreException, InterruptedException, IOException {
        try {
            ...
            sources[1] = "interface I {\n" + "  void foo();\n" + "  void bar(X p);\n" + "}\n";
            createFile("/P2/I.java", sources[1]);
            createJavaProject("P3", new String[] { "" }, new String[] { "JCL_LIB" }, new String[] { /* compare with test1001 */
            "/P1", "/P2" }, "bin");
            sources[2] = "class Y implements I {\n" + "  // public void foo() { }\n" + "  // public void bar(X p) { }\n" + "}\n";
            createFile("/P3/Y.java", sources[2]);
            for (int i = 0; i < sources.length; i++) {
 ...
 */
    ...
    public void testIgnoreMethodBodies3() throws CoreException {
        ...
        setWorkingCopyContents("package p1;\n" + "import p2.*;" + "public class X {\n" + "  public void foo() {\n" + "    int i = 0;\n" + "  }\n" + "  public int bar() {\n" + "    int i = 0;\n" + "    new X() {\n" + "    };" + "  }\n" + "}");
        org.eclipse.jdt.core.dom.CompilationUnit ast = this.workingCopy.reconcile(JLS_LATEST, ICompilationUnit.IGNORE_METHOD_BODIES | ICompilationUnit.ENABLE_STATEMENTS_RECOVERY, null, null);
        // methods with anonymous classes should have their statements intact
        assertASTNodeEquals("Unexpected ast", "package p1;\n" + "import p2.*;\n" + "public class X {\n" + "  public void foo(){\n" + "  }\n" + "  public int bar(){\n" + "  }\n" + "}\n", ast);
    }
    ...
    public void testGenericAPIUsageFromA14Project() throws CoreException {
        ...
        try {
            ...
            createFile("/Reconciler1415/src/p1/X.java", source);
            this.workingCopies = new ICompilationUnit[1];
            char[] sourceChars = source.toCharArray();
            this.problemRequestor.initialize(sourceChars);
    ...
    public void testGenericAPIUsageFromA14Project4() throws CoreException {
        ...
        try {
            ...
            createFile("/Reconciler15API/src/p2/X.java", otherSource);
            project15.setOption(JavaCore.COMPILER_SOURCE, JavaCore.VERSION_1_5);
            project15.setOption(JavaCore.COMPILER_COMPLIANCE, JavaCore.VERSION_1_5);
            project15.setOption(JavaCore.COMPILER_CODEGEN_TARGET_PLATFORM, JavaCore.VERSION_1_5);
    ...
    public void testGenericAPIUsageFromA14Project7() throws CoreException, IOException {
        ...
        try {
            ...
            project15.setOption(JavaCore.COMPILER_COMPLIANCE, JavaCore.VERSION_1_5);
            project15.setOption(JavaCore.COMPILER_CODEGEN_TARGET_PLATFORM, JavaCore.VERSION_1_5);
            addLibrary(project15, "libList15.jar", "libList15src.zip", new String[] { "java/util/List.java", "package java.util;\n" + "public class List<T> {\n" + "}" }, JavaCore.VERSION_1_5);
            project14 = createJavaProject("Reconciler1415", new String[] { "src" }, new String[] { "JCL_LIB" }, "bin");
            project14.setOption(JavaCore.COMPILER_SOURCE, JavaCore.VERSION_1_4);
            project14.setOption(JavaCore.COMPILER_COMPLIANCE, JavaCore.VERSION_1_4);
            project14.setOption(JavaCore.COMPILER_CODEGEN_TARGET_PLATFORM, JavaCore.VERSION_1_4);
            addLibrary(project14, "libList14.jar", "libList14src.zip", new String[] { "java/util/List.java", "package java.util;\n" + "public class List {\n" + "}" }, JavaCore.VERSION_1_4);
            IClasspathEntry[] oldClasspath = project14.getRawClasspath();
            int oldLength = oldClasspath.length;
            IClasspathEntry[] newClasspath = new IClasspathEntry[oldLength + 1];
            System.arraycopy(oldClasspath, 0, newClasspath, 0, oldLength);
    ...
    public void testBug374176() throws CoreException, IOException, InterruptedException {
        ...
        try {
            ...
            String source = "package p1;\n" + "public class Y {\n" + "}\n;";
            createFile("/TestAnnot/src/p1/Y.java", source);
    ...
    public void testBug374176b() throws CoreException, IOException, InterruptedException {
        ...
        try {
            ...
            createFolder("/TestAnnot/src/p1");
            String source = "package p1;\n";
            createFile("/TestAnnot/src/p1/package-info.java", source);
            project15.setOption(JavaCore.COMPILER_SOURCE, JavaCore.VERSION_1_5);
            project15.setOption(JavaCore.COMPILER_COMPLIANCE, JavaCore.VERSION_1_5);
            project15.setOption(JavaCore.COMPILER_PB_NULL_REFERENCE, JavaCore.ERROR);
            project15.setOption(JavaCore.COMPILER_PB_POTENTIAL_NULL_REFERENCE, JavaCore.ERROR);
    ...
    public void testSecondaryTypeDeletion() throws CoreException, IOException {
        // Set working copy content with no error
        setUpWorkingCopy("/Reconciler/src/X.java", "interface I {\n" + "	void foo();\n" + "}\n" + "public class X {\n" + "	static void goo(I i) {\n" + "	}\n" + "}\n");
        assertProblems("Unexpected problems", "----------\n" + "----------\n");
 ...
 */
    public void testBug410207a() throws Exception {
        try {
            ...
            refresh(p);
            setUpWorkingCopy("/P/src/p/Main.java", "package p;\n" + "import lib.External;\n" + "public class Main {\n" + "   public void m() {\n" + "      External external = new External();\n" + "      external.setNonCompliant(null);\n" + "   };\n" + "}");
            this.problemRequestor.reset();
            this.workingCopy.reconcile(ICompilationUnit.NO_AST, /*force problem detection*/
            true, null, null);
            assertProblems("Unexpected problems", "----------\n" + "----------\n");
 ...
 */
    ...
    public void testBug485092() throws CoreException, IOException, InterruptedException {
        ...
        try {
            ...
            createFile("/Reconciler1518/src/p1/PreferenceableOption.java", source);
            project15.setOption(JavaCore.COMPILER_SOURCE, JavaCore.VERSION_1_5);
            project15.setOption(JavaCore.COMPILER_COMPLIANCE, JavaCore.VERSION_1_5);
            project15.setOption(JavaCore.COMPILER_CODEGEN_TARGET_PLATFORM, JavaCore.VERSION_1_5);
            ...
            createFile("/Reconciler18/src/p2/PivotEnvironmentFactory.java", otherSource);
