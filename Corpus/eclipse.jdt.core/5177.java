 ...
 */
    ...
    public void setUpSuite() throws Exception {
        super.setUpSuite();
        //$NON-NLS-1$
        final String compliance = "1.5";
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        this.testProject = createJavaProject("P", new String[] { "src" }, new String[] { getExternalJCLPathString(compliance) }, "bin", compliance);
        createFolder("/P/src/p");
        createFile("/P/src/p/X.java", // package now includes comment (see bug https://bugs.eclipse.org/bugs/show_bug.cgi?id=93880)
    ...
    private ICompilationUnit createWorkingCopy(String source) throws JavaModelException {
        this.workingCopy = getCompilationUnit("/P/src/p/Y.java").getWorkingCopy(new WorkingCopyOwner() {
        }, null);
 ...
 */
    public void testDefaultValue1() throws CoreException {
        try {
            ...
            assertMemberValuePairEquals("member=\"abc\"", method.getDefaultValue());
        } finally {
 ...
 */
    public void testDefaultValue2() throws CoreException {
        try {
            ...
            createFile("/P/src/p/Y.java", cuSource);
            IMethod method = getCompilationUnit("/P/src/p/Y.java").getType("Y").getMethod("member", new String[0]);
            assertMemberValuePairEquals("member=(int)1", method.getDefaultValue());
        } finally {
            deleteFile("/P/src/p/Y.java");
        }
    }
 ...
 */
    public void testDefaultValue3() throws CoreException {
        try {
            ...
            createFile("/P/src/p/Y.java", cuSource);
            IMethod method = getCompilationUnit("/P/src/p/Y.java").getType("Y").getMethod("member", new String[0]);
            assertMemberValuePairEquals("<null>", method.getDefaultValue());
        } finally {
            deleteFile("/P/src/p/Y.java");
        }
    }
 ...
 */
    public void testDefaultValue5() throws CoreException {
        try {
            ...
            createFile("/P/src/p/Y.java", cuSource);
            IMethod method = getCompilationUnit("/P/src/p/Y.java").getType("Y").getMethod("member", new String[0]);
            assertMemberValuePairEquals("member=<null>", method.getDefaultValue());
        } finally {
            deleteFile("/P/src/p/Y.java");
        }
    }
 ...
 */
    public void testDefaultValue8() throws CoreException {
        try {
            ...
            createFile("/P/src/p/Y.java", cuSource);
            IMethod method = getCompilationUnit("/P/src/p/Y.java").getType("Y").getMethod("member", new String[0]);
            assertMemberValuePairEquals("member=-1.0f", method.getDefaultValue());
        } finally {
            deleteFile("/P/src/p/Y.java");
        }
    }
 ...
 */
    public void testDefaultValue9() throws CoreException {
        try {
            ...
            createFile("/P/src/p/Y.java", cuSource);
            IMethod method = getCompilationUnit("/P/src/p/Y.java").getType("Y").getMethod("member", new String[0]);
            assertMemberValuePairEquals("member=(double)-1.0", method.getDefaultValue());
        } finally {
            deleteFile("/P/src/p/Y.java");
        }
    }
 ...
 */
    public void testDefaultValue10() throws CoreException {
        try {
            ...
            createFile("/P/src/p/Y.java", cuSource);
            IMethod method = getCompilationUnit("/P/src/p/Y.java").getType("Y").getMethod("member", new String[0]);
            assertMemberValuePairEquals("member=-1L", method.getDefaultValue());
        } finally {
            deleteFile("/P/src/p/Y.java");
        }
    }
 ...
 */
    public void testFindPrimaryType1() throws JavaModelException {
        ...
        assertElementEquals("Unexpected primary type", "X [in X.java [in p [in src [in P]]]]", unit.findPrimaryType());
    }
 ...
 */
    public void testGetCategories09() throws CoreException {
        createWorkingCopyComputingProblems("package p;\n" + "public class Y {\n" + "  /**\n" + "  */\n" + "  void foo() {}\n" + "}");
        String[] categories = this.workingCopy.getType("Y").getMethod("foo", new String[0]).getCategories();
        assertStringsEqual("Unexpected categories", "", categories);
    }
 ...
 */
    public void testGetContentsForNotPresentRemote() throws CoreException, URISyntaxException {
        ...
        try {
            ...
            assertExceptionEquals("Unexpected exception", "<null>", actual);
        } finally {
 ...
 */
    public void testGetElementAt() throws JavaModelException {
        ...
        IJavaElement element = this.cu.getElementAt(sourceRange.getOffset() + type.getElementName().length() + 1);
        assertTrue("Should have found a type", element instanceof IType);
        assertEquals("Should have found X", "X", element.getElementName());
 ...
 */
    public void testGetElementAt2() throws JavaModelException {
        ...
        assertEquals("Import not found", "p2.*", element.getElementName());
    }
 ...
 */
    public void testGetElementAt3() throws JavaModelException {
        ...
        assertEquals("Unexpected field found", this.cu.getType("X").getField("f5"), element);
    }
 ...
 */
    public void testGetElementAt4() throws JavaModelException {
        ...
        IJavaElement element = this.cu.getElementAt(fieldPos);
        assertEquals("Unexpected field found", this.cu.getType("X").getField("f6"), element);
    }
 ...
 */
    public void testGetElementAt5() throws JavaModelException {
        ...
        IJavaElement element = this.cu.getElementAt(fieldPos);
        assertEquals("Unexpected field found", this.cu.getType("X").getField("f7"), element);
    }
 ...
 */
    public void testGetElementAt7() throws JavaModelException {
        ...
        IJavaElement element = this.cu.getElementAt(fieldPos);
        assertEquals("Unexpected type found", this.cu.getType("Annot"), element);
    }
 ...
 */
    public void testGetImports() throws JavaModelException {
        ...
        assertEquals("Offset container range not correct", imprts[0].getSourceRange().getOffset(), containerRange.getOffset());
        assertEquals("Length container range not correct", imprts[imprts.length - 1].getSourceRange().getOffset() + imprts[imprts.length - 1].getSourceRange().getLength(), containerRange.getOffset() + containerRange.getLength());
        assertSourceEquals("Source not correct", "import p2.*;\n" + "import p3.Z;", container.getSource());
    }
 ...
 */
    public void testGetTypes() throws JavaModelException {
        ...
        String[][] superInterfaceNames = new String[][] { new String[] { "Runnable" }, new String[0], new String[0], new String[0], new String[] { "I2<E>" }, new String[0], new String[0] };
        String[][] superInterfaceTypes = new String[][] { new String[] { "QRunnable;" }, new String[0], new String[0], new String[0], new String[] { "QI2<QE;>;" }, new String[0], new String[0] };
        String[][] formalTypeParameters = new String[][] { new String[0], new String[0], new String[] { "E" }, new String[0], new String[] { "E" }, new String[0], new String[0] };
 ...
 */
    public void testStructureUnknownForCU() throws CoreException {
        try {
            this.createFile("/P/src/p/Invalid.java", "@#D(03");
 ...
 */
    public void testBug78275() throws CoreException {
        try {
            String cuSource = "public class X {\n" + "	void a() {\n" + "	     }\n" + "	}\n" + "	void m() {}\n" + "}\n";
    ...
    public void testApplyEdit() throws CoreException {
        try {
            ...
            String newSource = "private class X {\n" + "}\n";
    ...
    public void testApplyEdit2() throws CoreException {
        try {
            ...
            UndoEdit undoEdit = compilationUnit.applyTextEdit(edit, null);
            String newSource = "import java.util.ArrayList;\n" + "import java.util.Vector;\n" + "\n" + "public class X {\n" + "}\n";
            assertEquals(newSource, compilationUnit.getSource());
            compilationUnit.applyTextEdit(undoEdit, null);
            assertEquals(source, compilationUnit.getSource());
        } finally {
 ...
 */
    ...
    public void testBug246594a() throws CoreException {
        ...
        //<T:TE;>
        IMethod[] methods = this.workingCopy.getType("Collection").getMethods();
