 ...
 */
    ...
    public void setUpSuite() throws Exception {
        ...
        this.createFile("/BinaryProject/src/X.java", "public class X {\n" + "  int bar;\n" + "  public void foo() {\n" + "  }\n" + "}");
        project.getProject().build(IncrementalProjectBuilder.FULL_BUILD, null);
        waitForAutoBuild();
        project.setRawClasspath(new IClasspathEntry[] { JavaCore.newLibraryEntry(new Path("/BinaryProject/lib"), null, null) }, null);
    }
 ...
 */
    public void testRenameCompilationUnitAndType() {
        renameNegative(new IJavaElement[] { this.cu, this.cu.getType("X") }, new String[] { "Y.java", "Y" }, false, IJavaModelStatusConstants.INVALID_ELEMENT_TYPES);
    }
 ...
 */
    public void testRenameCompilationUnitResultingInCollision() throws CoreException {
        this.createFile("/P/src/Y.java", "public class Y {\n" + "}");
 ...
 */
    public void testRenameCompilationUnitsCheckingDeltas() throws CoreException {
        ...
        clearDeltas();
        renamePositive(new ICompilationUnit[] { this.cu, cu2 }, new String[] { "NewX.java", "NewY.java" }, false);
 ...
 */
    public void testRenameMainTypes() throws CoreException {
        ...
        IJavaElement[] types = new IJavaElement[] { this.cu.getType("X"), cu2.getType("Y") };
        String[] newNames = new String[] { "NewX", "NewY" };
        renamePositive(new IJavaElement[] { this.cu.getType("X"), cu2.getType("Y") }, new IJavaElement[] { types[0].getParent(), types[1].getParent() }, newNames, false);
 ...
 */
    public void testRenameMainTypesAndAChild() throws CoreException {
        ...
        IJavaElement[] elements = new IJavaElement[] { this.cu.getType("X").getField("bar"), this.cu.getType("X"), cu2.getType("Y") };
 ...
 */
    ...
    public void testRenamePF() throws CoreException {
        this.createFolder("/P/src/x/y/z");
        this.createFile("/P/src/x/y/z/A.java", "package x.y.z;\n" + "public class A {\n" + "}");
        ...
        assertEquals("Unexpected A.java's main type'", "x.y.newZ.A", mainType.getFullyQualifiedName());
 ...
 */
    public void testRenamePF2() throws CoreException {
        ...
        assertTrue(types != null && types.length == 1);
        IType mainType = types[0];
        assertEquals("Unexpected A.java's main type'", "x.y.z2.A", mainType.getFullyQualifiedName());
    ...
    public void testRenamePF3() throws CoreException {
        ...
        IWorkspaceRunnable runnable = new IWorkspaceRunnable() {
            ...
            public void run(IProgressMonitor monitor) throws CoreException {
                ...
                assertTypesEqual("Unepected type", "x.y.A\n", new IType[] { type });
            }
        };
 ...
 */
    public void testRenameWithInvalidRenamings() {
        ...
        renameNegative(new IJavaElement[] { method }, new String[] { "", "" }, false, IJavaModelStatusConstants.INDEX_OUT_OF_BOUNDS);
        renameNegative(new IJavaElement[] { method }, null, false, IJavaModelStatusConstants.NULL_NAME);
    }
