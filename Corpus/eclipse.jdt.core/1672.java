 ...
 */
    public void test1FVVWS8_1() {
        ...
        "class X {									\n" + "	void foo() {							\n" + "		for (int i = 10; i > 0; --i)		\n" + "			fred(							\n" + "	}										\n" + "}											\n", // completeBehind:
        "fred(", // expectedCompletionNodeToString:
        "<CompleteOnMessageSend:fred()>", // expectedUnitDisplayString:
 ...
 */
    public void test1FW35YZ_1() {
        ...
        "class Bar {								\n" + "	void foo() {							\n" + "		bar(primary().fred(					\n" + "	}										\n" + "}											\n", // completeBehind:
        "fred(", // expectedCompletionNodeToString:
        "<CompleteOnMessageSend:primary().fred()>", // expectedUnitDisplayString:
 ...
 */
    public void test1FW35YZ_2() {
        ...
        "<CompleteOnQualifiedAllocationExpression:primary().new X()>", // expectedUnitDisplayString:
 ...
 */
    public void test1FWYBKF() {
        ...
        "<CompleteOnMessageSend:this.x.bar()>", // expectedUnitDisplayString:
 ...
 */
    public void test1GAJBUQ() {
        this.runTestCheckMethodParse(// compilationUnit:
        "class Bar {								\n" + "	void foo() {							\n" + "		x.y.Z.fred(buzz());					\n" + "	}										\n" + "}											\n", // completeBehind:
        "fred(buzz()", // expectedCompletionNodeToString:
        "<CompleteOnMessageSend:x.y.Z.fred(buzz())>", // expectedUnitDisplayString:
 ...
 */
    public void testAfterEmptyAnonymous() {
        ...
        "fred(new Runnable() {}, ", // expectedCompletionNodeToString:
        "<CompleteOnMessageSend:this.fred(new Runnable() {\n})>", // expectedUnitDisplayString:
        "class Bar {\n" + "  Bar() {\n" + "  }\n" + "  void foo() {\n" + "    <CompleteOnMessageSend:this.fred(new Runnable() {\n" + "})>;\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "", // expectedReplacedSource:
        "fred(new Runnable() {}, ", // test name
 ...
 */
    public void testAfterFirstParameter() {
        this.runTestCheckMethodParse(// compilationUnit:
        "class Bar {								\n" + "	void foo() {							\n" + "		this.fred(\"abc\" , 2, i);		\n" + "	}										\n" + "}											\n", // completeBehind:
        "fred(\"abc\" ", // expectedCompletionNodeToString:
        "<CompleteOnMessageSend:this.fred(\"abc\")>", // expectedUnitDisplayString:
 ...
 */
    public void testBeforeFirstParameter() {
        ...
        "class Bar {								\n" + "	void foo() {							\n" + "		this.fred(1, 2, i);					\n" + "	}										\n" + "}											\n", // completeBehind:
        "fred(", // expectedCompletionNodeToString:
        "<CompleteOnMessageSend:this.fred()>", // expectedUnitDisplayString:
 ...
 */
    public void testBeforeLastParameter() {
        ...
        "<CompleteOnMessageSend:this.fred(1, 2)>", // expectedUnitDisplayString:
 ...
 */
    public void testBeforeSecondParameter() {
        this.runTestCheckMethodParse(// compilationUnit:
        "class Bar {								\n" + "	void foo() {							\n" + "		this.fred(1, 2, i);					\n" + "	}										\n" + "}											\n", // completeBehind:
        "fred(1, ", // expectedCompletionNodeToString:
        "<CompleteOnMessageSend:this.fred(1)>", // expectedUnitDisplayString:
 ...
 */
    public void testInFirstParameter() {
        ...
        "fred(\"abc\" + bi", // expectedCompletionNodeToString:
        "<CompleteOnName:bi>", // expectedUnitDisplayString:
        "class Bar {\n" + "  Bar() {\n" + "  }\n" + "  void foo() {\n" + "    (\"abc\" + <CompleteOnName:bi>);\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "bi", // expectedReplacedSource:
        "bizz", // test name
 ...
 */
    public void testInIfStatement() {
        ...
        "class X {									\n" + "	void foo() {							\n" + "		if (true) {							\n" + "			bar.fred();						\n" + "		}									\n" + "	}										\n" + "}											\n", // completeBehind:
        "fred(", // expectedCompletionNodeToString:
        "<CompleteOnMessageSend:bar.fred()>", // expectedUnitDisplayString:
 ...
 */
    public void testLabeledWithExpressionReceiver() {
        ...
        "fred(1, 2,", // expectedCompletionNodeToString:
        "<CompleteOnMessageSend:bar().fred(1, 2)>", // expectedUnitDisplayString:
        "class X {\n" + "  X() {\n" + "  }\n" + "  void foo() {\n" + "    <CompleteOnMessageSend:bar().fred(1, 2)>;\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "", // expectedReplacedSource:
        "fred(1, 2,", // expectedLabels:
        new String[] { "label1" }, // test name
        "<completion in labeled method invocation with expression receiver>");
    }
 ...
 */
    public void testLabeledWithoutReceiver() {
        ...
        "class Bar {								\n" + "	void foo() {							\n" + "		label1: fred(1, 2, o);				\n" + "	}										\n" + "}											\n", // completeBehind:
        "fred(1, 2,", // expectedCompletionNodeToString:
        "<CompleteOnMessageSend:fred(1, 2)>", // expectedUnitDisplayString:
 ...
 */
    public void testSuper() {
        ...
        "class Bar {								\n" + "	void foo() {							\n" + "		super.fred(1, 2, i);				\n" + "	}										\n" + "}											\n", // completeBehind:
        "fred(", // expectedCompletionNodeToString:
        "<CompleteOnMessageSend:super.fred()>", // expectedUnitDisplayString:
 ...
 */
    public void testWithNameReceiver() {
        this.runTestCheckMethodParse(// compilationUnit:
        "class Bar {								\n" + "	void foo() {							\n" + "		Vector v = new Vector();			\n" + "		v.addElement(\"1\");				\n" + "	}										\n" + "}											\n", // completeBehind:
        "addElement(", // expectedCompletionNodeToString:
        "<CompleteOnMessageSend:v.addElement()>", // expectedUnitDisplayString:
        "class Bar {\n" + "  Bar() {\n" + "  }\n" + "  void foo() {\n" + "    Vector v;\n" + "    <CompleteOnMessageSend:v.addElement()>;\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "", // expectedReplacedSource:
        "addElement(", // test name
 ...
 */
    public void testWithNameReceiverAndTwoArgs() {
        ...
        "<CompleteOnMessageSend:x.fred(1, 2)>", // expectedUnitDisplayString:
 ...
 */
    public void testWithQualifiedNameReceiver() {
        ...
        "class Bar {								\n" + "	void foo() {							\n" + "		X x = new X();						\n" + "		y.x.fred(1, 2, o);					\n" + "	}										\n" + "}											\n", // completeBehind:
        "x.fred(1, 2,", // expectedCompletionNodeToString:
        "<CompleteOnMessageSend:y.x.fred(1, 2)>", // expectedUnitDisplayString:
