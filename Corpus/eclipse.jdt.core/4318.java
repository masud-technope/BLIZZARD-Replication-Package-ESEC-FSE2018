...
public class ConstantPool implements ClassFileConstants, TypeIds {
    ...
    public static final char[] JAVA_LANG_INVOKE_LAMBDAMETAFACTORY_ALTMETAFACTORY_SIGNATURE = //$NON-NLS-1$
    "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;[Ljava/lang/Object;)Ljava/lang/invoke/CallSite;".toCharArray();
            ...
            if ((stringIndex = this.UTF8Cache.putIfAbsent(stringCharArray, this.currentIndex)) < 0) {
                ...
                for (int i = 0; i < stringCharArray.length; i++) {
                    ...
                    if ((current >= 0x0001) && (current <= 0x007F)) {
                        ...
                        this.poolContent[this.currentOffset++] = (byte) (// 0xE0 = 1110 0000
                        0xE0 | // 0xE0 = 1110 0000
                        ((current >> 12) & 0x0F));
                        this.poolContent[this.currentOffset++] = (byte) (// 0x80 = 1000 0000
                        0x80 | // 0x80 = 1000 0000
                        ((current >> 6) & 0x3F));
                        this.poolContent[this.currentOffset++] = (// 0x80 = 1000 0000
                        byte) // 0x80 = 1000 0000
                        (0x80 | (current & 0x3F));
                    } else {
                        if (this.currentOffset + 2 >= this.poolContent.length) {
                        ...
                        // In that case we only need 2 bytes
                        length += 2;
                        this.poolContent[this.currentOffset++] = (byte) (// 0xC0 = 1100 0000
                        0xC0 | // 0xC0 = 1100 0000
                        ((current >> 6) & 0x1F));
                        this.poolContent[this.currentOffset++] = (// 0x80 = 1000 0000
                        byte) // 0x80 = 1000 0000
