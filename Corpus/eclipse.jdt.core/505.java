...
public class MessagerCodeExample {
    ...
    public static final String CODE1 = HEADER_CHUNK + INFO_CHUNK + WARNING_CHUNK + ERROR_CHUNK + "}";

    /** Code example with INFO and WARNING severities */
    public static final String CODE2 = HEADER_CHUNK + INFO_CHUNK + WARNING_CHUNK + "}";

    /** Code example with INFO severity only */
    public static final String CODE3 = HEADER_CHUNK + INFO_CHUNK + "}";

    /** Code example with INFO severity only */
    public static final String CODE4 = HEADER_CHUNK + OK_CHUNK + "}";
}
