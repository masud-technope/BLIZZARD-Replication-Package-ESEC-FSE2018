...
public class ASTConverterBugsTest extends ConverterTestSetup {
    ...
    public ASTNode runConversion(ICompilationUnit unit, boolean resolveBindings, boolean statementsRecovery, boolean bindingsRecovery) {
 ...
 */
    public void testBug212100a() throws JavaModelException {
        ...
        final String key = "Ljava/lang/Object;";
        //	final String key = "LX;"; // this would make the test pass
        resolveASTs(this.workingCopies, new String[] { key }, new ASTRequestor() {
    ...
    public void testBug212100b() throws JavaModelException {
        ...
        String contentsZ = "public class Z {\n" + "	public class W {\n" + "      void bar() {}\n" + "   }\n" + "}";
        ...
        resolveASTs(this.workingCopies, new String[] { keyX, keyZ }, new ASTRequestor() {

            public void acceptBinding(String bindingKey, IBinding binding) {
                IBinding[] bindings = createBindings(new String[] { keyX, keyXY, keyZ, keyZW });
 ...
 */
    public void testBug212834() throws CoreException, IOException {
        ...
        CompilationUnit unit = (CompilationUnit) runConversion(this.workingCopies[1], true, /*bindings*/
        false, /*no statement recovery*/
        true);
        ...
        assertBindingsEqual(methodInvocation + " has invalid parameter annotations!", "@LBaz;", methodBinding.getParameterAnnotations(0));
    }
 ...
 */
    public void testBug212857() throws CoreException, IOException {
        ...
        CompilationUnit unit = (CompilationUnit) runConversion(this.workingCopies[0], true, /*bindings*/
        false, /*no statement recovery*/
        true);
        MethodDeclaration methodDeclaration = (MethodDeclaration) getASTNode(unit, 0, 0);
 ...
 */
    public void testBug213509() throws CoreException, IOException {
        ...
        true);
        MethodDeclaration methodDeclaration = (MethodDeclaration) getASTNode(unit, 0, 0);
        checkParameterAnnotations(methodDeclaration + " has invalid parameter annotations!", "----- param 1-----\n" + "@LTest~Foo;\n" + "@LTest~Bar;\n" + "@LTest~Annot;\n" + "----- param 2-----\n" + "@LTest~Bar;\n" + "@LTest~Foo;\n" + "----- param 3-----\n" + "@LTest~Annot;\n", methodDeclaration.resolveBinding());
    }
    ...
    public void testBug213509_invocation() throws CoreException, IOException {
        ...
        checkParameterAnnotations(methodInvocation + " has invalid parameter annotations!", "----- param 1-----\n" + "@LTest~Foo;\n" + "@LTest~Bar;\n" + "@LTest~Annot;\n" + "----- param 2-----\n" + "@LTest~Bar;\n" + "@LTest~Foo;\n" + "----- param 3-----\n" + "@LTest~Annot;\n", methodInvocation.resolveMethodBinding());
    }
 ...
 */
    public void testBug218824a() throws JavaModelException {
        ASTResult result = this.buildMarkedAST("/Converter15/src/a/X.java", "package a;\n" + "public class X {\n" + "        public void takeParam(int i) {\n" + "                // do something\n" + "        }\n" + "\n" + "        void test() {\n" + "                char c = 'a';\n" + "                   public void takeParam(int i) {\n" + "                             // do something\n" + "                           }\n" + "\n" + "                           void test() {\n" + "                             char c = 'a';\n" + "                            takeParam((int) c);\n" + "                           }[*1*]takeParam([*1*](int) c);\n" + "        }\n" + "}\n");
 ...
 */
    public void testBug223838() throws JavaModelException {
        String contents = "package b223838;\n" + "@Deprecated\n" + "@Invalid\n" + "public class Test {\n" + "}\n";
        ICompilationUnit workingCopy = getWorkingCopy("/Converter15/src/b223838/Test.java", contents, /*resolve*/
        true);
