...
public class SingleNameReference extends NameReference implements OperatorIds {
    ...
    public FlowInfo analyseAssignment(BlockScope currentScope, FlowContext flowContext, FlowInfo flowInfo, Assignment assignment, boolean isCompound) {
        ...
        if (// check the variable part is initialized if blank final
        isCompound) {
            switch(this.bits & ASTNode.RestrictiveFlagMASK) {
                ...
                Binding.FIELD:
                    ...
                    manageSyntheticAccessIfNecessary(currentScope, /*read-access*/
                    flowInfo, true);
                    break;
        ...
        switch(this.bits & ASTNode.RestrictiveFlagMASK) {
            ...
            Binding.FIELD:
                manageSyntheticAccessIfNecessary(currentScope, flowInfo, /*write-access*/
                false);
                ...
                } else if (!isCompound && (fieldBinding.isNonNull() || fieldBinding.type.isTypeVariable()) && // inherited fields are not tracked here
            ...
            Binding.LOCAL:
                ...
                if (// for local variable debug attributes
    ...
    public TypeBinding checkFieldAccess(BlockScope scope) {
        ...
        if (fieldBinding.isStatic()) {
            ...
            if (methodScope.isStatic) {
                ...
                scope.tagAsAccessingEnclosingInstanceStateOf(fieldBinding.declaringClass, /* type variable access */
                false);
            }
        }
        if (isFieldUseDeprecated(fieldBinding, scope, this.bits))
            scope.problemReporter().deprecatedField(fieldBinding, this);
        if ((this.bits & ASTNode.IsStrictlyAssigned) == 0 && TypeBinding.equalsEquals(methodScope.enclosingSourceType(), fieldBinding.original().declaringClass) && methodScope.lastVisibleFieldID >= 0 && fieldBinding.id >= methodScope.lastVisibleFieldID && (!fieldBinding.isStatic() || methodScope.isStatic)) {
 ...
 */
    public void computeConversion(Scope scope, TypeBinding runtimeTimeType, TypeBinding compileTimeType) {
        ...
        if (this.binding != null && this.binding.isValidBinding()) {
            ...
            if (originalType != null && originalType.leafComponentType().isTypeVariable()) {
                TypeBinding targetType = (!compileTimeType.isBaseType() && runtimeTimeType.isBaseType()) ? // unboxing: checkcast before conversion
    ...
    public void generateAssignment(BlockScope currentScope, CodeStream codeStream, Assignment assignment, boolean valueRequired) {
        ...
        if (assignment.expression.isCompactableOperation()) {
            ...
            if ((operation.right instanceof SingleNameReference) && // only commutative operations
            ((operator == OperatorIds.PLUS) || (operator == OperatorIds.MULTIPLY)) && ((variableReference = (SingleNameReference) operation.right).binding == this.binding) && // exclude non constant expressions, since could have side-effect
            (operation.left.constant != Constant.NotAConstant) && // exclude string concatenation which would occur backwards
        ...
        switch(this.bits & ASTNode.RestrictiveFlagMASK) {
            ...
            Binding.FIELD:
                ...
                !codegenBinding.isStatic()) {
                    if ((this.bits & ASTNode.DepthMASK) != 0) {
                        ...
                        Object[] emulationPath = currentScope.getEmulationPath(/*only exact match*/
                        targetType, true, /*consider enclosing arg*/
                        false);
                ...
                fieldStore(currentScope, codeStream, codegenBinding, this.syntheticAccessors == null ? null : this.syntheticAccessors[SingleNameReference.WRITE], this.actualReceiverType, /*implicit this*/
                true, valueRequired);
                if (valueRequired) {
                    codeStream.generateImplicitConversion(assignment.implicitConversion);
                }
            ...
            Binding.LOCAL:
                ...
                if (localBinding.type.isArrayType() && (// arrayLoc = (type[])null
                ...
                if (// for local variable debug attributes
                (this.bits & ASTNode.FirstAssignmentToLocal) != 0) {
            ...
            switch(this.bits & ASTNode.RestrictiveFlagMASK) {
                ...
                Binding.FIELD:
                    ...
                    if (codegenField.isStatic()) {
                        if (!valueRequired && // if no valueRequired, still need possible side-effects of <clinit> invocation, if field belongs to different class
                        TypeBinding.equalsEquals(((FieldBinding) this.binding).original().declaringClass, this.actualReceiverType.erasure()) && ((this.implicitConversion & TypeIds.UNBOXING) == 0) && this.genericCast == null) {
                        ...
                        if ((this.syntheticAccessors == null) || (this.syntheticAccessors[SingleNameReference.READ] == null)) {
                            TypeBinding constantPoolDeclaringClass = CodeStream.getConstantPoolDeclaringClass(currentScope, codegenField, this.actualReceiverType, /* implicit this */
                            true);
                            codeStream.fieldAccess(Opcodes.OPC_getstatic, codegenField, constantPoolDeclaringClass);
                        } else {
                            codeStream.invoke(Opcodes.OPC_invokestatic, this.syntheticAccessors[SingleNameReference.READ], /* default declaringClass */
                            null);
                        }
                    } else {
 ...
 */
    public void generateCompoundAssignment(BlockScope currentScope, CodeStream codeStream, Expression expression, int operator, int assignmentImplicitConversion, boolean valueRequired) {
        ...
        this.generateCompoundAssignment(currentScope, codeStream, this.syntheticAccessors == null ? null : this.syntheticAccessors[SingleNameReference.WRITE], expression, operator, assignmentImplicitConversion, valueRequired);
    }
    ...
    public void generateCompoundAssignment(BlockScope currentScope, CodeStream codeStream, MethodBinding writeAccessor, Expression expression, int operator, int assignmentImplicitConversion, boolean valueRequired) {
        switch(this.bits & ASTNode.RestrictiveFlagMASK) {
            ...
            Binding.FIELD:
                ...
                break;
            case // assigning to a local variable (cannot assign to outer local)
            Binding.LOCAL:
                LocalVariableBinding localBinding = (LocalVariableBinding) this.binding;
                ...
                switch(localBinding.type.id) {
                    ...
                    case T_int:
                        ...
                        if ((assignConstant != Constant.NotAConstant) && (// only for integral types
                        assignConstant.typeID() != TypeIds.T_float) && // TODO (philippe) is this test needed ?
                        (assignConstant.typeID() != TypeIds.T_double)) {
                            switch(operator) {
                                case PLUS:
                                    int increment = assignConstant.intValue();
                                    // not representable as a 16-bits value
        ...
        switch(this.bits & ASTNode.RestrictiveFlagMASK) {
            ...
            Binding.FIELD:
                FieldBinding codegenField = ((FieldBinding) this.binding).original();
                fieldStore(currentScope, codeStream, codegenField, writeAccessor, this.actualReceiverType, /* implicit this*/
                true, valueRequired);
                // no need for generic cast as value got dupped
                return;
            case // assigning to a local variable
    ...
    public void generatePostIncrement(BlockScope currentScope, CodeStream codeStream, CompoundAssignment postIncrement, boolean valueRequired) {
        switch(this.bits & ASTNode.RestrictiveFlagMASK) {
            ...
            Binding.FIELD:
                ...
                fieldStore(currentScope, codeStream, codegenField, this.syntheticAccessors == null ? null : this.syntheticAccessors[SingleNameReference.WRITE], this.actualReceiverType, /*implicit this*/
                true, false);
 ...
 */
    ...
    public VariableBinding nullAnnotatedVariableBinding(boolean supportTypeAnnotations) {
        switch(this.bits & ASTNode.RestrictiveFlagMASK) {
            ...
            case // reading a local variable
            Binding.LOCAL:
                if (supportTypeAnnotations || (((VariableBinding) this.binding).tagBits & TagBits.AnnotationNullMASK) != 0)
    ...
    public void manageSyntheticAccessIfNecessary(BlockScope currentScope, FlowInfo flowInfo, boolean isReadAccess) {
        ...
        if ((this.bits & Binding.FIELD) != 0) {
            FieldBinding fieldBinding = (FieldBinding) this.binding;
            FieldBinding codegenField = fieldBinding.original();
            if (((this.bits & ASTNode.DepthMASK) != 0) && (// private access
            codegenField.isPrivate() || (// implicit protected access
            codegenField.isProtected() && codegenField.declaringClass.getPackage() != currentScope.enclosingSourceType().getPackage()))) {
                if (this.syntheticAccessors == null)
                    this.syntheticAccessors = new MethodBinding[2];
                this.syntheticAccessors[isReadAccess ? SingleNameReference.READ : SingleNameReference.WRITE] = ((SourceTypeBinding) currentScope.enclosingSourceType().enclosingTypeAt((this.bits & ASTNode.DepthMASK) >> ASTNode.DepthSHIFT)).addSyntheticMethod(codegenField, isReadAccess, /*not super access*/
                false);
 ...
 */
    ...
    public TypeBinding resolveType(BlockScope scope) {
        if (this.actualReceiverType != null) {
            ...
            this.binding = scope.getBinding(this.token, this.bits & ASTNode.RestrictiveFlagMASK, this, /*resolve*/
            true);
        }
        if (this.binding.isValidBinding()) {
            switch(this.bits & ASTNode.RestrictiveFlagMASK) {
                ...
                Binding.VARIABLE | Binding.TYPE:
                    if (this.binding instanceof VariableBinding) {
                        ...
                        if (this.binding instanceof LocalVariableBinding) {
                            this.bits &= ~// clear bits
                            ASTNode.RestrictiveFlagMASK;
                        ...
                        if (variableType != null) {
                            this.resolvedType = variableType = (((this.bits & ASTNode.IsStrictlyAssigned) == 0) ? variableType.capture(scope, this.sourceStart, this.sourceEnd) : variableType);
                ...
                Binding.TYPE:
                    ...
                    type = scope.environment().convertToRawType(/*do not force conversion of enclosing types*/
                    type, false);
