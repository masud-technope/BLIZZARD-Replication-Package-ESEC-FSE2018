...
public class JavadocContents {
    ...
    public String getTypeDoc() throws JavaModelException {
        ...
        if (this.typeDocRange != null) {
            if (this.typeDocRange == UNKNOWN_FORMAT)
                throw new JavaModelException(new JavaModelStatus(IJavaModelStatusConstants.UNKNOWN_JAVADOC_FORMAT, this.type));
    ...
    private String computeMethodAnchorPrefixEnd(BinaryMethod method) throws JavaModelException {
        ...
        if (genericSignature != null) {
            ...
            if (anchor == null)
                throw new JavaModelException(new JavaModelStatus(IJavaModelStatusConstants.UNKNOWN_JAVADOC_FORMAT, method));
        } else {
