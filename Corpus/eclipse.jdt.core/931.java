...
public class CatchClause extends ASTNode {
	 ...
	 * @since 3.0
	 */
    public static final ChildPropertyDescriptor EXCEPTION_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(CatchClause.class, "exception", SingleVariableDeclaration.class, MANDATORY, CYCLE_RISK);
    ...
    new ChildPropertyDescriptor(CatchClause.class, "body", Block.class, MANDATORY, CYCLE_RISK);
