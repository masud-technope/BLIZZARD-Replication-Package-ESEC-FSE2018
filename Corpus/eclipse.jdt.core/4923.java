...
public interface TagBits {
    ...
    // method/parameterized type binding
    long ContainsNestedTypeReferences = ASTNode.Bit12;
    ...
    // type
    long PauseHierarchyCheck = ASTNode.Bit20;

    // method/constructor
    long HasParameterAnnotations = ASTNode.Bit11;
    ...
    // TVB, STB
    long HasAnnotatedVariants = ASTNode.Bit24;
    ...
    long HasTypeVariable = ASTNode.Bit30;

    // set for parameterized types directly referencing wildcards
    long HasDirectWildcard = ASTNode.Bit31;
    ...
    long AnnotationTarget = ASTNode.Bit36L;
    ...
    long SE7AnnotationTargetMASK = AnnotationForType | AnnotationForField | AnnotationForMethod | AnnotationForParameter | AnnotationForConstructor | AnnotationForLocalVariable | AnnotationForAnnotationType | AnnotationForPackage;

    long AnnotationTargetMASK = SE7AnnotationTargetMASK | AnnotationTarget | AnnotationForTypeUse | AnnotationForTypeParameter;
    ...
    // Only for annotation types and since these cannot have constructors, we can overload HasNonPrivateConstructor.
    long AnnotationRepeatable = ASTNode.Bit61L;

    long AllStandardAnnotationsMask = AnnotationTargetMASK | AnnotationRetentionMASK | AnnotationDeprecated | AnnotationDocumented | AnnotationInherited | AnnotationOverride | AnnotationSuppressWarnings | AnnotationSafeVarargs | AnnotationPolymorphicSignature | AnnotationNullable | AnnotationNonNull | AnnotationNonNullByDefault | AnnotationNullUnspecifiedByDefault | AnnotationRepeatable;
