...
public class FieldReference extends Reference implements InvocationSite {
    ...
    public FlowInfo analyseAssignment(BlockScope currentScope, FlowContext flowContext, FlowInfo flowInfo, Assignment assignment, boolean isCompound) {
        ...
        if (this.binding.isFinal()) {
            ...
            ((this.receiver.bits & ASTNode.ParenthesizedMASK) == 0) && currentScope.allowBlankFinalFieldAssignment(this.binding)) {
            ...
            TypeBinding.equalsEquals(this.receiver.resolvedType, this.binding.declaringClass) && // (this).x is forbidden
            ((this.receiver.bits & ASTNode.ParenthesizedMASK) == 0)) {
                flowInfo.markAsDefinitelyAssigned(this.binding);
            }
        }
        return flowInfo;
 ...
 */
    public void generateCode(BlockScope currentScope, CodeStream codeStream, boolean valueRequired) {
        ...
        if (valueRequired || (!isThisReceiver && currentScope.compilerOptions().complianceLevel >= ClassFileConstants.JDK1_4) || ((this.implicitConversion & TypeIds.UNBOXING) != 0) || (this.genericCast != null)) {
            ...
            if (// array length
            codegenBinding.declaringClass == null) {
                ...
                if (this.syntheticAccessors == null || this.syntheticAccessors[FieldReference.READ] == null) {
                    ...
                    codeStream.invoke(Opcodes.OPC_invokestatic, this.syntheticAccessors[FieldReference.READ], /* default declaringClass */
                    null);
                }
        ...
        if (this.receiver.isThis() && !(this.receiver instanceof QualifiedThisReference)) {
            ...
            if (reference instanceof FieldReference) {
                ...
                if (((QualifiedNameReference) reference).binding instanceof LocalVariableBinding)
                    // initial variable mismatch: local (from f1.f2) vs. field (from this.f1.f2)
                    return false;
    ...
    public void manageSyntheticAccessIfNecessary(BlockScope currentScope, FlowInfo flowInfo, boolean isReadAccess) {
        ...
        if (this.binding.isPrivate()) {
            if ((TypeBinding.notEquals(currentScope.enclosingSourceType(), codegenBinding.declaringClass)) && this.binding.constant(currentScope) == Constant.NotAConstant) {
                ...
                this.syntheticAccessors[isReadAccess ? FieldReference.READ : FieldReference.WRITE] = ((SourceTypeBinding) codegenBinding.declaringClass).addSyntheticMethod(codegenBinding, isReadAccess, /* not super ref in remote type*/
                false);
