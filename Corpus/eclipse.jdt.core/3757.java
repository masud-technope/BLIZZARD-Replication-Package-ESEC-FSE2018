...
public final class ExtraFlags {
    ...
    public static final int HasNonPrivateStaticMemberTypes = 0x0001;

    public static final int IsMemberType = 0x0002;

    public static final int IsLocalType = 0x0004;

    //internal flags
    public static final int ParameterTypesStoredAsSignature = 0x0010;
