 ...
 */
    ...
    public  TypeDeclarationPattern(char[] pkg, char[][] enclosingTypeNames, char[] simpleName, char typeSuffix, int matchRule) {
        ...
        if (this.isCaseSensitive || enclosingTypeNames == null) {
            ...
            for (int i = 0; i < length; i++) this.enclosingTypeNames[i] = CharOperation.toLowerCase(enclosingTypeNames[i]);
        }
 ...
 */
        ...
        switch(getMatchMode()) {
            ...
            case R_EXACT_MATCH:
                ...
                if (this.simpleName != null) {
                    ...
                    key = this.pkg == null ? CharOperation.append(this.simpleName, SEPARATOR) : CharOperation.concat(this.simpleName, SEPARATOR, this.pkg, SEPARATOR, CharOperation.NO_CHAR);
    ...
    protected StringBuffer print(StringBuffer output) {
        switch(this.typeSuffix) {
            ...
            case INTERFACE_AND_ANNOTATION_SUFFIX:
                //$NON-NLS-1$
                output.append("InterfaceAndAnnotationDeclarationPattern: pkg<");
                break;
            case ENUM_SUFFIX:
                //$NON-NLS-1$
