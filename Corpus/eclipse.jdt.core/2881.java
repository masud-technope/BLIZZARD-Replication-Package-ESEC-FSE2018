...
public class DefaultCodeFormatterOptions {
    ...
    public static class Alignment {
        ...
        public static final int M_ONE_PER_LINE_SPLIT = 32 + 16;
        ...
        public static final int M_NEXT_PER_LINE_SPLIT = 64 + 16;
    ...
    public Map<String, String> getMap() {
        ...
        options.put(DefaultCodeFormatterConstants.FORMATTER_INDENTATION_SIZE, Integer.toString(this.tab_char == MIXED ? this.indentation_size : this.tab_size));
        ...
        // reverse values swapping performed by IndentationTabPage
        options.put(DefaultCodeFormatterConstants.FORMATTER_TAB_SIZE, Integer.toString(this.tab_char == SPACE ? this.indentation_size : this.tab_size));
    ...
    private void setDeprecatedOptions(Map<String, String> settings) {
        ...
        if (insertNewLineAfterAnnotationOnTypeOption == null && insertNewLineAfterAnnotationOnEnumConstantOption == null && insertNewLineAfterAnnotationOnFieldOption == null && insertNewLineAfterAnnotationOnMethodOption == null && insertNewLineAfterAnnotationOnPackageOption == null) {
            ...
            } else if (insertNewLineAfterAnnotationOnParameterOption == null && insertNewLineAfterAnnotationOnLocalVariableOption == null) {
    ...
    public void setDefaultSettings() {
        ...
        this.tab_size = 4;
        this.page_width = 120;
        // see https://bugs.eclipse.org/bugs/show_bug.cgi?id=49081
        this.tab_char = TAB;
