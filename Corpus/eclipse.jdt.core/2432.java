...
public class ASTImplTests extends AbstractRegressionTest {
    ...
    public void test0002_combined_binary_expression() {
        ...
        CombinedBinaryExpression.defaultArityMaxStartingValue = CombinedBinaryExpression.ARITY_MAX_MIN;
    }
    ...
    public void test0003_combined_binary_expression() {
        Parser parser = new Parser(new ProblemReporter(DefaultErrorHandlingPolicies.proceedWithAllProblems(), new CompilerOptions(), new DefaultProblemFactory()), // optimize string literals
        true);
