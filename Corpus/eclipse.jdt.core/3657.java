...
public class ASTStructuralPropertyTest extends org.eclipse.jdt.core.tests.junit.extension.TestCase {
        ...
        ASTVisitor v = new ASTVisitor(true) {
            ...
            public void postVisit(ASTNode node) {
                ...
                if (p != null) {
                    ...
                    for (Iterator it = parentProperties.iterator(); it.hasNext(); ) {
    ...
    public void testNodeClassForType() {
        ...
        // last known one
        assertEquals("Wrong last known type", 92, hi);
        // all classes are distinct
        assertEquals("Wrong number of distinct types", hi, classes.size());
    }
}
