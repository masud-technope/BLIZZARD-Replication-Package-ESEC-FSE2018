...
public class PackageDeclarationImpl extends DeclarationImpl implements PackageDeclaration {
    ...
    public  PackageDeclarationImpl(final IPackageBinding binding, final TypeDeclarationImpl typeDecl, final BaseProcessorEnv env, final boolean hideSourcePosition) {
        this(binding, typeDecl, env, hideSourcePosition, null);
    }

    public  PackageDeclarationImpl(final IPackageBinding binding, final TypeDeclarationImpl typeDecl, final BaseProcessorEnv env, final boolean hideSourcePosition, final IPackageFragment[] pkgFragments) {
        super(binding, env);
        _typeDecl = typeDecl;
    ...
    public IPackageBinding getPackageBinding() {
        return (IPackageBinding) _binding;
    }
    ...
    public boolean isFromSource() {
        return _typeDecl != null && _typeDecl.isFromSource();
    }
