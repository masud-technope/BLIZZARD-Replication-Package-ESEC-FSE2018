...
public class LambdaExpression extends Expression {
	 ...
	 * </p>
	 */
    public static final SimplePropertyDescriptor PARENTHESES_PROPERTY = //$NON-NLS-1$
    new SimplePropertyDescriptor(LambdaExpression.class, "parentheses", boolean.class, MANDATORY);
    ...
    new ChildListPropertyDescriptor(LambdaExpression.class, "parameters", VariableDeclaration.class, CYCLE_RISK);
    ...
    new ChildPropertyDescriptor(LambdaExpression.class, "body", ASTNode.class, MANDATORY, CYCLE_RISK);
