...
public class IfStatement extends Statement {
    ...
    new ChildPropertyDescriptor(IfStatement.class, "expression", Expression.class, MANDATORY, CYCLE_RISK);

    /**
	 * The "thenStatement" structural property of this node type (child type: {@link Statement}).
	 * @since 3.0
	 */
    public static final ChildPropertyDescriptor THEN_STATEMENT_PROPERTY = //$NON-NLS-1$
	 ...
	 * @since 3.0
	 */
    public static final ChildPropertyDescriptor ELSE_STATEMENT_PROPERTY = //$NON-NLS-1$
	 ...
	 */
    int treeSize() {
        return memSize() + (this.expression == null ? 0 : getExpression().treeSize()) + (this.thenStatement == null ? 0 : getThenStatement().treeSize()) + (this.optionalElseStatement == null ? 0 : getElseStatement().treeSize());
    }
}
