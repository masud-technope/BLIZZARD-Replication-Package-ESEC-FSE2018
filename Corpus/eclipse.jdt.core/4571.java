...
public class VarargsTest extends AbstractComparableTest {
    ...
    public // array dimension test compatibility with Object
    void test007() {
    ...
    public // check behaviour of Scope.mostSpecificMethodBinding()
    void test013() {
    ...
    public // ensure AccVarargs does not collide
    void test027() {
    ...
    public void test033() {
        ...
        false, this.complianceLevel < ClassFileConstants.JDK1_7 ? JavacTestOptions.Excuse.JavacCompilesIncorrectSource : null, new String[] { "X.java", "public class X {\n" + "	void a(boolean b, Object... o) {System.out.print(1);}\n" + "	void a(Object... o) {System.out.print(2);}\n" + "	public static void main(String[] args) {\n" + "		X x = new X();\n" + "		x.a(true);\n" + "		x.a(true, \"foobar\");\n" + "		x.a(\"foo\", \"bar\");\n" + "	}\n" + "}\n" }, "----------\n" + "1. ERROR in X.java (at line 6)\n" + "	x.a(true);\n" + "	  ^\n" + "The method a(boolean, Object[]) is ambiguous for the type X\n" + "----------\n" + "2. ERROR in X.java (at line 7)\n" + "	x.a(true, \"foobar\");\n" + "	  ^\n" + "The method a(boolean, Object[]) is ambiguous for the type X\n" + "----------\n");
    ...
    public void test033_tolerate() {
        ...
        try {
            ...
            if (this.complianceLevel >= ClassFileConstants.JDK1_7) {
                ...
                this.runConformTest(new String[] { "X.java", "public class X {\n" + "	void a(boolean b, Object... o) {System.out.print(1);}\n" + "	void a(Object... o) {System.out.print(2);}\n" + "	public static void main(String[] args) {\n" + "		X x = new X();\n" + "		x.a(true);\n" + "		x.a(true, \"foobar\");\n" + "		x.a(\"foo\", \"bar\");\n" + "	}\n" + "}\n" }, "112", null, true, null, options, null);
            }
        } finally {
            System.setProperty("tolerateIllegalAmbiguousVarargsInvocation", "false");
        }
    ...
    public void test060() {
        ...
        assertTrue("varargs attribute not found", CharOperation.equals(attributes[0].getAttributeName(), "Varargs".toCharArray()) || CharOperation.equals(attributes[1].getAttributeName(), "Varargs".toCharArray()));
        options.put(CompilerOptions.OPTION_Compliance, CompilerOptions.VERSION_1_5);
        options.put(CompilerOptions.OPTION_Source, CompilerOptions.VERSION_1_5);
    ...
    public void test070_tolerate2() throws Exception {
        ...
        try {
            ...
            if (this.complianceLevel >= ClassFileConstants.JDK1_7) {
                this.runNegativeTest(/* skipJavac */
                false, this.complianceLevel == ClassFileConstants.JDK1_7 ? JavacTestOptions.Excuse.JavacCompilesIncorrectSource : null, new String[] { "X.java", "import java.util.Arrays;\n" + "public class X {\n" + "        public static void test(int... a) {\n" + "			System.out.println(Arrays.toString(a));\n}\n" + "        public static <T> void test(Object... a) {\n" + "			System.out.println(Arrays.toString(a));\n}\n" + "        public static void main(String[] args) {\n" + "            test(1);\n" + "        }\n" + "}\n" }, "----------\n" + "1. ERROR in X.java (at line 10)\n" + "	test(1);\n" + "	^^^^\n" + "The method test(int[]) is ambiguous for the type X\n" + "----------\n", null, true, options);
            } else {
                this.runConformTest(new String[] { "X.java", "import java.util.Arrays;\n" + "public class X {\n" + "        public static void test(int... a) {\n" + "			System.out.println(Arrays.toString(a));\n}\n" + "        public static <T> void test(Object... a) {\n" + "			System.out.println(Arrays.toString(a));\n}\n" + "        public static void main(String[] args) {\n" + "            test(1);\n" + "        }\n" + "}\n" }, "[1]", null, true, null, options, null);
            }
        } finally {
