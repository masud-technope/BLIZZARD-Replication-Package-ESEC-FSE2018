...
public class SyntheticAccessMethodBinding extends MethodBinding {
    ...
    // bridge method
    public static final int BridgeMethodAccess = 6;

    static final char[] AccessMethodPrefix = { 'a', 'c', 'c', 'e', 's', 's', '$' };
	...
	*/
    ...
    public void initializeConstructorAccessor(MethodBinding accessedConstructor) {
        ...
        parameters[accessedConstructor.parameters.length] = accessedConstructor.declaringClass;
