    ...
    public Object getConstant() throws JavaModelException {
        ...
        try {
            if (signature.equals(Signature.SIG_INT)) {
                ...
                constantSource.endsWith("L") || constantSource.endsWith("l")) {
                    int index = //$NON-NLS-1$
                    constantSource.lastIndexOf(//$NON-NLS-1$
                    "L");
                    if (index != -1) {
                        constant = Long.valueOf(constantSource.substring(0, index));
                    } else {
                        constant = Long.valueOf(constantSource.substring(0, //$NON-NLS-1$
                        constantSource.lastIndexOf(//$NON-NLS-1$
                        "l")));
                    }
                } else {
            ...
            signature.equals("QString;")) {
                constant = constantSource;
            } else if (//$NON-NLS-1$
            signature.equals("Qjava.lang.String;")) {
                constant = constantSource;
            }
