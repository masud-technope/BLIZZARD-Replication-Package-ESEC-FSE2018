...
public class ResolveTests18 extends AbstractJavaModelTests {
    ...
    public void test0001() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "goo() [in X [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]", elements);
    }
    ...
    public void test0004() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "goo() [in Y [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]", elements);
    }
    ...
    public void test0012() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "X [in [Working copy] X.java [in <default> [in src [in Resolve]]]]", elements);
    }
    ...
    public void test0013() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "Y [in [Working copy] X.java [in <default> [in src [in Resolve]]]]", elements);
    }
    ...
    public void test0015() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "X(long) [in X [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]", elements);
    }
    ...
    public void test0019() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "hashCode() [in Object [in Object.class [in java.lang [in " + getExternalPath() + "jclFull1.8.jar]]]]", elements);
    }
    ...
    public void test0022() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "foo() [in Y [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]", elements);
    }
    ...
    public void test0024() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "xyz [in foo(int) [in <lambda #1> [in foo() [in X [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]]]]", elements);
    }
    ...
    public void test0025() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "abc [in foo(int) [in <lambda #1> [in foo() [in X [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]]]]", elements);
    }
    ...
    public void test0026() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "abc [in foo(int) [in <lambda #1> [in i [in X [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]]]]", elements);
    }
    ...
    public void test0027() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "abc [in doit(I) [in <lambda #1> [in doit(I) [in <lambda #1> [in doit(I) [in <lambda #1> [in main(String[]) [in X [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]]]]]]]]", elements);
    }
    ...
    public void test0028() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "xyz [in doit(I) [in <lambda #1> [in doit(I) [in <lambda #1> [in main(String[]) [in X [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]]]]]]", elements);
    }
    ...
    public void test0029() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "args [in main(String[]) [in X [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]]", elements);
    }
    ...
    public void test0030() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "zyx [in doit(I) [in <lambda #1> [in doit(I) [in <lambda #1> [in fx [in X [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]]]]]]", elements);
    }
    ...
    public void test0032() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "hij [in doit(I) [in <lambda #1> [in doit(I) [in <lambda #1> [in main(String[]) [in X [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]]]]]]", elements);
    }
    ...
    public void test417935() throws JavaModelException {
        // JCL_MIN does not have the relevant classes - these are needed to handle lambda. Use local versions.
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "compareTo(X) [in X [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]", elements);
    }
    ...
    public void testFieldInit() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "first [in foo(int, int) [in <lambda #1> [in i [in X [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]]]]", elements);
    }
    ...
    public void test422468() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "first [in foo(X, java.lang.Object) [in <lambda #1> [in i [in X [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]]]]", elements);
    }
    ...
    public void test422468a() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "second [in foo(X, java.lang.Object) [in <lambda #1> [in i [in X [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]]]]", elements);
    }
    ...
    public void test422468b() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "y [in foo(I) [in <lambda #1> [in foo(I) [in <lambda #1> [in main(String[]) [in X [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]]]]]]", elements);
    }
    ...
    public void test422468d() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "length() [in String [in String.class [in java.lang [in " + getExternalPath() + "jclFull1.8.jar]]]]", elements);
    }
    ...
    public void test422468e() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "q [in foo(java.lang.String, int) [in <lambda #1> [in foo(java.lang.String, java.lang.String) [in <lambda #1> [in foo(java.lang.String, java.lang.String) [in <lambda #1> [in main(String[]) [in X [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]]]]]]]]", elements);
    }
    ...
    public void testParser() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "x [in foo(java.lang.String, java.lang.Integer) [in <lambda #1> [in main(String[]) [in X [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]]]]", elements);
    }
    ...
    public void test424110() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "m(int) [in X [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]", elements);
    }
    ...
    public void test424071() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "getLast() [in Person [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]", elements);
    }
    ...
    public void test424198() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "v1 [in apply(java.lang.String) [in <lambda #1> [in processJar(Path) [in InsistentCapture [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]]]]", elements, true);
    }
    ...
    public void test424198a() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "v2 [in apply(capture-of ? extends java.lang.String) [in <lambda #1> [in processJar(Path) [in InsistentCapture [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]]]]", elements, true);
    }
    ...
    public void test424198b() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "s1 [in accept(capture-of ? extends java.lang.String) [in <lambda #1> [in withWildcard(Stream<? extends String>) [in InsistentCapture [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]]]]", elements, true);
    }
    ...
    public void test424198c() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "s2 [in accept(java.lang.String) [in <lambda #1> [in withoutWildcard(Stream<String>) [in InsistentCapture [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]]]]", elements, true);
    }
    ...
    public void test429262() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "foo(int) [in I [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]", elements);
    }
    ...
    public void test429845() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "ex [in foo() [in <lambda #1> [in fun1(int) [in C1 [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]]]]", elements, true);
    }
    ...
    public void test429948() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "xxx [in run() [in <lambda #1> [in get() [in <lambda #1> [in main(String[]) [in X [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]]]]]]", elements, true);
    }
    ...
    public void test429934() throws CoreException {
        ...
        assertElementsEqual("Unexpected elements", "s [in main(String[]) [in X [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]]", elements, true);
    }
    ...
    public void test429812() throws CoreException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.workingCopies[0].codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "x [in get(java.util.List<U>, int) [in <lambda #1> [in foo(List<U>) [in X [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]]]]", elements, true);
    ...
    public void test430136() throws CoreException {
        ...
        assertEquals("Incorrect memento string", "=Resolve/src<{X.java[X~foo~QList\\<QU;>;=)=\"LGetter\\<TU;>;!144!161!152=&get!2=\"Ljava.util.List\\<TU;>;=\"x=\"I=\"i=\"TU;=\"LX\\~Getter\\<LX;:TU;>;.get\\(Ljava\\/util\\/List\\<TU;>;I)TU;@x!145!145!145!145!Ljava\\/util\\/List;!0!true@i!148!148!148!148!I!0!true=&", memento);
        ...
        assertEquals("Incorrect memento string", "=Resolve/src<{X.java[X~foo~QList\\<QU;>;=)=\"LGetter\\<TU;>;!180!197!188=&get!2=\"Ljava.util.List\\<TU;>;=\"x=\"I=\"i=\"TU;=\"LX\\~Getter\\<LX;:TU;>;.get\\(Ljava\\/util\\/List\\<TU;>;I)TU;@x!181!181!181!181!Ljava\\/util\\/List;!0!true@i!184!184!184!184!I!0!true=&", memento);
        result = JavaCore.create(memento);
        assertEquals("Java elements should be equal", lambda, result);
    ...
    public void test430307() throws CoreException {
        ...
        assertEquals("Incorrect memento string", "=Resolve/src<{X.java[X~foo~QList\\<QU;>;=)=\"LGetter\\<TU;>;!144!161!152=&get!2=\"Ljava.util.List\\<TU;>;=\"x=\"I=\"i=\"TU;=\"LX\\~Getter\\<LX;:TU;>;.get\\(Ljava\\/util\\/List\\<TU;>;I)TU;@x!145!145!145!145!Ljava\\/util\\/List;!0!true@i!148!148!148!148!I!0!true=&@x!145!145!145!145!Ljava.util.List\\<LU;>;!0!true", memento);
        IJavaElement result = JavaCore.create(memento);
    ...
    public void test430307a() throws JavaModelException {
        ...
        ILocalVariable local = (ILocalVariable) elements[0];
        String memento = local.getHandleIdentifier();
        assertEquals("Incorrect memento string", "=Resolve/src<{X.java[X~main~\\[QString;=)=\"LI;!103!169!110=&doit!1=\"LI;=\"pqr=\"LI;=\"LX\\~I;.doit\\(LI;)" + "LI;@pqr!104!106!104!106!LI;!0!true=&=)=\"LI;!124!164!131=&doit!1=\"LI;=\"xyz=\"LI;=\"LX\\~I;.doit\\(LI;)" + "LI;@xyz!125!127!125!127!LI;!0!true=&=)=\"LI;!146!157!153=&doit!1=\"LI;=\"abc=\"LI;=\"LX\\~I;.doit\\(LI;)" + "LI;@abc!147!149!147!149!LI;!0!true=&@abc!147!149!147!149!LI;!0!true", memento);
        IJavaElement result = JavaCore.create(memento);
        assertEquals("Java elements should be equal", local, result);
        IJavaElement parentMethod = result.getParent();
        IJavaElement parentExpr = parentMethod.getParent();
        ...
        assertEquals("Incorrect memento string", "=Resolve/src<{X.java[X~main~\\[QString;=)=\"LI;!103!169!110=&doit!1=\"LI;=\"pqr=\"LI;=\"LX\\~I;.doit\\(LI;)" + "LI;@pqr!104!106!104!106!LI;!0!true=&=)=\"LI;!124!164!131=&doit!1=\"LI;=\"xyz=\"LI;=\"LX\\~I;.doit\\(LI;)" + "LI;@xyz!125!127!125!127!LI;!0!true=&@xyz!125!127!125!127!LI;!0!true", memento);
        result = JavaCore.create(memento);
        assertEquals("Java elements should be equal", local, result);
        ...
        local = (ILocalVariable) elements[0];
        memento = local.getHandleIdentifier();
        assertEquals("Incorrect memento string", "=Resolve/src<{X.java[X~main~\\[QString;=)=\"LI;!103!169!110=&doit!1=\"LI;=\"pqr=\"LI;=\"LX\\~I;.doit\\(LI;)" + "LI;@pqr!104!106!104!106!LI;!0!true=&@pqr!104!106!104!106!LI;!0!true", memento);
        result = JavaCore.create(memento);
        assertEquals("Java elements should be equal", local, result);
        parentMethod = result.getParent();
        parentExpr = parentMethod.getParent();
    ...
    public void test440731() throws JavaModelException {
        ...
        IJavaElement[] elements;
        elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "fooY() [in Y [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]", elements);
        this.wc = getWorkingCopy("/Resolve/src/X.java", "class Y {\n" + "	public void fooY() {return;}\n" + "	public void bar(I2 i) {return;}\n" + "	public void bar(I i) {return;}   \n" + "}\n" + // [1]: Why class fooY {} ?
        "class fooY{}\n" + "interface I { void fooI(Y y); }\n" + "interface I2 { void fooI2(int n);}\n" + "public class X {\n" + "	void foo() {\n" + "		Y y = new Y();\n" + "		y.bar(Y::fooY);\n" + "	}\n" + "}");
        ...
        length = selection.length();
        elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "fooI(Y) [in I [in [Working copy] X.java [in <default> [in src [in Resolve]]]]]", elements);
    ...
    public void test430572() throws JavaModelException {
        ...
        IJavaElement[] elements;
        elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "Object [in Object.class [in java.lang [in " + getExternalPath() + "jclFull1.8.jar]]]", elements);
        this.wc = getWorkingCopy("/Resolve/src/X.java", "class Y {\n" + "	public void fooY() {return;}\n" + "	public void bar(I2 i) {return;}\n" + "	public void bar(I i) {return;}   \n" + "}\n" + // [1]: Why class fooY {} ?
        "class fooY{}\n" + "interface I { void fooI(Y y); }\n" + "interface I2 { void fooI2(int n);}\n" + "public class X {\n" + "	void foo() {\n" + "		Y y = new Y();\n" + "		y.bar(Y::fooY);\n" + "	}\n" + "}");
        str = this.wc.getSource();
        selection = "::";
    ...
    public void testBug487791() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "collectingAndThen(java.util.stream.Collector<T,A,R>, java.util.function.Function<R,RR>) [in Collectors [in Collectors.class [in java.util.stream [in " + getExternalPath() + "jclFull1.8.jar]]]]", elements);
    ...
    public void testBug487791b() throws JavaModelException {
        ...
        int length = selection.length();
        IJavaElement[] elements = this.wc.codeSelect(start, length);
        assertElementsEqual("Unexpected elements", "f1(X) [in Example [in [Working copy] Example.java [in <default> [in src [in Resolve]]]]]", elements);
