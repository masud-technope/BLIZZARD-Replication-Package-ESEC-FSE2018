...
public class CompilationParticipantResult extends BuildContext {
    ...
    // only set during processAnnotations
    protected boolean hasAnnotations;

    // added/changed generated source files that need to be compiled
    protected IFile[] addedFiles;

    // previously generated source files that should be deleted
 ...
 */
    public void recordAddedGeneratedFiles(IFile[] addedGeneratedFiles) {
        ...
        if (// always make a copy even if currently empty
        length1 > 0)
