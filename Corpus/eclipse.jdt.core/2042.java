...
public class EclipseDiagnostic implements Diagnostic<EclipseFileObject> {
    ...
    private  EclipseDiagnostic(Kind kind, int problemId, String[] problemArguments, char[] originatingFileName, DefaultProblemFactory problemFactory, int lineNumber, int columnNumber, int startPosition, int endPosition) {
        this.kind = kind;
