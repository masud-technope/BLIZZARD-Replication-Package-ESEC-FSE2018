...
public class ClassLiteralAccess extends Expression {
    ...
    public TypeBinding resolveType(BlockScope scope) {
        ...
        if ((this.targetType = this.type.resolveType(scope, /* check bounds*/
        true)) == null)
            return null;
        ...
        this.targetType = environment.convertToRawType(this.targetType, /* force conversion of enclosing types*/
        true);
        ...
        if (scope.compilerOptions().sourceLevel >= ClassFileConstants.JDK1_5) {
            ...
            this.resolvedType = environment.createParameterizedType(classType, new TypeBinding[] { boxedType }, /*not a member*/
            null);
        } else {
