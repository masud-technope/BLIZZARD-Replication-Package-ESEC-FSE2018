...
public class AnnotationContext {
    ...
    public String toString() {
        return //$NON-NLS-1$
        "AnnotationContext [annotation=" + this.annotation + ", typeReference=" + this.typeReference + ", targetType=" + this.targetType + //$NON-NLS-1$
        ", info =" + this.info + ", boundIndex=" + this.info2 + //$NON-NLS-1$
        "]";
    }
}
