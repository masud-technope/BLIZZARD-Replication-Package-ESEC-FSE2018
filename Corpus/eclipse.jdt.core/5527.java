...
public class MethodDeclarationPattern extends MethodPattern {
    ...
    public  MethodDeclarationPattern(char[] declaringPackageName, char[] declaringQualification, char[] declaringSimpleName, char[] methodName, int matchRule) {
        super(methodName, declaringQualification, declaringSimpleName, null, null, null, null, null, IJavaSearchConstants.DECLARATIONS, matchRule);
    ...
    public  MethodDeclarationPattern(char[] declaringQualifier, char[] methodName, int matchRule) {
        super(methodName, CharOperation.NO_CHAR, CharOperation.NO_CHAR, null, null, null, null, null, IJavaSearchConstants.DECLARATIONS, matchRule);
    ...
    private void removeInternalFlags() {
        this.extraFlags = this.extraFlags & ~ExtraFlags.ParameterTypesStoredAsSignature;
    }
}
