...
public interface QualifiedNamesConstants {
    ...
    //$NON-NLS-1$
    char[] JavaUtilIteratorConstantPoolName = "java/util/Iterator".toCharArray();

    //$NON-NLS-1$
    char[] JavaLangStringBuilderConstantPoolName = "java/lang/StringBuilder".toCharArray();
    ...
    //$NON-NLS-1$
    char[] StringBufferAppendIntSignature = "(I)Ljava/lang/StringBuffer;".toCharArray();

    //$NON-NLS-1$
    char[] StringBufferAppendLongSignature = "(J)Ljava/lang/StringBuffer;".toCharArray();

    //$NON-NLS-1$
    char[] StringBufferAppendFloatSignature = "(F)Ljava/lang/StringBuffer;".toCharArray();

    //$NON-NLS-1$
    char[] StringBufferAppendDoubleSignature = "(D)Ljava/lang/StringBuffer;".toCharArray();

    //$NON-NLS-1$
    char[] StringBufferAppendCharSignature = "(C)Ljava/lang/StringBuffer;".toCharArray();

    //$NON-NLS-1$
    char[] StringBufferAppendBooleanSignature = "(Z)Ljava/lang/StringBuffer;".toCharArray();

    //$NON-NLS-1$
    char[] StringBufferAppendObjectSignature = "(Ljava/lang/Object;)Ljava/lang/StringBuffer;".toCharArray();

    //$NON-NLS-1$
    char[] StringBufferAppendStringSignature = "(Ljava/lang/String;)Ljava/lang/StringBuffer;".toCharArray();

    //$NON-NLS-1$
    char[] StringBuilderAppendIntSignature = "(I)Ljava/lang/StringBuilder;".toCharArray();

    //$NON-NLS-1$
    char[] StringBuilderAppendLongSignature = "(J)Ljava/lang/StringBuilder;".toCharArray();

    //$NON-NLS-1$
    char[] StringBuilderAppendFloatSignature = "(F)Ljava/lang/StringBuilder;".toCharArray();

    //$NON-NLS-1$
    char[] StringBuilderAppendDoubleSignature = "(D)Ljava/lang/StringBuilder;".toCharArray();

    //$NON-NLS-1$
    char[] StringBuilderAppendCharSignature = "(C)Ljava/lang/StringBuilder;".toCharArray();

    //$NON-NLS-1$
    char[] StringBuilderAppendBooleanSignature = "(Z)Ljava/lang/StringBuilder;".toCharArray();

    //$NON-NLS-1$
    char[] StringBuilderAppendObjectSignature = "(Ljava/lang/Object;)Ljava/lang/StringBuilder;".toCharArray();

    //$NON-NLS-1$
    char[] StringBuilderAppendStringSignature = "(Ljava/lang/String;)Ljava/lang/StringBuilder;".toCharArray();
    ...
    //$NON-NLS-1$
    char[] JavaLangAssertionErrorConstantPoolName = "java/lang/AssertionError".toCharArray();

    //$NON-NLS-1$
    char[] AssertionErrorIntConstrSignature = "(I)V".toCharArray();

    //$NON-NLS-1$
    char[] AssertionErrorLongConstrSignature = "(J)V".toCharArray();

    //$NON-NLS-1$
    char[] AssertionErrorFloatConstrSignature = "(F)V".toCharArray();

    //$NON-NLS-1$
    char[] AssertionErrorDoubleConstrSignature = "(D)V".toCharArray();

    //$NON-NLS-1$
    char[] AssertionErrorCharConstrSignature = "(C)V".toCharArray();

    //$NON-NLS-1$
    char[] AssertionErrorBooleanConstrSignature = "(Z)V".toCharArray();

    //$NON-NLS-1$
    char[] AssertionErrorObjectConstrSignature = "(Ljava/lang/Object;)V".toCharArray();

    //$NON-NLS-1$
    char[] DesiredAssertionStatus = "desiredAssertionStatus".toCharArray();

    //$NON-NLS-1$
    char[] DesiredAssertionStatusSignature = "()Z".toCharArray();

    //$NON-NLS-1$
    char[] ShortConstrSignature = "(S)V".toCharArray();

    //$NON-NLS-1$
    char[] ByteConstrSignature = "(B)V".toCharArray();

    //$NON-NLS-1$
    char[] GetClass = "getClass".toCharArray();

    //$NON-NLS-1$
    char[] GetClassSignature = "()Ljava/lang/Class;".toCharArray();

    //$NON-NLS-1$
    char[] GetComponentType = "getComponentType".toCharArray();

    char[] GetComponentTypeSignature = GetClassSignature;

    //$NON-NLS-1$
    char[] HasNext = "hasNext".toCharArray();

    //$NON-NLS-1$
    char[] HasNextSignature = "()Z".toCharArray();

    //$NON-NLS-1$
    char[] Next = "next".toCharArray();

    //$NON-NLS-1$
    char[] NextSignature = "()Ljava/lang/Object;".toCharArray();
}
