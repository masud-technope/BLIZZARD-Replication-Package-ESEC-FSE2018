...
public class WorkingCopyOwnerTests extends ModifyingResourceTests {
    ...
    public void testCommitPrimaryWorkingCopy() throws CoreException {
        try {
            IFile file = createFile("P/Y.java", "public class Y {\n" + "}");
            this.workingCopy = getCompilationUnit("P/Y.java");
            this.workingCopy.becomeWorkingCopy(null);
            ...
            assertSourceEquals("Unexpected source", newContents, new String(Util.getResourceContentsAsCharArray(file)));
        } finally {
            deleteFile("P/Y.java");
        }
    }
    ...
    public void testGetCorrespondingResource() throws CoreException {
        ...
        try {
            cu = getCompilationUnit("P/X.java");
            cu.becomeWorkingCopy(null);
            assertResourceNamesEqual("Unexpected resource", "X.java", new Object[] { cu.getCorrespondingResource() });
        } finally {
            if (cu != null) {
                cu.discardWorkingCopy();
            }
    ...
    public void testGetWorkingCopies() throws CoreException {
        ...
        try {
            ...
            assertSortedElementsEqual("Unexpected working copies (1)", "", JavaCore.getWorkingCopies(owner1));
            ...
            assertSortedElementsEqual("Unexpected working copies (2)", "[Working copy] X.java [in <default> [in <project root> [in P]]]", JavaCore.getWorkingCopies(owner1));
            ...
            assertSortedElementsEqual("Unexpected working copies (4)", "[Working copy] X.java [in <default> [in <project root> [in P]]]", JavaCore.getWorkingCopies(owner2));
            ...
            assertSortedElementsEqual("Unexpected working copies (6)", "[Working copy] Y.java [in <default> [in <project root> [in P]]]", JavaCore.getWorkingCopies(owner1));
        } finally {
    ...
    public void testHierarchy() throws CoreException {
        try {
            ...
            this.workingCopy = getCompilationUnit("/P/Y.java").getWorkingCopy(/*no progress*/
            owner, null);
    ...
    public void testNewWorkingCopy07() throws CoreException {
        this.workingCopy = newExternalWorkingCopy("X.java", "public class X {\n" + "}");
        this.workingCopy.getBuffer().setContents("public class X {\n" + "  int field;\n" + "}");
        CompilationUnit ast = this.workingCopy.reconcile(JLS3_INTERNAL, /*force resolution*/
        true, null, null);
    ...
    public void testNewWorkingCopy08() throws CoreException {
        ...
        this.workingCopy = owner.newWorkingCopy("X.java", /*no classpath*/
    ...
    public void testParseCompilationUnit3() throws CoreException {
        try {
			...
			*/
            ...
            assertEquals("Unexpected super type", "Y", superType == null ? "<null>" : superType.getQualifiedName());
        } finally {
            deleteProject("P1");
        }
    }
    ...
    public void testSearch1() throws CoreException {
        ...
        this.workingCopy.getBuffer().setContents("public class Y {\n" + "  X field;\n" + "}");
        this.workingCopy.makeConsistent(null);
        SearchPattern pattern = SearchPattern.createPattern("X", IJavaSearchConstants.TYPE, IJavaSearchConstants.REFERENCES, SearchPattern.R_EXACT_MATCH | SearchPattern.R_CASE_SENSITIVE);
        JavaSearchTests.JavaSearchResultCollector resultCollector = new JavaSearchTests.JavaSearchResultCollector();
        new SearchEngine(owner).search(pattern, new SearchParticipant[] { SearchEngine.getDefaultSearchParticipant() }, SearchEngine.createWorkspaceScope(), resultCollector, null);
    ...
    public void testSearch2() throws CoreException {
        ...
        this.workingCopy.makeConsistent(null);
        SearchPattern pattern = SearchPattern.createPattern("X", IJavaSearchConstants.TYPE, IJavaSearchConstants.DECLARATIONS, SearchPattern.R_EXACT_MATCH | SearchPattern.R_CASE_SENSITIVE);
        JavaSearchTests.JavaSearchResultCollector resultCollector = new JavaSearchTests.JavaSearchResultCollector();
        new SearchEngine(owner).search(pattern, new SearchParticipant[] { SearchEngine.getDefaultSearchParticipant() }, SearchEngine.createWorkspaceScope(), resultCollector, null);
        assertEquals(// should not find any in the owner's context
    ...
    public void testSearch3() throws CoreException {
        try {
            ...
            this.workingCopy.makeConsistent(null);
            JavaSearchTests.JavaSearchResultCollector resultCollector = new JavaSearchTests.JavaSearchResultCollector();
            search("Y", IJavaSearchConstants.TYPE, IJavaSearchConstants.DECLARATIONS, SearchEngine.createWorkspaceScope(), resultCollector);
    ...
    public void testSearch4() throws CoreException {
        ...
        try {
            ...
            SearchPattern pattern = SearchPattern.createPattern("*", IJavaSearchConstants.TYPE, IJavaSearchConstants.DECLARATIONS, SearchPattern.R_PATTERN_MATCH | SearchPattern.R_CASE_SENSITIVE);
            new SearchEngine(new ICompilationUnit[] { this.workingCopy }).search(pattern, new SearchParticipant[] { SearchEngine.getDefaultSearchParticipant() }, scope, resultCollector, null);
