...
public class ClassInstanceCreation extends Expression {
	 ...
	 * @since 3.1
	 */
    public static final ChildListPropertyDescriptor TYPE_ARGUMENTS_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(ClassInstanceCreation.class, "typeArguments", Type.class, NO_CYCLE_RISK);

    /**
	 * The "expression" structural property of this node type (child type: {@link Expression}).
	 * @since 3.0
	 */
    public static final ChildPropertyDescriptor EXPRESSION_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(ClassInstanceCreation.class, "expression", Expression.class, OPTIONAL, CYCLE_RISK);
    ...
    new ChildPropertyDescriptor(ClassInstanceCreation.class, "name", Name.class, MANDATORY, NO_CYCLE_RISK);

    /**
	 * The "type" structural property of this node type (child type: {@link Type}) (added in JLS3 API).
	 * @since 3.1
	 */
    public static final ChildPropertyDescriptor TYPE_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(ClassInstanceCreation.class, "type", Type.class, MANDATORY, NO_CYCLE_RISK);

    /**
	 * The "arguments" structural property of this node type (element type: {@link Expression}).
	 * @since 3.0
	 */
    public static final ChildListPropertyDescriptor ARGUMENTS_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(ClassInstanceCreation.class, "arguments", Expression.class, CYCLE_RISK);

    /**
	 * The "anonymousClassDeclaration" structural property of this node type (child type: {@link AnonymousClassDeclaration}).
	 * @since 3.0
	 */
    public static final ChildPropertyDescriptor ANONYMOUS_CLASS_DECLARATION_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(ClassInstanceCreation.class, "anonymousClassDeclaration", AnonymousClassDeclaration.class, OPTIONAL, CYCLE_RISK);
    ...
    ASTNode clone0(AST target) {
        ...
        result.setAnonymousClassDeclaration((AnonymousClassDeclaration) ASTNode.copySubtree(target, getAnonymousClassDeclaration()));
        return result;
    }
