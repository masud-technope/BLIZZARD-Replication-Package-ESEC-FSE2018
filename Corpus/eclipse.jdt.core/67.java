...
public class TypeDeclarationStatement extends Statement {
	 ...
	 */
    public static final ChildPropertyDescriptor TYPE_DECLARATION_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(TypeDeclarationStatement.class, "typeDeclaration", TypeDeclaration.class, MANDATORY, CYCLE_RISK);

    /**
	 * The "declaration" structural property of this node type (child type: {@link AbstractTypeDeclaration}) (added in JLS3 API).
	 * @since 3.1
	 */
    public static final ChildPropertyDescriptor DECLARATION_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(TypeDeclarationStatement.class, "declaration", AbstractTypeDeclaration.class, MANDATORY, CYCLE_RISK);
