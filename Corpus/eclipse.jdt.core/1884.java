...
class DOMType extends /* package */
DOMMember implements IDOMType {
 ...
 */
    public boolean isAllowableChild(IDOMNode node) {
        if (node != null) {
            ...
            return type == IDOMNode.TYPE || type == IDOMNode.FIELD || type == IDOMNode.METHOD || type == IDOMNode.INITIALIZER;
        } else {
            return false;
        }
    }
