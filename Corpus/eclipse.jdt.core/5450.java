 ...
 */
    public void testConstructorDeclaration02() throws CoreException {
        // was testConstructorDeclarationInJar
        ...
        search(method, DECLARATIONS, getJavaSearchScope(), this.resultCollector);
 ...
 */
    public void testConstructorReference01() throws CoreException {
        // was testSimpleConstructorReference1
        IType type = getCompilationUnit("JavaSearch", "src", "p", "A.java").getType("A");
        IMethod constructor = type.getMethod("A", new String[] { "QX;" });
        search(constructor, REFERENCES, getJavaSearchScope(), this.resultCollector);
 ...
 */
    public void testConstructorReference02() throws CoreException {
        // was testSimpleConstructorReference2
        search("p.A(X)", CONSTRUCTOR, REFERENCES, getJavaSearchScope(), this.resultCollector);
        assertSearchResults("src/Test.java void Test.main(String[]) [new p.A(y)]", this.resultCollector);
    }
 ...
 */
    public void testConstructorReference03() throws CoreException {
        // was testConstructorReferenceExplicitConstructorCall1
 ...
 */
    public void testConstructorReference04() throws CoreException {
        // was testConstructorReferenceExplicitConstructorCall2
 ...
 */
    public void testConstructorReference05() throws CoreException {
        // was testConstructorReferenceImplicitConstructorCall1
 ...
 */
    public void testConstructorReference06() throws CoreException {
        // was testConstructorReferenceImplicitConstructorCall2
        search("c8.X()", CONSTRUCTOR, REFERENCES, getJavaSearchScope(), this.resultCollector);
 ...
 */
    public void testConstructorReference07() throws CoreException {
        // was testConstructorReferenceInFieldInitializer
 ...
 */
    public void testConstructorReference08() throws CoreException {
        // was testConstructorReferenceDefaultConstructorOfMemberClass
        search("c10.X.Inner()", CONSTRUCTOR, REFERENCES, getJavaSearchScope(), this.resultCollector);
 ...
 */
    public void testConstructorReference10() throws CoreException {
        ...
        search("c11.A()", CONSTRUCTOR, REFERENCES, getJavaSearchScope(), this.resultCollector);
 ...
 */
    public void testCoreException() throws CoreException {
        ...
        try {
            search(type, DECLARATIONS, getJavaSearchScope(), result);
 ...
 */
    public void testDeclarationOfAccessedFields3() throws CoreException {
        IMethod method = getCompilationUnit("JavaSearch", "src", "b6", "A.java").getType("A").getMethod("foo", new String[] {});
        searchDeclarationsOfAccessedFields(method, this.resultCollector);
 ...
 */
    public void testDeclarationOfAccessedFields4() throws CoreException {
        IMethod method = getCompilationUnit("JavaSearch", "src", "b10", "A.java").getType("A").getMethod("foo", new String[] {});
        searchDeclarationsOfAccessedFields(method, this.resultCollector);
        assertSearchResults("", this.resultCollector);
    }
 ...
 */
    public void testDeclarationOfReferencedTypes01() throws CoreException {
        IMethod method = getCompilationUnit("JavaSearch", "src", "a3", "References.java").getType("References").getMethod("foo", new String[] {});
 ...
 */
    public void testDeclarationOfReferencedTypes02() throws CoreException {
        IMethod method = getCompilationUnit("JavaSearch", "src", "a7", "X.java").getType("X").getMethod("foo", new String[] {});
        searchDeclarationsOfReferencedTypes(method, this.resultCollector);
 ...
 */
    public void testDeclarationOfReferencedTypes03() throws CoreException {
        ...
        searchDeclarationsOfReferencedTypes(unit, this.resultCollector);
 ...
 */
    public void testDeclarationOfReferencedTypes06() throws CoreException {
        ...
        searchDeclarationsOfReferencedTypes(innerType, this.resultCollector);
 ...
 */
    public void testDeclarationOfReferencedTypes07() throws CoreException {
        ...
        boolean iae = false;
        try {
            searchDeclarationsOfReferencedTypes(pkg, this.resultCollector);
 ...
 */
    public void testDeclarationOfReferencedTypes09() throws CoreException {
        ...
        searchDeclarationsOfReferencedTypes(cu, result);
 ...
 */
    public void testDeclarationsOfSentMessages01() throws CoreException {
        // was testSimpleDeclarationsOfSentMessages
        ICompilationUnit cu = getCompilationUnit("JavaSearch", "src", "", "Test.java");
        searchDeclarationsOfSentMessages(cu, this.resultCollector);
 ...
 */
    public void testDeclarationsOfSentMessages02() throws CoreException {
        // was testDeclarationOfSentMessages
        IMethod method = getCompilationUnit("JavaSearch", "src", "a5", "B.java").getType("C").getMethod("i", new String[] {});
 ...
 */
    public void testExternalFolder1() throws CoreException {
        try {
            ...
            assertSearchResults(getExternalPath() + "externalLib void p.X.foo()", this.resultCollector);
        } finally {
            deleteProject("P");
 ...
 */
    public void testExternalFolder2() throws CoreException {
        try {
            ...
            new SearchEngine(this.workingCopies).searchAllTypeNames(null, SearchPattern.R_EXACT_MATCH, "ExternalType".toCharArray(), SearchPattern.R_EXACT_MATCH, TYPE, SearchEngine.createJavaSearchScope(new IJavaProject[] { getJavaProject("P") }), collector, IJavaSearchConstants.WAIT_UNTIL_READY_TO_SEARCH, null);
            assertSearchResults("ExternalType (not open) [in ExternalType.class [in p [in " + getExternalPath() + "externalLib]]]", collector);
        } finally {
            deleteProject("P");
            deleteExternalResource("externalLib");
        }
 ...
 */
    public void testExternalFolder3() throws CoreException {
        try {
            ...
            createJavaProject("P", new String[0], new String[] { getExternalResourcePath("externalLib") }, "");
            TypeNameMatchCollector collector = new TypeNameMatchCollector();
            new SearchEngine(this.workingCopies).searchAllTypeNames(null, SearchPattern.R_EXACT_MATCH, "ExternalType229304".toCharArray(), SearchPattern.R_EXACT_MATCH, TYPE, SearchEngine.createWorkspaceScope(), collector, IJavaSearchConstants.WAIT_UNTIL_READY_TO_SEARCH, null);
            assertSearchResults("ExternalType229304 (not open) [in ExternalType229304.class [in p [in " + getExternalPath() + "externalLib]]]", collector);
        } finally {
            deleteProject("P");
            deleteExternalResource("externalLib");
        }
 ...
 */
    public void testZIPArchive1() throws Exception {
        try {
            ...
            IJavaSearchScope scope = SearchEngine.createJavaSearchScope(new IJavaProject[] { getJavaProject("P") });
            search("foo", METHOD, DECLARATIONS, scope);
            assertSearchResults(getExternalPath() + "externalLib.abc void p.X.foo()", this.resultCollector);
        } finally {
 ...
 */
    public void testZIPArchive2() throws Exception {
        try {
            ...
            TypeNameMatchCollector collector = new TypeNameMatchCollector();
            new SearchEngine(this.workingCopies).searchAllTypeNames(null, SearchPattern.R_EXACT_MATCH, "ExternalType".toCharArray(), SearchPattern.R_EXACT_MATCH, TYPE, SearchEngine.createJavaSearchScope(new IJavaProject[] { getJavaProject("P") }), collector, IJavaSearchConstants.WAIT_UNTIL_READY_TO_SEARCH, null);
            assertSearchResults("ExternalType (not open) [in ExternalType.class [in p [in " + getExternalPath() + "externalLib.abc]]]", collector);
        } finally {
            deleteExternalResource("externalLib.abc");
            deleteProject("P");
        }
 ...
 */
    public void testFieldDeclaration01() throws CoreException {
        // was testSimpleFieldDeclaration
        IType type = getCompilationUnit("JavaSearch", "src", "p", "A.java").getType("A");
        IField field = type.getField("x");
        search(field, DECLARATIONS, getJavaSearchScope(), this.resultCollector);
 ...
 */
    public void testFieldDeclaration03() throws CoreException {
        // was testFieldDeclarationArrayType
 ...
 */
    public void testFieldDeclaration04() throws CoreException {
        // was testFieldDeclarationWithWildCard
 ...
 */
    public void testFieldReference09() throws CoreException {
        // was testSimpleReadFieldReference
        IType type = getCompilationUnit("JavaSearch", "src", "p", "A.java").getType("A");
        IField field = type.getField("x");
        search(field, READ_ACCESSES, getJavaSearchScope(), this.resultCollector);
 ...
 */
    public void testFieldReference10() throws CoreException {
        // was testSimpleWriteFieldReference
        IType type = getCompilationUnit("JavaSearch", "src", "p", "A.java").getType("A");
        IField field = type.getField("x");
        search(field, WRITE_ACCESSES, getJavaSearchScope(), this.resultCollector);
        assertSearchResults("src/p/A.java p.A(X) [x]", this.resultCollector);
    }
 ...
 */
    public void testFieldReference11() throws CoreException {
        // was testMultipleFieldReference
 ...
 */
    public void testFieldReference13() throws CoreException {
        // was testFieldReferenceInInnerClass
 ...
 */
    public void testFieldReference14() throws CoreException {
        // was testFieldReferenceInAnonymousClass
 ...
 */
    public void testFieldReference15() throws CoreException {
        // was testFieldReferenceThroughSubclass
 ...
 */
    public void testFieldReference16() throws CoreException {
        // was testReadWriteFieldReferenceInCompoundExpression
 ...
 */
    public void testFieldReference17() throws CoreException {
        // was testReadWriteAccessInQualifiedNameReference
 ...
 */
    public void testFieldReference18() throws CoreException {
        // was testFieldReferenceInBrackets
 ...
 */
    public void testFieldReference19() throws CoreException {
        // was testAccurateFieldReference1
        search("d6.X.CONSTANT", FIELD, REFERENCES, SearchEngine.createJavaSearchScope(new IJavaElement[] { getPackageFragment("JavaSearch", "src", "d6") }), this.resultCollector);
 ...
 */
    public void testFieldReference20() throws CoreException {
        // was testFieldReferenceInOutDocComment
 ...
 */
    public void testInterfaceImplementors1() throws CoreException {
        // was testInterfaceImplementors
        // implementors of an interface
        IType type = getCompilationUnit("JavaSearch", "src", "p", "I.java").getType("I");
        search(type, IMPLEMENTORS, getJavaSearchScope(), this.resultCollector);
 ...
 */
    public void testMethodDeclaration01() throws CoreException {
        // was testSimpleMethodDeclaration
        IType type = getCompilationUnit("JavaSearch", "src", "p", "X.java").getType("X");
 ...
 */
    public void testMethodDeclaration02() throws CoreException {
        // was testMethodDeclaration
        IType type = getCompilationUnit("JavaSearch", "src", "e2", "X.java").getType("X");
        search("foo(String, String)", METHOD, DECLARATIONS, SearchEngine.createJavaSearchScope(new IJavaElement[] { type }), this.resultCollector);
 ...
 */
    public void testMethodDeclaration03() throws CoreException {
        // was testInnerMethodDeclaration
 ...
 */
    public void testMethodDeclaration04() throws CoreException {
        // was testMethodDeclarationInHierarchyScope1
        IType type = getCompilationUnit("JavaSearch", "src", "p", "X.java").getType("X");
        search("foo", METHOD, DECLARATIONS, SearchEngine.createHierarchyScope(type), this.resultCollector);
 ...
 */
    public void testMethodDeclaration05() throws CoreException {
        // was testMethodDeclarationInHierarchyScope2
        IType type = getCompilationUnit("JavaSearch", "src", "p", "X.java").getType("X");
        IMethod method = type.getMethod("foo", new String[] { "I", "QString;", "QX;" });
        search(method, DECLARATIONS, SearchEngine.createHierarchyScope(type), this.resultCollector);
        assertSearchResults("src/p/X.java void p.X.foo(int, String, X) [foo]\n" + "src/p/Z.java void p.Z.foo(int, String, X) [foo]", this.resultCollector);
    }
 ...
 */
    public void testMethodDeclaration06() throws CoreException {
        // was testMethodDeclarationInHierarchyScope3
 ...
 */
    public void testMethodDeclaration07() throws CoreException {
        // was testMethodDeclarationInPackageScope
        IType type = getCompilationUnit("JavaSearch", "src", "p", "X.java").getType("X");
        IJavaSearchScope scope = SearchEngine.createJavaSearchScope(new IJavaElement[] { type.getPackageFragment() });
        search("main(String[])", METHOD, DECLARATIONS, scope, this.resultCollector);
 ...
 */
    public void testMethodDeclaration08() throws CoreException {
        // was testMethodDeclarationInJar
        IType type = getClassFile("JavaSearch", "MyJar.jar", "p1", "A.class").getType();
 ...
 */
    public void testMethodDeclaration09() throws CoreException {
        // was testMethodDeclarationInInitializer
        search("foo24346", METHOD, DECLARATIONS, getJavaSearchScope(), this.resultCollector);
 ...
 */
    public void testMethodDeclaration10() throws CoreException {
        // was testMethodDeclarationNoReturnType
        IType type = getCompilationUnit("JavaSearch", "src", "e8", "A.java").getType("A");
        IJavaSearchScope scope = SearchEngine.createJavaSearchScope(new IJavaElement[] { type.getPackageFragment() });
        search("m() int", METHOD, DECLARATIONS, scope, this.resultCollector);
 ...
 */
    public void testMethodDeclaration11() throws CoreException {
        ...
        search("foo", METHOD, DECLARATIONS, scope, this.resultCollector);
 ...
 */
    public void testMethodReference08() throws CoreException {
        // was testStaticMethodReference1
        IType type = getCompilationUnit("JavaSearch", "src", "p", "Y.java").getType("Y");
        IMethod method = type.getMethod("bar", new String[] {});
        search(method, REFERENCES, getJavaSearchScope(), this.resultCollector);
 ...
 */
    public void testMethodReference09() throws CoreException {
        // was testStaticMethodReference2
        IType type = getCompilationUnit("JavaSearch", "src", "p", "X.java").getType("X");
        IMethod method = type.getMethod("bar", new String[] {});
        search(method, REFERENCES, getJavaSearchScope(), this.resultCollector);
        assertSearchResults("", this.resultCollector);
 ...
 */
    public void testMethodReference11() throws CoreException {
        // was testMethodReferenceThroughSuper
 ...
 */
    public void testMethodReference12() throws CoreException {
        // was testMethodReferenceInInnerClass
 ...
 */
    public void testMethodReference13() throws CoreException {
        // was testMethodReferenceInAnonymousClass
 ...
 */
    public void testMethodReference14() throws CoreException {
        // was testMethodReferenceThroughArray
 ...
 */
    public void testMethodReference15() throws CoreException {
        // was testMethodReferenceInOutDocComment
        IType type = getCompilationUnit("JavaSearch", "src", "s4", "X.java").getType("X");
        IMethod method = type.getMethod("foo", new String[] {});
        this.resultCollector.showInsideDoc();
        search(method, REFERENCES, getJavaSearchScope(), this.resultCollector);
 ...
 */
    public void testOrPattern() throws CoreException {
        IMethod leftMethod = getCompilationUnit("JavaSearch", "src", "q9", "I.java").getType("I").getMethod("m", new String[] {});
        SearchPattern leftPattern = createPattern(leftMethod, ALL_OCCURRENCES);
        IMethod rightMethod = getCompilationUnit("JavaSearch", "src", "q9", "I.java").getType("A1").getMethod("m", new String[] {});
        ...
        this.resultCollector.showAccuracy(true);
        search(orPattern, getJavaSearchScope(), this.resultCollector);
 ...
 */
    public void testPackageDeclaration1() throws CoreException {
        // was testSimplePackageDeclaration
        IPackageFragment pkg = getPackageFragment("JavaSearch", "src", "p");
        search(pkg, DECLARATIONS, getJavaSearchScope(), this.resultCollector);
 ...
 */
    public void testPackageDeclaration2() throws CoreException {
        // was testVariousPackageDeclarations
        JavaSearchResultCollector packageCollector = new JavaSearchResultCollector(true);
        search("p3*", PACKAGE, DECLARATIONS, getJavaSearchScope(), packageCollector);
        assertSearchResults("src/p3 p3\n" + "src/p3/p2 p3.p2\n" + "src/p3/p2/p p3.p2.p", packageCollector);
    }
 ...
 */
    public void testPackageDeclaration3() throws CoreException {
        // was testPackageDeclaration
        IPackageFragment pkg = getPackageFragment("JavaSearch", getExternalJCLPathString(), "java.lang");
        search(pkg, DECLARATIONS, getJavaSearchScope(), this.resultCollector);
        assertSearchResults(getExternalJCLPath() + " java.lang", this.resultCollector);
    }
 ...
 */
    public void testPackageDeclaration4() throws CoreException {
        ...
        try {
            ...
            search("r9", PACKAGE, DECLARATIONS, getJavaSearchScope(), this.resultCollector);
 ...
 */
    public void testPackageDeclarationBug73551() throws CoreException {
        ...
        assertSearchResults("src/p71267/Test.java p71267 [No source] EXACT_MATCH", result);
    }
 ...
 */
    public void testPackageDeclarationBug117020() throws CoreException {
        ...
        try {
            ...
            assertSearchResults("src/b117020 b117020 EXACT_MATCH", result);
    ...
    public void testPackageDeclarationBug183062a() throws CoreException {
        JavaSearchResultCollector packageCollector = new JavaSearchResultCollector(true);
        search("j?", PACKAGE, DECLARATIONS, getJavaSearchScope(), packageCollector);
        assertSearchResults("src/j1 j1\n" + "src/j2 j2\n" + "src/j3 j3\n" + "src/j4 j4\n" + "src/j5 j5\n" + "src/j6 j6\n" + "src/j7 j7\n" + "test47909.jar j3 [No source]", packageCollector);
    }
    ...
    public void testPackageDeclarationBug183062c() throws CoreException {
        JavaSearchResultCollector packageCollector = new JavaSearchResultCollector(true);
        search("j7.*", PACKAGE, DECLARATIONS, getJavaSearchScope(), packageCollector);
        assertSearchResults("src/j7/qua j7.qua\n" + "src/j7/qua/li j7.qua.li\n" + "src/j7/qua/li/fied j7.qua.li.fied", packageCollector);
    }
    ...
    public void testPackageDeclarationBug183062e() throws CoreException {
        JavaSearchResultCollector packageCollector = new JavaSearchResultCollector(true);
        search("????.????", PACKAGE, DECLARATIONS, getJavaSearchScope(), packageCollector);
        assertSearchResults("" + getExternalJCLPathString() + " java.lang", packageCollector);
    }
 ...
 */
    public void testPackageReference1() throws CoreException {
        ...
        search(pkg, REFERENCES, getJavaSearchScope(), this.resultCollector);
 ...
 */
    public void testPackageReference3() throws CoreException {
        ...
        search(pkg, REFERENCES, scope, this.resultCollector);
 ...
 */
    public void testPackageReference4() throws CoreException {
        // was testSimplePackageReference
        IPackageFragment pkg = getPackageFragment("JavaSearch", "src", "p");
        search(pkg, REFERENCES, getJavaSearchScope(), this.resultCollector);
 ...
 */
    public void testPackageReference5() throws CoreException {
        // was testVariousPackageReference
 ...
 */
    public void testPackageReference6() throws CoreException {
        // was testAccuratePackageReference
 ...
 */
    public void testPackageReference7() throws CoreException {
        // was testPatternMatchPackageReference
        search("*p2.*", PACKAGE, REFERENCES, getJavaSearchScope(), this.resultCollector);
        assertSearchResults("src/PackageReference/A.java [p3.p2.p]\n" + "src/PackageReference/B.java [p3.p2.p]\n" + "src/PackageReference/C.java PackageReference.C [p3.p2.p]\n" + "src/PackageReference/D.java PackageReference.D.x [p3.p2.p]\n" + "src/PackageReference/E.java PackageReference.E.x [p3.p2.p]\n" + "src/PackageReference/F.java p3.p2.p.X PackageReference.F.foo() [p3.p2.p]\n" + "src/PackageReference/G.java void PackageReference.G.foo(p3.p2.p.X) [p3.p2.p]\n" + "src/PackageReference/H.java void PackageReference.H.foo() [p3.p2.p]\n" + "src/PackageReference/I.java void PackageReference.I.foo() [p3.p2.p]\n" + "src/PackageReference/J.java void PackageReference.J.foo() [p3.p2.p]", this.resultCollector);
    }
 ...
 */
    public void testPackageReference8() throws CoreException {
        // was testPatternMatchPackageReference2
        search("*", PACKAGE, REFERENCES, getJavaSearchScope(), this.resultCollector);
 ...
 */
    ...
    public void testSearchFieldInBinaryNoResolution() throws CoreException {
        ...
        try {
            ...
            assertSearchResults("AbortCompilation.jar AbortCompilation.MissingFieldType.field [No source] EXACT_MATCH\n" + "AbortCompilation.jar AbortCompilation.MissingFieldType.missing [No source] EXACT_MATCH\n" + "AbortCompilation.jar AbortCompilation.MissingFieldType.otherField [No source] EXACT_MATCH", collector);
        } finally {
            // reset classpath
            JAVA_PROJECT.setRawClasspath(classpath, null);
        }
 ...
 */
    ...
    public void testSearchMethodInBinaryNoResolution() throws CoreException {
        ...
        try {
            ...
            assertSearchResults("AbortCompilation.jar void AbortCompilation.MissingArgumentType.foo() [No source] EXACT_MATCH\n" + "AbortCompilation.jar void AbortCompilation.MissingArgumentType.foo(java.util.EventListener) [No source] EXACT_MATCH\n" + "AbortCompilation.jar void AbortCompilation.MissingArgumentType.foo2() [No source] EXACT_MATCH\n" + "AbortCompilation.jar AbortCompilation.MissingArgumentType() [No source] EXACT_MATCH", collector);
        } finally {
            // reset classpath
            JAVA_PROJECT.setRawClasspath(classpath, null);
        }
 ...
 */
    public void testSearchScope05() throws CoreException, IOException {
        ...
        try {
            ...
            search("X", TYPE, DECLARATIONS, scope, this.resultCollector);
            assertSearchResults(externalJar + " p0.X", this.resultCollector);
            IClassFile classFile = pkg.getClassFile("X.class");
            scope = SearchEngine.createJavaSearchScope(new IJavaElement[] { classFile });
            this.resultCollector = new JavaSearchResultCollector();
            search(classFile.getType(), DECLARATIONS, scope, this.resultCollector);
            assertSearchResults(externalJar.getCanonicalPath() + " p0.X", this.resultCollector);
        } finally {
 ...
 */
    public void testSearchScope14() throws CoreException {
        ICompilationUnit cuC = this.getCompilationUnit("JavaSearch", "src", "a10", "C.java");
        IType type = cuC.getType("C");
        IJavaSearchScope scope = SearchEngine.createStrictHierarchyScope(null, type, /*onlySubTypes*/
        false, true, null);
        search("**", TYPE, DECLARATIONS, scope);
 ...
 */
    public void testSearchScope15() throws CoreException {
        ...
        new SearchEngine().searchAllTypeNames(null, null, scope, collector, IJavaSearchConstants.WAIT_UNTIL_READY_TO_SEARCH, null);
        String expected = "a10.D\n" + "a10.E\n" + "a10.F\n" + "a10.H$I";
 ...
 */
    public void testTypeDeclaration01() throws CoreException {
        // was testSimpleTypeDeclaration
        IType type = getCompilationUnit("JavaSearch", "src", "p", "X.java").getType("X");
        search(type, DECLARATIONS, getJavaSearchScope(), this.resultCollector);
 ...
 */
    public void testTypeDeclaration02() throws CoreException {
        ...
        IJavaSearchScope scope = SearchEngine.createJavaSearchScope(new IJavaElement[] { pkg });
        search("Y", TYPE, DECLARATIONS, scope, this.resultCollector);
 ...
 */
    public void testTypeDeclaration03() throws CoreException {
        // was testTypeDeclaration
        IPackageFragment pkg = getPackageFragment("JavaSearch", "src", "d8");
        IJavaSearchScope scope = SearchEngine.createJavaSearchScope(new IJavaElement[] { pkg });
        search("A", TYPE, DECLARATIONS, scope, this.resultCollector);
 ...
 */
    public void testTypeDeclaration06() throws CoreException {
        // was testTypeDeclarationInPackageScope
 ...
 */
    public void testTypeDeclaration07() throws CoreException {
        // was testTypeDeclarationInPackageScope2
 ...
 */
    public void testTypeDeclaration08() throws CoreException {
        // was testMemberTypeDeclaration
        IJavaSearchScope scope = SearchEngine.createJavaSearchScope(new IJavaElement[] { getPackageFragment("JavaSearch", "src", "b4") });
        search("*.A.B", TYPE, DECLARATIONS, scope, this.resultCollector);
 ...
 */
    public void testTypeDeclaration09() throws CoreException {
        search("X?Z", TYPE, DECLARATIONS, getJavaSearchScope(), this.resultCollector);
 ...
 */
    public void testTypeOccurence1() throws CoreException {
        // was testTypeOccurence
        IType type = getCompilationUnit("JavaSearch", "src", "r", "A.java").getType("A").getType("X");
        search(type, ALL_OCCURRENCES, getJavaSearchScope(), this.resultCollector);
 ...
 */
    public void testTypeOccurence2() throws CoreException {
        ...
        IJavaSearchScope scope = SearchEngine.createJavaSearchScope(new IJavaElement[] { type.getPackageFragment() });
        search(type, ALL_OCCURRENCES, scope, this.resultCollector);
 ...
 */
    public void testTypeOccurence4() throws CoreException {
        // was testTypeOccurenceWithDollar
 ...
 */
    public void testTypeReference06() throws CoreException {
        ...
        search(type, REFERENCES, getJavaSearchScope15("p1", true), this.resultCollector);
 ...
 */
    public void testTypeReference08() throws CoreException {
        // was testTypeReferenceInInitializer
 ...
 */
    public void testTypeReference09() throws CoreException {
        // was testTypeReferenceAsSingleNameReference
 ...
 */
    public void testTypeReference10() throws CoreException {
        // was testMemberTypeReference
        // references to second level member type
        this.resultCollector.showAccuracy(true);
        search("BMember", TYPE, REFERENCES, getJavaSearchScope(), this.resultCollector);
        ...
        this.resultCollector = new JavaSearchResultCollector();
        this.resultCollector.showAccuracy(true);
        search("AzzMember", TYPE, REFERENCES, getJavaSearchScope(), this.resultCollector);
        ...
        this.resultCollector = new JavaSearchResultCollector();
        this.resultCollector.showAccuracy(true);
        search("BMember", FIELD, REFERENCES, getJavaSearchScope(), this.resultCollector);
 ...
 */
    public void testTypeReference12() throws CoreException {
        // was testObjectMemberTypeReference
 ...
 */
    public void testTypeReference13() throws CoreException {
        // was testTypeReferenceInQualifiedNameReference
        IType type = getCompilationUnit("JavaSearch", "src", "p", "A.java").getType("A");
        search(type, REFERENCES, getJavaSearchScope(), this.resultCollector);
 ...
 */
    public void testTypeReference14() throws CoreException {
        // was testTypeReferenceInQualifiedNameReference2
 ...
 */
    public void testTypeReference15() throws CoreException {
        // was testTypeReferenceInQualifiedNameReference3
 ...
 */
    public void testTypeReference16() throws CoreException {
        // was testTypeReferenceInQualifiedNameReference4
 ...
 */
    public void testTypeReference17() throws CoreException {
        // was testTypeReferenceNotInClasspath
        IType type = getCompilationUnit("JavaSearch", "src", "p", "X.java").getType("X");
        search(type, REFERENCES, getJavaSearchScope(), this.resultCollector);
        assertSearchResults("src/p/A.java p.A.x [X]\n" + "src/p/A.java p.A(X) [X]\n" + "src/p/A.java void p.A.foo(int, String, X) [X]\n" + "src/p/X.java p.X() [X]\n" + "src/p/X.java void p.X.foo(int, String, X) [X]\n" + "src/p/Y.java p.Y [X]\n" + "src/p/Z.java void p.Z.foo(int, String, X) [X]", this.resultCollector);
    }
 ...
 */
    public void testTypeReference18() throws CoreException {
        // was testVariousTypeReferences
        IType type = getCompilationUnit("JavaSearch", "src", "NoReference", "A.java").getType("A");
        search(type, REFERENCES, getJavaSearchScope(), this.resultCollector);
        assertSearchResults(// no reference should be found
        "", this.resultCollector);
    }
 ...
 */
    public void testTypeReference20() throws CoreException {
        // was testTypeReferenceInImport2
 ...
 */
    public void testTypeReference25() throws CoreException {
        // was testInnacurateTypeReference1
        search("Zork", TYPE, REFERENCES, SearchEngine.createJavaSearchScope(new IJavaElement[] { getPackageFragment("JavaSearch", "src", "b5") }), this.resultCollector);
 ...
 */
    public void testTypeReference26() throws CoreException {
        // was testInnacurateTypeReference2
        this.resultCollector.showAccuracy(true);
        this.resultCollector.showSelection();
        search("p.Zork", TYPE, REFERENCES, SearchEngine.createJavaSearchScope(new IJavaElement[] { getPackageFragment("JavaSearch", "src", "b5") }), this.resultCollector);
 ...
 */
    public void testTypeReference27() throws CoreException {
        // was testInnacurateTypeReference3
 ...
 */
    public void testTypeReference29() throws CoreException {
        // was testPatternMatchTypeReference
        search("p24741.*", TYPE, REFERENCES, getJavaSearchScope(), this.resultCollector);
 ...
 */
    public void testTypeReference30() throws CoreException {
        // was testTypeReferenceNotCaseSensitive
 ...
 */
    public void testTypeReference31() throws CoreException {
        // was testAccurateTypeReference
        search("d5.X", TYPE, REFERENCES, SearchEngine.createJavaSearchScope(new IJavaElement[] { getPackageFragment("JavaSearch", "src", "d5") }), this.resultCollector);
 ...
 */
    public void testTypeReference32() throws CoreException {
        // was testTypeReferenceInHierarchy
 ...
 */
    public void testTypeReference33() throws CoreException {
        // was testTypeReferenceWithRecovery
 ...
 */
    public void testTypeReference34() throws CoreException {
        // was testTypeReferenceWithProblem
        IType type = getCompilationUnit("JavaSearch", "src", "e6", "A.java").getType("A");
        this.resultCollector.showAccuracy(true);
        search("B36479", TYPE, REFERENCES, SearchEngine.createJavaSearchScope(new IJavaElement[] { type }), this.resultCollector);
 ...
 */
    public void testTypeReference35() throws CoreException {
        // was testTypeReferenceWithCorruptJar
        IJavaProject project = getJavaProject("JavaSearch");
        IClasspathEntry[] originalCP = project.getRawClasspath();
        try {
            // add corrupt.jar to classpath
 ...
 */
    public void testTypeReference38() throws CoreException {
        // was testTypeReferenceInOutDocComment
        IType type = getCompilationUnit("JavaSearch", "src", "s4", "X.java").getType("X");
        this.resultCollector.showInsideDoc();
        search(type, REFERENCES, getJavaSearchScope(), this.resultCollector);
 ...
 */
    ...
    public void testTypeParameterTypes02() throws CoreException {
        ICompilationUnit unit = getCompilationUnit("JavaSearch15", "src", "g5.m.def", "Single.java");
        // return type of returnParamType() method
        ITypeParameter typeParam = selectTypeParameter(unit, "T", 3);
    ...
    public void testTypeParameterTypes03() throws CoreException {
        ICompilationUnit unit = getCompilationUnit("JavaSearch15", "src", "g5.m.def", "Single.java");
        // type argument of Single<T>
        ITypeParameter typeParam = selectTypeParameter(unit, "T", 4);
    ...
    public void testTypeParameterTypes05() throws CoreException {
        ICompilationUnit unit = getCompilationUnit("JavaSearch15", "src", "g5.m.def", "Multiple.java");
        // return type of returnParamType() method
        ITypeParameter typeParam = selectTypeParameter(unit, "T1", 2);
        search(typeParam, DECLARATIONS, getJavaSearchScope15());
    ...
    public void testTypeParameterTypes06() throws CoreException {
        ICompilationUnit unit = getCompilationUnit("JavaSearch15", "src", "g5.m.def", "Multiple.java");
        // type argument of Multiple<T1,T2,T3>
        ITypeParameter typeParam = selectTypeParameter(unit, "T2", 3);
        search(typeParam, ALL_OCCURRENCES, getJavaSearchScope15());
 ...
 */
    ...
    public void testTypeParameterMethods02() throws CoreException {
        ICompilationUnit unit = getCompilationUnit("JavaSearch15", "src", "g5.m.def", "Single.java");
        // argument of generic method
        ITypeParameter typeParam = selectTypeParameter(unit, "U", 2);
        search(typeParam, DECLARATIONS, getJavaSearchScope15());
        assertSearchResults("src/g5/m/def/Single.java T g5.m.def.Single.generic(U) [U]");
    }
    ...
    public void testTypeParameterMethods03() throws CoreException {
        ICompilationUnit unit = getCompilationUnit("JavaSearch15", "src", "g5.m.def", "Single.java");
        // argument of complete method
        ITypeParameter typeParam = selectTypeParameter(unit, "U", 4);
        search(typeParam, ALL_OCCURRENCES, getJavaSearchScope15());
    ...
    public void testTypeParameterMethods04() throws CoreException {
        ICompilationUnit unit = getCompilationUnit("JavaSearch15", "src", "g5.m.def", "Multiple.java");
        // type parameter of complete method (extends)
        ITypeParameter typeParam = selectTypeParameter(unit, "U3", 3);
        search(typeParam, REFERENCES, getJavaSearchScope15());
    ...
    public void testTypeParameterMethods05() throws CoreException {
        ICompilationUnit unit = getCompilationUnit("JavaSearch15", "src", "g5.m.def", "Multiple.java");
        // argument of generic method
        ITypeParameter typeParam = selectTypeParameter(unit, "U1", 2);
        search(typeParam, DECLARATIONS, getJavaSearchScope15());
    ...
    public void testTypeParameterMethods06() throws CoreException {
        ICompilationUnit unit = getCompilationUnit("JavaSearch15", "src", "g5.m.def", "Multiple.java");
        // argument of complete method
        ITypeParameter typeParam = selectTypeParameter(unit, "U2", 4);
        search(typeParam, ALL_OCCURRENCES, getJavaSearchScope15());
 ...
 */
    ...
    public void testCamelCaseTypePattern06_CamelCase() throws CoreException {
        ...
        assertSearchResults("Unexpected all type names", "java.lang.CloneNotSupportedException", requestor);
    }
 ...
 */
    ...
    public void testBug383908() throws CoreException {
        try {
            ...
            search(methods[0], DECLARATIONS, SearchEngine.createJavaSearchScope(new IJavaElement[] { type }), this.resultCollector);
