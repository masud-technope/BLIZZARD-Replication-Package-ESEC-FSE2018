...
public class TypeDeclaration extends AbstractTypeDeclaration {
	 ...
	 * @since 3.0
	 */
    public static final SimplePropertyDescriptor INTERFACE_PROPERTY = //$NON-NLS-1$
    new SimplePropertyDescriptor(TypeDeclaration.class, "interface", boolean.class, MANDATORY);
	 ...
	 */
    public static final ChildPropertyDescriptor SUPERCLASS_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(TypeDeclaration.class, "superclass", Name.class, OPTIONAL, NO_CYCLE_RISK);
	 ...
	 */
    public static final ChildListPropertyDescriptor SUPER_INTERFACES_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(TypeDeclaration.class, "superInterfaces", Name.class, NO_CYCLE_RISK);

    /**
	 * The "superclassType" structural property of this node type (child type: {@link Type}) (added in JLS3 API).
	 * @since 3.1
	 */
    public static final ChildPropertyDescriptor SUPERCLASS_TYPE_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(TypeDeclaration.class, "superclassType", Type.class, OPTIONAL, NO_CYCLE_RISK);

    /**
	 * The "superInterfaceTypes" structural property of this node type (element type: {@link Type}) (added in JLS3 API).
	 * @since 3.1
	 */
    public static final ChildListPropertyDescriptor SUPER_INTERFACE_TYPES_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(TypeDeclaration.class, "superInterfaceTypes", Type.class, NO_CYCLE_RISK);
    ...
    new ChildListPropertyDescriptor(TypeDeclaration.class, "typeParameters", TypeParameter.class, NO_CYCLE_RISK);
