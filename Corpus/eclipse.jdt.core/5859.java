...
public class RunJavaSearchGenericTests extends junit.framework.TestCase {
    ...
    public static Class[] getJavaSearchTestClasses() {
        return new Class[] { JavaSearchGenericTypeExactTests.class, JavaSearchGenericTypeTests.class, JavaSearchGenericTypeEquivalentTests.class, JavaSearchGenericFieldTests.class, JavaSearchGenericMethodExactTests.class, JavaSearchGenericMethodTests.class, JavaSearchGenericMethodEquivalentTests.class, JavaSearchGenericConstructorExactTests.class, JavaSearchGenericConstructorTests.class, JavaSearchGenericConstructorEquivalentTests.class };
    }
