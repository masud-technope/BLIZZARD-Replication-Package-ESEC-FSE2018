...
public class DependencyTests extends BuilderTests {
    ...
    public void testAbstractMethod() throws JavaModelException {
        ...
        "}\n");
        IPath collaboratorPath = //$NON-NLS-1$ //$NON-NLS-2$
        env.addClass(//$NON-NLS-1$ //$NON-NLS-2$
        root, //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public void testExactMethodDeleting() throws JavaModelException {
        ...
        "}\n");
        IPath cPath = //$NON-NLS-1$ //$NON-NLS-2$
        env.addClass(//$NON-NLS-1$ //$NON-NLS-2$
        root, //$NON-NLS-1$ //$NON-NLS-2$
        ...
        "	int j = i(1);\n" + //$NON-NLS-1$
        "}\n");
        IPath dPath = //$NON-NLS-1$ //$NON-NLS-2$
        env.addClass(//$NON-NLS-1$ //$NON-NLS-2$
        root, //$NON-NLS-1$ //$NON-NLS-2$
        "p3", //$NON-NLS-1$ //$NON-NLS-2$
        "D", //$NON-NLS-1$
    ...
    public void testExternalJarChanged() throws CoreException, java.io.IOException {
        ...
        "package q;\n" + //$NON-NLS-1$
        "public class Y {\n" + //$NON-NLS-1$
        "}" }, new java.util.HashMap(), externalJar);
    ...
    public void testFieldDeleting() throws JavaModelException {
        ...
        //$NON-NLS-1$ //$NON-NLS-2$
        expectingSpecificProblemFor(cPath, new Problem("C", "i cannot be resolved to a variable", cPath, 50, 51, CategorizedProblem.CAT_MEMBER, IMarker.SEVERITY_ERROR));
        //$NON-NLS-1$ //$NON-NLS-2$
        expectingSpecificProblemFor(xPath, new Problem("X", "i cannot be resolved or is not a field", xPath, 57, 58, CategorizedProblem.CAT_MEMBER, IMarker.SEVERITY_ERROR));
        //$NON-NLS-1$ //$NON-NLS-2$
        env.addClass(//$NON-NLS-1$ //$NON-NLS-2$
        root, //$NON-NLS-1$ //$NON-NLS-2$
        "p1", //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public void testInterfaceDeleting() throws JavaModelException {
        ...
        IPath testPath = //$NON-NLS-1$ //$NON-NLS-2$
        env.addClass(//$NON-NLS-1$ //$NON-NLS-2$
        root, //$NON-NLS-1$ //$NON-NLS-2$
        "p1", //$NON-NLS-1$ //$NON-NLS-2$
        "Test", //$NON-NLS-1$
    ...
    public void testSecondaryTypeDeleting() throws JavaModelException {
        ...
        fullBuild(projectPath);
        expectingNoProblems();
        IPath typePath = //$NON-NLS-1$ //$NON-NLS-2$
        env.addClass(//$NON-NLS-1$ //$NON-NLS-2$
        root, //$NON-NLS-1$ //$NON-NLS-2$
        "p1", //$NON-NLS-1$ //$NON-NLS-2$
        "A", //$NON-NLS-1$
    ...
    public void test0100() throws JavaModelException {
        ...
        expectingSpecificProblemFor(M1Path, new Problem("", "The type N1.N2.N3 is deprecated", M1Path, 198, 200, CategorizedProblem.CAT_DEPRECATION, IMarker.SEVERITY_WARNING));
        expectingSpecificProblemFor(M1Path, new Problem("", "The method foo() from the type N1.N2.N3 is deprecated", M1Path, 217, 222, CategorizedProblem.CAT_DEPRECATION, IMarker.SEVERITY_WARNING));
