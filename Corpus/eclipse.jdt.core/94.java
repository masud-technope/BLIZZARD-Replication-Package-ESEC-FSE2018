 ...
 */
    protected boolean buildStructure(OpenableElementInfo info, IProgressMonitor pm, Map newElements, IResource underlyingResource) throws JavaModelException {
        ...
        // compute children
        fragInfo.setChildren(computeChildren(entries[/*class files*/
        0]));
        // compute non-Java resources
        fragInfo.setNonJavaResources(computeNonJavaResources(entries[/*non Java resources*/
        1]));
 ...
 */
    private Object[] computeNonJavaResources(ArrayList entryNames) {
        ...
        HashMap jarEntries = new HashMap();
