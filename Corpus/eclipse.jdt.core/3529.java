 ...
 */
    public void test08() {
        ...
        "		V", // expectedCompletionNodeToString:
        "<CompleteOnType:V>", // expectedUnitDisplayString:
        "package test;\n" + "import java.util.Vector;\n" + "public class VA {\n" + "  Object o1 = new Object() {\n" + "    <CompleteOnType:V>;\n" + "    void foo2() {\n" + "    }\n" + "  };\n" + "  String s2;\n" + "  public VA() {\n" + "  }\n" + "  void bar() {\n" + "  }\n" + "  void foo() {\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "V", // expectedReplacedSource:
        "V", // test name
 ...
 */
    public void test09() {
        ...
        "argv", // expectedCompletionNodeToString:
        "<CompleteOnArgumentName:String[] argv>", // expectedUnitDisplayString:
        "package pack;\n" + "class A {\n" + "  class Member {\n" + "    Member() {\n" + "    }\n" + "    int foo() {\n" + "    }\n" + "  }\n" + "  A() {\n" + "  }\n" + "  public static void main(<CompleteOnArgumentName:String[] argv>) {\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "argv", // expectedReplacedSource:
        "argv", // test name
 ...
 */
    public void test11() {
        this.runTestCheckMethodParse(// compilationUnit:
        "package pack;								\n" + "class A  {									\n" + "											\n" + "	public static void main(String[] argv	\n" + "			new Member().f					\n" + "			;								\n" + "	}										\n" + "	class Member {							\n" + "		int foo()							\n" + "		}									\n" + "	}										\n" + "};											\n", // completeBehind:
        "new Member().f", // expectedCompletionNodeToString:
        "<CompleteOnMemberAccess:new Member().f>", // expectedUnitDisplayString:
        "package pack;\n" + "class A {\n" + "  class Member {\n" + "    Member() {\n" + "    }\n" + "    int foo() {\n" + "    }\n" + "  }\n" + "  A() {\n" + "  }\n" + "  public static void main(String[] argv) {\n" + "    <CompleteOnMemberAccess:new Member().f>;\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "f", // expectedReplacedSource:
        "f", // test name
        "<complete inside method with incomplete signature>");
    }
 ...
 */
    public void test13() {
        ...
        "<CompleteOnClassLiteralAccess:String[].>", // expectedUnitDisplayString:
 ...
 */
    public void test14() {
        ...
        NONE, // expectedUnitDisplayString:
        "public class B {\n" + "  class Member {\n" + "    Member() {\n" + "    }\n" + "  }\n" + "  public B() {\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "", // expectedReplacedSource:
        NONE, // test name
        "<complete inside array type>");
 ...
 */
    public void test16() {
        runTestCheckDietParse(// compilationUnit:
        "public class B {			\n" + "	class Member {}			\n" + "							\n" + "	int[					\n" + "	Obje					\n", // completeBehind:
        "Obje", // expectedCompletionNodeToString:
        "<CompleteOnType:Obje>", // expectedUnitDisplayString:
        "public class B {\n" + "  class Member {\n" + "    Member() {\n" + "    }\n" + "  }\n" + "  <CompleteOnType:Obje>;\n" + "  public B() {\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "Obje", // expectedReplacedSource:
        "Obje", // test name
        "<complete behind invalid array type>");
    }
 ...
 */
    public void test17() {
        ...
        "class D {				\n" + "	class Member {}		\n" + "						\n" + "	void test() {		\n" + "		int.			\n" + "		test();			\n" + "	}					\n", // completeBehind:
        "int.", // expectedCompletionNodeToString:
        "<CompleteOnClassLiteralAccess:int.>", // expectedUnitDisplayString:
 ...
 */
    public void test18() {
        this.runTestCheckMethodParse(// compilationUnit:
        "class E {					\n" + "	int bar() {				\n" + "		class Local {		\n" + "			int hello() {	\n", // completeBehind:
        "hello()", // expectedCompletionNodeToString:
        "<CompleteOnName:>", // expectedUnitDisplayString:
        "class E {\n" + "  E() {\n" + "  }\n" + "  int bar() {\n" + "    class Local {\n" + "      Local() {\n" + "      }\n" + "      int hello() {\n" + "      }\n" + "    }\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "", // expectedReplacedSource:
        "", // test name
 ...
 */
    public void test19() {
        this.runTestCheckMethodParse(// compilationUnit:
        "public class Test {					\n" + "	void foo() {						\n" + "		try {							\n" + "		} catch (Exception e) {			\n" + "		}								\n" + "		e								\n" + "	}									\n" + "}										\n", // completeBehind:
        "\n\t\te", // expectedCompletionNodeToString:
        "<CompleteOnName:e>", // expectedUnitDisplayString:
        "public class Test {\n" + "  public Test() {\n" + "  }\n" + "  void foo() {\n" + "    <CompleteOnName:e>;\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "e", // expectedReplacedSource:
        "e", // test name
        "<complete behind catch variable>");
    }
 ...
 */
    public void test22() {
        ...
        "	SomeOther", // expectedCompletionNodeToString:
        "<CompleteOnType:SomeOther>", // expectedUnitDisplayString:
        "public class SomeType {\n" + "  public SomeType(int i) {\n" + "  }\n" + "}\n" + "class SomeOtherType extends SomeType {\n" + "  <CompleteOnType:SomeOther>;\n" + "  int i;\n" + "  {\n" + "  }\n" + "  SomeOtherType() {\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "SomeOther", // expectedReplacedSource:
        "SomeOtherType", // test name
        "<complete on constructor type name>");
    }
 ...
 */
    public void test23() {
        this.runTestCheckMethodParse(// compilationUnit:
        "package p;\n" + "public class X {\n" + "  void foo(){)\n" + "    {\n" + "      Obj\n" + "    }\n" + "  }\n" + "}\n", // completeBehind:
        "Obj", // expectedCompletionNodeToString:
        "<CompleteOnName:Obj>", // expectedUnitDisplayString:
        "package p;\n" + "public class X {\n" + "  public X() {\n" + "  }\n" + "  void foo() {\n" + "    {\n" + "      <CompleteOnName:Obj>;\n" + "    }\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "Obj", // expectedReplacedSource:
        "Obj", // test name
 ...
 */
    public void test25() {
        this.runTestCheckMethodParse(// compilationUnit:
        "package p;\n" + "public class X {\n" + "  void foo(){\n" + "      this.12\n" + "  }\n" + "}\n", // completeBehind:
        "this.", // expectedCompletionNodeToString:
        "<CompleteOnMemberAccess:this.>", // expectedUnitDisplayString:
    ...
    public void test26() {
        ...
        "SWT.CAP_", // expectedCompletionNodeToString:
        "<CompleteOnName:SWT.CAP_>", // expectedUnitDisplayString:
        "import org.eclipse.swt.*;\n" + "import org.eclipse.swt.events.*;\n" + "import org.eclipse.swt.widgets.*;\n" + "public class Try {\n" + "  public Try() {\n" + "  }\n" + "  void main(Shell shell) {\n" + "    final Label label;\n" + "    new PaintListener() {\n" + "      public void paintControl(PaintEvent e) {\n" + "        e.gc.setLineCap(<CompleteOnName:SWT.CAP_>);\n" + "      }\n" + "    };\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "CAP_", // expectedReplacedSource:
        "SWT.CAP_", // test name
        "<complete after dot number>");
    }
}
