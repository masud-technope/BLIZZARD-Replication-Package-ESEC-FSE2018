...
class APTProblem extends CategorizedProblem {
    ...
    private final String[] _arguments;
     ...
     APTProblem(final String msg, final Severity severity, final IFile file, final int startingOffset, final int endingOffset, final int line, final String[] arguments, boolean isNonReconcile) {
        _message = msg;
        _severity = severity;
    ...
    public String toString() {
        //$NON-NLS-1$
        return _message == null ? "<null message>" : _message;
    }
