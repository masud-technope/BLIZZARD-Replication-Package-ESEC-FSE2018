...
public class JavadocAllocationExpression extends AllocationExpression {
    ...
    TypeBinding internalResolveType(Scope scope) {
        ...
        if (this.type == null) {
            ...
            this.resolvedType = this.type.resolveType((BlockScope) scope, /* check bounds*/
            true);
        }
        ...
        this.resolvedType = scope.environment().convertToRawType(this.type.resolvedType, /*force the conversion of enclosing types*/
        true);
        ...
        if (!this.binding.isValidBinding()) {
            ...
            if (// accept qualified member class constructor reference => see bug https://bugs.eclipse.org/bugs/show_bug.cgi?id=103304
            length > 1) {
                ReferenceBinding enclosingTypeBinding = allocationType;
