...
public final class Modifier extends ASTNode implements IExtendedModifier {
    ...
    public static class ModifierKeyword {
        ...
        //$NON-NLS-1$
        public static final ModifierKeyword ABSTRACT_KEYWORD = new ModifierKeyword("abstract", ABSTRACT);

        /** "final" modifier with flag value {@link Modifier#FINAL}. */
        //$NON-NLS-1$
        public static final ModifierKeyword FINAL_KEYWORD = new ModifierKeyword("final", FINAL);
        ...
        //$NON-NLS-1$
        public static final ModifierKeyword PRIVATE_KEYWORD = new ModifierKeyword("private", PRIVATE);

        /** "protected" modifier with flag value {@link Modifier#PROTECTED}. */
        //$NON-NLS-1$
        public static final ModifierKeyword PROTECTED_KEYWORD = new ModifierKeyword("protected", PROTECTED);

        /** "public" modifier with flag value {@link Modifier#PUBLIC}. */
        //$NON-NLS-1$
        public static final ModifierKeyword PUBLIC_KEYWORD = new ModifierKeyword("public", PUBLIC);

        /** "static" modifier with flag value {@link Modifier#STATIC}. */
        //$NON-NLS-1$
        public static final ModifierKeyword STATIC_KEYWORD = new ModifierKeyword("static", STATIC);

        /** "strictfp" modifier with flag value {@link Modifier#STRICTFP}. */
        //$NON-NLS-1$
        public static final ModifierKeyword STRICTFP_KEYWORD = new ModifierKeyword("strictfp", STRICTFP);

        /** "synchronized" modifier with flag value {@link Modifier#SYNCHRONIZED}. */
        //$NON-NLS-1$
        public static final ModifierKeyword SYNCHRONIZED_KEYWORD = new ModifierKeyword("synchronized", SYNCHRONIZED);

        /** "transient" modifier with flag value {@link Modifier#TRANSIENT}. */
        //$NON-NLS-1$
        public static final ModifierKeyword TRANSIENT_KEYWORD = new ModifierKeyword("transient", TRANSIENT);
		 ...
		 */
        //$NON-NLS-1$
        public static final ModifierKeyword DEFAULT_KEYWORD = new ModifierKeyword("default", DEFAULT);

        static {
            KEYWORDS = new HashMap(20);
            ModifierKeyword[] ops = { PUBLIC_KEYWORD, PROTECTED_KEYWORD, PRIVATE_KEYWORD, STATIC_KEYWORD, ABSTRACT_KEYWORD, FINAL_KEYWORD, NATIVE_KEYWORD, SYNCHRONIZED_KEYWORD, TRANSIENT_KEYWORD, VOLATILE_KEYWORD, STRICTFP_KEYWORD, DEFAULT_KEYWORD };
	 ...
	 * @since 3.0
	 */
    public static final SimplePropertyDescriptor KEYWORD_PROPERTY = //$NON-NLS-1$
    new SimplePropertyDescriptor(Modifier.class, "keyword", Modifier.ModifierKeyword.class, MANDATORY);
