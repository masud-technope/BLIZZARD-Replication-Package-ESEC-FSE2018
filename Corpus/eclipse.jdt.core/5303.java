 ...
 */
    public void testExternalJarInternalExternalJar() throws CoreException, IOException {
        ...
        try {
            ...
            // ensure that project is opened, as external jar delta is optimized for this case (if the project is not opened, there is no need for broadcasting an external jar delta)
            project.open(null);
