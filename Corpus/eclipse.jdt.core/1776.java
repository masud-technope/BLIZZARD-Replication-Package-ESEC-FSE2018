...
public class ElementUtilsProc extends BaseProcessor {
    ...
    private boolean examineGetConstantExpression() {
        for (VariableElement field : ElementFilter.fieldsIn(_elementConstants.getEnclosedElements())) {
            ...
            if (constantValue instanceof String) {
                ...
                if (constantExpression == null || constantExpression.charAt(0) != '\"' || constantExpression.charAt(constantExpression.length() - 1) != '\"') {
    ...
    private boolean examineOverrides() {
        ...
        if (null == methodAF || null == methodAG || null == methodAH || null == methodAJ || null == methodBF || null == methodBG || null == methodBH || null == methodCH || null == methodDF || null == methodDG || null == methodDJ || null == methodXF) {
