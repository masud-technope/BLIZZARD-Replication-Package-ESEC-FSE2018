...
public class ASTConverterAST8Test extends ConverterTestSetup {
    ...
    public void test0305() {
        ...
        //$NON-NLS-1$
        ASTNode result = runConversion(AST.JLS8, source, "Test.java", project, true);
        //$NON-NLS-1$
        assertNotNull("No compilation unit", result);
        //$NON-NLS-1$
        assertTrue("result is not a compilation unit", result instanceof CompilationUnit);
    ...
    public void test0306() {
        ...
        IJavaProject project = getJavaProject("Converter");
        //$NON-NLS-1$
        ASTNode result = runConversion(AST.JLS8, source, "Object.java", project, true);
        //$NON-NLS-1$
        assertNotNull("No compilation unit", result);
        //$NON-NLS-1$
        assertTrue("result is not a compilation unit", result instanceof CompilationUnit);
    ...
    public void test0401() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter18", "src", "testBug496596", "Test.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        ...
        Statement statement = (Statement) statements.get(0);
        //$NON-NLS-1$
        assertTrue("Not a return", statement.getNodeType() == ASTNode.RETURN_STATEMENT);
