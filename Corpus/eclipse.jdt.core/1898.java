...
public class TypeAnnotationSyntaxTest extends AbstractSyntaxTreeTest {
    ...
    public void test0003() throws IOException {
        String source = "@Marker class A implements Comparable, " + "                   @Marker Serializable," + "                   Cloneable {\n" + "}\n";
    ...
    public void test0004() throws IOException {
        String source = "@Marker class A implements Comparable, " + "                   @Marker @SingleMember(0) Serializable," + "                   Cloneable {\n" + "}\n";
    ...
    public void test0005() throws IOException {
        String source = "@Marker class A implements Comparable, " + "                   @Marker @SingleMember(0) @Normal(Value=0) Serializable," + "                   Cloneable {\n" + "}\n";
    ...
    public void test0006() throws IOException {
        String source = "@Marker class A implements @Marker Comparable, " + "                   @Marker @SingleMember(0) @Normal(Value=0) Serializable," + "                   @Marker Cloneable {\n" + "}\n";
    ...
    public void test007() throws IOException {
        String source = "@Marker class A extends Object implements Comparable, " + "                   @Marker @SingleMember(10) @Normal(Value=0) Serializable," + "                   Cloneable {\n" + "}\n";
    ...
    public void test0008() throws IOException {
        String source = "@Marker class A extends @Marker Object implements Comparable, " + "                   @Marker @SingleMember(0) @Normal(Value=0) Serializable," + "                   Cloneable {\n" + "}\n";
    ...
    public void test0009() throws IOException {
        String source = "@Marker class A extends @Marker @SingleMember(0) Object implements Comparable, " + "                   @Marker @SingleMember(0) @Normal(Value=0) Serializable," + "                   Cloneable {\n" + "}\n";
    ...
    public void test0010() throws IOException {
        String source = "@Marker class A extends @Marker @SingleMember(0) @Normal(Value=0) Object implements Comparable, " + "                   @Marker @SingleMember(0) @Normal(Value=0) Serializable," + "                   Cloneable {\n" + "}\n";
    ...
    public void test0090() throws IOException {
        String source = "class X <@Marker T extends @Readonly String> {\n" + "    T foo(T t) {\n" + "        return t;\n" + "    }\n" + "    public static void main(String[] args) {\n" + // Parser.classInstanceCreation called
    ...
    public void test0125() throws IOException {
        String source = "public class X extends @A(\"Hello, World!\") Y<@B @C('(') String[] @D[]> {}";
        String expectedUnitToString = "public class X extends @A(\"Hello, World!\") Y<@B @C(\'(\') String[] @D []> {\n" + "  public X() {\n" + "    super();\n" + "  }\n" + "}\n";
