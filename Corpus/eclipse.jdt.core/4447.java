    ...
    protected int matchLevelForTokens(char[][] tokens) {
        ...
        switch(this.matchMode) {
            ...
            case SearchPattern.R_PATTERN_MATCH:
                char[] patternName = this.pattern.pkgName[this.pattern.pkgName.length - 1] == '*' ? this.pattern.pkgName : //$NON-NLS-1$
                CharOperation.concat(//$NON-NLS-1$
                this.pattern.pkgName, //$NON-NLS-1$
                ".*".toCharArray());
