 ...
 */
    public void testAnnotations26() throws JavaModelException {
        ...
        String expected = "@test342757.Annot\n" + "@java.lang.Deprecated\n" + "@test342757.Annot\n" + "@java.lang.Deprecated\n";
 ...
 */
    ...
    public void testGetChildrenForCategory02() throws CoreException, IOException {
        ...
        assertElementsEqual("Unexpected children", "foo3() [in X [in X.class [in p [in lib2.jar [in P]]]]]", others);
 ...
 */
    public void testDefaultValue1() throws JavaModelException {
        ...
        assertMemberValuePairEquals("_int=(int)0", method.getDefaultValue());
    }
 ...
 */
    public void testDefaultValue2() throws JavaModelException {
        ...
        assertMemberValuePairEquals("_annot=@annotated.MyOtherAnnot", method.getDefaultValue());
    }
 ...
 */
    public void testDefaultValue3() throws JavaModelException {
        ...
        assertMemberValuePairEquals("_array=[unknown]{}", method.getDefaultValue());
    }
 ...
 */
    public void testGetResource() throws Exception {
        try {
            ...
            assertResourceEquals("Unexpected resource", "<null>", classFile1.getResource());
        } finally {
 ...
 */
    public void testGetSuperclassTypeSignature() throws JavaModelException {
        ...
        assertEquals("Unexpected signature", "Lgeneric.X<Ljava.lang.Thread;>;", type.getSuperclassTypeSignature());
    }
 ...
 */
    public void testParameterTypeSignatures2() throws JavaModelException {
        ...
        assertStringsEqual("Unexpected type parameters", "", type.getTypeParameterSignatures());
    }
 ...
 */
    public void testReturnType1() throws JavaModelException {
        IType type = this.jarRoot.getPackageFragment("generic").getClassFile("X.class").getType();
        IMethod method = type.getMethod("foo", new String[] { "TK;", "TV;" });
        assertEquals("Unexpected return type", "TV;", method.getReturnType());
    }
 ...
 */
    public void testReturnType2() throws JavaModelException {
        IType type = this.jarRoot.getPackageFragment("generic").getClassFile("X.class").getType();
        IMethod method = type.getMethod("foo", new String[] { "Lgeneric.X<TT;>;" });
        assertEquals("Unexpected return type", "Lgeneric.X<TT;>;", method.getReturnType());
    }
 ...
 */
    public void testSourceRange1() throws CoreException {
        // was testSourceRangeNonJavaProject()
        try {
 ...
 */
    public void testSourceRange2() throws CoreException {
        // was testSourceRangeNotOnClasspath()
        try {
 ...
 */
    public void testWorkingCopy01() throws CoreException {
        ...
        this.workingCopy = clazz.getWorkingCopy(null, /*primary owner*/
 ...
 */
    public void testWorkingCopy02() throws CoreException {
        ...
        try {
            ...
            this.workingCopy = clazz.getWorkingCopy(/*primary owner*/
 ...
 */
    public void testWorkingCopy03() throws CoreException {
        ...
        this.workingCopy.reconcile(ICompilationUnit.NO_AST, false, /*don't force problems*/
        null, /*primary owner*/
        null);
 ...
 */
    public void testWorkingCopy04() throws CoreException {
        ...
        JavaModelException exception = null;
        try {
            this.workingCopy.commitWorkingCopy(/*don't force*/
            false, null);
        } catch (JavaModelException e) {
            exception = e;
        }
        assertEquals("Unxepected JavaModelException", "Java Model Exception: Java Model Status [Operation not supported for specified element type(s):[Working copy] X.class [in workingcopy [in lib.jar [in P]]]]", exception.toString());
    }
 ...
 */
    public void testWorkingCopy08() throws CoreException {
        ...
        try {
            copy = cu.getWorkingCopy(owner, /*no progress*/
            null);
            ...
            copy.reconcile(ICompilationUnit.NO_AST, /*don't force problems*/
            false, owner, /*no progress*/
            null);
 ...
 */
    public void testWorkingCopy09() throws CoreException {
        ...
        ICompilationUnit copy = null;
        try {
            copy = cu.getWorkingCopy(/*problemRequestor, */
            owner, /*no prpgress*/
            null);
            copy.getBuffer().setContents("public class Y {\n" + "  workingcopy.X x;\n" + "}");
            problemRequestor.problems = new StringBuffer();
 ...
 */
    public void testWorkingCopy11() throws CoreException {
        ...
        assertSearchResults("lib.jar workingcopy.Y", requestor);
    }
 ...
 */
    public void testGenericFieldGetTypeSignature() throws JavaModelException {
        ...
        assertEquals("Wrong type signature", "Ljava.util.Collection<Ljava.lang.String;>;", field.getTypeSignature());
    }
    ...
    public void testBug316937() throws Exception {
        try {
            IJavaProject project = getJavaProject("P");
            String[] pathAndContents = new String[] { "bug316937/Foo.java", "package bug316937;\n" + "public class Foo {\n" + "	class Bar {\n" + "		public Bar(int a, int b) {}\n" + "	}\n" + "}\n" };
            addLibrary(project, "lib316937.jar", "src316937.zip", pathAndContents, JavaCore.VERSION_1_5);
            IPackageFragmentRoot packageFragRoot = project.getPackageFragmentRoot(getFile("/P/lib316937.jar"));
            IType type = packageFragRoot.getPackageFragment("bug316937").getClassFile("Foo.class").getType();
            ...
            packageFragRoot = project.getPackageFragmentRoot(getFile("/P/lib316937.jar"));
            type = packageFragRoot.getPackageFragment("bug316937").getClassFile("Foo.class").getType();
