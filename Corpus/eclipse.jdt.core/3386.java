 ...
 */
    ...
    public void test004() throws JavaModelException {
        ...
        assertResults("docRoot[JAVADOC_INLINE_TAG]{{@docRoot}, null, null, docRoot, null, " + this.positions + JAVADOC_RELEVANCE + "}");
    }
 ...
 */
    ...
    public void test026() throws JavaModelException {
        ...
        assertSortedResults("java.lang[PACKAGE_REF]{java.lang, java.lang, null, null, null, " + this.positions + R_DRICQNR + "}");
    }
 ...
 */
    public void test030() throws JavaModelException {
        ...
        assertSortedResults("foo[JAVADOC_FIELD_REF]{{@link #foo}, Ljavadoc.text.BasicTestTextIns;, I, foo, null, " + this.positions + R_DRICNRNSIT + "}");
    }
    ...
    public void test031() throws JavaModelException {
        ...
        assertSortedResults("foo[JAVADOC_FIELD_REF]{{@link BasicTestTextIns#foo}, Ljavadoc.text.BasicTestTextIns;, I, foo, null, " + this.positions + R_DRICNRIT + "}\n" + "foo[JAVADOC_VALUE_REF]{{@value BasicTestTextIns#foo}, Ljavadoc.text.BasicTestTextIns;, I, foo, null, " + this.positions + R_DRICNRIT + "}");
    }
    ...
    public void test032() throws JavaModelException {
        ...
        assertSortedResults("foo[JAVADOC_FIELD_REF]{{@link javadoc.text.BasicTestTextIns#foo}, Ljavadoc.text.BasicTestTextIns;, I, foo, null, " + this.positions + R_DRICNRNSIT + "}");
    }

    public void test033() throws JavaModelException {
        String[] sources = { "/Completion/src/javadoc/text/BasicTestTextIns.java", "package javadoc.text;\n" + "public class BasicTestTextIns {\n" + "	/**\n" + "	 * Completion after: OtherFields#fo\n" + "	 */\n" + "	int foo;\n" + "}", "/Completion/src/javadoc/text/OtherFields.java", "package javadoc.text;\n" + "public class OtherFields {\n" + "	static int foo;\n" + "}" };
        completeInJavadoc(sources, true, "OtherFields#fo");
        assertSortedResults("foo[JAVADOC_FIELD_REF]{{@link OtherFields#foo}, Ljavadoc.text.OtherFields;, I, foo, null, " + this.positions + R_DRICNRIT + "}\n" + "foo[JAVADOC_VALUE_REF]{{@value OtherFields#foo}, Ljavadoc.text.OtherFields;, I, foo, null, " + this.positions + R_DRICNRIT + "}");
    }

    public void test034() throws JavaModelException {
        String source = "package javadoc.text;\n" + "public class BasicTestTextIns {\n" + "	/**\n" + "	 * Completion after: {@value #fo\n" + "	 *		Note: this test must be run with 1.4 compliance\n" + "	 */\n" + "	int foo;\n" + "}";
        completeInJavadoc("/Completion/src/javadoc/text/BasicTestTextIns.java", source, true, "fo");
        assertSortedResults("foo[FIELD_REF]{foo, Ljavadoc.text.BasicTestTextIns;, I, foo, null, " + this.positions + R_DRICNRNS + "}");
    }
    ...
    public void test036() throws JavaModelException {
        ...
        completeInJavadoc("/Completion/src/javadoc/text/BasicTestTextIns.java", source, true, "fo");
        assertSortedResults("foo[FIELD_REF]{foo, Ljavadoc.text.BasicTestTextIns;, I, foo, null, " + this.positions + R_DRICNR + "}");
    }
    ...
    public void test038() throws JavaModelException {
        ...
        assertSortedResults("foo[FIELD_REF]{foo, Ljavadoc.text.OtherFields;, I, foo, null, " + this.positions + R_DRICNR + "}");
    }
 ...
 */
    ...
    public void test041() throws JavaModelException {
        String source = "package javadoc.text;\n" + "public class BasicTestTextIns {\n" + "	/**\n" + "	 * Completion after: #meth\n" + "	 */\n" + "	void method() {}\n" + "	void paramMethod(String str, boolean flag, Object obj) {}\n" + "}\n";
        completeInJavadoc("/Completion/src/javadoc/text/BasicTestTextIns.java", source, true, "#meth");
        assertSortedResults("method[JAVADOC_METHOD_REF]{{@link #method()}, Ljavadoc.text.BasicTestTextIns;, ()V, method, null, " + this.positions + R_DRICNRNSIT + "}");
    }
    ...
    public void test044() throws JavaModelException {
        ...
        assertSortedResults("paramMethod[JAVADOC_METHOD_REF]{{@link BasicTestTextIns#paramMethod(String, boolean, Object)}, Ljavadoc.text.BasicTestTextIns;, (Ljava.lang.String;ZLjava.lang.Object;)V, paramMethod, (str, flag, obj), " + this.positions + R_DRICNRNSIT + "}");
    }
    ...
    public void test045() throws JavaModelException {
        ...
        assertSortedResults("method[JAVADOC_METHOD_REF]{{@link javadoc.text.BasicTestTextIns#method()}, Ljavadoc.text.BasicTestTextIns;, ()V, method, null, " + this.positions + R_DRICNRNSIT + "}");
    }
    ...
    public void test046() throws JavaModelException {
        ...
        assertSortedResults("paramMethod[METHOD_REF]{paramMethod(String, boolean, Object), Ljavadoc.text.BasicTestTextIns;, (Ljava.lang.String;ZLjava.lang.Object;)V, paramMethod, (str, flag, obj), " + this.positions + R_DRICNRNS + "}");
    }

    public void test047() throws JavaModelException {
        String source = "package javadoc.text;\n" + "public class BasicTestTextIns {\n" + "	/**\n" + "	 * Completion after: {@link BasicTestTextIns#meth\n" + "	 */\n" + "	void method() {}\n" + "	void paramMethod(String str, boolean flag, Object obj) {}\n" + "}\n";
        completeInJavadoc("/Completion/src/javadoc/text/BasicTestTextIns.java", source, true, "meth");
        assertSortedResults("method[METHOD_REF]{method(), Ljavadoc.text.BasicTestTextIns;, ()V, method, null, " + this.positions + R_DRICNRNS + "}");
    }
    ...
    public void test055() throws JavaModelException {
        ...
        assertSortedResults("paramMethod[JAVADOC_METHOD_REF]{{@link #paramMethod(String, boolean, Object)}, Ljavadoc.text.BasicTestTextIns;, (Ljava.lang.String;ZLjava.lang.Object;)V, paramMethod, (str, flag, obj), " + this.positions + R_DRICENUNRIT + "}");
    }
    ...
    public void test056() throws JavaModelException {
        ...
        assertSortedResults("String[TYPE_REF]{String, java.lang, Ljava.lang.String;, null, null, " + this.positions + R_DRICUNR + "}");
    }
    ...
    public void test057() throws JavaModelException {
        ...
        assertSortedResults("paramMethod[METHOD_REF]{paramMethod(String, boolean, Object), Ljavadoc.text.BasicTestTextIns;, (Ljava.lang.String;ZLjava.lang.Object;)V, paramMethod, (str, flag, obj), " + this.positions + R_DRICENUNR + "}");
    }
 ...
 */
    public void test070() throws JavaModelException {
        ...
        assertSortedResults("BasicTestTextIns[JAVADOC_METHOD_REF]{{@link #BasicTestTextIns(int, float, Class)}, Ljavadoc.text.BasicTestTextIns;, (IFLjava.lang.Class;)V, BasicTestTextIns, (xxx, real, clazz), " + this.positions + R_DRINRIT + "}\n" + "BasicTestTextIns[JAVADOC_METHOD_REF]{{@link #BasicTestTextIns()}, Ljavadoc.text.BasicTestTextIns;, ()V, BasicTestTextIns, null, " + this.positions + R_DRINRIT + "}");
    }

    public void test071() throws JavaModelException {
        String source = "package javadoc.text;\n" + "public class BasicTestTextIns {\n" + "	/**\n" + "	 * Completion after: {@link BasicTestTextIns#BasicTest\n" + "	 */\n" + "	BasicTestTextIns() {}\n" + "	BasicTestTextIns(int xxx, float real, Class clazz) {}\n" + "}\n";
        // 3rd occurence
        completeInJavadoc("/Completion/src/javadoc/text/BasicTestTextIns.java", source, true, "BasicTest", 3);
        assertSortedResults("BasicTestTextIns[METHOD_REF<CONSTRUCTOR>]{BasicTestTextIns(int, float, Class), Ljavadoc.text.BasicTestTextIns;, (IFLjava.lang.Class;)V, BasicTestTextIns, (xxx, real, clazz), " + this.positions + R_DRINR + "}\n" + "BasicTestTextIns[METHOD_REF<CONSTRUCTOR>]{BasicTestTextIns(), Ljavadoc.text.BasicTestTextIns;, ()V, BasicTestTextIns, null, " + this.positions + R_DRINR + "}");
    }
    ...
    public void test073() throws JavaModelException {
        ...
        assertSortedResults("OtherTypes[JAVADOC_METHOD_REF]{{@link OtherTypes#OtherTypes()}, Ljavadoc.text.OtherTypes;, ()V, OtherTypes, null, " + this.positions + R_DRINRIT + "}");
    }
    ...
    public void test074() throws JavaModelException {
        ...
        assertSortedResults("OtherTypes[METHOD_REF<CONSTRUCTOR>]{OtherTypes(), Ljavadoc.text.OtherTypes;, ()V, OtherTypes, null, " + this.positions + R_DRINR + "}");
    }
    ...
    public void test079() throws JavaModelException {
        ...
        assertSortedResults("BasicTestTextIns[JAVADOC_METHOD_REF]{{@link BasicTestTextIns#BasicTestTextIns(int, float, Class)}, Ljavadoc.text.BasicTestTextIns;, (IFLjava.lang.Class;)V, BasicTestTextIns, (xxx, real, clazz), " + this.positions + R_DRINRIT + "}");
    }
    ...
    public void test081() throws JavaModelException {
        ...
        assertSortedResults("BasicTestTextIns[JAVADOC_METHOD_REF]{{@link javadoc.text.BasicTestTextIns#BasicTestTextIns()}, Ljavadoc.text.BasicTestTextIns;, ()V, BasicTestTextIns, null, " + this.positions + R_DRINRIT + "}");
    }
    ...
    public void test086() throws JavaModelException {
        ...
        completeInJavadoc("/Completion/src/javadoc/text/BasicTestTextIns.java", source, true, "#meth");
        assertSortedResults("method1[JAVADOC_METHOD_REF]{{@link #method1()}, Ljavadoc.text.BasicTestSecondaryClass;, ()V, method1, null, " + this.positions + R_DRICNRNSIT + "}\n" + "method2[JAVADOC_METHOD_REF]{{@link #method2()}, Ljavadoc.text.BasicTestSecondaryInterface;, ()V, method2, null, " + this.positions + R_DRICNRNSIT + "}");
    }
}
