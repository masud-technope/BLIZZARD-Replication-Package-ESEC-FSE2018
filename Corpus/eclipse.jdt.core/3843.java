...
public class ASTModelBridgeTests extends AbstractASTTests {
    ...
    private void assertFindElement(String key, String expectedElement) throws JavaModelException {
        ...
        assertElementEquals("Unexpected found element", expectedElement, element);
    }
    ...
    private void setUpJavaProject() throws CoreException, IOException, JavaModelException {
        ...
        addLibrary(project, "lib.jar", "libsrc.zip", new String[] { "p/Y.java", "package p;\n" + "public class Y<T> {\n" + "  public Y(T t) {\n" + "  }\n" + "}", "p/Z.java", "package p;\n" + "public class Z {\n" + "  /*start*/class Member {\n" + "  }/*end*/\n" + "  void foo() {\n" + "    new Member() {};\n" + "  }\n" + "}", "p/W.java", "package p;\n" + "public class W {\n" + "  class Member {\n" + "    /*start*/Member(String s) {\n" + "    }/*end*/\n" + "  }\n" + "}", "p/ABC.java", "package p;\n" + "public class ABC {\n" + "}", "Z.java", "public class Z {\n" + "  /*start*/class Member {\n" + "  }/*end*/\n" + "  void foo() {\n" + "    new Member() {};\n" + "  }\n" + "}", "p/Q.java", "package p;\n" + "/*start*/@MyAnnot/*end*/\n" + "public class Q {\n" + "}\n" + "@interface MyAnnot {\n" + "}" }, "1.5");
        setUpWorkingCopy();
    }
    ...
    private void setUpWorkingCopy() throws JavaModelException {
        ...
        this.workingCopy = getCompilationUnit("/P/src/X.java").getWorkingCopy(newWorkingCopyOwner(problemRequestor), /*no progress*/
        null);
    }
    ...
    public void testAnnotation1() throws JavaModelException {
        ...
        assertElementExists("Unexpected Java element", "@MyAnnot [in foo() [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]]", element);
    }
    ...
    public void testAnnotation2() throws JavaModelException {
        ...
        IBinding binding = ((Annotation) node).resolveAnnotationBinding();
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "@MyAnnot [in field [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]]", element);
    }
    ...
    public void testAnnotation3() throws JavaModelException {
        ASTNode node = buildAST("/*start*/@MyAnnot/*end*/\n" + "public class X {\n" + "}\n" + "@interface MyAnnot {\n" + "}");
        IBinding binding = ((Annotation) node).resolveAnnotationBinding();
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "@MyAnnot [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]", element);
    }
    ...
    public void testAnnotation4() throws JavaModelException {
        ...
        try {
            ...
            myAnnot.getBuffer().setContents("package pkg;\n" + "public @interface MyAnnot {\n" + "}");
            ...
            IBinding binding = ((Annotation) node).resolveAnnotationBinding();
            IJavaElement element = binding.getJavaElement();
            assertElementExists("Unexpected Java element", "@MyAnnot [in package pkg [in [Working copy] package-info.java [in pkg [in src [in P]]]]]", element);
        } finally {
            if (myAnnot != null)
    ...
    public void testAnnotation5() throws JavaModelException {
        ...
        IBinding binding = ((Annotation) node).resolveAnnotationBinding();
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "@MyAnnot [in var1 [in foo() [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]]]", element);
    }
    ...
    public void testAnnotation14() throws JavaModelException {
        ...
        IBinding binding = ((Annotation) node).resolveAnnotationBinding();
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "@MyAnnot [in foo [in bar() [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]]]", element);
    }
    ...
    public void testAnnotation15() throws Exception {
        ...
        assertBindingsEqual("Llib/Foo;.bug1<T:Ljava/lang/Object;>(TT;)V%<Ljava/lang/String;>", bindings);
        IMethodBinding method = (IMethodBinding) bindings[0];
        assertBindingsEqual("@Llib/NonNull;", method.getParameterAnnotations(0));
    }
    ...
    public void testAnonymousType() throws JavaModelException {
        ...
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "<anonymous #1> [in foo() [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]]", element);
    }
    ...
    public void testArrayType1() throws JavaModelException {
        ...
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "Object [in Object.class [in java.lang [in " + getExternalJCLPathString("1.5") + "]]]", element);
    }
    ...
    public void testArrayType2() throws JavaModelException {
        ...
        IBinding binding = ((ArrayType) node).resolveBinding();
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "<null>", element);
    }
    ...
    public void testBinaryMethod() throws JavaModelException {
        ...
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "Enum(java.lang.String, int) [in Enum [in Enum.class [in java.lang [in " + getExternalJCLPathString("1.5") + "]]]]", element);
    }
    ...
    public void testBinaryMemberTypeConstructor() throws JavaModelException {
        ...
        IBinding binding = ((MethodDeclaration) node).resolveBinding();
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "Member(p.W, java.lang.String) [in Member [in W$Member.class [in p [in lib.jar [in P]]]]]", element);
    }
    ...
    public void testBinaryType() throws JavaModelException {
        ...
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "String [in String.class [in java.lang [in " + getExternalJCLPathString("1.5") + "]]]", element);
    }
    ...
    public void testBinaryType2() throws CoreException {
        ...
        IBinding binding = ((TypeDeclaration) node).resolveBinding();
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "ABC [in ABC.class [in p [in lib.jar [in P]]]]", element);
    }
    ...
    public void testBinaryMemberTypeFromAnonymousClassFile1() throws JavaModelException {
        ...
        IBinding binding = ((TypeDeclaration) node).resolveBinding();
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "Member [in Z$Member.class [in p [in lib.jar [in P]]]]", element);
    }
    ...
    public void testBinaryMemberTypeFromAnonymousClassFile2() throws JavaModelException {
        ...
        IBinding binding = ((TypeDeclaration) node).resolveBinding();
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "Member [in Z$Member.class [in <default> [in lib.jar [in P]]]]", element);
    }
    ...
    public void testCreateBindings01() throws JavaModelException {
        ...
        IJavaElement[] elements = new IJavaElement[] { typeX, getClassFile("P", getExternalJCLPathString("1.5"), "java.lang", "Object.class").getType(), typeX.getMethod("foo", new String[] { "I", "QString;" }), this.workingCopies[2].getType("I").getField("BAR"), this.workingCopies[1].getType("Y").getMethod("bar", new String[0]).getType("", 1) };
    ...
    public void testCreateBindings23() throws JavaModelException {
        ...
        IJavaElement[] elements = new IJavaElement[] { this.workingCopies[0].getType("IScriptRunnable"), this.workingCopies[1].getType("Environment"), this.workingCopies[2].getType("X").getMethod("test", new String[0]).getType("", 1) };
        IBinding[] bindings = parser.createBindings(elements, null);
    ...
    public void testCreateBindings02() throws JavaModelException {
        IBinding[] bindings = createBindings("public class X {\n" + "}", this.workingCopy.getType("X"));
        assertBindingsEqual("LX;", bindings);
    }
    ...
    public void testCreateBindings03() throws JavaModelException {
        ...
        assertBindingsEqual("LX$Member;", bindings);
    }
    ...
    public void testCreateBindings04() throws JavaModelException {
        ...
        assertBindingsEqual("LX$40;", bindings);
    }
    ...
    public void testCreateBindings05() throws JavaModelException {
        ...
        assertBindingsEqual("LX$42$Y;", bindings);
    }
    ...
    public void testCreateBindings06() throws JavaModelException {
        ...
        assertBindingsEqual("LX;.field)I", bindings);
    }
    ...
    public void testCreateBindings07() throws JavaModelException {
        ...
        assertBindingsEqual("LX;.foo()V", bindings);
    }
    ...
    public void testCreateBindings08() throws JavaModelException {
        IBinding[] bindings = createBindings("@interface X {\n" + "}", this.workingCopy.getType("X"));
        assertBindingsEqual("LX;", bindings);
    }
    ...
    public void testCreateBindings09() throws JavaModelException {
        IBinding[] bindings = createBindings("public enum X {\n" + "}", this.workingCopy.getType("X"));
        assertBindingsEqual("LX;", bindings);
    }
    ...
    public void testCreateBindings10() throws JavaModelException {
        IBinding[] bindings = createBindings("@interface X {\n" + "  int foo();\n" + "}", this.workingCopy.getType("X").getMethod("foo", new String[0]));
        assertBindingsEqual("LX;.foo()I", bindings);
    }
    ...
    public void testCreateBindings11() throws JavaModelException {
        ...
        assertBindingsEqual("LX;.FOO)LX;", bindings);
    }
    ...
    public void testCreateBindings12() throws JavaModelException {
        IBinding[] bindings = createBindings("import java.io.*;\n" + "public class X implements Serializable {\n" + "  static final long serialVersionUID = 0;\n" + "}", this.workingCopy.getImport("java.io.*"));
        assertBindingsEqual("java/io", bindings);
    }
    ...
    public void testCreateBindings13() throws JavaModelException {
        IBinding[] bindings = createBindings("import java.io.Serializable;\n" + "public class X implements Serializable {\n" + "  static final long serialVersionUID = 0;\n" + "}", this.workingCopy.getImport("java.io.Serializable"));
        assertBindingsEqual("Ljava/io/Serializable;", bindings);
    }
    ...
    public void testCreateBindings14() throws JavaModelException {
        IBinding[] bindings = createBindings("public class X<T> {\n" + "}", this.workingCopy.getType("X").getTypeParameter("T"));
        assertBindingsEqual("LX;:TT;", bindings);
    }
    ...
    public void testCreateBindings14a() throws JavaModelException {
        IBinding[] bindings = createBindings("public class X<T extends java.lang.Number> {\n" + "}", this.workingCopy.getType("X").getTypeParameter("T"));
        assertBindingsEqual("LX;:TT;", bindings);
    }
    ...
    public void testCreateBindings14b() throws JavaModelException {
        IBinding[] bindings = createBindings("public class X<T extends java.util.List<String>> {\n" + "}", this.workingCopy.getType("X").getTypeParameter("T"));
        assertBindingsEqual("LX;:TT;", bindings);
    }
    ...
    public void testCreateBindings15() throws CoreException {
        IBinding[] bindings = createBinaryBindings("public class A {\n" + "}", getClassFile("/P/lib/A.class").getType());
        assertBindingsEqual("LA;", bindings);
    }
    ...
    public void testCreateBindings16() throws CoreException {
        ...
        assertBindingsEqual("LA;.field)I", bindings);
    }
    ...
    public void testCreateBindings17() throws CoreException {
        ...
        assertBindingsEqual("LA;.foo(Ljava/lang/String;Z)I", bindings);
    }
    ...
    public void testCreateBindings18() throws CoreException {
        ...
        assertBindingsEqual("LA;.foo<E:Ljava/lang/Object;>(TE;)V", bindings);
    }
    ...
    public void testCreateBindings19() throws CoreException {
        ...
        assertBindingsEqual("LA;.foo(Ljava/lang/String;)Ljava/lang/String;", bindings);
    }
    ...
    public void testCreateBindings20() throws CoreException {
        ...
        IBinding[] bindings = createBinaryBindings("public class A {\n" + "  static int LINE = 0;\n" + "}", field);
        assertBindingsEqual("LA;.LINE)I", bindings);
    }
    ...
    public void testCreateBindings21() throws CoreException {
        ...
        IBinding[] bindings = createBinaryBindings("public class A {\n" + "  static int THREE = 0;\n" + "}", field);
        assertBindingsEqual("LA;.THREE)I", bindings);
    }
    ...
    public void testCreateBindings22() throws JavaModelException {
        IBinding[] bindings = createBindings("@MyAnnot\n" + "public class X {\n" + "}\n" + "@interface MyAnnot {\n" + "}", this.workingCopy.getType("X").getAnnotation("MyAnnot"));
        assertBindingsEqual("LX;@LX~MyAnnot;", bindings);
    }
    ...
    public void testCreateBindings24() throws CoreException {
        createClassFile("/P/lib", "pack/package-info.class", "@Deprecated\n" + "package pack;");
        ...
        IBinding[] bindings = parser.createBindings(elements, null);
        assertBindingsEqual("Lpack/package-info;", bindings);
        IAnnotationBinding[] annotations = ((ITypeBinding) bindings[0]).getAnnotations();
        assertBindingsEqual("@Ljava/lang/Deprecated;", annotations);
    }
    ...
    public void testCreateBindings25() throws JavaModelException {
        ...
        assertBindingsEqual(// occurrence 0, rank 0
        "LX;.foo(Ljava/lang/String;I)V#str#0#0\n" + // occurrence 0, rank 1
        "LX;.foo(Ljava/lang/String;I)V#i#0#1", bindings);
    }
    ...
    public void testCreateBindings26() throws CoreException {
        createClassFile("/P/lib", "A.class", "public class A {\n" + "  void foo(String str, int i) {}\n" + "}");
        ...
        "LA;.foo(Ljava/lang/String;I)V#i#0#1", bindings);
    }
    ...
    public void testCreateBinding27() throws Exception {
        createClassFile("/P/lib", "p/A.class", "package p;\n" + "public class A {\n" + "  public static <T> T foo(T[] arg) { return arg[0]; }\n" + "}");
        this.workingCopies = new ICompilationUnit[1];
        String xSource = "public class X {\n" + "  public String test(String[] args) {\n" + "    return p.A.foo(args);\n" + "  }\n" + "}";
        this.workingCopies[0] = getWorkingCopy("/P/src/X.java", xSource, this.wcOwner);
        ...
        assertBindingsEqual("Lp/A;.foo<T:Ljava/lang/Object;>([TT;)TT;%<Ljava/lang/String;>", bindings);
        IMethodBinding method = (IMethodBinding) bindings[0];
        assertBindingsEqual("[Ljava/lang/String;", method.getParameterTypes());
        assertBindingsEqual("Ljava/lang/String;", new IBinding[] { method.getReturnType() });
    }
    ...
    public void testCreateBinding28() throws Exception {
        ...
        try {
            ...
            assertBindingsEqual("Lp/A;.foo<T:Ljava/lang/Object;>(IZ)TT;#arg0#0#0\n" + "Lp/A;.foo<T:Ljava/lang/Object;>(IZ)TT;#arg1#0#1", bindings);
            IVariableBinding param1 = (IVariableBinding) bindings[0];
            IVariableBinding param2 = (IVariableBinding) bindings[1];
            assertBindingsEqual("I\n" + "Z", new IBinding[] { param1.getType(), param2.getType() });
        } finally {
    ...
    public void testField1() throws JavaModelException {
        ...
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "field [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]", element);
    }
    ...
    public void testField2() throws JavaModelException {
        ...
        IBinding binding = ((VariableDeclaration) node).resolveBinding();
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "field [in <anonymous #1> [in foo() [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]]]", element);
    }
    ...
    public void testFindElement01() throws JavaModelException {
        String bindingKey = buildBindingKey("/*start*/public class X {\n" + "}/*end*/");
        assertFindElement(bindingKey, "X [in [Working copy] X.java [in <default> [in src [in P]]]]");
    }
    ...
    public void testFindElement02() throws JavaModelException {
        String bindingKey = buildBindingKey("public class X {\n" + "  /*start*/void foo() {\n" + "  }/*end*/\n" + "}");
        assertFindElement(bindingKey, "foo() [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]");
    }
    ...
    public void testFindElement03() throws JavaModelException {
        String bindingKey = buildBindingKey("public class X {\n" + "  int /*start*/field/*end*/;\n" + "}");
        assertFindElement(bindingKey, "field [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]");
    }
    ...
    public void testFindElement04() throws JavaModelException {
        String bindingKey = buildBindingKey("public class X {\n" + "  /*start*/class Member {\n" + "  }/*end*/\n" + "}");
        assertFindElement(bindingKey, "Member [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]");
    }
    ...
    public void testFindElement05() throws JavaModelException {
        String bindingKey = buildBindingKey("public class X {\n" + "  void foo() {\n" + "    /*start*/class Local {\n" + "    }/*end*/\n" + "  }\n" + "}");
        assertFindElement(bindingKey, "Local [in foo() [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]]");
    }
    ...
    public void testFindElement06() throws JavaModelException {
        String bindingKey = buildBindingKey("public class X {\n" + "  void foo() {\n" + "    new X() /*start*/{\n" + "    }/*end*/;\n" + "  }\n" + "}");
        assertFindElement(bindingKey, "<anonymous #1> [in foo() [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]]");
    }
    ...
    public void testFindElement07() throws JavaModelException {
        ...
        assertFindElement(bindingKey, "Secondary [in [Working copy] X.java [in <default> [in src [in P]]]]");
    }
    ...
    public void testFindElement08() throws JavaModelException {
        String bindingKey = buildBindingKey("/*start*/@MyAnnot/*end*/\n" + "public class X {\n" + "}\n" + "@interface MyAnnot {\n" + "}");
        assertFindElement(bindingKey, "@MyAnnot [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]");
    }
    ...
    public void testFindElement09() throws JavaModelException {
        ...
        assertFindElement(bindingKey, "java.lang [in " + getExternalJCLPathString("1.5") + "]");
    }
    ...
    public void testFindElement10() throws JavaModelException {
        String bindingKey = buildBindingKey("public class X</*start*/T/*end*/> {\n" + "}");
        assertFindElement(bindingKey, "<T> [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]");
    }
    ...
    public void testFindElement11() throws JavaModelException {
        ...
        assertFindElement(bindingKey, "Y [in Y.class [in p [in lib.jar [in P]]]]");
    }
    ...
    public void testFindElement12() throws JavaModelException {
        ...
        assertFindElement(bindingKey, "Member [in Z$Member.class [in p [in lib.jar [in P]]]]");
    }
    ...
    public void testFindElement13() throws JavaModelException {
        ...
        assertFindElement(bindingKey, "Z$1.class [in p [in lib.jar [in P]]]");
    }
    ...
    public void testLocalType() throws JavaModelException {
        ...
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "Y [in foo() [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]]", element);
    }
    ...
    public void testLocalType2() throws CoreException {
        ...
        try {
            ...
            resolveASTs(new ICompilationUnit[] {}, bindingKeys, requestor, getJavaProject("P"), this.workingCopy.getOwner());
            ...
            assertElementExists("Unexpected Java element", "Local [in foo() [in Z [in Z.java [in <default> [in src [in P]]]]]]", element);
        } finally {
            deleteFile(filePath);
        }
    }
    ...
    public void testLocalVariable1() throws JavaModelException {
        ...
        assertEquals("Unexpected Java element", expected, element);
    }
    ...
    public void testLocalVariable4() throws JavaModelException {
        try {
            ...
            this.workingCopy.discardWorkingCopy();
            IJavaElement element = binding.getJavaElement();
            assertEquals("Unexpected Java element", null, element);
        } finally {
            setUpWorkingCopy();
        }
    }
    ...
    public void testMemberType() throws JavaModelException {
        ...
        IBinding binding = ((TypeDeclaration) node).resolveBinding();
        IJavaElement element = binding.getJavaElement();
        assertElementEquals("Unexpected Java element", "Y [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]", element);
    ...
    public void testMethod01() throws JavaModelException {
        ASTNode node = buildAST("public class X<K, V> {\n" + "  /*start*/void foo(int i, Object o, java.lang.String s, Class[] c, X<K, V> x) {\n" + "  }/*end*/\n" + "}");
        IBinding binding = ((MethodDeclaration) node).resolveBinding();
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "foo(int, Object, java.lang.String, Class[], X<K,V>) [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]", element);
    }
    ...
    public void testMethod02() throws JavaModelException {
        ...
        IBinding binding = ((MethodDeclaration) node).resolveBinding();
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "foo() [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]", element);
    }
    ...
    public void testMethod03() throws JavaModelException {
        ...
        try {
            otherWorkingCopy = getWorkingCopy("/P/src/Y.java", "public class Y {\n" + "  void foo(int i, String[] args, java.lang.Class clazz) {}\n" + "}", this.workingCopy.getOwner());
            ASTNode node = buildAST("public class X {\n" + "  void bar() {\n" + "    Y y = new Y();\n" + "    /*start*/y.foo(1, new String[0], getClass())/*end*/;\n" + "  }\n" + "}");
            IBinding binding = ((MethodInvocation) node).resolveMethodBinding();
            IJavaElement element = binding.getJavaElement();
            assertElementExists("Unexpected Java element", "foo(int, String[], java.lang.Class) [in Y [in [Working copy] Y.java [in <default> [in src [in P]]]]]", element);
        } finally {
    ...
    public void testMethod04() throws JavaModelException {
        ...
        IBinding binding = ((MethodInvocation) node).resolveMethodBinding();
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "bar(A<? extends T>) [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]", element);
    }
    ...
    public void testMethod05() throws JavaModelException {
        ASTNode node = buildAST("public class X<T> {\n" + "    void m(T t) { }\n" + "}\n" + "\n" + "class Y {\n" + "    {\n" + "        /*start*/new X<String>().m(\"s\")/*end*/;\n" + "    }\n" + "}");
        IBinding binding = ((MethodInvocation) node).resolveMethodBinding();
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "m(T) [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]", element);
    }
    ...
    public void testMethod06() throws JavaModelException {
        ASTNode node = buildAST("@X(/*start*/value/*end*/=\"Hello\", count=-1)\n" + "@interface X {\n" + "    String value();\n" + "    int count();\n" + "}");
        IBinding binding = ((SimpleName) node).resolveBinding();
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "value() [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]", element);
    }
    ...
    public void testMethod07() throws JavaModelException {
        ...
        IBinding binding = ((MethodDeclaration) node).resolveBinding();
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "bar(int[]) [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]", element);
    }
    ...
    public void testMethod08() throws JavaModelException {
        ...
        IBinding binding = ((MethodDeclaration) node).resolveBinding();
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "bar2(Object[][][]) [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]", element);
    }
    ...
    public void testMethod09() throws JavaModelException {
        ...
        IBinding binding = ((MethodDeclaration) node).resolveBinding();
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "bar3(Object[]) [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]", element);
    }
    ...
    public void testMethod10() throws CoreException {
        try {
            ...
            ASTNode node = buildAST(/*use existing contents*/
            null, /*don't report errors*/
            cu, false, /*statement recovery*/
            true, false);
            IBinding binding = ((MethodDeclaration) node).resolveBinding();
            IJavaElement element = binding.getJavaElement();
            assertElementExists("Unexpected Java element", "yes() [in <anonymous #1> [in test() [in X [in Test.java [in <default> [in src [in P]]]]]]]", element);
        } finally {
            deleteFile("/P/src/Test.java");
        }
    }
    ...
    public void testMethod11() throws JavaModelException {
        ...
        IBinding binding = ((MethodDeclaration) node).resolveBinding();
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "bar() [in <anonymous #1> [in <initializer #1> [in <anonymous #1> [in foo() [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]]]]]", element);
    }
    ...
    public void testMethod12() throws Exception {
        try {
            ...
            IBinding binding = ((MethodDeclaration) node).resolveBinding();
            IJavaElement element = binding.getJavaElement();
            assertElementExists("Unexpected Java element", "foo(p2.X249567) [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]", element);
        } finally {
    ...
    public void testMethod13() throws Exception {
        try {
            ...
            IBinding binding = ((MethodDeclaration) node).resolveBinding();
            IJavaElement element = binding.getJavaElement();
            assertElementExists("Unexpected Java element", "foo(p1.X249567.Member) [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]", element);
        } finally {
            deleteFolder("/P/src/p1");
        }
    }
    ...
    public void testMethod14() throws Exception {
        try {
            ...
            IBinding binding = ((MethodDeclaration) node).resolveBinding();
            IJavaElement element = binding.getJavaElement();
            assertElementExists("Unexpected Java element", "foo(p1.X249567.Member<java.lang.String>) [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]", element);
        } finally {
            deleteFolder("/P/src/p1");
        }
    }
    ...
    public void testPackage1() throws CoreException {
        ...
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "java.lang [in " + getExternalJCLPathString("1.5") + "]", element);
    }
    ...
    public void testPackage2() throws CoreException {
        ASTNode node = buildAST("/*start*/public class X {\n" + "}/*end*/");
        ITypeBinding typeBinding = ((TypeDeclaration) node).resolveBinding();
        IPackageBinding binding = typeBinding.getPackage();
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "<default> [in src [in P]]", element);
    }
    ...
    public void testParameterizedBinaryType() throws CoreException {
        ...
        IBinding binding = ((Type) node).resolveBinding();
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "Comparable [in Comparable.class [in java.lang [in " + getExternalJCLPathString("1.5") + "]]]", element);
    }
    ...
    public void testParameterizedBinaryMethod() throws CoreException {
        ASTNode node = buildAST("public class X extends p.Y<String> {\n" + "  public X(String s) {\n" + "    /*start*/super(s);/*end*/\n" + "  }\n" + "}");
        IBinding binding = ((SuperConstructorInvocation) node).resolveConstructorBinding();
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "Y(T) [in Y [in Y.class [in p [in lib.jar [in P]]]]]", element);
    }
    ...
    public void testRecoveredTypeBinding1() throws Exception {
        try {
            ...
            org.eclipse.jdt.core.tests.util.Util.createJar(new String[] { "java/util/List.java", "package java.util;\n" + "public class List<T> {\n" + "}" }, p.getProject().getLocation() + File.separator + "util.jar", "1.5");
            p.getProject().refreshLocal(IResource.DEPTH_INFINITE, null);
            createFile("/P15/X.java", "");
            ASTNode node = buildAST("public class X {\n" + "  void m() {\n" + "    /*start*/new java.util.List<URL>()/*end*/;\n" + "  }\n" + "}", getCompilationUnit("/P15/X.java"), /*don't report errors*/
            false, /*statement recovery*/
            true, /*binding recovery*/
            true);
            IBinding binding = ((ClassInstanceCreation) node).resolveTypeBinding();
            IJavaElement element = binding.getJavaElement();
            // equals should not throw an NPE
    ...
    public void testTopLevelType1() throws JavaModelException {
        ...
        IBinding binding = ((TypeDeclaration) node).resolveBinding();
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "X [in [Working copy] X.java [in <default> [in src [in P]]]]", element);
    }
    ...
    public void testTopLevelType2() throws CoreException {
        try {
            ...
            IBinding binding = ((Type) node).resolveBinding();
            IJavaElement element = binding.getJavaElement();
            assertElementExists("Unexpected Java element", "Y [in Y.java [in <default> [in src [in P]]]]", element);
        } finally {
    ...
    public void testTypeParameter() throws JavaModelException {
        ASTNode node = buildAST("public class X</*start*/T/*end*/> {\n" + "}");
        IBinding binding = ((TypeParameter) node).resolveBinding();
        IJavaElement element = binding.getJavaElement();
        assertElementExists("Unexpected Java element", "<T> [in X [in [Working copy] X.java [in <default> [in src [in P]]]]]", element);
    ...
    public void testTypeParameter2() throws CoreException {
        ...
        try {
            ...
            IJavaElement[] elements = new IJavaElement[] { cu.getType("X"), cu.getType("X").getTypeParameters()[0] };
            IBinding[] bindings = parser.createBindings(elements, null);
            assertBindingsEqual("Lp/X<TT;>;\n" + "Lp/X;:TT;", bindings);
            IJavaElement element = bindings[1].getJavaElement();
            assertElementExists("Unexpected Java element", "<T> [in X [in [Working copy] X.java [in p [in src [in P]]]]]", element);
            assertEquals("Wrong type", IJavaElement.TYPE_PARAMETER, element.getElementType());
            ITypeParameter typeParameter = (ITypeParameter) element;
    ...
    public void testTypeParameter3() throws CoreException {
        try {
            createClassFile("/P/lib", "A.class", "package lib;\n" + "public interface A<T,Z> {\n" + "  public T foo(int i, String s);\n" + "}");
            IJavaProject javaProject = getJavaProject("P");
            IJavaElement[] elements = new IJavaElement[] { javaProject.findType("lib.A"), javaProject.findType("lib.A").getTypeParameters()[0], javaProject.findType("lib.A").getTypeParameters()[1] };
            ASTParser parser = ASTParser.newParser(AST.JLS8);
            parser.setProject(javaProject);
            IBinding[] bindings = parser.createBindings(elements, null);
            assertBindingsEqual("Llib/A<TT;TZ;>;\n" + "Llib/A;:TT;\n" + "Llib/A;:TZ;", bindings);
        } finally {
    ...
    public void testTypeParameter4() throws CoreException {
        try {
            ...
            IJavaElement[] elements = new IJavaElement[] { method, method.getTypeParameters()[0], method.getTypeParameters()[1] };
            ASTParser parser = ASTParser.newParser(AST.JLS8);
            parser.setProject(javaProject);
            IBinding[] bindings = parser.createBindings(elements, null);
            assertBindingsEqual("Llib/A;.foo<T:Ljava/lang/Object;Z:Ljava/lang/Object;>(ITZ;)TT;\n" + "Llib/A;.foo<T:Ljava/lang/Object;Z:Ljava/lang/Object;>(ITZ;)TT;:TT;\n" + "Llib/A;.foo<T:Ljava/lang/Object;Z:Ljava/lang/Object;>(ITZ;)TT;:TZ;", bindings);
        } finally {
            deleteFile("/P/lib/A.class");
            deleteFolder("/P/lib");
        }
    ...
    public void test157847a() throws CoreException {
        ...
        try {
            String contents = "public class Bug157847A<T> {\n" + "	void add(Y<? extends T> l) {}\n" + "}\n" + "interface Y<T> {}\n";
            createFile(filePath, contents);
            BindingRequestor requestor = new BindingRequestor();
    ...
    public void test157847b() throws CoreException {
        ...
        try {
            String contents = "public class Bug157847B<T> {\n" + "	void add(Y<? super T> l) {}\n" + "}\n" + "interface Y<T> {}\n";
            createFile(filePath, contents);
            BindingRequestor requestor = new BindingRequestor();
    ...
    public void test157847c() throws CoreException {
        ...
        try {
            String contents = "public class Bug157847C<T> {\n" + "	void add(Y<? extends T> l) {}\n" + "}\n" + "interface Y<T> {}\n";
            createFile(filePath, contents);
            BindingRequestor requestor = new BindingRequestor();
