 ...
 */
    public void testArrayTypeWithNonEmptyIdentifier() {
        this.runTestCheckMethodParse(// compilationUnit:
        "class Bar {										\n" + "	void foo() {									\n" + "		String[].class;								\n" + "	}												\n" + "}													\n", // completeBehind:
        "String[].cl", // expectedCompletionNodeToString:
        "<CompleteOnClassLiteralAccess:String[].cl>", // expectedUnitDisplayString:
        "class Bar {\n" + "  Bar() {\n" + "  }\n" + "  void foo() {\n" + "    <CompleteOnClassLiteralAccess:String[].cl>;\n" + "  }\n" + "}\n", // expectedCompletionIdentifier:
        "cl", // expectedReplacedSource:
        "String[].class", // test name
 ...
 */
    public void testPrimitiveArrayTypeWithNonEmptyIdentifier() {
        this.runTestCheckMethodParse(// compilationUnit:
        "class Bar {										\n" + "	void foo() {									\n" + "		int[].class;								\n" + "	}												\n" + "}													\n", // completeBehind:
        "int[].cl", // expectedCompletionNodeToString:
        "<CompleteOnClassLiteralAccess:int[].cl>", // expectedUnitDisplayString:
