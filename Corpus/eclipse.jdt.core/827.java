...
public class WhileStatement extends Statement {
    ...
    public FlowInfo analyseCode(BlockScope currentScope, FlowContext flowContext, FlowInfo flowInfo) {
        ...
        if (this.action == null || (this.action.isEmptyBlock() && currentScope.compilerOptions().complianceLevel <= ClassFileConstants.JDK1_3)) {
            ...
            loopingContext = new LoopingFlowContext(flowContext, flowInfo, this, this.breakLabel, this.continueLabel, currentScope, true);
            if (isConditionFalse) {
    ...
    public void generateCode(BlockScope currentScope, CodeStream codeStream) {
        ...
        if (this.continueLabel == null) {
            ...
            if (!(((this.condition.constant != Constant.NotAConstant) && (this.condition.constant.booleanValue() == true)) || (this.action == null) || this.action.isEmptyBlock())) {
