...
public class NumberLiteral extends Expression {
	 ...
	 * @since 3.0
	 */
    public static final SimplePropertyDescriptor TOKEN_PROPERTY = //$NON-NLS-1$
    new SimplePropertyDescriptor(NumberLiteral.class, "token", String.class, MANDATORY);
                ...
                case TerminalTokens.TokenNameMINUS:
                    ...
                    switch(tokenType) {
                        ...
                        case TerminalTokens.TokenNameLongLiteral:
                            break;
                        default:
                            throw //$NON-NLS-1$//$NON-NLS-2$
                            new IllegalArgumentException("Invalid number literal : >" + token + "<");
                    }
                    break;
                default:
                    //$NON-NLS-1$//$NON-NLS-2$
