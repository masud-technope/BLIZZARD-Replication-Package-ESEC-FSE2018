...
public class CompilationUnit extends ASTNode {
	 ...
	 * @since 3.0
	 */
    public static final ChildListPropertyDescriptor IMPORTS_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(CompilationUnit.class, "imports", ImportDeclaration.class, NO_CYCLE_RISK);
	 ...
	 * @since 3.0
	 */
    public static final ChildPropertyDescriptor PACKAGE_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(CompilationUnit.class, "package", PackageDeclaration.class, OPTIONAL, NO_CYCLE_RISK);
	 ...
	 * @since 3.0
	 */
    public static final ChildListPropertyDescriptor TYPES_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(CompilationUnit.class, "types", AbstractTypeDeclaration.class, CYCLE_RISK);
