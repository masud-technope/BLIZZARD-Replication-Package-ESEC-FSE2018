...
public class ASTConverterTest2 extends ConverterTestSetup {
    ...
    public void test0540() {
        ...
        //$NON-NLS-1$
        ASTNode result = runConversion(source, "Test.java", project, options, true);
        //$NON-NLS-1$
        assertNotNull("No compilation unit", result);
        //$NON-NLS-1$
    ...
    public void test0569() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0569", "A.java");
        ASTNode result = runConversion(sourceUnit, true);
        //$NON-NLS-1$
        assertEquals("not a compilation unit", ASTNode.COMPILATION_UNIT, result.getNodeType());
        CompilationUnit unit = (CompilationUnit) result;
    ...
    public void test0570() throws CoreException {
        ...
        try {
            ...
            CompilationUnit unit = (CompilationUnit) buildAST("import java.util.List;\n" + "public class X{\n" + "  List field;\n" + "}", workingCopy);
    ...
    public void test0571() throws CoreException, IOException {
        try {
            ...
            for (int i = 0, length = problems.length; i < length; i++) Util.appendProblem(buffer, problems[i], source.toCharArray(), i);
    ...
    public void test0572() throws CoreException {
        ...
        try {
            ...
            true);
            AnonymousClassDeclaration type = (AnonymousClassDeclaration) buildAST("public class X {\n" + "  void foo() {\n" + "    new X() /*start*/{\n" + "      void bar() {}\n" + "    }/*end*/;\n" + "  }\n" + "}", workingCopy);
            ITypeBinding typeBinding = type.resolveBinding();
            assertBindingsEqual("LX$40;.(LX;)V\n" + "LX$40;.bar()V", typeBinding.getDeclaredMethods());
        } finally {
            if (workingCopy != null)
                workingCopy.discardWorkingCopy();
        }
    ...
    public void test0573() throws CoreException {
        ...
        try {
            workingCopy = getWorkingCopy("/Converter/src/X.java", /*resolve*/
            true);
            CompilationUnit cu = (CompilationUnit) buildAST("public class X {\n" + "}", workingCopy);
    ...
    public void test0574() throws CoreException {
        ...
        try {
            workingCopy = getWorkingCopy("/Converter/src/X.java", /*resolve*/
            true);
            ASTNode string = buildAST("public class X {\n" + "  String s = /*start*/\"a\" + \"b\"/*end*/;\n" + "}", workingCopy);
    ...
    public void test0576() throws CoreException, IOException {
        try {
            ...
            addLibrary(project, "lib.jar", "src.zip", new String[] { "/P1/p/X.java", "package p;\n" + "public class X<T> {\n" + "  /*start*/public class Member {\n" + "  }/*end*/\n" + "}" }, "1.5");
    ...
    public void test0577() throws CoreException {
        ICompilationUnit workingCopy = null;
        try {
            workingCopy = getWorkingCopy("/Converter/src/X.java", "public class X {\n" + "  String s = /*start*/\"a\" + \"b\"/*end*/;\n" + "}", /*resolve*/
            true);
    ...
    public void test0578() throws CoreException {
        ...
        try {
            ...
            String contents = "public class External {\n" + "	/*start*/String foo(){\n" + "		return \"\";\n" + "	}/*end*/\n" + "}\n";
            IBinding methodBinding = resolveBindings(contents, workingCopy)[0];
            assertBindingEquals("LExternal;.foo()Ljava/lang/String;", methodBinding);
        } finally {
            if (workingCopy != null)
                workingCopy.discardWorkingCopy();
        }
    ...
    public void test0606() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0606", "X.java");
        ASTNode result = runConversion(sourceUnit, true);
        //$NON-NLS-1$
        assertEquals("not a compilation unit", ASTNode.COMPILATION_UNIT, result.getNodeType());
        CompilationUnit unit = (CompilationUnit) result;
