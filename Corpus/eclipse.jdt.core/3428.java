...
public class JavadocMessageSend extends MessageSend {
    ...
    private TypeBinding internalResolveType(Scope scope) {
        ...
        this.binding = (this.receiver != null && this.receiver.isThis()) ? scope.getImplicitMethod(this.selector, argumentTypes, this) : scope.getMethod(this.receiverType, this.selector, argumentTypes, this);
