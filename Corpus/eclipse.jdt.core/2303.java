...
public class FactoryLoaderTests extends APTTestBase {
    ...
    // external annotation jar
    private File _extJar;

    // external annotation jar, as a classpath-var-relative path
    private IPath _extVarJar;

    // initialized in setUp(), cleared in tearDown()
    ...
    public void setUp() throws Exception {
        ...
        _extJar = TestUtil.createAndAddExternalAnnotationJar(env.getJavaProject(_projectPath));
