...
public class JavaSearchGenericMethodEquivalentTests extends JavaSearchGenericMethodTests {
    ...
    public static Test suite() {
        ...
        List tests = buildTestsList(JavaSearchGenericMethodEquivalentTests.class, /* do not sort*/
        1, 0);
    ...
    void addResultLine(StringBuffer buffer, char[] line) {
        if (!CharOperation.match(RESULT_ERASURE_MATCH, line, true) && !CharOperation.match(RESULT_POTENTIAL_MATCH, line, true)) {
