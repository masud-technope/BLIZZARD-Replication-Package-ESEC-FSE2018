    ...
    public void launch(ILaunchConfiguration configuration, String mode, ILaunch launch, IProgressMonitor monitor) throws CoreException {
        try {
            ...
            if ((javaProject == null) || !javaProject.exists()) {
                abort(//$NON-NLS-1$
                PDEPlugin.getResourceString("JUnitLaunchConfiguration.error.invalidproject"), //$NON-NLS-1$
                null, //$NON-NLS-1$
            ...
            if (testTypes.length == 0) {
                abort(//$NON-NLS-1$
                PDEPlugin.getResourceString("JUnitLaunchConfiguration.error.notests"), //$NON-NLS-1$
                null, //$NON-NLS-1$
            ...
            monitor.worked(1);
            launch.setAttribute(ILauncherSettings.CONFIG_LOCATION, (configFile == null) ? null : configFile.getParent());
