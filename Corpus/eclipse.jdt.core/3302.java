...
public abstract class AbstractNullAnnotationTest extends AbstractComparableTest {
    ...
    void runNegativeTestWithLibs(String[] testFiles, String expectedErrorLog) {
        runNegativeTest(testFiles, expectedErrorLog, this.LIBS, /*shouldFlush*/
        false);
    }

    void runNegativeTestWithLibs(boolean skipJavac, String[] testFiles, String expectedErrorLog) {
        runNegativeTest(skipJavac, null, testFiles, expectedErrorLog, this.LIBS, /*shouldFlush*/
        false);
    }
    ...
    void runNegativeTestWithExtraLibs(String[] testFiles, String expectedErrorLog, String[] extraLibs) {
        ...
        runNegativeTest(testFiles, expectedErrorLog, libraries, /*shouldFlush*/
        false);
    }
    ...
    void runNegativeTestWithLibs(boolean shouldFlushOutputDirectory, String[] testFiles, Map customOptions, String expectedErrorLog) {
        runNegativeTestWithLibs(shouldFlushOutputDirectory, testFiles, customOptions, expectedErrorLog, // runtime options
        false);
    }
    ...
    void runNegativeTestWithLibs(boolean shouldFlushOutputDirectory, String[] testFiles, Map customOptions, String expectedErrorLog, boolean skipJavaC) {
        runNegativeTest(shouldFlushOutputDirectory, testFiles, this.LIBS, customOptions, expectedErrorLog, // runtime options
        skipJavaC ? JavacTestOptions.SKIP : JavacTestOptions.Excuse.EclipseWarningConfiguredAsError);
    }

    void runNegativeTestWithLibs(String[] testFiles, Map customOptions, String expectedErrorLog) {
        runNegativeTestWithLibs(/* flush output directory */
        false, testFiles, customOptions, expectedErrorLog);
    }

    void runNegativeTestWithLibs(String[] testFiles, Map customOptions, String expectedErrorLog, boolean skipJavac) {
        runNegativeTestWithLibs(/* flush output directory */
        false, testFiles, customOptions, expectedErrorLog, skipJavac);
    }

    void runConformTestWithLibs(String[] testFiles, Map customOptions, String expectedCompilerLog) {
        runConformTestWithLibs(/* flush output directory */
        false, testFiles, customOptions, expectedCompilerLog);
    }
    ...
    void runConformTestWithLibs(String[] testFiles, Map customOptions, String expectedCompilerLog, String expectedOutput) {
        ...
        false, testFiles, this.LIBS, customOptions, expectedCompilerLog, expectedOutput, /* expected error */
    ...
    void runConformTestWithLibs(boolean shouldFlushOutputDirectory, String[] testFiles, Map customOptions, String expectedCompilerLog) {
        runConformTest(shouldFlushOutputDirectory, testFiles, this.LIBS, customOptions, expectedCompilerLog, /* expected output */
        "", /* expected error */
        "", JavacTestOptions.Excuse.EclipseWarningConfiguredAsError);
    }

    void runConformTest(String[] testFiles, Map customOptions, String expectedOutputString) {
        runConformTest(testFiles, expectedOutputString, /*classLibraries*/
        null, /*shouldFlushOutputDirectory*/
        true, /*vmArguments*/
        null, customOptions, /*customRequestor*/
        null);
    }
}
