...
public class CompilationUnitDeclaration extends ASTNode implements ProblemSeverities, ReferenceContext {
    ...
    //$NON-NLS-1$
    private static final char[] PACKAGE_INFO_FILE_NAME = "package-info.java".toCharArray();
    ...
    public void cleanUp() {
        ...
        for (int i = 0, max = classFiles.length; i < max; i++) {
            ...
            // codeStream holds onto ast and scopes
    ...
    public void resolve() {
        if (this.currentPackage != null) {
            if (this.currentPackage.annotations != null && !CharOperation.endsWith(getFileName(), PACKAGE_INFO_FILE_NAME)) {
