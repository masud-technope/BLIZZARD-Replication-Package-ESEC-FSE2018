...
public class ASTConverterTestAST8_2 extends ConverterTestSetup {
    ...
    public void test0401() throws JavaModelException {
        ...
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0401", "A.java");
    ...
    public void test0402() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0402", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        ASTNode node = getASTNode((CompilationUnit) result, 1, 0, 0);
        //$NON-NLS-1$
        assertEquals("Wrong number of problems", 0, ((CompilationUnit) result).getProblems().length);
        assertNotNull(node);
        //$NON-NLS-1$
    ...
    public void test0403() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0403", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        ASTNode node = getASTNode((CompilationUnit) result, 1, 0, 1);
        //$NON-NLS-1$
        assertEquals("Wrong number of problems", 1, ((CompilationUnit) result).getProblems().length);
        assertNotNull(node);
        //$NON-NLS-1$
        ...
        //$NON-NLS-1$ //$NON-NLS-2$
        assertEquals("Wrong name", "test", variableBinding.getName());
    ...
    public void test0404() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0404", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
    ...
    public void test0405() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0405", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        ASTNode node = getASTNode((CompilationUnit) result, 1, 0, 1);
        //$NON-NLS-1$
        assertEquals("Wrong number of problems", 1, ((CompilationUnit) result).getProblems().length);
    ...
    public void test0406() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0406", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
    ...
    public void test0407() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0407", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertEquals("Wrong number of problems", 0, ((CompilationUnit) result).getProblems().length);
        ASTNode node = getASTNode((CompilationUnit) result, 0, 0);
    ...
    public void test0408() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0408", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertEquals("Wrong number of problems", 0, ((CompilationUnit) result).getProblems().length);
        ASTNode node = getASTNode((CompilationUnit) result, 0, 0);
    ...
    public void test0409() throws JavaModelException {
        ...
        try {
            ...
            //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
            ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0409", "A.java");
            ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
            //$NON-NLS-1$
            ...
            //$NON-NLS-1$
            assertEquals("wrong number", 212, bindingsMap.size());
            ...
            for (Iterator iterator = detachedNodes.iterator(); iterator.hasNext(); ) {
                ...
                switch(detachedNode.getNodeType()) {
                    ...
                    case ASTNode.VARIABLE_DECLARATION_EXPRESSION:
                        ...
                        assertTrue("binding not equals", //$NON-NLS-1$
                        binding.equals(//$NON-NLS-1$
                        typeBinding));
                        break;
                    case ASTNode.VARIABLE_DECLARATION_FRAGMENT:
                        assertTrue("binding not equals", binding.equals(//$NON-NLS-1$
                        ((VariableDeclarationFragment) detachedNode).resolveBinding()));
                        break;
                    case ASTNode.ANONYMOUS_CLASS_DECLARATION:
                        assertTrue("binding not equals", binding.equals(//$NON-NLS-1$
                        ((AnonymousClassDeclaration) detachedNode).resolveBinding()));
                        break;
                    ...
                    case ASTNode.PRIMITIVE_TYPE:
                        assertTrue("binding not equals", binding.equals(//$NON-NLS-1$
                        ((Type) detachedNode).resolveBinding()));
                        break;
                    case ASTNode.CONSTRUCTOR_INVOCATION:
                        assertTrue("binding not equals", binding.equals(//$NON-NLS-1$
                        ((ConstructorInvocation) detachedNode).resolveConstructorBinding()));
                        break;
                    case ASTNode.IMPORT_DECLARATION:
                        assertTrue("binding not equals", binding.equals(//$NON-NLS-1$
                        ((ImportDeclaration) detachedNode).resolveBinding()));
                        break;
                    case ASTNode.METHOD_DECLARATION:
                        assertTrue("binding not equals", binding.equals(//$NON-NLS-1$
                        ((MethodDeclaration) detachedNode).resolveBinding()));
                        break;
                    case ASTNode.PACKAGE_DECLARATION:
                        assertTrue("binding not equals", binding.equals(//$NON-NLS-1$
                        ((PackageDeclaration) detachedNode).resolveBinding()));
                        break;
                    case ASTNode.TYPE_DECLARATION:
                        assertTrue("binding not equals", binding.equals(//$NON-NLS-1$
                        ((TypeDeclaration) detachedNode).resolveBinding()));
                        break;
                }
            }
        } finally {
    ...
    public void test0410() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0410", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertEquals("Wrong number of problems", 0, ((CompilationUnit) result).getProblems().length);
    ...
    public void test0411() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0411", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertEquals("Wrong number of problems", 0, ((CompilationUnit) result).getProblems().length);
        ASTNode node = getASTNode((CompilationUnit) result, 0, 0, 0);
    ...
    public void test0412() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0412", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
        //$NON-NLS-1$
        assertEquals("Wrong number of problems", 0, unit.getProblems().length);
    ...
    public void test0413() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0413", "A.java");
        ...
        if (node.getAST().apiLevel() < AST.JLS8) {
            ...
            //$NON-NLS-1$
            assertEquals("wrong size", 2, throwsExceptionTypes.size());
    ...
    public void test0414() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0414", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
        ...
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit2 = getCompilationUnit("Converter", "src", "test0414", "B.java");
        result = runConversion(AST.JLS8, sourceUnit2, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit2 = (CompilationUnit) result;
        //$NON-NLS-1$
        assertEquals("Wrong number of problems", 0, unit2.getProblems().length);
    ...
    public void test0415() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0415", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        ...
        //$NON-NLS-1$
        assertTrue("not a switch case (default)", statement.getNodeType() == ASTNode.SWITCH_CASE);
    ...
    public void test0416() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0416", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
        ...
        //$NON-NLS-1$
        assertTrue("not a qualified name", init.getNodeType() == ASTNode.QUALIFIED_NAME);
    ...
    public void test0417() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0417", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
    ...
    public void test0418() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0418", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
    ...
    public void test0419() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0419", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
    ...
    public void test0420() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0420", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
    ...
    public void test0421() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0421", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
    ...
    public void test0422() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0422", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
    ...
    public void test0423() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0423", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
    ...
    public void test0424() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0424", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
    ...
    public void test0425() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0425", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        ...
        Expression expression2 = infixExpression.getRightOperand();
        //$NON-NLS-1$
        assertTrue("not an infix expression", expression2.getNodeType() == ASTNode.INFIX_EXPRESSION);
        InfixExpression infixExpression2 = (InfixExpression) expression2;
        Expression expression3 = infixExpression2.getRightOperand();
        //$NON-NLS-1$
        assertTrue("not a parenthesized expression", expression3.getNodeType() == ASTNode.PARENTHESIZED_EXPRESSION);
        checkSourceRange(expression3, "( 2 + 3 )", source);
    }
    ...
    public void test0426() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0426", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true, false, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
    ...
    public void test0427() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0427", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
    ...
    public void test0428() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0428", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
    ...
    public void test0429() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0429", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
    ...
    public void test0430() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0430", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
    ...
    public void test0431() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0431", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
    ...
    public void test0432() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0432", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
    ...
    public void test0433() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0433", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
    ...
    public void test0434() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0434", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
    ...
    public void test0435() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0435", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
    ...
    public void test0436() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0436", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true, false, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
        //$NON-NLS-1$
        assertProblemsSize(unit, 1, "The type A.CInner is not visible");
        ASTNode node = getASTNode(unit, 1, 0, 0);
    ...
    public void test0437() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0437", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true, false, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
        //$NON-NLS-1$
        assertProblemsSize(unit, 1, "The type CInner is not visible");
        ASTNode node = getASTNode(unit, 1, 0, 0);
        assertEquals("Not a variable declaration statement", ASTNode.VARIABLE_DECLARATION_STATEMENT, node.getNodeType());
        VariableDeclarationStatement statement = (VariableDeclarationStatement) node;
        Type type = statement.getType();
    ...
    public void test0438() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0438", "D.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true, false, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
    ...
    public void test0439() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0439", "E.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true, false, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
    ...
    public void test0440() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0440", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
    ...
    public void test0441() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0441", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
    ...
    public void test0442() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0442", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
    ...
    public void test0443() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0443", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
        //$NON-NLS-1$<
        assertEquals("Wrong number of problems", 3, unit.getProblems().length);
        ASTNode node = getASTNode(unit, 0, 0);
    ...
    public void test0444() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0444", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
        //$NON-NLS-1$<
        assertEquals("Wrong number of problems", 2, unit.getProblems().length);
        ASTNode node = getASTNode(unit, 0);
    ...
    public void test0445() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0445", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
    ...
    public void test0446() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0446", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
    ...
    public void test0447() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0447", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
    ...
    public void test0448() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0448", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
    ...
    public void test0449() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0449", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
    ...
    public void test0450() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0450", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
    ...
    public void test0451() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0451", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
    ...
    public void test0452() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "", "NO_WORKING.java");
    ...
    public void test0453() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0453", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit compilationUnit = (CompilationUnit) result;
    ...
    public void test0454() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0454", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        ...
        //$NON-NLS-1$
        assertTrue("not a parenthesized expression", expression2.getNodeType() == ASTNode.PARENTHESIZED_EXPRESSION);
    }
    ...
    public void test0455() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0455", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        ...
        //$NON-NLS-1$
        assertTrue("not a for statement", body.getNodeType() == ASTNode.FOR_STATEMENT);
    ...
    public void test0456() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0456", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
    ...
    public void test0457() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0457", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
    ...
    public void test0458() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0458", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        ...
        checkSourceRange(body, expectedSource, source);
        //$NON-NLS-1$
        assertTrue("not an empty statement", body.getNodeType() == ASTNode.EMPTY_STATEMENT);
    }
    ...
    public void test0459() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0459", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        ...
        checkSourceRange(body, expectedSource, source);
        //$NON-NLS-1$
        assertTrue("not a block", body.getNodeType() == ASTNode.BLOCK);
    }
    ...
    public void test0460() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0460", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit compilationUnit = (CompilationUnit) result;
        //$NON-NLS-1$
        assertTrue("Has error", compilationUnit.getProblems().length == 0);
        ASTNode node = getASTNode(compilationUnit, 0, 0, 0);
        assertNotNull("No node", node);
    ...
    public void test0461() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0461", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, false);
        char[] source = sourceUnit.getSource().toCharArray();
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
    ...
    public void test0462() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "", "Test462.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit compilationUnit = (CompilationUnit) result;
    ...
    public void test0463() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0463", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, false);
        CompilationUnit compilationUnit = (CompilationUnit) result;
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode node = getASTNode(compilationUnit, 0, 0, 0);
    ...
    public void test0464() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0464", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        CompilationUnit compilationUnit = (CompilationUnit) result;
        ASTNode node = getASTNode(compilationUnit, 0, 0, 0);
        //$NON-NLS-1$
        ...
        assertNotNull("No expression", expression);
        //$NON-NLS-1$
        assertTrue("not a null literal", expression.getNodeType() == ASTNode.NULL_LITERAL);
    ...
    public void test0465() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0465", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        CompilationUnit compilationUnit = (CompilationUnit) result;
        ASTNode node = getASTNode(compilationUnit, 0, 1, 0);
        //$NON-NLS-1$
        assertEquals("No error", 0, compilationUnit.getProblems().length);
        assertNotNull("No node", node);
        //$NON-NLS-1$
        assertTrue("not a return statement", node.getNodeType() == ASTNode.RETURN_STATEMENT);
        ReturnStatement returnStatement = (ReturnStatement) node;
    ...
    public void test0466() throws JavaModelException {
        ...
        try {
            ...
            JavaCore.setOptions(newOptions);
            //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
            ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0466", "Assert.java");
            ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
            CompilationUnit compilationUnit = (CompilationUnit) result;
            char[] source = sourceUnit.getSource().toCharArray();
            ASTNode node = getASTNode(compilationUnit, 0, 0, 0);
            ...
            //$NON-NLS-1$
            assertTrue("not an assert statement", node.getNodeType() == ASTNode.ASSERT_STATEMENT);
    ...
    public void test0467() throws JavaModelException {
        ...
        try {
            ...
            JavaCore.setOptions(newOptions);
            //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
            ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0467", "Assert.java");
            ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
            CompilationUnit compilationUnit = (CompilationUnit) result;
            char[] source = sourceUnit.getSource().toCharArray();
            ASTNode node = getASTNode(compilationUnit, 0, 0, 0);
    ...
    public void test0468() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0468", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        CompilationUnit compilationUnit = (CompilationUnit) result;
        ASTNode node = getASTNode(compilationUnit, 0, 1, 0);
        //$NON-NLS-1$
    ...
    public void test0469() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "codeManipulation", "bug.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        CompilationUnit compilationUnit = (CompilationUnit) result;
        ...
        //$NON-NLS-1$
        assertTrue("not a block", parent.getNodeType() == ASTNode.BLOCK);
    }
    ...
    public void test0470() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0470", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        CompilationUnit compilationUnit = (CompilationUnit) result;
        ASTNode node = getASTNode(compilationUnit, 0, 0, 0);
        ...
        //$NON-NLS-1$
        assertTrue("not a variable declaration expression", initializer.getNodeType() == ASTNode.VARIABLE_DECLARATION_EXPRESSION);
    ...
    public void test0471() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0471", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        CompilationUnit compilationUnit = (CompilationUnit) result;
        //$NON-NLS-1$
        ...
        checkSourceRange(methodDeclaration, "private void foo(){", source, /*expectMalformed*/
        true);
    ...
    public void test0472() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "junit.textui", "ResultPrinter.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        CompilationUnit compilationUnit = (CompilationUnit) result;
        //$NON-NLS-1$
        assertEquals("No error", 2, compilationUnit.getProblems().length);
    ...
    public void test0473() throws JavaModelException {
        ...
        try {
            ...
            JavaCore.setOptions(newOptions);
            //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
            ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0473", "A.java");
            char[] source = sourceUnit.getSource().toCharArray();
            ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
            CompilationUnit compilationUnit = (CompilationUnit) result;
            //$NON-NLS-1$
    ...
    public void test0474() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0474", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        CompilationUnit compilationUnit = (CompilationUnit) result;
        //$NON-NLS-1$
    ...
    public void test0475() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0475", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        CompilationUnit compilationUnit = (CompilationUnit) result;
        //$NON-NLS-1$
    ...
    public void test0476() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0476", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        CompilationUnit compilationUnit = (CompilationUnit) result;
        //$NON-NLS-1$
    ...
    public void test0477() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0477", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        CompilationUnit compilationUnit = (CompilationUnit) result;
        //$NON-NLS-1$
    ...
    public void test0478() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0478", "A.java");
        ...
        assertNotNull(node2);
        //$NON-NLS-1$
        assertTrue("Not an expression statement", node2.getNodeType() == ASTNode.EXPRESSION_STATEMENT);
        ...
        //$NON-NLS-1$ //$NON-NLS-2$
        assertEquals("Wrong name", "clone", methodBinding2.getName());
    }
    ...
    public void test0479() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0479", "A.java");
        IType[] types = sourceUnit.getTypes();
        assertNotNull(types);
        assertEquals("wrong size", 2, types.length);
        IType type = types[1];
    ...
    public void test0480() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0480", "A.java");
        IType[] types = sourceUnit.getTypes();
        assertNotNull(types);
        ...
        assertNotNull(node2);
        //$NON-NLS-1$
        assertTrue("Not an variable declaration statement", node2.getNodeType() == ASTNode.VARIABLE_DECLARATION_STATEMENT);
    }
    ...
    public void test0481() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0481", "A.java");
        IType[] types = sourceUnit.getTypes();
        assertNotNull(types);
        assertEquals("wrong size", 1, types.length);
        IType type = types[0];
    ...
    public void test0482() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0482", "A.java");
        IType[] types = sourceUnit.getTypes();
        assertNotNull(types);
        assertEquals("wrong size", 1, types.length);
        IType type = types[0];
    ...
    public void test0483() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0483", "A.java");
        IType[] types = sourceUnit.getTypes();
        assertNotNull(types);
        assertEquals("wrong size", 1, types.length);
        IType type = types[0];
    ...
    public void test0484() throws JavaModelException {
        ...
        BodyDeclaration bodyDeclaration = (BodyDeclaration) bodyDeclarations.get(0);
        //$NON-NLS-1$
        assertTrue("Not a method declaration", bodyDeclaration.getNodeType() == ASTNode.METHOD_DECLARATION);
        MethodDeclaration methodDeclaration = (MethodDeclaration) bodyDeclaration;
        Block block = methodDeclaration.getBody();
        List statements = block.statements();
        assertEquals("Wrong size", 1, statements.size());
    ...
    public void test0486() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0486", "A.java");
        IType[] types = sourceUnit.getTypes();
        assertNotNull(types);
        assertEquals("wrong size", 1, types.length);
        IType type = types[0];
    ...
    public void test0487() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0487", "A.java");
        IType[] types = sourceUnit.getTypes();
        assertNotNull(types);
        assertEquals("wrong size", 1, types.length);
        IType type = types[0];
    ...
    public void test0488() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0488", "A.java");
        IType[] types = sourceUnit.getTypes();
        assertNotNull(types);
        assertEquals("wrong size", 1, types.length);
        IType type = types[0];
    ...
    public void test0489() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0489", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
    ...
    public void test0490() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0490", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
    ...
    public void test0491() throws JavaModelException {
        ...
        try {
            ...
            JavaCore.setOptions(newOptions);
            //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
            ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0491", "A.java");
            char[] source = sourceUnit.getSource().toCharArray();
            ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
            //$NON-NLS-1$
            assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
    ...
    public void test0492() throws JavaModelException {
        ...
        try {
            ...
            JavaCore.setOptions(newOptions);
            //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
            ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0492", "A.java");
            char[] source = sourceUnit.getSource().toCharArray();
            ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
            //$NON-NLS-1$
            assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
    ...
    public void test0493() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0493", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
    ...
    public void test0494() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0494", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
    ...
    public void test0495() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0495", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
    ...
    public void test0496() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0496", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
    ...
    public void test0497() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0497", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        ...
        //$NON-NLS-1$
        assertTrue("is an array type", !type.isArrayType());
        checkSourceRange(type, "Class", source);
    }
    ...
    public void test0498() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0498", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
    }
    ...
    public void test0499() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0499", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) result;
        ...
        //$NON-NLS-1$
        assertTrue("Not a simple name", expression3.getNodeType() == ASTNode.SIMPLE_NAME);
        ITypeBinding binding = expression3.resolveTypeBinding();
        assertNotNull("No binding", binding);
        Expression expression4 = assignment.getLeftHandSide();
        //$NON-NLS-1$
        assertTrue("Not a simple name", expression4.getNodeType() == ASTNode.SIMPLE_NAME);
    ...
    public void test0500() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0500", "A.java");
    ...
    public void test0501() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0501", "JavaEditor.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, false);
        assertNotNull(result);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
    ...
    public void test0502a() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0502", "A.java");
        ...
        //$NON-NLS-1$
        assertEquals("Unexpected key", "Ltest0502/A;#0#i", localBinding.getKey());
    }
    ...
    public void test0502b() throws JavaModelException {
        ...
        IVariableBinding localBinding = fragment.resolveBinding();
        //$NON-NLS-1$
        assertEquals("Unexpected key", "Ltest0502/A;#0#0#j", localBinding.getKey());
    }
    ...
    public void test0502c() throws JavaModelException {
        ...
        IVariableBinding localBinding = fragment.resolveBinding();
        //$NON-NLS-1$
        assertEquals("Unexpected key", "Ltest0502/A;.foo()V#i", localBinding.getKey());
    }
    ...
    public void test0502d() throws JavaModelException {
        ...
        IVariableBinding localBinding = fragment.resolveBinding();
        //$NON-NLS-1$
        assertEquals("Unexpected key", "Ltest0502/A;.foo()V#0#j", localBinding.getKey());
    }
    ...
    public void test0502e() throws JavaModelException {
        ...
        IVariableBinding localBinding = fragment.resolveBinding();
        //$NON-NLS-1$
        assertEquals("Unexpected key", "Ltest0502/A;.foo()V#1#j", localBinding.getKey());
    }
    ...
    public void test0502f() throws JavaModelException {
        ...
        //$NON-NLS-1$
        assertEquals("Unexpected key", "Ltest0502/A$182;", typeBinding.getKey());
    }
    ...
    public void test0502g() throws JavaModelException {
        ...
        ITypeBinding typeBinding = typeDeclaration.resolveBinding();
        //$NON-NLS-1$
        assertEquals("Unexpected key", "Ltest0502/A$206$B;", typeBinding.getKey());
    }
    ...
    public void test0502h() throws JavaModelException {
        ...
        ITypeBinding typeBinding = anonymousClassDeclaration.resolveBinding();
        //$NON-NLS-1$
        assertEquals("Unexpected key", "Ltest0502/A$255;", typeBinding.getKey());
    }
    ...
    public void test0502i() throws JavaModelException {
        ...
        //$NON-NLS-1$
        assertEquals("Unexpected key", "Ltest0502/A$206$B;.field)I", fieldBinding.getKey());
    }
    ...
    public void test0502j() throws JavaModelException {
        ...
        IMethodBinding methodBinding = methodDeclaration.resolveBinding();
        //$NON-NLS-1$
        assertEquals("Unexpected key", "Ltest0502/A$206$B;.bar()V", methodBinding.getKey());
    }
    ...
    public void test0503a() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0503", "A.java");
        CompilationUnit unit = (CompilationUnit) runConversion(AST.JLS8, sourceUnit, true);
        // top level type A
        TypeDeclaration type = (TypeDeclaration) getASTNode(unit, 0);
        ITypeBinding typeBinding = type.resolveBinding();
        //$NON-NLS-1$
        assertEquals("Unexpected binary name", "test0503.A", typeBinding.getBinaryName());
    }
    ...
    public void test0503b() throws JavaModelException {
        ...
        ITypeBinding typeBinding = type.resolveBinding();
        //$NON-NLS-1$
        assertEquals("Unexpected binary name", "test0503.A$B", typeBinding.getBinaryName());
    }
    ...
    public void test0503c() throws JavaModelException {
        ...
        ITypeBinding typeBinding = typeDeclaration.resolveBinding();
        //$NON-NLS-1$
        assertEquals("Unexpected binary name", "test0503.A$1$E", typeBinding.getBinaryName());
    }
    ...
    public void test0503d() throws JavaModelException {
        ...
        ITypeBinding typeBinding = anonymousClassDeclaration.resolveBinding();
        //$NON-NLS-1$
        assertEquals("Unexpected binary name", "test0503.A$2", typeBinding.getBinaryName());
    }
    ...
    public void test0503e() throws JavaModelException {
        ...
        ITypeBinding typeBinding = type.resolveBinding();
        //$NON-NLS-1$
        assertEquals("Unexpected binary name", "test0503.A$2$F", typeBinding.getBinaryName());
    }
    ...
    public void test0503f() throws JavaModelException {
        ...
        ITypeBinding typeBinding = typeDeclaration.resolveBinding();
        //$NON-NLS-1$
        assertEquals("Unexpected binary name", "test0503.A$1$C", typeBinding.getBinaryName());
    }
    ...
    public void test0503g() throws JavaModelException {
        ...
        ITypeBinding typeBinding = anonymousClassDeclaration.resolveBinding();
        //$NON-NLS-1$
        assertEquals("Unexpected binary name", "test0503.A$1", typeBinding.getBinaryName());
    }
    ...
    public void test0503h() throws JavaModelException {
        ...
        ITypeBinding typeBinding = type.resolveBinding();
        //$NON-NLS-1$
        assertEquals("Unexpected binary name", "test0503.A$1$D", typeBinding.getBinaryName());
    }
    ...
    public void test0503i() throws JavaModelException {
        ...
        ITypeBinding typeBinding = typeDeclaration.resolveBinding();
        //$NON-NLS-1$
        assertEquals("Unexpected binary name", null, typeBinding.getBinaryName());
    }
    ...
    public void test0504() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0504", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        ...
        assertNotNull(node);
        //$NON-NLS-1$
        assertTrue("Not a constructor declaration", node.getNodeType() == ASTNode.METHOD_DECLARATION);
        MethodDeclaration declaration = (MethodDeclaration) node;
        assertTrue("A constructor", !declaration.isConstructor());
        checkSourceRange(declaration, "public method(final int parameter);", source, /*expectMalformed*/
        true);
    }
    ...
    public void test0505() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0505", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
    ...
    public void test0506() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0506", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        ...
        ExpressionStatement expressionStatement = (ExpressionStatement) node;
        //$NON-NLS-1$
        assertTrue("Not a class instance creation", expressionStatement.getExpression().getNodeType() == ASTNode.CLASS_INSTANCE_CREATION);
        ClassInstanceCreation classInstanceCreation = (ClassInstanceCreation) expressionStatement.getExpression();
    ...
    public void test0507() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0507", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        final CompilationUnit unit = (CompilationUnit) result;
        ASTNode node = getASTNode(unit, 0, 0, 0);
        //$NON-NLS-1$
    ...
    public void test0508() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0508", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        final CompilationUnit unit = (CompilationUnit) result;
        ASTNode node = getASTNode(unit, 0, 1, 0);
        //$NON-NLS-1$
    ...
    public void test0509() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0509", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        final CompilationUnit unit = (CompilationUnit) result;
        ASTNode node = getASTNode(unit, 0, 0, 0);
        //$NON-NLS-1$
    ...
    public void test0510() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0510", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        final CompilationUnit unit = (CompilationUnit) result;
        ASTNode node = getASTNode(unit, 0, 0, 0);
        //$NON-NLS-1$
    ...
    public void test0511() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0511", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        final CompilationUnit unit = (CompilationUnit) result;
        ASTNode node = getASTNode(unit, 0, 0, 0);
        //$NON-NLS-1$
    ...
    public void test0512() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0512", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        final CompilationUnit unit = (CompilationUnit) result;
        ASTNode node = getASTNode(unit, 0, 0);
        ...
        checkSourceRange(declaration, "public A();", source, /*expectMalformed*/
        true);
    }
    ...
    public void test0513() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0513", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        final CompilationUnit unit = (CompilationUnit) result;
        //$NON-NLS-1$
        assertEquals("Wrong number of problems", 1, unit.getProblems().length);
    ...
    public void test0514() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0514", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        final CompilationUnit unit = (CompilationUnit) result;
        //$NON-NLS-1$
        assertEquals("Wrong number of problems", 1, unit.getProblems().length);
    ...
    public void test0515() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0515", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        final CompilationUnit unit = (CompilationUnit) result;
        //$NON-NLS-1$
    ...
    public void test0516() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0516", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, false);
        final CompilationUnit unit = (CompilationUnit) result;
        //$NON-NLS-1$
    ...
    public void test0517() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0517", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, false);
        final CompilationUnit unit = (CompilationUnit) result;
        //$NON-NLS-1$
    ...
    public void test0518() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0518", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, false);
        final CompilationUnit unit = (CompilationUnit) result;
        //$NON-NLS-1$
    ...
    public void test0519() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0519", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, false);
        final CompilationUnit unit = (CompilationUnit) result;
        //$NON-NLS-1$
    ...
    public void test0520() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0520", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, false);
        final CompilationUnit unit = (CompilationUnit) result;
        //$NON-NLS-1$
    ...
    public void test0521() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0521", "A.java");
    ...
    public void test0533() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0533", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, false);
        final CompilationUnit unit = (CompilationUnit) result;
        //$NON-NLS-1$
    ...
    public void test0534() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0534", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, false);
        final CompilationUnit unit = (CompilationUnit) result;
        //$NON-NLS-1$
    ...
    public void test0535() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0535", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, false);
        final CompilationUnit unit = (CompilationUnit) result;
        //$NON-NLS-1$
    ...
    public void test0536() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0536", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, false);
    ...
    public void test0537a() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0537", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, false);
        assertNotNull("No compilation unit", result);
    }
    ...
    public void test0537b() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0537", "B.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, false);
        assertNotNull("No compilation unit", result);
    }
    ...
    public void test0537c() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0537", "C.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, false);
        assertNotNull("No compilation unit", result);
    }
    ...
    public void test0538a() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0538", "A.java");
        try {
            sourceUnit.becomeWorkingCopy(null, null);
            sourceUnit.getBuffer().setContents("package test0538;\n" + "public class A {\n" + "  int i;\n" + "}");
    ...
    public void test0538e() throws JavaModelException {
        ...
        try {
            ...
            sourceUnit.becomeWorkingCopy(pbRequestor, null);
            // TODO improve test for AST.JLS8
            CompilationUnit unit = sourceUnit.reconcile(AST.JLS2, /*force pb detection*/
            true, null, null);
            ASTNode node = getASTNode(unit, 0);
            assertNotNull("No node", node);
            assertTrue("not a type declaration", node.getNodeType() == ASTNode.TYPE_DECLARATION);
    ...
    public void test0538g() throws JavaModelException {
        ...
        try {
            ...
            sourceUnit.becomeWorkingCopy(pbRequestor, null);
            sourceUnit.getBuffer().setContents("package test0538;\n" + "public class A {\n" + "  void foo() {\n" + "    new Object() {\n" + "      void bar() {\n" + "      }\n" + "    };\n" + "  }\n" + "}");
            sourceUnit.reconcile(ICompilationUnit.NO_AST, /* don't force pb detection*/
            false, null, null);
            // TODO improve test for AST.JLS8
            CompilationUnit unit = sourceUnit.reconcile(AST.JLS2, /*force pb detection*/
            true, null, null);
    ...
    public void test0539() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0539", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, false);
        final CompilationUnit unit = (CompilationUnit) result;
        //$NON-NLS-1$
    ...
    public void test0540() {
        ...
        //$NON-NLS-1$
        ASTNode result = runConversion(AST.JLS8, source, "Test.java", project, options, true);
        //$NON-NLS-1$
        assertNotNull("No compilation unit", result);
        //$NON-NLS-1$
        ...
        //$NON-NLS-1$ //$NON-NLS-2$
        assertEquals("Wrong package", "test0540", typeBinding.getPackage().getName());
        //$NON-NLS-1$
    ...
    public void test0541() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0541", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        final CompilationUnit unit = (CompilationUnit) result;
        //$NON-NLS-1$
        assertEquals("Wrong number of problems", 0, unit.getProblems().length);
    ...
    public void test0542() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0542", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        final CompilationUnit unit = (CompilationUnit) result;
        //$NON-NLS-1$
    ...
    public void test0543() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0543", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        final CompilationUnit unit = (CompilationUnit) result;
        //$NON-NLS-1$
        assertEquals("Wrong number of problems", 0, unit.getProblems().length);
    ...
    public void test0544() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0544", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        final CompilationUnit unit = (CompilationUnit) result;
        //$NON-NLS-1$
        assertEquals("Wrong number of problems", 1, unit.getProblems().length);
    ...
    public void test0545() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0545", "First.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        CompilationUnit unit = (CompilationUnit) result;
        //$NON-NLS-1$
        assertEquals("Wrong number of problems", 0, unit.getProblems().length);
        ...
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        sourceUnit = getCompilationUnit("Converter", "src", "test0545", "Second.java");
        ...
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        sourceUnit = getCompilationUnit("Converter", "src", "test0545", "Third.java");
        result = runConversion(AST.JLS8, sourceUnit, true);
        unit = (CompilationUnit) result;
        //$NON-NLS-1$
        assertEquals("Wrong number of problems", 0, unit.getProblems().length);
        ...
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        sourceUnit = getCompilationUnit("Converter", "src", "test0545", "Test.java");
        result = runConversion(AST.JLS8, sourceUnit, true);
        unit = (CompilationUnit) result;
        //$NON-NLS-1$
        assertEquals("Wrong number of problems", 0, unit.getProblems().length);
    ...
    public void test0546() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0546", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        final CompilationUnit unit = (CompilationUnit) result;
        //$NON-NLS-1$
        assertEquals("Wrong number of problems", 0, unit.getProblems().length);
        ...
        Expression initializer = fragment.getInitializer();
        //$NON-NLS-1$
        assertEquals("not a class instance creation", ASTNode.CLASS_INSTANCE_CREATION, initializer.getNodeType());
    ...
    public void test0547() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0547", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        CompilationUnit unit = (CompilationUnit) result;
        //$NON-NLS-1$
        assertEquals("Wrong number of problems", 1, unit.getProblems().length);
        ...
        BodyDeclaration bodyDeclaration = (BodyDeclaration) bodyDeclarations.get(0);
        //$NON-NLS-1$
        assertEquals("not a type declaration statement", ASTNode.TYPE_DECLARATION, bodyDeclaration.getNodeType());
    ...
    public void test0548() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0548", "PaletteStackEditPart.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, false);
        //$NON-NLS-1$
    ...
    public void test0549() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0549", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, false);
        //$NON-NLS-1$
        assertEquals("not a compilation unit", ASTNode.COMPILATION_UNIT, result.getNodeType());
    }
    ...
    public void test0550() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0550", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, false);
        //$NON-NLS-1$
        assertEquals("not a compilation unit", ASTNode.COMPILATION_UNIT, result.getNodeType());
    }
    ...
    public void test0551() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0551", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, false);
        //$NON-NLS-1$
        assertEquals("not a compilation unit", ASTNode.COMPILATION_UNIT, result.getNodeType());
    ...
    public void test0553() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0553", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertEquals("not a compilation unit", ASTNode.COMPILATION_UNIT, result.getNodeType());
        CompilationUnit unit = (CompilationUnit) result;
        final IProblem[] problems = unit.getProblems();
        //$NON-NLS-1$
        assertEquals("Wrong number of problems", 0, problems.length);
        ASTNode node = getASTNode(unit, 0, 0);
        assertEquals("Not a field declaration", ASTNode.FIELD_DECLARATION, node.getNodeType());
        FieldDeclaration fieldDeclaration = (FieldDeclaration) node;
        List fragments = fieldDeclaration.fragments();
    ...
    public void test0554() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0554", "B.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertEquals("not a compilation unit", ASTNode.COMPILATION_UNIT, result.getNodeType());
    ...
    public void test0555() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0555", "B.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertEquals("not a compilation unit", ASTNode.COMPILATION_UNIT, result.getNodeType());
    ...
    public void test0556() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0556", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertEquals("not a compilation unit", ASTNode.COMPILATION_UNIT, result.getNodeType());
    ...
    public void test0557() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0557", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertEquals("not a compilation unit", ASTNode.COMPILATION_UNIT, result.getNodeType());
    ...
    public void test0559() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0559", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertEquals("not a compilation unit", ASTNode.COMPILATION_UNIT, result.getNodeType());
    ...
    public void test0560() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0560", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertEquals("not a compilation unit", ASTNode.COMPILATION_UNIT, result.getNodeType());
    ...
    public void test0561() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0561", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertEquals("not a compilation unit", ASTNode.COMPILATION_UNIT, result.getNodeType());
    ...
    public void test0562() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0562", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertEquals("not a compilation unit", ASTNode.COMPILATION_UNIT, result.getNodeType());
    ...
    public void test0563() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0563", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertEquals("not a compilation unit", ASTNode.COMPILATION_UNIT, result.getNodeType());
    ...
    public void test0564() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0564", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertEquals("not a compilation unit", ASTNode.COMPILATION_UNIT, result.getNodeType());
    ...
    public void test0565() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0565", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertEquals("not a compilation unit", ASTNode.COMPILATION_UNIT, result.getNodeType());
    ...
    public void test0566() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0566", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertEquals("not a compilation unit", ASTNode.COMPILATION_UNIT, result.getNodeType());
    ...
    public void test0567() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0567", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertEquals("not a compilation unit", ASTNode.COMPILATION_UNIT, result.getNodeType());
    ...
    public void test0568() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0568", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertEquals("not a compilation unit", ASTNode.COMPILATION_UNIT, result.getNodeType());
    }
    ...
    public void test0570() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0570", "A.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertEquals("not a compilation unit", ASTNode.COMPILATION_UNIT, result.getNodeType());
        CompilationUnit unit = (CompilationUnit) result;
    ...
    public void test0573() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0573", "Z.java");
    ...
    public void test0574() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0574", "X.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertEquals("not a compilation unit", ASTNode.COMPILATION_UNIT, result.getNodeType());
        CompilationUnit unit = (CompilationUnit) result;
    ...
    public void test0575() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0575", "X.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertEquals("not a compilation unit", ASTNode.COMPILATION_UNIT, result.getNodeType());
        CompilationUnit unit = (CompilationUnit) result;
    ...
    public void test0576() throws JavaModelException {
        ...
        org.eclipse.jdt.core.jdom.IDOMCompilationUnit domCompilationUnit = factory.createCompilationUnit("package x; /** @model */ interface X  {}", "NAME");
    ...
    public void test0578() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0578", "X.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertEquals("not a compilation unit", ASTNode.COMPILATION_UNIT, result.getNodeType());
        CompilationUnit unit = (CompilationUnit) result;
    ...
    public void test0579() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0579", "ParserTask.java");
    ...
    public void test0580() throws JavaModelException {
        ...
        try {
            workingCopy = getWorkingCopy("/Converter/src/p/X.java", /*resolve*/
            true);
            String source = "package p;\n" + "public class X {\n" + "	d String[][]tab;\n" + "}";
            ASTNode node = buildAST(source, workingCopy, false);
            assertEquals("wrong type", ASTNode.COMPILATION_UNIT, node.getNodeType());
            CompilationUnit compilationUnit = (CompilationUnit) node;
            node = getASTNode(compilationUnit, 0, 0);
            assertEquals("wrong type", ASTNode.FIELD_DECLARATION, node.getNodeType());
            FieldDeclaration fieldDeclaration = (FieldDeclaration) node;
            checkSourceRange(fieldDeclaration, "d String[][]", source.toCharArray(), /*expectMalformed*/
            true);
            Type type = fieldDeclaration.getType();
            assertTrue("Not a simple type", type.isSimpleType());
            List fragments = fieldDeclaration.fragments();
    ...
    public void test0582() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0582", "X.java");
        IType[] types = sourceUnit.getTypes();
        assertEquals("wrong size", 1, types.length);
        IType type = types[0];
        IMethod[] methods = type.getMethods();
    ...
    public void test0583() throws JavaModelException {
        ...
        try {
            ...
            workingCopy = getWorkingCopy("/Converter/src/X.java", /*resolve*/
            true);
            ASTNode node = buildAST(contents, workingCopy);
            assertEquals("Not a compilation unit", ASTNode.COMPILATION_UNIT, node.getNodeType());
            CompilationUnit compilationUnit = (CompilationUnit) node;
    ...
    public void test0595() throws JavaModelException {
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0595", "X.java");
    ...
    public void test0597() throws JavaModelException {
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0597", "X.java");
    ...
    public void test0599() throws JavaModelException {
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0599", "X.java");
        ASTNode node = runJLS8Conversion(sourceUnit, true, false);
        assertNotNull(node);
        assertEquals("Not a compilation unit", ASTNode.COMPILATION_UNIT, node.getNodeType());
        CompilationUnit compilationUnit = (CompilationUnit) node;
        String expectedResult = "The hierarchy of the type X is inconsistent\n" + "The type test0599.Zork2 cannot be resolved. It is indirectly referenced from required .class files";
    ...
    public void test0600() throws JavaModelException {
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0600", "Try.java");
        ASTNode node = runJLS8Conversion(sourceUnit, true, false);
        assertNotNull(node);
        assertEquals("Not a compilation unit", ASTNode.COMPILATION_UNIT, node.getNodeType());
        CompilationUnit compilationUnit = (CompilationUnit) node;
        ...
        sourceUnit = getCompilationUnit("Converter", "src", "test0600", "C.java");
    ...
    public void test0602() throws JavaModelException {
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0602", "X.java");
        ASTNode node = runJLS8Conversion(sourceUnit, true, false);
        assertNotNull(node);
        assertEquals("Not a compilation unit", ASTNode.COMPILATION_UNIT, node.getNodeType());
        CompilationUnit compilationUnit = (CompilationUnit) node;
    ...
    public void test0603() throws JavaModelException {
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0603", "X.java");
        ASTNode node = runJLS8Conversion(sourceUnit, true, false);
        assertNotNull(node);
        assertEquals("Not a compilation unit", ASTNode.COMPILATION_UNIT, node.getNodeType());
        CompilationUnit compilationUnit = (CompilationUnit) node;
    ...
    public void test0604() throws JavaModelException {
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0604", "X.java");
        ASTNode node = runJLS8Conversion(sourceUnit, true, false);
        assertNotNull(node);
        assertEquals("Not a compilation unit", ASTNode.COMPILATION_UNIT, node.getNodeType());
        CompilationUnit compilationUnit = (CompilationUnit) node;
    ...
    public void test0605() throws JavaModelException {
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0605", "X.java");
        ASTNode node = runJLS8Conversion(sourceUnit, true, false);
        assertNotNull(node);
        assertEquals("Not a compilation unit", ASTNode.COMPILATION_UNIT, node.getNodeType());
        CompilationUnit compilationUnit = (CompilationUnit) node;
    ...
    public void test0610() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        final ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0610", "X.java");
    ...
    public void test0614() throws JavaModelException {
        ICompilationUnit workingCopy = null;
        try {
            String contents = "class T { void m() { for (i=0, j=0; i<10; i++, j++) ; }}";
            workingCopy = getWorkingCopy("/Converter/src/X.java", /*resolve*/
            false);
            ASTNode node = buildAST(contents, workingCopy, false);
    ...
    public void test0619() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0619", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, false);
        final CompilationUnit unit = (CompilationUnit) result;
        assertProblemsSize(unit, 0);
    ...
    public void test0624() throws JavaModelException {
        ICompilationUnit workingCopy = null;
        try {
            String contents = "public class X extend {}";
            workingCopy = getWorkingCopy("/Converter/src/X.java", /*resolve*/
            true);
            ASTNode node = buildAST(contents, workingCopy, false);
            assertEquals("Not a compilation unit", ASTNode.COMPILATION_UNIT, node.getNodeType());
            CompilationUnit unit = (CompilationUnit) node;
            String expectedOutput = "Syntax error on token \"extend\", delete this token";
            assertProblemsSize(unit, 1, expectedOutput);
            unit.accept(new ASTVisitor() {
    ...
    public void test0625() {
        ...
        IJavaProject project = getJavaProject("Converter");
        //$NON-NLS-1$
        ASTNode result = runConversion(AST.JLS8, source, "Test.java", project);
        //$NON-NLS-1$
        assertNotNull("No compilation unit", result);
        //$NON-NLS-1$
        assertTrue("result is not a compilation unit", result instanceof CompilationUnit);
        ...
        ITypeBinding typeBinding = typeDeclaration.resolveBinding();
        //$NON-NLS-1$
        assertNull("Got a type binding", typeBinding);
    }
    ...
    public void test0626() {
        ...
        IJavaProject project = getJavaProject("Converter");
        //$NON-NLS-1$
        ASTNode result = runConversion(AST.JLS8, source, "Object.java", project);
        //$NON-NLS-1$
        assertNotNull("No compilation unit", result);
        //$NON-NLS-1$
        assertTrue("result is not a compilation unit", result instanceof CompilationUnit);
    ...
    public void test0627() throws JavaModelException {
        ...
        try {
            ...
            assertEquals("Not a compilation unit", ASTNode.COMPILATION_UNIT, node.getNodeType());
            CompilationUnit unit = (CompilationUnit) node;
            String expectedOutput = "The method error() is undefined for the type X";
            assertProblemsSize(unit, 1, expectedOutput);
            node = getASTNode(unit, 0, 0, 1);
            assertEquals("Not an expression statement", ASTNode.EXPRESSION_STATEMENT, node.getNodeType());
            Expression expression = ((ExpressionStatement) node).getExpression();
    ...
    public void test0629() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0629", "X.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true, true);
        //$NON-NLS-1$
        assertEquals("Not a compilation unit", ASTNode.COMPILATION_UNIT, result.getNodeType());
        CompilationUnit compilationUnit = (CompilationUnit) result;
        String expectedOutput = "Syntax error on token \",\", invalid Expression";
    ...
    public void test0630() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0630", "X.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true, true);
        //$NON-NLS-1$
        assertEquals("Not a compilation unit", ASTNode.COMPILATION_UNIT, result.getNodeType());
        CompilationUnit compilationUnit = (CompilationUnit) result;
    ...
    public void test0631() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0631", "X.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true, true);
        //$NON-NLS-1$
        assertEquals("Not a compilation unit", ASTNode.COMPILATION_UNIT, result.getNodeType());
        CompilationUnit compilationUnit = (CompilationUnit) result;
        String expectedOutput = "Syntax error, insert \"}\" to complete ArrayInitializer\n" + "Syntax error, insert \";\" to complete FieldDeclaration\n" + "Syntax error, insert \"}\" to complete ClassBody";
        ...
        assertEquals("wrong size", 1, fragments.size());
        VariableDeclarationFragment fragment = (VariableDeclarationFragment) fragments.get(0);
        checkSourceRange(fragment, "s =  {\"\",,,", source, /*expectMalformed*/
        true);
    ...
    public void test0635() throws JavaModelException {
        ...
        try {
            ...
            workingCopy = getWorkingCopy("/Converter/src/X.java", /*resolve*/
            true);
            ASTNode node = buildAST(contents, workingCopy, true);
            assertEquals("Not a compilation unit", ASTNode.COMPILATION_UNIT, node.getNodeType());
            CompilationUnit unit = (CompilationUnit) node;
            assertProblemsSize(unit, 0);
            node = getASTNode(unit, 0, 0);
    ...
    public void _test0642() throws JavaModelException {
        ICompilationUnit workingCopy = null;
        try {
            String contents = "import java.awt.Point;\n" + "public class X {\n" + "	public void foo(Point p, int[] a) {\n" + "	   p.x;\n" + "	}\n" + "}";
            workingCopy = getWorkingCopy("/Converter/src/X.java", /*resolve*/
            true);
            ASTNode node = buildAST(contents, workingCopy, false, true);
            assertEquals("Not a compilation unit", ASTNode.COMPILATION_UNIT, node.getNodeType());
            CompilationUnit unit = (CompilationUnit) node;
    ...
    public void test0653() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0653", "X.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        assertEquals("Not a compilation unit", ASTNode.COMPILATION_UNIT, result.getNodeType());
        CompilationUnit unit = (CompilationUnit) result;
    ...
    public void test0657() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0657", "X.java");
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit2 = getCompilationUnit("Converter", "src", "test0657", "A.java");
        ...
        resolveASTs(new ICompilationUnit[] { sourceUnit, sourceUnit2 }, new String[0], requestor, getJavaProject("Converter"), sourceUnit.getOwner());
    ...
    public void _test0658() {
        ...
        String errors = "Syntax error on token(s), misplaced construct(s)\n" + "Syntax error, insert \";\" to complete BlockStatements\n" + "Syntax error on token(s), misplaced construct(s)\n" + "Syntax error, insert \";\" to complete Statement";
    ...
    public void test0662() throws JavaModelException {
        ...
        try {
            ...
            assertEquals("Not a compilation unit", ASTNode.COMPILATION_UNIT, node.getNodeType());
            CompilationUnit unit = (CompilationUnit) node;
            String expectedLog = "The assignment to variable x has no effect\n" + "Duplicate local variable x\n" + "The assignment to variable x has no effect";
    ...
    public void test0666() throws JavaModelException {
        ICompilationUnit workingCopy = null;
        try {
            String contents = "import java.util.ArrayList;\n" + "\n" + "public class X {\n" + "	protected String foo() {\n" + "		List c = new ArrayList();\n" + "		c.add(null);\n" + "		return c;\n" + "	}\n" + "}";
            workingCopy = getWorkingCopy("/Converter/src/X.java", /*resolve*/
            true);
            ASTNode node = buildAST(contents, workingCopy, false, true, true);
            assertEquals("Not a compilation unit", ASTNode.COMPILATION_UNIT, node.getNodeType());
            CompilationUnit unit = (CompilationUnit) node;
    ...
    public void test0666_2() throws JavaModelException {
        ...
        try {
            ...
            workingCopy = getWorkingCopy("/Converter/src/X.java", /*resolve*/
            true);
            ASTNode node = buildAST(contents, workingCopy, false, true, false);
            assertEquals("Not a compilation unit", ASTNode.COMPILATION_UNIT, node.getNodeType());
            CompilationUnit unit = (CompilationUnit) node;
            String expectedError = "List cannot be resolved to a type";
            assertProblemsSize(unit, 1, expectedError);
    ...
    public void test0669() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0669", "UIPerformChangeOperation.java");
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true, true);
        assertNotNull(result);
    }
    ...
    public void test0676() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0676", "X.java");
    ...
    public void test0677() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0677", "A.java");
    ...
    public void test0680() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0680", "SAMPLE_UTF8.java");
        ASTNode node = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("Not a compilation unit", node.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit compilationUnit = (CompilationUnit) node;
        assertProblemsSize(compilationUnit, 0);
    ...
    public void test0681() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "Sample", "Sample.java");
        ASTNode node = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("Not a compilation unit", node.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit compilationUnit = (CompilationUnit) node;
    ...
    public void test0682() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0682", "Test.java");
        ASTNode node = runConversion(AST.JLS8, sourceUnit, true, true);
        //$NON-NLS-1$
        assertTrue("Not a compilation unit", node.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) node;
        assertProblemsSize(unit, 2, "Variable must provide either dimension expressions or an array initializer\n" + "Syntax error on token \"String\", [ expected after this token");
        node = getASTNode(unit, 0, 1, 0);
        assertEquals("Not a expression statement", ASTNode.EXPRESSION_STATEMENT, node.getNodeType());
        ExpressionStatement expressionStatement = (ExpressionStatement) node;
    ...
    public void test0683() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0683", "Test.java");
        ASTNode node = runConversion(AST.JLS8, sourceUnit, true, true);
        //$NON-NLS-1$
        assertTrue("Not a compilation unit", node.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) node;
    ...
    public void test0684() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0684", "X.java");
        ASTNode node = runConversion(AST.JLS8, sourceUnit, true, true);
        //$NON-NLS-1$
        assertTrue("Not a compilation unit", node.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) node;
    ...
    public void test0685() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0685", "C.java");
        ASTNode node = runConversion(AST.JLS8, sourceUnit, true, true);
        //$NON-NLS-1$
        assertTrue("Not a compilation unit", node.getNodeType() == ASTNode.COMPILATION_UNIT);
        CompilationUnit unit = (CompilationUnit) node;
    ...
    public void test0688() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0688", "X.java");
        IType[] types = sourceUnit.getTypes();
        assertNotNull(types);
        assertEquals("wrong size", 1, types.length);
        IType type = types[0];
    ...
    public void test0689() throws JavaModelException {
        ...
        try {
            ...
            //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
            ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0689", "X.java");
            ASTNode result = runConversion(AST.JLS8, sourceUnit, true, true);
            assertNotNull(result);
    ...
    public void test0690() throws JavaModelException {
        ...
        try {
            ...
            project.setRawClasspath(newClasspath, null);
            //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
            ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0690", "X.java");
    ...
    public void test0691() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit unit = getCompilationUnit("Converter", "src", "test0691", "X.java");
    ...
    public void test0692() throws JavaModelException {
        ICompilationUnit workingCopy = null;
        try {
            String contents = "/*start*/public class X {\n" + "	int k;\n" + "	Zork z;\n" + "}/*end*/";
            workingCopy = getWorkingCopy("/Converter/src/X.java", /*resolve*/
            true);
            TypeDeclaration typeDeclaration = (TypeDeclaration) buildAST(contents, workingCopy, false, false, false);
    ...
    public void test0693() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit unit = getCompilationUnit("Converter", "src", "test0693", "X.java");
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit unit2 = getCompilationUnit("Converter", "src", "test0693", "Y.java");
        ASTParser parser = ASTParser.newParser(AST.JLS8);
    ...
    public void test0694() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit unit = getCompilationUnit("Converter", "src", "test0694", "X.java");
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit unit2 = getCompilationUnit("Converter", "src", "test0694", "Y.java");
        ASTParser parser = ASTParser.newParser(AST.JLS8);
        ASTRequestor requestor = new ASTRequestor() {
        };
        ICompilationUnit[] cus = new ICompilationUnit[2];
    ...
    public void test0695() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit unit = getCompilationUnit("Converter", "src", "test0695", "X.java");
        ASTParser parser = ASTParser.newParser(AST.JLS8);
        parser.setKind(ASTParser.K_COMPILATION_UNIT);
    ...
    public void test0696() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit unit = getCompilationUnit("Converter", "src", "test0696", "X.java");
        ASTParser parser = ASTParser.newParser(AST.JLS8);
        parser.setKind(ASTParser.K_COMPILATION_UNIT);
        parser.setSource(unit.getSource().toCharArray());
        Map options = JavaCore.getOptions();
    ...
    public void test0697() throws JavaModelException {
        ...
        try {
            ...
            workingCopy = getWorkingCopy("/Converter/src/X.java", /*resolve*/
            true);
            MethodDeclaration methodDeclaration = (MethodDeclaration) buildAST(contents, workingCopy, false, false, true);
            Block body = methodDeclaration.getBody();
    ...
    public void test0698a() throws JavaModelException {
        ...
        try {
            ...
            workingCopy = getWorkingCopy("/Converter/src/X.java", /*resolve*/
            true);
            ExpressionStatement statement = (ExpressionStatement) buildAST(contents, workingCopy, false, true, true);
    ...
    public void test0698b() throws JavaModelException {
        ...
        try {
            ...
            workingCopy = getWorkingCopy("/Converter/src/X.java", /*resolve*/
            true);
            VariableDeclarationStatement statement = (VariableDeclarationStatement) buildAST(contents, workingCopy, false, true, true);
    ...
    public void test0699() throws JavaModelException {
        ICompilationUnit workingCopy = null;
        try {
            workingCopy = getWorkingCopy("/Converter/src/example/Test.java", /*resolve*/
            true);
            String contents = "package example;\n" + "public class Test {\n" + "	public void test() throws Throwable {\n" + "		B /*start*/b = new B()/*end*/;\n" + "	}\n" + "}";
            ...
            parser.setResolveBindings(true);
            parser.setKind(ASTParser.K_COMPILATION_UNIT);
            parser.createASTs(new ICompilationUnit[] { workingCopy }, new String[] { key }, new ASTRequestor() {
                ...
                public void acceptAST(ICompilationUnit source, CompilationUnit astCompilationUnit) {
                }
            }, null);
        } finally {
            if (workingCopy != null) {
    ...
    public void test0718() throws JavaModelException {
        ...
        try {
            ...
            CompilationUnit unit = (CompilationUnit) buildAST(contents, workingCopy, false);
    ...
    public void test0719() throws JavaModelException {
        ...
        try {
            ...
            true);
            String contents = "public class X {}";
            CompilationUnit unit = (CompilationUnit) buildAST(contents, workingCopy, true);
            ...
            "void", "java.lang.AssertionError", "java.lang.Class", "java.lang.Cloneable", "java.lang.Error", "java.lang.Exception", "java.lang.Object", "java.lang.RuntimeException", "java.lang.String", "java.lang.StringBuffer", "java.lang.Throwable", "java.io.Serializable", "java.lang.Boolean", "java.lang.Byte", "java.lang.Character", "java.lang.Double", "java.lang.Float", "java.lang.Integer", "java.lang.Long", "java.lang.Short", "java.lang.Void" };
            // no-so-well-known bindings
            String[] nwkbs = { //$NON-NLS-1$
            "verylong", "java.lang.Math", "com.example.MyCode" };
    ...
    public void test0720() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "test0720", "A.java");
        char[] source = sourceUnit.getSource().toCharArray();
        ASTNode result = runConversion(AST.JLS8, sourceUnit, true);
        //$NON-NLS-1$
        assertTrue("not a compilation unit", result.getNodeType() == ASTNode.COMPILATION_UNIT);
        ...
        MethodDeclaration declaration = (MethodDeclaration) node;
        assertTrue("A constructor", !declaration.isConstructor());
        checkSourceRange(declaration, "public void method(final int parameter) {     }", source, /*expectMalformed*/
        true);
    }
    ...
    public void test0721() throws JavaModelException {
        ...
        try {
            ...
            workingCopy = getWorkingCopy("/Converter/src/X.java", /*resolve*/
            true);
            TryStatement statement = (TryStatement) buildAST(getJLS3(), contents, workingCopy, false, true, true);
    ...
    public void test0725() throws JavaModelException {
        ICompilationUnit workingCopy = null;
        try {
            String contents = "package one.two;\n" + "public class one {}";
            workingCopy = getWorkingCopy("/Converter/src/one/two/one.java", /*resolve*/
            true);
            CompilationUnit unit = (CompilationUnit) buildAST(getJLS3(), contents, workingCopy, true, true, true);
    ...
    public void testBug443942() throws JavaModelException {
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ICompilationUnit sourceUnit = getCompilationUnit("Converter", "src", "org.eclipse.swt.internal.gtk", "A.java");
        try {
            ReconcilerTests.ProblemRequestor pbRequestor = new ReconcilerTests.ProblemRequestor() {
            ...
            sourceUnit.becomeWorkingCopy(pbRequestor, null);
            sourceUnit.getBuffer().setContents("package org.eclipse.swt.internal.gtk;\n" + "public class X {\n" + "  public static final native long /*int*/ realpath(byte[] path, byte[] realPath);\n" + "}");
            // TODO improve test for AST.JLS8
