...
public class RepeatableAnnotationTest extends AbstractComparableTest {
    ...
    public // verify that deprecation warning does not show up when the deprecated element is used in the same file defining it.
    void testDeprecation2() {
