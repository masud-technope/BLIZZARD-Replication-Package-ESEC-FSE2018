 ...
 */
    ...
    public void test003() throws JavaModelException {
        ...
        assertResults("return[JAVADOC_BLOCK_TAG]{@return, null, null, return, null, " + this.positions + JAVADOC_RELEVANCE + "}");
    }

    public void test004() throws JavaModelException {
        String source = "package javadoc.methods;\n" + "public class Test {\n" + "	/**\n" + "	 * Completion with several letters:\n" + "	 * 	@ser\n" + "	 */\n" + "	public void foo() {}\n" + "}\n";
        completeInJavadoc("/Completion/src/javadoc/methods/Test.java", source, true, "@ser");
        assertResults("serialData[JAVADOC_BLOCK_TAG]{@serialData, null, null, serialData, null, " + this.positions + JAVADOC_RELEVANCE + "}");
    }

    public void test005() throws JavaModelException {
        String source = "package javadoc.methods;\n" + "public class Test {\n" + "	/**\n" + "	 * Completion on full tag name:\n" + "	 * 	@inheritDoc\n" + "	 */\n" + "	public void foo() {}\n" + "}\n";
        completeInJavadoc("/Completion/src/javadoc/methods/Test.java", source, true, "@inheritDoc");
        assertResults("inheritDoc[JAVADOC_INLINE_TAG]{{@inheritDoc}, null, null, inheritDoc, null, " + this.positions + JAVADOC_RELEVANCE + "}");
    }
 ...
 */
    ...
    public void test012() throws JavaModelException {
        ...
        completeInJavadoc("/Completion/src/javadoc/methods/tags/BasicTestMethods.java", source, true, "BasicTestMethodsE");
        assertSortedResults("BasicTestMethodsException1[TYPE_REF]{BasicTestMethodsException1, javadoc.methods.tags, Ljavadoc.methods.tags.BasicTestMethodsException1;, null, null, " + this.positions + R_DRICUNRE + "}\n" + "BasicTestMethodsException2[TYPE_REF]{BasicTestMethodsException2, javadoc.methods.tags, Ljavadoc.methods.tags.BasicTestMethodsException2;, null, null, " + this.positions + R_DRICUNRE + "}\n" + "BasicTestMethodsExample[TYPE_REF]{BasicTestMethodsExample, javadoc.methods.tags, Ljavadoc.methods.tags.BasicTestMethodsExample;, null, null, " + this.positions + R_DRICUNR + "}");
    }

    public void test013() throws JavaModelException {
        String source = "package javadoc.methods.tags;\n" + "public class BasicTestMethods {\n" + "\n" + "	/**\n" + "	 * Completion after:\n" + "	 * 	@throws BasicTestMethodsE\n" + "	 */\n" + "	public void foo() throws BasicTestMethodsException2 {}\n" + "}\n" + "class BasicTestMethodsException1 extends Exception{}\n" + "class BasicTestMethodsException2 extends Exception{}\n" + "class BasicTestMethodsExample {\n" + "}\n";
        completeInJavadoc("/Completion/src/javadoc/methods/tags/BasicTestMethods.java", source, true, "BasicTestMethodsE");
        assertSortedResults("BasicTestMethodsException2[TYPE_REF]{BasicTestMethodsException2, javadoc.methods.tags, Ljavadoc.methods.tags.BasicTestMethodsException2;, null, null, " + this.positions + R_DRICUNREEET + "}\n" + "BasicTestMethodsException1[TYPE_REF]{BasicTestMethodsException1, javadoc.methods.tags, Ljavadoc.methods.tags.BasicTestMethodsException1;, null, null, " + this.positions + R_DRICUNRE + "}\n" + "BasicTestMethodsExample[TYPE_REF]{BasicTestMethodsExample, javadoc.methods.tags, Ljavadoc.methods.tags.BasicTestMethodsExample;, null, null, " + this.positions + R_DRICUNR + "}");
    }

    public void test014() throws JavaModelException {
        String source = "package javadoc.methods.tags;\n" + "public class BasicTestMethods {\n" + "\n" + "	/**\n" + "	 * Completion after:\n" + "	 * 	@throws \n" + "	 */\n" + "	public void foo() throws BasicTestMethodsException {}\n" + "}\n" + "class BasicTestMethodsException extends Exception{}\n" + "class BasicTestMethodsExample {\n" + "}\n";
        // completion on empty token
        completeInJavadoc("/Completion/src/javadoc/methods/tags/BasicTestMethods.java", source, true, "@throws ", 0);
        if (CompletionEngine.NO_TYPE_COMPLETION_ON_EMPTY_TOKEN) {
            assertResults("BasicTestMethodsException[TYPE_REF]{BasicTestMethodsException, javadoc.methods.tags, Ljavadoc.methods.tags.BasicTestMethodsException;, null, null, " + this.positions + R_DRICUNREET + "}");
        } else {
 ...
 */
    public void test020() throws JavaModelException {
        ...
        assertResults("foo[FIELD_REF]{foo, Ljavadoc.methods.tags.BasicTestMethods;, I, foo, null, " + this.positions + R_DRICNRNS + "}\n" + "foo[METHOD_REF]{foo(), Ljavadoc.methods.tags.BasicTestMethods;, ()V, foo, null, " + this.positions + R_DRICNRNS + "}");
    }
 ...
 */
    ...
    public void test031() throws JavaModelException {
        ...
        String source = "package javadoc.methods.tags;\n" + "public class BasicTestMethods {\n" + "	/**\n" + "	 * Completion after:\n" + "	 * 	@see #fo\n" + "	 */\n" + "	<T> void foo() {}\n" + "	void bar(String str, boolean flag, Object obj) {}\n" + "}\n";
        completeInJavadoc("/Completion/src/javadoc/methods/tags/BasicTestMethods.java", source, true, "fo");
        assertResults("foo[METHOD_REF]{foo(), Ljavadoc.methods.tags.BasicTestMethods;, <T:Ljava.lang.Object;>()V, foo, null, " + this.positions + R_DRICNRNS + "}");
    }
    ...
    public void test032() throws JavaModelException {
        ...
        assertResults("bar[METHOD_REF]{bar(String, boolean, Object), Ljavadoc.methods.tags.BasicTestMethods;, (Ljava.lang.String;ZLjava.lang.Object;)V, bar, (str, flag, obj), " + this.positions + R_DRICNRNS + "}");
    }
    ...
    public void test033() throws JavaModelException {
        ...
        completeInJavadoc("/Completion/src/javadoc/methods/tags/BasicTestMethods.java", source, true, "ba");
        assertResults("bar[METHOD_REF]{bar(String, Class, Class), Ljavadoc.methods.tags.BasicTestMethods;, <T:Ljava.lang.Object;U:Ljava.lang.Object;>(Ljava.lang.String;Ljava.lang.Class<TT;>;Ljava.lang.Class<TU;>;)V, bar, (str, clt, clu), " + this.positions + R_DRICNRNS + "}");
    }
    ...
    public void test041() throws JavaModelException {
        ...
        assertResults("bar[METHOD_REF]{bar(String, boolean, Object), Ljavadoc.methods.tags.BasicTestMethods;, (Ljava.lang.String;ZLjava.lang.Object;)V, bar, (str, flag, obj), " + this.positions + R_DRICENUNR + "}");
    }
    ...
    public void test042() throws JavaModelException {
        ...
        assertResults("String[TYPE_REF]{String, java.lang, Ljava.lang.String;, null, null, " + this.positions + R_DRICUNR + "}");
    }
    ...
    public void test044() throws JavaModelException {
        ...
        assertResults("String[TYPE_REF]{String, java.lang, Ljava.lang.String;, null, null, " + this.positions + R_DRICNR + "}");
    }
    ...
    public void test049() throws JavaModelException {
        ...
        assertResults("boolean[KEYWORD]{boolean, null, null, boolean, null, " + this.positions + R_DRICNR + "}");
    }
 ...
 */
    ...
    public void test053() throws JavaModelException {
        ...
        assertResults("Object[TYPE_REF]{Object, java.lang, Ljava.lang.Object;, null, null, " + this.positions + R_DRICENUNR + "}");
    }
 ...
 */
    ...
    public void test056() throws JavaModelException {
        ...
        assertResults("foo[METHOD_REF]{foo(String), Ljavadoc.methods.tags.OtherTypes;, (Ljava.lang.String;)V, foo, (str), " + this.positions + R_DRICENUNR + "}");
    }
    ...
    public void test058() throws JavaModelException {
        ...
        // 2nd occurrence
        completeInJavadoc("/Completion/src/javadoc/methods/tags/BasicTestMethods.java", source, true, "meth", 2);
        assertResults("method[METHOD_REF]{method(), Ljavadoc.methods.tags.BasicTestMethods;, ()V, method, null, " + this.positions + R_DRICNRNS + "}");
    }
    ...
    public void test059() throws JavaModelException {
        ...
        // 2nd occurrence
        completeInJavadoc("/Completion/src/javadoc/methods/tags/BasicTestMethods.java", source, true, "meth", 2);
        assertResults("method[METHOD_REF]{method(String, boolean, Object), Ljavadoc.methods.tags.BasicTestMethods;, (Ljava.lang.String;ZLjava.lang.Object;)V, method, (str, flag, obj), " + this.positions + R_DRICNRNS + "}\n" + "method[METHOD_REF]{method(), Ljavadoc.methods.tags.BasicTestMethods;, ()V, method, null, " + this.positions + R_DRICNRNS + "}");
    }
    ...
    public void test061() throws JavaModelException {
        ...
        // 2nd occurrence
        completeInJavadoc("/Completion/src/javadoc/methods/tags/BasicTestMethods.java", source, true, "meth", 2);
        assertResults("method[METHOD_REF]{method(String, boolean, Object), Ljavadoc.methods.tags.BasicTestMethods;, (Ljava.lang.String;ZLjava.lang.Object;)V, method, (str, flag, obj), [116, 145], " + R_DRICNRNS + "}\n" + "method[METHOD_REF]{method(), Ljavadoc.methods.tags.BasicTestMethods;, ()V, method, null, [116, 145], " + R_DRICNRNS + "}");
    }
    ...
    public void _test062() throws JavaModelException {
        ...
        // 2nd occurrence
        completeInJavadoc("/Completion/src/javadoc/methods/tags/BasicTestMethods.java", source, true, "meth", 2);
        assertResults("method[METHOD_REF]{method(String, boolean, Object), Ljavadoc.methods.tags.BasicTestMethods;, (Ljava.lang.String;ZLjava.lang.Object;)V, method, (str, flag, obj), " + this.positions + R_DRICUNR + "}\n" + "method[METHOD_REF]{method(), Ljavadoc.methods.tags.BasicTestMethods;, ()V, method, null, " + this.positions + R_DRICUNR + "}");
    }
 ...
 */
    public void test070() throws JavaModelException {
        ...
        assertResults("str[JAVADOC_PARAM_REF]{str, null, null, str, null, " + this.positions + (JAVADOC_RELEVANCE + R_INTERESTING) + "}");
    }
    ...
    public void test071() throws JavaModelException {
        ...
        assertResults("xstr[JAVADOC_PARAM_REF]{xstr, null, null, xstr, null, " + this.positions + (JAVADOC_RELEVANCE + R_INTERESTING) + "}");
    }
    ...
    public void test078() throws JavaModelException {
        ...
        completeInJavadoc("/Completion/src/javadoc/methods/tags/BasicTestMethods.java", source, true, "xstr");
        assertResults("xstr2[JAVADOC_PARAM_REF]{xstr2, null, null, xstr2, null, " + this.positions + (JAVADOC_RELEVANCE + R_INTERESTING) + "}");
    }
    ...
    public void test084() throws JavaModelException {
        String source = "package javadoc.methods.tags;\n" + "public class BasicTestMethods {\n" + "	/**\n" + "	 * Completion after:\n" + "	 * 	@param xstr\n" + "	 * 	@param xstr\n" + "	 * 	@param xstr2\n" + "	 */\n" + "	public String foo(String xstr, String xstr2) {\n" + "		return null;\n" + "	}\n" + "}\n";
        // 3rd position
        completeInJavadoc("/Completion/src/javadoc/methods/tags/BasicTestMethods.java", source, true, "xstr", 3);
        assertResults("xstr2[JAVADOC_PARAM_REF]{xstr2, null, null, xstr2, null, " + this.positions + (JAVADOC_RELEVANCE + R_INTERESTING) + "}");
    }
    ...
    public void test086() throws JavaModelException {
        ...
        // empty token
        completeInJavadoc("/Completion/src/javadoc/methods/tags/BasicTestMethods.java", source, true, "** 	@param ", 0);
        assertResults("flag[JAVADOC_PARAM_REF]{flag, null, null, flag, null, " + this.positions + (JAVADOC_RELEVANCE + R_INTERESTING + 1) + "}\n" + "obj[JAVADOC_PARAM_REF]{obj, null, null, obj, null, " + this.positions + (JAVADOC_RELEVANCE + R_INTERESTING) + "}");
    }
    ...
    public void test087() throws JavaModelException {
        ...
        // empty token
        completeInJavadoc("/Completion/src/javadoc/methods/tags/BasicTestMethods.java", source, true, "@param ", 0);
        assertResults("xstr[JAVADOC_PARAM_REF]{xstr, null, null, xstr, null, " + this.positions + (JAVADOC_RELEVANCE + R_INTERESTING + 1) + "}\n" + "obj[JAVADOC_PARAM_REF]{obj, null, null, obj, null, " + this.positions + (JAVADOC_RELEVANCE + R_INTERESTING) + "}");
    }
    ...
    public void test088() throws JavaModelException {
        ...
        // empty token
        completeInJavadoc("/Completion/src/javadoc/methods/tags/BasicTestMethods.java", source, true, "** 	@param ", 0);
        assertResults("flag[JAVADOC_PARAM_REF]{flag, null, null, flag, null, " + this.positions + (JAVADOC_RELEVANCE + R_INTERESTING) + "}");
    }
    ...
    public void test090() throws JavaModelException {
        ...
        assertResults("obj[JAVADOC_PARAM_REF]{obj, null, null, obj, null, " + this.positions + (JAVADOC_RELEVANCE + R_INTERESTING) + "}");
    }
 ...
 */
    ...
    public void test102() throws JavaModelException {
        ...
        // empty token
        completeInJavadoc("/Completion/src/javadoc/methods/tags/BasicTestMethods.java", source, true, "** 	@param ", 0);
        assertSortedResults("xtm[JAVADOC_PARAM_REF]{xtm, null, null, xtm, null, " + this.positions + (JAVADOC_RELEVANCE + R_INTERESTING) + "}");
    }
    ...
    public void test104() throws JavaModelException {
        ...
        // empty token
        completeInJavadoc("/Completion/src/javadoc/methods/tags/BasicTestMethods.java", source, true, "** 	@param ", 0);
        assertSortedResults("TM[JAVADOC_PARAM_REF]{<TM>, null, null, TM, null, " + this.positions + JAVADOC_RELEVANCE + "}");
    }
    ...
    public void test106() throws JavaModelException {
        ...
        String source = "package javadoc.methods.tags;\n" + "public class BasicTestMethods<TC> {\n" + "	/**\n" + "	 * Completion after:\n" + "	 * 	@param <\n" + "	 */\n" + "	<TM> void foo(Class<TM> xtm, Class<TC> xtc) {}\n" + "}\n";
        // 2nd occurence
        completeInJavadoc("/Completion/src/javadoc/methods/tags/BasicTestMethods.java", source, true, "<", 2);
        assertSortedResults("TM[JAVADOC_PARAM_REF]{<TM>, null, null, TM, null, " + this.positions + JAVADOC_RELEVANCE + "}");
    }
    ...
    public void test107() throws JavaModelException {
        ...
        String source = "package javadoc.methods.tags;\n" + "public class BasicTestMethods<TC> {\n" + "	/**\n" + "	 * Completion after:\n" + "	 * 	@param <T\n" + "	 */\n" + "	<TM> void foo(Class<TM> xtm, Class<TC> xtc) {}\n" + "}\n";
        // 2nd occurence
        completeInJavadoc("/Completion/src/javadoc/methods/tags/BasicTestMethods.java", source, true, "<T", 2);
        assertSortedResults("TM[JAVADOC_PARAM_REF]{<TM>, null, null, TM, null, " + this.positions + JAVADOC_RELEVANCE + "}");
    }
    ...
    public void test108() throws JavaModelException {
        ...
        String source = "package javadoc.methods.tags;\n" + "public class BasicTestMethods<TC> {\n" + "	/**\n" + "	 * Completion after:\n" + "	 * 	@param <TC\n" + "	 */\n" + "	<TM> void foo(Class<TM> xtm, Class<TC> xtc) {}\n" + "}\n";
        // 2nd occurence
        completeInJavadoc("/Completion/src/javadoc/methods/tags/BasicTestMethods.java", source, true, "<TC", 2);
        assertSortedResults("");
    }
    ...
    public void test112() throws JavaModelException {
        ...
        String source = "package javadoc.methods.tags;\n" + "public class BasicTestMethods<TC> {\n" + "	/**\n" + "	 * Completion after:\n" + "	 * 	@param <TM>\n" + "	 * 	@param <TM>\n" + "	 */\n" + "	<TM> void foo(Class<TM> xtm, Class<TC> xtc) {}\n" + "}\n";
        // 2nd occurence
        completeInJavadoc("/Completion/src/javadoc/methods/tags/BasicTestMethods.java", source, true, "<TM>", 2);
        assertSortedResults("");
    }
    ...
    public void test113() throws JavaModelException {
        ...
        completeInJavadoc("/Completion/src/javadoc/methods/tags/BasicTestMethods.java", source, true, "@param ", 0);
        assertSortedResults("ab1[JAVADOC_PARAM_REF]{ab1, null, null, ab1, null, " + this.positions + (JAVADOC_RELEVANCE + R_INTERESTING + 1) + "}\n" + "ab2[JAVADOC_PARAM_REF]{ab2, null, null, ab2, null, " + this.positions + (JAVADOC_RELEVANCE + R_INTERESTING) + "}");
    }
    ...
    public void test114() throws JavaModelException {
        ...
        // empty token
        completeInJavadoc("/Completion/src/javadoc/methods/tags/BasicTestMethods.java", source, true, "@param ", 0);
        assertSortedResults("xtm[JAVADOC_PARAM_REF]{xtm, null, null, xtm, null, " + this.positions + (R_DEFAULT + 14) + "}\n" + "xtc[JAVADOC_PARAM_REF]{xtc, null, null, xtc, null, " + this.positions + (R_DEFAULT + 13) + "}\n" + "TM[JAVADOC_PARAM_REF]{<TM>, null, null, TM, null, " + this.positions + JAVADOC_RELEVANCE + "}");
    }
 ...
 */
    public void test130() throws JavaModelException {
        ...
        // 2nd occurence
        completeInJavadoc("/Completion/src/javadoc/methods/tags/BasicTestMethods.java", source, true, "BasicTest", 2);
        assertResults("BasicTestMethods[METHOD_REF<CONSTRUCTOR>]{BasicTestMethods(int, float, Class), Ljavadoc.methods.tags.BasicTestMethods;, (IFLjava.lang.Class;)V, BasicTestMethods, (xxx, real, clazz), " + this.positions + R_DRINR + "}\n" + "BasicTestMethods[METHOD_REF<CONSTRUCTOR>]{BasicTestMethods(), Ljavadoc.methods.tags.BasicTestMethods;, ()V, BasicTestMethods, null, " + this.positions + R_DRINR + "}");
    }
    ...
    public void test132() throws JavaModelException {
        ...
        // 2nd occurence
        completeInJavadoc("/Completion/src/javadoc/methods/tags/BasicTestMethods.java", source, true, "BasicTest", 2);
        assertResults("BasicTestMethods[METHOD_REF<CONSTRUCTOR>]{BasicTestMethods(int, float, Class), Ljavadoc.methods.tags.BasicTestMethods;, <T:Ljava.lang.Object;>(IFLjava.lang.Class<TT;>;)V, BasicTestMethods, (xxx, real, clazz), " + this.positions + R_DRINR + "}\n" + "BasicTestMethods[METHOD_REF<CONSTRUCTOR>]{BasicTestMethods(), Ljavadoc.methods.tags.BasicTestMethods;, ()V, BasicTestMethods, null, " + this.positions + R_DRINR + "}");
    }

    public void test133() throws JavaModelException {
        String source = "package javadoc.methods.tags;\n" + "public class BasicTestMethods {\n" + "	/**\n" + "	 * Completion after:\n" + "	 * 	@see BasicTestMethods#BasicTest\n" + "	 */\n" + "	BasicTestMethods() {}\n" + "	BasicTestMethods(int xxx, float real, Class clazz) {}\n" + "}\n";
        // 3rd occurence
        completeInJavadoc("/Completion/src/javadoc/methods/tags/BasicTestMethods.java", source, true, "BasicTest", 3);
        assertResults("BasicTestMethods[METHOD_REF<CONSTRUCTOR>]{BasicTestMethods(int, float, Class), Ljavadoc.methods.tags.BasicTestMethods;, (IFLjava.lang.Class;)V, BasicTestMethods, (xxx, real, clazz), " + this.positions + R_DRINR + "}\n" + "BasicTestMethods[METHOD_REF<CONSTRUCTOR>]{BasicTestMethods(), Ljavadoc.methods.tags.BasicTestMethods;, ()V, BasicTestMethods, null, " + this.positions + R_DRINR + "}");
    }
    ...
    public void test135() throws JavaModelException {
        String[] sources = { "/Completion/src/javadoc/methods/tags/BasicTestMethods.java", "package javadoc.methods.tags;\n" + "public class BasicTestMethods {\n" + "	/**\n" + "	 * Completion after:\n" + "	 * 	@see OtherTypes#O\n" + "	 */\n" + "	void foo() {};\n" + "}", "/Completion/src/javadoc/methods/tags/OtherTypes.java", "package javadoc.methods.tags;\n" + "public class OtherTypes {\n" + "	OtherTypes() {};\n" + "}" };
        // 2nd occurence
        completeInJavadoc(sources, true, "O", 2);
        assertResults("OtherTypes[METHOD_REF<CONSTRUCTOR>]{OtherTypes(), Ljavadoc.methods.tags.OtherTypes;, ()V, OtherTypes, null, " + this.positions + R_DRINR + "}");
    }
    ...
    public void test149() throws JavaModelException {
        ...
        completeInJavadoc("/Completion/src/javadoc/methods/tags/BasicTestMethods.java", source, true, "BasicTestMethods(");
        assertResults("BasicTestMethods[METHOD_REF<CONSTRUCTOR>]{BasicTestMethods(), Ljavadoc.methods.tags.BasicTestMethods;, ()V, BasicTestMethods, null, " + this.positions + R_DRINR + "}");
    }
    ...
    public void test151() throws JavaModelException {
        ...
        assertResults("int[KEYWORD]{int, null, null, int, null, " + this.positions + R_DRICENNR + "}\n" + "InterruptedException[TYPE_REF]{InterruptedException, java.lang, Ljava.lang.InterruptedException;, null, null, " + this.positions + R_DRIUNR + "}");
    }
    ...
    public void test152() throws JavaModelException {
        ...
        assertResults("float[KEYWORD]{float, null, null, float, null, " + this.positions + R_DRICNR + "}");
    }
    ...
    public void test153() throws JavaModelException {
        ...
        assertResults("float[KEYWORD]{float, null, null, float, null, " + this.positions + R_DRICENNR + "}");
    }
    ...
    public void test154() throws JavaModelException {
        ...
        assertResults("Class[TYPE_REF]{Class, java.lang, Ljava.lang.Class;, null, null, " + this.positions + R_DRICUNR + "}");
    }
    ...
    public void test156() throws JavaModelException {
        ...
        assertResults("Class[TYPE_REF]{Class, java.lang, Ljava.lang.Class;, null, null, " + this.positions + R_DRICNR + "}");
    }
    ...
    public void test157() throws JavaModelException {
        ...
        assertResults("Class[TYPE_REF]{Class, java.lang, Ljava.lang.Class;, null, null, " + this.positions + R_DRICENUNR + "}");
    }
 ...
 */
    ...
    public void test161() throws JavaModelException {
        ...
        try {
            ...
            assertResults("oneTwoThree[METHOD_REF]{oneTwoThree(int), Ljavadoc.methods.tags.BasicTestMethods;, (I)V, oneTwoThree, (i), " + this.positions + (R_DEFAULT + 25) + "}");
        } finally {
            JavaCore.setOptions(this.oldOptions);
        }
    }
    ...
    public void test162() throws JavaModelException {
        ...
        assertResults("oneTwoThree[METHOD_REF]{oneTwoThree(Object...), Ljavadoc.methods.tags.BasicTestMethods;, ([Ljava.lang.Object;)V, oneTwoThree, (o), " + this.positions + R_DRICNRNS + "}");
    }
    ...
    public void test163() throws JavaModelException {
        ...
        assertResults("BasicTestMethods[METHOD_REF<CONSTRUCTOR>]{BasicTestMethods(Object...), Ljavadoc.methods.tags.BasicTestMethods;, ([Ljava.lang.Object;)V, BasicTestMethods, (o), " + this.positions + R_DRINR + "}");
    }
    ...
    public void test164() throws JavaModelException {
        ...
        completeInJavadoc("/Completion/src/javadoc/types/Depr.java", source, true, "fo", 1);
        assertResults("foo[METHOD_REF]{foo(), Ljavadoc.types.Depr;, ()V, foo, null, " + this.positions + R_DRICNRNS + "}");
    }
}
