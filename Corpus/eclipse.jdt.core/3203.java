...
public class StringLiteral extends Expression {
	 ...
	 * @since 3.0
	 */
    public static final SimplePropertyDescriptor ESCAPED_VALUE_PROPERTY = //$NON-NLS-1$
    new SimplePropertyDescriptor(StringLiteral.class, "escapedValue", String.class, MANDATORY);
    ...
    public void setLiteralValue(String value) {
        ...
        // opening delimiter //$NON-NLS-1$
        b.append("\"");
        for (int i = 0; i < len; i++) {
            char c = value.charAt(i);
            Util.appendEscapedChar(b, c, true);
        }
        // closing delimiter //$NON-NLS-1$
        b.append("\"");
