 ...
 */
    public void test0001() {
        ...
        String expectedUnitDisplayString = "public @<SelectOnType:MyAnn> class X {\n" + "  public X() {\n" + "  }\n" + "}\n";
        ...
        checkDietParse(str.toCharArray(), selectionStart, selectionEnd, expectedCompletionNodeToString, expectedUnitDisplayString, completionIdentifier, expectedReplacedSource, testName);
    }
 ...
 */
    public void test0002() {
        String str = "public @MyAnn.ZZ class X {		\n" + "}											\n";
        String selection = "MyAnn";
        String expectedCompletionNodeToString = "<SelectOnType:MyAnn>";
        String completionIdentifier = "MyAnn";
        String expectedUnitDisplayString = "public @<SelectOnType:MyAnn> class X {\n" + "  public X() {\n" + "  }\n" + "}\n";
 ...
 */
    public void test0003() {
        ...
        String expectedUnitDisplayString = "public @<SelectOnType:MyAnn.ZZ> class X {\n" + "  public X() {\n" + "  }\n" + "}\n";
 ...
 */
    public void test0006() {
        String str = "public  class X {" + "  public @MyAnn void foo() {" + "  }" + "}											\n";
        String selection = "MyAnn";
        String expectedCompletionNodeToString = "<SelectOnType:MyAnn>";
        String completionIdentifier = "MyAnn";
 ...
 */
    public void test0008() {
        String str = "public  class X {" + "  public @MyAnn Object var;" + "}											\n";
        String selection = "MyAnn";
        String expectedCompletionNodeToString = "<SelectOnType:MyAnn>";
        String completionIdentifier = "MyAnn";
 ...
 */
    public void test0010() {
        String str = "public class X {" + "  public void foo(@MyAnn int i) {" + "  }" + "}											\n";
        String selection = "MyAnn";
        String expectedCompletionNodeToString = "<SelectOnType:MyAnn>";
        String completionIdentifier = "MyAnn";
 ...
 */
    public void test0011() {
        String str = "public class X {" + "  public @MyAnn class Y {" + "  }" + "}											\n";
        String selection = "MyAnn";
        String expectedCompletionNodeToString = "<SelectOnType:MyAnn>";
        String completionIdentifier = "MyAnn";
 ...
 */
    public void test0014() {
        String str = "public @MyAnn(A.B) class X {" + "}											\n";
        String selection = "MyAnn";
        String expectedCompletionNodeToString = "<SelectOnType:MyAnn>";
        String completionIdentifier = "MyAnn";
        String expectedUnitDisplayString = "public @<SelectOnType:MyAnn>(A.B) class X {\n" + "  public X() {\n" + "  }\n" + "}\n";
        String expectedReplacedSource = "MyAnn";
        String testName = "<select type>";
        int selectionStart = str.lastIndexOf(selection);
        int selectionEnd = str.lastIndexOf(selection) + selection.length() - 1;
 ...
 */
    public void test0015() {
        String str = "public @MyAnn(value = \"\") class X {" + "}											\n";
        String selection = "MyAnn";
        String expectedCompletionNodeToString = "<SelectOnType:MyAnn>";
        String completionIdentifier = "MyAnn";
        String expectedUnitDisplayString = "public @<SelectOnType:MyAnn>(value = \"\") class X {\n" + "  public X() {\n" + "  }\n" + "}\n";
        String expectedReplacedSource = "MyAnn";
        String testName = "<select type>";
        int selectionStart = str.lastIndexOf(selection);
        int selectionEnd = str.lastIndexOf(selection) + selection.length() - 1;
 ...
 */
    public void test0016() {
        String str = "public @MyAnn(value1 = \"\", value2 = \"\") class X {" + "}											\n";
        String selection = "MyAnn";
        String expectedCompletionNodeToString = "<SelectOnType:MyAnn>";
        String completionIdentifier = "MyAnn";
        String expectedUnitDisplayString = "public @<SelectOnType:MyAnn>(value1 = \"\",value2 = \"\") class X {\n" + "  public X() {\n" + "  }\n" + "}\n";
        String expectedReplacedSource = "MyAnn";
        String testName = "<select type>";
        int selectionStart = str.lastIndexOf(selection);
        int selectionEnd = str.lastIndexOf(selection) + selection.length() - 1;
 ...
 */
    public void test0017() {
        ...
        String expectedUnitDisplayString = "public @MyAnn(<SelectOnName:value1>,value2 = \"\") class X {\n" + "  public X() {\n" + "  }\n" + "}\n";
