 ...
 */
    public TypeBinding checkFieldAccess(BlockScope scope) {
        ...
        if ((this.indexOfFirstFieldBinding == 1 || declaringClass.isEnum()) && TypeBinding.equalsEquals(methodScope.enclosingSourceType(), declaringClass) && methodScope.lastVisibleFieldID >= 0 && fieldBinding.id >= methodScope.lastVisibleFieldID && (!fieldBinding.isStatic() || methodScope.isStatic)) {
    ...
    public void generateCode(BlockScope currentScope, CodeStream codeStream, boolean valueRequired) {
        ...
        if (// nothing to do if type ref
        (this.bits & Binding.VARIABLE) == 0) {
 ...
 */
                                    ...
                                    if (TypeBinding.notEquals(initialFieldBinding.declaringClass, this.actualReceiverType.erasure())) {
                                        if (lastFieldBinding.canBeSeenBy(lastReceiverType, this, currentScope)) {
                                            ...
                                            if (accessor == null) {
                                                ...
                                                codeStream.invoke(/* default declaringClass */
                                                Opcodes.OPC_invokestatic, accessor, null);
                                            }
                                        } else {
                                            codeStream.generateEmulatedReadAccessForField(lastFieldBinding);
                                        }
    ...
    public TypeBinding getOtherFieldBindings(BlockScope scope) {
        ...
        if ((this.bits & Binding.FIELD) != 0) {
            if (//must check for the static status....
            !((FieldBinding) this.binding).isStatic()) {
 ...
 */
    public TypeBinding reportError(BlockScope scope) {
        ...
        if ((this.binding instanceof ProblemFieldBinding && ((ProblemFieldBinding) this.binding).problemId() == NotFound) || (this.binding instanceof ProblemBinding && ((ProblemBinding) this.binding).problemId() == NotFound)) {
