 ...
 */
    public static IClassFile getClassFile(IJavaProject project, String rootPath, String packageName, String className) throws JavaModelException {
 ...
 */
    public static ICompilationUnit getCompilationUnit(IJavaProject javaProject, String packageName, String unitName) throws JavaModelException {
        if (javaProject == null)
            return null;
 ...
 */
    public static List getCompilationUnits(IJavaProject javaProject) throws JavaModelException {
 ...
 * @return List of org.eclipse.jdt.core.ICompilationUnit
 */
    public static List getCompilationUnits(IPackageFragmentRoot root) throws JavaModelException {
        List allUnits = new ArrayList();
    ...
    public static IPackageFragmentRoot getExternalJarFile(IJavaProject project, String jarSimpleName) throws JavaModelException {
 ...
 * Returns the IPath to the external java class library (e.g. jclMin.jar)
 */
    public static IPath getExternalJCLPath(String compliance) {
 ...
 * Returns the java.io path to the external java class library (e.g. jclMin.jar)
 */
    public static String getExternalJCLPathString(String compliance) {
 ...
 * Returns the IPath to the source of the external java class library (e.g. jclMinsrc.zip)
 */
    public static IPath getExternalJCLSourcePath(String compliance) {
 ...
 * Returns the java.io path to the source of the external java class library (e.g. jclMinsrc.zip)
 */
    public static String getExternalJCLSourcePathString(String compliance) {
 ...
 */
    public static IPackageFragment getPackageFragment(IJavaProject project, String rootPath, String packageName) throws JavaModelException {
 ...
 */
    public static IPackageFragmentRoot getPackageFragmentRoot(IJavaProject project, String rootPath) throws JavaModelException {
        if (project == null) {
            return null;
        }
 ...
 */
    public static String getPluginDirectoryPath(String type) {
        try {
    ...
    public static String getSourceWorkspacePath(String workspace) {
 ...
 */
    public static void setupExternalJCL(String jclName) throws IOException {
    ...
    public static void setUpJCLClasspathVariables(String compliance) throws JavaModelException, IOException {
        if ("1.8".equals(compliance)) {
            if (JavaCore.getClasspathVariable("JCL18_LIB") == null) {
                setupExternalJCL("jclMin1.8");
                JavaCore.setClasspathVariables(new String[] { "JCL18_LIB", "JCL18_SRC", "JCL_SRCROOT" }, new IPath[] { getExternalJCLPath(compliance), getExternalJCLSourcePath(compliance), getExternalJCLRootSourcePath() }, null);
            }
        } else if ("1.7".equals(compliance)) {
            if (JavaCore.getClasspathVariable("JCL17_LIB") == null) {
                setupExternalJCL("jclMin1.7");
                JavaCore.setClasspathVariables(new String[] { "JCL17_LIB", "JCL17_SRC", "JCL_SRCROOT" }, new IPath[] { getExternalJCLPath(compliance), getExternalJCLSourcePath(compliance), getExternalJCLRootSourcePath() }, null);
            }
        } else if ("1.5".equals(compliance)) {
            if (JavaCore.getClasspathVariable("JCL15_LIB") == null) {
                setupExternalJCL("jclMin1.5");
                JavaCore.setClasspathVariables(new String[] { "JCL15_LIB", "JCL15_SRC", "JCL_SRCROOT" }, new IPath[] { getExternalJCLPath(compliance), getExternalJCLSourcePath(compliance), getExternalJCLRootSourcePath() }, null);
            }
        } else {
