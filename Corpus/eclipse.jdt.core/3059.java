...
public class ProblemTypeAndMethodTest extends AbstractRegressionTest {
    ...
    public void test001() {
        ...
        true, /* no custom options */
        null, /* do not generate output */
        true, /* do not show category */
    ...
    public void test005() {
        ...
        runNegativeTest(/* do not flush output directory */
        false, new String[] /* test files */
        { //-----------------------------------------------------------------------
        "X.java", "public class X {\n" + "	void foo() {\n" + "		p.OtherFoo ofoo = new p.OtherFoo();\n" + "		ofoo.bar();\n" + "		q1.q2.Zork z;\n" + "	}\n" + "}	\n" }, /* no class libraries */
        null, /* no custom options */
        null, // compiler results
        ...
        JavacTestOptions.SKIP_UNTIL_FRAMEWORK_FIX);
    }
    ...
    public void test032() {
        this.runNegativeTest(new String[] { //-----------------------------------------------------------------------
        "X.java", "import existing.*;\n" + "public class X {\n" + "  void foo(p.Zork z) {}\n" + "  void bar(Zork z) {} // should bind to existing.Zork\n" + "}\n", //-----------------------------------------------------------------------
        "p/Clyde.java", // just so package p does exist
        "package p;\n" + "public class Clyde {\n" + "}\n", //-----------------------------------------------------------------------
    ...
    public void test048() {
        this.runNegativeTest(new String[] { //-----------------------------------------------------------------------
        "X.java", "public class X extends X1 {\n" + "	X(X1 x1) {\n" + "		super(x1);\n" + "	}\n" + "}\n", //-----------------------------------------------------------------------
        "X1.java", "public class X1 {\n" + "	public X1(Zork z) {}\n" + "}\n" }, "----------\n" + "1. ERROR in X.java (at line 3)\n" + "	super(x1);\n" + "	^^^^^^^^^^\n" + "The constructor X1(Zork) refers to the missing type Zork\n" + "----------\n" + "----------\n" + "1. ERROR in X1.java (at line 2)\n" + "	public X1(Zork z) {}\n" + "	          ^^^^\n" + "Zork cannot be resolved to a type\n" + "----------\n");
    }
    ...
    public void test089() {
        ...
        this.runConformTest(new String[] { // ================
        "com/foo/bar/baz/reporting/dom/ReportExceptionBase.java", "package com.foo.bar.baz.reporting.dom;\n" + "public class ReportExceptionBase extends Exception  {\n" + "}\n", // ================
    ...
    public void test124b() {
        ...
        compilerOptions.put(CompilerOptions.OPTION_ReportMethodCanBePotentiallyStatic, CompilerOptions.ERROR);
        compilerOptions.put(CompilerOptions.OPTION_ReportNonStaticAccessToStatic, CompilerOptions.IGNORE);
        this.runNegativeTest(new String[] { "X.java", "public class X {\n" + "   public static X xField;" + // don't warn
        "	public void method1() {\n" + "		Foo.m(this.xField);\n" + "	}\n" + "static class Foo{\n" + "	static void m(X bug) {\n" + "		\n" + "	}\n" + "}\n" + "}" }, "", /* no extra class libraries */
        null, /* flush output directory */
        true, compilerOptions);
    }
    ...
    public void test376550_13() {
        ...
        null, /* flush output directory */
        true, null, compilerOptions, /* custom options */
        null);
    }
    ...
    public void test378674_comment21a() {
        runStaticWarningConformTest("X.java", "public class X<P extends Exception> {\n" + "	final <T> void foo(T x) throws P {\n" + "	}\n" + "}\n" + "");
    }
