...
public class LocalDeclaration extends AbstractVariableDeclaration {
    ...
    public FlowInfo analyseCode(BlockScope currentScope, FlowContext flowContext, FlowInfo flowInfo) {
        ...
        boolean shouldAnalyseResource = this.binding != null && flowInfo.reachMode() == FlowInfo.REACHABLE && currentScope.compilerOptions().analyseResourceLeaks && FakedTrackingVariable.isAnyCloseable(this.initialization.resolvedType);
    ...
    public void generateCode(BlockScope currentScope, CodeStream codeStream) {
        ...
        generateInit: {
            ...
            if (this.binding.type.isArrayType() && (// arrayLoc = (type[])null
    ...
    public void resolve(BlockScope scope) {
        ...
        TypeBinding variableType = this.type.resolveType(scope, /* check bounds*/
        true);
        ...
        this.binding = new LocalVariableBinding(this, variableType, this.modifiers, /*isArgument*/
        false);
        ...
        if (this.initialization != null) {
            if (this.initialization instanceof ArrayInitializer) {
                ...
                if (initializationType != null) {
                    ...
                    TypeBinding.notEquals(variableType, initializationType))
    ...
    public // recovered from lonely identifier or identifier cluster ?
    boolean isRecoveredFromLoneIdentifier() {
