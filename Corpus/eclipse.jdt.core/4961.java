...
public class VariableDeclarationExpression extends Expression {
    ...
    new SimplePropertyDescriptor(VariableDeclarationExpression.class, "modifiers", int.class, MANDATORY);
    ...
    new ChildListPropertyDescriptor(VariableDeclarationExpression.class, "modifiers", IExtendedModifier.class, CYCLE_RISK);
    ...
    new ChildPropertyDescriptor(VariableDeclarationExpression.class, "type", Type.class, MANDATORY, NO_CYCLE_RISK);
    ...
    new ChildListPropertyDescriptor(VariableDeclarationExpression.class, "fragments", VariableDeclarationFragment.class, CYCLE_RISK);
