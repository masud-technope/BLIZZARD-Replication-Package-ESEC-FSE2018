            ...
            if (CharOperation.equals(attributeName, ExceptionsName)) {
                ...
                if (entriesNumber == 0) {
                    ...
                    for (int j = 0; j < entriesNumber; j++) {
                        utf8Offset = constantPoolOffsets[u2At(constantPoolOffsets[u2At(readOffset)] - structOffset + 1)] - structOffset;
 ...
 */
    ...
    public String toString() {
        ...
        ((modifiers & 0x0080) == 0x0080 ? "transient " : "")).append(getSelector()).append(desc).append(//$NON-NLS-1$
        "}").toString();
    }
}
