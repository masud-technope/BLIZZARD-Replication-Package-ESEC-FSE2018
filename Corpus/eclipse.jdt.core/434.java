...
public class DietRecoveryTest extends AbstractCompilerTest {
    ...
    public void checkParse(char[] source, String expectedDietUnitToString, String expectedDietPlusBodyUnitToString, String expectedDietPlusBodyPlusStatementsRecoveryUnitToString, String expectedFullUnitToString, String expectedCompletionDietUnitToString, String testName) {
        /* using regular parser in DIET mode */
        {
            ...
            assertEquals("Invalid unit diet structure" + testName, expectedDietUnitToString, computedUnitToString);
        }
        /* using regular parser in DIET mode + getMethodBodies */
        {
            ...
            assertEquals("Invalid unit diet+body structure" + testName, expectedDietPlusBodyUnitToString, computedUnitToString);
        }
        /* using regular parser in DIET mode + getMethodBodies + statements recovery */
        {
            ...
            assertEquals("Invalid unit diet+body structure with statements recovery" + testName, expectedDietPlusBodyPlusStatementsRecoveryUnitToString, computedUnitToString);
        }
        /* using regular parser in FULL mode */
        {
            ...
            assertEquals("Invalid unit full structure" + testName, expectedFullUnitToString, computedUnitToString);
        }
        /* using source element parser in DIET mode */
        {
            SourceElementParser parser = new SourceElementParser(new TestSourceElementRequestor(), new DefaultProblemFactory(Locale.getDefault()), new CompilerOptions(getCompilerOptions()), /*don't record local declarations*/
            false, /*optimize string literals*/
            true);
            ICompilationUnit sourceUnit = new CompilationUnit(source, testName, null);
            CompilationResult compilationResult = new CompilationResult(sourceUnit, 0, 0, 0);
            CompilationUnitDeclaration computedUnit = parser.dietParse(sourceUnit, compilationResult);
        ...
        /* using source element parser in FULL mode */
        {
            ...
            assertEquals("Invalid source element full structure" + testName, expectedFullUnitToString, computedUnitToString);
        }
        /* using completion parser in DIET mode */
        {
            ...
            assertEquals("Invalid completion diet structure" + testName, expectedCompletionDietUnitToString, computedUnitToString);
        }
    }
 ...
 */
    public void test01() {
        ...
        checkParse(s.toCharArray(), expectedDietUnitToString, expectedDietPlusBodyUnitToString, expectedDietPlusBodyUnitToString, expectedFullUnitToString, expectedCompletionDietUnitToString, testName);
    }
 ...
 */
    public void test02() {
        ...
        checkParse(s.toCharArray(), expectedDietUnitToString, expectedDietPlusBodyUnitToString, expectedDietPlusBodyPlusStatementsRecoveryUnitToString, expectedFullUnitToString, expectedCompletionDietUnitToString, testName);
    }
 ...
 */
    public void _test32() {
        ...
        if (this.complianceLevel <= ClassFileConstants.JDK1_4) {
            expectedDietPlusBodyPlusStatementsRecoveryUnitToString = "public class WB2 {\n" + "  public WB2() {\n" + "    super();\n" + "  }\n" + "  public void foo() {\n" + "    java.util.Locale.java.util.Vector $missing$;\n" + "  }\n" + "}\n";
        } else {
            expectedDietPlusBodyPlusStatementsRecoveryUnitToString = expectedDietPlusBodyUnitToString;
        }
        String expectedFullUnitToString = expectedDietUnitToString;
        String expectedCompletionDietUnitToString = expectedDietUnitToString;
 ...
 */
    public void test91() {
        ...
        String expectedDietUnitToString = "public interface Fred {\n" + "  void foo();\n" + "  void bar();\n" + "  public fred(X x, int y);\n" + "}\n";
        String expectedDietPlusBodyUnitToString = expectedDietUnitToString;
        String expectedFullUnitToString = expectedDietUnitToString;
        String expectedCompletionDietUnitToString = expectedDietUnitToString;
 ...
 */
    public void test95() {
        ...
        String expectedDietUnitToString = "public interface IP {\n" + "  public static toString() {\n" + "  }\n" + "}\n";
        String expectedDietPlusBodyUnitToString = expectedDietUnitToString;
        String expectedFullUnitToString = expectedDietUnitToString;
        String expectedCompletionDietUnitToString = expectedDietUnitToString;
 ...
 */
    ...
    public void _test124() {
        ...
        String expectedDietPlusBodyPlusStatementsRecoveryUnitToString = null;
        if (this.complianceLevel <= ClassFileConstants.JDK1_4) {
            expectedDietPlusBodyPlusStatementsRecoveryUnitToString = "public class Test {\n" + "  public Test() {\n" + "    super();\n" + "  }\n" + "  void aMethod() {\n" + "    m1();\n" + "    {\n" + "      int a;\n" + "      int b;\n" + "    }\n" + "    m2();\n" + "    {\n" + "      int c;\n" + "      int d;\n" + "    }\n" + "  }\n" + "}\n";
        } else {
            expectedDietPlusBodyPlusStatementsRecoveryUnitToString = "public class Test {\n" + "  public Test() {\n" + "    super();\n" + "  }\n" + "  void aMethod() {\n" + "  }\n" + "}\n";
        }
    ...
    public void test126() {
        ...
        String expectedDietPlusBodyPlusStatementsRecoveryUnitToString = "package p;\n" + "public class ContextTest {\n" + "  private Context context = new Context();\n" + "  public ContextTest() {\n" + "    super();\n" + "  }\n" + "  public void test() {\n" + "    context.new Callback() {\n" + "      public void doit(int value) {\n" + "      }\n" + "    };\n" + "  }\n" + "}\n";
        String expectedFullUnitToString = expectedDietUnitToString;
        String expectedCompletionDietUnitToString = "package p;\n" + "public class ContextTest {\n" + "  private Context context;\n" + "  public ContextTest() {\n" + "  }\n" + "  public void test() {\n" + "  }\n" + "}\n";
        String testName = "test";
        checkParse(s.toCharArray(), expectedDietUnitToString, expectedDietPlusBodyUnitToString, expectedDietPlusBodyPlusStatementsRecoveryUnitToString, expectedFullUnitToString, expectedCompletionDietUnitToString, testName);
    }
    ...
    public void test405778() {
        ...
        String expectedDietUnitToString = "import java.util.Collection;\n" + "public class E {\n" + "  public E() {\n" + "  }\n" + "  public void __test1() {\n" + "  }\n" + "}\n";
        String expectedDietPlusBodyUnitToString = "import java.util.Collection;\n" + "public class E {\n" + "  public E() {\n" + "    super();\n" + "  }\n" + "  public void __test1() {\n" + "  }\n" + "}\n";
        String expectedDietPlusBodyPlusStatementsRecoveryUnitToString = "import java.util.Collection;\n" + "public class E {\n" + "  public E() {\n" + "    super();\n" + "  }\n" + "  public void __test1() {\n" + "    Object o = new Object();\n" + "    if ((o.hashCode() != 0))\n" + "        {\n" + "          o = $missing$;\n" + "        }\n" + "  }\n" + "}\n";
        String expectedFullUnitToString = "import java.util.Collection;\n" + "public class E {\n" + "  public E() {\n" + "  }\n" + "  public void __test1() {\n" + "  }\n" + "}\n";
        String expectedCompletionDietUnitToString = "import java.util.Collection;\n" + "public class E {\n" + "  public E() {\n" + "  }\n" + "  public void __test1() {\n" + "  }\n" + "}\n";
        String testName = "test";
        checkParse(s.toCharArray(), expectedDietUnitToString, expectedDietPlusBodyUnitToString, expectedDietPlusBodyPlusStatementsRecoveryUnitToString, expectedFullUnitToString, expectedCompletionDietUnitToString, testName);
    }
    ...
    public void test456861() {
        String s = "import java.awt.Point;\n" + "public class Test {\n" + "	public void foo(Point p, int[] a) {\n" + "		String s1 = \"\";\n" + "		s.;\n" + "	}\n" + " }";
        String expectedDietUnitToString = "import java.awt.Point;\n" + "public class Test {\n" + "  public Test() {\n" + "  }\n" + "  public void foo(Point p, int[] a) {\n" + "  }\n" + "}\n";
        String expectedDietPlusBodyUnitToString = "import java.awt.Point;\n" + "public class Test {\n" + "  public Test() {\n" + "    super();\n" + "  }\n" + "  public void foo(Point p, int[] a) {\n" + "  }\n" + "}\n";
        String expectedDietPlusBodyPlusStatementsRecoveryUnitToString = "import java.awt.Point;\n" + "public class Test {\n" + "  public Test() {\n" + "    super();\n" + "  }\n" + "  public void foo(Point p, int[] a) {\n" + "    String s1 = \"\";\n" + "    s = $missing$;\n" + "  }\n" + "}\n";
        String expectedFullUnitToString = "import java.awt.Point;\n" + "public class Test {\n" + "  public Test() {\n" + "  }\n" + "  public void foo(Point p, int[] a) {\n" + "  }\n" + "}\n";
        String expectedCompletionDietUnitToString = "import java.awt.Point;\n" + "public class Test {\n" + "  public Test() {\n" + "  }\n" + "  public void foo(Point p, int[] a) {\n" + "  }\n" + "}\n";
        String testName = "test";
        checkParse(s.toCharArray(), expectedDietUnitToString, expectedDietPlusBodyUnitToString, expectedDietPlusBodyPlusStatementsRecoveryUnitToString, expectedFullUnitToString, expectedCompletionDietUnitToString, testName);
    }
}
