...
public class MemberRef extends ASTNode implements IDocElement {
    ...
    new ChildPropertyDescriptor(MemberRef.class, "qualifier", Name.class, OPTIONAL, NO_CYCLE_RISK);
    ...
    new ChildPropertyDescriptor(MemberRef.class, "name", SimpleName.class, MANDATORY, NO_CYCLE_RISK);
	 ...
	 */
    int treeSize() {
        return memSize() + (this.optionalQualifier == null ? 0 : getQualifier().treeSize()) + (this.memberName == null ? 0 : getName().treeSize());
    }
}
