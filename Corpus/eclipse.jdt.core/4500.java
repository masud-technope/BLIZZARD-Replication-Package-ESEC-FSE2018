...
public class JDIStackFrame implements EvaluationConstants, RuntimeConstants {
    ...
    public  JDIStackFrame(VirtualMachine jdiVM, DebugEvaluationTest test, String userCode, String breakpointClassName, String breakpointMethodName, int breakpointLine) {
        this(jdiVM, test, userCode, breakpointClassName, breakpointMethodName, breakpointLine, 10000);
    }
    ...
    public char[] declaringTypeName() {
        if (// if not in a code snippet
        this.breakpointLine != Integer.MAX_VALUE) {
