...
public class JavadocTestOptions extends JavadocTest {
    ...
    private void runErrorsTest(String[] testFiles, int visibility, boolean isMethod) {
        String[] errors = isMethod ? errorsForInvalidTagsMethodOrConstructor(visibility) : errorsForInvalidTagsClassOrField(visibility);
        int length = errors.length;
        ...
        runNegativeTest(testFiles, expectedProblemLog.toString(), JavacTestOptions.Excuse.EclipseWarningConfiguredAsError);
    }
    ...
    protected void checkCompilerLog(String[] testFiles, Requestor requestor, String[] alternatePlatformIndependantExpectedLogs, Throwable exception) {
        ...
        switch(firstChar) {
            ...
            case 'C':
                ...
                break;
            default:
                super.checkCompilerLog(testFiles, requestor, alternatePlatformIndependantExpectedLogs, exception);
                return;
        }
    ...
    private String resultForMissingTags(int visibility) {
        ...
        } else // Private level is always reported as it never overrides...
        if (visibility == this.PRIVATE_VISIBILITY) {
    ...
    private String resultForMissingComments(int visibility) {
        ...
        } else // Private level is always reported for as it never overrides...
        if (visibility == this.PRIVATE_VISIBILITY) {
	...
	*/
    ...
    public void testInvalidTagsClassErrorTagsPublic() {
        ...
        runNegativeTest(CLASSES_INVALID_COMMENT, resultForInvalidTagsClassOrField(this.PUBLIC_VISIBILITY), JavacTestOptions.Excuse.EclipseWarningConfiguredAsError);
    }
    ...
    public void testInvalidTagsFieldErrorTagsPublic() {
        ...
        this.reportInvalidJavadocTags = CompilerOptions.ENABLED;
        this.reportInvalidJavadocTagsVisibility = CompilerOptions.PUBLIC;
        runNegativeTest(FIELDS_INVALID_COMMENT, resultForInvalidTagsClassOrField(this.PUBLIC_VISIBILITY), JavacTestOptions.Excuse.EclipseWarningConfiguredAsError);
    }
    ...
    public void testInvalidTagsMethodErrorTagsPublic() {
        ...
        this.reportInvalidJavadocTags = CompilerOptions.ENABLED;
        this.reportInvalidJavadocTagsVisibility = CompilerOptions.PUBLIC;
        runNegativeTest(METHODS_INVALID_COMMENT, resultForInvalidTagsMethodOrConstructor(this.PUBLIC_VISIBILITY), JavacTestOptions.Excuse.EclipseWarningConfiguredAsError);
    }
    ...
    public void testInvalidTagsConstructorErrorTagsPublic() {
        ...
        this.reportInvalidJavadocTags = CompilerOptions.ENABLED;
        this.reportInvalidJavadocTagsVisibility = CompilerOptions.PUBLIC;
        runNegativeTest(CONSTRUCTORS_INVALID_COMMENT, resultForInvalidTagsMethodOrConstructor(this.PUBLIC_VISIBILITY), JavacTestOptions.Excuse.EclipseWarningConfiguredAsError);
    }
    ...
    public void testInvalidTagsClassErrorTagsProtected() {
        ...
        runNegativeTest(CLASSES_INVALID_COMMENT, resultForInvalidTagsClassOrField(this.PROTECTED_VISIBILITY), JavacTestOptions.Excuse.EclipseWarningConfiguredAsError);
    }
    ...
    public void testInvalidTagsFieldErrorTagsProtected() {
        ...
        this.reportInvalidJavadocTags = CompilerOptions.ENABLED;
        this.reportInvalidJavadocTagsVisibility = CompilerOptions.PROTECTED;
        runNegativeTest(FIELDS_INVALID_COMMENT, resultForInvalidTagsClassOrField(this.PROTECTED_VISIBILITY), JavacTestOptions.Excuse.EclipseWarningConfiguredAsError);
    }
    ...
    public void testInvalidTagsMethodErrorTagsProtected() {
        ...
        this.reportInvalidJavadocTags = CompilerOptions.ENABLED;
        this.reportInvalidJavadocTagsVisibility = CompilerOptions.PROTECTED;
        runNegativeTest(METHODS_INVALID_COMMENT, resultForInvalidTagsMethodOrConstructor(this.PROTECTED_VISIBILITY), JavacTestOptions.Excuse.EclipseWarningConfiguredAsError);
    }
    ...
    public void testInvalidTagsConstructorErrorTagsProtected() {
        ...
        this.reportInvalidJavadocTags = CompilerOptions.ENABLED;
        this.reportInvalidJavadocTagsVisibility = CompilerOptions.PROTECTED;
        runNegativeTest(CONSTRUCTORS_INVALID_COMMENT, resultForInvalidTagsMethodOrConstructor(this.PROTECTED_VISIBILITY), JavacTestOptions.Excuse.EclipseWarningConfiguredAsError);
    }
    ...
    public void testInvalidTagsFieldErrorTagsPackage() {
        ...
        this.reportInvalidJavadocTags = CompilerOptions.ENABLED;
        this.reportInvalidJavadocTagsVisibility = CompilerOptions.DEFAULT;
        runNegativeTest(FIELDS_INVALID_COMMENT, resultForInvalidTagsClassOrField(this.DEFAULT_VISIBILITY), JavacTestOptions.Excuse.EclipseWarningConfiguredAsError);
    }
    ...
    public void testInvalidTagsMethodErrorTagsPackage() {
        ...
        this.reportInvalidJavadocTags = CompilerOptions.ENABLED;
        this.reportInvalidJavadocTagsVisibility = CompilerOptions.DEFAULT;
        runNegativeTest(METHODS_INVALID_COMMENT, resultForInvalidTagsMethodOrConstructor(this.DEFAULT_VISIBILITY), JavacTestOptions.Excuse.EclipseWarningConfiguredAsError);
    }
    ...
    public void testInvalidTagsConstructorErrorTagsPackage() {
        ...
        this.reportInvalidJavadocTags = CompilerOptions.ENABLED;
        this.reportInvalidJavadocTagsVisibility = CompilerOptions.DEFAULT;
        runNegativeTest(CONSTRUCTORS_INVALID_COMMENT, resultForInvalidTagsMethodOrConstructor(this.DEFAULT_VISIBILITY), JavacTestOptions.Excuse.EclipseWarningConfiguredAsError);
    }
    ...
    public void testInvalidTagsDeprecatedRefClassErrorTagsPrivate() {
        this.reportInvalidJavadoc = CompilerOptions.ERROR;
        this.reportInvalidJavadocTagsDeprecatedRef = CompilerOptions.DISABLED;
        runNegativeTest(CLASSES_INVALID_COMMENT, resultForInvalidTagsClassOrField(this.PRIVATE_VISIBILITY), JavacTestOptions.Excuse.EclipseWarningConfiguredAsError);
    }

    public void testInvalidTagsDeprecatedRefFieldErrorTagsPrivate() {
        this.reportInvalidJavadoc = CompilerOptions.ERROR;
        this.reportInvalidJavadocTagsDeprecatedRef = CompilerOptions.DISABLED;
        runNegativeTest(FIELDS_INVALID_COMMENT, resultForInvalidTagsClassOrField(this.PRIVATE_VISIBILITY), JavacTestOptions.Excuse.EclipseWarningConfiguredAsError);
    }

    public void testInvalidTagsDeprecatedRefMethodErrorTagsPrivate() {
        this.reportInvalidJavadoc = CompilerOptions.ERROR;
        this.reportInvalidJavadocTagsDeprecatedRef = CompilerOptions.DISABLED;
        runNegativeTest(METHODS_INVALID_COMMENT, resultForInvalidTagsMethodOrConstructor(this.PRIVATE_VISIBILITY), JavacTestOptions.Excuse.EclipseWarningConfiguredAsError);
    }

    public void testInvalidTagsDeprecatedRefConstructorErrorTagsPrivate() {
        this.reportInvalidJavadoc = CompilerOptions.ERROR;
        this.reportInvalidJavadocTagsDeprecatedRef = CompilerOptions.DISABLED;
        runNegativeTest(CONSTRUCTORS_INVALID_COMMENT, resultForInvalidTagsMethodOrConstructor(this.PRIVATE_VISIBILITY), JavacTestOptions.Excuse.EclipseWarningConfiguredAsError);
    }
    ...
    public void testMissingTagsErrorPublicOverriding() {
        ...
        runNegativeTest(MISSING_TAGS, resultForMissingTags(this.PUBLIC_VISIBILITY), JavacTestOptions.Excuse.EclipseWarningConfiguredAsError);
    }
    ...
    public void testMissingTagsErrorProtectedOverriding() {
        ...
        this.reportMissingJavadocTagsOverriding = CompilerOptions.ENABLED;
        runNegativeTest(MISSING_TAGS, resultForMissingTags(this.PROTECTED_VISIBILITY), JavacTestOptions.Excuse.EclipseWarningConfiguredAsError);
    }
    ...
    public void testMissingTagsErrorPrivateOverriding() {
        ...
        this.reportMissingJavadocTagsOverriding = CompilerOptions.ENABLED;
        runNegativeTest(MISSING_TAGS, resultForMissingTags(this.PRIVATE_VISIBILITY), JavacTestOptions.Excuse.EclipseWarningConfiguredAsError);
    }
    ...
    public void testMissingCommentsErrorPublicOverriding() {
        ...
        runNegativeTest(MISSING_COMMENTS, resultForMissingComments(this.PUBLIC_VISIBILITY), JavacTestOptions.Excuse.EclipseWarningConfiguredAsError);
    }
    ...
    public void testMissingCommentsErrorProtectedOverriding() {
        ...
        this.reportMissingJavadocCommentsOverriding = CompilerOptions.ENABLED;
        runNegativeTest(MISSING_COMMENTS, resultForMissingComments(this.PROTECTED_VISIBILITY), JavacTestOptions.Excuse.EclipseWarningConfiguredAsError);
    }
    ...
    public void testMissingCommentsErrorPackageOverriding() {
        ...
        this.reportMissingJavadocCommentsOverriding = CompilerOptions.ENABLED;
        runNegativeTest(MISSING_COMMENTS, resultForMissingComments(this.DEFAULT_VISIBILITY), JavacTestOptions.Excuse.EclipseWarningConfiguredAsError);
    }
    ...
    public void testMissingCommentsErrorPrivateOverriding() {
        ...
        this.reportMissingJavadocCommentsOverriding = CompilerOptions.ENABLED;
        runNegativeTest(MISSING_COMMENTS, resultForMissingComments(this.PRIVATE_VISIBILITY), JavacTestOptions.Excuse.EclipseWarningConfiguredAsError);
    }
