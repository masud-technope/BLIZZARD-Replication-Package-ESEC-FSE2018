...
public interface BaseTypes {
    ...
    //N stands for null even if it is never internally used //$NON-NLS-1$
    final BaseTypeBinding NullBinding = new BaseTypeBinding(TypeIds.T_null, "null".toCharArray(), new char[] { 'N' });
