...
public class ExecutableTypeImpl extends TypeMirrorImpl implements ExecutableType {
    ...
    public List<? extends TypeMirror> getParameterTypes() {
        ...
        boolean isEnumConstructor = binding.isConstructor() && binding.declaringClass.isEnum() && binding.declaringClass.isBinaryBinding() && ((binding.modifiers & ExtraCompilerModifiers.AccGenericSignature) == 0);
