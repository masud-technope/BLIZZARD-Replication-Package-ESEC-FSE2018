...
public class QualifiedSuperReference extends QualifiedThisReference {
    ...
    int findCompatibleEnclosing(ReferenceBinding enclosingType, TypeBinding type, BlockScope scope) {
        if (type.isInterface()) {
            ...
            // false => compoundName != null && closestMatch != null
            ...
            if (!isLegal || !isJava8) {
                ...
                this.resolvedType = new ProblemReferenceBinding(compoundName, closestMatch, isJava8 ? ProblemReasons.AttemptToBypassDirectSuper : ProblemReasons.InterfaceMethodInvocationNotBelow18);
            }
            // never an outer enclosing type
            return 0;
        }
