...
public class CreateImportsTests extends AbstractJavaModelTests {
    ...
    private String createImport(String importName, int flags) throws JavaModelException {
        return createImport(importName, flags, /*no sibling*/
        null);
    }
    ...
    private String createImport(String importName, int flags, IJavaElement sibling) throws JavaModelException {
        ...
        workingCopy.createImport(importName, sibling, flags, /*no progress*/
        null);
    ...
    private void setContents(String contents) throws JavaModelException {
        ...
        this.workingCopies[0].makeConsistent(/*no progress*/
        null);
    }
    ...
    public void test010() throws JavaModelException {
        ...
        assertExceptionEquals("Unexpected exception", "Invalid name specified: null", exception);
    }
    ...
    public void test011() throws JavaModelException {
        ...
        assertExceptionEquals("Unexpected exception", "Invalid name specified: java.,.", exception);
    }
}
