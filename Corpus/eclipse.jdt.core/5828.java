...
public class AssertionTest extends AbstractRegressionTest {
    ...
    public void test002() {
        ...
        "SUCCESS", // use default class-path
        null, // flush previous output dir content
        true, new String[] { "-ea" });
    }

    public void test003() {
        this.runConformTest(new String[] { "A4.java", "public class A4 { \n" + "	public static void main(String[] args) {\n" + "    int i = 4;\n" + "    assert i != 4;\n" + "	   System.out.println(i);\n" + "	} \n" + "} \n" }, "4", // use default class-path
        null, // flush previous output dir content
        true, new String[] { "-da" });
    }
	 ...
	 */
    public void test015() {
        this.runConformTest(new String[] { "X.java", "public class X {\n" + "\n" + "	public static class Foo {\n" + "		public void myMethod(boolean trash) {\n" + "			System.out.println(\"Expecting class Foo\");\n" + "			Class c = Foo.class;\n" + "			System.out.println(\"Got the class \" + c);\n" + "		}\n" + "	}\n" + "	public static class Bar {\n" + "		public void myMethod(boolean doAssert) {\n" + "			System.out.println(\"Expecting class Bar\");\n" + "			Class c = Bar.class;\n" + "			try {\n" + "				assert c.getName().endsWith(\"Bar2\");\n" + "			} catch(AssertionError e) {\n" + "				System.out.println(\"SUCCESS\");\n" + "			}\n" + "			System.out.println(\"Got the class \" + c);\n" + "		}\n" + "	}\n" + "	public static void main(String[] args) {\n" + "		new Foo().myMethod(false);\n" + "		new Bar().myMethod(false);\n" + "	}\n" + "}" }, "Expecting class Foo\n" + "Got the class class X$Foo\n" + "Expecting class Bar\n" + "SUCCESS\n" + "Got the class class X$Bar", // use default classpath
        null, // flush previous output dir content
        true, new String[] { "-ea" });
    }
