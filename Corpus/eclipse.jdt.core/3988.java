...
public class CompletionScanner extends Scanner {
    ...
    protected boolean isAtAssistIdentifier() {
        ...
        this.cursorLocation < this.startPosition && this.currentPosition == this.startPosition) {
            return true;
        }
 ...
 */
    ...
    protected int getNextToken0() throws InvalidInputException {
        ...
        int whiteStart = 0;
        try {
            while (//loop for jumping over comments
            true) {
                ...
                do {
                    ...
                    if ((whiteStart != this.currentPosition) && (this.completionIdentifier == null) && (whiteStart <= this.cursorLocation + 1) && (this.cursorLocation < this.startPosition) && !ScannerHelper.isJavaIdentifierStart(this.complianceLevel, this.currentCharacter)) {
                        this.currentPosition = this.startPosition;
                        return TokenNameIdentifier;
                    }
                } while (isWhiteSpace);
                                ...
                                try {
                                    ...
                                    if (this.currentCharacter == '\r' && this.eofPosition > this.currentPosition) {
                                        if (this.source[this.currentPosition] == '\n') {
                                            ...
                                            int c1 = 0, c2 = 0, c3 = 0, c4 = 0;
                                            if ((c1 = ScannerHelper.getHexadecimalValue(this.source[index++])) > 15 || c1 < 0 || (c2 = ScannerHelper.getHexadecimalValue(this.source[index++])) > 15 || c2 < 0 || (c3 = ScannerHelper.getHexadecimalValue(this.source[index++])) > 15 || c3 < 0 || (c4 = ScannerHelper.getHexadecimalValue(this.source[index++])) > 15 || c4 < 0) {
