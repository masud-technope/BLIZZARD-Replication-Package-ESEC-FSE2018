...
public class FlowAnalysisTest extends AbstractRegressionTest {
    ...
    // problem category
    public void test021() {
        if (ProblemReporter.getProblemCategory(ProblemSeverities.Warning, IProblem.FallthroughCase) != CategorizedProblem.CAT_POTENTIAL_PROGRAMMING_PROBLEM) {
    ...
    public void test050_definite_assigment_and_if_true() {
        runConformTest(// test directory preparation
    ...
    public void test052() {
        runNegativeTest(new String[] /* test files */
    ...
    public void test056() {
        if (this.complianceLevel < ClassFileConstants.JDK1_4) {
            runNegativeTest(new /* test files */
    ...
    public void test065() {
        ...
        null, /* shouldFlushOutputDirectory */
        true, /* vmArguments */
        null, compilerOptions, /* clientRequestor */
        null);
    }
