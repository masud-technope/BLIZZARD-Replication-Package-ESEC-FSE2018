...
public class EnhancedForStatement extends Statement {
	 ...
	 */
    public static final ChildPropertyDescriptor PARAMETER_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(EnhancedForStatement.class, "parameter", SingleVariableDeclaration.class, MANDATORY, CYCLE_RISK);

    /**
	 * The "expression" structural property of this node type (child type: {@link Expression}).
	 */
    public static final ChildPropertyDescriptor EXPRESSION_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(EnhancedForStatement.class, "expression", Expression.class, MANDATORY, CYCLE_RISK);
    ...
    new ChildPropertyDescriptor(EnhancedForStatement.class, "body", Statement.class, MANDATORY, CYCLE_RISK);
	 ...
	 */
    int treeSize() {
        return memSize() + (this.parameter == null ? 0 : getParameter().treeSize()) + (this.expression == null ? 0 : getExpression().treeSize()) + (this.body == null ? 0 : getBody().treeSize());
    }
}
