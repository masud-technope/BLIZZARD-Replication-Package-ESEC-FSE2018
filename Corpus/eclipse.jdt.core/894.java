...
public class TypeResolveTests extends ModifyingResourceTests {
    ...
    protected void assertTypesEqual(String expected, String[][] types) {
        ...
        assertEquals("Unexpected types", expected, actual);
    }
 ...
 */
    public void testResolveMemberTypeInInner() throws JavaModelException {
        ...
        assertTypesEqual("p.TypeResolve.A.B", types);
    }
 ...
 */
    public void testResolveSiblingTypeInInner() throws JavaModelException {
        ...
        assertTypesEqual("p.TypeResolve.A.C", types);
    }
 ...
 */
    public void testResolveInnerType1() throws JavaModelException {
        ...
        assertTypesEqual("p4.A.Inner", types);
    }
 ...
 */
    public void testParamAnnotations2() throws CoreException, IOException {
        try {
            ...
            String[] pathAndContents = new String[] { "p/X.java", "package p;\n" + "public class X<T> {\n" + "	X<String> field;\n" + "	@Inject\n" + "	public void Test(@Default String processor) {}\n" + "}" + "@interface Inject{\n" + "}" + "@interface Default{\n" + "}" };
 ...
 */
    public void testParamAnnotations4() throws CoreException, IOException {
        try {
            ...
            String localSource = sourceX.substring(sourceRange.getOffset(), sourceRange.getOffset() + sourceRange.getLength());
 ...
 */
    ...
    public void test405026a() throws CoreException, IOException {
        try {
            ...
            Answer answer = nameLookup.findType("p.test13outer", /*NameLookup.ACCEPT_ALL*/
            false, NameLookup.ACCEPT_INTERFACES, false, true, false, null);
            assertNull(answer);
            ...
            itype = nameLookup.findType("test13outer", packageFragments[0], false, NameLookup.ACCEPT_ALL, /* considerSecondaryTypes */
            false, true);
            assertEquals("test13outer", itype.getElementName());
            itype = nameLookup.findType("test13outer", packageFragments[0], false, NameLookup.ACCEPT_ALL, /* considerSecondaryTypes */
            false, false);
            assertNull(itype);
            itype = nameLookup.findType("test13", packageFragments[0], false, NameLookup.ACCEPT_ALL, /* considerSecondaryTypes */
            false, false);
            assertEquals("test13", itype.getElementName());
            answer = nameLookup.findType("p.test13", false, NameLookup.ACCEPT_ALL, /* considerSecondaryTypes */
            false, true, false, null);
            assertEquals("test13", answer.type.getElementName());
            answer = nameLookup.findType("test13", "p", false, NameLookup.ACCEPT_ALL, /* considerSecondaryTypes */
            false, true, false, null);
            assertEquals("test13", answer.type.getElementName());
            answer = nameLookup.findType("test13outer", "p", false, NameLookup.ACCEPT_ALL, /* considerSecondaryTypes */
            false, true, false, null);
            assertNull(answer);
            answer = nameLookup.findType("test13outer", "p", false, NameLookup.ACCEPT_ALL, /* considerSecondaryTypes */
    ...
    public void test405026b() throws CoreException, IOException {
        try {
            ...
            assertNotNull(itype);
            Answer answer = nameLookup.findType("p.test13outer", /*NameLookup.ACCEPT_ALL*/
            true, NameLookup.ACCEPT_INTERFACES, false, true, false, null);
            ...
            assertEquals("test13", itype.getElementName());
            answer = nameLookup.findType("test13out", "p", true, NameLookup.ACCEPT_ALL, /* considerSecondaryTypes */
            true, true, false, null);
            assertEquals("test13outer", answer.type.getElementName());
        } finally {
            deleteProject("P");
    ...
    public void testBug458613() throws CoreException, IOException {
        ...
        try {
            ...
            LambdaMethod method = (LambdaMethod) variable.getParent();
            LambdaExpression lambda = (LambdaExpression) method.getParent();
            assertEquals("Incorrect handle", "=Bug458613/src<p{X.java[X~main~\\[QString;=)=\"Lp.I9\\<Ljava.lang.String;>;!134!169!138=&foo!1=\"Ljava.lang.String;=\"x_=\"V=\"Lp\\/X\\~I9\\" + "<Ljava\\/lang\\/String;>;.foo\\(Ljava\\/lang\\/String;)V@x_!134!135!134!135!Ljava\\/lang\\/String;!0!true=)", lambda.getHandleMemento());
        } finally {
            if (prj != null)
                deleteProject(prj);
        }
    ...
    public void testBug458613b() throws CoreException, IOException {
        ...
        try {
            ...
            LambdaMethod method = (LambdaMethod) variable.getParent();
            LambdaExpression lambda = (LambdaExpression) method.getParent();
            assertEquals("Incorrect handle", "=Bug458613/src<p{X.java[X~main~\\[QString;=)=\"Lp.I10\\<Ljava.lang.String;>;!212!224!216=&foo!1=\"Ljava.lang.String;=\"x_=\"V=\"Lp\\/X\\" + "~I9\\<LNumber;Ljava\\/lang\\/String;>;.foo\\(Ljava\\/lang\\/String;)V@x_!212!213!212!213!Ljava\\/lang\\/String;!0!true=)", lambda.getHandleMemento());
        } finally {
            if (prj != null)
                deleteProject(prj);
        }
