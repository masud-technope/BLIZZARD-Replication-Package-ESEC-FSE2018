...
public class PreferencesTests extends APTTestBase {
    ...
    public void testFactoryPathEncodingAndDecoding() throws Exception {
        ...
        //$NON-NLS-1$
        FactoryContainer jarFactory1 = FactoryPathUtil.newExtJarFactoryContainer(new File(JAR_PATH_1));
        FactoryPath.Attributes jarFPA1 = new FactoryPath.Attributes(true, false);
        //$NON-NLS-1$
        FactoryContainer jarFactory2 = FactoryPathUtil.newExtJarFactoryContainer(new File(JAR_PATH_2));
        FactoryPath.Attributes jarFPA2 = new FactoryPath.Attributes(true, true);
        //$NON-NLS-1$
        FactoryContainer pluginFactory = FactoryPluginManager.getPluginFactoryContainer("org.eclipse.jdt.apt.tests");
        ...
        for (Map.Entry<FactoryContainer, FactoryPath.Attributes> entry : factories.entrySet()) {
            ...
            switch(index) {
                ...
                case 2:
                    ...
                    "org.eclipse.jdt.apt.tests", //$NON-NLS-1$
                    container.getId());
                    break;
                default:
    ...
    public void testSimpleConfigApi() throws Exception {
        ...
        assertTrue("getRawProcessorOptions() should return the values set in setProcessorOptions()", wkspOpts.equals(retrievedWkspOpts));
        ...
        assertTrue("getRawProcessorOptions() should return the values set in setProcessorOptions()", projOpts.equals(retrievedProjOpts));
        wkspOpts.clear();
