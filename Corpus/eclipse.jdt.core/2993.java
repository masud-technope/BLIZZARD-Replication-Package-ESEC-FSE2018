...
public class NegativeTests extends TestCase {
    ...
    public void testNegativeModel10WithEclipseCompiler() throws IOException {
        ...
        printWriter.flush();
        printWriter.close();
        String expectedErrors = "Class targets.inherited.TestGenericChild lacks a public constructor with args: java.awt.Point" + "Class targets.inherited.TestNormalChild lacks a public constructor with args: java.awt.Point";
