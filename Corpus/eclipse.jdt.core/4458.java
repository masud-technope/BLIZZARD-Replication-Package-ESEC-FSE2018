    ...
    public void movePositive(IJavaElement[] elements, IJavaElement[] destinations, IJavaElement[] siblings, String[] names, boolean force, IProgressMonitor monitor) throws JavaModelException {
        ...
        try {
            ...
            for (i = 0; i < elements.length; i++) {
                ...
                if (//moved/renamed main type to same cu
                isMainType(element, destinations[i]) && names != null && names[i] != null) {
 ...
 */
    public void testCopyCU01() throws CoreException {
        ...
        this.createFile("/P/src/p1/X.java", "package p1;\n" + "public class X {\n" + "}");
 ...
 */
    public void testCopyCU02() throws CoreException {
        ...
        this.createFile("/P/src/p1/X.java", "package p1;\n" + "public class X {\n" + "}");
        ICompilationUnit cuSource = getCompilationUnit("/P/src/p1/X.java");
        copyNegative(new IJavaElement[] { cuSource, cuSource.getType("X") }, new IJavaElement[] { cuSource.getParent(), cuSource }, null, new String[] { "Y.java", "Y" }, false, IJavaModelStatusConstants.INVALID_ELEMENT_TYPES);
    }
 ...
 */
    public void testCopyCU03() throws CoreException {
        ...
        ICompilationUnit cuSource = getCompilationUnit("/P/src/p1/X.java");
        this.createFolder("/P/src/p2");
        this.createFile("/P/src/p2/X.java", "package p2;\n" + "public class X {\n" + "}");
        IPackageFragment pkgDest = getPackage("/P/src/p2");
 ...
 */
    public void testCopyCU06() throws CoreException {
        ...
        try {
            this.createFolder("/P/src/p1");
            file = this.createFile("/P/src/p1/X.java", "package p1;\n" + "public class X {\n" + "}");
 ...
 */
    public void testCopyCU07() throws CoreException {
        ...
        ICompilationUnit cuSource = getCompilationUnit("/P/src/p1/X.java");
        this.createFolder("/P/src/p2");
        this.createFile("/P/src/p2/Y.java", "package p2;\n" + "public class Y {\n" + "}");
        IPackageFragment pkgDest = getPackage("/P/src/p2");
 ...
 */
    public void testCopyCU11() throws CoreException {
        ...
        assertEquals("Server property should be copied with cu", "some value", propertyValue);
    }
 ...
 */
    public void testCopyReadOnlyPackageFragment() throws CoreException {
        ...
        try {
            ...
            this.createFile("/P/src/p1/p2/p3/X.java", "package p1.p2.p3;\n" + "public class X {\n" + "}");
 ...
 */
    public void testCopyWorkingCopyDestination() throws CoreException {
        ...
        try {
            ...
            copyPositive(cuSource, pkgDest, null, null, /*force*/
            true);
        } finally {
            if (copy != null)
                copy.discardWorkingCopy();
 ...
 */
    public void testMoveCU02() throws CoreException {
        ...
        this.createFile("/P/src/p1/X.java", "package p1;\n" + "public class X {\n" + "}");
        ICompilationUnit cuSource = getCompilationUnit("/P/src/p1/X.java");
        moveNegative(new IJavaElement[] { cuSource, cuSource.getType("X") }, new IJavaElement[] { cuSource.getParent(), cuSource }, null, new String[] { "Y.java", "Y" }, false, IJavaModelStatusConstants.INVALID_ELEMENT_TYPES);
    }
 ...
 */
    public void testMoveCU10() throws CoreException {
        ...
        cuSource.move(pkgDest, null, /*no sibling*/
        null, /*no rename*/
        false, /*don't replace*/
        null);
