...
public class InclusionPatternsTests extends ModifyingResourceTests {
    ...
    protected void setClasspath(String[] sourceFoldersAndInclusionPatterns) throws JavaModelException {
        this.project.setRawClasspath(createClasspath(sourceFoldersAndInclusionPatterns, true, /*inclusion*/
        false), null);
    }
 ...
 */
    public void testAddInclusionOnCompilationUnit() throws CoreException {
        ...
        assertSortedElementsEqual("Unexpected children", "A.java [in p [in src [in P]]]", pkg.getChildren());
        assertResourceNamesEqual("Unexpected non-java resources", "", pkg.getNonJavaResources());
    }
 ...
 */
    public void testAddInclusionOnFolderUnderProject() throws CoreException {
        try {
            ...
            createFolder("/P1/doc");
            clearDeltas();
            javaProject.setRawClasspath(createClasspath(new String[] { "/P1", "doc/" }, /*inclusion*/
            true, /*no exclusion*/
            false), null);
            ...
            assertSortedElementsEqual("Unexpected children", "doc [in <project root> [in P1]]", root.getChildren());
            assertResourceNamesEqual("Unexpected non-java resources of project", ".classpath\n" + ".project", javaProject.getNonJavaResources());
        } finally {
            deleteProject("P1");
        }
    }
 ...
 */
    public void testAddInclusionOnPackage() throws CoreException {
        ...
        assertSortedElementsEqual("Unexpected children", "p [in src [in P]]", root.getChildren());
        assertResourceNamesEqual("Unexpected non-java resources", "", root.getNonJavaResources());
    }
 ...
 */
    public void testCreateIncludedCompilationUnit() throws CoreException {
        ...
        IPackageFragment pkg = getPackage("/P/src/p");
        clearDeltas();
        pkg.createCompilationUnit("A.java", "package p;\n" + "public class A {\n" + "}", false, null);
        assertDeltas("Unexpected deltas", "P[*]: {CHILDREN}\n" + "	src[*]: {CHILDREN}\n" + "		p[*]: {CHILDREN}\n" + "			A.java[+]: {}");
        assertSortedElementsEqual("Unexpected children", "A.java [in p [in src [in P]]]", pkg.getChildren());
        assertResourceNamesEqual("Unexpected non-java resources", "", pkg.getNonJavaResources());
    }
 ...
 */
    public void testCreateResourceIncludedCompilationUnit2() throws CoreException {
        ...
        assertSortedElementsEqual("Unexpected children", "A.java [in p1.p2.p3 [in src [in P]]]", pkg.getChildren());
        assertResourceNamesEqual("Unexpected non-java resources", "", pkg.getNonJavaResources());
    }
 ...
 */
    public void testCreateResourceIncludedPackage2() throws CoreException {
        ...
        assertDeltas("Unexpected deltas", "P[*]: {CHILDREN}\n" + "	src[*]: {CHILDREN | CONTENT}\n" + "		p1.p2.p3[+]: {}\n" + "		ResourceDelta(/P/src/p1)[*]");
        IPackageFragmentRoot root = getPackageFragmentRoot("/P/src");
        assertSortedElementsEqual("Unexpected children", "p1.p2.p3 [in src [in P]]", root.getChildren());
        assertResourceNamesEqual("Unexpected non-java resources", "p1", root.getNonJavaResources());
    }
 ...
 */
    public void testIncludeCUOnly01() throws CoreException {
        ...
        try {
            ...
            workingCopy = getWorkingCopy("/P/src/Y.java", "import p1.p2.X;\n" + "public class Y extends X {\n" + "}", /*primary owner*/
 ...
 */
    public void testIncludeCUOnly02() throws CoreException {
        ...
        try {
            ProblemRequestor problemRequestor = new ProblemRequestor();
            workingCopy = getWorkingCopy("/P/src/Y.java", "import p1.p2.p3.X;\n" + "public class Y extends X {\n" + "}", /*primary owner*/
            null, problemRequestor);
            assertProblems("Unepected problems", "----------\n" + "----------\n", problemRequestor);
        } finally {
            if (workingCopy != null)
 ...
 */
    public void testIsOnClasspath1() throws CoreException {
        ...
        createFolder("/P/src/p");
        IFile file = createFile("/P/src/p/A.java", "package p;\n" + "public class A {\n" + "}");
 ...
 */
    public void testNestedSourceFolder1() throws CoreException {
        ...
        assertResourceNamesEqual("Unexpected non-java resources for /P/src1", "", root1.getNonJavaResources());
    }
 ...
 */
    public void testRemoveInclusionOnCompilationUnit() throws CoreException {
        ...
        assertDeltas("Unexpected deltas", "P[*]: {CHILDREN | CONTENT | RAW CLASSPATH CHANGED | RESOLVED CLASSPATH CHANGED}\n" + "	src[*]: {ADDED TO CLASSPATH | REMOVED FROM CLASSPATH}\n" + "	ResourceDelta(/P/.classpath)[*]");
        IPackageFragment pkg = getPackage("/P/src/p");
        assertSortedElementsEqual("Unexpected children", "", pkg.getChildren());
        assertResourceNamesEqual("Unexpected non-java resources", "A.java", pkg.getNonJavaResources());
    }
 ...
 */
    public void testRemoveInclusionOnPackage() throws CoreException {
        ...
        assertDeltas("Unexpected deltas", "P[*]: {CHILDREN | CONTENT | RAW CLASSPATH CHANGED | RESOLVED CLASSPATH CHANGED}\n" + "	src[*]: {ADDED TO CLASSPATH | REMOVED FROM CLASSPATH}\n" + "	ResourceDelta(/P/.classpath)[*]");
        IPackageFragmentRoot root = getPackageFragmentRoot("/P/src");
        assertSortedElementsEqual("Unexpected children", "<default> [in src [in P]]", root.getChildren());
        assertResourceNamesEqual("Unexpected non-java resources", "p", root.getNonJavaResources());
    }
 ...
 */
    public void testRenameIncludedCompilationUnit() throws CoreException {
        ...
        IPackageFragment pkg = getPackage("/P/src/p");
        assertSortedElementsEqual("Unexpected children", "", pkg.getChildren());
        assertResourceNamesEqual("Unexpected non-java resources", "B.java", pkg.getNonJavaResources());
    }
 ...
 */
    public void testRenameIncludedPackage1() throws CoreException {
        ...
        assertSortedElementsEqual("Unexpected children", "", root.getChildren());
        assertResourceNamesEqual("Unexpected non-java resources", "q", root.getNonJavaResources());
    }
        ...
        try {
            JavaCore.run(new IWorkspaceRunnable() {
                ...
                public void run(IProgressMonitor monitor) throws CoreException {
                    ...
                    javaProject.setRawClasspath(createClasspath(new String[] { "/P2", "**/X.java", "/P2/src", "" }, /*inclusion*/
                    true, /*no exclusion*/
                    false), null);
                    createFile("/P2/bin/X.java", "public class X {\n" + "}");
                }
            }, null);
            ...
            search("X", IJavaSearchConstants.TYPE, IJavaSearchConstants.DECLARATIONS, scope, resultCollector);
 ...
 */
    public void testSearchWithIncludedCompilationUnit1() throws CoreException {
        ...
        createFile("/P/src/p/A.java", "package p;\n" + "public class A {\n" + "}");
        JavaSearchTests.JavaSearchResultCollector resultCollector = new JavaSearchTests.JavaSearchResultCollector();
        search("A", IJavaSearchConstants.TYPE, IJavaSearchConstants.DECLARATIONS, SearchEngine.createJavaSearchScope(new IJavaProject[] { getJavaProject("P") }), resultCollector);
        assertEquals("Unexpected matches found", "src/p/A.java p.A [A]", resultCollector.toString());
    }
 ...
 */
    public void testSearchWithIncludedCompilationUnit2() throws CoreException {
        ...
        JavaSearchTests.JavaSearchResultCollector resultCollector = new JavaSearchTests.JavaSearchResultCollector();
        search("A", IJavaSearchConstants.TYPE, IJavaSearchConstants.DECLARATIONS, SearchEngine.createJavaSearchScope(new IJavaProject[] { getJavaProject("P") }), resultCollector);
        assertEquals("Unexpected matches found", "", resultCollector.toString());
    }
