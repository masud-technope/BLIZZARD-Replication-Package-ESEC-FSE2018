...
public class ConstantPool implements ClassFileConstants, TypeIds {
    ...
    static final int JAVA_UTIL_ITERATOR_TYPE = 21;

    static final int JAVA_LANG_STRINGBUILDER_TYPE = 22;

    // predefined constant index for well known fields  
    static final int JAVA_LANG_BYTE_TYPE_FIELD = 0;

    static final int JAVA_LANG_SHORT_TYPE_FIELD = 1;

    static final int JAVA_LANG_CHARACTER_TYPE_FIELD = 2;

    static final int JAVA_LANG_INTEGER_TYPE_FIELD = 3;

    static final int JAVA_LANG_LONG_TYPE_FIELD = 4;

    static final int JAVA_LANG_FLOAT_TYPE_FIELD = 5;

    static final int JAVA_LANG_DOUBLE_TYPE_FIELD = 6;

    static final int JAVA_LANG_BOOLEAN_TYPE_FIELD = 7;

    static final int JAVA_LANG_VOID_TYPE_FIELD = 8;

    // predefined constant index for well known methods 
    static final int CLASS_FORNAME_METHOD = 0;

    static final int NOCLASSDEFFOUNDERROR_CONSTR_METHOD = 1;

    static final int STRINGBUFFER_APPEND_INT_METHOD = 2;

    static final int STRINGBUFFER_APPEND_FLOAT_METHOD = 3;

    static final int STRINGBUFFER_APPEND_LONG_METHOD = 4;

    static final int STRINGBUFFER_APPEND_OBJECT_METHOD = 5;

    static final int STRINGBUFFER_APPEND_CHAR_METHOD = 6;

    static final int STRINGBUFFER_APPEND_STRING_METHOD = 7;

    static final int STRINGBUFFER_APPEND_BOOLEAN_METHOD = 8;

    static final int STRINGBUFFER_APPEND_DOUBLE_METHOD = 9;
    ...
    static final int STRING_VALUEOF_INT_METHOD = 18;

    static final int STRING_VALUEOF_FLOAT_METHOD = 19;

    static final int STRING_VALUEOF_LONG_METHOD = 20;

    static final int STRING_VALUEOF_OBJECT_METHOD = 21;

    static final int STRING_VALUEOF_CHAR_METHOD = 22;

    static final int STRING_VALUEOF_BOOLEAN_METHOD = 23;

    static final int STRING_VALUEOF_DOUBLE_METHOD = 24;
    ...
    static final int CLASS_DESIREDASSERTIONSTATUS_METHOD = 33;

    static final int OBJECT_GETCLASS_METHOD = 34;

    static final int CLASS_GETCOMPONENTTYPE_METHOD = 35;

    static final int ITERATOR_HASNEXT_METHOD = 36;

    static final int ITERATOR_NEXT_METHOD = 37;

    static final int STRINGBUILDER_STRING_CONSTR_METHOD = 38;

    static final int STRINGBUILDER_DEFAULT_CONSTR_METHOD = 39;

    static final int STRINGBUILDER_TOSTRING_METHOD = 40;

    static final int STRINGBUILDER_APPEND_INT_METHOD = 41;

    static final int STRINGBUILDER_APPEND_FLOAT_METHOD = 42;

    static final int STRINGBUILDER_APPEND_LONG_METHOD = 43;

    static final int STRINGBUILDER_APPEND_OBJECT_METHOD = 44;

    static final int STRINGBUILDER_APPEND_CHAR_METHOD = 45;

    static final int STRINGBUILDER_APPEND_STRING_METHOD = 46;

    static final int STRINGBUILDER_APPEND_BOOLEAN_METHOD = 47;

    static final int STRINGBUILDER_APPEND_DOUBLE_METHOD = 48;
    ...
    static final int APPEND_INT_STRINGBUFFER_METHOD_NAME_AND_TYPE = 3;

    static final int APPEND_FLOAT_STRINGBUFFER_METHOD_NAME_AND_TYPE = 4;

    static final int APPEND_LONG_STRINGBUFFER_METHOD_NAME_AND_TYPE = 5;

    static final int APPEND_OBJECT_STRINGBUFFER_METHOD_NAME_AND_TYPE = 6;

    static final int APPEND_CHAR_STRINGBUFFER_METHOD_NAME_AND_TYPE = 7;

    static final int APPEND_STRING_STRINGBUFFER_METHOD_NAME_AND_TYPE = 8;

    static final int APPEND_BOOLEAN_STRINGBUFFER_METHOD_NAME_AND_TYPE = 9;

    static final int APPEND_DOUBLE_STRINGBUFFER_METHOD_NAME_AND_TYPE = 10;
    ...
    static final int GETCOMPONENTTYPE_CLASS_METHOD_NAME_AND_TYPE = 32;

    static final int HASNEXT_METHOD_NAME_AND_TYPE = 33;

    static final int NEXT_METHOD_NAME_AND_TYPE = 34;

    static final int APPEND_INT_STRINGBUILDER_METHOD_NAME_AND_TYPE = 35;

    static final int APPEND_FLOAT_STRINGBUILDER_METHOD_NAME_AND_TYPE = 36;

    static final int APPEND_LONG_STRINGBUILDER_METHOD_NAME_AND_TYPE = 37;

    static final int APPEND_OBJECT_STRINGBUILDER_METHOD_NAME_AND_TYPE = 38;

    static final int APPEND_CHAR_STRINGBUILDER_METHOD_NAME_AND_TYPE = 39;

    static final int APPEND_STRING_STRINGBUILDER_METHOD_NAME_AND_TYPE = 40;

    static final int APPEND_BOOLEAN_STRINGBUILDER_METHOD_NAME_AND_TYPE = 41;

    static final int APPEND_DOUBLE_STRINGBUILDER_METHOD_NAME_AND_TYPE = 42;
    ...
    public int indexOfWellKnownMethodNameAndType(MethodBinding methodBinding) {
        ...
        switch(firstChar) {
            ...
            case 'g':
                ...
                if (methodBinding.parameters.length == 0 && methodBinding.returnType.id == T_JavaLangClass && CharOperation.equals(methodBinding.selector, QualifiedNamesConstants.GetClass)) {
                    return GETCLASS_OBJECT_METHOD_NAME_AND_TYPE;
                }
                if (methodBinding.parameters.length == 0 && methodBinding.returnType.id == T_JavaLangClass && CharOperation.equals(methodBinding.selector, QualifiedNamesConstants.GetComponentType)) {
    ...
    public int indexOfWellKnownMethods(MethodBinding methodBinding) {
        ...
        switch(methodBinding.declaringClass.id) {
            ...
            case T_JavaLangStringBuffer:
                ...
                } else if ((firstChar == '<') && (CharOperation.equals(methodBinding.selector, QualifiedNamesConstants.Init))) {
            ...
            case T_JavaLangString:
                ...
                } else if ((firstChar == 'i') && (methodBinding.parameters.length == 0) && (methodBinding.returnType.id == T_JavaLangString) && (CharOperation.equals(methodBinding.selector, QualifiedNamesConstants.Intern))) {
                    // This method binding is valueOf(java.lang.Object)
            ...
            case T_JavaLangAssertionError:
                ...
                break;
            case T_JavaLangObject:
                if (methodBinding.parameters.length == 0 && CharOperation.equals(methodBinding.selector, QualifiedNamesConstants.GetClass)) {
            ...
            if ((stringIndex = UTF8Cache.get(stringCharArray)) < 0) {
                ...
                for (int i = 0; i < stringCharArray.length; i++) {
                    ...
                    if ((current >= 0x0001) && (current <= 0x007F)) {
                        ...
                        // we need 3 bytes
                        length += 3;
                        writeU1(0xE0 | (// 0xE0 = 1110 0000
                        (current >> 12) & // 0xE0 = 1110 0000
                        0x0F));
                        writeU1(0x80 | (// 0x80 = 1000 0000
                        (current >> 6) & // 0x80 = 1000 0000
                        0x3F));
                        writeU1(// 0x80 = 1000 0000
                        0x80 | // 0x80 = 1000 0000
                        (current & 0x3F));
                    } else {
                        // we can be 0 or between 0x0080 and 0x07FF
