    ...
    protected Object createArgumentReference(char[] name, int dim, boolean isVarargs, Object typeRef, long[] dimPositions, long argNamePos) throws InvalidInputException {
        ...
        if (start <= this.selectionStart && this.selectionEnd <= end) {
            ...
            if (SelectionEngine.DEBUG) {
                //$NON-NLS-1$
                System.out.println(//$NON-NLS-1$
                "	selected argument=" + this.selectedNode);
            }
        }
        return expression;
    }
    ...
    protected Object createFieldReference(Object receiver) throws InvalidInputException {
        ...
        if (start <= this.selectionStart && this.selectionEnd <= end) {
            ...
            if (SelectionEngine.DEBUG) {
                //$NON-NLS-1$
                System.out.println(//$NON-NLS-1$
                "	selected field=" + this.selectedNode);
            }
        }
        return null;
    }
    ...
    protected Object createMethodReference(Object receiver, List arguments) throws InvalidInputException {
        ...
        if (start <= this.selectionStart && this.selectionEnd <= end) {
            ...
            if (SelectionEngine.DEBUG) {
                //$NON-NLS-1$
                System.out.println(//$NON-NLS-1$
                "	selected method=" + this.selectedNode);
            }
        }
        return null;
    }
    ...
    protected Object createTypeReference(int primitiveToken) {
        ...
        if (typeRef.sourceStart <= this.selectionStart && this.selectionEnd <= typeRef.sourceEnd) {
            ...
            if (typeRef instanceof JavadocQualifiedTypeReference) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    if (start <= this.selectionStart && this.selectionEnd <= end) {
                        ...
                        if (SelectionEngine.DEBUG) {
                            System.out.println(//$NON-NLS-1$
                            "	selected partial qualified type=" + //$NON-NLS-1$
                            this.selectedNode);
                        }
                        return typeRef;
                    }
            ...
            if (SelectionEngine.DEBUG) {
                //$NON-NLS-1$
                System.out.println(//$NON-NLS-1$
                "	selected type=" + this.selectedNode);
            }
        }
        return typeRef;
    }
    ...
    protected boolean pushParamName(boolean isTypeParam) {
        if (super.pushParamName(isTypeParam)) {
            ...
            if (expression.sourceStart <= this.selectionStart && this.selectionEnd <= expression.sourceEnd) {
                ...
                this.abort = true;
                if (SelectionEngine.DEBUG) {
                    System.out.println("	selected param=" + //$NON-NLS-1$
                    this.selectedNode);
                }
            }
        }
