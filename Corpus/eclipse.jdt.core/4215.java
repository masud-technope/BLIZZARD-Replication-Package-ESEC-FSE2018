...
public class ArrayInitializer extends Expression {
	 ...
	 * @since 3.0
	 */
    public static final ChildListPropertyDescriptor EXPRESSIONS_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(ArrayInitializer.class, "expressions", Expression.class, CYCLE_RISK);
