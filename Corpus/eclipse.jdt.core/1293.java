...
public class StackMapFrame {
    ...
    private void printFrame(StringBuffer buffer, StackMapFrame frame) {
        ...
        buffer.append(MessageFormat.format(pattern, new Object[] { Integer.toString(frame.pc), Integer.toString(frame.getNumberOfLocals()), Integer.toString(frame.numberOfStackItems), print(frame.locals, localsLength), print(frame.stackItems, frame.numberOfStackItems) }));
    }
