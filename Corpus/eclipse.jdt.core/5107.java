...
public class NullReferenceTest extends AbstractRegressionTest {
    ...
    public void test0026_suppress_warnings() {
        if (this.complianceLevel >= ClassFileConstants.JDK1_5) {
            ...
            this.runConformTest(new String[] { "X.java", "@SuppressWarnings(\"null\")\n" + "public class X {\n" + "  void foo() {\n" + "    Object o = null;\n" + "    o.toString();\n" + "  }\n" + "}\n" }, "", null, true, null, compilerOptions, null);
        }
    }
    ...
    public void test0419_while() {
        this.runNegativeTest(new String[] { "X.java", "public class X {\n" + "  boolean bool;\n" + "  void foo(Object o) {\n" + "    while (bool) {\n" + // complain NPE because of second iteration
        "      o.toString();" + "      o = null;\n" + "    }\n" + "  }\n" + "}" }, "----------\n" + "1. ERROR in X.java (at line 5)\n" + "	o.toString();      o = null;\n" + "	^\n" + "Potential null pointer access: The variable o may be null at this location\n" + "----------\n", JavacTestOptions.Excuse.EclipseWarningConfiguredAsError);
    }
    ...
    public void _test0534_try_finally() {
        ...
        false, /* expectedCompilerLog */
        "", /* expectedOutputString */
        "", /* expectedErrorString */
        "", /* forceExecution */
        false, /* classLib */
        null, /* shouldFlushOutputDirectory */
        true, /* vmArguments */
        null, /* customOptions */
    ...
    public void test0564_try_catch_unchecked_exception() {
        ...
        true, /* no vm arguments */
        null, options, /* no custom requestor*/
        null, false);
    }
    ...
    public void test0567_try_catch_checked_exception() {
        this.runConformTest(new String[] { "X.java", "import java.net.MalformedURLException;\n" + "import java.net.URL;\n" + "public class X {\n" + "	public void test1(String[] args) {\n" + "		URL[] urls = null;\n" + "		try	{\n" + "			urls = new URL[args.length];\n" + "			for (int i = 0; i < args.length; i++)\n" + "				urls[i] = new URL(\"http\", \"\", -1, args[i]);\n" + "		}\n" + "		catch (MalformedURLException mfex) {\n" + "			urls = null;\n" + "		}\n" + "	}\n" + "}" }, "");
    }
    ...
    public void test1051_options_all_ignore() {
        ...
        this.runConformTest(new String[] { "X.java", "public class X {\n" + "  void foo(Object p) {\n" + "    Object o = null;\n" + "    if (o != null) {\n" + "       o = null;\n" + "    }\n" + "    if (p == null) {}\n" + "    o.toString();\n" + "    p.toString();\n" + "  }\n" + "}\n" }, /* no expected output string */
        null, /* no extra class libraries */
        null, /* flush output directory */
        true, /* no vm arguments */
        null, customOptions, /* no custom requestor*/
        null, /* do not skip javac for this peculiar test */
        false);
    }
    ...
    public void test1053_options_mix() {
        ...
        customOptions.put(CompilerOptions.OPTION_ReportPotentialNullReference, CompilerOptions.IGNORE);
        customOptions.put(CompilerOptions.OPTION_ReportRedundantNullCheck, CompilerOptions.IGNORE);
        runNegativeTest(/* flush output directory */
        true, new String[] /* test files */
        { "X.java", "public class X {\n" + "  void foo(Object p) {\n" + "    Object o = null;\n" + "    if (o != null) {\n" + "       o = null;\n" + "    }\n" + // taint p
        "    if (p == null) {}\n" + "    o.toString();\n" + "    p.toString();\n" + "  }\n" + "}\n" }, /* no class libraries */
        null, customOptions, // compiler results
    ...
    public void testBug303448b() throws Exception {
        ...
        options.put(CompilerOptions.OPTION_ReportRawTypeReference, CompilerOptions.IGNORE);
        if (this.complianceLevel >= ClassFileConstants.JDK1_4) {
            this.runConformTest(new String[] { "X.java", "public class X {\n" + "	public static void main(String[] args) {\n" + "		System.out.print(\"start\");\n" + "		Object foo = null;\n" + "		assert (foo != null);\n" + "		if (foo != null) {\n" + "			System.out.println(\"foo is not null\");\n" + "		}\n" + "		System.out.print(\"end\");\n" + "	}\n" + "}\n" }, "startend", null, true, null, options, null);
        }
    }
    ...
    public void testBug317829a() {
        ...
        options.put(JavaCore.COMPILER_PB_DEAD_CODE, JavaCore.WARNING);
        options.put(JavaCore.COMPILER_PB_REDUNDANT_NULL_CHECK, JavaCore.WARNING);
        this.runConformTest(new String[] { "X.java", "import java.io.IOException;\n" + "public class X {\n" + "  public static void main(String[] args) {\n" + "	 String someVariable = null;\n" + "	 int i = 0;\n" + "	 try {\n" + "       someVariable = \"not null\";\n" + "		while (true) {\n" + "			throw new IOException();\n" + "		}\n" + "	 } catch (IOException e) {\n" + "	 	if (someVariable == null) {\n" + "    		System.out.println(\"Compiler bad\");\n" + "	 	} else {\n" + "			System.out.print(\"Compiler good \");\n" + "	 	}\n" + "	 }\n" + "	 if (someVariable == null) {\n" + "    	System.out.println(\"Compiler bad\");\n" + "	 } else {\n" + "		System.out.println(\"Compiler good\");\n" + "	 }\n" + "  }\n" + "}" }, "Compiler good Compiler good", options);
    }
    ...
    public void testBug336428() {
        this.runConformTest(new String[] { "DoWhileBug.java", "public class DoWhileBug {\n" + "	void test(boolean b1, Object o1) {\n" + "		Object o2 = new Object();\n" + "		do {\n" + "           if (b1)\n" + "				o1 = null;\n" + "		} while ((o2 = o1) != null);\n" + "	}\n" + "}" }, "");
    }
 ...
 */
    ...
    public void testBug326950c() throws Exception {
        ...
        options.put(CompilerOptions.OPTION_ReportRedundantNullCheck, CompilerOptions.WARNING);
        this.runConformTest(new String[] { "X.java", "public class X {\n" + "	public void foo(String[] args) {\n" + "		String s = \"\";\n" + "		int i = 0;\n" + "		if (s != null) {\n" + "			return;\n" + "		}\n" + "		i++;\n" + "	}\n" + "}" }, "", null, true, null, options, null);
        String expectedOutput = "  public void foo(java.lang.String[] args);\n" + "     0  ldc <String \"\"> [16]\n" + "     2  astore_2 [s]\n" + "     3  iconst_0\n" + "     4  istore_3 [i]\n" + "     5  aload_2 [s]\n" + "     6  ifnull 10\n" + "     9  return\n" + "    10  iinc 3 1 [i]\n" + "    13  return\n";
        checkDisassembledClassFile(OUTPUT_DIR + File.separator + "X.class", "X", expectedOutput);
    }
    ...
    public void testBug339250() throws Exception {
        ...
        options.put(CompilerOptions.OPTION_ReportRedundantNullCheck, CompilerOptions.WARNING);
        this.runConformTest(new String[] { "X.java", "public class X {\n" + "	public static void main(String[] args) {\n" + "		String s = null;\n" + "		s += \"correctly\";\n" + // s cannot be null
        "		if (s != null) {\n" + "			System.out.println(\"It works \" + s);\n" + "		}\n" + "	}\n" + "}" }, "It works nullcorrectly", null, true, null, options, null);
    }
    ...
    public void testBug354554() {
        this.runNegativeTest(new String[] { "Bug354554.java", "public class Bug354554{\n" + "    void foo() {\n" + "        Object u = new Object();\n" + // condition is always false - should not spoil subsequent null-analysis
    ...
    public void testBug256796() {
        ...
        this.runNegativeTest(new String[] { "Bug.java", "public class Bug {\n" + "	private static final boolean TRUE = true;\n" + "   private static final boolean FALSE = false;\n" + "	void foo() throws Exception {\n" + "		if (TRUE) return;\n" + "		else System.out.println(\"\");\n" + // not dead code
    ...
    public void testBug360328() {
        ...
        customOptions.put(CompilerOptions.OPTION_ReportNullReference, CompilerOptions.ERROR);
        customOptions.put(CompilerOptions.OPTION_ReportRedundantNullCheck, CompilerOptions.ERROR);
        runNegativeTest(/* flushOutputDir */
