...
public class BaseTypeBinding extends TypeBinding {
    ...
    public static final boolean isNarrowing(int left, int right) {
        ...
        return right2left >= 0 && right2left < MAX_CONVERSIONS && (CONVERSIONS[right2left] & (IDENTITY | NARROWING)) != 0;
    }
    ...
    public static final boolean isWidening(int left, int right) {
        int right2left = right + (left << 4);
        return right2left >= 0 && right2left < MAX_CONVERSIONS && (CONVERSIONS[right2left] & (IDENTITY | WIDENING)) != 0;
    }
	...
	*/
    ...
    public void setTypeAnnotations(AnnotationBinding[] annotations, boolean evalNullAnnotations) {
        // never set nullTagBits on base types
