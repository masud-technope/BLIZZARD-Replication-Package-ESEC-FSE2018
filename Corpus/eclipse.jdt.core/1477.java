...
public class InfixExpression extends Expression {
    ...
    public static class Operator {
        ...
        public static final Operator RIGHT_SHIFT_UNSIGNED = //$NON-NLS-1$
        new Operator(">>>");
        ...
        static {
            ...
            Operator[] ops = { TIMES, DIVIDE, REMAINDER, PLUS, MINUS, LEFT_SHIFT, RIGHT_SHIFT_SIGNED, RIGHT_SHIFT_UNSIGNED, LESS, GREATER, LESS_EQUALS, GREATER_EQUALS, EQUALS, NOT_EQUALS, XOR, OR, AND, CONDITIONAL_OR, CONDITIONAL_AND };
	 ...
	 * @since 3.0
	 */
    public static final ChildPropertyDescriptor LEFT_OPERAND_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(InfixExpression.class, "leftOperand", Expression.class, MANDATORY, CYCLE_RISK);

    /**
	 * The "operator" structural property of this node type (type: {@link InfixExpression.Operator}).
	 * @since 3.0
	 */
    public static final SimplePropertyDescriptor OPERATOR_PROPERTY = //$NON-NLS-1$
    new SimplePropertyDescriptor(InfixExpression.class, "operator", InfixExpression.Operator.class, MANDATORY);

    /**
	 * The "rightOperand" structural property of this node type (child type: {@link Expression}).
	 * @since 3.0
	 */
    public static final ChildPropertyDescriptor RIGHT_OPERAND_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(InfixExpression.class, "rightOperand", Expression.class, MANDATORY, CYCLE_RISK);

    /**
	 * The "extendedOperands" structural property of this node type (element type: {@link Expression}).
	 * @since 3.0
	 */
    public static final ChildListPropertyDescriptor EXTENDED_OPERANDS_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(InfixExpression.class, "extendedOperands", Expression.class, CYCLE_RISK);
