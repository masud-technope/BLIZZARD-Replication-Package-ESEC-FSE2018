            ...
            for (int i = 1; i < constantPoolCount; i++) {
                ...
                switch(tag) {
                    ...
                    case 1:
                        ...
                        // ConstantUtf8.fixedSize
                        readOffset += 3;
                        break;
                    // IntegerTag
                    case 3:
                        constantPoolOffsets[i] = readOffset;
                        // ConstantInteger.fixedSize
                        readOffset += 5;
                        break;
                    // FloatTag
                    case 4:
                        constantPoolOffsets[i] = readOffset;
                        // ConstantFloat.fixedSize
                        readOffset += 5;
                        break;
                    // LongTag
                    case 5:
                        constantPoolOffsets[i] = readOffset;
                        // ConstantLong.fixedSize
                        readOffset += 9;
                        i++;
                        break;
                    // DoubleTag
                    ...
                    case 7:
                        constantPoolOffsets[i] = readOffset;
                        // ConstantClass.fixedSize
                        readOffset += 3;
                        break;
                    // StringTag
                    case 8:
                        constantPoolOffsets[i] = readOffset;
                        // ConstantString.fixedSize
                        readOffset += 3;
                        break;
                    // FieldRefTag
                    case 9:
                        constantPoolOffsets[i] = readOffset;
                        // ConstantFieldRef.fixedSize
                        readOffset += 5;
                        break;
                    // MethodRefTag
                    case 10:
                        constantPoolOffsets[i] = readOffset;
                        // ConstantMethodRef.fixedSize
                        readOffset += 5;
                        break;
                    // InterfaceMethodRefTag
                    case 11:
                        constantPoolOffsets[i] = readOffset;
                        // ConstantInterfaceMethodRef.fixedSize
                        readOffset += 5;
                        break;
                    // NameAndTypeTag
                    case 12:
                        constantPoolOffsets[i] = readOffset;
                        // ConstantNameAndType.fixedSize
                        readOffset += 5;
                }
            }
            // Skip access flags
