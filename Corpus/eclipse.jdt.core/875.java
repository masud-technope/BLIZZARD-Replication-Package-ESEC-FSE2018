...
public class FieldDeclaration extends AbstractVariableDeclaration {
    ...
    public FlowInfo analyseCode(MethodScope initializationScope, FlowContext flowContext, FlowInfo flowInfo) {
        ...
        if (this.binding != null && this.binding.isValidBinding() && this.binding.isStatic() && !this.binding.isConstantValue() && this.binding.declaringClass.isNestedType() && this.binding.declaringClass.isClass() && !this.binding.declaringClass.isStatic()) {
    ...
    public void generateCode(BlockScope currentScope, CodeStream codeStream) {
        ...
        boolean isStatic;
        if (this.initialization != null && !((isStatic = this.binding.isStatic()) && this.binding.isConstantValue())) {
        ...
        if (!this.hasBeenResolved && this.binding != null && this.binding.isValidBinding()) {
            ...
            if (classScope != null) {
                ...
                if (declaringType.superclass != null) {
                    Binding existingVariable = classScope.findField(declaringType.superclass, this.name, /*do not resolve hidden field*/
                    this, false);
                ...
                if (checkLocal) {
                    ...
                    Binding existingVariable = outerScope.getBinding(this.name, BindingIds.VARIABLE, /*do not resolve hidden field*/
                    this, false);
                    if (existingVariable != null && existingVariable.isValidBinding() && (!(existingVariable instanceof FieldBinding) || ((FieldBinding) existingVariable).isStatic() || !declaringType.isStatic())) {
                        initializationScope.problemReporter().fieldHiding(this, existingVariable);
                    }
                }
            }
            ...
            try {
                ...
                if (this.initialization == null) {
                    ...
                    if (this.initialization instanceof ArrayInitializer) {
                        ...
                        if (this.initialization.isConstantValueOfTypeAssignableToType(initializationType, fieldType) || (fieldType.isBaseType() && BaseTypeBinding.isWidening(fieldType.id, initializationType.id)) || initializationType.isCompatibleWith(fieldType)) {
                            this.initialization.computeConversion(initializationScope, fieldType, initializationType);
                        ...
                        if (// cast from constant actual type to variable type
