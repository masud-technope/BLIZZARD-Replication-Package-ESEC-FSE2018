...
public class CodeSnippetSkeleton implements IBinaryType, EvaluationConstants {
    ...
    IBinaryMethod[] methods = new IBinaryMethod[] { new BinaryMethodSkeleton(//$NON-NLS-1$
    "<init>".toCharArray(), //$NON-NLS-1$
    "()V".toCharArray(), new char[][] {}, true), new BinaryMethodSkeleton(//$NON-NLS-1$
    "run".toCharArray(), //$NON-NLS-1$
    "()V".toCharArray(), //$NON-NLS-1$
    new char[][] { "java/lang/Throwable".toCharArray() }, false), new BinaryMethodSkeleton(//$NON-NLS-1$
    "setResult".toCharArray(), //$NON-NLS-1$
    "(Ljava/lang/Object;Ljava/lang/Class;)V".toCharArray(), new char[][] {}, false) };
