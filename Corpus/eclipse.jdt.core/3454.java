 ...
 */
    public void testCopyConstructorInDifferentProject() throws CoreException {
        try {
            ...
            this.createFile("/P2/src/Y.java", "public class Y {\n" + "}");
 ...
 */
    public void testCopyFieldWithInvalidPositioning() throws CoreException {
        ...
        this.createFile("/P/src/Y.java", "public class Y {\n" + "}");
        IType typeDest = getCompilationUnit("/P/src/Y.java").getType("Y");
        copyNegative(fieldSource, typeDest, typeDest.getField("invalid"), null, false, IJavaModelStatusConstants.INVALID_SIBLING);
    }
 ...
 */
    public void testCopyImportStatic() throws CoreException {
        this.createFile("/P/src/X.java", "import static java.lang.Math;\n" + "public class X {\n" + "  int foo;\n" + "  {\n" + "    foo = 10;\n" + "  }\n" + "}");
 ...
 */
    public void testCopyMoveWithInvalidRenamings() throws CoreException {
        ...
        copyNegative(new IJavaElement[] { methodSource }, new IJavaElement[] { typeSource }, null, new String[] { "bar", "fred" }, false, IJavaModelStatusConstants.INDEX_OUT_OF_BOUNDS);
    }
 ...
 */
    public void testMoveConstructor() throws CoreException {
        ...
        assertTrue("Constructor was not renamed", typeDest.getMethod("Y", new String[] { "QString;" }).exists());
    }
 ...
 */
    public void testMoveMainTypes() throws CoreException {
        ...
        movePositive(new IJavaElement[] { typeSource }, new IJavaElement[] { cu }, null, new String[] { "Y" }, false);
