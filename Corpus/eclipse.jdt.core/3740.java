...
public class X23 {
	 ...
	 *        arranged in non-decreasing order. The array is updated in place
	 *        when this method returns to reflect the corresponding source
	 *        positions in the permuted source code string (but not necessarily
	 *        any longer in non-decreasing order).
	 * @param comparator
