...
public class InMemoryNameEnvironment implements INameEnvironment {
    ...
    public NameEnvironmentAnswer findType(char[][] compoundTypeName) {
        return findType(compoundTypeName[compoundTypeName.length - 1], CharOperation.subarray(compoundTypeName, 0, compoundTypeName.length - 1));
    }
    ...
    public boolean isPackage(char[][] parentPackageName, char[] packageName) {
        ...
        return this.compilationUnits.get(pkg) != null || isPackageFromClassLibs(parentPackageName, packageName);
    }
