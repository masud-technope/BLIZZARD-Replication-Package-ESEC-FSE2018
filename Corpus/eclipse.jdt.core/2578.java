...
public abstract class Engine implements ITypeRequestor {
    ...
    public  Engine(Map<String, String> settings) {
        ...
        this.forbiddenReferenceIsError = (this.compilerOptions.getSeverity(CompilerOptions.ForbiddenReference) & ProblemSeverities.Error) != 0;
        this.discouragedReferenceIsError = (this.compilerOptions.getSeverity(CompilerOptions.DiscouragedReference) & ProblemSeverities.Error) != 0;
    }
    ...
    public void accept(ISourceType[] sourceTypes, PackageBinding packageBinding, AccessRestriction accessRestriction) {
        ...
        if (sourceTypes[0].getEnclosingType() != null) {
            try {
                ...
                ISourceType otherType = (ISourceType) ((JavaElement) types[0]).getElementInfo();
        ...
        CompilationUnitDeclaration unit = SourceTypeConverter.buildCompilationUnit(//sourceTypes[0] is always toplevel here
        sourceTypes, // need field and methods
    ...
    public void initializeImportCaches() {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (importBinding.onDemand) {
                ...
                if (!(importBinding.resolvedImport instanceof MethodBinding) || importBinding instanceof ImportConflictBinding) {
    ...
    public void initializePackageCache() {
        ...
        } else if (this.unitScope.referenceContext != null && this.unitScope.referenceContext.currentPackage != null) {
                ...
                for (int j = 0; j < this.onDemandImportCacheCount; j++) {
                    if (i != j) {
                        ...
                        if (conflictingImportBinding.resolvedImport instanceof ReferenceBinding) {
                            ...
                            if (this.nameEnvironment.nameLookup.findType(String.valueOf(typeName), String.valueOf(conflictingImportName), false, NameLookup.ACCEPT_ALL, /*don't check restrictions*/
                            false) != null) {
                                return true;
                            }
                        }
