    ...
    protected int matchField(FieldBinding field, boolean matchName) {
        ...
        if (receiverBinding == null) {
            if (field == ArrayBinding.ArrayLength)
                ...
                return fieldPattern.declaringQualification == null && fieldPattern.declaringSimpleName == null ? ACCURATE_MATCH : IMPOSSIBLE_MATCH;
            return INACCURATE_MATCH;
        }
        ...
        if (this.isDeclarationOfAccessedFieldsPattern) {
            ...
            if (element != null) {
                if (reference instanceof FieldReference) {
                    ...
                    for (int i = 0; i < otherMax; i++) reportDeclaration(qNameRef.otherBindings[i], locator, declPattern.knownFields);
 ...
 */
    protected int resolveLevelForType(TypeBinding typeBinding) {
        ...
        return resolveLevelForType(fieldPattern.typeSimpleName, fieldPattern.typeQualification, fieldPattern.getTypeArguments(), 0, fieldTypeBinding);
    }
}
