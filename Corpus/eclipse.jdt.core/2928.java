...
public class RootManipulationsTests extends ModifyingResourceTests {
    ...
    protected void copy(IPackageFragmentRoot root, IPath destination, IClasspathEntry sibling) throws JavaModelException {
        root.copy(destination, IResource.NONE, IPackageFragmentRoot.DESTINATION_PROJECT_CLASSPATH, sibling, null);
    }
    ...
    protected void delete(IPackageFragmentRoot root) throws JavaModelException {
        ...
        root.delete(IResource.NONE, IPackageFragmentRoot.ORIGINATING_PROJECT_CLASSPATH | IPackageFragmentRoot.OTHER_REFERRING_PROJECTS_CLASSPATH, null);
    }
    ...
    protected void move(IPackageFragmentRoot root, IPath destination, IClasspathEntry sibling) throws JavaModelException {
        ...
        waitUntilIndexesReady();
        root.move(destination, IResource.NONE, IPackageFragmentRoot.DESTINATION_PROJECT_CLASSPATH | IPackageFragmentRoot.ORIGINATING_PROJECT_CLASSPATH | IPackageFragmentRoot.OTHER_REFERRING_PROJECTS_CLASSPATH, sibling, null);
    }
 ...
 */
    public void testCopySourceFolder1() throws CoreException {
        try {
            ...
            this.createFile("/P1/src/p/X.java", "package p;\n" + "public class X {\n" + "}");
 ...
 */
    public void testCopySourceFolder3() throws CoreException {
        try {
            ...
            p1.setRawClasspath(createClasspath(new String[] { "/P1/src1", "src2/**", "/P1/src1/src2", "" }, /*no inclusion*/
            false, /*exclusion*/
            true), null);
            this.createJavaProject("P2", new String[] {}, "bin");
            this.createFolder("/P1/src1/p");
            this.createFile("/P1/src1/p/X.java", "package p;\n" + "public class X {\n" + "}");
            this.createFolder("/P1/src1/src2/q");
            this.createFile("/P1/src1/src2/q/Y.java", "package q;\n" + "public class Y {\n" + "}");
 ...
 */
    public void testCopySourceFolder6() throws CoreException {
        try {
            ...
            this.createFile("/P/src/p/X.java", "package p;\n" + "public class X {\n" + "}");
            IPackageFragmentRoot root = this.getPackageFragmentRoot("/P/src");
            startDeltas();
            root.copy(new Path("/P/src1"), IResource.KEEP_HISTORY, IPackageFragmentRoot.REPLACE | IPackageFragmentRoot.DESTINATION_PROJECT_CLASSPATH, null, null);
 ...
 */
    public void testDeleteSourceFolder2() throws CoreException {
        try {
            ...
            project.setRawClasspath(createClasspath(new String[] { "/P/src1", "src2/**", "/P/src1/src2", "" }, /*no inclusion*/
            false, /*exclusion*/
            true), null);
            IFolder folder = this.createFolder("/P/src1/p");
            IFile file = this.createFile("/P/src1/p/X.java", "package p;\n" + "public class X {\n" + "}");
            this.createFolder("/P/src1/src2/q");
            this.createFile("/P/src1/src2/q/Y.java", "package q;\n" + "public class Y {\n" + "}");
 ...
 */
    public void testRenameSourceFolder1() throws CoreException {
        try {
            ...
            this.createFile("/P/src1/p/X.java", "package p;\n" + "public class X {\n" + "}");
            IPackageFragmentRoot root = this.getPackageFragmentRoot("/P/src1");
            startDeltas();
 ...
 */
    public void testRenameJarFile3() throws CoreException {
        try {
            ...
            startDeltas();
            root.move(new Path("/P/myLib2.jar"), IResource.NONE, IPackageFragmentRoot.ORIGINATING_PROJECT_CLASSPATH | IPackageFragmentRoot.DESTINATION_PROJECT_CLASSPATH | IPackageFragmentRoot.REPLACE, null, null);
