...
public class CompletionParserTest extends AbstractCompletionTest {
    ...
    public void testA() {
        ...
        checkMethodParse(str.toCharArray(), cursorLocation, expectedCompletionNodeToString, expectedUnitDisplayString, completionIdentifier, expectedReplacedSource, testName);
    }
    ...
    public void testB() {
        ...
        checkDietParse(str.toCharArray(), cursorLocation, expectedCompletionNodeToString, expectedUnitDisplayString, completionIdentifier, expectedReplacedSource, testName);
    }
 ...
 */
    ...
    public void testBug310423() {
        String str = "import java.lang.annotation.Annotation;\n" + "interface In {}\n" + "interface Inn {\n" + "	interface Inn2 {}\n" + "	@interface InAnnot {}\n" + "}\n" + "@interface InnAnnot {}\n" + "public class Test implements In{\n" + "}\n";
        String testName = "";
        String completeBehind = "In";
        String expectedCompletionNodeToString = "<CompleteOnInterface:In>";
        String expectedParentNodeToString = "public class Test implements <CompleteOnInterface:In> {\n" + "  public Test() {\n" + "  }\n" + "}";
        ...
        String expectedUnitDisplayString = "import java.lang.annotation.Annotation;\n" + "interface In {\n" + "}\n" + "interface Inn {\n" + "  interface Inn2 {\n" + "  }\n" + "  @interface InAnnot {\n" + "  }\n" + "}\n" + "@interface InnAnnot {\n" + "}\n" + "public class Test implements <CompleteOnInterface:In> {\n" + "  public Test() {\n" + "  }\n" + "}\n";
        checkDietParse(str.toCharArray(), cursorLocation, expectedCompletionNodeToString, expectedParentNodeToString, expectedUnitDisplayString, completionIdentifier, expectedReplacedSource, testName);
    }
    ...
    public void testBug346454() {
        if (this.complianceLevel < ClassFileConstants.JDK1_7)
            return;
        String str = "public class Test<T> {\n" + "	public void foo() {\n" + "      Test<String> t = new Test<>()\n" + "   }" + "}\n";
