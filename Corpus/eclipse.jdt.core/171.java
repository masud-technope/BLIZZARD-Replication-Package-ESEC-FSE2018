 ...
 */
    public void test09() {
        ...
        String expectedUnitDisplayString = "public class X extends <CompleteOnClass:java.io> {\n" + "  public X() {\n" + "  }\n" + "}\n";
        String expectedReplacedSource = "java.io.IOException";
 ...
 */
    public void test10() {
        String str = "public class X extends IOException implements java.io.Serializable {		\n" + "}																			\n";
        String completeBehind = ".io";
        String expectedCompletionNodeToString = "<CompleteOnInterface:java.io>";
        String completionIdentifier = "io";
        String expectedUnitDisplayString = "public class X extends IOException implements <CompleteOnInterface:java.io> {\n" + "  public X() {\n" + "  }\n" + "}\n";
        String expectedReplacedSource = "java.io.Serializable";
 ...
 */
    public void test12() {
        String str = "public class X extends IOException implements java.io.				 {		\n" + "}																			\n";
        String completeBehind = ".io.";
        String expectedCompletionNodeToString = "<CompleteOnInterface:java.io.>";
        String completionIdentifier = "";
        String expectedUnitDisplayString = "public class X extends IOException implements <CompleteOnInterface:java.io.> {\n" + "  public X() {\n" + "  }\n" + "}\n";
 ...
 */
    public void test20() {
        String str = "class X extends IOException {				\n" + "											\n" + "}											\n";
        String completeBehind = "extends ";
        String expectedCompletionNodeToString = "<CompleteOnClass:>";
        String completionIdentifier = "";
        String expectedUnitDisplayString = "class X extends <CompleteOnClass:> {\n" + "  X() {\n" + "  }\n" + "}\n";
        String expectedReplacedSource = "IOException";
 ...
 */
    public void test31() {
        ...
        String expectedUnitDisplayString = "class Bar {\n" + "  Bar() {\n" + "  }\n" + "  void foo() {\n" + "  }\n" + "}\n";
 ...
 */
    public void test33() {
        ...
        String expectedUnitDisplayString = "package x.abc;\n" + "import <CompleteOnImport:x.util>;\n" + "import x.*;\n" + "class X extends util {\n" + "  X() {\n" + "  }\n" + "  X(int a, int b) {\n" + "  }\n" + "}\n";
 ...
 */
    public void test49() {
        String str = "import java.lang.reflect.*;	\n" + "class X {						\n" + "}								\n";
        ...
        String expectedUnitDisplayString = "import <CompleteOnImport:java.la>;\n" + "class X {\n" + "  X() {\n" + "  }\n" + "}\n";
