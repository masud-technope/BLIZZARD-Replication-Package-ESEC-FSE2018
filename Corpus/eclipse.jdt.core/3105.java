...
class DefaultBindingResolver extends BindingResolver {
    ...
    private synchronized IMethodBinding getMethodOrLambdaBinding(org.eclipse.jdt.internal.compiler.lookup.MethodBinding methodBinding, org.eclipse.jdt.internal.compiler.lookup.MethodBinding descriptor, IBinding enclosingBinding) {
        if (methodBinding != null && !methodBinding.isValidBinding()) {
            org.eclipse.jdt.internal.compiler.lookup.ProblemMethodBinding problemMethodBinding = (org.eclipse.jdt.internal.compiler.lookup.ProblemMethodBinding) methodBinding;
    ...
    synchronized IMemberValuePairBinding getMemberValuePairBinding(ElementValuePair valuePair) {
        if (valuePair == null || valuePair.binding == null)
            return null;
        IMemberValuePairBinding binding = (IMemberValuePairBinding) this.bindingTables.compilerBindingsToASTBindings.get(valuePair);
        if (binding != null)
            return binding;
    ...
    private int getTypeCount(ParameterizedQualifiedTypeReference typeReference) {
        ...
        for (int i = 0; i < length; ++i) {
            if (value != 0 || (typeArguments != null && typeArguments[i] != null) || (typeAnnotations != null && typeAnnotations[i] != null)) {
                value++;
            }
        }
        return value;
                    ...
                    if (variableBinding instanceof ProblemFieldBinding) {
                        ...
                        switch(problemFieldBinding.problemId()) {
                            ...
                            case ProblemReasons.NonStaticReferenceInConstructorInvocation:
                                ...
                                FieldBinding exactBinding = declaringClass.getField(/*resolve*/
                                problemFieldBinding.name, true);
            ...
            if (variableBinding.isValidBinding()) {
                ...
                if (variableBinding instanceof ProblemFieldBinding) {
                    ...
                    switch(problemFieldBinding.problemId()) {
                        ...
                        case ProblemReasons.NonStaticReferenceInConstructorInvocation:
                            ReferenceBinding declaringClass = problemFieldBinding.declaringClass;
                            FieldBinding exactBinding = declaringClass.getField(problemFieldBinding/*resolve*/
                            .name, true);
                            if (exactBinding != null) {
                                IVariableBinding variableBinding2 = (IVariableBinding) this.bindingTables.compilerBindingsToASTBindings.get(exactBinding);
                                if (variableBinding2 != null) {
    ...
    synchronized ITypeBinding resolveWellKnownType(String name) {
        ...
        try {
            if (//$NON-NLS-1$
            ("boolean".equals(name)) || (//$NON-NLS-1$
            "char".equals(//$NON-NLS-1$
            name)) || (//$NON-NLS-1$
            "byte".equals(//$NON-NLS-1$
            name)) || (//$NON-NLS-1$
            "short".equals(//$NON-NLS-1$
            name)) || (//$NON-NLS-1$
            "int".equals(//$NON-NLS-1$
            name)) || (//$NON-NLS-1$
            "long".equals(//$NON-NLS-1$
            name)) || (//$NON-NLS-1$
            "float".equals(//$NON-NLS-1$
            name)) || (//$NON-NLS-1$
            "double".equals(//$NON-NLS-1$
            name)) || //$NON-NLS-1$
            ("void".equals(name))) {
            ...
            "java.lang.StringBuffer".equals(name)) {
            ...
            "java.lang.RuntimeException".equals(name)) {
            ...
            "java.io.Serializable".equals(name)) {
            ...
            "java.lang.AssertionError".equals(name)) {
    ...
    synchronized IAnnotationBinding resolveAnnotation(final Annotation domASTNode) {
        ...
        if (oldNode instanceof org.eclipse.jdt.internal.compiler.ast.Annotation) {
            org.eclipse.jdt.internal.compiler.ast.Annotation internalAstNode = (org.eclipse.jdt.internal.compiler.ast.Annotation) oldNode;
    ...
    ITypeBinding resolveArrayType(ITypeBinding typeBinding, int dimensions) {
        ...
        if (!(leafComponentType instanceof TypeBinding))
            return null;
        org.eclipse.jdt.internal.compiler.lookup.TypeBinding leafTypeBinding = ((TypeBinding) leafComponentType).binding;
        if (leafTypeBinding instanceof VoidTypeBinding) {
            throw new IllegalArgumentException();
        }
        if (typeBinding.isArray()) {
            return this.getTypeBinding(lookupEnvironment().createArrayType(leafTypeBinding, actualDimensions, insertAnnotations((((TypeBinding) typeBinding).binding).getTypeAnnotations(), dimensions)));
        } else {
            return this.getTypeBinding(lookupEnvironment().createArrayType(leafTypeBinding, actualDimensions));
        }
    }

    private org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[] insertAnnotations(org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[] annots, int dimensions) {
        ...
        if (dimensions < 0) {
            ...
            // Just means there were no annotations
            if (dimensions < 0)
                dimensions = 0;
        }
        org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[] newAnnots = new org.eclipse.jdt.internal.compiler.lookup.AnnotationBinding[annots.length - index + dimensions];
