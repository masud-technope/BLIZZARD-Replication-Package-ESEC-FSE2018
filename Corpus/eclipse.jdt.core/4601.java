...
public class SimpleName extends Name {
	 ...
	 * @since 3.0
	 */
    public static final SimplePropertyDescriptor IDENTIFIER_PROPERTY = //$NON-NLS-1$
    new SimplePropertyDescriptor(SimpleName.class, "identifier", String.class, MANDATORY);
    ...
    public void setIdentifier(String identifier) {
        ...
        try {
            ...
            try {
                ...
                IllegalArgumentException iae = new IllegalArgumentException("Invalid identifier : >" + identifier + "<");
                iae.initCause(e);
                throw iae;
            }
        } finally {
