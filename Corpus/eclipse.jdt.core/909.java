...
public class Assignment extends Expression {
    ...
    public static class Operator {
        ...
        /** &lt;&lt;== operator. */
        public static final Operator LEFT_SHIFT_ASSIGN = //$NON-NLS-1$
        new Operator("<<=");

        /** &gt;&gt;= operator. */
        public static final Operator RIGHT_SHIFT_SIGNED_ASSIGN = //$NON-NLS-1$
        new Operator(">>=");

        /** &gt;&gt;&gt;= operator. */
        public static final Operator RIGHT_SHIFT_UNSIGNED_ASSIGN = //$NON-NLS-1$
        new Operator(">>>=");
        ...
        static {
            ...
            Operator[] ops = { ASSIGN, PLUS_ASSIGN, MINUS_ASSIGN, TIMES_ASSIGN, DIVIDE_ASSIGN, BIT_AND_ASSIGN, BIT_OR_ASSIGN, BIT_XOR_ASSIGN, REMAINDER_ASSIGN, LEFT_SHIFT_ASSIGN, RIGHT_SHIFT_SIGNED_ASSIGN, RIGHT_SHIFT_UNSIGNED_ASSIGN };
	 ...
	 * @since 3.0
	 */
    public static final ChildPropertyDescriptor LEFT_HAND_SIDE_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(Assignment.class, "leftHandSide", Expression.class, MANDATORY, CYCLE_RISK);
    ...
    new SimplePropertyDescriptor(Assignment.class, "operator", Assignment.Operator.class, MANDATORY);

    /**
	 * The "rightHandSide" structural property of this node type (child type: {@link Expression}).
	 * @since 3.0
	 */
    public static final ChildPropertyDescriptor RIGHT_HAND_SIDE_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(Assignment.class, "rightHandSide", Expression.class, MANDATORY, CYCLE_RISK);
