...
public class ASTConverter18Test extends ConverterTestSetup {
    ...
    public void test0001() throws JavaModelException {
        String contents = "    @java.lang.annotation.Target (java.lang.annotation.ElementType.TYPE_USE)\n" + "    @interface Marker {\n" + "    }\n" + "public class X {\n" + "	public void foo(int @Marker... args) {\n" + "	}\n" + " 	public void bar(@Marker int @Marker... args) {\n" + " 	}\n" + "}";
    ...
    public void test0002() throws JavaModelException {
        this.workingCopy = getWorkingCopy("/Converter18/src/test0002/X.java", /* resolve */
        true);
    ...
    public void test0003() throws JavaModelException {
        this.workingCopy = getWorkingCopy("/Converter18/src/test0003/X.java", /* resolve */
        true);
    ...
    public void test0004() throws JavaModelException {
        this.workingCopy = getWorkingCopy("/Converter18/src/test0004/X.java", /* resolve */
        true);
        String contents = "package test0004;" + "import java.lang.annotation.Target;\n" + "public class X implements One</*start*/@Marker1 Outer<Integer>. @Marker2 Inner<Double>[]/*end*/> {\n" + "}\n" + "interface One<T> {}\n" + "class Outer<T> {\n" + "	public class Inner<S> {}\n" + "}\n" + "@Target (java.lang.annotation.ElementType.TYPE_USE)\n" + "@interface Marker1 {}\n" + "@Target (java.lang.annotation.ElementType.TYPE_USE)\n" + "@interface Marker2 {}\n";
    ...
    public void test0013() throws JavaModelException {
        this.workingCopy = getWorkingCopy("/Converter18/src/test0010/X.java", /* resolve */
        true);
        String contents = "package test0010;" + "import java.lang.annotation.Target;\n" + "public class X implements One<@Marker1 Integer, @Marker2 Boolean> {\n" + "}\n" + "class Y implements One<@Marker1 @Marker2 Integer, @Marker2 @Marker1 Double> {\n" + "}\n" + "interface One<T, U> {}\n" + "@Target (java.lang.annotation.ElementType.TYPE_USE)\n" + "@interface Marker1 {}\n" + "@Target (java.lang.annotation.ElementType.TYPE_USE)\n" + "@interface Marker2 {}\n";
        CompilationUnit cu = (CompilationUnit) buildAST(contents, this.workingCopy);
    ...
    public void test399793a() throws JavaModelException {
        this.workingCopy = getWorkingCopy("/Converter18/src/test399793/X.java", /* resolve */
        true);
        String contents = "package test399793;" + "interface I {\n" + "	int foo(int x);\n" + "}\n" + "public class X {\n" + " I i =  vlambda -> {return 200;};\n" + "}\n";
        CompilationUnit cu = (CompilationUnit) buildAST(contents, this.workingCopy);
    ...
    public void test402674() throws JavaModelException {
        this.workingCopy = getWorkingCopy("/Converter18/src/test402674/X.java", /* resolve */
        true);
        String contents = "package test402674;" + "public class X {\n" + "  public static interface StringToInt {\n" + "   	int stoi(String s);\n" + "  }\n" + "  public static interface ReduceInt {\n" + "      int reduce(int a, int b);\n" + "  }\n" + "  void foo(StringToInt s) { }\n" + "  void bar(ReduceInt r) { }\n" + "  void bar() {\n" + "      foo(s -> s.length());\n" + "      foo((s) -> s.length());\n" + "      foo((String s) -> s.length()); //SingleVariableDeclaration is OK\n" + "      bar((x, y) -> x+y);\n" + "      bar((int x, int y) -> x+y); //SingleVariableDeclarations are OK\n" + "  }\n" + "}\n";
        CompilationUnit cu = (CompilationUnit) buildAST(contents, this.workingCopy);
        TypeDeclaration typedeclaration = (TypeDeclaration) getASTNode(cu, 0);
        MethodDeclaration methoddecl = (MethodDeclaration) typedeclaration.bodyDeclarations().get(4);
        List statements = methoddecl.getBody().statements();
    ...
    public void testBug406505() throws JavaModelException {
        this.workingCopy = getWorkingCopy("/Converter18/src/test406505/X.java", /* resolve */
        true);
        String contents = "package test406505;" + "import java.lang.annotation.Target;\n" + "import java.io.File;\n" + "public class X {\n" + "	class Folder<@Marker  F extends File> { }\n" + "}\n" + "@Target (java.lang.annotation.ElementType.TYPE_USE)\n" + "@interface Marker {}\n";
        CompilationUnit cu = (CompilationUnit) buildAST(contents, this.workingCopy);
        TypeDeclaration typedeclaration = (TypeDeclaration) getASTNode(cu, 0);
    ...
    public void test417017a() throws JavaModelException {
        this.workingCopy = getWorkingCopy("/Converter18/src/test417017/X.java", /* resolve */
        true);
        String contents = "package test417017;" + "interface I {\n" + "	int foo(int x);\n" + "}\n" + "public class X {\n" + " void fun(int a) {\n" + "  	I i1 = x1-> x1;\n" + "  	I i2 = xxx-> {\n" + "  		i1.foo(a);\n" + "  		return xxx;\n" + "  	};\n" + "  }\n" + "}\n";
        CompilationUnit cu = (CompilationUnit) buildAST(contents, this.workingCopy);
        TypeDeclaration typedeclaration = (TypeDeclaration) getASTNode(cu, 1);
    ...
    public void test417017b() throws JavaModelException {
        this.workingCopy = getWorkingCopy("/Converter18/src/test417017/X.java", /* resolve */
        true);
        String contents = "package test417017;" + "interface I1 {\n" + "	int foo(int a);\n" + "}\n" + "\n" + "interface I2 {\n" + "	public default int foo() {\n" + "		I1 i1 = (a) -> {\n" + "			return a;\n" + "		};\n" + "		//return 0;\n" + "	}\n" + "}\n";
    ...
    public void test417017d() throws JavaModelException {
        this.workingCopy = getWorkingCopy("/Converter18/src/test399794/X.java", /* resolve */
        true);
        String contents = "package test399794;" + "interface I {\n" + "	void foo(X x);\n" + "}\n" + "public class X {\n" + "	void foo(X x) {\n" + "	}\n" + "	I i = this::foo;\n" + "}\n";
        CompilationUnit cu = (CompilationUnit) buildAST(contents, this.workingCopy);
        TypeDeclaration typeDeclaration = (TypeDeclaration) getASTNode(cu, 1);
    ...
    public void test423584() throws JavaModelException {
        ...
        // no NPE, just a null method binding.
        assertTrue("Should be null", resolveMethodBinding == null);
    }
    ...
    public void testBug418979_002() throws JavaModelException {
        ...
        this.workingCopy = getWorkingCopy("/Converter18/src/test/X.java", /*resolve*/
        true);
        ASTNode node = buildAST(contents, this.workingCopy, false);
        assertEquals("Not a compilation unit", ASTNode.COMPILATION_UNIT, node.getNodeType());
        CompilationUnit compilationUnit = (CompilationUnit) node;
    ...
    public void test428526() throws JavaModelException {
        String contents = "interface Foo<T, N extends Number> {\n" + "    void m(T arg);\n" + "    void m(N arg);\n" + "}\n" + "interface Baz extends Foo<Integer, Integer> {}\n";
        this.workingCopy = getWorkingCopy("/Converter18/src/X.java", true);
        ASTNode node = buildAST(contents, this.workingCopy);
        assertEquals("Not a compilation unit", ASTNode.COMPILATION_UNIT, node.getNodeType());
        CompilationUnit compilationUnit = (CompilationUnit) node;
    ...
    public void test428526a() throws JavaModelException {
        String contents = "interface I { X foo(); }\n" + "interface J { Y foo(); }\n" + "interface K extends I, J {}\n" + "class X {}\n" + "class Y extends X {}\n";
        this.workingCopy = getWorkingCopy("/Converter18/src/X.java", true);
        ASTNode node = buildAST(contents, this.workingCopy);
        assertEquals("Not a compilation unit", ASTNode.COMPILATION_UNIT, node.getNodeType());
        CompilationUnit compilationUnit = (CompilationUnit) node;
    ...
    public void testBug425183a() throws JavaModelException {
        ...
        assertElementsEqual("Unexpected elements", "naturalOrder() {key=LBug425183a~Comparator<>;.naturalOrder<T::Ljava/lang/Comparable<-TT;>;>()LComparator<TT;>;%<^{291#0};>} [in Comparator [in [Working copy] Bug425183a.java [in <default> [in src [in Converter18]]]]]", elements, true);
        ...
        assertBindingsEqual(keys[0], requestor.getBindings(keys));
 ...
 */
    public void testBug432051() throws JavaModelException {
        ...
        this.workingCopy = getWorkingCopy("/Converter18/src/test432051/X.java", contents, true);
 ...
 */
    public void testBug426977() throws JavaModelException {
        String contents = "package com.test.todo;\r\n" + "import java.lang.annotation.ElementType;\r\n" + "import java.lang.annotation.Target;\r\n" + "public class Test {\r\n" + "	static void m() {}\r\n" + "	new Runnable() {\r\n" + "		public void run(R) {}\r\n" + "	};\r\n" + "}\r\n" + "@Target(ElementType.TYPE_USE)\r\n" + "@interface TU { }";
    ...
    public void test406805() throws CoreException, IOException {
        ...
        this.workingCopy = getWorkingCopy("/Converter18/src/test406805/X.java", contents1, true);
        ...
        try {
            String[] contents = new String[] { "TestEnum.java", "package test406805;\n" + "public enum TestEnum {\n" + "	FirstValue(\"Zonk\") {\n" + "		@Override\n" + "		public String toString() {\n" + "			return super.toString();\n" + "		}\n" + "	},\n" + "	SecondValue(\"Bla\");\n" + "	String string;\n" + "	TestEnum(String string) {\n" + "		this.string = string;\n" + "	}\n" + "}" };
    ...
    public void test406805a() throws CoreException, IOException {
        ...
        this.workingCopy = getWorkingCopy("/Converter18/src/test406805a/X.java", contents1, true);
        String jarName = "getParameters.jar";
        String srcName = "getParameters_src.zip";
        final IJavaProject javaProject = this.workingCopy.getJavaProject();
        try {
            String[] contents = new String[] { "NestedTestEnum.java", "package test406805a;\n" + "public class NestedTestEnum {\n" + "	public enum TestEnum {\n" + "		FirstValue(\"Zonk\") {\n" + "			@Override\n" + "			public String toString() {\n" + "				return super.toString();\n" + "			}\n" + "		},\n" + "	SecondValue(\"Bla\");\n" + "	String string;\n" + "	TestEnum(String string) {\n" + "		this.string = string;\n" + "	}\n" + "}\n" + "}" };
    ...
    public void test406805b() throws CoreException, IOException {
        ...
        this.workingCopy = getWorkingCopy("/Converter18/src/test406805b/X.java", contents1, true);
        String jarName = "getParameters.jar";
        String srcName = "getParameters_src.zip";
        final IJavaProject javaProject = this.workingCopy.getJavaProject();
        try {
            String[] contents = new String[] { "TestEnum.java", "package test406805b;\n" + "interface A<T> {}\n" + "\n" + "class Y {\n" + "	static A<String> A1;\n" + "}\n" + "public enum TestEnum implements A<String> {\n" + " FirstValue(Y.A1);\n" + "  A<String> xyzabcdef;\n" + "  TestEnum(A<String> abcdefghi) {\n" + "	this.xyzabcdef = abcdefghi;\n" + "  }\n" + " int SecondValue() { return 0;}\n" + "}\n" };
            addLibrary(javaProject, jarName, srcName, contents, JavaCore.VERSION_1_8);
            ASTParser parser = ASTParser.newParser(AST.JLS8);
            parser.setIgnoreMethodBodies(true);
            parser.setProject(javaProject);
    ...
    public void test406805d() throws CoreException, IOException {
        ...
        this.workingCopy = getWorkingCopy("/Converter18/src/test406805d/X.java", contents1, true);
        String jarName = "getParameters.jar";
        String srcName = "getParameters_src.zip";
        final IJavaProject javaProject = this.workingCopy.getJavaProject();
        try {
            String[] contents = new String[] { "NestedTestEnum.java", "package test406805d;\n" + "public class NestedTestEnum {\n" + "	public enum TestEnum {\n" + "		FirstValue(\"Zonk\", 1) {\n" + "			@Override\n" + "			public String toString() {\n" + "				return super.toString();\n" + "			}\n" + "		},\n" + "	SecondValue(\"Bla\", 2);\n" + "	String string;\n" + "   int xyz;\n" + "	TestEnum(String string, int xyz) {\n" + "		this.string = string;\n" + "       this.xyz = xyz;\n" + "	}\n" + "}\n" + "}" };
            addLibrary(javaProject, jarName, srcName, contents, JavaCore.VERSION_1_8, null);
            ASTParser parser = ASTParser.newParser(AST.JLS8);
            parser.setIgnoreMethodBodies(true);
            parser.setProject(javaProject);
    ...
    public void test436347() throws CoreException, IOException {
        String contents1 = "package test436347;\n" + "public class X {\n" + "}";
        createFolder("/Converter18/src/test436347");
        createFile("/Converter18/src/test436347/X.java", contents1);
        this.workingCopy = getWorkingCopy("/Converter18/src/test436347/X.java", contents1, true);
        String jarName = "getParameters.jar";
        String srcName = "getParameters_src.zip";
        final IJavaProject javaProject = this.workingCopy.getJavaProject();
        try {
            String[] contents = new String[] { "TestEnum.java", "package test436347;\n" + "public enum TestEnum {\n" + "	FirstValue() {\n" + "		@Override\n" + "		public String toString() {\n" + "			return super.toString();\n" + "		}\n" + "	},\n" + "	SecondValue();\n" + "	TestEnum() {\n" + "		return;\n" + "	}\n" + "}" };
            addLibrary(javaProject, jarName, srcName, contents, JavaCore.VERSION_1_8);
            ASTParser parser = ASTParser.newParser(AST.JLS8);
            parser.setIgnoreMethodBodies(true);
            parser.setProject(javaProject);
    ...
    public void testBug433879() throws JavaModelException {
        String contents = "package Bug433879;\r\n" + "public class X {\n" + "Class<? extends Exception>[] exceptions;\n" + "	void foo() {\n" + "	try {\n" + "		// some stuff here\n" + "	} catch (exceptions[0] e) {\n" + "   	// some more stuff here\n" + "	}\n" + "	}\n" + "}\n";
    ...
    public void testBug433879a() throws JavaModelException {
        String contents = "package Bug433879a;\n" + "public class X {\n" + "	void foo() {\n" + "		try {\n" + "		    // some stuff here\n" + "		} catch (A[0] e) {\n" + "		    // some more stuff here\n" + "		}\n" + "	}\n" + "}\n";
    ...
    public void testBug433879b() throws JavaModelException {
        String contents = "package Bug433879c;\n" + "public class X {\n" + "	void foo() {\n" + "		try {\n" + "		    // some stuff here\n" + "		} catch (A[0] | B[0] e) {\n" + "		    // some more stuff here\n" + "		}\n" + "	}\n" + "}\n";
    ...
    public void testBug432175() throws JavaModelException {
        this.workingCopy = getWorkingCopy("/Converter18/src/testBug432175/X.java", /* resolve */
        true);
    ...
    public void testBug435348() throws JavaModelException {
        this.workingCopy = getWorkingCopy("/Converter18/src/testBug435348/X.java", /* resolve */
        true);
 ...
 */
    public void testBug447062() throws JavaModelException {
        String contents = "public class X {\n" + "    Runnable foo = () -> {\n" + "    \n" + "    }\n" + "}\n";
        this.workingCopy = getWorkingCopy("/Converter18/src/test447062/X.java", contents, true);
        IJavaProject javaProject = this.workingCopy.getJavaProject();
        class BindingRequestor extends ASTRequestor {
 ...
 */
    public void testBug425601_001() throws JavaModelException {
        this.workingCopy = getWorkingCopy("/Converter18/src/testBug425601_001/Outer.java", /* resolve */
        true);
        ...
        assertTrue(binding.isDeprecated());
        // Middle Case One
        binding = fields[1].getType().resolveBinding();
        assertTrue(binding.isDeprecated());
        // Middle Case Two
        binding = fields[2].getType().resolveBinding();
        assertTrue(binding.isDeprecated());
        // Inner Case One
        binding = fields[4].getType().resolveBinding();
        assertTrue(binding.isDeprecated());
    }
 ...
 */
    public void testBug425601_002() throws JavaModelException {
        this.workingCopy = getWorkingCopy("/Converter18/src/testBug425601_002/Outer.java", /* resolve */
        true);
 ...
 */
    public void testBug440000_001() throws JavaModelException {
        String contents = "interface I<T, R> {\n" + "    R apply(T t);\n" + "}\n" + "public class X {\n" + "    I<Integer, int[]> m1 = int[]::new;\n" + "}\n";
        this.workingCopy = getWorkingCopy("/Converter18/src/X.java", contents, true);
        CompilationUnit cu = (CompilationUnit) buildAST(contents, this.workingCopy);
        TypeDeclaration typedeclaration = (TypeDeclaration) getASTNode(cu, 1);
        FieldDeclaration fieldDeclaration = (FieldDeclaration) typedeclaration.bodyDeclarations().get(0);
        VariableDeclarationFragment fragment = (VariableDeclarationFragment) fieldDeclaration.fragments().get(0);
 ...
 */
    public void testBug459344_001() throws JavaModelException {
        this.workingCopy = getWorkingCopy("/Converter18/src/test459344/X.java", /* resolve */
        true);
        String contents = "package test459344;" + "interface I {\n" + "	int foo();\n" + "}\n" + "public class X {\n" + "	private void foo(Object arg) {\n" + "		I i = arg :: hashCode;\n" + "	}\n" + "}\n";
        CompilationUnit cu = (CompilationUnit) buildAST(contents, this.workingCopy);
        TypeDeclaration typeDeclaration = (TypeDeclaration) getASTNode(cu, 1);
        MethodDeclaration methodDeclaration = typeDeclaration.getMethods()[0];
 ...
 */
    public void testBug460186() throws JavaModelException {
        ...
        this.workingCopy = getWorkingCopy("/Converter18/src/test460186/NPE.java", contents, false);
        IJavaProject javaProject = this.workingCopy.getJavaProject();
        final ASTParser parser = ASTParser.newParser(AST.JLS8);
        parser.setResolveBindings(false);
        parser.setProject(javaProject);
 ...
 */
    public void testBug443232() throws JavaModelException {
        String contents = "package test443232;\n" + "public class E21 {\n" + "	{private int[] nums;\n" + "	void foo() {\n" + "        nums\n" + "	}\n" + "}";
        this.workingCopy = getWorkingCopy("/Converter18/src/test443232/E21.java", contents, false);
        IJavaProject javaProject = this.workingCopy.getJavaProject();
        final ASTParser parser = ASTParser.newParser(AST.JLS8);
        parser.setResolveBindings(false);
        parser.setProject(javaProject);
 ...
 */
    public void test429813() throws JavaModelException {
        this.workingCopy = getWorkingCopy("/Converter18/src/test429813/Snippet.java", /* resolve */
        true);
        String contents = "package test429813;" + "public class Snippet {\n" + "		Function<Integer, int[]> m1L = n -> new int[n];\n" + "}" + "interface Function<T, R> {\n" + "   public R apply(T t);\n" + "}\n";
        CompilationUnit cu = (CompilationUnit) buildAST(contents, this.workingCopy);
        TypeDeclaration typedeclaration = (TypeDeclaration) getASTNode(cu, 0);
        FieldDeclaration fieldDeclaration = (FieldDeclaration) typedeclaration.bodyDeclarations().get(0);
        VariableDeclarationFragment fragment = (VariableDeclarationFragment) fieldDeclaration.fragments().get(0);
    ...
    public void test429813a() throws JavaModelException {
        this.workingCopy = getWorkingCopy("/Converter18/src/test429813/Snippet.java", /* resolve */
        true);
        String contents = "package test429813;" + "interface FTest {\n" + "		Object foo (int[]... ints);\n" + "};" + "class TestX {" + "		FTest fi= ints -> null;\n" + "}\n";
        CompilationUnit cu = (CompilationUnit) buildAST(contents, this.workingCopy);
        TypeDeclaration typedeclaration = (TypeDeclaration) getASTNode(cu, 1);
        FieldDeclaration fieldDeclaration = (FieldDeclaration) typedeclaration.bodyDeclarations().get(0);
        VariableDeclarationFragment fragment = (VariableDeclarationFragment) fieldDeclaration.fragments().get(0);
