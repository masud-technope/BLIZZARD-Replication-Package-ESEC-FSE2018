...
public class BooleanLiteral extends Expression {
	 ...
	 * @since 3.0
	 */
    public static final SimplePropertyDescriptor BOOLEAN_VALUE_PROPERTY = //$NON-NLS-1$
    new SimplePropertyDescriptor(BooleanLiteral.class, "booleanValue", boolean.class, MANDATORY);
