 ...
 */
    public void testInIfStatement() {
        ...
        "class Bar {								\n" + "	void foo() {							\n" + "		if (true) {							\n" + "			new z.y.X(1, 2, i);				\n" + "		}									\n" + "	}										\n" + "}\n", // completeBehind:
        "X(1, 2,", // expectedCompletionNodeToString:
        "<CompleteOnAllocationExpression:new z.y.X(1, 2)>", // expectedUnitDisplayString:
 ...
 */
    public void testNoQualificationSimpleTypeName() {
        ...
        "class Bar {								\n" + "	void foo() {							\n" + "		new X(1, 2, i);						\n" + "	}										\n" + "}\n", // completeBehind:
        "X(1, 2,", // expectedCompletionNodeToString:
        "<CompleteOnAllocationExpression:new X(1, 2)>", // expectedUnitDisplayString:
 ...
 */
    public void testQualifiedWithName() {
        ...
        "class Bar {\n" + "	void foo() {							\n" + "		Buz.x.new X(1, 2, i);				\n" + "	}										\n" + "}\n", // completeBehind:
        "X(1, 2,", // expectedCompletionNodeToString:
        "<CompleteOnQualifiedAllocationExpression:Buz.x.new X(1, 2)>", // expectedUnitDisplayString:
 ...
 */
    public void testQualifiedWithPrimary() {
        ...
        "class Bar {								\n" + "	void foo() {							\n" + "		primary().new X(1, 2, i);			\n" + "	}										\n" + "}\n", // completeBehind:
        "X(1, 2,", // expectedCompletionNodeToString:
        "<CompleteOnQualifiedAllocationExpression:primary().new X(1, 2)>", // expectedUnitDisplayString:
