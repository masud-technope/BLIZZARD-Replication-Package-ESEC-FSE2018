...
public class ElementValuePair {
    ...
    public static class UnresolvedEnumConstant {
        ...
        FieldBinding getResolved() {
            if (this.enumType.isUnresolvedType())
                this.enumType = (ReferenceBinding) BinaryTypeBinding.resolveType(this.enumType, this.environment, /* no raw conversion */
                false);
    ...
    public static Object getValue(Expression expression) {
        ...
        if (expression instanceof ArrayInitializer) {
            ...
            for (int i = 0; i < length; i++) values[i] = getValue(exprs[i]);
            return values;
        }
