    ...
    public void close() throws IOException {
        ...
        try {
            ...
            //TODO - implement reconcile
                ...
                result = gfm.generateFileDuringBuild(_parentFiles, _name.toString(), charset == null ? this.toString() : this.toString(charset), _env.currentProcessorSupportsRTTG(), /* progress monitor */
                null);
            }
            if (result != null) {
