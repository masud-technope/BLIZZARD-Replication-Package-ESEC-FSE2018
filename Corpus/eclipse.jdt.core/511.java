 ...
 */
    ...
    // https://bugs.eclipse.org/bugs/show_bug.cgi?id=200724
    public void test047() {
        this.runConformTest(new String[] { "X.java", "public class X {\n" + "	public static X MyX;\n" + "	public static String s;\n" + "	void foo(String s1) {\n" + // MyX could hold any extending type, hence we must not complain
        "		X.MyX.s = s;" + "	}\n" + "}\n" }, "");
    }
    ...
    public void _test054_definite_unassignment_try_catch() {
        runNegativeTest(// test directory preparation
    ...
    public void test056_definite_unassignment_infinite_for_loop() {
        ...
        "", JavacTestOptions.EclipseJustification.EclipseBug235546);
    }
