        ...
        if (numberOfAnnotations > 0) {
            ...
            if (runtimeVisible) {
                ...
                if (numStandardAnnotations != 0) {
                    ...
                    int tmpIndex = 0;
                    for (int i = 0; i < numberOfAnnotations; i++) if (annos[i] != null)
        ...
        if (numberOfParameters > 0) {
            ...
            for (int i = 0; i < numberOfParameters; i++) {
                ...
                if (numberOfAnnotations > 0) {
                    ...
                    for (int aIndex = 0; aIndex < annos.length; aIndex++) readOffset += annos[aIndex].readOffset;
                }
            }
        }
 ...
 */
    ...
    public boolean equals(Object o) {
        ...
        MethodInfo otherMethod = (MethodInfo) o;
        return CharOperation.equals(getSelector(), otherMethod.getSelector()) && CharOperation.equals(getMethodDescriptor(), otherMethod.getMethodDescriptor());
    }
            ...
            if (CharOperation.equals(attributeName, AttributeNamesConstants.ExceptionsName)) {
                ...
                if (entriesNumber == 0) {
                    ...
                    for (int j = 0; j < entriesNumber; j++) {
                        utf8Offset = this.constantPoolOffsets[u2At(this.constantPoolOffsets[u2At(readOffset)] - this.structOffset + 1)] - this.structOffset;
 ...
 */
    ...
    protected void toStringContent(StringBuffer buffer) {
        ...
        ((modifiers & 0x0080) == 0x0080 ? "varargs " : Util.EMPTY_STRING)).append(getSelector()).append(desc).append('}');
    }
