...
public class SelectionJavadocModelTests extends AbstractJavaModelTests {
    ...
    public void test11() throws JavaModelException {
        ...
        assertElementsEqual("Invalid selection(s)", "RuntimeException [in RuntimeException.class [in java.lang [in " + getExternalJCLPathString("1.5") + "]]]\n" + "InterruptedException [in InterruptedException.class [in java.lang [in " + getExternalJCLPathString("1.5") + "]]]", elements);
    }
    ...
    public void test16() throws JavaModelException {
        ...
        assertElementsEqual("Invalid selection(s)", "Test [in [Working copy] Test.java [in <default> [in <project root> [in Tests]]]]\n" + "Other [in [Working copy] Test.java [in <default> [in <project root> [in Tests]]]]\n" + "Test [in [Working copy] Test.java [in <default> [in <project root> [in Tests]]]]\n" + "Other [in [Working copy] Test.java [in <default> [in <project root> [in Tests]]]]", elements);
    }
    ...
    public void test17() throws JavaModelException {
        ...
        assertElementsEqual("Invalid selection(s)", "Test [in [Working copy] Test.java [in <default> [in <project root> [in Tests]]]]\n" + "Field [in Test [in [Working copy] Test.java [in <default> [in <project root> [in Tests]]]]]\n" + "foo [in Field [in Test [in [Working copy] Test.java [in <default> [in <project root> [in Tests]]]]]]\n" + "Field [in Test [in [Working copy] Test.java [in <default> [in <project root> [in Tests]]]]]\n" + "foo [in Field [in Test [in [Working copy] Test.java [in <default> [in <project root> [in Tests]]]]]]\n" + "foo [in Field [in Test [in [Working copy] Test.java [in <default> [in <project root> [in Tests]]]]]]\n" + "Field [in Test [in [Working copy] Test.java [in <default> [in <project root> [in Tests]]]]]\n" + "foo [in Field [in Test [in [Working copy] Test.java [in <default> [in <project root> [in Tests]]]]]]\n" + "Test [in [Working copy] Test.java [in <default> [in <project root> [in Tests]]]]\n" + "Field [in Test [in [Working copy] Test.java [in <default> [in <project root> [in Tests]]]]]\n" + "foo [in Field [in Test [in [Working copy] Test.java [in <default> [in <project root> [in Tests]]]]]]", elements);
    }
    ...
    public void test19() throws JavaModelException {
        ...
        assertElementsEqual("Invalid selection(s)", "Test [in [Working copy] Test.java [in <default> [in <project root> [in Tests]]]]\n" + "Other [in Test [in [Working copy] Test.java [in <default> [in <project root> [in Tests]]]]]\n" + "Test [in [Working copy] Test.java [in <default> [in <project root> [in Tests]]]]\n" + "Other [in Test [in [Working copy] Test.java [in <default> [in <project root> [in Tests]]]]]\n" + "Test [in [Working copy] Test.java [in <default> [in <project root> [in Tests]]]]\n" + "Other [in Test [in [Working copy] Test.java [in <default> [in <project root> [in Tests]]]]]", elements);
    }
    ...
    public void test22() throws JavaModelException {
        ...
        elements[1] = selectType(this.workingCopies[0], "Other");
        // Running test with Unix/Windows do not matter even if result includes positions as we use working copies
        assertElementsEqual("Invalid selection(s)", "Test [in [Working copy] Test.java [in <default> [in <project root> [in Tests]]]]\n" + "Other [in bar() [in Test [in [Working copy] Test.java [in <default> [in <project root> [in Tests]]]]]]", elements);
    }
    ...
    public void test25() throws JavaModelException {
        ...
        elements[1] = selectType(this.workingCopies[0], "Other");
        // Running test with Unix/Windows do not matter even if result includes positions as we use working copies
        assertElementsEqual("Invalid selection(s)", "Test [in [Working copy] Test.java [in <default> [in <project root> [in Tests]]]]\n" + "Other [in <anonymous #1> [in bar() [in Test [in [Working copy] Test.java [in <default> [in <project root> [in Tests]]]]]]]", elements);
    }
    ...
    public void testBug90266_String() throws JavaModelException {
        ...
        assertElementsEqual("Invalid selection(s)", "field [in Test [in [Working copy] Test.java [in b90266 [in <project root> [in Tests]]]]]", elements);
    }
    ...
    public void testBug165701() throws JavaModelException {
        ...
        IJavaElement[] elements = this.workingCopies[0].codeSelect(selectionPositions[0], 0);
        assertElementsEqual("Invalid selection(s)", "Test [in [Working copy] Test.java [in b165701 [in <project root> [in Tests]]]]", elements);
    }
    ...
    public void testBug165794() throws JavaModelException {
        ...
        IJavaElement[] elements = this.workingCopies[0].codeSelect(selectionPositions[0], 0);
        assertElementsEqual("Invalid selection(s)", "getMax(A<T>) [in X [in [Working copy] Test.java [in b165794 [in <project root> [in Tests]]]]]", elements);
    }
    ...
    public void testBug171802() throws CoreException {
        ...
        assertElementsEqual("Invalid selection(s)", "bar(char[], Y) [in X [in [Working copy] X.java [in b171802 [in <project root> [in Tests]]]]]", elements);
    }
    ...
    public void testBug191322a() throws CoreException {
        ...
        assertElementsEqual("Invalid selection(s)", "foo() [in X [in [Working copy] X.java [in b191322 [in <project root> [in Tests]]]]]", elements);
    }
    ...
    public void testBug191322h() throws CoreException {
        ...
        IJavaElement[] elements = new IJavaElement[1];
        elements[0] = selectMethod(this.workingCopies[0], "foo", 3);
        assertElementsEqual("Invalid selection(s)", "foo(String) [in X [in [Working copy] X.java [in b191322 [in <project root> [in Tests]]]]]", elements);
    }
    ...
    public void testBug191322j2() throws CoreException {
        ...
        IJavaElement[] elements = new IJavaElement[1];
        elements[0] = selectMethod(this.workingCopies[0], "foo", 3);
        assertElementsEqual("Invalid selection(s)", "foo() [in Y [in [Working copy] X.java [in b191322 [in <project root> [in Tests]]]]]", elements);
    }
    ...
    public void testBug191322j3() throws CoreException {
        ...
        IJavaElement[] elements = new IJavaElement[1];
        elements[0] = selectMethod(this.workingCopies[0], "foo", 3);
        assertElementsEqual("Invalid selection(s)", "foo(int) [in X [in [Working copy] X.java [in b191322 [in <project root> [in Tests]]]]]", elements);
    }
    ...
    public void testBug171019c() throws CoreException {
        ...
        IJavaElement[] elements = new IJavaElement[1];
        elements[0] = selectMethod(this.workingCopies[0], "@inheritDoc", 1);
        assertElementsEqual("Invalid selection(s)", "foo(int) [in X2 [in [Working copy] X.java [in b171019 [in <project root> [in Tests]]]]]", elements);
    }
    ...
    public void testBug171019d() throws CoreException {
        ...
        IJavaElement[] elements = new IJavaElement[1];
        elements[0] = selectMethod(this.workingCopies[0], "@inheritDoc", 1);
        assertElementsEqual("Invalid selection(s)", "foo(int) [in X [in [Working copy] X.java [in b171019 [in <project root> [in Tests]]]]]", elements);
    }
    ...
    public void testBug171019f() throws CoreException {
        ...
        assertElementsEqual("Invalid selection(s)", "foo(int) [in X [in [Working copy] X.java [in b171019 [in <project root> [in Tests]]]]]\n" + "foo(int) [in X [in [Working copy] X.java [in b171019 [in <project root> [in Tests]]]]]\n" + "foo(int) [in X [in [Working copy] X.java [in b171019 [in <project root> [in Tests]]]]]\n" + "foo(int) [in X [in [Working copy] X.java [in b171019 [in <project root> [in Tests]]]]]", elements);
    }
    ...
    public void testBug400767() throws Exception {
        ...
        assertElementEquals("Should return a valid element", "componentShown(ComponentEvent) [in ComponentAdapter [in [Working copy] ETest.java [in test [in <project root> [in Tests]]]]]", selection[0]);
    }
}
