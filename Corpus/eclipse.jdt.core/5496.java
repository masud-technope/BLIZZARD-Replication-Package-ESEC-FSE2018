 ...
 */
    public void testInitializerProblem() {
        ...
        try {
            ...
            evaluateWithExpectedProblem(var, // j cannot be resolved to a variable
            newProblem(IProblem.UnresolvedVariable, Error, 11, 11, 2));
        } finally {
            if (var != null) {
        ...
        try {
            ...
            evaluateWithExpectedProblem(var2, // Invalid argument to operation ++/--
            newProblem(IProblem.InvalidUnaryExpression, Error, 11, 11, 2));
        } finally {
            if (var1 != null) {
 ...
 */
    public void _testInvalidName() {
        ...
        try {
            ...
            evaluateWithExpectedProblem(var, // Syntax error, delete these tokens
            newProblem(IProblem.ParsingErrorDeleteTokens, Error, 0, 9, 0));
        } finally {
            if (var != null) {
                this.context.deleteVariable(var);
            }
        ...
        try {
            ...
            evaluateWithExpectedProblem(var2, // Syntax error, delete these tokens
            newProblem(IProblem.ParsingErrorDeleteTokens, Error, 0, 9, 0));
        } finally {
            if (var1 != null) {
                this.context.deleteVariable(var1);
 ...
 */
    public void testUnknownType() {
        ...
        try {
            ...
            evaluateWithExpectedProblem(var, // The type foo is undefined
            newProblem(IProblem.UndefinedType, Error, 0, 2, -1));
        } finally {
            if (var != null) {
                this.context.deleteVariable(var);
            }
        ...
        try {
            ...
            evaluateWithExpectedProblem(var2, // The type foo is undefined
            newProblem(IProblem.UndefinedType, Error, 0, 2, -1));
        } finally {
            if (var1 != null) {
                this.context.deleteVariable(var1);
