...
public class JavadocFieldReference extends FieldReference {
	...
	*/
    ...
    protected TypeBinding internalResolveType(Scope scope) {
        ...
        Binding fieldBinding = (this.receiver != null && this.receiver.isThis()) ? scope.classScope().getBinding(this.token, this.bits & RestrictiveFlagMASK, /*resolve*/
        this, true) : scope.getField(this.actualReceiverType, this.token, this);
            ...
            switch(fieldBinding.problemId()) {
                ...
                case ProblemReasons.InheritedNameHidesEnclosingName:
                    ...
                    if (closestMatch != null) {
                        // ignore problem if can reach target field through it
