...
public class SetClasspathOperation extends ChangeClasspathOperation {
    ...
    protected void executeOperation() throws JavaModelException {
        ...
        try {
            ...
            classpathChanged(classpathChange, /*refresh if external linked folder already exists*/
            true);
    ...
    protected ISchedulingRule getSchedulingRule() {
        if (this.canChangeResources) {
            ...
            return new MultiRule(new ISchedulingRule[] { // use project modification rule as this is needed to create the .classpath file if it doesn't exist yet, or to update project references
            ruleFactory.modifyRule(this.project.getProject()), // and external project modification rule in case the external folders are modified
