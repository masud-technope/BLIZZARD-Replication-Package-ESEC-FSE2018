...
public class FullSourceWorkspaceTypeHierarchyTests extends FullSourceWorkspaceTests implements IJavaSearchConstants {
    ...
    public void testPerSuperTypes() throws CoreException {
        ...
        setComment(Performance.EXPLAINS_DEGRADATION_COMMENT, "Extra handling of type parameters even in case of 1.4 projects");
        // Warm up
        for (// More Warm up is required.
        int i = 0; // More Warm up is required.
        i < 10 * WARMUP_COUNT; // More Warm up is required.
        i++) {
