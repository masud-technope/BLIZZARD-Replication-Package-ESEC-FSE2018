 ...
 */
    protected void writeFiles(String[] sources) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            IPath filePath = new Path(sources[2 * i]).removeFirstSegments(2);
    ...
    public void test004() throws JavaModelException {
        ...
        assertResults("serial[JAVADOC_BLOCK_TAG]{@serial, null, null, serial, null, " + this.positions + JAVADOC_RELEVANCE + "}");
    }
    ...
    public void test005() throws JavaModelException {
        ...
        assertResults("since[JAVADOC_BLOCK_TAG]{@since, null, null, since, null, " + this.positions + JAVADOC_RELEVANCE + "}");
    }
    ...
    public void test011() throws JavaModelException {
        ...
        assertResults("BasicTestReferences[TYPE_REF]{org.eclipse.jdt.core.tests.BasicTestReferences, org.eclipse.jdt.core.tests, Lorg.eclipse.jdt.core.tests.BasicTestReferences;, null, null, " + this.positions + R_DRICNR + "}");
    }
    ...
    public void test012() throws JavaModelException {
        ...
        assertResults("BasicTestReferences[TYPE_REF]{org.eclipse.jdt.core.tests.BasicTestReferences, org.eclipse.jdt.core.tests, Lorg.eclipse.jdt.core.tests.BasicTestReferences;, null, null, " + this.positions + R_DRICQNR + "}");
    }
    ...
    public void test013() throws JavaModelException {
        ...
        assertResults("java.lang.annotation[PACKAGE_REF]{java.lang.annotation, java.lang.annotation, null, null, null, " + this.positions + R_DRICQNR + "}\n" + "java.lang[PACKAGE_REF]{java.lang, java.lang, null, null, null, " + this.positions + R_DRICQNR + "}");
    }
    ...
    public void test022() throws JavaModelException {
        String[] sources = { "/Completion/src/javadoc/tags/package-info.java", /**\n" +
			" * Completion after:\n" +
			" * 	@see OtherTypes#bar\n" +
			" */
        "/**\n" + " * Completion after:\n" + " * 	@see OtherTypes#bar\n" + " */\n" + "package javadoc.tags;\n", "/Completion/src/javadoc/tags/OtherTypes.java", "package javadoc.tags;\n" + "public class OtherTypes {\n" + "	int bar;\n" + "}" };
        completeInJavadoc(sources, true, "bar");
        assertResults("bar[FIELD_REF]{bar, Ljavadoc.tags.OtherTypes;, I, bar, null, " + this.positions + R_DRICENNRNS + "}");
    }
    ...
    public void test023() throws JavaModelException {
		...
		" */
        "/**\n" + " * Completion after:\n" + " * 	@see BasicTestReferences#\n" + " */\n" + "package javadoc.tags;\n";
        completeInJavadoc("/Completion/src/javadoc/tags/package-info.java", source, true, "#", 0);
        assertResults("");
    }
    ...
    public void test030() throws JavaModelException {
        String[] sources = { "/Completion/src/javadoc/tags/package-info.java", /**\n" +
			...
			" * 	@see OtherTypes#meth\n" +
			" */
        "/**\n" + " * Completion after:\n" + " * 	@see OtherTypes#meth\n" + " */\n" + "package javadoc.tags;", "/Completion/src/javadoc/tags/OtherTypes.java", "package javadoc.tags;\n" + "public class OtherTypes {\n" + "	void method() {};\n" + "}" };
        completeInJavadoc(sources, true, "meth");
        assertResults("method[METHOD_REF]{method(), Ljavadoc.tags.OtherTypes;, ()V, method, null, " + this.positions + R_DRICNRNS + "}");
    }
    ...
    public void test040() throws JavaModelException {
        ...
        assertResults("OtherTypes[METHOD_REF<CONSTRUCTOR>]{OtherTypes(), Ljavadoc.tags.OtherTypes;, ()V, OtherTypes, null, " + this.positions + R_DRINR + "}");
    }

    public void test041() throws JavaModelException {
        String[] sources = { "/Completion/src/javadoc/tags/package-info.java", "/**\n" + " * Completion after:\n" + " * 	@see OtherTypes#O\n" + " */\n" + "package javadoc.tags;\n", "/Completion/src/javadoc/tags/OtherTypes.java", "package javadoc.tags;\n" + "public class OtherTypes {\n" + "	OtherTypes(int x) {};\n" + "	OtherTypes(Object obj, String str) {};\n" + "}" };
        completeInJavadoc(sources, true, "O", 2);
        assertResults("OtherTypes[METHOD_REF<CONSTRUCTOR>]{OtherTypes(Object, String), Ljavadoc.tags.OtherTypes;, (Ljava.lang.Object;Ljava.lang.String;)V, OtherTypes, (obj, str), " + this.positions + R_DRINR + "}\n" + "OtherTypes[METHOD_REF<CONSTRUCTOR>]{OtherTypes(int), Ljavadoc.tags.OtherTypes;, (I)V, OtherTypes, (x), " + this.positions + R_DRINR + "}");
    }
}
