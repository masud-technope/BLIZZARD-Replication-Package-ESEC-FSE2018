...
public class ASTConverter17Test extends ConverterTestSetup {
    ...
    public void test0001() throws JavaModelException {
        ...
        this.workingCopy = getWorkingCopy("/Converter17/src/X.java", /*resolve*/
        true);
    ...
    public void test0017() throws JavaModelException {
        String contents = "package test0017;\n" + "public class Y {}";
        this.workingCopy = getWorkingCopy("/Converter17/src/test0017/Y.java", contents, /*resolve*/
        true);
    ...
    public void test0019() throws JavaModelException {
        String contents = "package test0019;\n" + "public class Y {}";
        this.workingCopy = getWorkingCopy("/Converter17/src/test0017/Y.java", contents, /*resolve*/
        true);
    ...
    public void test0020() throws JavaModelException {
        String contents = "public class DiamondTest<T> {\n" + "	public <U> DiamondTest(T t) {}\n" + "	public static void main ( String[] args ) {\n" + "		DiamondTest<String> d = new <Integer> DiamondTest<>();\n" + "	}\n" + "}";
        this.workingCopy = getWorkingCopy("/Converter17/src/DiamondTest.java", /*resolve*/
        true);
        this.workingCopy.getBuffer().setContents(contents);
    ...
    public void test402673a() throws JavaModelException {
        String contents = "package test402673;" + "public class X {\n" + "    Runnable r = () -> System.out.println(\"hi\");\n" + "}\n";
        this.workingCopy = getWorkingCopy("/Converter/src/test402673/X.java", true);
        this.workingCopy.getBuffer().setContents(contents);
        ASTNode node = runConversion(this.workingCopy, true);
