...
public class FieldBinding extends VariableBinding {
    ...
    // number or accesses via postIncrement or compoundAssignment
 ...
 */
    public char[] computeUniqueKey(boolean isLeaf) {
        ...
        CharOperation.NO_CHAR : this.declaringClass.computeUniqueKey(/*not a leaf*/
        false);
 ...
 */
    public long getAnnotationTagBits() {
        ...
        if ((originalField.tagBits & TagBits.AnnotationResolved) == 0 && originalField.declaringClass instanceof SourceTypeBinding) {
            ...
            if (// synthetic fields do not have a scope nor any annotations
            scope == null) {
 ...
 */
    ...
    public FieldDeclaration sourceField() {
        ...
        if (fields != null) {
            for (int i = fields.length; --i >= 0; ) if (this == fields[i].binding)
                return fields[i];
        }
        return null;
    }
