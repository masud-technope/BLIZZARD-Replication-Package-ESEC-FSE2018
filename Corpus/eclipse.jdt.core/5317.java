...
public class ManifestAnalyzer {
    ...
    private static final int START = 0, // multistate
    IN_CLASSPATH_HEADER = 1, PAST_CLASSPATH_HEADER = 2, SKIPPING_WHITESPACE = 3, READING_JAR = 4, CONTINUING = 5, SKIP_LINE = 6;

    private static final char[] CLASSPATH_HEADER_TOKEN = //$NON-NLS-1$
