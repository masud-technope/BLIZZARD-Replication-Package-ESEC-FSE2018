...
public class PackageDeclaration extends ASTNode {
	 ...
	 * @since 3.0
	 */
    public static final ChildPropertyDescriptor JAVADOC_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(PackageDeclaration.class, "javadoc", Javadoc.class, OPTIONAL, NO_CYCLE_RISK);

    /**
	 * The "annotations" structural property of this node type (element type: {@link Annotation}) (added in JLS3 API).
	 * @since 3.1
	 */
    public static final ChildListPropertyDescriptor ANNOTATIONS_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(PackageDeclaration.class, "annotations", Annotation.class, CYCLE_RISK);
    ...
    new ChildPropertyDescriptor(PackageDeclaration.class, "name", Name.class, MANDATORY, NO_CYCLE_RISK);
