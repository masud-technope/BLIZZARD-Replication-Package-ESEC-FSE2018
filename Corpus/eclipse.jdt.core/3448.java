...
public class PackageBindingTest extends AbstractCompilerTest {
    ...
    public void test03() {
        ...
        //the method findType(char[], char[][]) should got executed (without an option to avoid the search for secondary types)
        assertTrue(nameEnv.isTypeSearchExecuted);
    }
    ...
    public void test04() {
        ...
        PackageBinding packageBinding = lookupEnv.createPackage(new char[][] { "org/eclipse/jdt".toCharArray(), "org/eclipse/jdt/internal".toCharArray() });
        assertNotNull(packageBinding);
        //the method findType(char[], char[][], boolean) should got executed ...
        assertTrue(nameEnvWithProgress.isTypeSearchExecutedWithSearchWithSecondaryTypes);
        //... but without the search for secondary types
        assertFalse(nameEnvWithProgress.isTypeSearchWithSearchWithSecondaryTypes);
    }
