...
public class RunAllTests extends junit.framework.TestCase {
    ...
    public static Class[] getAllTestClasses() {
        return new Class[] { RunConverterTests.class, ASTTest.class, ASTVisitorTest.class, ASTMatcherTest.class, ASTStructuralPropertyTest.class, ASTParserTest.class, ASTModelBridgeTests.class, BatchASTCreationTests.class, CompatibilityRulesTests.class, org.eclipse.jdt.core.tests.rewrite.describing.ASTRewritingTest.class, org.eclipse.jdt.core.tests.rewrite.modifying.ASTRewritingModifyingTest.class, ASTPositionsTest.class, ASTNodeFinderTest.class, org.eclipse.jdt.core.tests.dom.APIDocumentationTests.class };
    }
