...
public class TypeMirrorImpl implements TypeMirror {
    ...
    public TypeKind getKind() {
        switch(_binding.kind()) {
            ...
            case Binding.IMPORT:
                //$NON-NLS-1$
                throw new IllegalArgumentException("Invalid binding kind: " + _binding.kind());
        }
        return null;
    }
	...
	*/
    ...
    public List<? extends AnnotationMirror> getAnnotationMirrors() {
        return _env == null ? Factory.EMPTY_ANNOTATION_MIRRORS : _env.getFactory().getAnnotationMirrors(getPackedAnnotationBindings());
    }
