...
public abstract class ASTBasedDeclarationImpl extends EclipseDeclarationImpl {
    ...
    public  ASTBasedDeclarationImpl(ASTNode astNode, IFile file, BaseProcessorEnv env) {
        ...
        assert astNode instanceof BodyDeclaration || astNode instanceof VariableDeclaration : //$NON-NLS-1$
        "ast node must be either a body declaration or a variable declaration";
        _astNode = astNode;
        _file = file;
    }
