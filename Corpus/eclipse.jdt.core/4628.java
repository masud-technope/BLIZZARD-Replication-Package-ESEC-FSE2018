...
public class TypeParameter extends ASTNode {
	 ...
	 * @since 3.10
	 */
    public static final ChildListPropertyDescriptor MODIFIERS_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(TypeParameter.class, "modifiers", IExtendedModifier.class, CYCLE_RISK);

    /**
	 * The "name" structural property of this node type (child type: {@link SimpleName}).
	 */
    public static final ChildPropertyDescriptor NAME_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(TypeParameter.class, "name", SimpleName.class, MANDATORY, NO_CYCLE_RISK);

    /**
	 * The "typeBounds" structural property of this node type (element type: {@link Type}).
	 */
    public static final ChildListPropertyDescriptor TYPE_BOUNDS_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(TypeParameter.class, "typeBounds", Type.class, NO_CYCLE_RISK);
