...
public class Util {
    ...
    static {
        ...
        // default is to keep previous run directories for 2 hours
        long delay = millisecondsPerHour * 2;
        try {
 ...
 */
    ...
    public static void createJar(String[] pathsAndContents, String[] extraPathsAndContents, Map options, String[] classpath, String jarPath) throws IOException {
        ...
        if (extraPathsAndContents != null) {
            for (int i = 0, l = extraPathsAndContents == null ? 0 : extraPathsAndContents.length; /* inc in loop */
            i < l; ) {
    ...
    public static void createJar(String[] javaPathsAndContents, String[] extraPathsAndContents, String jarPath, String compliance) throws IOException {
        createJar(javaPathsAndContents, extraPathsAndContents, jarPath, null, /*no classpath*/
        compliance);
    }
 ...
 */
    private static boolean waitUntilFileDeleted(File file) {
        if (DELETE_DEBUG) {
            ...
            // display parent with its children
 ...
 */
    ...
    public static void zip(File rootDir, String zipPath) throws IOException {
        ...
        try {
            ...
            if (zipFile.exists()) {
                ...
                // some platform (like Linux) have a 1s granularity)
                int timeToWait = 1000;
            ...
            // 1 for last slash
            zip(rootDir, zip, rootDir.getPath().length() + 1);
        } finally {
            if (zip != null) {
                zip.close();
            }
    ...
    public static long getMajorMinorVMVersion() {
        ...
        if (classFileVersion != null) {
            String[] versionParts = classFileVersion.split("\\.");
