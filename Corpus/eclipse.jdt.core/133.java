...
public class LambdaExpressionsTest extends AbstractRegressionTest {
    ...
    public void test056() {
        ...
        false, JavacTestOptions.Excuse.JavacGeneratesIncorrectCode, new String[] { "X.java", "interface I {\n" + "	void foo(int i);\n" + "}\n" + "public class X {\n" + "	public static void main(String[] args) {\n" + "		X x = null;\n" + "		I i = x::foo;\n" + "		try {\n" + "			i.foo(10);\n" + "		} catch (NullPointerException npe) {\n" + "			System.out.println(npe.getMessage());\n" + "		}\n" + "	}\n" + "	int foo(int x) {\n" + "		return x;\n" + "	}\n" + "}\n" }, "null");
    }
    ...
    public void testReferenceExpressionInference3a() {
        runConformTest(/* skipJavac*/
        false, JavacTestOptions.Excuse.JavacDoesNotCompileCorrectSource, new String[] { "X.java", "interface I<E,F> {\n" + "	F foo(E e);\n" + "}\n" + "public class X {\n" + "	<S,T,U> I<S,U> compose(I<S,T> i1, I<T,U> i2) { return null; }\n" + "	void test() {\n" + // help inference with an explicit type argument
    ...
    public void test430035a() {
        // test reference expressions requiring bridges.
    ...
    public void test430035f() {
        // ensure co-variant return emits a bridge request.
    ...
    public void test430241() {
        // ensure raw return type variant does not emit a bridge request.
