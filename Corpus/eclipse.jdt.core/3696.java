...
public class LabeledStatement extends Statement {
	 ...
	 * @since 3.0
	 */
    public static final ChildPropertyDescriptor LABEL_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(LabeledStatement.class, "label", SimpleName.class, MANDATORY, NO_CYCLE_RISK);
    ...
    new ChildPropertyDescriptor(LabeledStatement.class, "body", Statement.class, MANDATORY, CYCLE_RISK);
	 ...
	 */
    int treeSize() {
        return memSize() + (this.labelName == null ? 0 : getLabel().treeSize()) + (this.body == null ? 0 : getBody().treeSize());
    }
}
