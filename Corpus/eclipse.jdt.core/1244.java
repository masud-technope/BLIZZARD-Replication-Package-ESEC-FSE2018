...
public class PauseAnnotationProcessor extends BaseProcessor {
    ...
    public  PauseAnnotationProcessor(Set<AnnotationTypeDeclaration> decls, AnnotationProcessorEnvironment env) {
        super(env);
        assert decls.size() == 1;
    ...
    public void process() {
        ...
        for (Declaration decl : annotatedDecls) {
            ...
            while (System.currentTimeMillis() < end) for (int i = 0; i < 100000; ++i) {
            /* pausing */
            }
