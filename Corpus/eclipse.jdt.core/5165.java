...
public class ASTRewritingMethodDeclTest extends ASTRewritingTest {
    ...
    public void _testListRemoves3() throws Exception {
        ...
        try {
            newOptions.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_METHOD_DECLARATION, JavaCore.INSERT);
            newOptions.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_CLOSING_PAREN_IN_METHOD_DECLARATION, JavaCore.INSERT);
            newOptions.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BETWEEN_EMPTY_PARENS_IN_METHOD_DECLARATION, JavaCore.DO_NOT_INSERT);
    ...
    public void _testReceiver4_since_8() throws Exception {
        ...
        // Remove the receiver type and qualifying name
        MethodDeclaration method1 = (MethodDeclaration) type.bodyDeclarations().get(0);
        // Remove the receiver but not the qualifier
        MethodDeclaration method2 = (MethodDeclaration) type.bodyDeclarations().get(1);
        // Remove the qualifier only 
        MethodDeclaration method3 = (MethodDeclaration) type.bodyDeclarations().get(2);
        // Remove the qualifier and receiver annotation
        MethodDeclaration method4 = (MethodDeclaration) type.bodyDeclarations().get(3);
        // Remove the receiver type and all parameters
        MethodDeclaration method5 = (MethodDeclaration) type.bodyDeclarations().get(4);
        // Remove the receiver type and add a param
        MethodDeclaration method6 = (MethodDeclaration) type.bodyDeclarations().get(5);
        // Remove the qualifier and remove a param
        MethodDeclaration method7 = (MethodDeclaration) type.bodyDeclarations().get(6);
        // Remove the qualifier and replace a param
        MethodDeclaration method8 = (MethodDeclaration) type.bodyDeclarations().get(7);
        // Add a receiver type and qualifier with annotation
        MethodDeclaration method9 = (MethodDeclaration) type.bodyDeclarations().get(8);
        // Add a receiver type and qualifier with annotations and add one parameter
        MethodDeclaration method10 = (MethodDeclaration) type.bodyDeclarations().get(9);
        // Add a receiver type with qualifier & annotations and remove all parameters
        MethodDeclaration method11 = (MethodDeclaration) type.bodyDeclarations().get(10);
        // Keep the receiver type and qualifier, but alter parameters
        MethodDeclaration method12 = (MethodDeclaration) type.bodyDeclarations().get(11);
        // Keep the receiver type and qualifier, but alter parameters
        MethodDeclaration method13 = (MethodDeclaration) type.bodyDeclarations().get(12);
    ...
    public void testReceiver5_since_8() throws Exception {
        ...
        AST ast = astRoot.getAST();
        TypeDeclaration type = (TypeDeclaration) findTypeDeclaration(astRoot, "XYZ").bodyDeclarations().get(0);
        // Change receiver type's child/children
        MethodDeclaration method1 = (MethodDeclaration) type.bodyDeclarations().get(0);
        // Insert receiver qualifier
        MethodDeclaration method2 = (MethodDeclaration) type.bodyDeclarations().get(1);
        // Replace receiver qualifier
        MethodDeclaration method3 = (MethodDeclaration) type.bodyDeclarations().get(2);
        // Change receiver qualifier's children
        MethodDeclaration method4 = (MethodDeclaration) type.bodyDeclarations().get(3);
