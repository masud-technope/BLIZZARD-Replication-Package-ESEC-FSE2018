...
public class ReadAnnotationProcessor extends BaseProcessor {
    ...
    private void assertAnnotation(final String[] expected, Collection<AnnotationMirror> annotations) {
        ...
        //$NON-NLS-1$
        junit.framework.TestCase.assertEquals("annotation number mismatch", expected.length, annotations.size());
        ...
        for (AnnotationMirror mirror : annotations) {
            ...
            if (counter >= expectedLen)
                //$NON-NLS-1$
                junit.framework.TestCase.assertEquals(//$NON-NLS-1$
                "", //$NON-NLS-1$
                mirrorString);
            else {
                ...
                //$NON-NLS-1$
                junit.framework.TestCase.assertTrue(//$NON-NLS-1$
                "unexpected annotation " + mirrorString, //$NON-NLS-1$
                contains);
