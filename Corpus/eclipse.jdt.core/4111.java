...
public class TestBase extends BuilderTests {
    ...
    // used to create unique project names, to avoid resource deletion problems
    ...
    private static void addAnnotationJar(IJavaProject jproj) throws Exception {
        // name in bundle
        final String resName = "lib/annotations.jar";
        // name in destination project
        final String libName = resName;
        InputStream is = null;
