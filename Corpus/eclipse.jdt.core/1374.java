...
public class Test {
    ...
    public boolean combineScriptsExist() {
        ...
        File matchorwarp = new File(System.getProperty("user.dir"), "matchorwarp.com");
        ...
        return solvematchshift.exists() && solvematchmod.exists() && atchvol1.exists() && matchorwarp.exists() && patchcorr.exists() && volcombine.exists() && warpvol.exists();
    }
}
