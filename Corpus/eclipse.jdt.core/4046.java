...
public class ASTMatcher {
    ...
    public boolean match(AnnotationTypeDeclaration node, Object other) {
        ...
        return (safeSubtreeMatch(node.getJavadoc(), o.getJavadoc()) && safeSubtreeListMatch(node.modifiers(), o.modifiers()) && safeSubtreeMatch(node.getName(), o.getName()) && safeSubtreeListMatch(node.bodyDeclarations(), o.bodyDeclarations()));
    }
    ...
    public boolean match(AnnotationTypeMemberDeclaration node, Object other) {
        ...
        // node type added in JLS3 - ignore old JLS2-style modifiers
        return (safeSubtreeMatch(node.getJavadoc(), o.getJavadoc()) && safeSubtreeListMatch(node.modifiers(), o.modifiers()) && safeSubtreeMatch(node.getType(), o.getType()) && safeSubtreeMatch(node.getName(), o.getName()) && safeSubtreeMatch(node.getDefault(), o.getDefault()));
    }
    ...
    public boolean match(ArrayType node, Object other) {
        ...
        return safeSubtreeMatch(node.getElementType(), o.getElementType()) && safeSubtreeListMatch(node.dimensions(), o.dimensions());
    }
    ...
    public boolean match(Assignment node, Object other) {
        ...
        return (node.getOperator().equals(o.getOperator()) && safeSubtreeMatch(node.getLeftHandSide(), o.getLeftHandSide()) && safeSubtreeMatch(node.getRightHandSide(), o.getRightHandSide()));
    }
    ...
    public boolean match(ClassInstanceCreation node, Object other) {
        ...
        return safeSubtreeMatch(node.getExpression(), o.getExpression()) && safeSubtreeListMatch(node.arguments(), o.arguments()) && safeSubtreeMatch(node.getAnonymousClassDeclaration(), o.getAnonymousClassDeclaration());
    }
    ...
    public boolean match(CompilationUnit node, Object other) {
        ...
        return (safeSubtreeMatch(node.getPackage(), o.getPackage()) && safeSubtreeListMatch(node.imports(), o.imports()) && safeSubtreeListMatch(node.types(), o.types()));
    }
    ...
    public boolean match(ConditionalExpression node, Object other) {
        ...
        return (safeSubtreeMatch(node.getExpression(), o.getExpression()) && safeSubtreeMatch(node.getThenExpression(), o.getThenExpression()) && safeSubtreeMatch(node.getElseExpression(), o.getElseExpression()));
    }
    ...
    public boolean match(CreationReference node, Object other) {
        ...
        return (safeSubtreeMatch(node.getType(), o.getType()) && safeSubtreeListMatch(node.typeArguments(), o.typeArguments()));
    }
    ...
    public boolean match(EnhancedForStatement node, Object other) {
        ...
        return (safeSubtreeMatch(node.getParameter(), o.getParameter()) && safeSubtreeMatch(node.getExpression(), o.getExpression()) && safeSubtreeMatch(node.getBody(), o.getBody()));
    }
    ...
    public boolean match(EnumConstantDeclaration node, Object other) {
        ...
        return (safeSubtreeMatch(node.getJavadoc(), o.getJavadoc()) && safeSubtreeListMatch(node.modifiers(), o.modifiers()) && safeSubtreeMatch(node.getName(), o.getName()) && safeSubtreeListMatch(node.arguments(), o.arguments()) && safeSubtreeMatch(node.getAnonymousClassDeclaration(), o.getAnonymousClassDeclaration()));
    }
    ...
    public boolean match(EnumDeclaration node, Object other) {
        ...
        return (safeSubtreeMatch(node.getJavadoc(), o.getJavadoc()) && safeSubtreeListMatch(node.modifiers(), o.modifiers()) && safeSubtreeMatch(node.getName(), o.getName()) && safeSubtreeListMatch(node.superInterfaceTypes(), o.superInterfaceTypes()) && safeSubtreeListMatch(node.enumConstants(), o.enumConstants()) && safeSubtreeListMatch(node.bodyDeclarations(), o.bodyDeclarations()));
    }
    ...
    public boolean match(ExpressionMethodReference node, Object other) {
        ...
        return (safeSubtreeMatch(node.getExpression(), o.getExpression()) && safeSubtreeListMatch(node.typeArguments(), o.typeArguments()) && safeSubtreeMatch(node.getName(), o.getName()));
    }
    ...
    public boolean match(ForStatement node, Object other) {
        ...
        return (safeSubtreeListMatch(node.initializers(), o.initializers()) && safeSubtreeMatch(node.getExpression(), o.getExpression()) && safeSubtreeListMatch(node.updaters(), o.updaters()) && safeSubtreeMatch(node.getBody(), o.getBody()));
    }
    ...
    public boolean match(IfStatement node, Object other) {
        ...
        return (safeSubtreeMatch(node.getExpression(), o.getExpression()) && safeSubtreeMatch(node.getThenStatement(), o.getThenStatement()) && safeSubtreeMatch(node.getElseStatement(), o.getElseStatement()));
    }
    ...
    public boolean match(InfixExpression node, Object other) {
        ...
        return (node.getOperator().equals(o.getOperator()) && safeSubtreeMatch(node.getLeftOperand(), o.getLeftOperand()) && safeSubtreeMatch(node.getRightOperand(), o.getRightOperand()));
    }
    ...
    public boolean match(LambdaExpression node, Object other) {
        ...
        return (node.hasParentheses() == o.hasParentheses()) && safeSubtreeListMatch(node.parameters(), o.parameters()) && safeSubtreeMatch(node.getBody(), o.getBody());
    }
    ...
    public boolean match(MethodRef node, Object other) {
        ...
        return (safeSubtreeMatch(node.getQualifier(), o.getQualifier()) && safeSubtreeMatch(node.getName(), o.getName()) && safeSubtreeListMatch(node.parameters(), o.parameters()));
    }
    ...
    public boolean match(MethodDeclaration node, Object other) {
        ...
        int level = node.getAST().apiLevel;
        return node.isConstructor() == o.isConstructor() && safeSubtreeMatch(node.getJavadoc(), o.getJavadoc()) && (level >= AST.JLS3_INTERNAL ? safeSubtreeListMatch(node.modifiers(), o.modifiers()) && safeSubtreeListMatch(node.typeParameters(), o.typeParameters()) && // n.b. compare return type even for constructors
        safeSubtreeMatch(node.getReturnType2(), o.getReturnType2()) : node.getModifiers() == o.getModifiers() && // n.b. compare return type even for constructors
        safeSubtreeMatch(node.internalGetReturnType(), o.internalGetReturnType())) && safeSubtreeMatch(node.getName(), o.getName()) && (level >= AST.JLS8 ? safeSubtreeMatch(node.getReceiverType(), o.getReceiverType()) && safeSubtreeMatch(node.getReceiverQualifier(), o.getReceiverQualifier()) : true) && safeSubtreeListMatch(node.parameters(), o.parameters()) && (level >= AST.JLS8 ? safeSubtreeListMatch(node.extraDimensions(), o.extraDimensions()) && safeSubtreeListMatch(node.thrownExceptionTypes(), o.thrownExceptionTypes()) : node.getExtraDimensions() == o.getExtraDimensions() && safeSubtreeListMatch(node.internalThrownExceptions(), o.internalThrownExceptions())) && safeSubtreeMatch(node.getBody(), o.getBody());
    }
    ...
    public boolean match(MethodInvocation node, Object other) {
        ...
        return (safeSubtreeMatch(node.getExpression(), o.getExpression()) && safeSubtreeMatch(node.getName(), o.getName()) && safeSubtreeListMatch(node.arguments(), o.arguments()));
    }
    ...
    public boolean match(NameQualifiedType node, Object other) {
        ...
        return safeSubtreeMatch(node.getQualifier(), o.getQualifier()) && safeSubtreeListMatch(node.annotations(), o.annotations()) && safeSubtreeMatch(node.getName(), o.getName());
    }
    ...
    public boolean match(PrimitiveType node, Object other) {
        ...
        int level = node.getAST().apiLevel;
        return (level >= AST.JLS8 ? safeSubtreeListMatch(node.annotations(), o.annotations()) : true) && node.getPrimitiveTypeCode() == o.getPrimitiveTypeCode();
    }
    ...
    public boolean match(QualifiedType node, Object other) {
        ...
        int level = node.getAST().apiLevel;
        return safeSubtreeMatch(node.getQualifier(), o.getQualifier()) && (level >= AST.JLS8 ? safeSubtreeListMatch(node.annotations(), o.annotations()) : true) && safeSubtreeMatch(node.getName(), o.getName());
    }
    ...
    public boolean match(SimpleType node, Object other) {
        ...
        int level = node.getAST().apiLevel;
        return (level >= AST.JLS8 ? safeSubtreeListMatch(node.annotations(), o.annotations()) : true) && safeSubtreeMatch(node.getName(), o.getName());
    }
    ...
    public boolean match(SingleVariableDeclaration node, Object other) {
        ...
        int level = node.getAST().apiLevel;
        return (level >= AST.JLS3_INTERNAL ? safeSubtreeListMatch(node.modifiers(), o.modifiers()) : node.getModifiers() == o.getModifiers()) && safeSubtreeMatch(node.getType(), o.getType()) && (level >= AST.JLS8 && node.isVarargs() ? safeSubtreeListMatch(node.varargsAnnotations(), o.varargsAnnotations()) : true) && (level >= AST.JLS3_INTERNAL ? node.isVarargs() == o.isVarargs() : true) && safeSubtreeMatch(node.getName(), o.getName()) && ((level >= AST.JLS8) ? safeSubtreeListMatch(node.extraDimensions(), o.extraDimensions()) : node.getExtraDimensions() == o.getExtraDimensions()) && safeSubtreeMatch(node.getInitializer(), o.getInitializer());
    }
    ...
    public boolean match(SuperMethodInvocation node, Object other) {
        ...
        return (safeSubtreeMatch(node.getQualifier(), o.getQualifier()) && safeSubtreeMatch(node.getName(), o.getName()) && safeSubtreeListMatch(node.arguments(), o.arguments()));
    }
    ...
    public boolean match(SuperMethodReference node, Object other) {
        ...
        return (safeSubtreeMatch(node.getQualifier(), o.getQualifier()) && safeSubtreeListMatch(node.typeArguments(), o.typeArguments()) && safeSubtreeMatch(node.getName(), o.getName()));
    }
    ...
    public boolean match(TryStatement node, Object other) {
        ...
        int level = node.getAST().apiLevel;
        return (level >= AST.JLS4_INTERNAL ? safeSubtreeListMatch(node.resources(), o.resources()) : true) && safeSubtreeMatch(node.getBody(), o.getBody()) && safeSubtreeListMatch(node.catchClauses(), o.catchClauses()) && safeSubtreeMatch(node.getFinally(), o.getFinally());
    }
    ...
    public boolean match(TypeDeclaration node, Object other) {
        ...
        return ((node.isInterface() == o.isInterface()) && safeSubtreeMatch(node.getJavadoc(), o.getJavadoc()) && safeSubtreeMatch(node.getName(), o.getName()) && safeSubtreeListMatch(node.bodyDeclarations(), o.bodyDeclarations()));
    }
    ...
    public boolean match(TypeMethodReference node, Object other) {
        ...
        return (safeSubtreeMatch(node.getType(), o.getType()) && safeSubtreeListMatch(node.typeArguments(), o.typeArguments()) && safeSubtreeMatch(node.getName(), o.getName()));
    }
    ...
    public boolean match(TypeParameter node, Object other) {
        ...
        int level = node.getAST().apiLevel;
        return (level >= AST.JLS8 ? safeSubtreeListMatch(node.modifiers(), o.modifiers()) : true) && safeSubtreeMatch(node.getName(), o.getName()) && safeSubtreeListMatch(node.typeBounds(), o.typeBounds());
    }
    ...
    public boolean match(VariableDeclarationFragment node, Object other) {
        ...
        int level = node.getAST().apiLevel;
        return safeSubtreeMatch(node.getName(), o.getName()) && (level >= AST.JLS8 ? safeSubtreeListMatch(node.extraDimensions(), o.extraDimensions()) : node.getExtraDimensions() == o.getExtraDimensions()) && safeSubtreeMatch(node.getInitializer(), o.getInitializer());
    }
    ...
    public boolean match(WildcardType node, Object other) {
        ...
        int level = node.getAST().apiLevel;
        return (level >= AST.JLS8 ? safeSubtreeListMatch(node.annotations(), o.annotations()) : true) && node.isUpperBound() == o.isUpperBound() && safeSubtreeMatch(node.getBound(), o.getBound());
    }
}
