...
public class WhileStatement extends Statement {
    ...
    public  WhileStatement(Expression condition, Statement action, int s, int e) {
        ...
        if (action instanceof EmptyStatement)
            action.bits |= IsUsefulEmptyStatementMASK;
        sourceStart = s;
        sourceEnd = e;
    }
    ...
    public FlowInfo analyseCode(BlockScope currentScope, FlowContext flowContext, FlowInfo flowInfo) {
        ...
        FlowInfo postCondInfo = this.condition.analyseCode(currentScope, (condLoopContext = new LoopingFlowContext(flowContext, this, null, null, currentScope)), flowInfo);
        ...
        // end of loop
        FlowInfo mergedInfo = FlowInfo.mergedOptimizedBranches(loopingContext.initsOnBreak, isConditionOptimizedTrue, postCondInfo.initsWhenFalse(), isConditionOptimizedFalse, !isConditionTrue);
        mergedInitStateIndex = currentScope.methodScope().recordInitializationStates(mergedInfo);
        return mergedInfo;
    }
