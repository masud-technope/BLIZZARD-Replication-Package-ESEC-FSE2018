...
public class InheritedAnnoProc extends BaseProcessor {
    ...
    // c'tor with int param
    private Element _elementAinitI;

    // method with c'tor-like name 
    ...
    private boolean collectElements() {
        ...
        if (null == _elementA || null == _elementAChild || null == _elementANotAnnotated || null == _elementAi || null == _elementAfoo || null == _elementAinitI || null == _elementAa || null == _elementAIntf || null == _elementAEnum || null == _elementAinit) {
        ...
        if (null == _elementB || null == _elementBChild || null == _elementBNotAnnotated || null == _elementBi || null == _elementBfoo) {
    ...
    private boolean examineGetElementsAnnotatedWith(RoundEnvironment roundEnv) {
        ...
        final Element[] expectedInherited = { _elementA, _elementAChild, _elementAIntf, _elementAEnum, _elementAi, _elementAfoo, _elementAinit, _elementAinitI, _elementAa, _elementB, _elementBChild };
        ...
        final Element[] expectedNotInherited = { _elementA, _elementAChild, _elementAIntf, _elementAEnum, _elementAi, _elementAfoo, _elementAinit, _elementAinitI, _elementAa };
