    ...
    private TypeBinding internalResolveType(Scope scope) {
        ...
        if (this.argument != null) {
            ...
            if (typeRef != null) {
                ...
                if (typeRef instanceof SingleTypeReference && this.resolvedType.leafComponentType().enclosingType() != null && scope.compilerOptions().complianceLevel <= ClassFileConstants.JDK1_4) {
                ...
                return this.resolvedType = scope.environment().convertToRawType(this.resolvedType, /*force the conversion of enclosing types*/
                true);
            }
        }
        return null;
