...
public class R3 {
    ...
    void simple_name(Generic<Object>.MemberGeneric<Object> gen_obj, Generic<Exception>.MemberGeneric<Exception> gen_exc, Generic<? extends Throwable>.MemberGeneric<? extends Throwable> gen_thr, Generic<? super RuntimeException>.MemberGeneric<? super RuntimeException> gen_run) {
        gen_obj.toString();
        gen_exc.toString();
        gen_thr.toString();
        gen_run.toString();
