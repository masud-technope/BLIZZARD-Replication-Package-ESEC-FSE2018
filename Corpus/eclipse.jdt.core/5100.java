...
public abstract class Constant implements TypeIds, OperatorIds {
    ...
    public boolean booleanValue() {
        //$NON-NLS-1$
        throw new ShouldNotImplement(Messages.bind(Messages.constant_cannotCastedInto, new String[] { typeName(), "boolean" }));
    }

    public byte byteValue() {
        //$NON-NLS-1$
        throw new ShouldNotImplement(Messages.bind(Messages.constant_cannotCastedInto, new String[] { typeName(), "byte" }));
    }
    ...
    public char charValue() {
        //$NON-NLS-1$
        throw new ShouldNotImplement(Messages.bind(Messages.constant_cannotCastedInto, new String[] { typeName(), "char" }));
    }
    ...
    public double doubleValue() {
        //$NON-NLS-1$
        throw new ShouldNotImplement(Messages.bind(Messages.constant_cannotCastedInto, new String[] { typeName(), "double" }));
    }

    public float floatValue() {
        //$NON-NLS-1$
        throw new ShouldNotImplement(Messages.bind(Messages.constant_cannotCastedInto, new String[] { typeName(), "float" }));
    }
    ...
    public int intValue() {
        //$NON-NLS-1$
        throw new ShouldNotImplement(Messages.bind(Messages.constant_cannotCastedInto, new String[] { typeName(), "int" }));
    }

    public long longValue() {
        //$NON-NLS-1$
        throw new ShouldNotImplement(Messages.bind(Messages.constant_cannotCastedInto, new String[] { typeName(), "long" }));
    }

    public short shortValue() {
        //$NON-NLS-1$
        throw new ShouldNotImplement(Messages.bind(Messages.constant_cannotConvertedTo, new String[] { typeName(), "short" }));
    }

    public String stringValue() {
        //$NON-NLS-1$
        throw new ShouldNotImplement(Messages.bind(Messages.constant_cannotConvertedTo, new String[] { typeName(), "String" }));
    }
