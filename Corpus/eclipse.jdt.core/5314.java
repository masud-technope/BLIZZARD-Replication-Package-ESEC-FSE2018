...
public final class SimpleLookupTable implements Cloneable {
    ...
    public Object keyForValue(Object valueToMatch) {
        if (valueToMatch != null)
            for (int i = 0, l = this.keyTable.length; i < l; i++) if (this.keyTable[i] != null && valueToMatch.equals(this.valueTable[i]))
    ...
    public String toString() {
        ...
        String s = "";
        Object object;
        for (int i = 0, l = this.valueTable.length; i < l; i++) if ((object = this.valueTable[i]) != null)
            //$NON-NLS-2$ //$NON-NLS-1$
