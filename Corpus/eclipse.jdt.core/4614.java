...
public class RuntimeTests extends AbstractRegressionTest {
    ...
    public void _test0001_memory_exhaustion() {
        ...
        "", "SUCCESS", /* expectedErrorString - skip this because some JREs emit additional info to stderr in case of exception */
        null, /* forceExecution */
        false, /* classLib */
    ...
    public void test1000_partial_rebuild() {
        ...
        this.runConformTest(new String[] { "X.java", "public class X {\n" + "static public void main(String args[]) {\n" + "  Z.go();\n" + "}\n" + "}\n", "Y.java", "public class Y {\n" + "java.util.Random generator = new java.util.Random();" + // random now returns an int
        "public int random() {\n" + "  return generator.nextInt();\n" + "}\n" + "}\n" }, "2", null, // do not purge output directory - pick old version of Z.class
        false, null);
    }
    ...
    public void test1002_partial_rebuild() {
        ...
        "    void foo() {\n" + "      return;\n" + "    }\n" + "  }\n" + "}\n" }, "", "2", "", JavacTestOptions.JavacHasABug.JavacBugFixed_6_10);
    }

    // partial rebuild - method signature changed (visibility)
    public void test1003_partial_rebuild() {
        this.runConformTest(new String[] { "X.java", "public class X {\n" + "static public void main(String args[]) {\n" + "  new Z().go();\n" + "}\n" + "}\n", "Z.java", "public class Z extends p.Y {\n" + "  class ZInner extends YInner {\n" + "    // empty\n" + "  }\n" + "public void go() {\n" + "  byte flag = 0;\n" + "  try {\n" + "    new ZInner().foo();\n" + "    flag = 1;\n" + "  }\n" + "  catch (IllegalAccessError e) {\n" + "    flag = 2;\n" + "  }\n" + "  catch (Throwable t) {\n" + "    flag = 3;\n" + "  }\n" + "  System.out.println(flag);\n" + "}\n" + "}\n", "p/Y.java", "package p;\n" + "public class Y {\n" + "  public class YInner {\n" + "    public void foo() {\n" + "      return;\n" + "    }\n" + "  }\n" + "}\n" }, "1");
        this.runConformTest(// do not purge output directory - pick old version of Z.class
    ...
    public void test1004_partial_rebuild() {
        ...
        String expectedOutput = this.complianceLevel == ClassFileConstants.JDK1_3 ? "X.field-X.staticField-Y.method()-X.staticMethod()-" : "Y.field-Y.staticField-Y.method()-Y.staticMethod()-";
        ...
        expectedOutput, // use default class-path
