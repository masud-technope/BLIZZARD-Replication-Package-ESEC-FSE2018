...
public final class NormalAnnotation extends Annotation {
	 ...
	 */
    public static final ChildPropertyDescriptor TYPE_NAME_PROPERTY = internalTypeNamePropertyFactory(NormalAnnotation.class);

    /**
	 * The "values" structural property of this node type (element type: {@link MemberValuePair}).
	 */
    public static final ChildListPropertyDescriptor VALUES_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(NormalAnnotation.class, "values", MemberValuePair.class, CYCLE_RISK);
