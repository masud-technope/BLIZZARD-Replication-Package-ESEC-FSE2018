 ...
 */
    public void testDeadlock01() throws CoreException {
        ...
        try {
            final IJavaProject project = this.createJavaProject("P", new String[] {}, new String[] { "org.eclipse.jdt.core.tests.model.TEST_CONTAINER" }, "");
                    ...
                    try {
                        ResourcesPlugin.getWorkspace().run(new IWorkspaceRunnable() {
                            ...
                            public void run(IProgressMonitor monitor) throws CoreException {
                                ...
                                step1.release();
                                // ensure the java model lock is taken
                                step2.acquire();
            ...
            // ensure both actions did complete
