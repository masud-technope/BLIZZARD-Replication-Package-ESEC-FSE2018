 ...
 */
    public String[] getCommandLine() {
        ...
        // VM binary
        commandLine.addElement(this.vmPath + (this.vmPath.endsWith(File.separator) ? "" : File.separator) + "bin" + File.separator + "j9");
        // VM arguments
 ...
 */
    public String[] getProxyCommandLine() {
        Vector commandLine = new Vector();
        // Proxy binary
        commandLine.addElement(this.vmPath + (this.vmPath.endsWith(File.separator) ? "" : File.separator) + "bin" + File.separator + "j9proxy");
        // Arguments
