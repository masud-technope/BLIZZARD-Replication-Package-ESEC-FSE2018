 ...
 */
    public RecoveredElement add(FieldDeclaration fieldDeclaration, int bracketBalanceValue) {
        ...
        (fieldDeclaration.modifiers & ~ClassFileConstants.AccFinal) != 0 || // initializer
                ...
                if (this.methodDeclaration.sourceEnd == parser.rParenPos) {
                    ...
                    for (count = 0; count < argLength; count++) {
                        ...
                        if (aNode instanceof Argument) {
                            ...
                            if ((argument.modifiers & ~ClassFileConstants.AccFinal) != 0 || (argTypeName.length == 1 && CharOperation.equals(argTypeName[0], TypeBinding.VOID.sourceName()))) {
