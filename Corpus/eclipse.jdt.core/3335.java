 ...
 */
    public void testCUAndImportContainer() throws JavaModelException {
        ...
        ICompilationUnit cu = pkg.createCompilationUnit("HelloImports.java", ("package p;\n" + "\n" + "import java.util.Enumeration;\n" + "import java.util.Vector;\n" + "\n" + "public class HelloImports {\n" + "\n" + "	public static main(String[] args) {\n" + "		System.out.println(\"HelloWorld\");\n" + "	}\n" + "}\n"), false, null);
        assertCreation(cu);
 ...
 */
    public void testForce() throws JavaModelException, IOException {
        ...
        ICompilationUnit cu = pkg.createCompilationUnit("X.java", "package p;\n" + "public class X {\n" + "}", // force,
        true, null);
        assertCreation(cu);
        assertDeltas("Unexpected delta", "P[*]: {CHILDREN}\n" + "	<project root>[*]: {CHILDREN}\n" + "		p[*]: {CHILDREN}\n" + "			X.java[+]: {}");
    }
 ...
 */
    public void testSimpleCreation() throws JavaModelException {
        IPackageFragment pkg = getPackage("/P/p");
        ICompilationUnit cu = pkg.createCompilationUnit("HelloWorld.java", ("package p;\n" + "\n" + "public class HelloWorld {\n" + "\n" + "	public static main(String[] args) {\n" + "		System.out.println(\"HelloWorld\");\n" + "	}\n" + "}\n"), false, null);
        assertCreation(cu);
        assertDeltas("Unexpected delta", "P[*]: {CHILDREN}\n" + "	<project root>[*]: {CHILDREN}\n" + "		p[*]: {CHILDREN}\n" + "			HelloWorld.java[+]: {}");
    }
