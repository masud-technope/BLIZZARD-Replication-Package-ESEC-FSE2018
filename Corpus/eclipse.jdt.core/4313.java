...
public class ScannerTest extends AbstractRegressionTest {
    ...
    public void test025() {
        ...
        // expecting line breaks to reset
    ...
    public void test046() {
        IScanner scanner = ToolFactory.createScanner(true, true, true, JavaCore.getOption(JavaCore.COMPILER_SOURCE), JavaCore.getOption(JavaCore.COMPILER_COMPLIANCE));
        final char[] source = "{\r\n\t}".toCharArray();
        scanner.setSource(source);
        scanner.resetTo(1, 3);
        try {
    ...
    public void test053() {
        IScanner scanner = ToolFactory.createScanner(true, true, true, JavaCore.VERSION_1_4, JavaCore.VERSION_1_4);
