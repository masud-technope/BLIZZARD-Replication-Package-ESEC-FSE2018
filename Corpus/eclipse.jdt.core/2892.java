...
public class CaptureBinding18 extends CaptureBinding {
    ...
    // used to give a hint at recursive types without going into infinity
            ...
            if (this.prototype.recursionLevel < 2) {
                try {
                    ...
                    if (this.upperBounds != null && this.upperBounds.length > 1) {
                        ...
                        for (int i = 1; i < this.upperBounds.length; i++) sb.append('&').append(this.upperBounds[i].readableName());
                        int len = sb.length();
            ...
            if (this.prototype.recursionLevel < 2) {
                try {
                    ...
                    if (this.upperBounds != null && this.upperBounds.length > 1) {
                        ...
                        for (int i = 1; i < this.upperBounds.length; i++) sb.append('&').append(this.upperBounds[i].shortReadableName());
                        int len = sb.length();
                        char[] name = new char[len];
                        sb.getChars(0, len, name, 0);
                        return name;
