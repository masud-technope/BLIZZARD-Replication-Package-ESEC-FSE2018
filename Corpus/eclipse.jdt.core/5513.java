...
public class ArrayAllocationExpression extends Expression {
    ...
    public TypeBinding resolveType(BlockScope scope) {
        ...
        TypeBinding referenceType = this.type.resolveType(scope, /* check bounds*/
        true);
        ...
        if (referenceType != null) {
            ...
            if (this.type.annotations != null && (referenceType.tagBits & TagBits.AnnotationNullMASK) == TagBits.AnnotationNullMASK) {
