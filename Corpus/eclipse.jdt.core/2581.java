...
public class IfStatement extends Statement {
    ...
    public FlowInfo analyseCode(BlockScope currentScope, FlowContext flowContext, FlowInfo flowInfo) {
        ...
        if (this.elseStatement != null) {
            ...
            if (thenFlowInfo == FlowInfo.DEAD_END && // else of an else-if
            (this.bits & IsElseIfStatement) == 0 && !(this.elseStatement instanceof IfStatement)) {
        ...
        FlowInfo mergedInfo = FlowInfo.mergedOptimizedBranchesIfElse(thenFlowInfo, isConditionOptimizedTrue, elseFlowInfo, isConditionOptimizedFalse, /*if(true){ return; }  fake-reachable(); */
        true, flowInfo, this, reportDeadCodeForKnownPattern);
 ...
 */
    public void generateCode(BlockScope currentScope, CodeStream codeStream) {
        ...
        Constant cst;
        boolean hasThenPart = !(((cst = this.condition.optimizedBooleanConstant()) != Constant.NotAConstant && cst.booleanValue() == false) || this.thenStatement == null || this.thenStatement.isEmptyBlock());
        boolean hasElsePart = !((cst != Constant.NotAConstant && cst.booleanValue() == true) || this.elseStatement == null || this.elseStatement.isEmptyBlock());
        if (hasThenPart) {
            ...
            if (cst != Constant.NotAConstant && cst.booleanValue() == true) {
                ...
                this.condition.generateOptimizedBoolean(currentScope, codeStream, null, hasElsePart ? (falseLabel = new BranchLabel(codeStream)) : endifLabel, /*cst == Constant.NotAConstant*/
                true);
            }
