...
public class AptReconcileTests extends ModifyingResourceTests {
    ...
    public void testGeneratedFile() throws Throwable {
        ...
        try {
            ...
            this._workingCopy.reconcile(ICompilationUnit.NO_AST, true, null, null);
    ...
    public void setUp() throws Exception {
        ...
        this._problemRequestor = new ProblemRequestor();
        final IJavaProject project = createJavaProject(_testProject, new String[] { "src" }, new String[] { "JCL15_LIB" }, "bin", "1.5");
    ...
    private void setUpWorkingCopy(String path, String contents) throws JavaModelException {
        ...
        this._workingCopy = getCompilationUnit(path).getWorkingCopy(new WorkingCopyOwner() {
    ...
    //$NON-NLS-1$
    private static final String TEST_PROJECT = AptReconcileTests.class.getName() + "Project";
}
