...
public class ASTMatcherTest extends org.eclipse.jdt.core.tests.junit.extension.TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        if (this.ast.apiLevel() >= AST.JLS8) {
            //$NON-NLS-1$
            this.T3 = this.ast.newSimpleType(this.ast.newSimpleName("U"));
            //$NON-NLS-1$
            this.T4 = this.ast.newSimpleType(this.ast.newSimpleName("V"));
        }
    }
    ...
    void basicMatch(ASTNode node) {
        TestMatcher[] m = { new TestMatcher(), new TestMatcher(true), new TestMatcher(false) };
        ...
        {
            // ignore doc tags
            int count = nodeCount(node, false);
    ...
    public void testParameterizedType() {
        ...
        //$NON-NLS-1$
        ParameterizedType x1 = this.ast.newParameterizedType(this.ast.newSimpleType(this.ast.newSimpleName("X")));
