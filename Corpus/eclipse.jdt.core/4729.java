...
public class MethodDeclaration extends BodyDeclaration {
	 ...
	 * @since 3.0
	 */
    public static final SimplePropertyDescriptor CONSTRUCTOR_PROPERTY = //$NON-NLS-1$
    new SimplePropertyDescriptor(MethodDeclaration.class, "constructor", boolean.class, MANDATORY);
    ...
    new ChildPropertyDescriptor(MethodDeclaration.class, "name", SimpleName.class, MANDATORY, NO_CYCLE_RISK);
	 ...
	 */
    public static final ChildPropertyDescriptor RETURN_TYPE_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(MethodDeclaration.class, "returnType", Type.class, MANDATORY, NO_CYCLE_RISK);

    /**
	 * The "returnType2" structural property of this node type (child type: {@link Type}) (added in JLS3 API).
	 * @since 3.1
	 */
    public static final ChildPropertyDescriptor RETURN_TYPE2_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(MethodDeclaration.class, "returnType2", Type.class, OPTIONAL, NO_CYCLE_RISK);
	 ...
	 */
    public static final SimplePropertyDescriptor EXTRA_DIMENSIONS_PROPERTY = //$NON-NLS-1$
    new SimplePropertyDescriptor(MethodDeclaration.class, "extraDimensions", int.class, MANDATORY);

    /**
	 * The "extraDimensions2" structural property of this node type (element type: {@link Dimension}) (added in JLS8 API).
	 * @since 3.10
	 */
    public static final ChildListPropertyDescriptor EXTRA_DIMENSIONS2_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(MethodDeclaration.class, "extraDimensions2", Dimension.class, NO_CYCLE_RISK);

    /**
	 * The "typeParameters" structural property of this node type (element type: {@link TypeParameter}) (added in JLS3 API).
	 * @since 3.1
	 */
    public static final ChildListPropertyDescriptor TYPE_PARAMETERS_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(MethodDeclaration.class, "typeParameters", TypeParameter.class, NO_CYCLE_RISK);
    ...
    new ChildListPropertyDescriptor(MethodDeclaration.class, "parameters", SingleVariableDeclaration.class, CYCLE_RISK);

    /**
	 * The "receiverType" structural property of this node type (child type: {@link Type}) (added in JLS8 API).
	 * @since 3.10
	 */
    public static final ChildPropertyDescriptor RECEIVER_TYPE_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(MethodDeclaration.class, "receiverType", Type.class, OPTIONAL, NO_CYCLE_RISK);

    /**
	 * The "receiverQualifier" structural property of this node type (child type: {@link SimpleName}) (added in JLS8 API).
	 * @since 3.10
	 */
    public static final ChildPropertyDescriptor RECEIVER_QUALIFIER_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(MethodDeclaration.class, "receiverQualifier", SimpleName.class, OPTIONAL, NO_CYCLE_RISK);
    ...
    new ChildListPropertyDescriptor(MethodDeclaration.class, "thrownExceptions", Name.class, NO_CYCLE_RISK);

    /**
	 * The "thrownExceptionTypes" structural property of this node type (element type: {@link Type}) (added in JLS8 API).
	 * @since 3.10
	 */
    public static final ChildListPropertyDescriptor THROWN_EXCEPTION_TYPES_PROPERTY = //$NON-NLS-1$
    new ChildListPropertyDescriptor(MethodDeclaration.class, "thrownExceptionTypes", Type.class, NO_CYCLE_RISK);
    ...
    new ChildPropertyDescriptor(MethodDeclaration.class, "body", Block.class, OPTIONAL, CYCLE_RISK);
