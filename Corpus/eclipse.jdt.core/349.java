...
public class MethodPattern extends JavaSearchPattern {
    ...
    //set only when focus is not null
 ...
 */
    public static char[] createIndexKey(char[] selector, int argCount) {
        char[] countChars = argCount < 10 ? COUNTS[argCount] : //$NON-NLS-1$
 ...
 */
    ...
    public boolean matchesDecodedKey(SearchPattern decodedPattern) {
        ...
        return (this.parameterCount == pattern.parameterCount || this.parameterCount == -1 || this.varargs) && matchesName(this.selector, pattern.selector);
    }
