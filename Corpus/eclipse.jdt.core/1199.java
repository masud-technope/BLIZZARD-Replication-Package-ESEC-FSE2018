...
public class LRUCache implements Cloneable {
    ...
    public void flush() {
        ...
        this.entryQueue = this.entryQueueTail = null;
        while (// send deletion notifications in LRU order
        entry != null) {
            entry = entry.previous;
        }
    }
    ...
    public String toString() {
        return //$NON-NLS-1$
        toStringFillingRation("LRUCache") + toStringContents();
    }
    ...
    protected String toStringContents() {
        ...
        for (int i = 0; i < length; i++) {
            ...
            unsortedKeys[i] = key;
            unsortedToStrings[i] = (key instanceof org.eclipse.jdt.internal.core.JavaElement) ? ((org.eclipse.jdt.internal.core.JavaElement) key).getElementName() : key.toString();
        }
