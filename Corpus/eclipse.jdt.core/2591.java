    ...
    public static final boolean camelCaseMatch(char[] pattern, int patternStart, int patternEnd, char[] name, int nameStart, int nameEnd, boolean samePartCount) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                } else // Same tests for non-obvious characters
 ...
 */
    public static final char[] concatWith(char[] name, char[][] array, char separator) {
        ...
        int size = nameLength;
        int index = length;
        while (--index >= 0) if (array[index].length > 0)
 ...
 */
    public static final boolean contains(char character, char[][] array) {
        for (int i = array.length; --i >= 0; ) {
            ...
            for (int j = subarray.length; --j >= 0; ) if (subarray[j] == character)
                return true;
        }
        return false;
    }
 ...
 */
    public static final boolean contains(char character, char[] array) {
        for (int i = array.length; --i >= 0; ) if (array[i] == character)
            return true;
        return false;
    }
 ...
 */
    public static final boolean contains(char[] characters, char[] array) {
        for (int i = array.length; --i >= 0; ) for (int j = characters.length; --j >= 0; ) if (array[i] == characters[j])
            return true;
        return false;
    }
 ...
 */
    public static final boolean endsWith(char[] array, char[] toBeFound) {
        ...
        if (j < 0)
            return false;
        while (--i >= 0) if (toBeFound[i] != array[i + j])
            return false;
        return true;
    }
 ...
 */
    public static final boolean equals(char[][] first, char[][] second) {
        ...
        if (first.length != second.length)
            return false;
        for (int i = first.length; --i >= 0; ) if (!equals(first[i], second[i]))
            return false;
        return true;
    }
 ...
 */
    public static final boolean equals(char[][] first, char[][] second, boolean isCaseSensitive) {
        ...
        if (first.length != second.length)
            return false;
        for (int i = first.length; --i >= 0; ) if (!equals(first[i], second[i], false))
            return false;
        return true;
    }
 ...
 */
    public static final boolean equals(char[] first, char[] second) {
        ...
        if (first.length != second.length)
            return false;
        for (int i = first.length; --i >= 0; ) if (first[i] != second[i])
            return false;
        return true;
    }
 ...
 */
    public static final boolean equals(char[] first, char[] second, int secondStart, int secondEnd, boolean isCaseSensitive) {
        ...
        if (first.length != secondEnd - secondStart)
            return false;
        if (isCaseSensitive) {
            for (int i = first.length; --i >= 0; ) if (first[i] != second[i + secondStart])
                return false;
        } else {
            for (int i = first.length; --i >= 0; ) if (ScannerHelper.toLowerCase(first[i]) != ScannerHelper.toLowerCase(second[i + secondStart]))
                return false;
        }
        return true;
    }
 ...
 */
    public static final boolean equals(char[] first, char[] second, boolean isCaseSensitive) {
        ...
        if (first.length != second.length)
            return false;
        for (int i = first.length; --i >= 0; ) if (ScannerHelper.toLowerCase(first[i]) != ScannerHelper.toLowerCase(second[i]))
            return false;
        return true;
    }
 ...
 */
    public static final int hashCode(char[] array) {
        ...
        if (length < 8) {
            for (int i = length; --i > 0; ) hash = (hash * 31) + array[i];
        } else {
            // 8 characters is enough to compute a decent hash code, don't waste time examining every character
            for (int i = length - 1, last = i > 16 ? i - 16 : 0; i > last; i -= 2) hash = (hash * 31) + array[i];
        }
 ...
 */
    public static final int indexOf(char toBeFound, char[] array, int start, int end) {
        for (int i = start; i < end; i++) if (toBeFound == array[i])
            return i;
        return -1;
    }
 ...
 */
    public static final int lastIndexOf(char toBeFound, char[] array) {
        for (int i = array.length; --i >= 0; ) if (toBeFound == array[i])
            return i;
        return -1;
    }
 ...
 */
    public static final int lastIndexOf(char toBeFound, char[] array, int startIndex) {
        for (int i = array.length; --i >= startIndex; ) if (toBeFound == array[i])
            return i;
        return -1;
    }
 ...
 */
    public static final int lastIndexOf(char toBeFound, char[] array, int startIndex, int endIndex) {
        for (int i = endIndex; --i >= startIndex; ) if (toBeFound == array[i])
            return i;
        return -1;
    }
 ...
 */
    public static final boolean match(char[] pattern, int patternStart, int patternEnd, char[] name, int nameStart, int nameEnd, boolean isCaseSensitive) {
        ...
        while (true) {
            ...
            if (iName == nameEnd) {
                // name has ended but not the pattern
                return false;
            }
 ...
 */
    public static final int occurencesOf(char toBeFound, char[] array) {
        int count = 0;
        for (int i = 0; i < array.length; i++) if (toBeFound == array[i])
            count++;
        return count;
    }
 ...
 */
    public static final boolean prefixEquals(char[] prefix, char[] name, boolean isCaseSensitive, int startIndex) {
        ...
        if (name.length - startIndex < max)
            return false;
        if (isCaseSensitive) {
            for (// assumes the prefix is not larger than the name
            int i = max; // assumes the prefix is not larger than the name
            --i >= 0; ) if (prefix[i] != name[startIndex + i])
                return false;
            return true;
        }
        for (// assumes the prefix is not larger than the name
        int i = max; // assumes the prefix is not larger than the name
        --i >= 0; ) if (ScannerHelper.toLowerCase(prefix[i]) != ScannerHelper.toLowerCase(name[startIndex + i]))
            return false;
        return true;
    }
 ...
 */
    public static final void replace(char[] array, char[] toBeReplaced, char replacementChar, int start, int end) {
        for (int i = end; --i >= start; ) for (int j = toBeReplaced.length; --j >= 0; ) if (array[i] == toBeReplaced[j])
            array[i] = replacementChar;
    }
 ...
 */
    public static final char[][] splitAndTrimOn(char divider, char[] array) {
        ...
        if (length == 0)
            return NO_CHAR_CHAR;
        int wordCount = 1;
        for (int i = 0; i < length; i++) if (array[i] == divider)
            wordCount++;
 ...
 */
    public static final char[][] splitOn(char divider, char[] array, int start, int end) {
        ...
        if (length == 0 || start > end)
            return NO_CHAR_CHAR;
        int wordCount = 1;
        for (int i = start; i < end; i++) if (array[i] == divider)
            wordCount++;
        char[][] split = new char[wordCount][];
 ...
 */
    public static final char[][] splitOnWithEnclosures(char divider, char openEncl, char closeEncl, char[] array, int start, int end) {
        ...
        int nesting = 0;
        if (// divider should be distinct
        openEncl == divider || closeEncl == divider)
