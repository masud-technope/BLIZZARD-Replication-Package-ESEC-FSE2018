 ...
 */
    public void complete(char[] codeSnippet, int completionPosition, SearchableEnvironment environment, CompletionRequestor requestor, Map<String, String> options, final IJavaProject project, WorkingCopyOwner owner, IProgressMonitor monitor) {
        try {
        ...
        final CodeSnippetToCuMapper mapper = new CodeSnippetToCuMapper(codeSnippet, this.packageName, this.imports, className, this.installedVars == null ? null : this.installedVars.className, this.localVariableNames, this.localVariableTypeNames, this.localVariableModifiers, this.declaringTypeName, this.lineSeparator, complianceVersion);
        ...
        if (this.installedVars != null) {
            ...
            if (binaryType != null) {
                engine.lookupEnvironment.cacheBinaryType(binaryType, /*no access restriction*/
                null);
            }
            ...
            for (int i = 0; i < classFiles.length; i++) {
                ...
                engine.lookupEnvironment.cacheBinaryType(binary, /*no access restriction*/
                null);
            }
        }
 ...
 */
    ...
    private void deployCodeSnippetClassIfNeeded(IRequestor requestor) throws InstallException {
        if (this.codeSnippetBinary == null) {
            ...
            if (!requestor.acceptClassFiles(new ClassFile[] { new ClassFile() {
    ...
    public void evaluate(char[] codeSnippet, char[][] contextLocalVariableTypeNames, char[][] contextLocalVariableNames, int[] contextLocalVariableModifiers, char[] contextDeclaringTypeName, boolean contextIsStatic, boolean contextIsConstructorCall, INameEnvironment environment, Map<String, String> options, final IRequestor requestor, IProblemFactory problemFactory) throws InstallException {
        ...
        try {
            ...
            if (!forwardingRequestor.hasErrors) {
                Evaluator evaluator = new CodeSnippetEvaluator(codeSnippet, this, environment, options, requestor, problemFactory);
 ...
 */
    public GlobalVariable newVariable(char[] typeName, char[] name, char[] initializer) {
        ...
        if (// assume variables is never empty
