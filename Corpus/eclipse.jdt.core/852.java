...
public class IntersectionTypeBinding18 extends // abstraction used for intersection casts in Java 8 + type inference at 1.8+
ReferenceBinding {
    ...
    public long updateTagBits() {
        for (TypeBinding intersectingType : this.intersectingTypes) this.tagBits |= intersectingType.updateTagBits();
