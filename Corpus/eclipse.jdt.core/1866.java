...
public class ArrayType extends Type {
	 ...
	 * @since 3.0
	 */
    public static final ChildPropertyDescriptor COMPONENT_TYPE_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(ArrayType.class, "componentType", Type.class, MANDATORY, CYCLE_RISK);
	 ...
	 * @since 3.10
	 */
    public static final ChildPropertyDescriptor ELEMENT_TYPE_PROPERTY = //$NON-NLS-1$	
    new ChildPropertyDescriptor(ArrayType.class, "elementType", Type.class, MANDATORY, CYCLE_RISK);
    ...
    new ChildListPropertyDescriptor(ArrayType.class, "dimensions", Dimension.class, CYCLE_RISK);
	...
	*/
	 ...
	 */
    int treeSize() {
        return memSize() + (this.type == null ? 0 : (this.ast.apiLevel() < AST.JLS8 ? getComponentType().treeSize() : getElementType().treeSize()) + (this.dimensions == null ? 0 : this.dimensions.listSize()));
    }
}
