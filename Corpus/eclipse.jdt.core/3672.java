...
public class FormatterJSR308Tests extends AbstractJavaModelTests {
    ...
    private void runTest(CodeFormatter codeFormatter, String packageName, String compilationUnitName, int kind, int indentationLevel, boolean checkNull, int offset, int length, String lineSeparator) {
        try {
            //$NON-NLS-1$ //$NON-NLS-2$
            ICompilationUnit sourceUnit = getCompilationUnit(PROJECT_NAME, "", packageName, getIn(compilationUnitName));
            String source = sourceUnit.getSource();
            assertNotNull(source);
            //$NON-NLS-1$ //$NON-NLS-2$
            ICompilationUnit outputUnit = getCompilationUnit(PROJECT_NAME, "", packageName, getOut(compilationUnitName));
    ...
    public void testReferenceExpression() {
        setPageWidth80();
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("testReferenceExpression", "A.java");
    }

    public void test000() {
        setPageWidth80();
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test000", "I.java");
    }

    public void test001() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test001", "X.java");
    }

    public void test002() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test002", "X.java");
    }

    public void test003() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test003", "X.java");
    }

    public void test004() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test004", "X.java");
    }

    public void test005() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test005", "X.java");
    }

    public void test006() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test006", "X.java");
    }

    public void test007() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test007", "X.java");
    }

    public void test008() {
        setPageWidth80();
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test008", "X.java");
    }

    public void test009() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test009", "X.java");
    }

    public void test010() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test010", "X.java");
    }

    public void test011() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test011", "X.java");
    }

    public void test012() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test012", "X.java");
    }

    public void test013() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test013", "X.java");
    }

    public void test014() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test014", "X.java");
    }

    public void test015() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test015", "X.java");
    }

    public void test016() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test016", "X.java");
    }

    public void test017() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test017", "X.java");
    }

    public void test018() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test018", "X.java");
    }

    public void test019() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test019", "X.java");
    }

    public void test020() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test020", "X.java");
    }

    public void test021() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test021", "X.java");
    }

    public void test022() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test022", "X.java");
    }

    public void test023() {
        setPageWidth80();
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test023", "X.java");
    }

    public void test024() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test024", "X.java");
    }

    public void test025() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test025", "X.java");
    }

    public void test026() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test026", "X.java");
    }

    public void test027() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test027", "X.java");
    }

    public void test028() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test028", "X.java");
    }

    public void test029() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test029", "X.java");
    }

    public void test030() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test030", "X.java");
    }

    public void test031() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test031", "X.java");
    }

    public void test032() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test032", "X.java");
    }

    public void test033() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test033", "X.java");
    }

    public void test034() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test034", "X.java");
    }

    public void test035() {
        setPageWidth80();
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test035", "X.java");
    }

    public void test036() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test036", "X.java");
    }

    public void test037() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test037", "X.java");
    }

    public void test038() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test038", "X.java");
    }

    public void test039() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("test039", "X.java");
    }

    public void testBug403881() {
        //$NON-NLS-1$ //$NON-NLS-2$
        runTest("testBugs", "Bug403881.java");
    }
}
