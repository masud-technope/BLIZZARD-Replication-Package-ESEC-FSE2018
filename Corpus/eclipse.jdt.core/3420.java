...
public class QualifiedThisReference extends ThisReference {
    ...
    public void generateCode(BlockScope currentScope, CodeStream codeStream, boolean valueRequired) {
        ...
        if (valueRequired) {
            if ((this.bits & DepthMASK) != 0) {
                Object[] emulationPath = currentScope.getEmulationPath(this.currentCompatibleType, /*only exact match*/
    ...
    public TypeBinding resolveType(BlockScope scope) {
        ...
        TypeBinding type = this.qualification.resolveType(scope, /* check bounds*/
        true);
        ...
        if (this.currentCompatibleType == null) {
            ...
            scope.tagAsAccessingEnclosingInstanceStateOf(this.currentCompatibleType, /* type variable access */
            false);
        }
