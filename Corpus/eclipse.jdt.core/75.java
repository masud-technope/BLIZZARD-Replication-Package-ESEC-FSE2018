...
public class PostfixExpression extends Expression {
    ...
    new SimplePropertyDescriptor(PostfixExpression.class, "operator", PostfixExpression.Operator.class, MANDATORY);

    /**
	 * The "operand" structural property of this node type (child type: {@link Expression}).
	 * @since 3.0
	 */
    public static final ChildPropertyDescriptor OPERAND_PROPERTY = //$NON-NLS-1$
    new ChildPropertyDescriptor(PostfixExpression.class, "operand", Expression.class, MANDATORY, CYCLE_RISK);
