 ...
 */
    public void checkComment() {
        ...
        nextComment: for (lastCommentIndex = this.scanner.commentPtr; lastCommentIndex >= 0; lastCommentIndex--) {
            ...
            if (// line comment
            commentSourceStart < 0 || // block comment
            this.scanner.commentStops[lastCommentIndex] < 0 || // the comment is after the modifier
 ...
 */
	...
	*/
        ...
        this.intPtr -= 3;
        Argument arg = new Argument(parameterName, namePositions, type, // modifiers
 ...
 */
    protected void consumeClassDeclaration() {
        ...
        this.requestor.exitClass(// '}' is the end of the body
        this.endStatementPosition, ((TypeDeclaration) this.astStack[this.astPtr]).declarationSourceEnd);
    }
 ...
 */
    protected void consumeClassHeader() {
        ...
        if (superclass == null) {
            this.requestor.enterClass(typeDecl.declarationSourceStart, this.intArrayStack[this.intArrayPtr--], typeDecl.modifiers, typeDecl.modifiersSourceStart, this.typeStartPosition, typeDecl.name, typeDecl.sourceStart, typeDecl.sourceEnd, null, -1, -1, interfaceNames, interfaceNameStarts, interfaceNameEnds, this.scanner.currentPosition - 1);
        } else {
 ...
 */
    protected void consumeConstructorHeader() {
        ...
        this.requestor.enterConstructor(cd.declarationSourceStart, this.intArrayStack[this.intArrayPtr--], cd.modifiers, cd.modifiersSourceStart, cd.selector, cd.sourceStart, (int) (this.selectorSourcePositions & 0xFFFFFFFFL), // retrieve the source end of the name
        argumentTypes, argumentTypeStarts, argumentTypeEnds, argumentNames, argumentNameStarts, argumentNameEnds, this.rParenPos, // right parenthesis
 ...
 */
    protected void consumeEnterVariable() {
        ...
        if (!isLocalDeclaration) {
            this.requestor.enterField(declaration.declarationSourceStart, javadocPositions, declaration.modifiers, declaration.modifiersSourceStart, returnTypeName(declaration.type), type.sourceStart, type.sourceEnd, this.typeDims, varName, (int) (namePosition >>> 32), (int) namePosition, extendedTypeDimension, extendedTypeDimension == 0 ? -1 : this.endPosition);
        }
    }
 ...
 */
	...
	*/
        ...
        Argument arg;
        if (isReceiver) {
            arg = new Receiver(parameterName, namePositions, type, qualifyingNameReference, this.intStack[this.intPtr + 1] & ~ClassFileConstants.AccDeprecated);
        } else {
            arg = new Argument(parameterName, namePositions, type, // modifiers
            this.intStack[this.intPtr + 1]);
        }
        // consume annotations
        if ((length = this.expressionLengthStack[this.expressionLengthPtr--]) != 0) {
 ...
 */
    protected void consumeInterfaceDeclaration() {
        ...
        this.requestor.exitInterface(// the '}' is the end of the body
        this.endStatementPosition, ((TypeDeclaration) this.astStack[this.astPtr]).declarationSourceEnd);
    }
 ...
 */
    protected void consumeInterfaceHeader() {
        ...
        this.scanner.commentPtr = -1;
        this.requestor.enterInterface(typeDecl.declarationSourceStart, this.intArrayStack[this.intArrayPtr--], typeDecl.modifiers, typeDecl.modifiersSourceStart, this.typeStartPosition, typeDecl.name, typeDecl.sourceStart, typeDecl.sourceEnd, interfaceNames, interfaceNameStarts, interfacenameEnds, this.scanner.currentPosition - 1);
    }
...
*/
    ...
    protected void consumeSingleStaticImportDeclarationName() {
        ...
        this.requestor.acceptImport(importReference.declarationSourceStart, importReference.declarationSourceEnd, this.intArrayStack[this.intArrayPtr--], CharOperation.concatWith(importReference.getImportName(), '.'), importReference.sourceStart, false, ClassFileConstants.AccStatic);
    }
 ...
 */
    protected void consumeSingleTypeImportDeclarationName() {
        ...
        ImportReference importReference = (ImportReference) this.astStack[this.astPtr];
        this.requestor.acceptImport(importReference.declarationSourceStart, importReference.declarationSourceEnd, this.intArrayStack[this.intArrayPtr--], CharOperation.concatWith(importReference.getImportName(), '.'), importReference.sourceStart, false, ClassFileConstants.AccDefault);
    }
    ...
    protected void consumeStaticImportOnDemandDeclarationName() {
        ...
        ImportReference importReference = (ImportReference) this.astStack[this.astPtr];
        this.requestor.acceptImport(importReference.declarationSourceStart, importReference.declarationSourceEnd, this.intArrayStack[this.intArrayPtr--], CharOperation.concatWith(importReference.getImportName(), '.'), importReference.sourceStart, true, ClassFileConstants.AccStatic);
    }
 ...
 */
    protected void consumeStaticInitializer() {
        ...
        Initializer initializer = (Initializer) this.astStack[this.astPtr];
        this.requestor.acceptInitializer(initializer.declarationSourceStart, initializer.declarationSourceEnd, this.intArrayStack[this.intArrayPtr--], ClassFileConstants.AccStatic, this.intStack[this.intPtr--], initializer.block.sourceStart, initializer.declarationSourceEnd);
    }
 ...
 */
    protected void consumeTypeImportOnDemandDeclarationName() {
        ...
        ImportReference importReference = (ImportReference) this.astStack[this.astPtr];
        this.requestor.acceptImport(importReference.declarationSourceStart, importReference.declarationSourceEnd, this.intArrayStack[this.intArrayPtr--], CharOperation.concatWith(importReference.getImportName(), '.'), importReference.sourceStart, true, ClassFileConstants.AccDefault);
    }
 ...
 */
    public void parseCompilationUnit(ICompilationUnit unit) {
        ...
        try {
            ...
            this.referenceContext = this.compilationUnit = new CompilationUnitDeclaration(problemReporter(), new CompilationResult(unit, 0, 0, this.options.maxProblemsPerUnit), regionSource.length);
 ...
 */
    public void parseConstructor(char[] regionSource) {
        try {
            ...
            this.referenceContext = this.compilationUnit = new CompilationUnitDeclaration(problemReporter(), new CompilationResult(regionSource, 0, 0, this.options.maxProblemsPerUnit), regionSource.length);
            this.scanner.resetTo(0, regionSource.length);
            this.scanner.setSource(regionSource);
            parse();
        } catch (AbortCompilation ex) {
