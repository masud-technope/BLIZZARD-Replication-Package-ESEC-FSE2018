 ...
 */
    ...
    public void testBug232768_Block01() throws JavaModelException {
        ...
        formatSource(source, "public class D {\n" + "	\n" + "	/*\n" + "	 * a b c d .\n" + "	 */\n" + "	void m2() {\n" + "\n" + "	}\n" + "\n" + "}");
    }
    ...
    public void testBug232768_Line01() throws JavaModelException {
        ...
        formatSource(source, "public class E {\n" + "	\n" + "\n" + "	void m3() { // this is a bug\n" + "\n" + "	}\n" + "   \n" + "}");
    }
    ...
    public void testBug232768_Line07() throws JavaModelException {
        ...
        // Note that the line comment wasn't formatted using 3.3 and 3.4 M6
        formatSource(source, "public class F {\n" + "	\n" + "\n" + "        void            m3()         {     \n" + "		// this is a bug\n" + "\n" + "        }\n" + "   \n" + "}");
    }
    ...
    public void testBug232768_Line08() throws JavaModelException {
        ...
        // Note that the line comment wasn't formatted using 3.3 and 3.4 M6
        formatSource(source, "public class G {\n" + "	void foo() {\n" + "\n" + "		// Now we parse one of 'CustomActionTagDependent',\n" + "		// 'CustomActionJSPContent', or 'CustomActionScriptlessContent'.\n" + "		// depending on body-content in TLD.\n" + "	}\n" + "}");
    }
 ...
 */
    public void testBug234336() throws JavaModelException {
        String source = "public class Test {\n" + "	[#/**\n" + "			 * test test\n" + "				 */#]\n" + "}\n";
        formatSource(source, "public class Test {\n" + "	/**\n" + "	 * test test\n" + "	 */\n" + "}\n", CodeFormatter.K_JAVA_DOC, /* indentation level */
        1, /* formatting twice */
        true);
    }
 ...
 */
    ...
    public void testBug236406_ST1() {
        String source = "/**        Javadoc		comment    	    */foo1();\n" + "//        Line		comment    	    \n" + "foo2();\n" + "/*        Block		comment    	    */\n" + "foo3(); {\n" + "/*        indented Block		comment    	    */\n" + "System.out.println();}\n";
 ...
 */
    public void testBug315732() throws JavaModelException {
        this.formatterPrefs.use_tags = true;
        String source = "// ============================================================================\r\n" + "// /*-*/\r\n" + "// ============================================================================\r\n";
        formatSource(source, "	// ============================================================================\n" + "	// /*-*/\n" + "	// ============================================================================\n", CodeFormatter.K_UNKNOWN, 1, true);
    }
 ...
 */
    ...
    public void testBug470986() {
        ...
        String source = "class Example {  	 // test\n" + "\n" + "	void method1() {   	  // test\n" + "		int a = 1; // test\n" + "	}// test\n" + "\n" + "}";
        formatSource(source);
    }
 ...
 */
    public void testBug479292() {
        String source = "/** This   is   a   header   comment */\n" + "\n" + "/** This   is   a   package   javadoc */\n" + "package test;";
        formatSource(source, "/** This   is   a   header   comment */\n" + "\n" + "/** This is a package javadoc */\n" + "package test;");
    }
 ...
 */
    public void testBug480029() {
        String source = "public class JavadocCommentIssue\n" + "{\n" + "	/** @return <ul><li>Case 1</b></li></ul> */\n" + "	public int foo() {return 0;}\n" + "}\n";
        formatSource(source, "public class JavadocCommentIssue {\n" + "	/**\n" + "	 * @return\n" + "	 *         <ul>\n" + "	 *         <li>Case 1</b></li>\n" + "	 *         </ul>\n" + "	 */\n" + "	public int foo() {\n" + "		return 0;\n" + "	}\n" + "}\n");
    }
 ...
 */
    public void testBug480030() {
        String source = "public class SwitchCommentIssue {\n" + "	public void switchIssue(int a) {\n" + "		while (a > 0) {\n" + "			switch (a) {\n" + "			// Test\n" + "			case 1:\n" + "				break;\n" + "			// Test\n" + "			case 2:\n" + "				continue;\n" + "			// Test\n" + "			case 3:\n" + "				return;\n" + "			// Test\n" + "			case 4: {\n" + "				return;\n" + "			}\n" + "			// test\n" + "			}\n" + "		}\n" + "	}\n" + "}\n";
        formatSource(source);
    }
