...
public final class TagElement extends ASTNode implements IDocElement {
	 ...
	 * @since 3.0
	 */
    public static final SimplePropertyDescriptor TAG_NAME_PROPERTY = //$NON-NLS-1$
    new SimplePropertyDescriptor(TagElement.class, "tagName", String.class, OPTIONAL);
    ...
    new ChildListPropertyDescriptor(TagElement.class, "fragments", IDocElement.class, CYCLE_RISK);
	 ...
	 */
    private ASTNode.NodeList fragments = new ASTNode.NodeList(FRAGMENTS_PROPERTY);
