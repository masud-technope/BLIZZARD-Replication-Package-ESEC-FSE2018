 ...
 */
    ...
    public String debugName() {
        ...
        for (int i = this.dimensions; --i >= 0; ) //$NON-NLS-1$
        brackets.append("[]");
...
*/
    ...
    public void swapUnresolved(UnresolvedReferenceBinding unresolvedType, ReferenceBinding resolvedType, LookupEnvironment env) {
        ...
        this.leafComponentType == unresolvedType) {
    ...
    public MethodBinding getCloneMethod(final MethodBinding originalMethod) {
        ...
        MethodBinding method = new MethodBinding() {
            ...
            public char[] signature(ClassFile classFile) {
                // for codeGen we need to answer the signature of j.l.Object.clone()
                return originalMethod.signature();
            }
        };
        method.modifiers = originalMethod.modifiers;
        method.selector = originalMethod.selector;
        // cannot set array binding as declaring class, will be tweaked in CodeStream.getConstantPoolDeclaringClass()
