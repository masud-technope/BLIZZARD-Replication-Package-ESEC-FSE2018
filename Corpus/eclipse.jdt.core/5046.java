...
public class JavaSearchBugsTests2 extends AbstractJavaSearchTests {
    ...
    public void testBug376673a() throws CoreException {
        try {
            ...
            createFolder("/P/pkg");
            try {
                IFile file = createFile("/P/pkg/?1.java", content, "UTF-8");
    ...
    public void testBug376673b() throws CoreException {
        try {
            ...
            waitUntilIndexesReady();
            IJavaSearchScope scope = SearchEngine.createJavaSearchScope(new IJavaElement[] { project }, IJavaSearchScope.SOURCES);
            search("?m", METHOD, DECLARATIONS, EXACT_RULE, scope, this.resultCollector);
    ...
    public void testBug376673d() throws CoreException {
        try {
            ...
            waitUntilIndexesReady();
            IJavaSearchScope scope = SearchEngine.createJavaSearchScope(new IJavaElement[] { project }, IJavaSearchScope.SOURCES);
            search("?f", FIELD, DECLARATIONS, EXACT_RULE, scope, this.resultCollector);
    ...
    public void testBug376673e() throws CoreException, IOException {
        try {
            ...
            org.eclipse.jdt.core.tests.util.Util.createJar(new String[] { "p?/i?/Test.java", "package p?.i?;\n" + "public class Test{}\n" }, p.getProject().getLocation().append("lib376673.jar").toOSString(), "1.7");
            refresh(p);
            waitUntilIndexesReady();
            int mask = IJavaSearchScope.APPLICATION_LIBRARIES | IJavaSearchScope.SOURCES;
            IJavaSearchScope scope = SearchEngine.createJavaSearchScope(new IJavaElement[] { p }, mask);
    ...
    public void testBug357547e() throws CoreException, IOException {
        ...
        try {
            ...
            org.eclipse.jdt.core.tests.util.Util.createJar(new String[] { "p2/A.java", "package p2;\n" + "public class A{}\n" }, project.getProject().getLocation().append("libStuff.jar").toOSString(), "1.5");
            org.eclipse.jdt.core.tests.util.Util.createJar(new String[] { "p1/B.java", "package p1;\n" + "import p2.*;\n" + "public class B extends A {\n" + "long k(){\n" + "return 0;\n" + "}\n" + "}\n" }, null, project.getProject().getLocation().append("lib357547.jar").toOSString(), new String[] { project.getProject().getLocation().append("libStuff.jar").toOSString() }, "1.5");
            refresh(project);
            createFolder("/P/p2");
            createFile("/P/p2/A.java", "package p2;\n" + "public class A {\n" + "long k(){\n" + "return 0;\n" + "}\n" + "public long m(){\n" + "return new A().k();\n" + "}\n" + "}\n");
            waitUntilIndexesReady();
    ...
    public void testBug357547f() throws CoreException, IOException {
        ...
        try {
            project = createJavaProject("P", new String[] { "" }, new String[] { "/P/lib357547.jar", "JCL15_LIB" }, "", "1.5");
            org.eclipse.jdt.core.tests.util.Util.createJar(new String[] { "p2/A.java", "package p2;\n" + "public class A{}\n" }, project.getProject().getLocation().append("libStuff.jar").toOSString(), "1.5");
            org.eclipse.jdt.core.tests.util.Util.createJar(new String[] { "p2/B.java", "package p2;\n" + "import p2.*;\n" + "public class B extends A {\n" + "long k(){\n" + "return 0;\n" + "}\n" + "}\n" }, null, project.getProject().getLocation().append("lib357547.jar").toOSString(), new String[] { project.getProject().getLocation().append("libStuff.jar").toOSString() }, "1.5");
            refresh(project);
            createFolder("/P/p2");
            createFile("/P/p2/A.java", "package p2;\n" + "public class A {\n" + "long k(){\n" + "return 0;\n" + "}\n" + "public long m(){\n" + "return new A().k();\n" + "}\n" + "}\n");
            waitUntilIndexesReady();
    ...
    public void testBug381567b() throws CoreException {
        try {
            ...
            waitUntilIndexesReady();
            IMethod[] methods = getCompilationUnit("/P/src/b381567/A.java").getType("A").getMethods();
    ...
    public void testBug382778() throws CoreException {
        try {
            ...
            IMethod method = unit.getType("Static").getMethod("printIt", new String[] { "QString;" });
            IJavaSearchScope scope = SearchEngine.createJavaSearchScope(new IJavaElement[] { p }, IJavaSearchScope.SOURCES);
    ...
    public void testBug383315a() throws CoreException {
        try {
            ...
            // an NPE was thrown without the fix
            assertSearchResults("");
        } finally {
            deleteProject("P");
        }
    ...
    public void testBug401272() throws CoreException, IOException {
        ...
        try {
            ...
            org.eclipse.jdt.core.tests.util.Util.createJar(new String[] { // the match must be impossible-due-to-mismatching-type-variables to trigger matchLocator.getMethodBinding(this.pattern);
            ...
            waitUntilIndexesReady();
            IJavaSearchScope scope = SearchEngine.createJavaSearchScope(new IJavaElement[] { p }, IJavaSearchScope.SOURCES | IJavaSearchScope.SYSTEM_LIBRARIES | IJavaSearchScope.APPLICATION_LIBRARIES);
    ...
    public void testBug473921() throws Exception {
        try {
            IJavaProject p = this.createJavaProject("P", new String[] {}, new String[] { "/P/lib473921.jar", "JCL17_LIB" }, new String[][] { { "p/*" }, {} }, new String[][] { { "**/*" }, {} }, /*no project*/
            ...
            new SearchEngine().searchAllTypeNames(null, new char[][] { "Nested".toCharArray(), "Enclosing".toCharArray(), "Matryoshka".toCharArray() }, scope, collector, IJavaSearchConstants.WAIT_UNTIL_READY_TO_SEARCH, null);
            assertEquals(3, collector.matches.size());
            assertEquals(IAccessRule.K_ACCESSIBLE, collector.matches.get(0).getAccessibility());
            // bug 482309
            assertEquals(IAccessRule.K_ACCESSIBLE, collector.matches.get(1).getAccessibility());
            // bug 482309 (double-nested type)
            assertEquals(IAccessRule.K_ACCESSIBLE, collector.matches.get(2).getAccessibility());
            collector = new Collector();
            new SearchEngine().searchAllTypeNames(null, new char[][] { "CNested".toCharArray(), "CEnclosing".toCharArray(), "CMatryoshka".toCharArray() }, scope, collector, IJavaSearchConstants.WAIT_UNTIL_READY_TO_SEARCH, null);
            assertEquals(3, collector.matches.size());
            assertEquals(IAccessRule.K_NON_ACCESSIBLE, collector.matches.get(0).getAccessibility());
            // bug 482309
            assertEquals(IAccessRule.K_NON_ACCESSIBLE, collector.matches.get(1).getAccessibility());
            // bug 482309 (double-nested type)
            assertEquals(IAccessRule.K_NON_ACCESSIBLE, collector.matches.get(2).getAccessibility());
        } finally {
            deleteProject("P");
        }
    }
    ...
    public void testBug478042_0003() throws Exception {
        ...
        try {
            ...
            IJavaSearchScope scope = SearchEngine.createJavaSearchScope(new IJavaElement[] { project }, IJavaSearchScope.SOURCES);
            Collector collector = new Collector();
            new SearchEngine().searchAllMethodNames(null, SearchPattern.R_EXACT_MATCH, null, SearchPattern.R_EXACT_MATCH, "AllMethodDeclarations01".toCharArray(), SearchPattern.R_EXACT_MATCH, "foo".toCharArray(), SearchPattern.R_PREFIX_MATCH, scope, collector, IJavaSearchConstants.WAIT_UNTIL_READY_TO_SEARCH, null);
    ...
    public void testBug478042_007() throws Exception {
        try {
            ...
            MethodDeclarationsCollector requestor = new MethodDeclarationsCollector();
            IJavaSearchScope scope = SearchEngine.createJavaSearchScope(new IJavaElement[] { p }, IJavaSearchScope.SOURCES | IJavaSearchScope.APPLICATION_LIBRARIES);
            searchAllMethodNames("Inner", SearchPattern.R_EXACT_MATCH, "foo", SearchPattern.R_PREFIX_MATCH, scope, requestor);
            assertSearchResults("/P/lib478042.jar|p478042/AllMethodDeclarations01$Nested$Inner.class char p478042.Inner.foo03(java.lang.Object o,java.lang.String s)\n" + "/P/lib478042.jar|p478042/AllMethodDeclarations01$Nested$Inner.class int p478042.Inner.foo02(java.lang.Object o)\n" + "/P/lib478042.jar|p478042/AllMethodDeclarations01$Nested$Inner.class void p478042.Inner.foo01()", requestor);
        } finally {
            deleteProject("P");
        }
    ...
    public void testBug483303_001() throws Exception {
        ...
        try {
            ...
            IJavaSearchScope scope = SearchEngine.createJavaSearchScope(new IJavaElement[] { project }, IJavaSearchScope.SOURCES);
            Collector collector = new Collector();
            new SearchEngine().searchAllMethodNames(null, SearchPattern.R_EXACT_MATCH, null, SearchPattern.R_EXACT_MATCH, "AllMethodDeclarations01".toCharArray(), SearchPattern.R_EXACT_MATCH, "m1".toCharArray(), SearchPattern.R_PREFIX_MATCH, scope, collector, IJavaSearchConstants.WAIT_UNTIL_READY_TO_SEARCH, null);
    ...
    public void testBug483650_0003() throws Exception {
        ...
        try {
            ...
            IJavaSearchScope scope = SearchEngine.createJavaSearchScope(new IJavaElement[] { project }, IJavaSearchScope.SOURCES);
            Collector collector = new Collector();
            new SearchEngine().searchAllMethodNames("*.AllMethodDeclarations01".toCharArray(), SearchPattern.R_PATTERN_MATCH, "foo".toCharArray(), SearchPattern.R_PREFIX_MATCH, scope, collector, IJavaSearchConstants.WAIT_UNTIL_READY_TO_SEARCH, null);
            assertEquals(4, collector.matches.size());
        } finally {
            deleteProject("P");
        }
    ...
    public void testBug483650_007() throws Exception {
        try {
            ...
            IJavaSearchScope scope = SearchEngine.createJavaSearchScope(new IJavaElement[] { p }, IJavaSearchScope.SOURCES | IJavaSearchScope.APPLICATION_LIBRARIES);
            searchAllMethodNames("*Inner", SearchPattern.R_PATTERN_MATCH, "foo", SearchPattern.R_PREFIX_MATCH, scope, collector);
            assertSearchResults("/P/lib478042.jar void p478042.AllMethodDeclarations01.Nested.Inner.foo01()\n" + "/P/lib478042.jar int p478042.AllMethodDeclarations01.Nested.Inner.foo02(java.lang.Object o)\n" + "/P/lib478042.jar char p478042.AllMethodDeclarations01.Nested.Inner.foo03(java.lang.Object o,java.lang.String s)", collector);
        } finally {
            deleteProject("P");
        }
    ...
    public void testBug483650_009() throws Exception {
        ...
        try {
            ...
            IJavaSearchScope scope = SearchEngine.createJavaSearchScope(new IJavaElement[] { project }, IJavaSearchScope.SOURCES);
            Collector collector = new Collector();
            new SearchEngine().searchAllMethodNames("*.AllMethodDeclarations01".toCharArray(), SearchPattern.R_PATTERN_MATCH, "m1".toCharArray(), SearchPattern.R_PREFIX_MATCH, scope, collector, IJavaSearchConstants.WAIT_UNTIL_READY_TO_SEARCH, null);
            assertEquals(1, collector.matches.size());
            IMethod method = collector.matches.get(0).getMethod();
            assertTrue(method.exists());
        } finally {
    ...
    public void testBug489404() throws CoreException, IOException {
        try {
            ...
            org.eclipse.jdt.core.tests.util.Util.createJar(new String[] { "p1/MissingClass.java", "package p1;\n" + "public class MissingClass{}\n" }, p.getProject().getLocation().append("p1.jar").toOSString(), "1.5");
            org.eclipse.jdt.core.tests.util.Util.createJar(new String[] { "p1/p2/BinaryWithField.java", "package p1.p2;\n" + "import p1.MissingClass;\n" + "public class BinaryWithField {\n" + "  public class Binary {\n" + "  }\n" + "  MissingClass f;\n" + "}\n", "p1/p2/BinaryWithMethod.java", "package p1.p2;\n" + "import p1.MissingClass;\n" + "public class BinaryWithMethod {\n" + "  public class Binary {\n" + "  }\n" + "  MissingClass m() {\n" + "    return null;\n" + "  }\n" + "}\n" }, null, p.getProject().getLocation().append("p1p2.jar").toOSString(), new String[] { p.getProject().getLocation().append("p1.jar").toOSString() }, "1.5");
