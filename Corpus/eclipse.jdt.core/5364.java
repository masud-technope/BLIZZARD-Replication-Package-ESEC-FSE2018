...
public class RunAllJava8Tests extends TestCase {
    ...
    public static Class[] getAllTestClasses() {
        return new Class[] { ComplianceDiagnoseTest.class, FormatterJSR335Tests.class, FormatterJSR308Tests.class, FormatterBugs18Tests.class, JavaSearchBugs8Tests.class, ResolveTests18.class, CompletionTests18.class, IncrementalTests18.class, org.eclipse.jdt.compiler.apt.tests.AllTests.class, JavaElement8Tests.class };
    }

    public static Class[] getConverterTestClasses() {
        return new Class[] { TypeAnnotationsConverterTest.class, ASTConverterTestAST8_2.class, ASTConverterAST8Test.class, ASTConverterBugsTestJLS8.class, ASTConverter15JLS8Test.class, ASTConverter18Test.class, ASTConverter17Test.class, ASTRewritingTest.class, TypeBindingTests308.class };
    }

    public static Class[] getCompilerClasses() {
        return new Class[] { org.eclipse.jdt.core.tests.eval.TestAll.class, org.eclipse.jdt.core.tests.compiler.regression.TestAll.class };
    }
