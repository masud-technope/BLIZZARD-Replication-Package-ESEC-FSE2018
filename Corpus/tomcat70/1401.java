...
public class TestStandardContext extends TomcatBaseTest {
    ...
    public static final class Bug50015SCI implements ServletContainerInitializer {
    ...
    public static final class Bug51376Servlet extends HttpServlet {
        ...
        protected boolean isOk() {
            if (initOk != null && initOk.booleanValue() && destroyOk != null && destroyOk.booleanValue()) {
                return true;
    ...
    public void testBug49711() {
        ...
        assertEquals("Incorrect response for non-configured casual multipart request", // multipart request should be ignored
        "parts=0", client.getResponseBody());
        client.reset();
    ...
    private static class Bug49711Servlet extends HttpServlet {
        ...
        protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
            ...
            out.println("parts=" + (null == req.getParts() ? "null" : Integer.valueOf(req.getParts().size())));
        }
    }
    ...
    public void testBug56903() {
        ...
        Assert.assertThat(Arrays.asList(context.getResourceOnlyServlets().split(",")), CoreMatchers.hasItems("a", "b", "c"));
    }
