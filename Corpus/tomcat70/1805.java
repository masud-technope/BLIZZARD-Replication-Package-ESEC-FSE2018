...
public final class TesterSupport {
    ...
    protected static void initSsl(Tomcat tomcat, String keystore, String keystorePass, String keyPass) {
        ...
        if (protocol.indexOf("Apr") == -1) {
            ...
            java.net.URL keyStoreUrl = cl.getResource("org/apache/tomcat/util/net/" + keystore);
            File keystoreFile = toFile(keyStoreUrl);
            connector.setAttribute("keystoreFile", keystoreFile.getAbsolutePath());
            java.net.URL truststoreUrl = cl.getResource("org/apache/tomcat/util/net/ca.jks");
            ...
            java.net.URL keyStoreUrl = cl.getResource("org/apache/tomcat/util/net/localhost-cert.pem");
            File keystoreFile = toFile(keyStoreUrl);
            tomcat.getConnector().setAttribute("SSLCertificateFile", keystoreFile.getAbsolutePath());
            java.net.URL sslCertificateKeyUrl = cl.getResource("org/apache/tomcat/util/net/localhost-key.pem");
            File sslCertificateKeyFile = toFile(sslCertificateKeyUrl);
            tomcat.getConnector().setAttribute("SSLCertificateKeyFile", sslCertificateKeyFile.getAbsolutePath());
        }
    ...
    protected static KeyManager[] getUser1KeyManagers() throws Exception {
        ...
        kmf.init(getKeyStore("org/apache/tomcat/util/net/user1.jks"), "changeit".toCharArray());
    ...
    protected static void configureClientSsl() {
        try {
            ...
            javax.net.ssl.HttpsURLConnection.setDefaultSSLSocketFactory(new NoSSLv2SocketFactory(sc.getSocketFactory()));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
