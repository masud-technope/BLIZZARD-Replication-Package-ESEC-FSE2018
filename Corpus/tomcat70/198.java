    ...
    private class Bug48839Client extends SimpleHttpClient {
        ...
        private Exception doRequest() {
            ...
            try {
                ...
                request[0] = "GET http://localhost:8080/test HTTP/1.1" + CRLF + "X-Bug48839: abcd" + CRLF + "\tefgh" + CRLF + "Connection: close" + CRLF + CRLF;
                setRequest(request);
    ...
    private class Bug51557Client extends SimpleHttpClient {
        ...
        private Exception doRequest() {
            ...
            try {
                ...
                connect();
                String[] request = new String[1];
                request[0] = "GET http://localhost:8080/test HTTP/1.1" + CRLF + headerLine + CRLF + "X-Bug51557: abcd" + CRLF + "Connection: close" + CRLF + CRLF;
                setRequest(request);
                processRequest();
                disconnect();
            } catch (Exception e) {
    ...
    private class NewLinesClient extends SimpleHttpClient {
        ...
        private Exception doRequest() {
            ...
            try {
                ...
                connect();
                String[] request = new String[1];
                request[0] = newLines + "GET http://localhost:8080/test HTTP/1.1" + CRLF + "X-Bug48839: abcd" + CRLF + "\tefgh" + CRLF + "Connection: close" + CRLF + CRLF;
                setRequest(request);
                // blocks until response has been read
                processRequest();
                // Close the connection
    ...
    private class InvalidMethodClient extends SimpleHttpClient {
        ...
        private Exception doRequest() {
            ...
            try {
                ...
                connect();
                String[] request = new String[1];
                request[0] = "GET" + (char) 0 + " /test HTTP/1.1" + CRLF + "Host: localhost:8080" + CRLF + "Connection: close" + CRLF + CRLF;
                setRequest(request);
                // blocks until response has been read
                processRequest();
                // Close the connection
