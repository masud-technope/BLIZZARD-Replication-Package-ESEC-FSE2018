...
public class SlowQueryReport extends AbstractQueryReport {
     ...
     */
    protected static ConcurrentHashMap<String, ConcurrentHashMap<String, QueryStats>> perPoolStats = new ConcurrentHashMap<String, ConcurrentHashMap<String, QueryStats>>();
    ...
    private static class QueryStatsComparator implements Comparator<QueryStats> {
        ...
        public int compare(QueryStats stats1, QueryStats stats2) {
            return compare(handleZero(stats1.lastInvocation), handleZero(stats2.lastInvocation));
        }
