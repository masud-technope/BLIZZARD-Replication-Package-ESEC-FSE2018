...
public class TestLocalResolver {
    ...
    @Test
    public void systemIdIsIgnoredWhenPublicIdIsResolved() throws IOException, SAXException {
    ...
    @Test
    public void relativeSystemIdIsResolvedAgainstBaseURI() throws IOException, SAXException {
    ...
    @Test
    public void absoluteSystemIdOverridesBaseURI() throws IOException, SAXException {
