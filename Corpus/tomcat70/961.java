...
public class TestFormAuthenticator extends TomcatBaseTest {
     ...
     *
     */
    private String doTest(String resourceMethod, String redirectMethod, boolean useContinue, boolean clientShouldUseCookies, boolean serverWillUseCookies, boolean serverWillChangeSessid) throws Exception {
        client = new FormAuthClient(clientShouldUseCookies, serverWillUseCookies, serverWillChangeSessid);
        // First request for protected resource gets the login page
        ...
        assertTrue(client.isResponse200());
        assertTrue(client.isResponseBodyOK());
        String protectedUri = client.extractBodyUri(FormAuthClient.RESOURCE_PARAM_TAG, FormAuthClient.PROTECTED_RESOURCE);
     ...
     *
     */
    private void doTestProtected(String resourceMethod, String protectedUri, boolean useContinue, int phase, int repeatCount) throws Exception {
        // Subsequent requests - keep accessing the protected resource
    ...
    private abstract class FormAuthClientBase extends SimpleHttpClient {
         ...
         */
        protected void doResourceRequest(String method, boolean isFullQualUri, String resourceUri, String requestTail) throws Exception {
            ...
            if (getUseCookies()) {
                ...
                if (sessionId != null) {
                    requestHead.append("Cookie: ").append(SESSION_COOKIE_NAME).append("=").append(sessionId).append(CRLF);
                }
            }
    ...
    private class FormAuthClient extends FormAuthClientBase {
        ...
        private  FormAuthClient(boolean clientShouldUseCookies, boolean serverShouldUseCookies, boolean serverShouldChangeSessid) throws Exception {
    ...
    private class FormAuthClientSelectedMethods extends FormAuthClientBase {
        ...
        private  FormAuthClientSelectedMethods(boolean clientShouldUseCookies, boolean serverShouldUseCookies, boolean serverShouldChangeSessid) throws Exception {
            Tomcat tomcat = getTomcatInstance();
