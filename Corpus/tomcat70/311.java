...
public class TestAbstractHttp11Processor extends TomcatBaseTest {
    ...
    private static class Bug57621Servlet extends HttpServlet {
        ...
        @Override
        protected void doPut(HttpServletRequest req, final HttpServletResponse resp) throws ServletException, IOException {
    ...
    private class Bug57621Client extends SimpleHttpClient {
        ...
        private Exception doRequest() {
            try {
                ...
                request[0] = "PUT http://localhost:8080/test HTTP/1.1" + CRLF + "Transfer-encoding: chunked" + CRLF + CRLF + "2" + CRLF + "OK";
    ...
    private static class Non2xxResponseClient extends SimpleHttpClient {
        ...
        void doResourceRequest(String resourceUri, String requestBody) throws Exception {
