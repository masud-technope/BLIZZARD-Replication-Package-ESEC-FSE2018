...
public class TestUriTemplate {
    ...
    public void testBasicPrefix() throws Exception {
        @SuppressWarnings("unused") UriTemplate t = new UriTemplate("/x{a}/y{b}");
    }
    ...
    public void testQuote2() throws Exception {
        @SuppressWarnings("unused") UriTemplate t = new UriTemplate("/.{a}");
    }
    ...
    public void testDuplicate01() throws Exception {
        @SuppressWarnings("unused") UriTemplate t = new UriTemplate("/{var}/{var}");
    }
    ...
    public void testEgMailingList04() throws Exception {
        ...
        @SuppressWarnings("unused") Map<String, String> result = t.match(new UriTemplate("/a//c"));
    }

    @Test(expected = java.lang.IllegalArgumentException.class)
    public void testEgMailingList05() throws Exception {
        UriTemplate t = new UriTemplate("/a/{var}/");
        @SuppressWarnings("unused") Map<String, String> result = t.match(new UriTemplate("/a/b/"));
    }
}
