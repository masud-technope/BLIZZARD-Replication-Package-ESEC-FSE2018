...
public abstract class ExpressionEvaluator {
     ...
     */
    public abstract Expression parseExpression(String expression, // TCK signature fails with generics
    @SuppressWarnings("rawtypes") Class expectedType, FunctionMapper fMapper) throws ELException;
     ...
     */
    public abstract Object evaluate(String expression, // TCK signature fails with generics
    @SuppressWarnings("rawtypes") Class expectedType, VariableResolver vResolver, FunctionMapper fMapper) throws ELException;
}
