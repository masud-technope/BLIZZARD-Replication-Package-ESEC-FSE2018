...
public class NioEndpoint extends AbstractEndpoint<NioChannel> {
                ...
                try {
                    if (key == null) {
                        ...
                        if (att != null) {
                            ...
                            //remove the callback flag
                            interestOps = (interestOps & (~OP_CALLBACK));
                            //to prevent timeout
                            att.access();
    ...
    public class Poller implements Runnable {
        ...
        public void cometInterest(NioChannel socket) {
            ...
            if ((att.getCometOps() & OP_CALLBACK) == OP_CALLBACK) {
                //force the check for faster callback
                nextExpiration = 0;
                selector.wakeup();
            }
        }
                ...
                for (Iterator<SelectionKey> iter = keys.iterator(); iter.hasNext(); ) {
                    ...
                    try {
                        ...
                        if (ka == null) {
                            ...
                            //avoid multiple calls, this gets reregistered after invocation
                            reg(key, ka, 0);
    ...
    protected class SocketProcessor implements Runnable {
        ...
        private void close(KeyAttachment ka, NioChannel socket, SelectionKey key, SocketStatus socketStatus) {
            try {
                if (ka != null) {
                    ka.setComet(false);
                }
