...
public class UnavailableException extends ServletException {
    ...
    public  UnavailableException(// Spec API does not use @Deprecated
    Servlet servlet, String msg) {
        super(msg);
    ...
    @SuppressWarnings("dep-ann")
    public  UnavailableException(// Spec API does not use @Deprecated
    int seconds, Servlet servlet, String msg) {
        super(msg);
        this.servlet = servlet;
        if (seconds <= 0)
            this.seconds = -1;
     ...
     */
    @SuppressWarnings("dep-ann")
    public // Spec API does not use @Deprecated
    Servlet getServlet() {
        return servlet;
    }
