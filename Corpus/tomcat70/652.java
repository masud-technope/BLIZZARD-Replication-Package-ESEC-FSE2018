...
public class TestAbstractAjpProcessor extends TomcatBaseTest {
    ...
    private void doSnoopTest(RequestDescriptor desc) throws Exception {
        ...
        for (String name : requestInfo.keySet()) {
            ...
            if (name.equals("REQUEST-METHOD")) {
                ...
                savedRequestInfo.put(name, value);
            } else if (name.equals("REQUEST-REMOTE-USER") || name.equals("REQUEST-ROUTE") || name.equals("REQUEST-SECRET") || name.equals("REQUEST-AUTH-TYPE") || name.equals("REQUEST-QUERY-STRING")) {
                savedRequestInfo.put(name, value);
     ...
     * ignored.
     */
    private void validateResponseHeaders(TesterAjpMessage message, int expectedStatus, String expectedMessage) throws Exception {
