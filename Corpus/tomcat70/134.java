...
public class SerializablePrincipal implements java.io.Serializable {
    ...
    private static final org.apache.juli.logging.Log log = org.apache.juli.logging.LogFactory.getLog(SerializablePrincipal.class);
    ...
    public GenericPrincipal getPrincipal() {
        return new GenericPrincipal(name, password, getRoles() != null ? Arrays.asList(getRoles()) : null, userPrincipal);
    }
