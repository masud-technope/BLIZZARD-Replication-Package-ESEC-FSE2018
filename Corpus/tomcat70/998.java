...
class ParserController implements TagConstants {
     ...
     * @param inFileName The path to the JSP page or tag file to be parsed.
     */
    public Node.Nodes parseDirectives(String inFileName) throws FileNotFoundException, JasperException, IOException {
        // If we're parsing a packaged tag file or a resource included by it
        // (using an include directive), ctxt.getTagFileJar() returns the 
        // JAR file from which to read the tag file or included resource,
        // respectively.
     ...
     */
    public Node.Nodes parse(String inFileName, Node parent, JarResource jarResource) throws FileNotFoundException, JasperException, IOException {
        // remain unchanged.
     ...
     */
    public Node.Nodes parseTagFileDirectives(String inFileName, JarResource jarResource) throws FileNotFoundException, JasperException, IOException {
     ...
     */
    private Node.Nodes doParse(String inFileName, Node parent, JarResource jarResource) throws FileNotFoundException, JasperException, IOException {
        ...
        if (parent != null) {
            ...
            if (jarFile == null) {
                ...
                compiler.getPageInfo().addDependant(jarResource.getEntry(entry).toString(), Long.valueOf(jarFile.getEntry(entry).getTime()));
            }
        }
        ...
        if (isXml) {
            ...
            try {
                ...
                parsedPage = Parser.parse(this, jspReader, parent, isTagFile, directiveOnly, jarResource, sourceEnc, jspConfigPageEnc, isDefaultPageEncoding, isBomPresent);
            } finally {
