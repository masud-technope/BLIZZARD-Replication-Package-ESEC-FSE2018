...
public class AccessLogValve extends ValveBase implements AccessLog {
     ...
     */
    private static enum FormatType implements  {
     ...
     */
    private static enum PortType implements  {
    ...
    public void log(Request request, Response response, long time) {
        if (!getState().isAvailable() || !getEnabled() || logElements == null || condition != null && null != request.getRequest().getAttribute(condition) || conditionIf != null && null == request.getRequest().getAttribute(conditionIf)) {
            return;
        }
        /**
