...
public class ContextRuleSet extends RuleSetBase {
    ...
    public void addRuleInstances(Digester digester) {
        ...
        digester.addObjectCreate(prefix + "Context/Listener", // MUST be specified in the element
        null, "className");
        ...
        digester.addObjectCreate(prefix + "Context/Manager/Store", // MUST be specified in the element
        null, "className");
        ...
        digester.addObjectCreate(prefix + "Context/Valve", // MUST be specified in the element
        null, "className");
