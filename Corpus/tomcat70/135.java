...
public class TestClose extends WebSocketBaseTest {
    ...
    public static void awaitOnError(Class<? extends Throwable> exceptionClazz) {
        ...
        Assert.assertTrue(events.onErrorThrowable.getClass().getName(), exceptionClazz.isAssignableFrom(events.onErrorThrowable.getClass()));
    }
    ...
    public abstract static class BaseEndpointConfig extends WsContextListener {
        ...
        public void contextInitialized(ServletContextEvent sce) {
            ...
            ServerEndpointConfig sec = ServerEndpointConfig.Builder.create(getEndpointClass(), PATH).build();
            try {
                sc.addEndpoint(sec);
