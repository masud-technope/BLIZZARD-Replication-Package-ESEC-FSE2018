...
public abstract class WsRemoteEndpointImplBase implements RemoteEndpoint {
    ...
    public void sendStringByCompletion(String text, SendHandler handler) {
        ...
        stateMachine.textStart();
        TextMessageSendHandler tmsh = new TextMessageSendHandler(handler, CharBuffer.wrap(text), true, encoder, encoderBuffer, this);
        tmsh.write();
    ...
    void startMessage(byte opCode, ByteBuffer payload, boolean last, SendHandler handler) {
        ...
        messageParts.add(new MessagePart(last, 0, opCode, payload, intermediateMessageHandler, new EndMessageHandler(this, handler)));
    ...
    private long getBlockingSendTimeout() {
        Object obj = wsSession.getUserProperties().get(BLOCKING_SEND_TIMEOUT_PROPERTY);
