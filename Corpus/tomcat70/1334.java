...
public class TestCometProcessor extends TomcatBaseTest {
    ...
    private static class SimpleCometServlet extends HttpServlet implements CometProcessor {
        ...
        public void init() throws ServletException {
            failOnBegin = Boolean.parseBoolean(getServletConfig().getInitParameter(FAIL_ON_BEGIN));
            failOnRead = Boolean.parseBoolean(getServletConfig().getInitParameter(FAIL_ON_READ));
            failOnEnd = Boolean.parseBoolean(getServletConfig().getInitParameter(FAIL_ON_END));
        }
    ...
    private static class CometCloseServlet extends HttpServlet implements CometProcessor {
    ...
    private static class ConnectionCloseServlet extends HttpServlet implements CometProcessor {
