...
public class TestCookies {
    ...
    public void testNameOnlyCookies() throws Exception {
        ...
        test("fred=1; jim=2; bob; george=3", "fred", "1", "jim", "2", "george", "3");
        test("fred=1; jim=2; bob=; george=3", "fred", "1", "jim", "2", "george", "3");
        test("fred=1; jim=2; bob=", "fred", "1", "jim", "2");
    }
    ...
    public static void test(String s, String name, String val, String name2, String val2, String name3, String val3) throws Exception {
        System.out.println("Processing [" + s + "]");
        Cookies cs = new Cookies(null);
        cs.processCookieHeader(s.getBytes(), 0, s.length());
        int num = cs.getCookieCount();
    ...
    public static void test(String s, String name, String val, String name2, String val2, String name3, String val3, String name4, String val4) throws Exception {
        System.out.println("Processing [" + s + "]");
        Cookies cs = new Cookies(null);
        cs.processCookieHeader(s.getBytes(), 0, s.length());
        int num = cs.getCookieCount();
