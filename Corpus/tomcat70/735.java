...
public class TagHandlerPool {
    ...
    private void doRelease(Tag handler) {
        try {
            ...
            ExceptionUtils.handleThrowable(t);
            log.warn("Error processing release on tag instance of " + handler.getClass().getName(), t);
        }
        try {
            ...
            Throwable t = ExceptionUtils.unwrapInvocationTargetException(e);
            ExceptionUtils.handleThrowable(t);
            log.warn("Error processing preDestroy on tag instance of " + handler.getClass().getName(), t);
        }
    }
