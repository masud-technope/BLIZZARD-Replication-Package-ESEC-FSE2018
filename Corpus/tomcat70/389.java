...
public class UTF8Reader extends Reader {
    ...
    private final org.apache.juli.logging.Log log = org.apache.juli.logging.LogFactory.getLog(UTF8Reader.class);
    ...
    public int read() throws IOException {
        ...
        if (fSurrogate == -1) {
            ...
            if (b0 < 0x80) {
                c = (char) b0;
            } else // Unicode: [0000 0yyy] [yyxx xxxx]
            if ((b0 & 0xE0) == 0xC0) {
            ...
            } else // Unicode: [zzzz yyyy] [yyxx xxxx]
            if ((b0 & 0xF0) == 0xE0) {
                int b1 = index == fOffset ? fInputStream.read() : fBuffer[index++] & 0x00FF;
                if (b1 == -1) {
                    expectedByte(2, 3);
    ...
    public int read(char ch[], int offset, int length) throws IOException {
        ...
        if (fOffset == 0) {
            ...
            count += out - offset;
        } else // skip read; last character was in error
    ...
    private void invalidByte(int position, int count) throws UTFDataFormatException {
