...
public class ClusterRuleSet extends RuleSetBase {
    ...
    public void addRuleInstances(Digester digester) {
        ...
        digester.addObjectCreate(prefix + "Manager", // MUST be specified in the element
        null, "className");
        ...
        digester.addObjectCreate(prefix + "Manager/SessionIdGenerator", "org.apache.catalina.util.StandardSessionIdGenerator", "className");
        digester.addSetProperties(prefix + "Manager/SessionIdGenerator");
        digester.addSetNext(prefix + "Manager/SessionIdGenerator", "setSessionIdGenerator", "org.apache.catalina.SessionIdGenerator");
        digester.addObjectCreate(prefix + "Channel", // MUST be specified in the element
        null, "className");
        ...
        {
            //channel properties
            digester.addObjectCreate(channelPrefix + "Membership", // MUST be specified in the element
            null, "className");
            ...
            digester.addObjectCreate(channelPrefix + "MembershipListener", // MUST be specified in the element
            null, "className");
            ...
            digester.addObjectCreate(channelPrefix + "Sender", // MUST be specified in the element
            null, "className");
            ...
            digester.addObjectCreate(channelPrefix + "Sender/Transport", // MUST be specified in the element
            null, "className");
            ...
            digester.addObjectCreate(channelPrefix + "Receiver", // MUST be specified in the element
            null, "className");
            ...
            digester.addObjectCreate(channelPrefix + "Interceptor", // MUST be specified in the element
            null, "className");
            ...
            digester.addObjectCreate(channelPrefix + "Interceptor/LocalMember", // MUST be specified in the element
            null, "className");
            ...
            digester.addObjectCreate(channelPrefix + "Interceptor/Member", // MUST be specified in the element
            null, "className");
            ...
            digester.addObjectCreate(channelPrefix + "ChannelListener", // MUST be specified in the element
            null, "className");
        ...
        digester.addObjectCreate(prefix + "Valve", // MUST be specified in the element
        null, "className");
        digester.addSetProperties(prefix + "Valve");
        digester.addSetNext(prefix + "Valve", "addValve", "org.apache.catalina.Valve");
        digester.addObjectCreate(prefix + "Deployer", // MUST be specified in the element
        null, "className");
        ...
        digester.addObjectCreate(prefix + "Listener", // MUST be specified in the element
        null, "className");
        ...
        digester.addObjectCreate(prefix + "ClusterListener", // MUST be specified in the element
        null, "className");
