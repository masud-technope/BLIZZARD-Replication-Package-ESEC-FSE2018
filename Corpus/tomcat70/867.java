...
public class TestListELResolver {
    ...
    public void testSetValue03() {
        ...
        ELContext context = new ELContextImpl();
        resolver.setValue(context, new ArrayList<Object>(), new Object(), new Object());
    }
    ...
    public void testSetValue05() {
        ListELResolver resolver = new ListELResolver();
        ELContext context = new ELContextImpl();
        List<Object> list = Collections.unmodifiableList(new ArrayList<Object>());
        resolver.setValue(context, list, new Integer(0), "value");
    }
    ...
    private static enum MethodUnderTest implements  {
