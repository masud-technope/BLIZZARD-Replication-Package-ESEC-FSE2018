...
public abstract class SimpleHttpClient {
    ...
    protected static final String SESSION_PARAMETER_NAME = SESSION_COOKIE_NAME.toLowerCase(Locale.ENGLISH);

    private static final String COOKIE_HEADER_PREFIX = "Set-Cookie: ";

    private static final String SESSION_COOKIE_HEADER_PREFIX = COOKIE_HEADER_PREFIX + SESSION_COOKIE_NAME + "=";
    ...
    public void processRequest(boolean wantBody) throws IOException, InterruptedException {
        sendRequest();
    ...
    private void processHeaders() throws IOException {
        ...
        while ((line != null) && (line.length() > 0)) {
            ...
            if (line.startsWith(CONTENT_LENGTH_HEADER_PREFIX)) {
                ...
                if (useCookies) {
                    String temp = line.substring(SESSION_COOKIE_HEADER_PREFIX.length());
