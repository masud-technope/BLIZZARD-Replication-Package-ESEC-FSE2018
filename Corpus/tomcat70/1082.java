...
public class TestCookiesAllowEquals extends TomcatBaseTest {
    ...
    private class TestCookieEqualsClient extends SimpleHttpClient {
        ...
        private void doRequest() throws Exception {
            ...
            request[0] = "GET /test HTTP/1.0" + CRLF + "Cookie: " + COOKIE_WITH_EQUALS_1 + CRLF + "Cookie: " + COOKIE_WITH_EQUALS_2 + CRLF + "Cookie: " + COOKIE_WITH_EQUALS_3 + CRLF + CRLF;
            setRequest(request);
            ...
            reset();
            tomcat.stop();
            assertEquals(COOKIE_WITH_EQUALS_1 + COOKIE_WITH_EQUALS_2 + COOKIE_WITH_EQUALS_3, response);
        }
