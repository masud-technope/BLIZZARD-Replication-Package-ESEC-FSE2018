...
public class WsServerContainer extends WsWebSocketContainer implements ServerContainer {
    ...
    private volatile boolean endpointsRegistered = false;
     ...
     WsServerContainer(ServletContext servletContext) {
        ...
        executorService = new ThreadPoolExecutor(executorCoreSize, Integer.MAX_VALUE, executorKeepAliveTimeSeconds, TimeUnit.SECONDS, new SynchronousQueue<Runnable>(), wsThreadFactory);
    }
    ...
    public void destroy() {
        ...
        if (!success) {
            log.warn(sm.getString("serverContainer.threadGroupNotDestroyed", threadGroup.getName(), Integer.valueOf(threadCount)));
        }
    }
