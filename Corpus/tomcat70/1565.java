...
class Validator {
            ...
            for (int i = 0; attrs != null && i < attrs.getLength(); i++) {
                ...
                if ("language".equals(attr)) {
                    ...
                    if (pageInfo.getDeferredSyntaxAllowedAsLiteral() == null) {
                        ...
                        err.jspError(n, "jsp.error.page.conflict.deferredsyntaxallowedasliteral", pageInfo.getDeferredSyntaxAllowedAsLiteral(), value);
                    }
                    ...
                    if (pageInfo.getTrimDirectiveWhitespaces() == null) {
                        ...
                        err.jspError(n, "jsp.error.page.conflict.trimdirectivewhitespaces", pageInfo.getTrimDirectiveWhitespaces(), value);
                    }
                }
            }
            ...
            for (int i = 0; attrs != null && i < attrs.getLength(); i++) {
                ...
                if ("language".equals(attr)) {
                    ...
                    if (pageInfo.getDeferredSyntaxAllowedAsLiteral() == null) {
                        ...
                        err.jspError(n, "jsp.error.tag.conflict.deferredsyntaxallowedasliteral", pageInfo.getDeferredSyntaxAllowedAsLiteral(), value);
                    }
                } else if ("trimDirectiveWhitespaces".equals(attr)) {
                    if (pageInfo.getTrimDirectiveWhitespaces() == null) {
                        pageInfo.setTrimDirectiveWhitespaces(value, n, err, false);
                    } else if (!pageInfo.getTrimDirectiveWhitespaces().equals(value)) {
                        err.jspError(n, "jsp.error.tag.conflict.trimdirectivewhitespaces", pageInfo.getTrimDirectiveWhitespaces(), value);
                    }
                }
            }
            // Attributes for imports for this node have been processed by
    ...
    static class ValidateVisitor extends Node.Visitor {
        ...
        public void visit(Node.UseBean n) throws JasperException {
            ...
            Node.JspAttribute jattr = getJspAttribute(null, "beanName", null, null, n.getAttributeValue("beanName"), n, null, false);
            n.setBeanName(jattr);
        ...
        public void visit(Node.PlugIn n) throws JasperException {
            ...
            Node.JspAttribute width = getJspAttribute(null, "width", null, null, n.getAttributeValue("width"), n, null, false);
            n.setWidth(width);
            Node.JspAttribute height = getJspAttribute(null, "height", null, null, n.getAttributeValue("height"), n, null, false);
            n.setHeight(height);
            visitBody(n);
        }
        ...
        public void visit(Node.UninterpretedTag n) throws JasperException {
            ...
            if (attrs != null) {
                ...
                for (int i = 0; i < attrSize; i++) {
                    ...
                    jspAttrs[i] = getJspAttribute(null, attrs.getQName(i), attrs.getURI(i), attrs.getLocalName(i), value, n, null, false);
                }
        ...
        public void visit(Node.JspElement n) throws JasperException {
            ...
            @SuppressWarnings("null") int xmlAttrLen = attrs.getLength();
            ...
            for (int i = 0; i < xmlAttrLen; i++) {
                if ("name".equals(attrs.getLocalName(i))) {
                    n.setNameAttribute(getJspAttribute(null, attrs.getQName(i), attrs.getURI(i), attrs.getLocalName(i), attrs.getValue(i), n, null, false));
                } else {
                    if (jspAttrIndex < jspAttrSize) {
                        jspAttrs[jspAttrIndex++] = getJspAttribute(null, attrs.getQName(i), attrs.getURI(i), attrs.getLocalName(i), attrs.getValue(i), n, null, false);
                    }
                }
            }
        ...
        private void checkXmlAttributes(Node.CustomTag n, Node.JspAttribute[] jspAttrs, Hashtable<String, Object> tagDataAttrs) throws JasperException {
            ...
            for (int i = 0; attrs != null && i < attrs.getLength(); i++) {
                ...
                boolean deferredSyntaxAllowedAsLiteral = pageInfo.isDeferredSyntaxAllowedAsLiteral() || libraryVersion < 2.1;
                            ...
                            if (!expression) {
                                ...
                                if (expectedType != null) {
                                    ...
                                    try {
                                        ...
                                        err.jspError(n, "jsp.error.unknown_attribute_type", tldAttr.getName(), expectedType);
                                    }
                                    ...
                                    if (String.class.equals(expectedClass) || expectedClass == Long.TYPE || expectedClass == Double.TYPE || expectedClass == Byte.TYPE || expectedClass == Short.TYPE || expectedClass == Integer.TYPE || expectedClass == Float.TYPE || Number.class.isAssignableFrom(expectedClass) || Character.class.equals(expectedClass) || Character.TYPE == expectedClass || Boolean.class.equals(expectedClass) || Boolean.TYPE == expectedClass || expectedClass.isEnum()) {
                                        try {
                                            ...
                                            err.jspError(n, "jsp.error.coerce_to_type", tldAttr.getName(), expectedType, textAttributeValue);
                                        }
                                    }
                                }
                                ...
                                jspAttrs[i] = getJspAttribute(tldAttr, attrs.getQName(i), attrs.getURI(i), attrs.getLocalName(i), xmlAttributeValue, n, el, false);
                            }
                        } else {
                ...
                if (!found) {
                    if (tagInfo.hasDynamicAttributes()) {
                        jspAttrs[i] = getJspAttribute(null, attrs.getQName(i), attrs.getURI(i), attrs.getLocalName(i), xmlAttributeValue, n, el, true);
                    } else {
        ...
        private static class XmlEscapeNonELVisitor extends ELParser.TextBuilder {
            ...
            public void visit(Text n) throws JasperException {
                output.append(ELParser.escapeLiteralExpression(xmlEscape(n.getText()), isDeferredSyntaxAllowedAsLiteral));
            }
        }
                ...
                while (nodes.hasNext()) {
                    ...
                    if (node instanceof ELNode.Root) {
                        if (((ELNode.Root) node).getType() == '$') {
                            elExpression = true;
                            break;
                        } else if (checkDeferred && !pageInfo.isDeferredSyntaxAllowedAsLiteral() && ((ELNode.Root) node).getType() == '#') {
                            elExpression = true;
                            break;
                        }
                    }
        ...
        private void throwErrorIfExpression(Node n, String attrName, String actionName) throws JasperException {
            if (n.getAttributes() != null && n.getAttributes().getValue(attrName) != null && isExpression(n, n.getAttributes().getValue(attrName), true)) {
            ...
            class MapperELVisitor extends ELNode.Visitor {
                ...
                public void visit(ELNode.Function n) throws JasperException {
                    ...
                    try {
                        ...
                        err.jspError("jsp.error.function.classnotfound", n.getFunctionInfo().getFunctionClass(), n.getPrefix() + ':' + n.getName(), e.getMessage());
                    }
                    ...
                    try {
                        ...
                        err.jspError("jsp.error.signature.classnotfound", paramTypes[i], n.getPrefix() + ':' + n.getName(), e.getMessage());
