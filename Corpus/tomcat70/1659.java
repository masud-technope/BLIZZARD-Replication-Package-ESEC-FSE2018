...
public class MessageDispatch15Interceptor extends MessageDispatchInterceptor {
    ...
    public LinkObject removeFromQueue() {
        //not used, thread pool contains its own queue.
        return null;
    }
    ...
    public void startQueue() {
        ...
        executor = ExecutorFactory.newThreadPool(maxSpareThreads, maxThreads, keepAliveTime, TimeUnit.MILLISECONDS, new TcclThreadFactory("MessageDispatch15Interceptor.MessageDispatchThread" + channelName));
        run = true;
    }
