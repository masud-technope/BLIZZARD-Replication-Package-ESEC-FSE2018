...
public class StandardContext extends ContainerBase implements Context, NotificationEmitter {
    ...
    public void addApplicationEventListener(Object listener) {
        ...
        Object[] newListeners = Arrays.copyOf(applicationEventListenersObjects, len + 1);
    ...
    public void setClearReferencesStatic(boolean clearReferencesStatic) {
        ...
        support.firePropertyChange("clearReferencesStatic", oldClearReferencesStatic, this.clearReferencesStatic);
    }
    ...
    public void setRenewThreadsWhenStoppingContext(boolean renewThreadsWhenStoppingContext) {
        ...
        support.firePropertyChange("renewThreadsWhenStoppingContext", oldRenewThreadsWhenStoppingContext, this.renewThreadsWhenStoppingContext);
    }
    ...
    public void addInstanceListener(String listener) {
        synchronized (instanceListenersLock) {
            ...
            for (int i = 0; i < instanceListeners.length; i++) results[i] = instanceListeners[i];
    ...
    public void addSecurityRole(String role) {
        synchronized (securityRolesLock) {
            ...
            for (int i = 0; i < securityRoles.length; i++) results[i] = securityRoles[i];
    ...
    public void addServletMapping(String pattern, String name, boolean jspWildCard) {
        ...
        mapper.addWrapper(decodedPattern, wrapper, jspWildCard, resourceOnlyServlets.contains(name));
    ...
    public void addWatchedResource(String name) {
        synchronized (watchedResourcesLock) {
            ...
            for (int i = 0; i < watchedResources.length; i++) results[i] = watchedResources[i];
    ...
    public void addWelcomeFile(String name) {
        synchronized (welcomeFilesLock) {
            ...
            for (int i = 0; i < welcomeFiles.length; i++) results[i] = welcomeFiles[i];
    ...
    public void addWrapperLifecycle(String listener) {
        synchronized (wrapperLifecyclesLock) {
            ...
            for (int i = 0; i < wrapperLifecycles.length; i++) results[i] = wrapperLifecycles[i];
    ...
    public void addWrapperListener(String listener) {
        synchronized (wrapperListenersLock) {
            ...
            for (int i = 0; i < wrapperListeners.length; i++) results[i] = wrapperListeners[i];
    ...
    public String[] findApplicationListeners() {
        ArrayList<String> list = new ArrayList<String>(applicationListeners.length);
    ...
    public ErrorPage[] findErrorPages() {
        synchronized (exceptionPages) {
            synchronized (statusPages) {
                ...
                for (int i = 0; i < results1.length; i++) results[i] = results1[i];
                for (int i = results1.length; i < results.length; i++) results[i] = results2[i - results1.length];
                return (results);
            }
        }
    }
    ...
    public int[] findStatusPages() {
        synchronized (statusPages) {
            ...
            int i = 0;
            while (elements.hasNext()) results[i++] = elements.next().intValue();
            return (results);
        }
    }
