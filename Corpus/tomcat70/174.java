...
public class AttributeParser {
    ...
    private static final boolean STRICT_QUOTE_ESCAPING = Boolean.parseBoolean(System.getProperty("org.apache.jasper.compiler.Parser.STRICT_QUOTE_ESCAPING", "true"));
    ...
    public static String getUnquoted(String input, char quote, boolean isELIgnored, boolean isDeferredSyntaxAllowedAsLiteral, boolean quoteAttributeEL) {
        return (new AttributeParser(input, quote, isELIgnored, isDeferredSyntaxAllowedAsLiteral, STRICT_QUOTE_ESCAPING, quoteAttributeEL)).getUnquoted();
    }
     ...
     *                      processor without fear of ambiguity.
     */
    protected static String getUnquoted(String input, char quote, boolean isELIgnored, boolean isDeferredSyntaxAllowedAsLiteral, boolean strict, boolean quoteAttributeEL) {
