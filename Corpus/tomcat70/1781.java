...
public class OutputBuffer extends Writer implements ByteChunk.ByteOutputChannel, CharChunk.CharOutputChannel {
     ...
     * List of encoders.
     */
    protected final ConcurrentHashMap<String, C2BConverter> encoders = new ConcurrentHashMap<String, C2BConverter>();
    ...
    public void close() throws IOException {
        ...
        if ((!coyoteResponse.isCommitted()) && (coyoteResponse.getContentLengthLong() == -1) && !coyoteResponse.getRequest().method().equals("HEAD")) {
