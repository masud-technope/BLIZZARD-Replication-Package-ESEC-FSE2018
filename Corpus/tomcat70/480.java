...
public class PoolProperties implements PoolConfiguration, Cloneable, Serializable {
    ...
    public void setValidatorClassName(String className) {
        ...
        try {
            @SuppressWarnings("unchecked") Class<Validator> validatorClass = (Class<Validator>) Class.forName(className);
            ...
            log.warn("An object of class " + className + " cannot be instantiated. Make sure that " + "it includes an implicit or explicit no-arg constructor.", e);
