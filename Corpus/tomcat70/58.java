...
public final class Mapper {
    ...
    public void addContextVersion(String hostName, Object host, String path, String version, Object context, String[] welcomeResources, javax.naming.Context resources, Collection<WrapperMappingInfo> wrappers) {
        addContextVersion(hostName, host, path, version, context, welcomeResources, resources, wrappers, false, false);
    }
     ...
     */
    public void addContextVersion(String hostName, Object host, String path, String version, Object context, String[] welcomeResources, javax.naming.Context resources, Collection<WrapperMappingInfo> wrappers, boolean mapperContextRootRedirectEnabled, boolean mapperDirectoryRedirectEnabled) {
    ...
    protected void addWrapper(ContextVersion context, String path, Object wrapper, boolean jspWildCard, boolean resourceOnly) {
        synchronized (context) {
            if (path.endsWith("/*")) {
                ...
                // Default wrapper
                Wrapper newWrapper = new Wrapper("", wrapper, jspWildCard, resourceOnly);
    ...
    private final void internalMapWrapper(ContextVersion contextVersion, CharChunk path, MappingData mappingData) throws Exception {
        ...
        if (mappingData.wrapper == null && noServletPath && contextVersion.mapperContextRootRedirectEnabled) {
        ...
        if (mappingData.wrapper == null && !checkJspWelcomeFiles) {
            ...
            if (contextVersion.resources != null && buf[pathEnd - 1] != '/') {
                ...
                if (file != null && file instanceof DirContext && contextVersion.mapperDirectoryRedirectEnabled) {
    ...
    protected static class Wrapper extends MapElement {
        ...
        public  Wrapper(String name, /* Wrapper */
