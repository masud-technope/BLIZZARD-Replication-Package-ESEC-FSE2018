...
public class TestWsWebSocketContainer extends WebSocketBaseTest {
    ...
    public static class ConstantTxEndpoint extends Endpoint {
        ...
        public void onOpen(Session session, EndpointConfig config) {
            ...
            // completes faster
            session.getUserProperties().put(WsRemoteEndpointImplBase.BLOCKING_SEND_TIMEOUT_PROPERTY, Long.valueOf(5000));
    ...
    private Session connectToEchoServer(WebSocketContainer wsContainer, Endpoint endpoint, String path) throws Exception {
        return wsContainer.connectToServer(endpoint, ClientEndpointConfig.Builder.create().build(), new URI("ws://" + getHostName() + ":" + getPort() + path));
    }
