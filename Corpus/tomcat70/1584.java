...
public class Benchmarks {
    ...
    private static class TimeDateElementBenchmarkTest_Sync extends TimeDateElementBenchmarkTestBase implements Runnable {
            ...
            if (currentDate != date) {
                synchronized (this) {
                    if (currentDate != date) {
                        ...
                        current.append('[');
                        // Day
                        current.append(dayFormatter.format(date));
                        current.append('/');
                        // Month
                        current.append(lookup(monthFormatter.format(date)));
                        current.append('/');
                        // Year
                        current.append(yearFormatter.format(date));
                        current.append(':');
                        // Time
                        current.append(timeFormatter.format(date));
                        current.append(']');
    ...
    private static class TimeDateElementBenchmarkTest_Local extends TimeDateElementBenchmarkTestBase implements Runnable {
        ...
        public String printDate() {
            ...
            if (currentDateStringLocal.get() == null) {
                StringBuilder current = new StringBuilder(32);
                current.append('[');
                current.append(dayFormatterLocal.get().format(// Day
                currentDateLocal.get()));
                current.append('/');
                current.append(lookup(monthFormatterLocal.get().format(// Month
                currentDateLocal.get())));
                current.append('/');
                current.append(yearFormatterLocal.get().format(// Year
                currentDateLocal.get()));
                current.append(':');
                current.append(timeFormatterLocal.get().format(// Time
                currentDateLocal.get()));
                current.append(']');
    ...
    private static class TimeDateElementBenchmarkTest_LocalStruct extends TimeDateElementBenchmarkTestBase implements Runnable {
        ...
        public String printDate() {
            ...
            if (struct.currentDateString == null) {
                ...
                current.append('/');
                current.append(lookup(struct.monthFormatter.format(// Month
                struct.currentDate)));
                current.append('/');
                // Year
    ...
    private static class TimeDateElementBenchmarkTest_LocalStruct_SBuilder extends TimeDateElementBenchmarkTestBase implements Runnable {
