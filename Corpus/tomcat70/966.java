...
public abstract class StoreBase extends LifecycleBase implements Store {
    ...
    protected ObjectInputStream getObjectInputStream(InputStream is) throws IOException {
        ...
        if (manager instanceof ManagerBase) {
            ...
            ois = new CustomObjectInputStream(bis, classLoader, manager.getContainer().getLogger(), managerBase.getSessionAttributeValueClassNamePattern(), managerBase.getWarnOnSessionAttributeFilterFailure());
        } else {
