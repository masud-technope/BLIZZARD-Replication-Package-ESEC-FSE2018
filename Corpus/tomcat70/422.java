...
public class TestDirContextURLStreamHandlerFactory {
    ...
    public void testUserSuppliedFactory() throws Exception {
        ...
        DirContextURLStreamHandlerFactory.addUserFactory(new FooURLStreamHandlerFactory());
        // Now it works
        try {
            url = new URL("foo://www.apache.org");
        } catch (MalformedURLException ignore) {
    ...
    public static class FooURLStreamHandlerFactory implements URLStreamHandlerFactory {
