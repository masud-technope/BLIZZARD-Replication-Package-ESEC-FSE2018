...
public class TestEncodingDecoding extends TomcatBaseTest {
    ...
    @ClientEndpoint(decoders = { MsgStringDecoder.class, MsgByteDecoder.class }, encoders = { MsgStringEncoder.class, MsgByteEncoder.class })
    ...
    @ServerEndpoint(value = PATH_ANNOTATED_EP, decoders = { MsgStringDecoder.class, MsgByteDecoder.class }, encoders = { MsgStringEncoder.class, MsgByteEncoder.class }, configurator = SingletonConfigurator.class)
    ...
    public static class ProgramaticServerEndpointConfig extends WsContextListener {
        ...
        public void contextInitialized(ServletContextEvent sce) {
            ...
            ServerContainer sc = (ServerContainer) sce.getServletContext().getAttribute(org.apache.tomcat.websocket.server.Constants.SERVER_CONTAINER_SERVLET_CONTEXT_ATTRIBUTE);
            try {
