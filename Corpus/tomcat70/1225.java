...
public class TestUtil {
    ...
    private abstract static class GenericMultipleSubSwapMessageHandler<Y, X> extends GenericMultipleMessageHandler<X, Y> {
    }

    private static class GenericMultipleSubSubSwapMessageHandler extends GenericMultipleSubSwapMessageHandler<Boolean, String> {
