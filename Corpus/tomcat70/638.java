...
class JspDocumentParser extends DefaultHandler2 implements TagConstants {
    ...
    private void addInclude(Node parent, List<String> files) throws SAXException {
        if (files != null) {
            ...
            while (iter.hasNext()) {
                ...
                Node includeDir = new // XXX
                Node.IncludeDirective(// XXX
                attrs, // XXX
                null, parent);
    ...
    public void startElement(String uri, String localName, String qName, Attributes attrs) throws SAXException {
        ...
        if (tagDependentPending && JSP_URI.equals(uri) && localName.equals(BODY_ACTION)) {
            ...
            tagDependentNesting++;
            current = parseStandardAction(qName, localName, nonTaglibAttrs, nonTaglibXmlnsAttrs, taglibAttrs, startMark);
            return;
        }
                ...
                if (children != null && children.size() > 0) {
                    for (int i = 0; i < children.size(); i++) {
                        ...
                        if (!(child instanceof Node.NamedAttribute)) {
                            throw new SAXParseException(Localizer.getMessage("jasper.error.emptybodycontent.nonempty", current.qName), locator);
                        }
                    }
                }
            }
    ...
    private static SAXParser getSAXParser(boolean validating, JspDocumentParser jspDocParser) throws Exception {
        ...
        try {
            ...
            factory.setFeature(//xml.org/sax/features/namespace-prefixes",
