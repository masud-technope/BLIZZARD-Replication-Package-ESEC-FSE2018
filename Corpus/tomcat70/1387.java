...
public class FarmWarDeployer extends ClusterListener implements ClusterDeployer, FileChangeListener {
    ...
    public void cleanDeployDir() {
        throw new java.lang.UnsupportedOperationException(sm.getString("farmWarDeployer.notImplemented", "cleanDeployDir()"));
    }
     ...
     */
    public synchronized FileMessageFactory getFactory(FileMessage msg) throws java.io.FileNotFoundException, java.io.IOException {
