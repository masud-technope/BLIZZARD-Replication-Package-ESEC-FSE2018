...
final class DefaultClientEndpointConfig implements ClientEndpointConfig {
    ...
    private final Configurator configurator;
     ...
     DefaultClientEndpointConfig(List<String> preferredSubprotocols, List<Extension> extensions, List<Class<? extends Encoder>> encoders, List<Class<? extends Decoder>> decoders, Configurator configurator) {
