...
class Generator {
    ...
    private void genPreambleClassVariableDeclarations() {
        if (isPoolingEnabled && !tagHandlerPoolNames.isEmpty()) {
            for (int i = 0; i < tagHandlerPoolNames.size(); i++) {
                out.printil("private org.apache.jasper.runtime.TagHandlerPool " + tagHandlerPoolNames.elementAt(i) + ";");
            }
            out.println();
        }
    ...
    class GenerateVisitor extends Node.Visitor {
         ...
         */
        private String attributeValue(Node.JspAttribute attr, boolean encode, Class<?> expectedType, boolean isXml) {
            ...
            if (attr.isExpression()) {
                ...
                v = elInterpreter.interpreterCall(ctxt, this.isTagFile, v, expectedType, attr.getEL().getMapName(), isXml);
                if (encode) {
        ...
        private void printParams(Node n, String pageParam, boolean literal) throws JasperException {
            class ParamVisitor extends Node.Visitor {
                ...
                public void visit(Node.ParamAction n) throws JasperException {
                    ...
                    out.print("+ \"=\" + ");
                    out.print(attributeValue(n.getValue(), true, String.class, n.getRoot().isXmlSyntax()));
        ...
        public void visit(Node.ELExpression n) throws JasperException {
            ...
            if (!pageInfo.isELIgnored() && (n.getEL() != null)) {
                out.printil("out.write(" + elInterpreter.interpreterCall(ctxt, this.isTagFile, n.getType() + "{" + n.getText() + "}", String.class, n.getEL().getMapName(), false) + ");");
            } else {
        ...
        public void visit(Node.IncludeAction n) throws JasperException {
            ...
            if (page.isNamedAttribute()) {
                ...
                pageParam = attributeValue(page, false, String.class, n.getRoot().isXmlSyntax());
            }
        ...
        public void visit(Node.ForwardAction n) throws JasperException {
            Node.JspAttribute page = n.getPage();
            n.setBeginJavaLine(out.getJavaLine());
            // So that javac won't complain about
            out.printil("if (true) {");
            // codes after "return"
            out.pushIndent();
            String pageParam;
        ...
        public void visit(Node.GetProperty n) throws JasperException {
            ...
            if (beanInfo.checkVariable(name)) {
                ...
                out.printil("out.write(org.apache.jasper.runtime.JspRuntimeLibrary.toString(" + "(((" + beanName + ")_jspx_page_context.findAttribute(" + "\"" + name + "\"))." + methodName + "())));");
            } else if (!STRICT_GET_PROPERTY || varInfoNames.contains(name)) {
                // The object is a custom action with an associated
                // VariableInfo entry for this name.
                // Get the class name and then introspect at runtime.
                out.printil("out.write(org.apache.jasper.runtime.JspRuntimeLibrary.toString" + "(org.apache.jasper.runtime.JspRuntimeLibrary.handleGetProperty" + "(_jspx_page_context.findAttribute(\"" + name + "\"), \"" + property + "\")));");
            } else {
        ...
        public void visit(Node.SetProperty n) throws JasperException {
            ...
            n.setBeginJavaLine(out.getJavaLine());
            if ("*".equals(property)) {
                out.printil("org.apache.jasper.runtime.JspRuntimeLibrary.introspect(" + "_jspx_page_context.findAttribute(" + "\"" + name + "\"), request);");
            } else if (value == null) {
                if (param == null)
                    // default to same as property
                    param = property;
                out.printil("org.apache.jasper.runtime.JspRuntimeLibrary.introspecthelper(" + "_jspx_page_context.findAttribute(\"" + name + "\"), \"" + property + "\", request.getParameter(\"" + param + "\"), " + "request, \"" + param + "\", false);");
            } else if (value.isExpression()) {
                out.printil("org.apache.jasper.runtime.JspRuntimeLibrary.handleSetProperty(" + "_jspx_page_context.findAttribute(\"" + name + "\"), \"" + property + "\",");
                out.print(attributeValue(value, false, null, n.getRoot().isXmlSyntax()));
                out.println(");");
                ...
                out.printil("org.apache.jasper.runtime.JspRuntimeLibrary.handleSetPropertyExpression(" + "_jspx_page_context.findAttribute(\"" + name + "\"), \"" + property + "\", " + quote(value.getValue()) + ", " + "_jspx_page_context, " + value.getEL().getMapName() + ");");
                ...
                out.printil("org.apache.jasper.runtime.JspRuntimeLibrary.introspecthelper(" + "_jspx_page_context.findAttribute(\"" + name + "\"), \"" + property + "\", " + valueVarName + ", null, null, false);");
            } else {
                out.printin("org.apache.jasper.runtime.JspRuntimeLibrary.introspecthelper(" + "_jspx_page_context.findAttribute(\"" + name + "\"), \"" + property + "\", ");
                out.print(attributeValue(value, false, null, n.getRoot().isXmlSyntax()));
                ...
                if (!generateNew) {
                    ...
                    if (beanName != null) {
                        if (beanName.isNamedAttribute()) {
                            ...
                            binaryName = attributeValue(beanName, false, String.class, n.getRoot().isXmlSyntax());
                        }
                    } else {
        ...
        public void visit(Node.PlugIn n) throws JasperException {
            ...
            class ParamVisitor extends Node.Visitor {
                ...
                public void visit(Node.ParamAction n) throws JasperException {
                    ...
                    if (ie) {
                        ...
                        // value=\"" + ... + "\">" );
                        out.printil("out.write( \"<param name=\\\"" + escape(name) + "\\\" value=\\\"\" + " + attributeValue(n.getValue(), false, String.class, n.getRoot().isXmlSyntax()) + " + \"\\\">\" );");
                        out.printil("out.write(\"\\n\");");
                    } else {
                        // We want something of the form
                        // out.print( " blah=\"" + ... + "\"" );
                        out.printil("out.write( \" " + escape(name) + "=\\\"\" + " + attributeValue(n.getValue(), false, String.class, n.getRoot().isXmlSyntax()) + " + \"\\\"\" );");
                    }
                    n.setEndJavaLine(out.getJavaLine());
                }
            }
            ...
            if (width != null) {
                if (width.isNamedAttribute()) {
                    ...
                    widthStr = attributeValue(width, false, String.class, n.getRoot().isXmlSyntax());
                }
            }
            ...
            if (height != null) {
                if (height.isNamedAttribute()) {
                    ...
                    heightStr = attributeValue(height, false, String.class, n.getRoot().isXmlSyntax());
                }
            }
            if (iepluginurl == null)
            ...
            if (attrs != null) {
                ...
                for (int i = 0; i < attrs.getLength(); i++) {
                    ...
                    if (jspAttrs[i].isELInterpreterInput()) {
                        out.print("\\\"\" + ");
                        String debug = attributeValue(jspAttrs[i], false, String.class, n.getRoot().isXmlSyntax());
                        out.print(debug);
                        out.print(" + \"\\\"");
                    } else {
                        out.print(DOUBLE_QUOTE);
        ...
        public void visit(Node.JspElement n) throws JasperException {
            ...
            for (int i = 0; attrs != null && i < attrs.length; i++) {
                ...
                if (attrs[i].isNamedAttribute()) {
                    ...
                    if (omitAttr == null) {
                        ...
                        omit = attributeValue(omitAttr, false, boolean.class, n.getRoot().isXmlSyntax());
                        if ("true".equals(omit)) {
                            continue;
                        }
                    }
                    ...
                    value = attributeValue(attrs[i], false, Object.class, n.getRoot().isXmlSyntax());
                    nvp = " + \" " + attrs[i].getName() + "=\\\"\" + " + value + " + \"\\\"\"";
                }
            ...
            // element name
            String elemName = attributeValue(n.getNameAttribute(), false, String.class, n.getRoot().isXmlSyntax());
            out.printin("out.write(\"<\"");
            out.print(" + " + elemName);
        ...
        private String evaluateAttribute(TagHandlerInfo handlerInfo, Node.JspAttribute attr, Node.CustomTag n, String tagHandlerVar) throws JasperException {
            ...
            // Do nothing
                ...
                if (attr.isDeferredInput() || ((tai != null) && ValueExpression.class.getName().equals(tai.getTypeName()))) {
                    ...
                    attrValue = elInterpreter.interpreterCall(ctxt, this.isTagFile, attrValue, c[0], mapName, false);
                }
            } else {
            ...
            if (body != null) {
                ...
                if (body.size() == 1) {
                    ...
                    if (bodyElement instanceof Node.TemplateText) {
                        ...
                        out.printil("java.lang.String " + varName + " = " + quote(((Node.TemplateText) bodyElement).getText()) + ";");
                    }
                }
                if (!templateTextOptimization) {
                    out.printil("out = _jspx_page_context.pushBody();");
                    visitBody(n);
                    out.printil("java.lang.String " + varName + " = " + "((javax.servlet.jsp.tagext.BodyContent)" + "out).getString();");
                    out.printil("out = _jspx_page_context.popBody();");
                }
            } else {
