...
public class EnumIncrementalBuildTests extends IncrementalBuildTests {
    ...
    public void testIncremantalEnum() throws Exception {
        int[] problemids = new int[] { ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_COMPATIBILITY, IDelta.ENUM_ELEMENT_TYPE, IDelta.REMOVED, IDelta.ENUM_CONSTANT), ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_USAGE, IElementDescriptor.TYPE, IApiProblem.ILLEGAL_INSTANTIATE, IApiProblem.NO_FLAGS), ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_USAGE, IElementDescriptor.METHOD, IApiProblem.API_LEAK, IApiProblem.LEAK_RETURN_TYPE), ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_USAGE, IElementDescriptor.TYPE, IApiProblem.UNSUPPORTED_TAG_USE, IApiProblem.NO_FLAGS) };
        deployIncrementalPerformanceTest(//$NON-NLS-1$
        "Incremetal Build (Enum) - All", //$NON-NLS-1$
        "test7", JAVA_5_PERF, "api.TestEnum", problemids, 500);
    }
    ...
    public void _testIncrementalEnumCompat() throws Exception {
        ...
        deployIncrementalPerformanceTest(//$NON-NLS-1$
        "Incremental Build (Enum) - Compatibility", //$NON-NLS-1$
        "test8", JAVA_5_PERF, "api.TestEnum", problemids, 500);
    }
    ...
    public void _testIncremetalEnumLeak() throws Exception {
        ...
        deployIncrementalPerformanceTest(//$NON-NLS-1$
        "Incremtal Build (Enum) - API Leak", //$NON-NLS-1$
        "test9", JAVA_5_PERF, "api.TestEnum", problemids, 500);
    }
    ...
    public void _testIncrementalEnumUsage() throws Exception {
        ...
        deployIncrementalPerformanceTest(//$NON-NLS-1$
        "Incremtal Build (Enum) - API Usage", //$NON-NLS-1$
        "test10", JAVA_5_PERF, "api.TestEnum", problemids, 500);
    }
    ...
    public void _testIncrementalEnumTags() throws Exception {
        int[] problemids = new int[] { ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_USAGE, IElementDescriptor.TYPE, IApiProblem.UNSUPPORTED_TAG_USE, IApiProblem.NO_FLAGS), ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_USAGE, IElementDescriptor.FIELD, IApiProblem.UNSUPPORTED_TAG_USE, IApiProblem.NO_FLAGS) };
        deployIncrementalPerformanceTest(//$NON-NLS-1$
        "Incremtal Build (Enum) - Unsupported Tags", //$NON-NLS-1$
        "test11", JAVA_5_PERF, "api.TestEnum", problemids, 500);
    }
}
