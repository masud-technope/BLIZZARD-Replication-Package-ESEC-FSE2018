...
public abstract class CompatibilityTest extends ApiBuilderTest {
    ...
    private static Class<?>[] getAllTestClasses() {
        Class<?>[] classes = new Class[] { ProjectTypeContainerTests.class, BundleCompatibilityTests.class, AnnotationCompatibilityTests.class, InterfaceCompatibilityTests.class, EnumCompatibilityTests.class, ClassCompatibilityTests.class, FieldCompatibilityTests.class, MethodCompatibilityTests.class, ConstructorCompatibilityTests.class, SinceTagTest.class, VersionTest.class, BundleMergeSplitTests.class, BundleVersionTests.class };
        return classes;
    }
    ...
    protected void setUp() throws Exception {
        ...
        if (baseline == null) {
            ...
            for (int i = 0; i < projects.length; i++) {
                ...
                "The project was not found in the workspace baseline: " + projects[i].getName(), //$NON-NLS-1$
                component);
