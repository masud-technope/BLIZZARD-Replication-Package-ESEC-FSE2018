...
public class PluginSection extends TableSection implements IPluginModelListener {
            ...
            fIncludeOptionalButton.addSelectionListener(new SelectionAdapter() {
                ...
                public void widgetSelected(SelectionEvent e) {
                    ...
                    if (input instanceof IFileEditorInput) {
                        IFile file = ((IFileEditorInput) input).getFile();
                        try {
                            file.setPersistentProperty(OPTIONAL_PROPERTY, //$NON-NLS-1$
                            fIncludeOptionalButton.getSelection() ? //$NON-NLS-1$
                            "true" : //$NON-NLS-1$
                            null);
    ...
    protected void doPaste(Object target, Object[] objects) {
        ...
        if (objects instanceof IProductPlugin[])
            ...
            for (int i = 0; i < objects.length; i++) if (objects[i] instanceof IProductPlugin)
