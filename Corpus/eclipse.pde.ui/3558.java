...
public class FieldCompatibilityModifierTests extends FieldCompatibilityTests {
    ...
    protected int getChangedProblemId(int flags) {
        return ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_COMPATIBILITY, IDelta.FIELD_ELEMENT_TYPE, IDelta.CHANGED, flags);
    }
    ...
    private void xRemoveFinalOnConstant(boolean incremental) throws Exception {
        ...
        int[] ids = new int[] { getChangedProblemId(IDelta.FINAL_TO_NON_FINAL_STATIC_CONSTANT) };
        setExpectedProblemIds(ids);
        String[][] args = new String[1][];
        //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void xAddStatic(boolean incremental) throws Exception {
        ...
        int[] ids = new int[] { getChangedProblemId(IDelta.NON_STATIC_TO_STATIC) };
        setExpectedProblemIds(ids);
        String[][] args = new String[1][];
        //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void xRemoveStatic(boolean incremental) throws Exception {
        ...
        int[] ids = new int[] { getChangedProblemId(IDelta.STATIC_TO_NON_STATIC) };
        setExpectedProblemIds(ids);
        String[][] args = new String[1][];
        //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void xModifyValue(boolean incremental) throws Exception {
        ...
        int[] ids = new int[] { getChangedProblemId(IDelta.VALUE) };
        setExpectedProblemIds(ids);
        String[][] args = new String[1][];
    ...
    private void xChangeType(boolean incremental) throws Exception {
        ...
        int[] ids = new int[] { getChangedProblemId(IDelta.TYPE) };
        setExpectedProblemIds(ids);
        String[][] args = new String[1][];
        //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void xRemoveTypeArguments(boolean incremental) throws Exception {
        ...
        int[] ids = new int[] { ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_COMPATIBILITY, IDelta.FIELD_ELEMENT_TYPE, IDelta.REMOVED, IDelta.TYPE_ARGUMENT) };
        setExpectedProblemIds(ids);
        String[][] args = new String[1][];
        //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void xAddNoReference(boolean incremental) throws Exception {
        ...
        int[] ids = new int[] { ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_COMPATIBILITY, IDelta.FIELD_ELEMENT_TYPE, IDelta.REMOVED, IDelta.API_FIELD) };
        setExpectedProblemIds(ids);
        String[][] args = new String[1][];
        //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void xPublicToPackage2(boolean incremental) throws Exception {
        //$NON-NLS-1$
        IPath filePath = WORKSPACE_CLASSES_PACKAGE_A.append("PublicToPackage2.java");
        int[] ids = new int[] { getChangedProblemId(IDelta.DECREASE_ACCESS) };
        setExpectedProblemIds(ids);
        String[][] args = new String[1][];
        //$NON-NLS-1$ //$NON-NLS-2$
        args[0] = new String[] { PACKAGE_PREFIX + "PublicToPackage2", "FIELD" };
        setExpectedMessageArgs(args);
        performCompatibilityTest(filePath, incremental);
    }
    ...
    private void xPublicToPrivate2(boolean incremental) throws Exception {
        //$NON-NLS-1$
        IPath filePath = WORKSPACE_CLASSES_PACKAGE_A.append("PublicToPrivate2.java");
        int[] ids = new int[] { getChangedProblemId(IDelta.DECREASE_ACCESS) };
        setExpectedProblemIds(ids);
        String[][] args = new String[1][];
        //$NON-NLS-1$ //$NON-NLS-2$
        args[0] = new String[] { PACKAGE_PREFIX + "PublicToPrivate2", "FIELD" };
        setExpectedMessageArgs(args);
        performCompatibilityTest(filePath, incremental);
    }
    ...
    private void xPublicToProtected2(boolean incremental) throws Exception {
        //$NON-NLS-1$
        IPath filePath = WORKSPACE_CLASSES_PACKAGE_A.append("PublicToProtected2.java");
        int[] ids = new int[] { getChangedProblemId(IDelta.DECREASE_ACCESS) };
        setExpectedProblemIds(ids);
        String[][] args = new String[1][];
        //$NON-NLS-1$ //$NON-NLS-2$
        args[0] = new String[] { PACKAGE_PREFIX + "PublicToProtected2", "FIELD" };
        setExpectedMessageArgs(args);
        performCompatibilityTest(filePath, incremental);
    }
