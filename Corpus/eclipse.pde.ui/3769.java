    ...
    static class ArchiveApiTypeRoot extends AbstractApiTypeRoot implements Comparable<Object> {
        ...
        public byte[] getContents() throws CoreException {
            ...
            try {
                ...
                abort("Failed to open archive: " + archive.fLocation, e);
                return null;
            }
            try {
                ...
                if (entry != null) {
                    try {
                        ...
                        abort("Failed to open class file: " + getTypeName() + " in archive: " + archive.fLocation, e);
                        return null;
                    }
                    try {
            ...
            //$NON-NLS-1$ //$NON-NLS-2$
            abort("Class file not found: " + getTypeName() + " in archive: " + archive.fLocation, null);
            return null;
        }
