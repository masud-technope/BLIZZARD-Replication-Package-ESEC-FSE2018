...
public class DSReference extends DSObject implements IDSReference {
    ...
    public  DSReference(DSModel model) {
        ...
        // set default values
        this.setReferenceCardinality(IDSConstants.VALUE_REFERENCE_CARDINALITY_ONE_ONE);
        ...
        this.setReferenceName(IDSConstants.ELEMENT_REFERENCE + ref_count);
        this.setReferenceInterface(IDSConstants.ATTRIBUTE_REFERENCE_INTERFACE + ref_count);
    }
    ...
    public String[] getAttributesNames() {
        return new String[] { IDSConstants.ATTRIBUTE_REFERENCE_BIND, IDSConstants.ATTRIBUTE_REFERENCE_CARDINALITY, IDSConstants.ATTRIBUTE_REFERENCE_INTERFACE, IDSConstants.ATTRIBUTE_REFERENCE_NAME, IDSConstants.ATTRIBUTE_REFERENCE_POLICY, IDSConstants.ATTRIBUTE_REFERENCE_TARGET, IDSConstants.ATTRIBUTE_REFERENCE_UNBIND };
    }
