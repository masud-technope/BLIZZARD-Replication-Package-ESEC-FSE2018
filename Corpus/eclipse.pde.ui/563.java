...
public class AddBundleContainerSelectionPage extends WizardSelectionPage {
    ...
    private void initViewerContents(TableViewer wizardSelectionViewer) {
        ...
        choices.addAll(getTargetLocationProvisionerChoices());
        // Deprecated extension point contributions
        choices.addAll(getTargetProvisionerChoices());
            ...
            public IWizard createWizard() {
                Wizard wizard = new Wizard() {
                    ...
                    public void addPages() {
                        ...
                        for (int i = 0; i < pages.length; i++) addPage(pages[i]);
                    }
