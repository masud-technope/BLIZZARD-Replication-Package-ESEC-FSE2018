    ...
    private void updateContent() {
        ...
        if (selection != null) {
            ...
            if (desc.length == 1)
                ...
                NLS.bind(PDEUIMessages.ReviewPage_descContent, (new String[] { selection.getAttribute("name"), desc[0].getValue() })));
            else
                //$NON-NLS-1$
                buf.append(//$NON-NLS-1$
                NLS.bind(PDEUIMessages.ReviewPage_content, selection.getAttribute("name")));
        } else {
