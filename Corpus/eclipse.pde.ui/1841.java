...
public class RegistryBrowser extends ViewPart {
    ...
    private void makeActions() {
        ...
        //$NON-NLS-1$
        fShowPluginsAction.setChecked(fMemento.getString(SHOW_RUNNING_PLUGINS).equals("true"));
        ...
        //$NON-NLS-1$
        fShowDisabledAction.setChecked(fMemento.getString(SHOW_DISABLED_MODE).equals("true"));
        ...
        //$NON-NLS-1$
        fShowAdvancedOperationsAction.setChecked(fMemento.getString(SHOW_ADVANCED_MODE).equals("true"));
        ...
        fCollapseAllAction = new //$NON-NLS-1$
        Action(//$NON-NLS-1$
        "collapseAll") {
    ...
    public String getTitleSummary() {
        ...
        if (tree == null)
            //$NON-NLS-1$ //$NON-NLS-2$
            return NLS.bind(PDERuntimeMessages.RegistryView_titleSummary, (new String[] { "0", "0", type }));
