...
public class ConstructorCompatibilityTests extends CompatibilityTest {
    ...
    protected int getChangedProblemId(int flags) {
        return ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_COMPATIBILITY, IDelta.CONSTRUCTOR_ELEMENT_TYPE, IDelta.CHANGED, flags);
    }
    ...
    private void xAddTypeParameter(boolean incremental) throws Exception {
        ...
        int[] ids = new int[] { ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_COMPATIBILITY, IDelta.CONSTRUCTOR_ELEMENT_TYPE, IDelta.ADDED, IDelta.TYPE_PARAMETER) };
        setExpectedProblemIds(ids);
        String[][] args = new String[1][];
        //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void xRemoveTypeParameter(boolean incremental) throws Exception {
        ...
        int[] ids = new int[] { ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_COMPATIBILITY, IDelta.CONSTRUCTOR_ELEMENT_TYPE, IDelta.REMOVED, IDelta.TYPE_PARAMETER) };
        setExpectedProblemIds(ids);
        String[][] args = new String[1][];
        //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void xVarArgsToArray(boolean incremental) throws Exception {
        ...
        int[] ids = new int[] { ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_COMPATIBILITY, IDelta.CONSTRUCTOR_ELEMENT_TYPE, IDelta.CHANGED, IDelta.VARARGS_TO_ARRAY) };
        setExpectedProblemIds(ids);
        String[][] args = new String[1][];
        //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void xPublicToProtected2(boolean incremental) throws Exception {
        ...
        String[][] args = new String[1][];
        //$NON-NLS-1$ //$NON-NLS-2$
        args[0] = new String[] { PACKAGE_PREFIX + "PublicToProtected2", "PublicToProtected2()" };
        setExpectedMessageArgs(args);
        performCompatibilityTest(filePath, incremental);
    }
    ...
    private void xPublicToPackage2(boolean incremental) throws Exception {
        ...
        String[][] args = new String[1][];
        //$NON-NLS-1$ //$NON-NLS-2$
        args[0] = new String[] { PACKAGE_PREFIX + "PublicToPackage2", "PublicToPackage2()" };
        setExpectedMessageArgs(args);
        performCompatibilityTest(filePath, incremental);
    }
    ...
    private void xPublicToPrivate2(boolean incremental) throws Exception {
        ...
        String[][] args = new String[1][];
        //$NON-NLS-1$ //$NON-NLS-2$
        args[0] = new String[] { PACKAGE_PREFIX + "PublicToPrivate2", "PublicToPrivate2()" };
        setExpectedMessageArgs(args);
        performCompatibilityTest(filePath, incremental);
    }
