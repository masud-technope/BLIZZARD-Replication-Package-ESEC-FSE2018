...
public interface IHelpContextIds {
    ...
    //$NON-NLS-1$
    public static final String TEMPLATE_E4_APPLICATION = PREFIX + "e4Application";

    //$NON-NLS-1$
    public static final String TEMPLATE_E4_VIEW = PREFIX + "e4View";

    //$NON-NLS-1$
    public static final String TEMPLATE_E4_HANDLER = PREFIX + "e4Handler";
    ...
    //$NON-NLS-1$
    public static final String TEMPLATE_SPLASH_HANDLERS = PREFIX + "splash_handlers";
}
