...
public class SearchEngineTests extends SearchTest {
    ...
    public void testSearchNoSeparateScope() {
        ...
        try {
            ...
            TEST_REPORTER.setExpectedReferences(new String[] { P2_NAME, P3_NAME }, new int[][] { { IReference.REF_FIELDDECL, IReference.REF_FIELDDECL }, { IReference.REF_FIELDDECL, IReference.REF_FIELDDECL, IReference.REF_FIELDDECL } });
    ...
    public void testSearchExcludeOne() {
        ...
        try {
            ...
            TEST_REPORTER.setExpectedReferences(new String[] { P2_NAME }, new int[][] { { IReference.REF_FIELDDECL, IReference.REF_FIELDDECL } });
    ...
    public void testExcludeRegexOne() {
        ...
        try {
            ...
            TEST_REPORTER.setExpectedReferences(new String[] { P3_NAME }, new int[][] { { IReference.REF_FIELDDECL, IReference.REF_FIELDDECL } });
    ...
    public void testSearchApiOnly() {
        ...
        try {
            ...
            TEST_REPORTER.setExpectedReferences(new String[] { P2_NAME, P3_NAME }, new int[][] { { IReference.REF_FIELDDECL }, { IReference.REF_FIELDDECL, IReference.REF_FIELDDECL } });
            TEST_REPORTER.setExpectedNotSearched(null);
            engine.search(getTestBaseline(), TEST_REQUESTOR, TEST_REPORTER, null);
        } catch (Exception e) {
            fail("The search engine should not throw an exception: " + e.getMessage());
    ...
    public void testSearchInternalOnly() {
        ...
        try {
            ...
            TEST_REPORTER.setExpectedReferences(new String[] { P2_NAME, P3_NAME }, new int[][] { { IReference.REF_FIELDDECL }, { IReference.REF_FIELDDECL } });
            TEST_REPORTER.setExpectedNotSearched(null);
            engine.search(getTestBaseline(), TEST_REQUESTOR, TEST_REPORTER, null);
        } catch (Exception e) {
            fail("The search engine should not throw an exception: " + e.getMessage());
