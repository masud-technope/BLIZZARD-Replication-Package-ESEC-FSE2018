...
public class PDEMarkerFactory {
    ...
    // deprecation
    public static final int M_DEPRECATED_IMPORT_SERVICE = 0x1015;

    // deprecation
    public static final int M_DEPRECATED_EXPORT_SERVICE = 0x1016;

    // other problem
    public static final int M_UNECESSARY_DEP = 0x1017;

    // other problem
    public static final int M_MISSING_EXPORT_PKGS = 0x1018;

    // deprecation
    public static final int M_DEPRECATED_PROVIDE_PACKAGE = 0x1019;

    // other problem
    public static final int M_EXECUTION_ENVIRONMENT_NOT_SET = 0x1020;

    // fatal problem
    public static final int M_MISSING_BUNDLE_CLASSPATH_ENTRY = 0x1021;

    //other problem
    public static final int M_LAZYLOADING_HAS_NO_EFFECT = 0x1022;

    //other problem
    public static final int M_DISCOURAGED_CLASS = 0x1023;

    // fatal problem
    public static final int M_NO_LINE_TERMINATION = 0x1024;

    // other problem
    public static final int M_R4_SYNTAX_IN_R3_BUNDLE = 0x1025;

    // other problem
    public static final int M_SERVICECOMPONENT_MISSING_LAZY = 0x1026;
