...
public interface IApiProblem {
    ...
    /**
	 * Constant representing the offset of the flags portion of a problem id bit
	 * mask.
	 */
    public static final int OFFSET_FLAGS = 12;

    /**
	 * Constant representing the offset of the kinds portion of a problem id bit
	 * mask.
	 */
    public static final int OFFSET_KINDS = 20;

    /**
	 * Constant representing the offset of the element kinds portion of a
	 * problem id bit mask.
	 */
    public static final int OFFSET_ELEMENT = 24;

    /**
	 * Constant representing the value of having no flags. Value is:
	 * <code>0</code>
	 */
    public static final int NO_FLAGS = 0x0;

    /**
	 * Constant representing the value of no char start / char end. Value is:
	 * <code>-1</code>
	 */
    ...
    /**
	 * Returns the category for this problem. Guaranteed to be one of:
	 * <ul>
	 ...
	 * <li>	<code>IMarker#SEVERITY</code> -&gt; {@link IApiProblem#getSeverity()}
	 * </li>
	 * <li>	<code>IApiMarkerConstants#API_MARKER_ATTR_ID : String</code> -&gt;
	 * {@link IApiProblem#getId()}</li>
	 * <li>	<code>IMarker#CHAR_START</code> -&gt;
	 * {@link IApiProblem#getCharStart()}</li>
	 * <li>	<code>IMarker#CHAR_END</code> -&gt; {@link IApiProblem#getCharEnd()}</li>
	 * <li>	<code>IMarker#LINE_NUMBER</code> -&gt;
	 * {@link IApiProblem#getLineNumber()}</li>
	 * </ul>
	 * The names must be eligible for marker creation, as defined by
	 * <code>IMarker#setAttributes(String[], Object[])</code>, and there must be
	 * as many names as values according to
