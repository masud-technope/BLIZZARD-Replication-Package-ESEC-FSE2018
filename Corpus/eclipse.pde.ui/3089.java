...
public interface IPDEColorConstants {
    ...
    //$NON-NLS-1$
    String P_BOLD_SUFFIX = "_bold";

    //$NON-NLS-1$
    String P_ITALIC_SUFFIX = "_italic";
    ...
    //$NON-NLS-1$
    String P_EXTERNALIZED_STRING = "editor.color.externalized_string";
    ...
    //$NON-NLS-1$
    String P_HEADER_KEY = "editor.color.header_key";

    //$NON-NLS-1$
    String P_HEADER_VALUE = "editor.color.header_value";

    //$NON-NLS-1$
    String P_HEADER_ASSIGNMENT = "editor.color.header_assignment";

    //$NON-NLS-1$
    String P_HEADER_OSGI = "editor.color.header_osgi";

    //$NON-NLS-1$
    String P_HEADER_ATTRIBUTES = "editor.color.header_attributes";
}
