...
public class ProjectCreationTests extends TestCase {
    ...
    public void testPlugin() throws CoreException {
        ...
        IRequiredBundleDescription rb1 = service.newRequiredBundle("org.eclipse.core.resources", new VersionRange(new Version(3, 5, 0), true, new Version(4, 0, 0), false), true, false);
    ...
    public void testModifyBundle() throws CoreException {
        ...
        // remove, add, re-order
        modify.setPackageExports(new IPackageExportDescription[] { ex0, ex2, ex4, ex3 });
        ...
        // the manifest ends up sorted, so order changes
        assertEquals("Wrong export", ex3, exports[2]);
    ...
    public void testFragToBundle() throws CoreException {
        ...
        IHostDescription host = service.newHost("some.host", null);
        // arbitrary header
        description.setHeader("HeaderOne", "one");
        description.setHost(host);
        description.apply(null);
