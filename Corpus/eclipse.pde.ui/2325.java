    ...
    protected String[] getMessageArgs(IReference reference) throws CoreException {
        ...
        switch(reference.getReferenceType()) {
            case IReference.T_TYPE_REFERENCE:
                {
                    return new String[] { getDisplay(member, false), simpleTypeName, eeValue };
                }
            case IReference.T_FIELD_REFERENCE:
                {
                    return new String[] { getDisplay(member, false), simpleTypeName, reference.getReferencedMemberName(), eeValue };
                }
            case IReference.T_METHOD_REFERENCE:
                {
                    ...
                    if (Util.isConstructor(referenceMemberName)) {
                        return new String[] { getDisplay(member, false), Signature.toString(reference.getReferencedSignature(), simpleTypeName, null, false, false), eeValue };
                    } else {
                        return new String[] { getDisplay(member, false), simpleTypeName, Signature.toString(reference.getReferencedSignature(), referenceMemberName, null, false, false), eeValue };
                    }
                }
            default:
                break;
