...
/**
 * Used to visit an API use scan. This visitor visits each referenced component
 * in a use scan, by each component that refers to it, by each reference.
 */
public abstract class UseScanVisitor {
    ...
    /**
	 * Visits the given component and returns whether to visit components
    ...
    /**
	 * Visits a component that makes references to the current target component
	 * being visited and returns whether to visit individual references.
	 * <p>
