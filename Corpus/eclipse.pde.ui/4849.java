...
public class InterfaceCompatibilityMemberTests extends InterfaceCompatibilityTests {
    ...
    private void xAddField(boolean incremental) throws Exception {
        ...
        int[] ids = new int[] { ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_COMPATIBILITY, IDelta.INTERFACE_ELEMENT_TYPE, IDelta.ADDED, IDelta.FIELD) };
    ...
    private void xAddMethod(boolean incremental) throws Exception {
        ...
        int[] ids = new int[] { ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_COMPATIBILITY, IDelta.INTERFACE_ELEMENT_TYPE, IDelta.ADDED, IDelta.METHOD) };
        setExpectedProblemIds(ids);
        String[][] args = new String[1][];
        //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void xRemoveField(boolean incremental) throws Exception {
        ...
        int[] ids = new int[] { ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_COMPATIBILITY, IDelta.INTERFACE_ELEMENT_TYPE, IDelta.REMOVED, IDelta.FIELD) };
        setExpectedProblemIds(ids);
        String[][] args = new String[1][];
        //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void xRemoveMethod(boolean incremental) throws Exception {
        ...
        int[] ids = new int[] { ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_COMPATIBILITY, IDelta.INTERFACE_ELEMENT_TYPE, IDelta.REMOVED, IDelta.METHOD) };
        setExpectedProblemIds(ids);
        String[][] args = new String[1][];
        //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void xRemoveMemberType(boolean incremental) throws Exception {
        ...
        int[] ids = new int[] { ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_COMPATIBILITY, IDelta.INTERFACE_ELEMENT_TYPE, IDelta.REMOVED, IDelta.TYPE_MEMBER) };
        setExpectedProblemIds(ids);
        String[][] args = new String[1][];
        //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void xAddSuperInterfaceA(boolean incremental) throws Exception {
        ...
        int[] ids = new int[] { ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_COMPATIBILITY, IDelta.INTERFACE_ELEMENT_TYPE, IDelta.ADDED, IDelta.SUPER_INTERFACE_WITH_METHODS) };
        setExpectedProblemIds(ids);
        String[][] args = new String[1][];
        args[0] = new String[] { PACKAGE_PREFIX + "AddInterfaceA", "a.classes.hierarchy.InterfaceA", //$NON-NLS-1$
        "methodA()" };
        setExpectedMessageArgs(args);
        performCompatibilityTest(filePath, incremental);
    }
    ...
    private void xAddSuperInterfaceANoExtend(boolean incremental) throws Exception {
        ...
        setExpectedProblemIds(ids);
        String[][] args = new String[1][];
        args[0] = new String[] { PACKAGE_PREFIX + "AddInterfaceANoExtend", "a.classes.hierarchy.InterfaceA", //$NON-NLS-1$
        "methodA()" };
        setExpectedMessageArgs(args);
        performCompatibilityTest(filePath, incremental);
    }
    ...
    private void xReduceSuperInterfaceABtoA(boolean incremental) throws Exception {
        ...
        int[] ids = new int[] { ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_COMPATIBILITY, IDelta.INTERFACE_ELEMENT_TYPE, IDelta.CHANGED, IDelta.CONTRACTED_SUPERINTERFACES_SET) };
        setExpectedProblemIds(ids);
        String[][] args = new String[1][];
        //$NON-NLS-1$
    ...
    private void xAddMethodNoImplement2(boolean incremental) throws Exception {
        ...
        createWorkspaceFile(filePath, getUpdateFilePath(filePath.lastSegment()));
        //$NON-NLS-1$
