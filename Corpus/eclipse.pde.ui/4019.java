...
public class IllegalOverrideProblemDetector extends AbstractIllegalMethodReference {
    ...
    protected String[] getMessageArgs(IReference reference) throws CoreException {
        ...
        return new String[] { getSimpleTypeName(method), getSimpleTypeName(reference.getMember()), Signature.toString(method.getSignature(), method.getName(), null, false, false) };
    }

    @Override
    protected String[] getQualifiedMessageArgs(IReference reference) throws CoreException {
        IApiMethod method = (IApiMethod) reference.getResolvedReference();
        return new String[] { getTypeName(method), getTypeName(reference.getMember()), Signatures.getMethodSignature(method) };
    }
