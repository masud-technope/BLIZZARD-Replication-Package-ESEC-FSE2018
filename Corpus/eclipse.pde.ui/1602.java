...
public class NLResourceHelper {
    ...
    private InputStream getResourceStream(String name, URL[] locations) {
        ...
        @SuppressWarnings("resource") URLClassLoader resourceLoader = new URLClassLoader(locations, null);
        //$NON-NLS-1$
        ...
        for (int i = 0; i < suffices.length; i++) {
            ...
            //$NON-NLS-1$
            stream = resourceLoader.getResourceAsStream(candidateFileName + ".properties");
            if (stream != null) {
