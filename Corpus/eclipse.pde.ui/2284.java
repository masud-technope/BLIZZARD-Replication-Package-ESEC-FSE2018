...
public class APIFreezeReportConversionTask extends Task {
        ...
        public void startElement(String uri, String localName, String name, Attributes attributes) throws SAXException {
            if (isResolverSection) {
                ...
                if (IApiXmlConstants.ELEMENT_API_TOOL_REPORT.equals(name)) {
                    ...
                    if (this.debug) {
                        //$NON-NLS-1$ //$NON-NLS-2$
                        System.out.println("Resolver error : " + componentID + " : " + message);
                    }
                }
            } else if (IApiXmlConstants.DELTA_ELEMENT_NAME.equals(name)) {
                if (this.debug) {
    ...
    public void execute() throws BuildException {
        ...
        if (this.htmlFileLocation == null) {
            ...
            if (//$NON-NLS-1$
            index == -1 || !this.xmlFileLocation.substring(index).toLowerCase().equals(".xml")) {
            ...
            if (//$NON-NLS-1$
            index == -1 || !this.htmlFileLocation.substring(index).toLowerCase().equals(".html")) {
