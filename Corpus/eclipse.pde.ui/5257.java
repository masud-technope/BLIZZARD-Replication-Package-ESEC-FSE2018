...
public final class ApiUseTask extends CommonUtilsTask {
    ...
    /**
	 * Package name patterns (regular expressions) to consider as API or
	 * <code>null</code> if none.
	 */
    private String[] apiPatterns = null;

    /**
	 * Package name patterns (regular expressions) to consider as internal or
	 * <code>null</code> if none.
	 */
    ...
    public void execute() throws BuildException {
        ...
        writeDebugHeader();
        cleanReportLocation();
        UseMetadata data = new UseMetadata(getSearchFlags(), this.scopepattern, this.referencepattern, this.currentBaselineLocation, this.reportLocation, this.apiPatterns, this.internalPatterns, this.archivePatterns, DateFormat.getDateTimeInstance().format(Calendar.getInstance().getTime()), getDescription());
    ...
    /**
	 * Prepares and creates and new baseline with the given name from the given
	 ...
	 * @return a new {@link IApiBaseline} with the given name from the given
	 *         location or <code>null</code> if the given location is
	 *         <code>null</code>
	 */
    ...
    /**
	 * Cleans the report location specified by the parameter
	 * {@link CommonUtilsTask#reportLocation}
	 */
