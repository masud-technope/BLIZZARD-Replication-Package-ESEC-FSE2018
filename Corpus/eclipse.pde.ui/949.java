...
public class PropertiesSection extends TableSection {
    ...
    private class PropertyDialog extends StatusDialog {
        ...
        protected Control createDialogArea(Composite parent) {
            ...
            //$NON-NLS-1$
            updateStatus(new Status(IStatus.ERROR, IPDEUIConstants.PLUGIN_ID, ""));
            return comp;
        }
        ...
        protected void okPressed() {
            ...
            //$NON-NLS-1$
            fEdit.setOs(index == 0 ? "" : COMBO_OSLABELS[index]);
            index = fArch.getSelectionIndex();
            //$NON-NLS-1$
            fEdit.setArch(index == 0 ? "" : COMBO_ARCHLABELS[index]);
    ...
    protected void createClient(Section section, FormToolkit toolkit) {
        ...
        // You must enter column properties to have cell editors  //$NON-NLS-1$//$NON-NLS-2$
        fPropertiesTable.setColumnProperties(new String[] { "0", "1" });
