...
public class CreateFeatureProjectFromLaunchOperation extends CreateFeatureProjectOperation {
    ...
    private IPluginBase[] getPlugins() {
        ...
        try {
            ...
            else // else if it is an OSGi launch
            if (id.equals(IPDELauncherConstants.OSGI_CONFIGURATION_TYPE))
        ...
        for (int i = 0; i < result.length; i++) result[i] = models[i].getPluginBase(true);
        return result;
    }
}
