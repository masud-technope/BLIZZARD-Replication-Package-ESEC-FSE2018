    ...
    static IDelta checkBundleVersionChanges(IApiComponent apiComponent2, String id, String apiComponentVersion, String apiComponentVersion2) {
        ...
        if (version != null && version2 != null) {
            ...
            if (version.getMajor() != version2.getMajor()) {
                return new Delta(Util.getDeltaComponentVersionsId(apiComponent2), IDelta.API_COMPONENT_ELEMENT_TYPE, IDelta.CHANGED, IDelta.MAJOR_VERSION, RestrictionModifiers.NO_RESTRICTIONS, RestrictionModifiers.NO_RESTRICTIONS, 0, 0, null, id, new String[] { id, apiComponentVersion, apiComponentVersion2 });
            } else if (version.getMinor() != version2.getMinor()) {
                return new Delta(Util.getDeltaComponentVersionsId(apiComponent2), IDelta.API_COMPONENT_ELEMENT_TYPE, IDelta.CHANGED, IDelta.MINOR_VERSION, RestrictionModifiers.NO_RESTRICTIONS, RestrictionModifiers.NO_RESTRICTIONS, 0, 0, null, id, new String[] { id, apiComponentVersion, apiComponentVersion2 });
            }
        }
        return null;
    }
    ...
    public static IDelta compare(final IApiBaseline referenceBaseline, final IApiBaseline baseline, final int visibilityModifiers, final boolean force, final IProgressMonitor monitor) {
        ...
        try {
            if (referenceBaseline == null || baseline == null) {
                ...
                "None of the baselines must be null");
            }
    ...
    public static IDelta compare(final IApiComponent component, final IApiBaseline referenceBaseline, final int visibilityModifiers, final boolean force, final IProgressMonitor monitor) {
        ...
        try {
            if (component == null) {
                throw new //$NON-NLS-1$
                IllegalArgumentException(//$NON-NLS-1$
                "The composent cannot be null");
            }
            if (referenceBaseline == null) {
                throw new //$NON-NLS-1$
                IllegalArgumentException(//$NON-NLS-1$
                "The reference baseline cannot be null");
            }
        ...
        try {
            ...
            for (String currentEE : referenceEEs) {
                ...
                if (!componentsEEs.remove(currentEE)) {
                    globalDelta.add(new Delta(Util.getDeltaComponentVersionsId(referenceComponent), IDelta.API_COMPONENT_ELEMENT_TYPE, IDelta.REMOVED, IDelta.EXECUTION_ENVIRONMENT, RestrictionModifiers.NO_RESTRICTIONS, RestrictionModifiers.NO_RESTRICTIONS, 0, 0, null, referenceComponentId, new String[] { currentEE, Util.getComponentVersionsId(referenceComponent) }));
                }
            }
            ...
            for (String currentEE : componentsEEs) {
                ...
                globalDelta.add(new Delta(Util.getDeltaComponentVersionsId(referenceComponent), IDelta.API_COMPONENT_ELEMENT_TYPE, IDelta.ADDED, IDelta.EXECUTION_ENVIRONMENT, RestrictionModifiers.NO_RESTRICTIONS, RestrictionModifiers.NO_RESTRICTIONS, 0, 0, null, referenceComponentId, new String[] { currentEE, Util.getComponentVersionsId(referenceComponent) }));
            }
        ...
        try {
            ...
            if (typeRoot == null) {
                if (Util.isAPI(visibility, typeDescriptor2)) {
                    return new Delta(deltaComponentID, IDelta.API_COMPONENT_ELEMENT_TYPE, IDelta.ADDED, reexporter == null ? IDelta.TYPE : IDelta.REEXPORTED_TYPE, elementDescription2 != null ? elementDescription2.getRestrictions() : RestrictionModifiers.NO_RESTRICTIONS, RestrictionModifiers.NO_RESTRICTIONS, 0, typeDescriptor2.getModifiers(), typeName, typeName, new String[] { typeName, Util.getComponentVersionsId(component2) });
                }
                return NO_DELTA;
            }
            localmonitor.split(1);
                        ...
                        public void visit(String packageName, IApiTypeRoot typeRoot) {
                            ...
                            try {
                                ...
                                if (typeRoot2 == null) {
                                    ...
                                    globalDelta.add(new Delta(deltaComponentID, IDelta.API_COMPONENT_ELEMENT_TYPE, IDelta.REMOVED, IDelta.TYPE, RestrictionModifiers.NO_RESTRICTIONS, RestrictionModifiers.NO_RESTRICTIONS, typeDescriptor.getModifiers(), 0, typeName, typeName, new String[] { typeName, Util.getComponentVersionsId(component2) }));
                                } else {
                                    if ((visibility & visibilityModifiers) == 0) {
                                        // their visibility
                                        return;
                                    ...
                                    public void visit(String packageName, IApiTypeRoot typeRoot) {
                                        ...
                                        try {
                                            ...
                                            if (typeRoot2 == null) {
                                                ...
                                                globalDelta.add(new Delta(currentComponentID, IDelta.API_COMPONENT_ELEMENT_TYPE, IDelta.REMOVED, IDelta.REEXPORTED_TYPE, RestrictionModifiers.NO_RESTRICTIONS, RestrictionModifiers.NO_RESTRICTIONS, typeDescriptor.getModifiers(), 0, typeName, typeName, new String[] { typeName, Util.getComponentVersionsId(component) }));
                                            } else {
                                                typeRootBaseLineNames.add(typeName);
                                                IApiType typeDescriptor2 = typeRoot2.getStructure();
                                                IApiAnnotations elementDescription2 = providerApiDesc.resolveAnnotations(typeDescriptor2.getHandle());
                    ...
                    container.accept(new ApiTypeContainerVisitor() {
                        ...
                        public void visit(String packageName, IApiTypeRoot typeRoot) {
                            ...
                            try {
                                ...
                                typeRootBaseLineNames.add(typeName);
                                String deltaComponentID = Util.getDeltaComponentVersionsId(component2);
                                globalDelta.add(new Delta(deltaComponentID, IDelta.API_COMPONENT_ELEMENT_TYPE, IDelta.ADDED, IDelta.TYPE, elementDescription != null ? elementDescription.getRestrictions() : RestrictionModifiers.NO_RESTRICTIONS, RestrictionModifiers.NO_RESTRICTIONS, 0, type.getModifiers(), typeName, typeName, new String[] { typeName, Util.getComponentVersionsId(component2) }));
                            } catch (CoreException e) {
                                ApiPlugin.log(e);
                            }
                        }
                                ...
                                container.accept(new ApiTypeContainerVisitor() {
                                    ...
                                    public void visit(String packageName, IApiTypeRoot typeRoot) {
                                        ...
                                        try {
                                            ...
                                            typeRootBaseLineNames.add(typeName);
                                            globalDelta.add(new Delta(currentComponentID, IDelta.API_COMPONENT_ELEMENT_TYPE, IDelta.ADDED, IDelta.REEXPORTED_TYPE, elementDescription != null ? elementDescription.getRestrictions() : RestrictionModifiers.NO_RESTRICTIONS, RestrictionModifiers.NO_RESTRICTIONS, 0, typeDescriptor.getModifiers(), typeName, typeName, new String[] { typeName, Util.getComponentVersionsId(component) }));
                                        } catch (CoreException e) {
                                            ApiPlugin.log(e);
                                        }
                                    }
