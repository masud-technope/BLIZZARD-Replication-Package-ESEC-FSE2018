...
public class Java8TypeAnnotationTests extends AnnotationTest {
    ...
    protected IPath getTestSourcePath() {
        //$NON-NLS-1$ //$NON-NLS-2$
        return super.getTestSourcePath().append("java8").append("types");
    }
    ...
    void x4(boolean inc) throws Exception {
        //$NON-NLS-1$
        deployAnnotationTestWithErrors("test4.java", inc, true);
    }
    ...
    void x5(boolean inc) throws Exception {
        //$NON-NLS-1$
        deployAnnotationTestWithErrors("test5.java", inc, true);
    }
    ...
    void x9(boolean inc) throws Exception {
        //$NON-NLS-1$
        deployAnnotationTestWithErrors("test9.java", inc, true);
    }
    ...
    void x10(boolean inc) throws Exception {
        //$NON-NLS-1$
        deployAnnotationTest("test10.java", inc, false);
    }
}
