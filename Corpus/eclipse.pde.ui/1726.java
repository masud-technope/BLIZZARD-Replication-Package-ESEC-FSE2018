...
public abstract class AntGeneratingExportWizard extends BaseExportWizard {
    ...
    protected class AntErrorDialog extends MessageDialog {
        ...
        protected Control createMessageArea(Composite composite) {
            ...
            try {
                //$NON-NLS-1$ //$NON-NLS-2$
                link.setText(NLS.bind(PDEUIMessages.PluginExportWizard_Ant_errors_during_export_logs_generated, "<a>" + fLogLocation.getCanonicalPath() + "</a>"));
            } catch (IOException e) {
                PDEPlugin.log(e);
            }
