...
public class ExportDialog extends Dialog {
    ...
    // widget state ids
    //$NON-NLS-1$
    static final String SETTINGS_SECTION = ApiUIPlugin.PLUGIN_ID + ".api.exportsession";

    //$NON-NLS-1$
    static final String REPORT_PATH_STATE = SETTINGS_SECTION + ".reportpath";
        ...
        this(shell, title, ActionMessages.ExportDialogDescription, Util.EMPTY_STRING, new IInputValidator() {
            ...
            public String isValid(String newText) {
                if (newText != null && newText.length() > 0) {
                    ...
                    !newText.endsWith(".html") & !newText.endsWith(".xml")) {
