...
public class DSAnnotationPropertyPage extends PropertyPage implements IWorkbenchPreferencePage {
    ...
    protected void performDefaults() {
        ...
        try {
            ...
            Activator.log(new Status(IStatus.ERROR, Activator.PLUGIN_ID, "Unable to restore default values.", e));
        }
        refreshWidgets();
    ...
    public boolean performOk() {
        ...
        if (isProjectPreferencePage()) {
            ...
            if (!useProjectSettings()) {
                try {
                    ...
                    Activator.log(new Status(IStatus.ERROR, Activator.PLUGIN_ID, "Unable to reset project preferences.", e));
                }
                prefs = null;
            }
        } else {
        ...
        try {
            ...
            Activator.log(new Status(IStatus.ERROR, Activator.PLUGIN_ID, "Unable to save preferences.", e));
            return false;
        }
        return true;
    }
