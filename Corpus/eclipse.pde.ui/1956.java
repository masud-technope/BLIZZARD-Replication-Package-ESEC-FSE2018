...
public class ConstructorParameterLeak extends LeakTest {
    ...
    protected int getDefaultProblemId() {
        if (pid == -1) {
            pid = ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_USAGE, IElementDescriptor.METHOD, IApiProblem.API_LEAK, IApiProblem.LEAK_CONSTRUCTOR_PARAMETER);
        }
        return pid;
    }
    ...
    private void x1(boolean inc) {
        ...
        setExpectedMessageArgs(new String[][] { { TESTING_INTERNAL_CLASS_NAME, typename }, { TESTING_INTERNAL_CLASS_NAME, typename }, { TESTING_INTERNAL_CLASS_NAME, typename }, { TESTING_INTERNAL_CLASS_NAME, typename } });
        //$NON-NLS-1$
    ...
    private void x3(boolean inc) {
        ...
        setExpectedMessageArgs(new String[][] { { TESTING_INTERNAL_INTERFACE_NAME, typename }, { TESTING_INTERNAL_INTERFACE_NAME, typename }, { TESTING_INTERNAL_INTERFACE_NAME, typename }, { TESTING_INTERNAL_INTERFACE_NAME, typename } });
        //$NON-NLS-1$
        deployLeakTest(typename + ".java", inc);
    }
    ...
    private void x5(boolean inc) {
        ...
        setExpectedMessageArgs(new String[][] { { TESTING_INTERNAL_INTERFACE_NAME, typename }, { TESTING_INTERNAL_INTERFACE_NAME, typename }, { TESTING_INTERNAL_INTERFACE_NAME, typename }, { TESTING_INTERNAL_INTERFACE_NAME, typename }, { TESTING_INTERNAL_CLASS_NAME, typename }, { TESTING_INTERNAL_CLASS_NAME, typename }, { TESTING_INTERNAL_CLASS_NAME, typename }, { TESTING_INTERNAL_CLASS_NAME, typename } });
        //$NON-NLS-1$
        deployLeakTest(typename + ".java", inc);
    }
    ...
    private void x7(boolean inc) {
        ...
        setExpectedMessageArgs(new String[][] { { TESTING_INTERNAL_INTERFACE_NAME, innertype }, { TESTING_INTERNAL_INTERFACE_NAME, innertype }, { TESTING_INTERNAL_INTERFACE_NAME, innertype }, { TESTING_INTERNAL_INTERFACE_NAME, innertype }, { TESTING_INTERNAL_CLASS_NAME, innertype }, { TESTING_INTERNAL_CLASS_NAME, innertype }, { TESTING_INTERNAL_CLASS_NAME, innertype }, { TESTING_INTERNAL_CLASS_NAME, innertype } });
        //$NON-NLS-1$
        deployLeakTest(typename + ".java", inc);
    }
    ...
    private void x9(boolean inc) {
        ...
        setExpectedMessageArgs(new String[][] { { TESTING_INTERNAL_INTERFACE_NAME, innertype1 }, { TESTING_INTERNAL_INTERFACE_NAME, innertype1 }, { TESTING_INTERNAL_INTERFACE_NAME, innertype2 }, { TESTING_INTERNAL_INTERFACE_NAME, innertype2 }, { TESTING_INTERNAL_CLASS_NAME, innertype1 }, { TESTING_INTERNAL_CLASS_NAME, innertype1 }, { TESTING_INTERNAL_CLASS_NAME, innertype2 }, { TESTING_INTERNAL_CLASS_NAME, innertype2 } });
        //$NON-NLS-1$
        deployLeakTest(typename + ".java", inc);
    }
    ...
    private void x11(boolean inc) {
        ...
        //$NON-NLS-1$
        String innertype2 = "inner3";
        setExpectedMessageArgs(new String[][] { { TESTING_INTERNAL_INTERFACE_NAME, innertype1 }, { TESTING_INTERNAL_CLASS_NAME, innertype1 }, { TESTING_INTERNAL_CLASS_NAME, innertype1 }, { TESTING_INTERNAL_INTERFACE_NAME, innertype2 }, { TESTING_INTERNAL_CLASS_NAME, innertype2 }, { TESTING_INTERNAL_CLASS_NAME, innertype2 } });
        //$NON-NLS-1$
        deployLeakTest(typename + ".java", inc);
    }
    ...
    private void x12(boolean inc) {
        ...
        //$NON-NLS-1$
        String innertype2 = "inner3";
        setExpectedMessageArgs(new String[][] { { TESTING_INTERNAL_INTERFACE_NAME, innertype1 }, { TESTING_INTERNAL_CLASS_NAME, innertype1 }, { TESTING_INTERNAL_INTERFACE_NAME, innertype2 }, { TESTING_INTERNAL_CLASS_NAME, innertype2 } });
        //$NON-NLS-1$
        deployLeakTest(typename + ".java", inc);
    }
