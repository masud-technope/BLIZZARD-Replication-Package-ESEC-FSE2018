...
public class ConfigurationTemplateBlock extends BaseBlock {
    ...
    public void initializeFrom(ILaunchConfiguration configuration) throws CoreException {
        ...
        if (generateDefault)
            fLocationText.setEnabled(true);
        //$NON-NLS-1$
        fLocationText.setText(configuration.getAttribute(IPDELauncherConstants.CONFIG_TEMPLATE_LOCATION, ""));
    }
    ...
    public void setDefaults(ILaunchConfigurationWorkingCopy configuration) {
        ...
        configuration.setAttribute(IPDELauncherConstants.CONFIG_TEMPLATE_LOCATION, "${target_home}" + File.separatorChar + "configuration" + File.separatorChar + "config.ini");
    }
    ...
    protected void handleBrowseWorkspace() {
        ...
        if (dialog.open() == Window.OK) {
            ...
            //$NON-NLS-1$ //$NON-NLS-2$
            fLocationText.setText("${workspace_loc:" + file.getFullPath().makeRelative() + "}");
        }
    }
