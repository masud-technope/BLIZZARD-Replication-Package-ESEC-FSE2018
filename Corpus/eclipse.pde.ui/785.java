            ...
            try {
                ...
                if (bundle != null) {
                    ...
                    if (header != null) {
                        ...
                        MovedTextFileChange change = new //$NON-NLS-1$
                        MovedTextFileChange(//$NON-NLS-1$
                        "", //$NON-NLS-1$
                        newManifest, //$NON-NLS-1$
                        manifest);
                ...
                FileBuffers.getTextFileBufferManager().disconnect(manifest.getFullPath(), LocationKind.NORMALIZE, subMonitor.split(1));
            }
        }
        return null;
    }
