...
public interface IApiJavadocTag {
    ...
    /**
	 * Type constant representing the tag applies to a Java class. Values is
	 * <code>1</code>
	 */
    public static final int TYPE_CLASS = 0x1;

    /**
	 * Type constant representing the tag applies to a Java interface. Values is
	 * <code>2</code>
	 */
    ...
    /**
	 * Type constant representing the tag applies to a Java annotation. Values
	 * is <code>128</code>
	 */
    ...
    /**
	 * Member constant representing the tag applies to a Java field. Values is
	 * <code>8</code>
	 */
	 ...
	 * not to a member. Values is <code>16</code>
	 */
    public static final int MEMBER_NONE = 0x1 << 4;

    /**
	 * Member constant representing the tag applies to a Java constructor Values
	 * is <code>32</code>
	 */
    public static final int MEMBER_CONSTRUCTOR = 0x1 << 5;

    /**
	 * Constant representing the id of the @noreference Javadoc tag. Value is:
	 * <code>org.eclipse.pde.api.tools.noreference</code>
	 */
    //$NON-NLS-1$
    public static final String NO_REFERENCE_TAG_ID = "org.eclipse.pde.api.tools.noreference";

    /**
	 * Constant representing the id of the @noextend Javadoc tag. Value is:
	 * <code>org.eclipse.pde.api.tools.noextend</code>
	 */
    //$NON-NLS-1$
    public static final String NO_EXTEND_TAG_ID = "org.eclipse.pde.api.tools.noextend";

    /**
	 * Constant representing the id of the @noimplement Javadoc tag. Value is:
	 * <code>org.eclipse.pde.api.tools.noimplement</code>
	 */
    //$NON-NLS-1$
    public static final String NO_IMPLEMENT_TAG_ID = "org.eclipse.pde.api.tools.noimplement";

    /**
	 * Constant representing the id of the @nooverride Javadoc tag. Value is:
	 * <code>org.eclipse.pde.api.tools.nooverride</code>
	 */
    //$NON-NLS-1$
    public static final String NO_OVERRIDE_TAG_ID = "org.eclipse.pde.api.tools.nooverride";

    /**
	 * Constant representing the id of the @noinstantiate Javadoc tag. Value is:
	 * <code>org.eclipse.pde.api.tools.noinstantiate</code>
	 */
    //$NON-NLS-1$
    ...
    /**
	 * Returns the complete formatted javadoc tag for an element of the
