...
public class InternationalizeWizard extends Wizard implements IImportWizard {
    ...
    public void addPages() {
        ...
        //$NON-NLS-1$
        page1 = new InternationalizeWizardPluginPage(fInternationalizePluginModelTable, "Plug-ins");
        addPage(page1);
        //$NON-NLS-1$
        page2 = new InternationalizeWizardLocalePage(fInternationalizeLocaleModelTable, "Locales");
        addPage(page2);
    }
    ...
    public boolean performFinish() {
        ...
        //$NON-NLS-1$ //$NON-NLS-2$
        String template = page1.getTemplate() + (page1.createIndividualFragments() ? "." + NLSFragmentGenerator.LOCALE_NAME_MACRO : "");
