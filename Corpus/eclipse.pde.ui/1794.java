...
public class ClassImplementsLeak extends LeakTest {
    ...
    protected int getDefaultProblemId() {
        if (pid == -1) {
            pid = ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_USAGE, IElementDescriptor.TYPE, IApiProblem.API_LEAK, IApiProblem.LEAK_IMPLEMENTS);
        }
        return pid;
    }
    ...
    private void x8(boolean inc) {
        ...
        setExpectedMessageArgs(new String[][] { { TESTING_INTERNAL_INTERFACE_NAME, typename }, { TESTING_INTERNAL_INTERFACE_NAME, innertype }, { TESTING_INTERNAL_INTERFACE_NAME, innertype2 } });
        //$NON-NLS-1$
        deployLeakTest(typename + ".java", inc);
    }
