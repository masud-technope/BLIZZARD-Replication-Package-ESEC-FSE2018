...
public class TargetStatus {
    ...
    private static class TargetStatusLineContributionItem extends StatusLineContributionItem {
        ...
        public  TargetStatusLineContributionItem() {
            ...
            // Needed to avoid disposing the image early
    ...
    private static // see https://bugs.eclipse.org/378395
    IStatusLineManager getStatusLineManager(IWorkbenchWindow window) {
    ...
    public static void initializeTargetStatus() {
        ...
        if (showStatus) {
            UIJob updateStatus = new //$NON-NLS-1$
            UIJob(//$NON-NLS-1$
            "Refresh PDE Target Status") {
