...
public class DSContentAssistProcessor extends TypePackageCompletionProcessor implements IContentAssistProcessor, ICompletionListener {
    ...
    private ICompletionProposal[] computeCompletionProposal(IDocumentAttributeNode attr, int offset, IDocument doc) {
        ...
        // Component
        if (element != null && //$NON-NLS-1$
        element.equals("scr:" + IDSConstants.ELEMENT_COMPONENT)) {
            boolean isAttrImmediate = attribute == null ? false : attribute.equals(IDSConstants.ATTRIBUTE_COMPONENT_IMMEDIATE);
            boolean isAttrEnabled = attribute == null ? false : attribute.equals(IDSConstants.ATTRIBUTE_COMPONENT_ENABLED);
            boolean isAttrConfigPolicy = attribute == null ? false : attribute.equals(IDSConstants.ATTRIBUTE_COMPONENT_CONFIGURATION_POLICY);
            if ((isAttrImmediate || isAttrEnabled)) {
                return getCompletionBooleans(startOffset, attrValueLength);
            }
            if (isAttrConfigPolicy) {
                return getConfigurationPolicyValues(attrValueLength, startOffset);
            }
        // Service
        } else if (element != null && element.equals(IDSConstants.ELEMENT_SERVICE)) {
            boolean isAttrServFactory = attribute == null ? false : attribute.equals(IDSConstants.ATTRIBUTE_SERVICE_FACTORY);
            if (isAttrServFactory) {
                return getCompletionBooleans(startOffset, attrValueLength);
            }
        // Reference
        } else if (element != null && element.equals(IDSConstants.ELEMENT_REFERENCE)) {
            boolean isAttrCardinality = attribute == null ? false : attribute.equals(IDSConstants.ATTRIBUTE_REFERENCE_CARDINALITY);
            boolean isAttrPolicy = attribute == null ? false : attribute.equals(IDSConstants.ATTRIBUTE_REFERENCE_POLICY);
        ...
        // Property
        } else if (element != null && element.equals(IDSConstants.ELEMENT_PROPERTY)) {
            boolean isAttrType = attribute == null ? false : attribute.equals(IDSConstants.ATTRIBUTE_PROPERTY_TYPE);
            if (isAttrType) {
    ...
    private ICompletionProposal[] getReferencePolicyValues(int attrValueLength, int startOffset) {
        return new ICompletionProposal[] { new TypeCompletionProposal(IDSConstants.VALUE_REFERENCE_POLICY_STATIC, null, IDSConstants.VALUE_REFERENCE_POLICY_STATIC, startOffset, attrValueLength), new TypeCompletionProposal(IDSConstants.VALUE_REFERENCE_POLICY_DYNAMIC, null, IDSConstants.VALUE_REFERENCE_POLICY_DYNAMIC, startOffset, attrValueLength) };
    }

    private ICompletionProposal[] getConfigurationPolicyValues(int attrValueLength, int startOffset) {
        return new ICompletionProposal[] { new TypeCompletionProposal(IDSConstants.VALUE_CONFIGURATION_POLICY_IGNORE, null, IDSConstants.VALUE_CONFIGURATION_POLICY_IGNORE, startOffset, attrValueLength), new TypeCompletionProposal(IDSConstants.VALUE_CONFIGURATION_POLICY_OPTIONAL, null, IDSConstants.VALUE_CONFIGURATION_POLICY_OPTIONAL, startOffset, attrValueLength), new TypeCompletionProposal(IDSConstants.VALUE_CONFIGURATION_POLICY_REQUIRE, null, IDSConstants.VALUE_CONFIGURATION_POLICY_REQUIRE, startOffset, attrValueLength) };
    }

    private ICompletionProposal[] getReferenceCardinalityValues(int attrValueLength, int startOffset) {
        return new ICompletionProposal[] { new TypeCompletionProposal(IDSConstants.VALUE_REFERENCE_CARDINALITY_ZERO_ONE, null, IDSConstants.VALUE_REFERENCE_CARDINALITY_ZERO_ONE, startOffset, attrValueLength), new TypeCompletionProposal(IDSConstants.VALUE_REFERENCE_CARDINALITY_ZERO_N, null, IDSConstants.VALUE_REFERENCE_CARDINALITY_ZERO_N, startOffset, attrValueLength), new TypeCompletionProposal(IDSConstants.VALUE_REFERENCE_CARDINALITY_ONE_ONE, null, IDSConstants.VALUE_REFERENCE_CARDINALITY_ONE_ONE, startOffset, attrValueLength), new TypeCompletionProposal(IDSConstants.VALUE_REFERENCE_CARDINALITY_ONE_N, null, IDSConstants.VALUE_REFERENCE_CARDINALITY_ONE_N, startOffset, attrValueLength) };
    }

    private ICompletionProposal[] getPropertyTypeValues(int attrValueLength, int startOffset) {
        return new ICompletionProposal[] { new TypeCompletionProposal(IDSConstants.VALUE_PROPERTY_TYPE_STRING, null, IDSConstants.VALUE_PROPERTY_TYPE_STRING, startOffset, attrValueLength), new TypeCompletionProposal(IDSConstants.VALUE_PROPERTY_TYPE_LONG, null, IDSConstants.VALUE_PROPERTY_TYPE_LONG, startOffset, attrValueLength), new TypeCompletionProposal(IDSConstants.VALUE_PROPERTY_TYPE_DOUBLE, null, IDSConstants.VALUE_PROPERTY_TYPE_DOUBLE, startOffset, attrValueLength), new TypeCompletionProposal(IDSConstants.VALUE_PROPERTY_TYPE_FLOAT, null, IDSConstants.VALUE_PROPERTY_TYPE_FLOAT, startOffset, attrValueLength), new TypeCompletionProposal(IDSConstants.VALUE_PROPERTY_TYPE_INTEGER, null, IDSConstants.VALUE_PROPERTY_TYPE_INTEGER, startOffset, attrValueLength), new TypeCompletionProposal(IDSConstants.VALUE_PROPERTY_TYPE_BYTE, null, IDSConstants.VALUE_PROPERTY_TYPE_BYTE, startOffset, attrValueLength), new TypeCompletionProposal(IDSConstants.VALUE_PROPERTY_TYPE_CHAR, null, IDSConstants.VALUE_PROPERTY_TYPE_CHAR, startOffset, attrValueLength), new TypeCompletionProposal(IDSConstants.VALUE_PROPERTY_TYPE_BOOLEAN, null, IDSConstants.VALUE_PROPERTY_TYPE_BOOLEAN, startOffset, attrValueLength), new TypeCompletionProposal(IDSConstants.VALUE_PROPERTY_TYPE_SHORT, null, IDSConstants.VALUE_PROPERTY_TYPE_SHORT, startOffset, attrValueLength) };
    }

    private ICompletionProposal[] getCompletionBooleans(int startOffset, int attrValueLength) {
        return new ICompletionProposal[] { new TypeCompletionProposal(IDSConstants.VALUE_TRUE, null, IDSConstants.VALUE_TRUE, startOffset, attrValueLength), new TypeCompletionProposal(IDSConstants.VALUE_FALSE, null, IDSConstants.VALUE_FALSE, startOffset, attrValueLength) };
    }
    ...
    private ICompletionProposal[] computeCompletionProposal(IDocumentElementNode node, int offset, IDocument doc) {
        ...
        switch(prop_type) {
            case F_ADD_ATTRIB:
                return computeAddAttributeProposal(node, offset, doc, null, node.getXMLTagName());
        ...
        if (attributesList == null || attributesList.length == 0) {
            ...
            for (String attribute : attributesList) {
                ...
                if (EqualToAnyItem == false) {
                    ...
                    addFilteredProposal(offset, proposals, dsAttrCompletionProposal, filter);
                }
            }
        }
    ...
    private ICompletionProposal[] computeAddChildProposal(IDocumentElementNode node, int offset, IDocument doc, String filter) {
        if (node instanceof IDSComponent) {
            ...
            return new DSCompletionProposal[] { new DSCompletionProposal(provide, offset) };
        } else {
            return null;
        }
    }
    ...
    private ICompletionProposal[] computeRootNodeProposals(IDocumentElementNode node, int offset, String filter) {
        ...
        addFilteredProposal(offset, proposals, new DSCompletionProposal(model.getFactory().createProperty(), offset, length), filter);
        addFilteredProposal(offset, proposals, new DSCompletionProposal(model.getFactory().createProperties(), offset, length), filter);
        addFilteredProposal(offset, proposals, new DSCompletionProposal(model.getFactory().createReference(), offset, length), filter);
        boolean hasService = component.getService() != null;
        if (!hasService) {
            addFilteredProposal(offset, proposals, new DSCompletionProposal(model.getFactory().createService(), offset, length), filter);
        }
        if (component.getImplementation() == null) {
            addFilteredProposal(offset, proposals, new DSCompletionProposal(model.getFactory().createImplementation(), offset, length), filter);
        }
    ...
    private void addFilteredProposal(int offset, ArrayList<DSCompletionProposal> proposals, DSCompletionProposal proposal, String filter) {
        if (filter == null || filter.length() == 0) {
            ...
            if (filter.regionMatches(true, 0, proposal.getDisplayString(), 0, filter.length()))
                proposals.add(proposal);
        }
    }
        ...
        if (offset > node.getXMLTagName().length() + 1) {
            try {
                ...
                if (ind == 0 && offset == len - 1)
                    // childless node - check if it can be
                    return F_OPEN_TAG;
                // cracked open
    ...
    private String[] guessContentRequest(int[] offset, IDocument doc, boolean brokenModel) {
        ...
        try {
            while (--offset[0] >= 0) {
                ...
                if (c == '"') {
                    ...
                    if (// ran into 2nd quotation mark, we are
                    attVal != null)
                        // out of range
                        continue;
                    offset[2] = offset[0];
        ...
        if (quoteCount % 2 == 0)
            ...
            // open quotes - don't provide assist
            return null;
