...
public final class ResourcesPlugin extends Plugin {
	 ...
	 */
    //$NON-NLS-1$
    public static final String PREF_AUTO_BUILDING = PREF_DESCRIPTION_PREFIX + "autobuilding";
	 ...
	 */
    //$NON-NLS-1$
    public static final String PREF_BUILD_ORDER = PREF_DESCRIPTION_PREFIX + "buildorder";
	 ...
	 */
    //$NON-NLS-1$
    public static final String PREF_DEFAULT_BUILD_ORDER = PREF_DESCRIPTION_PREFIX + "defaultbuildorder";
	 ...
	 */
    //$NON-NLS-1$
    public static final String PREF_MAX_BUILD_ITERATIONS = PREF_DESCRIPTION_PREFIX + "maxbuilditerations";
	 ...
	 */
    //$NON-NLS-1$
    public static final String PREF_FILE_STATE_LONGEVITY = PREF_DESCRIPTION_PREFIX + "filestatelongevity";
	 ...
	 */
    //$NON-NLS-1$
    public static final String PREF_MAX_FILE_STATE_SIZE = PREF_DESCRIPTION_PREFIX + "maxfilestatesize";
	 ...
	 */
    //$NON-NLS-1$	
    public static final String PREF_MAX_FILE_STATES = PREF_DESCRIPTION_PREFIX + "maxfilestates";
	 ...
	 */
    //$NON-NLS-1$	
    public static final String PREF_SNAPSHOT_INTERVAL = PREF_DESCRIPTION_PREFIX + "snapshotinterval";
	 ...
	 */
    //$NON-NLS-1$
    public static final String PREF_DISABLE_LINKING = PREF_DESCRIPTION_PREFIX + "disableLinking";
