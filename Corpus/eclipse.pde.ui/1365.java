...
public class UseSearchTests extends SearchTest {
    ...
    public void testSearchXmlReporterNoExclusions() {
        ...
        try {
            ...
            setProjectsUsedBy(new String[] { getProjectId(P1_NAME, DEFAULT_VERSION), getProjectId(P2_NAME, DEFAULT_VERSION) }, new String[][] { { getProjectId(P2_NAME, DEFAULT_VERSION), getProjectId(P3_NAME, DEFAULT_VERSION) }, { getProjectId(P3_NAME, DEFAULT_VERSION) } });
