...
public interface IApiDescription {
    ...
    /**
	 * Status code indicating an element was not found when attempting to set
	 * its visibility or usage restrictions.
	 */
    ...
    /**
	 * Returns annotations for the specified element when referenced from the
	 * specified component.
	 * <p>
	 * If the given element does not appear in the description and none of its
	 * enclosing elements appear in the description, <code>null</code> is
	 * returned. Otherwise the annotations of the first restricted enclosing
	 * member are returned.
	 * </p>
	 * <p>
	 ...
	 *            access to
	 * @param access the desired access level to the given package from the
	 *            given element
	 */
	 ...
	 * @return whether the element was visited - <code>true</code> if present
	 *         and <code>false</code> if not present
	 */
