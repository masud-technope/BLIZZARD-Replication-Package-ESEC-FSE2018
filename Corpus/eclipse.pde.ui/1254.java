...
public class PDEFormTextEditorContributor extends PDEFormEditorContributor {
    ...
    public  PDEFormTextEditorContributor(String menuName) {
        ...
        if (supportsCorrectionAssist()) {
            //$NON-NLS-1$
            fCorrectionAssist = new RetargetTextEditorAction(PDESourcePage.getBundleForConstructedKeys(), "CorrectionAssistProposal.");
        ...
        if (supportsContentAssist()) {
            //$NON-NLS-1$
            fContentAssist = new RetargetTextEditorAction(PDESourcePage.getBundleForConstructedKeys(), "ContentAssistProposal.");
