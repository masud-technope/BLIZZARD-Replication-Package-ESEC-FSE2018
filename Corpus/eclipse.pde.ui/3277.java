...
public abstract class ApiTypeContainerVisitor {
    ...
    /**
	 * Visits a component in the container and returns whether class files in
	 * the component should be visited. This method is only called when the
	 * class file container being visited is contained in an API component.
	 * <p>
    ...
    /**
	 * End visiting a component. This method is only called when the class file
	 * container being visited is contained in an API component.
	 * <p>
    ...
    /**
	 * Visits a container and returns whether class files in the container
	 * should be visited.
	 * <p>
	 * The default implementation does nothing and returns <code>true</code>.
	 * Subclasses may re-implement.
    ...
    /**
	 * Visits a package in the container and returns whether class files in the
	 * package should be visited.
	 * <p>
	 * The default implementation does nothing and returns <code>true</code>.
	 * Subclasses may re-implement.
	 * </p>
