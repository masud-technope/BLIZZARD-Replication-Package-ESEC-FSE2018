                ...
                if (element instanceof IPluginImport) {
                    ...
                    if (element instanceof RequireBundleObject) {
                        ...
                        if (aggModel instanceof BundlePluginModel) {
                            ...
                            boolean option = (bundleManifestVersion > 1) ? Constants.RESOLUTION_OPTIONAL.equals(requireBundle.getDirective(Constants.RESOLUTION_DIRECTIVE)) : "true".equals(requireBundle.getAttribute(//$NON-NLS-1$;
                            ICoreConstants.OPTIONAL_ATTRIBUTE));
                            boolean exported = (bundleManifestVersion > 1) ? Constants.VISIBILITY_REEXPORT.equals(requireBundle.getDirective(Constants.VISIBILITY_DIRECTIVE)) : "true".equals(requireBundle.getAttribute(//$NON-NLS-1$;
