...
public interface IPDEUIConstants extends IPDEConstants {
    ...
    //$NON-NLS-1$
    String CATEGORY_EDITOR_ID = PLUGIN_ID + ".categoryEditor";
    ...
    //$NON-NLS-1$
    String TARGET_EDITOR_ID = PLUGIN_ID + ".targetEditor";
    ...
    //$NON-NLS-1$
    String PERSPECTIVE_ID = "org.eclipse.pde.ui.PDEPerspective";
    ...
    //$NON-NLS-1$
    QualifiedName PROPERTY_EDITOR_PAGE_KEY = new QualifiedName(PLUGIN_ID, "editor-page-key");

    //$NON-NLS-1$
    QualifiedName PROPERTY_MANIFEST_EDITOR_PAGE_KEY = new QualifiedName(PLUGIN_ID, "manifest-editor-page-key");

    //$NON-NLS-1$
    QualifiedName DEFAULT_PRODUCT_EXPORT_LOCATION = new QualifiedName(PLUGIN_ID, "product-export-location");

    //$NON-NLS-1$
    QualifiedName DEFAULT_PRODUCT_EXPORT_DIR = new QualifiedName(PLUGIN_ID, "product-export-type");

    //$NON-NLS-1$
    QualifiedName DEFAULT_PRODUCT_EXPORT_ROOT = new QualifiedName(PLUGIN_ID, "product-export-root");

    //$NON-NLS-1$
    String PLUGIN_DOC_ROOT = "/org.eclipse.pde.doc.user/";
	 ...
	 */
    //$NON-NLS-1$
    String GENERATED_CONFIG = "pde.generated.config";
}
