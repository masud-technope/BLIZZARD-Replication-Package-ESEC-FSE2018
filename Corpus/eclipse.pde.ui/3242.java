...
public class IllegalMethodReferenceDetector extends AbstractIllegalMethodReference {
    ...
    protected String[] getMessageArgs(IReference reference) throws CoreException {
        ...
        if (method.isConstructor()) {
            return new String[] { Signatures.getMethodSignature(method), getSimpleTypeName(reference.getMember()) };
        }
        return new String[] { getSimpleTypeName(method), getSimpleTypeName(reference.getMember()), Signatures.getMethodSignature(method) };
    }
    ...
    protected String[] getQualifiedMessageArgs(IReference reference) throws CoreException {
        IApiMethod method = (IApiMethod) reference.getResolvedReference();
        return new String[] { getQualifiedTypeName(method), getQualifiedTypeName(reference.getMember()), Signatures.getMethodSignature(method) };
    }
}
