...
public class Java8MethodConstRefUsageTests extends Java8UsageTest {
    ...
    private void x1(boolean inc) {
        ...
        //$NON-NLS-1$
        String typename = "testMethodReference";
        String[][] args = new String[][] { //$NON-NLS-1$ //$NON-NLS-2$
        { "MethodReference", typename, "method1()" }, //$NON-NLS-1$ //$NON-NLS-2$
        { "MethodReference", typename, "method2()" }, { //$NON-NLS-1$
        "ConstructorReference()", //$NON-NLS-1$
        typename, //$NON-NLS-1$
        null }, { //$NON-NLS-1$
        "ConstructorReference(String)", //$NON-NLS-1$
        typename, //$NON-NLS-1$
        null }, { //$NON-NLS-1$
        "ConstructorReference(List<String>)", //$NON-NLS-1$
        typename, //$NON-NLS-1$
        null } };
        setExpectedMessageArgs(args);
        setExpectedLineMappings(new LineMapping[] { new LineMapping(31, pids[0], args[0]), new LineMapping(34, pids[1], args[1]), new LineMapping(36, pids[2], args[2]), new LineMapping(38, pids[3], args[3]), new LineMapping(40, pids[4], args[4]) });
    ...
    private void x2(boolean inc) {
        ...
        setExpectedProblemIds(pids);
        //$NON-NLS-1$
        String typename = "testMethodReference2";
        String[][] args = new String[][] { //$NON-NLS-1$ //$NON-NLS-2$
        { "MR", typename, "mrCompare(String, String)" }, //$NON-NLS-1$ //$NON-NLS-2$
        { "MR", typename, "mrCompare2(String, String)" }, //$NON-NLS-1$ //$NON-NLS-2$
        { "MR", typename, "con(Supplier<T>)" } };
        setExpectedMessageArgs(args);
        setExpectedLineMappings(new LineMapping[] { new LineMapping(27, pids[0], args[0]), new LineMapping(29, pids[1], args[1]), new LineMapping(31, pids[2], args[2]) });
        deployUsageTest(typename, inc);
    }
    ...
    private void x3(boolean inc) {
        ...
        setExpectedProblemIds(pids);
        //$NON-NLS-1$
        String typename = "testMethodReferenceAnnotation";
        String[][] args = new String[][] { //$NON-NLS-1$ //$NON-NLS-2$
        { "MethodReferenceAnnotation", typename, "method1()" }, //$NON-NLS-1$ //$NON-NLS-2$
        { "MethodReferenceAnnotation", typename, "method2()" }, { //$NON-NLS-1$
        "ConstructorReferenceAnnotation()", //$NON-NLS-1$
        typename, //$NON-NLS-1$
        null }, { //$NON-NLS-1$
        "ConstructorReferenceAnnotation(String)", //$NON-NLS-1$
        typename, //$NON-NLS-1$
        null }, { //$NON-NLS-1$
        "ConstructorReferenceAnnotation(List<String>)", //$NON-NLS-1$
        typename, //$NON-NLS-1$
        null } };
        setExpectedMessageArgs(args);
        setExpectedLineMappings(new LineMapping[] { new LineMapping(31, pids[0], args[0]), new LineMapping(34, pids[1], args[1]), new LineMapping(36, pids[2], args[2]), new LineMapping(38, pids[3], args[3]), new LineMapping(40, pids[4], args[4]) });
    ...
    private void x4(boolean inc) {
        ...
        setExpectedProblemIds(pids);
        //$NON-NLS-1$
        String typename = "testMethodReferenceAnnotation2";
        String[][] args = new String[][] { //$NON-NLS-1$ //$NON-NLS-2$
        ...
        { "MRAnnotation", typename, "con(Supplier<T>)" } };
        setExpectedMessageArgs(args);
        setExpectedLineMappings(new LineMapping[] { new LineMapping(27, pids[0], args[0]), new LineMapping(29, pids[1], args[1]), new LineMapping(31, pids[2], args[2]) });
        deployUsageTest(typename, inc);
    }
