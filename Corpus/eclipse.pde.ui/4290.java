...
public class SplashHandlersTemplate extends PDETemplateSection {
    ...
    public IPluginReference[] getDependencies(String schemaVersion) {
        ...
        //$NON-NLS-1$
        dependencies[0] = new PluginReference("org.eclipse.core.runtime");
        //$NON-NLS-1$
        dependencies[1] = new PluginReference("org.eclipse.swt");
        //$NON-NLS-1$
        dependencies[2] = new PluginReference("org.eclipse.jface");
        //$NON-NLS-1$
        dependencies[3] = new PluginReference("org.eclipse.ui.workbench");
        return dependencies;
    }
    ...
    private String createAttributeValueID() {
        ...
        return //$NON-NLS-1$
        fFieldPackage.getValue() + "." + fFieldTemplate.getValue();
    }

    private String createAttributeValueClass() {
        // Create the class based on the splash screen type
        return //$NON-NLS-1$
        fFieldPackage.getValue() + "." + fFieldClass.getValue();
    }
