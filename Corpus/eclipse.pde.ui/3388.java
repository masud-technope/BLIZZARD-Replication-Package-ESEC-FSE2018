...
public class FilterDialog extends TrayDialog {
    ...
    private void createSessionSection(Composite parent) {
        ...
        if (//$NON-NLS-1$
        memento.getString(LogView.P_SHOW_ALL_SESSIONS).equals("true")) {
    ...
    protected void okPressed() {
        //$NON-NLS-1$ //$NON-NLS-2$
        memento.putString(LogView.P_LOG_OK, okCheckbox.getSelection() ? "true" : "false");
        //$NON-NLS-1$ //$NON-NLS-2$
        memento.putString(LogView.P_LOG_INFO, infoCheckbox.getSelection() ? "true" : "false");
        //$NON-NLS-1$ //$NON-NLS-2$
        memento.putString(LogView.P_LOG_WARNING, warningCheckbox.getSelection() ? "true" : "false");
        //$NON-NLS-1$ //$NON-NLS-2$
        memento.putString(LogView.P_LOG_ERROR, errorCheckbox.getSelection() ? "true" : "false");
