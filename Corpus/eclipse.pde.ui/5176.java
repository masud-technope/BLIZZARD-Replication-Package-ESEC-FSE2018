...
public class InterfaceExtendsLeak extends LeakTest {
    ...
    protected int getDefaultProblemId() {
        if (pid == -1) {
            pid = ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_USAGE, IElementDescriptor.TYPE, IApiProblem.API_LEAK, IApiProblem.LEAK_EXTENDS);
        }
        return pid;
    }
    ...
    private void x8(boolean inc) {
        ...
        setExpectedMessageArgs(new String[][] { { TESTING_INTERNAL_INTERFACE_NAME, typename }, { TESTING_INTERNAL_INTERFACE_NAME, innertype3 }, { TESTING_INTERNAL_INTERFACE_NAME, inner } });
        //$NON-NLS-1$
        deployLeakTest(typename + ".java", inc);
    }
    ...
    private void x9(boolean inc) {
        ...
        setExpectedMessageArgs(new String[][] { { TESTING_INTERNAL_INTERFACE_NAME, typename }, { TESTING_INTERNAL_INTERFACE_NAME, innertype1 }, { TESTING_INTERNAL_INTERFACE_NAME, innertype2 } });
        //$NON-NLS-1$
        deployLeakTest(typename + ".java", inc);
    }
