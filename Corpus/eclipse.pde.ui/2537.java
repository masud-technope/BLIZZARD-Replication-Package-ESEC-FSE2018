...
public class TargetDefinitionPersistenceTests extends MinimalTargetDefinitionPersistenceTests {
    ...
    protected void initComplexDefiniton(ITargetDefinition definition) throws URISyntaxException {
        ...
        NameVersionDescriptor[] implicit = new NameVersionDescriptor[] { new NameVersionDescriptor("org.eclipse.jdt.launching", null), new NameVersionDescriptor("org.eclipse.jdt.debug", null) };
        ...
        ITargetLocation profileContainer = getTargetService().newProfileLocation(TargetPlatform.getDefaultLocation(), new File(Platform.getConfigurationLocation().getURL().getFile()).getAbsolutePath());
