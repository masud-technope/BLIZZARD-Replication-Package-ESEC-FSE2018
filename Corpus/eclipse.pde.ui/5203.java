...
public class PDERuntimePluginImages {
    ...
    //$NON-NLS-1$
    private static final String PATH_DCL = ICONS_PATH + "dlcl16/";
    ...
    //$NON-NLS-1$
    public static final ImageDescriptor DESC_REFRESH_DISABLED = create(PATH_DCL, "refresh.gif");
    ...
    //$NON-NLS-1$
    public static final ImageDescriptor DESC_ERROR_STACK_OBJ = create(PATH_OBJ, "error_stack.gif");
    ...
    //$NON-NLS-1$
    public static final ImageDescriptor DESC_ATTR_XML_OBJ = create(PATH_OBJ, "attr_xml_obj.gif");
    ...
    //$NON-NLS-1$
    public static final ImageDescriptor DESC_IMP_OBJ = create(PATH_OBJ, "bundle-importer.gif");

    //$NON-NLS-1$
    public static final ImageDescriptor DESC_EXP_OBJ = create(PATH_OBJ, "bundle-exporter.gif");
    ...
    //$NON-NLS-1$
    public static final ImageDescriptor DESC_PLUGINS_OBJ = create(PATH_OBJ, "plugins_obj.gif");
    ...
    //$NON-NLS-1$
    public static final ImageDescriptor DESC_REMOTE_SERVICE_PROXY_OBJ = create(PATH_OBJ, "rsvcproxy_obj.gif");
    ...
    //$NON-NLS-1$
    public static final ImageDescriptor DESC_DEFAULT_CO = create(PATH_OVR, "default_co.gif");
