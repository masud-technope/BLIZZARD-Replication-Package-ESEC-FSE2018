...
public class JavadocConversionRefactoring extends Refactoring {
    ...
    static {
        ...
        //$NON-NLS-1$
        ALL_API_IMPORTS.put(JavadocTagManager.ANNOTATION_NOEXTEND, "org.eclipse.pde.api.tools.annotations.NoExtend");
        //$NON-NLS-1$
        ALL_API_IMPORTS.put(JavadocTagManager.ANNOTATION_NOIMPLEMENT, "org.eclipse.pde.api.tools.annotations.NoImplement");
        //$NON-NLS-1$
        ALL_API_IMPORTS.put(JavadocTagManager.ANNOTATION_NOINSTANTIATE, "org.eclipse.pde.api.tools.annotations.NoInstantiate");
        //$NON-NLS-1$
        ALL_API_IMPORTS.put(JavadocTagManager.ANNOTATION_NOOVERRIDE, "org.eclipse.pde.api.tools.annotations.NoOverride");
        //$NON-NLS-1$
        ALL_API_IMPORTS.put(JavadocTagManager.ANNOTATION_NOREFERENCE, "org.eclipse.pde.api.tools.annotations.NoReference");
    }
    ...
    class TagVisitor extends ASTVisitor {
        ...
        public boolean visit(MethodDeclaration node) {
            ...
            if (binding != null) {
                IMethodDescriptor method = Factory.methodDescriptor(binding.getQualifiedName(), node.getName().getIdentifier(), Signatures.getMethodSignatureFromNode(node, true));
                try {
