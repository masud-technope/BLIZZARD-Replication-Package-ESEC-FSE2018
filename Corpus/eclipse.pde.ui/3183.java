...
public class OverviewPage extends LaunchShortcutOverviewPage {
    ...
    public void linkActivated(HyperlinkEvent e) {
        ...
        href.equals("multi-platform-wiki")) {
            //$NON-NLS-1$
            openBrowser("https://wiki.eclipse.org/Building#Cross-platform_build");
        } else
