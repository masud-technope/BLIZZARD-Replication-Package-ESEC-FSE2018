...
public class PluginDetailsSection extends PDESection implements IPartSelectionListener {
    ...
    private void update() {
        if (fInput != null) {
            ...
            //$NON-NLS-1$
            fdownloadSizeText.setValue(fInput.getDownloadSize() >= 0 ? "" + fInput.getDownloadSize() : null, true);
            //$NON-NLS-1$
            fInstallSizeText.setValue(fInput.getInstallSize() >= 0 ? "" + fInput.getInstallSize() : null, true);
