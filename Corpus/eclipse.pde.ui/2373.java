...
public class ShowSampleAction extends Action implements IIntroAction {
    ...
    public void run(IIntroSite site, Properties params) {
        ...
        Runnable r = new Runnable() {
            ...
            public void run() {
                ...
                try {
                    //$NON-NLS-1$
                    wizard.setInitializationData(//$NON-NLS-1$
                    null, //$NON-NLS-1$
                    "class", //$NON-NLS-1$
                    sampleId);
    ...
    void applyConfiguration() throws CoreException {
        ...
        try {
            ...
            throw new CoreException(new Status(IStatus.ERROR, IPDEUIConstants.PLUGIN_ID, "Unexpected failure applying configuration", e));
        } finally {
