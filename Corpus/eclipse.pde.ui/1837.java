...
public class ApplicationSelectionDialog extends TrayDialog {
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        getShell().setText(fMode.equals(ILaunchManager.DEBUG_MODE) ? PDEUIMessages.ApplicationSelectionDialog_dtitle : //
        PDEUIMessages.ApplicationSelectionDialog_rtitle);
