    ...
    protected IStatus run(IProgressMonitor monitor) {
        ...
        try {
            ...
            try {
                ...
                String description = NLS.bind(ActionMessages.CompareWithAction_compared_with_against, new Object[] { Integer.valueOf(size), baselineName, Integer.valueOf(delta.getChildren().length) });
                if (size == 0) {
                    ...
                    description = NLS.bind(ActionMessages.CompareWithAction_compared_project_with, new Object[] { elementName, baselineName, Integer.valueOf(delta.getChildren().length) });
                }
