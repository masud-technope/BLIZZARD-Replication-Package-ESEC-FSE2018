...
public class BundleManifestDescriber implements ITextContentDescriber {
    ...
    private static final String[] HEADERS = { Constants.BUNDLE_MANIFESTVERSION, Constants.BUNDLE_NAME, Constants.BUNDLE_VERSION, Constants.BUNDLE_SYMBOLICNAME, Constants.BUNDLE_VENDOR, Constants.BUNDLE_ACTIVATOR };
    ...
    public int describe(InputStream contents, IContentDescription description) throws IOException {
        ...
        String line;
        for (int i = 0; ((line = reader.readLine()) != null) && i < LINES; i++) if (matches(line))
            // found signature
            return VALID;
