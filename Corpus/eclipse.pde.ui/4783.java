...
public abstract class LeakTest extends ApiBuilderTest {
    ...
    private static Class<?>[] getAllTestClasses() {
        Class<?>[] classes = new Class[] { ClassExtendsLeak.class, ClassImplementsLeak.class, InterfaceExtendsLeak.class, ConstructorParameterLeak.class, MethodParameterLeak.class, MethodReturnTypeLeak.class, FieldTypeLeak.class };
        return classes;
    }
