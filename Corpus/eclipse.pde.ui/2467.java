...
public class ApiUseScanTab extends AbstractLaunchConfigurationTab {
    ...
    Button radioBaseline = null, radioTarget = null, radioInstall = null, radioReportOnly = null, baselinesButton = null, targetsButton = null, installButton = null, considerapi = null, considerinternal = null, consideruse = null, createhtml = null, openreport = null, cleanreportlocation = null, cleanhtmllocation = null;

    ITargetHandle[] targetHandles = new ITargetHandle[0];

    Text installLocation = null, searchScope = null, targetScope = null, reportlocation = null, description = null, filterRoot = null;
    ...
    public void createControl(Composite parent) {
        ...
        this.baselinesButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                getTabShell(), //$NON-NLS-1$
                "org.eclipse.pde.api.tools.ui.apiprofiles.prefpage", //$NON-NLS-1$
                null);
    ...
    /**
	 * The selected target has changed (radio selection). Update control enabled
	 * state and dialog.
	 */
    void updateTarget() {
    ...
    void updateAvailableTargets() {
        ...
        if (service != null) {
            ...
            for (int i = 0; i < defs.size(); i++) {
                ITargetDefinition def = defs.get(i);
