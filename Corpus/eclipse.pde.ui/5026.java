...
public class TocHTMLWizardPage extends WizardNewFileCreationPage {
    ...
    protected boolean validatePage() {
        ...
        if (!HelpEditorUtil.hasValidPageExtension(new Path(fLastFilename))) {
            String message = NLS.bind(TocWizardMessages.TocHTMLWizardPage_errorMessage2, HelpEditorUtil.getPageExtensionList());
    ...
    protected IStatus validateLinkedResource() {
        //$NON-NLS-1$
        return new Status(IStatus.OK, PDEUserAssistanceUIPlugin.PLUGIN_ID, IStatus.OK, "", null);
    }
