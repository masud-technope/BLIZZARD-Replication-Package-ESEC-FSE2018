...
public class UpdateSplashHandlerAction extends Action implements ISplashHandlerConstants {
    ...
    private void createExtensionChildrenSplash(IPluginExtension extension) throws CoreException {
        ...
        //$NON-NLS-1$ //$NON-NLS-2$
        IPluginElement splashElementAf = createElementSplash(extension, "af", iconsDir + "af.png", PDEUIMessages.UpdateSplashHandlerInModelAction_nameApplicationFramework);
        if (splashElementAf != null) {
            extension.add(splashElementAf);
        }
        // Splash element: Embedded
        //$NON-NLS-1$ //$NON-NLS-2$
        IPluginElement splashElementEmbedded = createElementSplash(extension, "embedded", iconsDir + "embedded.png", PDEUIMessages.UpdateSplashHandlerInModelAction_nameEmbedded);
        if (splashElementEmbedded != null) {
            extension.add(splashElementEmbedded);
        }
        // Splash element: Enterprise
        //$NON-NLS-1$ //$NON-NLS-2$
        IPluginElement splashElementEnterprise = createElementSplash(extension, "enterprise", iconsDir + "enterprise.png", PDEUIMessages.UpdateSplashHandlerInModelAction_nameEnterprise);
        if (splashElementEnterprise != null) {
            extension.add(splashElementEnterprise);
        }
        // Splash element: Languages
        //$NON-NLS-1$ //$NON-NLS-2$
        IPluginElement splashElementLanguages = createElementSplash(extension, "languages", iconsDir + "languages.png", PDEUIMessages.UpdateSplashHandlerInModelAction_nameLanguages);
        if (splashElementLanguages != null) {
            extension.add(splashElementLanguages);
        }
        // Splash element: RCP
        //$NON-NLS-1$ //$NON-NLS-2$
        IPluginElement splashElementRCP = createElementSplash(extension, "rcp", iconsDir + "rcp.png", PDEUIMessages.UpdateSplashHandlerInModelAction_nameRCP);
