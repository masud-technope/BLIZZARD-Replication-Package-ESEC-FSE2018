...
public class FeatureOptionsTab extends ExportOptionsTab {
            ...
            addListFilter(new ViewerFilter() {
                ...
                public boolean select(Viewer viewer, Object parentElement, Object element) {
                    ...
                    if (resource != null && resource instanceof IFile) {
                        ...
                        return extension != null && //$NON-NLS-1$
                        extension.toLowerCase().equals(//$NON-NLS-1$
                        "xml");
                    }
                    return false;
                }
                ...
                if (resource instanceof IFile) {
                    try {
                        ...
                        if (description != null) {
                            ...
                            if (type != null && type.getId().equalsIgnoreCase("org.eclipse.pde.categoryManifest")) {
    ...
    protected void addAdditionalOptions(Composite comp) {
        ...
        //$NON-NLS-1$
        fCategoryButton.setText(PDEUIMessages.ExportWizard_generateCategories + ":");
