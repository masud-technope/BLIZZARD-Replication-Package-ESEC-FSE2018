...
public final class JavadocTagManager {
    ...
    private void initializeJavadocTags() {
        if (tagcache == null) {
            ...
            // noimplement tag
            ApiJavadocTag newtag = new //$NON-NLS-1$
            ApiJavadocTag(//$NON-NLS-1$
            IApiJavadocTag.NO_IMPLEMENT_TAG_ID, //$NON-NLS-1$
            "noimplement", RestrictionModifiers.NO_IMPLEMENT);
            ...
            list.add(newtag);
            // noextend tag
            newtag = new //$NON-NLS-1$
            ApiJavadocTag(//$NON-NLS-1$
            IApiJavadocTag.NO_EXTEND_TAG_ID, //$NON-NLS-1$
            "noextend", RestrictionModifiers.NO_EXTEND);
            ...
            newtag = new //$NON-NLS-1$
            ApiJavadocTag(//$NON-NLS-1$
            IApiJavadocTag.NO_OVERRIDE_TAG_ID, //$NON-NLS-1$
            "nooverride", RestrictionModifiers.NO_OVERRIDE);
            ...
            newtag = new //$NON-NLS-1$
            ApiJavadocTag(//$NON-NLS-1$
            IApiJavadocTag.NO_INSTANTIATE_TAG_ID, //$NON-NLS-1$
            "noinstantiate", RestrictionModifiers.NO_INSTANTIATE);
            ...
            newtag = new //$NON-NLS-1$
            ApiJavadocTag(//$NON-NLS-1$
            IApiJavadocTag.NO_REFERENCE_TAG_ID, //$NON-NLS-1$
            "noreference", RestrictionModifiers.NO_REFERENCE);
