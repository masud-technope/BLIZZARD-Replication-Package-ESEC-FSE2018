...
public class Factory {
    ...
    public static IMethodDescriptor resolveMethod(IApiTypeContainer container, IMethodDescriptor descriptor) throws CoreException {
        if (container != null) {
            ...
            //$NON-NLS-1$
            throw new CoreException(new Status(IStatus.ERROR, ApiPlugin.PLUGIN_ID, MessageFormat.format("Unable to resolve method signature: {0}", descriptor.toString()), null));
        }
        return descriptor;
    }
}
