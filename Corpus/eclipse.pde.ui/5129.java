...
public class TocDropAdapter extends ViewerDropAdapter {
    ...
    private void setDNDMode(DropTargetEvent event) {
        ...
        } else //The only other transfer type allowed is a Model Data Transfer
        if (//disallow drag if the transfer is not Model Data or Files
        !ModelDataTransfer.getInstance().isSupportedType(event.currentDataType)) {
