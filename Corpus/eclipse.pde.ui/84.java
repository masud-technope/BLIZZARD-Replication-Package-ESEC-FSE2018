...
public class NewFragmentProjectWizard extends NewWizard implements IExecutableExtension {
    ...
    public void addPages() {
        //$NON-NLS-1$
        fMainPage = new NewProjectCreationPage("main", fFragmentData, true, getSelection());
        ...
        //$NON-NLS-1$
        fContentPage = new FragmentContentPage("page2", fProjectProvider, fMainPage, fFragmentData);
