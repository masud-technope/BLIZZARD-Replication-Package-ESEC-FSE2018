...
public class ClassCompatibilityTypeParameterTests extends ClassCompatibilityTests {
    ...
    protected int getProblemId(int kind, int flags) {
        return ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_COMPATIBILITY, IDelta.CLASS_ELEMENT_TYPE, kind, flags);
    }
    ...
    private void xConvertToAnnotation(boolean incremental) throws Exception {
        ...
        int[] ids = new int[] { getProblemId(IDelta.CHANGED, IDelta.TYPE_CONVERSION) };
        setExpectedProblemIds(ids);
        String[][] args = new String[1][];
        args[0] = new String[] { //$NON-NLS-1$
        PACKAGE_PREFIX + "ConvertToAnnotation", Integer.toString(IDelta.CLASS_ELEMENT_TYPE), Integer.toString(IDelta.ANNOTATION_ELEMENT_TYPE) };
        setExpectedMessageArgs(args);
        performCompatibilityTest(filePath, incremental);
    }
    ...
    private void xConvertToEnum(boolean incremental) throws Exception {
        ...
        String[][] args = new String[1][];
        args[0] = new String[] { //$NON-NLS-1$
        PACKAGE_PREFIX + "ConvertToEnum", Integer.toString(IDelta.CLASS_ELEMENT_TYPE), Integer.toString(IDelta.ENUM_ELEMENT_TYPE) };
        setExpectedMessageArgs(args);
        performCompatibilityTest(filePath, incremental);
    }
    ...
    private void xConvertToInterface(boolean incremental) throws Exception {
        ...
        String[][] args = new String[1][];
        args[0] = new String[] { //$NON-NLS-1$
        PACKAGE_PREFIX + "ConvertToInterface", Integer.toString(IDelta.CLASS_ELEMENT_TYPE), Integer.toString(IDelta.INTERFACE_ELEMENT_TYPE) };
        setExpectedMessageArgs(args);
        performCompatibilityTest(filePath, incremental);
    }
