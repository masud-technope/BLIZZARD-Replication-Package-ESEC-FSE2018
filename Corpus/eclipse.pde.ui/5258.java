...
public class MethodCompatibilityModifierTests extends MethodCompatibilityTests {
    ...
    protected int getChangedProblemId(int flags) {
        return ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_COMPATIBILITY, IDelta.METHOD_ELEMENT_TYPE, IDelta.CHANGED, flags);
    }
    ...
    protected int getAddedProblemId(int flags) {
        return ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_COMPATIBILITY, IDelta.METHOD_ELEMENT_TYPE, IDelta.ADDED, flags);
    }
    ...
    private void xAddNoOverride(boolean incremental) throws Exception {
        ...
        int[] ids = new int[] { getAddedProblemId(IDelta.RESTRICTIONS) };
        setExpectedProblemIds(ids);
        String[][] args = new String[1][];
        //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void xAddNoReference(boolean incremental) throws Exception {
        ...
        int[] ids = new int[] { ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_COMPATIBILITY, IDelta.METHOD_ELEMENT_TYPE, IDelta.REMOVED, IDelta.API_METHOD) };
        setExpectedProblemIds(ids);
        String[][] args = new String[1][];
        //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void xPublicToPackage2(boolean incremental) throws Exception {
        ...
        String[][] args = new String[1][];
        //$NON-NLS-1$ //$NON-NLS-2$
        args[0] = new String[] { PACKAGE_PREFIX + "PublicToPackage2", "method()" };
        setExpectedMessageArgs(args);
        performCompatibilityTest(filePath, incremental);
    }
    ...
    private void xPublicToPrivate2(boolean incremental) throws Exception {
        ...
        String[][] args = new String[1][];
        //$NON-NLS-1$ //$NON-NLS-2$
        args[0] = new String[] { PACKAGE_PREFIX + "PublicToPrivate2", "method()" };
        setExpectedMessageArgs(args);
        performCompatibilityTest(filePath, incremental);
    }
    ...
    private void xPublicToProtected2(boolean incremental) throws Exception {
        ...
        String[][] args = new String[1][];
        //$NON-NLS-1$ //$NON-NLS-2$
        args[0] = new String[] { PACKAGE_PREFIX + "PublicToProtected2", "method()" };
        setExpectedMessageArgs(args);
        performCompatibilityTest(filePath, incremental);
    }
