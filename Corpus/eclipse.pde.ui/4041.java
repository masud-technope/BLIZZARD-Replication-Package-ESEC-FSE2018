...
public class ApiUIPlugin extends AbstractUIPlugin {
	 ...
	 */
    private static Map<ImageDescriptor, Image> fCompositeImages = new HashMap<ImageDescriptor, Image>();
    ...
    //basic colors - size 16x16 disabled//$NON-NLS-1$
    private static final String DLCL = ICONS_PATH + "dlcl16/";

    //basic colors - size 16x16 //$NON-NLS-1$
    ...
    //basic colors - size 7x8 //$NON-NLS-1$
    ...
    protected void initializeImageRegistry(ImageRegistry reg) {
        // model objects
        //$NON-NLS-1$
        declareRegistryImage(reg, IApiToolsConstants.IMG_OBJ_API_COMPONENT, OBJECT + "api_tools.gif");
        //$NON-NLS-1$
        declareRegistryImage(reg, IApiToolsConstants.IMG_OBJ_API_SYSTEM_LIBRARY, OBJECT + "library_obj.gif");
        //$NON-NLS-1$
        declareRegistryImage(reg, IApiToolsConstants.IMG_OBJ_API_SEARCH, OBJECT + "extract_references.gif");
        //$NON-NLS-1$
        declareRegistryImage(reg, IApiToolsConstants.IMG_OBJ_BUNDLE, OBJECT + "plugin_obj.gif");
        //$NON-NLS-1$
        declareRegistryImage(reg, IApiToolsConstants.IMG_OBJ_FRAGMENT, OBJECT + "frgmt_obj.gif");
        //$NON-NLS-1$
        declareRegistryImage(reg, IApiToolsConstants.IMG_OBJ_ECLIPSE_PROFILE, OBJECT + "eclipse16.png");
        //$NON-NLS-1$
        declareRegistryImage(reg, IApiToolsConstants.IMG_OBJ_BUNDLE_VERSION, OBJECT + "bundleversion.gif");
        //$NON-NLS-1$
        declareRegistryImage(reg, IApiToolsConstants.IMG_OBJ_CHANGE_CORRECTION, OBJECT + "correction_change.gif");
        //$NON-NLS-1$
        declareRegistryImage(reg, IApiToolsConstants.IMG_ELCL_SETUP_APITOOLS, OBJECT + "category_menu.gif");
        // overlays
        //$NON-NLS-1$
        declareRegistryImage(reg, IApiToolsConstants.IMG_OVR_ERROR, OVR + "error_ovr.gif");
        //$NON-NLS-1$
        declareRegistryImage(reg, IApiToolsConstants.IMG_OVR_WARNING, OVR + "warning_ovr.gif");
        //$NON-NLS-1$
        declareRegistryImage(reg, IApiToolsConstants.IMG_OVR_SUCCESS, OVR + "success_ovr.gif");
        // wizards
        //$NON-NLS-1$
        declareRegistryImage(reg, IApiToolsConstants.IMG_WIZBAN_PROFILE, WIZBAN + "profile_wiz.png");
        //$NON-NLS-1$
        declareRegistryImage(reg, IApiToolsConstants.IMG_WIZBAN_COMPARE_TO_BASELINE, WIZBAN + "compare_wiz.png");
        // enabled images
        //$NON-NLS-1$
        declareRegistryImage(reg, IApiToolsConstants.IMG_ELCL_FILTER, ELCL + "filter_ps.gif");
        //$NON-NLS-1$
        declareRegistryImage(reg, IApiToolsConstants.IMG_ELCL_REMOVE, ELCL + "remove_exc.gif");
        //$NON-NLS-1$
        declareRegistryImage(reg, IApiToolsConstants.IMG_ELCL_OPEN_PAGE, ELCL + "open_page.gif");
        //$NON-NLS-1$
        declareRegistryImage(reg, IApiToolsConstants.IMG_ELCL_COMPARE_APIS, ELCL + "compare_apis.gif");
        //$NON-NLS-1$
        declareRegistryImage(reg, IApiToolsConstants.IMG_ELCL_COMPARE_APIS_DISABLED, DLCL + "compare_apis.gif");
        //$NON-NLS-1$
        declareRegistryImage(reg, IApiToolsConstants.IMG_ELCL_EXPORT, ELCL + "export.gif");
        //$NON-NLS-1$
        declareRegistryImage(reg, IApiToolsConstants.IMG_ELCL_NEXT_NAV, ELCL + "next_nav.gif");
        //$NON-NLS-1$
        declareRegistryImage(reg, IApiToolsConstants.IMG_ELCL_PREV_NAV, ELCL + "prev_nav.gif");
        //$NON-NLS-1$
        declareRegistryImage(reg, IApiToolsConstants.IMG_ELCL_EXPANDALL, ELCL + "expandall.gif");
        //$NON-NLS-1$
        declareRegistryImage(reg, IApiToolsConstants.IMG_ELCL_TEXT_EDIT, ELCL + "text_edit.gif");
        // disabled images
        //$NON-NLS-1$
        declareRegistryImage(reg, IApiToolsConstants.IMG_DLCL_EXPORT, DLCL + "export.gif");
        //$NON-NLS-1$
        declareRegistryImage(reg, IApiToolsConstants.IMG_DLCL_NEXT_NAV, DLCL + "next_nav.gif");
        //$NON-NLS-1$
        declareRegistryImage(reg, IApiToolsConstants.IMG_DLCL_PREV_NAV, DLCL + "prev_nav.gif");
        //$NON-NLS-1$
        declareRegistryImage(reg, IApiToolsConstants.IMG_DLCL_EXPANDALL, DLCL + "expandall.gif");
    }
