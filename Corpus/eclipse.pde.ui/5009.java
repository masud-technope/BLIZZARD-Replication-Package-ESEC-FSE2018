...
public class ApiProblemFactory {
    ...
    public static int getProblemHashcode(String filterhandle) {
        if (filterhandle != null) {
            ...
            try {
                ...
                if (//$NON-NLS-1$
                args[2] != null && !args[2].equalsIgnoreCase("null")) {
    ...
    public static String getLocalizedMessage(int messageid, String[] messageargs) {
        ...
        if (messageid == TYPE_CONVERSION_ID) {
            ...
            double[] typeElementTypes = { IDelta.ANNOTATION_ELEMENT_TYPE, IDelta.CLASS_ELEMENT_TYPE, IDelta.ENUM_ELEMENT_TYPE, IDelta.INTERFACE_ELEMENT_TYPE };
            String[] typeElementTypesStrings = { fMessages.get(Util.getDeltaElementType(IDelta.ANNOTATION_ELEMENT_TYPE)), fMessages.get(Util.getDeltaElementType(IDelta.CLASS_ELEMENT_TYPE)), fMessages.get(Util.getDeltaElementType(IDelta.ENUM_ELEMENT_TYPE)), fMessages.get(Util.getDeltaElementType(IDelta.INTERFACE_ELEMENT_TYPE)) };
