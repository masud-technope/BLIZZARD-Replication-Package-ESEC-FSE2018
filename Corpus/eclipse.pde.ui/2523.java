...
public class ClassUsageTests extends UsageTest {
    ...
    //$NON-NLS-1$
    public static final String CLASS_NAME = "ClassUsageClass";
    ...
    private void x1(boolean inc) {
        setExpectedProblemIds(new int[] { getProblemId(IApiProblem.ILLEGAL_EXTEND, IApiProblem.NO_FLAGS), getProblemId(IApiProblem.ILLEGAL_EXTEND, IApiProblem.NO_FLAGS), getProblemId(IApiProblem.ILLEGAL_EXTEND, IApiProblem.NO_FLAGS), getProblemId(IApiProblem.ILLEGAL_EXTEND, IApiProblem.NO_FLAGS) });
        //$NON-NLS-1$
        String typename = "testC1";
        setExpectedMessageArgs(new String[][] { { CLASS_NAME, typename }, { CLASS_NAME, INNER_NAME1 }, { CLASS_NAME, INNER_NAME2 }, { CLASS_NAME, OUTER_NAME } });
    ...
    private void x2(boolean inc) {
        setExpectedProblemIds(new int[] { getProblemId(IApiProblem.ILLEGAL_INSTANTIATE, IApiProblem.NO_FLAGS), getProblemId(IApiProblem.ILLEGAL_INSTANTIATE, IApiProblem.NO_FLAGS), getProblemId(IApiProblem.ILLEGAL_INSTANTIATE, IApiProblem.NO_FLAGS), getProblemId(IApiProblem.ILLEGAL_INSTANTIATE, IApiProblem.NO_FLAGS) });
        //$NON-NLS-1$
    ...
    private void x3(boolean inc) {
        setExpectedProblemIds(new int[] { getProblemId(IApiProblem.ILLEGAL_IMPLEMENT, IApiProblem.INDIRECT_REFERENCE) });
        //$NON-NLS-1$
    ...
    private void x5(boolean inc) {
        setExpectedProblemIds(new int[] { getProblemId(IApiProblem.ILLEGAL_IMPLEMENT, IApiProblem.INDIRECT_REFERENCE), getProblemId(IApiProblem.ILLEGAL_IMPLEMENT, IApiProblem.INDIRECT_REFERENCE), getProblemId(IApiProblem.ILLEGAL_IMPLEMENT, IApiProblem.INDIRECT_REFERENCE), getProblemId(IApiProblem.ILLEGAL_IMPLEMENT, IApiProblem.INDIRECT_REFERENCE) });
        //$NON-NLS-1$
    ...
    private void x9(boolean inc) {
        setExpectedProblemIds(new int[] { getProblemId(IApiProblem.ILLEGAL_IMPLEMENT, IApiProblem.NO_FLAGS) });
        //$NON-NLS-1$
    ...
    private void x19(boolean inc) {
        ...
        setExpectedLineMappings(new LineMapping[] { //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        new LineMapping(29, localId, new String[] { "local1", "x.y.z.testC11.method1()", "INoImpl2" }), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        new LineMapping(31, indId, new String[] { "local2", "x.y.z.testC11.method1()", "INoImpl5", "INoImpl2" }) });
        setExpectedMessageArgs(new String[][] { //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        { "local1", "x.y.z.testC11.method1()", "INoImpl2" }, //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    ...
    private void x20(boolean inc) {
        ...
        setExpectedLineMappings(new LineMapping[] { //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    ...
    private void x21(boolean inc) {
        ...
        setExpectedProblemIds(new int[] { indId });
        setExpectedLineMappings(new LineMapping[] { //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private void x11(boolean inc) {
        setExpectedProblemIds(new int[] { getProblemId(IApiProblem.ILLEGAL_EXTEND, IApiProblem.ANONYMOUS_TYPE) });
        //$NON-NLS-1$
    ...
    private void x16(boolean inc) {
        setExpectedProblemIds(new int[] { getProblemId(IApiProblem.ILLEGAL_EXTEND, IApiProblem.LOCAL_TYPE), getProblemId(IApiProblem.ILLEGAL_EXTEND, IApiProblem.LOCAL_TYPE), getProblemId(IApiProblem.ILLEGAL_EXTEND, IApiProblem.LOCAL_TYPE) });
        ...
        setExpectedLineMappings(new LineMapping[] { new LineMapping(21, getExpectedProblemIds()[0], getExpectedMessageArgs()[0]), new LineMapping(28, getExpectedProblemIds()[1], getExpectedMessageArgs()[1]), new LineMapping(35, getExpectedProblemIds()[2], getExpectedMessageArgs()[2]) });
        //$NON-NLS-1$
    ...
    private void x14(boolean inc) {
        setExpectedProblemIds(new int[] { getProblemId(IApiProblem.ILLEGAL_EXTEND, IApiProblem.LOCAL_TYPE) });
        //$NON-NLS-1$
    ...
    private void x22(boolean inc) {
        setExpectedProblemIds(new int[] { getProblemId(IApiProblem.ILLEGAL_REFERENCE, IApiProblem.METHOD), getProblemId(IApiProblem.ILLEGAL_REFERENCE, IApiProblem.METHOD), getProblemId(IApiProblem.ILLEGAL_REFERENCE, IApiProblem.CONSTRUCTOR_METHOD), getProblemId(IApiProblem.ILLEGAL_REFERENCE, IApiProblem.CONSTRUCTOR_METHOD), getProblemId(IApiProblem.ILLEGAL_REFERENCE, IApiProblem.FIELD), getProblemId(IApiProblem.ILLEGAL_REFERENCE, IApiProblem.FIELD) });
        setExpectedMessageArgs(new String[][] { //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        { "NoRefClass", "testC14", "noRefClassMethod()" }, //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        { "NoRefClass", "Inner", "noRefClassMethod()" }, //$NON-NLS-1$ //$NON-NLS-2$
        { "NoRefClass()", "testC14" }, //$NON-NLS-1$ //$NON-NLS-2$
        { "NoRefClass()", "Inner" }, //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    private void x23(boolean inc) {
        ...
        { "NoRefClass", "testC15", "noRefClassMethod()" }, //$NON-NLS-1$ //$NON-NLS-2$
        { "NoRefClass()", "testC15" }, //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    private void x24(boolean inc) {
        setExpectedProblemIds(new int[] { getProblemId(IApiProblem.ILLEGAL_REFERENCE, IApiProblem.METHOD), getProblemId(IApiProblem.ILLEGAL_REFERENCE, IApiProblem.CONSTRUCTOR_METHOD), getProblemId(IApiProblem.ILLEGAL_REFERENCE, IApiProblem.FIELD) });
        setExpectedMessageArgs(new String[][] { //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        { "Inner", "testC16", "noRefMemberClassMethod()" }, //$NON-NLS-1$ //$NON-NLS-2$
        { "Inner()", "testC16" }, //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
