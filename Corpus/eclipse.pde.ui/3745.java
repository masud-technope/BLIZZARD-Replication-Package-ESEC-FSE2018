...
public class IncrementalBuildTests extends PerformanceTest {
    ...
    private static Class<?>[] getAllTestClasses() {
        Class<?>[] classes = new Class[] { EnumIncrementalBuildTests.class, AnnotationIncrementalBuildTests.class };
        return classes;
    }
    ...
    public void testIncrementalBuildAll() throws Exception {
        int[] problems = new int[] { ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_USAGE, IElementDescriptor.TYPE, IApiProblem.UNSUPPORTED_TAG_USE, IApiProblem.NO_FLAGS), ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_USAGE, IElementDescriptor.TYPE, IApiProblem.ILLEGAL_EXTEND, IApiProblem.NO_FLAGS), ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_USAGE, IElementDescriptor.METHOD, IApiProblem.API_LEAK, IApiProblem.LEAK_RETURN_TYPE), ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_COMPATIBILITY, IDelta.CLASS_ELEMENT_TYPE, IDelta.REMOVED, IDelta.METHOD) };
        deployIncrementalPerformanceTest(//$NON-NLS-1$
        "Incremental Build - All", //$NON-NLS-1$
        "test1", DEBUG_CORE, //$NON-NLS-1$
        DEBUG_CORE + //$NON-NLS-1$
        ".Launch", problems, 500);
    }
    ...
    public void _testApiStructuralChange() throws Exception {
        deployIncrementalPerformanceTest(//$NON-NLS-1$
        "Incremental - API Structural Change", "api-struc-change", "org.eclipse.core.jobs", "org.eclipse.core.runtime.jobs.Job", new int[0], 550);
    }
    ...
    public void _testApiNonStructuralChange() throws Exception {
        deployIncrementalPerformanceTest(//$NON-NLS-1$
        "Incremental - API Non-Structural Change", "api-non-struc-change", "org.eclipse.core.resources", "org.eclipse.core.resources.ResourcesPlugin", new int[0], 500);
    }
    ...
    public void _testApiDescriptionChange() throws Exception {
        deployIncrementalPerformanceTest(//$NON-NLS-1$
        "Incremental - API Description Change", "api-desc-change", "org.eclipse.core.resources", "org.eclipse.core.resources.IResource", new int[0], 500);
    }
    ...
    public void _testInternalStructuralChange() throws Exception {
        deployIncrementalPerformanceTest(//$NON-NLS-1$
        "Incremental - Internal Structural Change", "non-api-struc-change", "org.eclipse.core.resources", "org.eclipse.core.internal.resources.Resource", new int[0], 500);
    }
    ...
    public void _testInternalNonStructuralChange() throws Exception {
        deployIncrementalPerformanceTest(//$NON-NLS-1$
        "Incremental - Internal Non-Structural Change", "non-api-non-struc-change", "org.eclipse.core.resources", "org.eclipse.core.internal.resources.File", new int[0], 600);
    }
    ...
    public void _testInternalDescriptionChange() throws Exception {
        deployIncrementalPerformanceTest(//$NON-NLS-1$
        "Incremental - Internal Description Change", "non-api-desc-change", "org.eclipse.core.jobs", "org.eclipse.core.internal.jobs.InternalJob", new int[0], 500);
    }
    ...
    public void _testIncrementalBuildCompat() throws Exception {
        ...
        deployIncrementalPerformanceTest(//$NON-NLS-1$
        "Incremental Build - Interface Compatibility", //$NON-NLS-1$
        "test2", DEBUG_CORE, DEBUG_CORE + ".model.IDebugElement", problems, 500);
    }
    ...
    public void _testIncremetalBuildClassCompat() throws Exception {
        ...
        deployIncrementalPerformanceTest(//$NON-NLS-1$
        "Incremental Build - Class Compatibility", //$NON-NLS-1$
        "test3", DEBUG_CORE, DEBUG_CORE + ".DebugException", problems, 500);
    }
    ...
    public void _testIncrementalBuildUsage() throws Exception {
        ...
        deployIncrementalPerformanceTest(//$NON-NLS-1$
        "Incremental Build - Usage", //$NON-NLS-1$
        "test4", DEBUG_CORE, DEBUG_CORE + ".model.DebugElement", problems, 500);
    }
    ...
    public void _testIncrementalBuildLeak() throws Exception {
        ...
        deployIncrementalPerformanceTest(//$NON-NLS-1$
        "Incremental Build - Leak", //$NON-NLS-1$
        "test5", DEBUG_CORE, DEBUG_CORE + ".model.Breakpoint", problems, 500);
    }
    ...
    public void _testIncrementalBuildTags() throws Exception {
        int[] problems = new int[] { ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_USAGE, IElementDescriptor.TYPE, IApiProblem.UNSUPPORTED_TAG_USE, IApiProblem.NO_FLAGS), ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_USAGE, IElementDescriptor.METHOD, IApiProblem.UNSUPPORTED_TAG_USE, IApiProblem.NO_FLAGS), ApiProblemFactory.createProblemId(IApiProblem.CATEGORY_USAGE, IElementDescriptor.METHOD, IApiProblem.UNSUPPORTED_TAG_USE, IApiProblem.NO_FLAGS) };
        deployIncrementalPerformanceTest(//$NON-NLS-1$
        "Incremental Build - Unsupported Tags", //$NON-NLS-1$
        "test6", DEBUG_CORE, DEBUG_CORE + ".model.RuntimeProcess", problems, 500);
    }
