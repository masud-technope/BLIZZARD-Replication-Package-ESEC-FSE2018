...
public abstract class AbstractIllegalTypeReference extends AbstractProblemDetector {
    ...
    protected boolean isProblem(IReference reference) {
        ...
        if (//$NON-NLS-1$
        type.getName().equals("<init>") && reference.getReferenceKind() == IReference.REF_VIRTUALMETHOD) {
        ...
        if (member.getType() == IApiElement.TYPE) {
            ...
            if (ltype.isLocal()) {
                ...
                if (method != null) {
                    ...
                    return new String[] { Signatures.getAnonymousTypeName(ltype.getName()), getSimpleTypeName(etype), simpleTypeName };
                }
            }
        }
