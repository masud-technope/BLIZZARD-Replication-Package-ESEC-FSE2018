    ...
    public void hookListeners() {
        ...
        fName.setFormEntryListener(new FormEntryAdapter(this) {
            ...
            public void textValueChanged(FormEntry entry) {
                ...
                if (fName.getValue().length() == 0)
                    ...
                    while (!(parent instanceof ISchemaElement)) parent = parent.getParent();
        ...
        fType.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                // adjust for "boolean" in combo
                int kind = fType.getSelectionIndex() - 1;
                // kind could be -1
                fAttribute.setKind(kind > 0 ? kind : 0);
                ISchemaSimpleType type = fAttribute.getType();
