...
public class DSEditReferenceDialog extends FormDialog {
    ...
    protected void createFormContent(IManagedForm mform) {
        ...
        // Attribute: Interface
        fInterfaceEntry = new FormEntry(entryContainer, toolkit, Messages.DSReferenceDetails_interfaceEntry, Messages.DSReferenceDetails_browse, false, 0);
    ...
    private void addCardinalityEntry(FormToolkit toolkit, Composite container3, GridData gd) {
        ...
        String[] itemsCard = new String[] { IDSConstants.VALUE_REFERENCE_CARDINALITY_ZERO_ONE, IDSConstants.VALUE_REFERENCE_CARDINALITY_ZERO_N, IDSConstants.VALUE_REFERENCE_CARDINALITY_ONE_ONE, IDSConstants.VALUE_REFERENCE_CARDINALITY_ONE_N };
    ...
    private void addPolicyEntry(FormToolkit toolkit, Composite container3, GridData gd) {
        ...
        String[] itemsPolicy = new String[] { IDSConstants.VALUE_REFERENCE_POLICY_STATIC, IDSConstants.VALUE_REFERENCE_POLICY_DYNAMIC };
    ...
    private void handleOKPressed() {
        fNameEntry.commit();
        if (//$NON-NLS-1$
        !(fNameEntry.getValue().equals("") && fReference.getReferenceName() == null)) {
        ...
        if (//$NON-NLS-1$
        !(fInterfaceEntry.getValue().equals("") && fReference.getReferenceInterface() == null)) {
        ...
        fBindEntry.commit();
        if (//$NON-NLS-1$
        !(fBindEntry.getValue().equals("") && fReference.getReferenceBind() == null)) {
        ...
        fUnBindEntry.commit();
        if (//$NON-NLS-1$
        !(fUnBindEntry.getValue().equals("") && fReference.getReferenceUnbind() == null)) {
        ...
        fTargetEntry.commit();
        if (//$NON-NLS-1$
        !(fTargetEntry.getValue().equals("") && fReference.getReferenceTarget() == null)) {
