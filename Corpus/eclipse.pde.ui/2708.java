...
public class Java5ClassUsageTests extends ClassUsageTests {
    ...
    private void x1(boolean inc) {
        ...
        "x.y.z.testGA1.m1(Object[], List<String>)", //$NON-NLS-1$
        CLASS_NAME } });
    ...
    private void x2(boolean inc) {
        ...
        setExpectedMessageArgs(new String[][] { { //$NON-NLS-1$
        "x.y.z.testGA2.m1(Object[], List<String>)", //$NON-NLS-1$
        CLASS_NAME } });
        deployUsageTest(typename, inc);
    }
    ...
    private void x3(boolean inc) {
        ...
        setExpectedMessageArgs(new String[][] { { //$NON-NLS-1$
        "x.y.z.testGA3.testGA3(Object[], List<String>)", //$NON-NLS-1$
        CLASS_NAME } });
        deployUsageTest(typename, inc);
    }
    ...
    private void x7(boolean inc) {
        ...
        setExpectedMessageArgs(new String[][] { { //$NON-NLS-1$
        GENERIC_CLASS_NAME + "<T>", //$NON-NLS-1$
        typename }, { //$NON-NLS-1$
        GENERIC_CLASS_NAME + "<T>", //$NON-NLS-1$
        INNER_NAME1 } });
        deployUsageTest(typename, inc);
    ...
    private void x18(boolean inc) {
        ...
        new LineMapping(31, indId, new String[] { "local2", "x.y.z.testC11.method1()", "INoImpl5", "INoImpl2" }), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        new LineMapping(21, localId, new String[] { "local3", "x.y.z.testC11.inner1.method2()", "INoImpl3" }), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
        ...
        { "local2", "x.y.z.testC11.method1()", "INoImpl5", "INoImpl2" }, //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        { "local3", "x.y.z.testC11.inner1.method2()", "INoImpl3" }, //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
