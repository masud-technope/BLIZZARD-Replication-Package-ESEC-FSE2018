...
public class InvalidEnumMethodTagTests extends InvalidMethodTagTests {
    ...
    public void x1(boolean inc) {
        ...
        "@noextend", //$NON-NLS-1$
        BuilderMessages.TagValidator_an_enum_method }, { //$NON-NLS-1$
        "@noextend", //$NON-NLS-1$
        BuilderMessages.TagValidator_an_enum_method }, { //$NON-NLS-1$
        "@noextend", //$NON-NLS-1$
        BuilderMessages.TagValidator_an_enum_method }, { //$NON-NLS-1$
        ...
        BuilderMessages.TagValidator_an_enum_method }, { //$NON-NLS-1$
        "@noextend", //$NON-NLS-1$
        BuilderMessages.TagValidator_an_enum_method }, { "@noextend", //$NON-NLS-1$
    ...
    public void x3(boolean inc) {
        ...
        BuilderMessages.TagValidator_an_enum_method }, { //$NON-NLS-1$
        "@noinstantiate", //$NON-NLS-1$
        BuilderMessages.TagValidator_an_enum_method }, { "@noinstantiate", //$NON-NLS-1$
        BuilderMessages.TagValidator_an_enum_method } });
        //$NON-NLS-1$
    ...
    public void x5(boolean inc) {
        ...
        BuilderMessages.TagValidator_an_enum_method }, { //$NON-NLS-1$
        "@noimplement", //$NON-NLS-1$
        BuilderMessages.TagValidator_an_enum_method }, { "@noimplement", //$NON-NLS-1$
        BuilderMessages.TagValidator_an_enum_method } });
        //$NON-NLS-1$
    ...
    public void x7(boolean inc) {
        ...
        BuilderMessages.TagValidator_an_enum_method }, { //$NON-NLS-1$
        "@nooverride", //$NON-NLS-1$
        BuilderMessages.TagValidator_an_enum_method }, { "@nooverride", //$NON-NLS-1$
        BuilderMessages.TagValidator_an_enum_method } });
        //$NON-NLS-1$
