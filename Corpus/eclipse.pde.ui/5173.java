...
public class FeatureSpecSection extends PDESection {
    ...
    public void refresh() {
        ...
        if (isPatch()) {
            ...
            if (featureImport != null) {
                //$NON-NLS-1$
                fPatchedIdText.setValue(//$NON-NLS-1$
                featureImport.getId() != null ? featureImport.getId() : "", //$NON-NLS-1$
                true);
                //$NON-NLS-1$
                fPatchedVersionText.setValue(//$NON-NLS-1$
                featureImport.getVersion() != null ? featureImport.getVersion() : "", //$NON-NLS-1$
                true);
            } else {
                //$NON-NLS-1$
                fPatchedIdText.setValue(//$NON-NLS-1$
    ...
    private void setUpdateSiteUrlText() {
        ...
        //$NON-NLS-1$
        fUpdateSiteUrlText.setValue(//$NON-NLS-1$
    ...
    private void setUpdateSiteNameText() {
        ...
        //$NON-NLS-1$
        fUpdateSiteNameText.setValue(updateSiteLabel != null ? updateSiteLabel : "", true);
    }
