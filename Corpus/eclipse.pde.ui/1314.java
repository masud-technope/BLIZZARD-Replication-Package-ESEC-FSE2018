...
/**
 * Ant task for performing analysis of an API use scan against an alterante
...
public final class ApiMigrationTask extends CommonUtilsTask {
    ...
    /**
	 * Location of the API use scan to resolve in the migration candidate. This
	 * can be the root directory containing an 'xml' sub directory or the 'xml'
	 * directory itself.
	 */
