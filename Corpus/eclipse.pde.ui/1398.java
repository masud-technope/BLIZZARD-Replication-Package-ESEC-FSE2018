...
public class DSEditProvideDialog extends FormDialog {
    ...
    protected void createFormContent(IManagedForm mform) {
        ...
        composite.setLayout(FormLayoutFactory.createSectionClientGridLayout(false, 3));
        composite.setLayoutData(new GridData(GridData.FILL_BOTH));
        // Attribute: Interface
        fInterfaceEntry = new FormEntry(composite, toolkit, Messages.DSProvideDetails_interface, Messages.DSProvideDetails_browse, false, 0);
    ...
    private void handleOKPressed() {
        ...
        if (//$NON-NLS-1$
        !(fInterfaceEntry.getValue().equals("") && fProvide.getInterface() == null)) {
            if (!fInterfaceEntry.getValue().equals(fProvide.getInterface())) {
    ...
    public void setInterfaceEntryListeners() {
        // Attribute: Interface
        fInterfaceEntry.setFormEntryListener(new FormEntryAdapter(this.fProvideSection) {
