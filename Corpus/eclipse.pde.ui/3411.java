...
public class TagScannerTests extends TestCase {
    ...
    public void testMultiInnerTypeAnnotations() {
        IApiDescription manifest = newDescription();
        //$NON-NLS-1$
        doScan("a/b/c/TestClass8.java", manifest);
        //$NON-NLS-1$
        IApiAnnotations description = manifest.resolveAnnotations(Factory.typeDescriptor("a.b.c.TestClass8"));
        //$NON-NLS-1$
        assertNotNull("the description for TestClass8 should exist", description);
        //$NON-NLS-1$
        assertTrue("There should be noreference restrictions on TestClass8", description.getRestrictions() == RestrictionModifiers.NO_REFERENCE);
        //$NON-NLS-1$
        assertTrue("TestClass8 should have API visibility", description.getVisibility() == VisibilityModifiers.API);
        //$NON-NLS-1$
        description = manifest.resolveAnnotations(Factory.typeDescriptor("a.b.c.TestClass8$InnerTestClass8a"));
        //$NON-NLS-1$
        assertNotNull("the description for TestClass8$InnerTestClass8a should exist", description);
        //$NON-NLS-1$
        assertTrue("There should be no subclass on TestClass8$InnerTestClass8a", description.getRestrictions() == RestrictionModifiers.NO_EXTEND);
        //$NON-NLS-1$
        assertTrue("TestClass8$InnerTestClass6a should have API visibility", description.getVisibility() == VisibilityModifiers.API);
        //$NON-NLS-1$
        description = manifest.resolveAnnotations(Factory.typeDescriptor("a.b.c.TestClass8$InnerTestClass8b"));
        //$NON-NLS-1$
        assertNotNull("the description for TestClass8$InnerTestClass8b should exist", description);
        //$NON-NLS-1$
        assertTrue("There should be no instantiate on TestClass8$InnerTestClass8b", description.getRestrictions() == RestrictionModifiers.NO_INSTANTIATE);
        //$NON-NLS-1$
        assertTrue("TestClass6$InnerTestClass8b should have API visibility", description.getVisibility() == VisibilityModifiers.API);
        //$NON-NLS-1$
        description = manifest.resolveAnnotations(Factory.typeDescriptor("a.b.c.TestClass8$InnerTestClass8c"));
        //$NON-NLS-1$
        assertNotNull("the description for TestClass8$InnerTestClass8c should exist", description);
        //$NON-NLS-1$
        assertTrue("There should be no restrictions on TestClass8$InnerTestClass8c", description.getRestrictions() == RestrictionModifiers.NO_RESTRICTIONS);
        //$NON-NLS-1$
        assertTrue("TestClass8$InnerTestClass8c should have API visibility", description.getVisibility() == VisibilityModifiers.API);
    }
    ...
    public void testMultiInnerInterfaceAnnotations() {
        IApiDescription manifest = newDescription();
        //$NON-NLS-1$
        doScan("a/b/c/TestInterface5.java", manifest);
        //$NON-NLS-1$
        IApiAnnotations description = manifest.resolveAnnotations(Factory.typeDescriptor("a.b.c.TestInterface5"));
        //$NON-NLS-1$
        assertNotNull("the description for TestInterface5 should exist", description);
        //$NON-NLS-1$
        assertTrue("There should be noextend restrictions on TestInterface5", description.getRestrictions() == RestrictionModifiers.NO_EXTEND);
        //$NON-NLS-1$
        assertTrue("TestInterface5 should have API visibility", description.getVisibility() == VisibilityModifiers.API);
        //$NON-NLS-1$
        description = manifest.resolveAnnotations(Factory.typeDescriptor("a.b.c.TestInterface5$Inner1"));
        //$NON-NLS-1$
        assertNotNull("the description for TestInterface5$Inner1 should exist", description);
        //$NON-NLS-1$
        assertTrue("There should be no implement on TestInterface5$Inner1", description.getRestrictions() == RestrictionModifiers.NO_IMPLEMENT);
        //$NON-NLS-1$
        assertTrue("TestInterface5$Inner1 should have API visibility", description.getVisibility() == VisibilityModifiers.API);
        //$NON-NLS-1$
        description = manifest.resolveAnnotations(Factory.typeDescriptor("a.b.c.TestInterface5$Inner2"));
        // Bug 402393 - The description returned is for the parent element
        // and is expected because the root type has a restricted sub-type
        //$NON-NLS-1$
        assertNotNull("the description for TestInterface5$Inner2 should exist", description);
        //$NON-NLS-1$
        assertTrue("The root type should be unrestricted", description.getRestrictions() == RestrictionModifiers.NO_RESTRICTIONS);
    }
    ...
    public void testFieldBaseClassInheritedNotSupported() {
        ...
        //$NON-NLS-1$
        assertTrue("there should be noreference restrictions on field 'field1'", description.getRestrictions() == RestrictionModifiers.NO_REFERENCE);
    }
    ...
    public void testFieldNoReference() {
        IApiDescription manifest = newDescription();
        //$NON-NLS-1$
        doScan("a/b/c/TestField10.java", manifest);
        //$NON-NLS-1$ //$NON-NLS-2$
        IApiAnnotations description = manifest.resolveAnnotations(Factory.fieldDescriptor("a.b.c.TestField10", "field1"));
        //$NON-NLS-1$
        assertNotNull("the description for field 'field1' in TestField10 should exist", description);
        //$NON-NLS-1$
        assertEquals("there shouldbe API visibility on field 'field1'", VisibilityModifiers.API, description.getVisibility());
        //$NON-NLS-1$
        assertEquals("There should be noreference restrictions on field 'field1'", RestrictionModifiers.NO_REFERENCE, description.getRestrictions());
    }
    ...
    public void testFieldBaseClassInheritedNotSupported2() {
        ...
        //$NON-NLS-1$
        assertTrue("there should be API visibility on field 'field1'", description.getVisibility() == VisibilityModifiers.API);
        //$NON-NLS-1$
        assertTrue("there should be noreference restrictions on field 'field1'", description.getRestrictions() == RestrictionModifiers.NO_REFERENCE);
    }
    ...
    public void testFieldBaseClassInheritedNotSupported3() {
        IApiDescription manifest = newDescription();
        //$NON-NLS-1$
        doScan("a/b/c/TestField11.java", manifest);
        //$NON-NLS-1$ //$NON-NLS-2$
        IApiAnnotations description = manifest.resolveAnnotations(Factory.fieldDescriptor("a.b.c.TestField11", "field1"));
        //$NON-NLS-1$
        assertNotNull("the description for field 'field1' in TestField11 should exist", description);
        //$NON-NLS-1$
        assertTrue("there should be API visibility on field 'field1'", description.getVisibility() == VisibilityModifiers.API);
        //$NON-NLS-1$
        assertTrue("there should be noreference restrictions on field 'field1'", description.getRestrictions() == RestrictionModifiers.NO_REFERENCE);
    ...
    public void testMethodBaseClassAnnotations() {
        IApiDescription manifest = newDescription();
        //$NON-NLS-1$
        doScan("a/b/c/TestMethod22.java", manifest);
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        IApiAnnotations description = manifest.resolveAnnotations(Factory.methodDescriptor("a.b.c.TestMethod22", "one", "()V"));
        //$NON-NLS-1$
        assertTrue("There should exist a description for method 'void one()'", description != null);
        //$NON-NLS-1$
        assertTrue("There should be API visibility for method 'void one()'", description.getVisibility() == VisibilityModifiers.API);
        ...
        assertTrue("There should be a no reference restriction on method 'void one()'", description.getRestrictions() == RestrictionModifiers.NO_REFERENCE);
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        description = manifest.resolveAnnotations(Factory.methodDescriptor("a.b.c.TestMethod22", "two", "()V"));
        //$NON-NLS-1$
        assertTrue("There should exist a description for method 'void two()'", description != null);
        //$NON-NLS-1$
        assertTrue("There should be API visibility for method 'void two()'", description.getVisibility() == VisibilityModifiers.API);
        ...
        assertTrue("There should be a no override restriction on method 'void two()'", description.getRestrictions() == RestrictionModifiers.NO_OVERRIDE);
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        description = manifest.resolveAnnotations(Factory.methodDescriptor("a.b.c.TestMethod22", "three", "()V"));
        //$NON-NLS-1$
        assertTrue("There should exist a description for method 'void three()'", description != null);
        //$NON-NLS-1$
        assertTrue("There should be API visibility for method 'void three()'", description.getVisibility() == VisibilityModifiers.API);
    ...
    public void testJava8InterfaceMethod1() throws Exception {
        IApiDescription manifest = newDescription();
        //$NON-NLS-1$
        doScan("a/b/c/TestJava8DefaultMethod1.java", manifest);
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        IApiAnnotations description = manifest.resolveAnnotations(Factory.methodDescriptor("a.b.c.TestJava8DefaultMethod1", "m2", "()I"));
        //$NON-NLS-1$
        assertNotNull("there should be annotations for method 'm2'", description);
        //$NON-NLS-1$
        assertTrue("The annotations should include nooverride", (description.getRestrictions() & RestrictionModifiers.NO_OVERRIDE) > 0);
        //$NON-NLS-1$//$NON-NLS-2$//$NON-NLS-3$
        description = manifest.resolveAnnotations(Factory.methodDescriptor("a.b.c.TestJava8DefaultMethod1", "m1", "()I"));
        //$NON-NLS-1$
        assertNotNull("There should be API annotations for the non-default method", description);
        //$NON-NLS-1$
        assertTrue("The annotations for the non-default method should be API", description.getRestrictions() == RestrictionModifiers.NO_RESTRICTIONS);
    }
    ...
    public void testJava8InterfaceMethod2() throws Exception {
        IApiDescription manifest = newDescription();
        //$NON-NLS-1$
        doScan("a/b/c/TestJava8DefaultMethod2.java", manifest);
        //$NON-NLS-1$//$NON-NLS-2$//$NON-NLS-3$
        IApiAnnotations description = manifest.resolveAnnotations(Factory.methodDescriptor("a.b.c.TestJava8DefaultMethod2", "m2", "()I"));
        //$NON-NLS-1$
        assertNotNull("there should be annotations for method 'm2'", description);
        //$NON-NLS-1$
        assertTrue("The annotations should include noreference", (description.getRestrictions() & RestrictionModifiers.NO_REFERENCE) > 0);
        //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        description = manifest.resolveAnnotations(Factory.methodDescriptor("a.b.c.TestJava8DefaultMethod2", "m1", "()I"));
        //$NON-NLS-1$
        assertNotNull("There should be API annotations for the non-default method", description);
        //$NON-NLS-1$
        assertTrue("The annotations for the non-default method should be API", description.getRestrictions() == RestrictionModifiers.NO_RESTRICTIONS);
    ...
    public void testJava8InterfaceMethod3() throws Exception {
        IApiDescription manifest = newDescription();
        //$NON-NLS-1$
        doScan("a/b/c/TestJava8DefaultMethod3.java", manifest);
        //$NON-NLS-1$//$NON-NLS-2$//$NON-NLS-3$
        IApiAnnotations description = manifest.resolveAnnotations(Factory.methodDescriptor("a.b.c.TestJava8DefaultMethod3", "m2", "()I"));
        //$NON-NLS-1$
        assertNotNull("there should be annotations for method 'm2'", description);
        //$NON-NLS-1$
        assertTrue("The annotations should include noreference", (description.getRestrictions() & RestrictionModifiers.NO_REFERENCE) > 0);
        //$NON-NLS-1$
        assertTrue("The annotations should include noreference", (description.getRestrictions() & RestrictionModifiers.NO_OVERRIDE) > 0);
        //$NON-NLS-1$//$NON-NLS-2$//$NON-NLS-3$
        description = manifest.resolveAnnotations(Factory.methodDescriptor("a.b.c.TestJava8DefaultMethod3", "m1", "()I"));
        //$NON-NLS-1$
        assertNotNull("There should be API annotations for the non-default method", description);
        //$NON-NLS-1$
        assertTrue("The annotations for the non-default method should be API", description.getRestrictions() == RestrictionModifiers.NO_RESTRICTIONS);
    ...
    public void testGenericMethodWithBounds() throws Exception {
        IApiDescription manifest = newDescription();
        //$NON-NLS-1$
        doScan("a/b/c/TestGenericMethod1.java", manifest);
        IApiAnnotations description = manifest.resolveAnnotations(//$NON-NLS-1$//$NON-NLS-2$//$NON-NLS-3$
        Factory.methodDescriptor("a.b.c.TestGenericMethod1", "m1", "(QObject;)I"));
        //$NON-NLS-1$
        assertNotNull("there should be annotations for method 'm1'", description);
        description = manifest.resolveAnnotations(//$NON-NLS-1$//$NON-NLS-2$//$NON-NLS-3$
        Factory.methodDescriptor("a.b.c.TestGenericMethod1", "m2", "(QCollection;)I"));
        //$NON-NLS-1$
        assertNotNull("There should be API annotations for the non-default method", description);
    }
}
