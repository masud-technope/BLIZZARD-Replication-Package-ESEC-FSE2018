...
public class PDEModelUtility {
    ...
    // the manifest.mf-related object will always be 1st
    private static final int F_Bi = 0;

    // the xml-related object will always be 2nd
    ...
    public static void setChangeTextType(TextFileChange change, IFile file) {
        ...
        name.equals(ICoreConstants.PLUGIN_FILENAME_DESCRIPTOR) || name.equals(ICoreConstants.FRAGMENT_FILENAME_DESCRIPTOR) ? //$NON-NLS-1$
