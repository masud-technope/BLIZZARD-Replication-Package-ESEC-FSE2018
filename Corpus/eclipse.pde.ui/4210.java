...
public class FeatureImportOperation implements IWorkspaceRunnable {
    ...
    public void run(IProgressMonitor monitor) throws CoreException, OperationCanceledException {
        SubMonitor subMonitor = SubMonitor.convert(monitor, PDEUIMessages.FeatureImportWizard_operation_creating, fModels.length);
    ...
    private void createProject(IFeatureModel model, IProgressMonitor monitor) throws CoreException {
        ...
        SubMonitor subMonitor = SubMonitor.convert(monitor, NLS.bind(PDEUIMessages.FeatureImportWizard_operation_creating2, name), 9);
        ...
        importContent(featureDir, project.getFullPath(), FileSystemStructureProvider.INSTANCE, null, subMonitor.split(1));
        //$NON-NLS-1$
    ...
    private void setClasspath(IProject project, IFeatureModel model, IProgressMonitor monitor) throws JavaModelException {
        ...
        //$NON-NLS-1$
        IClasspathEntry jreCPEntry = JavaCore.newContainerEntry(new Path("org.eclipse.jdt.launching.JRE_CONTAINER"));
