...
public class ApiErrorsWarningsConfigurationBlock extends ConfigurationBlock {
    ...
    protected static class ControlData {
        ...
        public int getSelection(String value) {
            ...
            // assume the last option is the least
    ...
    private static final Key KEY_INCOMPATIBLE_API_COMPONENT_VERSION_INCLUDE_INCLUDE_MINOR_WITHOUT_API_CHANGE = getApiToolsKey(IApiProblemTypes.INCOMPATIBLE_API_COMPONENT_VERSION_INCLUDE_INCLUDE_MINOR_WITHOUT_API_CHANGE);

    private static final Key KEY_INCOMPATIBLE_API_COMPONENT_VERSION_INCLUDE_INCLUDE_MAJOR_WITHOUT_BREAKING_CHANGE = getApiToolsKey(IApiProblemTypes.INCOMPATIBLE_API_COMPONENT_VERSION_INCLUDE_INCLUDE_MAJOR_WITHOUT_BREAKING_CHANGE);
    ...
    static Key[] fgAllVersionManagementKeys = { KEY_MISSING_SINCE_TAG, KEY_MALFORMED_SINCE_TAG, KEY_INVALID_SINCE_TAG_VERSION, KEY_CHANGED_EXECUTION_ENV, KEY_INCOMPATIBLE_API_COMPONENT_VERSION };
	 ...
	 * for each option
	 */
    private static final String[] SEVERITIES = { ApiPlugin.VALUE_ERROR, ApiPlugin.VALUE_WARNING, ApiPlugin.VALUE_IGNORE };
	 ...
	 * @since 1.1
	 */
    private static final String[] CHECKBOX_VALUES = { ApiPlugin.VALUE_ENABLED, ApiPlugin.VALUE_DISABLED };
    ...
    private void createApiComponentResolutionPage(Composite page) {
        Composite vcomp = SWTFactory.createComposite(page, 2, 1, GridData.FILL_BOTH);
        initializeComboControls(vcomp, new String[] { PreferenceMessages.ReportApiComponentResolutionFailure, PreferenceMessages.ApiErrorsWarningsConfigurationBlock_unused_problem_filters }, new Key[] { KEY_REPORT_RESOLUTION_ERRORS_API_COMPONENT, KEY_UNUSED_PROBLEM_FILTERS });
    ...
    private void createVersionManagementPage(Composite page) {
        Composite vcomp = SWTFactory.createComposite(page, 2, 1, GridData.FILL_BOTH);
        initializeComboControls(vcomp, new String[] { PreferenceMessages.VersionManagementReportMissingSinceTag, PreferenceMessages.VersionManagementReportMalformedSinceTags, PreferenceMessages.VersionManagementReportInvalidSinceTagVersion, PreferenceMessages.VersionManagementReportChangedExecutionEnv, PreferenceMessages.VersionManagementReportInvalidApiComponentVersion }, new Key[] { KEY_MISSING_SINCE_TAG, KEY_MALFORMED_SINCE_TAG, KEY_INVALID_SINCE_TAG_VERSION, KEY_CHANGED_EXECUTION_ENV, KEY_INCOMPATIBLE_API_COMPONENT_VERSION });
        addCheckBox(vcomp, PreferenceMessages.VersionManagementReportInvalidApiComponentVersionIncludeMinorWithoutApiChange, KEY_INCOMPATIBLE_API_COMPONENT_VERSION_INCLUDE_INCLUDE_MINOR_WITHOUT_API_CHANGE, CHECKBOX_VALUES, 2);
        addCheckBox(vcomp, PreferenceMessages.VersionManagementReportInvalidApiComponentVersionIncludeMajorWithoutBreakingChange, KEY_INCOMPATIBLE_API_COMPONENT_VERSION_INCLUDE_INCLUDE_MAJOR_WITHOUT_BREAKING_CHANGE, CHECKBOX_VALUES, 2);
    }
