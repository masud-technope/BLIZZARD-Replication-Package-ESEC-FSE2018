...
public class ConvertNonPublicAnonymousTypeToNestedUnitTests extends AbstractRefactoringDebugTest {
    ...
    public void testLineBreakpoint() throws Exception {
        try {
            String src = "src", pack = "a.b.c", cunit = "MoveeChild.java", fullTargetName = "NonPublicChildType$nonPublicChildsMethod()V$1", targetParentType = "NonPublicChildType$nonPublicChildsMethod()V$1", newAnonTypeName = "a.b.c.NonPublicChildType$NewAnonymousClass";
            int lineNumber = 56, ///////VERIFY NEW LINE NUMBER
            newLineNumber = 60;
    ...
    public void testMethodBreakpoint() throws Exception {
        try {
            String src = "src", pack = "a.b.c", cunit = "MoveeChild.java", fullTargetName = "NonPublicChildType$nonPublicChildsMethod()V$1$anonTypeMethod()V", targetParentType = "NonPublicChildType$nonPublicChildsMethod()V$1", newAnonTypeName = "a.b.c.NonPublicChildType$NewAnonymousClass", methodName = "anonTypeMethod";
            //create breakpoint to test
    ...
    public void testWatchpoint() throws Exception {
        try {
            String src = "src", pack = "a.b.c", cunit = "MoveeChild.java", fullTargetName = "NonPublicChildType$nonPublicChildsMethod()V$1$anAnonInt", targetParentType = "NonPublicChildType$nonPublicChildsMethod()V$1", newAnonTypeName = "a.b.c.NonPublicChildType$NewAnonymousClass", fieldName = "anAnonInt";
            //create breakpoint to test
    ...
    private Refactoring setupRefactor(String root, String packageName, String cuName, String targetName) throws Exception {
        ...
        //must have *A* name...			
        ref.setClassName("ThisWillBeErased");
