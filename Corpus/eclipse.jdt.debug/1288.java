...
public class JDIMethod {
    ...
    public static final boolean isXReturn(byte opCode) {
        return (opCode & 0xFF) == IRETURN || (opCode & 0xFF) == LRETURN || (opCode & 0xFF) == FRETURN || (opCode & 0xFF) == DRETURN || (opCode & 0xFF) == ARETURN;
    }
    ...
    public static final boolean isXLoad1(byte opCode) {
        return (opCode & 0xFF) == ILOAD_1 || (opCode & 0xFF) == LLOAD_1 || (opCode & 0xFF) == FLOAD_1 || (opCode & 0xFF) == DLOAD_1 || (opCode & 0xFF) == ALOAD_1;
    }
    ...
    public static boolean isGetterMethod(Method method) {
        ...
        return bytecodes.length == 5 && (bytecodes[0] & 0xFF) == ALOAD_0 && (bytecodes[1] & 0xFF) == GETFIELD && isXReturn(bytecodes[4]);
    }
    ...
    public static boolean isSetterMethod(Method method) {
        ...
        byte[] bytecodes = method.bytecodes();
        return bytecodes.length == 6 && (bytecodes[0] & 0xFF) == ALOAD_0 && isXLoad1(bytecodes[1]) && (bytecodes[2] & 0xFF) == PUTFIELD && (bytecodes[5] & 0xFF) == RETURN;
    }
}
