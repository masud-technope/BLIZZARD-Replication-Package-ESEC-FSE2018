...
public class ConvertPublicAnonymousTypeToNestedUnitTests extends AbstractRefactoringDebugTest {
    ...
    public void testLineBreakpoint() throws Exception {
        try {
            String src = "src", pack = "a.b.c", cunit = "MoveeChild.java", fullTargetName = "MoveeChild$childsMethod()V$1", targetParentType = "MoveeChild$childsMethod()V$1", newAnonTypeName = "a.b.c.MoveeChild$NewAnonymousClass";
            int lineNumber = 26, newLineNumber = 30;
    ...
    public void testMethodBreakpoint() throws Exception {
        try {
            String src = "src", pack = "a.b.c", cunit = "MoveeChild.java", fullTargetName = "MoveeChild$childsMethod()V$1$anonTypeMethod()QString", targetParentType = "MoveeChild$childsMethod()V$1", methodName = "anonTypeMethod", newAnonTypeName = "a.b.c.MoveeChild$NewAnonymousClass";
            //create breakpoint to test
    ...
    public void testWatchpoint() throws Exception {
        try {
            String src = "src", pack = "a.b.c", cunit = "MoveeChild.java", fullTargetName = "MoveeChild$childsMethod()V$1$anAnonInt", targetParentType = "MoveeChild$childsMethod()V$1", fieldName = "anAnonInt", newAnonTypeName = "a.b.c.MoveeChild$NewAnonymousClass";
            //create breakpoint to test
