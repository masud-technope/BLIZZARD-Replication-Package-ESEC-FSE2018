...
=====================
(1) Create reformulated query, i.e., reformulateQuery
(2) Collect/evaluate localization results, i.e., getResult


Required parameters for the operations:
======================================
(1) -task : expects a task to be performed
(2) -repo : expects the name of a system.
(3) -queryFile: file to store the reformulated queries  
(4) -bugIDFile: file containing the bug IDs
(5) -topk : expects the number of results to be analyzed.
(6) -resultFile: file to store the localization results
(7) -reportKey: expects one of three bug report classes (e.g., ST, PE, NL)


Q.1: How to install the BLIZZARD tool?
======================================
(1) Download all items from the Google drive, and keep in /home folder.
(2) Unzip all zip files, and make sure that they are in the home directory. For example, ecf in Goldset.zip should be /home/Goldset/ecf
